...
related_theories: ["[[Autopoiesis]]", "[[World Culture Theory]]", "[[Transition Design]]", "[[Nation Building through Education]]"]
...
Amos 的出发点是两个互相牵连的"未知变量"：我们既不知道教育——包括其制度和组织形式——将变成什么样，也不确定生活在晚期现代性（late modernity）中到底意味着什么（Amos, 2022, p.53）。
...
- [[World Culture Theory]] — 援引 Ramirez & Boli (1987) 对大众教育政治建构的历史分析：18 世纪欧洲民族国家如何通过教育创造 membership（成员身份）——建立忠诚与归属的纽带，同时划定"谁属于我们、谁是外人"的边界（Amos, 2022, pp.54–55）。这一分析为理解"国家中心教育"提供了历史基线
- [[Autopoiesis]] — Maturana & Varela 的自创生系统理论被 Escobar 引入社会转型分析。Amos 将 autopoiesis（自我制造）与 Haraway 的 sympoiesis（共同制造）并置对比，作为两种世界观在理论层面的映射（Amos, 2022, pp.61–63）

---

## 研究方法

这是一篇规范性概念分析（normative conceptual analysis），不是经验研究。Amos 的方法是：选取一个分析框架（[[Robert Cowen]] 的 [[Transitology]] 和双轴模型），用它来诊断两种对立的教育愿景，然后在论证的后半段从描述转向规范——为后人类主义方向提供论证。文中引用的 Escobar 转型设计十条原则等材料，用来支撑"关系性路径已有具体主张"这一论点。
...
> 例：想象 1960 年代的英国综合学校改革——纵轴上的动力清晰可见：政府推动综合学校（comprehensive schools）取代文法学校，核心理由是"教育机会平等"，即 polis-driven 逻辑。国家文化认同（学什么历史、读什么文学）和经济增长（培养产业工人）在水平轴上形成张力，但教育的基本组织者仍然是国家。
...
> 例：想象今天一所英国大学——纵轴上端不再是"如何让更多人上大学"，而是"我们的排名多少、毕业生就业率多高、每个学生的培养成本多少"。纵轴下端"劳动力分化"意味着教育不再追求统一的公民身份，而是根据市场需求将学生分流到不同层级和类型的岗位。学校自主权改革（学校为自己的"竞争力"负责）和跨国排名系统正是这个新模型的操作工具。（Cowen, 1996, pp.160–162；Amos, 2022, p.55）
...
Amos 还借德国小说家 Günther Grass 的自创词 **[[Vergegenkunft]]**（Vergangenheit/Gegenwart/Zukunft = 过去/现在/未来的合成词）来说明：过去、现在和未来并非线性排列，而是彼此纠缠。你无法理解今天的 [[Educational Technology Industry]] 热潮，除非你看到 1950 年代的"知识=生产力"话语和 Sputnik 之后 OECD 对 STEM 的持续关注（Amos, 2022, p.56）。
...
> 例：撒哈拉以南非洲的偏远村庄可能没有合格的物理教师，但如果有一部能上网的手机，学生就能观看可汗学院或 Coursera 的物理课程。"Anytime, anywhere"在理想情况下是包容性的——不需要全日制在校，不需要固定时间表，对有工作、有家庭责任的学生尤其有益。但 Amos 紧接着指出，这个叙事的盲点是基础设施：没有稳定电力和网络，"anytime, anywhere"就是空话。（Amos, 2022, p.57）
...
数字化也在重新绘制大学的组织地图：[[Regional University Alliances]]——欧洲研究型大学联盟（LERU）、The GUILD、以及欧盟委员会框架下的欧洲大学联盟（European University Alliances）——跨越国界甚至大洲边界，合作研究、推动学生和教职流动、开发联合学位项目。Bologna Process 在欧洲高等教育区内的多样化实施证明，即便在标准化压力下，大学仍然有强大的力量维持各自的运作方式（Amos, 2022, p.57）。

> 例：想象一所德国中型大学。它既要在 Bologna 框架下确保学位被欧洲各国承认（标准化压力），又坚持自己的考试制度和课程传统（制度惯性）。同时它加入了两个跨国联盟——一个是研究导向的 LERU，另一个是欧盟资助的欧洲大学联盟——在不同联盟中扮演不同角色。这就是 Amos 所说的"多层级地缘政治教育空间"：不是单一逻辑在运作，而是多种力量在同时拉扯。（Amos, 2022, pp.57–58）

### 第四步：展示第一种教育愿景——超人类主义（§4.4）
...
> 例：Natasha Vita-More 的"身体设计"（body by design）项目是超人类主义的典型表达——不满足于健身和营养来改善身体，而是主张通过技术干预"重新设计"身体。在教育领域的类比是认知增强（cognitive augmentation）：不是通过学习来提升思维能力，而是通过神经技术或药物直接增强大脑功能。如果这种技术只对能支付得起的人开放——显然如此——那么"全人类一起超越"的宣称就只是修辞。（Amos, 2022, p.58）

Amos 将超人类主义定位为**高度现代性（high modernity）的激进延续**：它把现代性的核心梦想——不朽、理性、自主、"做自己命运的主人、设计自己的模样"——推到了逻辑终点。而这一梦想的历史渊源值得注意：Julian Huxley——UNESCO 的第一任总干事——既是科学人文主义和优生学的倡导者，也是人权的推动者。超人类主义的"普世"宣称与优生学传统之间存在着令人不安的连续性（Amos, 2022, p.59）。
...
Amos 接着指出，超人类主义与 Cowen 的**市场驱动模型**高度兼容：它是 hyper-individualist 的（每个人自己做自己的优化项目）、成本密集的（只有少数人能支付顶级增强技术）、以"劳动力分化"为教育目标的（不是培养平等公民，而是培育不同层级的"增强型"劳动者）。如果超人类主义成为主导，我们将看到高端全球 EdTech 产业设定教育标准和节奏（Amos, 2022, pp.58–59）。

### 第五步：描绘第一种愿景的后果——教育愿景 I（§4.4.1）

Amos 随后给出一个推测性预测：**大众教育的权威将持续弱化**。COVID-19 疫情期间的全球"居家学习"实验是一个意外加速器——当家庭教育（home schooling）突然成为全球现实，国家作为教育组织者和认证者的地位就受到了挑战（Amos, 2022, p.59）。

> 例：想象一个 2040 年的学习场景。一个学生在 Coursera 上修完了机器学习微证书，在 Udacity 上拿到了数据科学纳米学位，在 YouTube 上自学了 UI 设计，但没有在任何一所大学注册。她的"学历"是一组数字徽章和项目作品集。雇主通过算法筛选她的技能标签。在这种场景下，国家级文凭意味着什么？大学校园的价值是什么？这就是 Amos 所说的"形式和制度化模式的增殖"——一种教育形态的大爆炸。（Amos, 2022, pp.59–60）

但 Amos 强调：**数字化本身并不自动带来正义和平等**。它可能在以下维度加剧差距（Amos, 2022, pp.60–61）：
...
> 例：两所同一城市的大学——一所富裕的研究型大学和一所资源紧张的社区学院——同时转向在线教学。前者投资了虚拟现实实验室、专业视频制作团队和教学设计师。后者用 Zoom 的免费版本，教师独自对着屏幕讲课。两所学校的学生的"在线学习体验"完全不同。数字化没有消除差距，它在数字化层面重新创造了差距。（Amos, 2022, p.58, 60–61）

更根本的是，**教育的"成员身份创造"功能在弱化**。大型公立学校承担着最重要的社会化任务——把年轻人培养成公民、培养他们对"共同善"的担当。但如果未来教育变成了高度个性化的微证书和自导学习路径的拼贴，那么"共同经验"在哪里？民主社会需要公民共享的基础知识和公共叙事，而超个性化的教育对这一基础构成威胁（Amos, 2022, pp.60–61）。

### 第六步：提出替代方案——关系性后人类主义（§4.5）
...
Escobar 援引 Irwin (2015) 的转型设计十条原则来具体化这个思路。Amos 在正文中全文引用了这十条（Amos, 2022, pp.61–62）。其核心逻辑可概括为：

1. **以生命系统理论理解和应对 wicked problems**——不是将问题简化为单个变量
...
如果说 Escobar 偏向"设计"，Haraway 则偏向"讲故事"。她的核心方法论是 **SF**——这个缩写同时代表 string figures（线绳图案）、speculative fabulation（推测性编造）、science fiction（科幻）、so far（迄今）。核心是：通过讲故事的实践，创造涉及人类与非人类多重行动者的关系模式（Amos, 2022, p.62）。
...
Haraway 的生活伴侣 Rusten Hogness 创造了一个词：**[[Humosity]]**（腐殖性）——描述一个人类被彻底去中心化的世界，人类的生死不过是巨大的物质循环中的一环，就像森林地面上腐殖质的形成和分解（Amos, 2022, p.62）。这个形象虽然令人不适，但它精确地表达了后人类主义与超人类主义的分界线：超人类主义追求被增强的人类站在宇宙中心；后人类主义则把人类放回生态系统中，只是众多物种之一。
...
她给出两个相互加强的解释：第一，大众教育——无论是国家中心还是市场中心——是问题的**一部分**而非解决方案。它的 DNA 里编码了竞争、增长和"粗野个人主义"（rugged individualism），正是制造了 Haraway 和 Escobar 所批评的全球问题的那种心态。第二，他们似乎**把社会化视为理所当然**——教育会随着共同体的转型而自动发生（Amos, 2022, p.63）。
...
Amos 并没有简单地否定大众教育。她明确指出：**大众教育是现代性的重大成就之一**——它创造了一个公共领域，在其中教什么、怎么教是可以被观察、批评和修订的。从 Illich (1971)、Bowles & Gintis (1976) 到 Bourdieu & Passeron (1977)——每一次对大众教育的激烈批评，本身也证明了它的力量：它仍然是**可问责的**（accountable），不能一走了之（Amos, 2022, p.64）。
...
她的最终立场可归结为一个研究和实践的议程：**我们需要一种新的教育理论**——不是关于"怎么教"（Didaktik）的技术理论，而是在更根本的层面回答"我们想怎样一起生活"（How do we want to live together?）的理论。这个理论的特征是：拒绝知识的区隔化组织、以 connectivity 和 response-ability 为组织原则、鼓励协作、对人类中心主义的意识形态持批判态度、提倡非二元思维和自我的非固化、关注物质和非物质的多元纠缠（Amos, 2022, pp.60, 64）。
...
Cowen (1996, pp.160–162) 的双轴模型精确地标示了现代教育→晚期现代教育的结构转型。关键转型参数：纵轴从 polis-driven 到 market-driven，核心价值从"教育机会平等"到"内部效率与外部效能"，合法性基础从"国家文化认同"到"劳动力分化"（Amos, 2022, p.55）。

### 知识市场化的时间深度

知识被建构为生产要素并非 1990s"知识经济"话语的产物。1950s 末经济理论已将知识作为 productive factor 讨论；Sputnik Shock（1957）后 OECD 对 STEM 教育的关注标志着"经济-知识"关联的制度化起点——远早于新公共管理成为主流话语（Amos, 2022, p.56）。

### 数字化的三重不可逆驱动力

利润（Google/Apple/Microsoft 的教育部门、EdTech 股票市场、Coursera/Udacity）、正义平等叙事（UNESCO 的 anytime/anywhere 逻辑）、专业发展（学习分析、个性化学习）同时推动数字化。这三重逻辑相互强化，使"去数字化"日益不可能——即便认识到数字化的不平等效应（Amos, 2022, pp.56–58）。

### 超人类主义的根本困境

Huxley (1957) 的超人类主义声称普世（"全人类一起超越"），但其实践逻辑——hyper-individualist、cost-intensive、依赖选择性增强——不可避免地制造排他性。谁是"完整的人"因而可以被优化？这不仅是分配问题，更是分类的政治。超人类主义与 Cowen 的市场驱动模型高度兼容：两者共享 individualism、劳动力分化和效率最大化逻辑（Amos, 2022, pp.58–59）。
...
- Amos 自认 §4.5 后人类主义部分属于"高度推测"（highly speculative），Haraway 和 Escobar 均未将教育作为论述重点，教育与后人类主义的对接仍是开放问题（Amos, 2022, p.61）
- 章末的"新教育理论"呼吁是纲领性的而非实质性的——Amos 没有给出这种理论的具体轮廓，更接近一个研究议程的宣告
- 对超人类主义的批评集中于其排他性，但未深入讨论"哪些增强技术可能是有益且公平可及的"——批评有余，建设性替代方案的可行性论证不足
