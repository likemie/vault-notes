...
> [!info] 研究问题
> 对 [[John Hattie]]《[[Visible Learning]]》(2008) 的方法论、论证和政策含[[Rightness|义]]进行系统性批判审查。核心问题：VL 的综合方法是否可靠？其结论能否直接用于教育政策制定？

## 理论框架

> [!abstract] 理论框架
> 未采用特定理论框架，从教育哲学和研究方法论视角出发进行批判性评论。引 Dewey 的实用主[[Rightness|义]]知识观作为基线立场：证据不提供行动规则，只为明智的问题解决提供假设（Dewey, quoted in [[John Hattie|Hattie]], 2008, p.147）。

## 研究方法

> [!info] 研究方法
> - 方法：批判性评论（critical commentary），非实证研究
> - 审查对象：[[John Hattie|Hattie]] (2008) 的方法论、论证逻辑和政策含[[Rightness|义]]
...
> 2. **[[Effect Size|效应量]]任意性**：0.4 的截断值武断；小型效应量在高质量大规模研究中可具有重大意[[Rightness|义]]（p.94, 99）
