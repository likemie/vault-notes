...
> [!note-] 可继续提取的信息
> - **[[21st Century Skills and Competencies Discourse|SCD]] 的基础定义与适用范围**：论文明确将 [[Single-Case Design|SCD]] 定义为一类通过在不同条件下重复测量特定行为或技能、以个体或小群体作为自身控制来评估干预效果的实验方法，并说明它起源于心[[Neo-Confucianism|理学]]，已用于教育、医学、言语和语言治疗等领域（Hitchcock et al., 2015, p.460）。
