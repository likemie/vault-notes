...
> - **Bacchi的WPR方法（What's the problem represented to be?）** — 通过六个递进问题审视政策文本：(1) 政策将"问题"表征为什么？(2) 这种表征基于什么预设？(3) 这种表征如何形成？(4) 哪些议题被沉默？(5) 这种表征产生什么效果？(6) 这种表征如何被生产、传播和捍卫？（Bacchi, 2009, p.2；引自 p.3）
>
> WPR方法在此处的运用聚焦于《强劲开端》报告优先改革1（Priority Reform 1），即"将大脑与学习作为核心内容"，以及附录D（Appendix D）中指定的核心内容规范和参考文献（p.5）。
...
> [!warning] 证据薄弱与问题滑动
> 在传统量化标准下，32%的比例构成较弱的论证基础。更重要的是，"问题"在此处发生了悄然滑动：从"教师因工作量过大而离职"滑向了"教师因课堂准备度不足而需要更好的培训"。这一置换将结构性劳动问题转化为了个体能力问题，为标准化核心内容的引入打开了合法性空间。

这一滑动的后果是，改革的靶心从雇主和政策制定者转向了教师教育机构和教师个体。教师被暗示为"未准备好"的一群人，而神经科学则被定位为解决问题的"银弹"（silver bullet）。

---

### 第二步：神经科学作为"价值中立"科学知识的预设

报告将"大脑与学习"定位为客观、价值中立的科学知识，作为解决教育问题的权威方案。核心内容明确区分"新手大脑"（novice brain）与"专家大脑"（expert brain），要求ITE学生学习"生物初级知识与生物次级知识获取的特征"（characteristics of biologically primary and biologically secondary knowledge acquisition），并明确反对自主学习（self-directed learning）和探究式学习（inquiry-based learning）（pp.6-7）。

> [!note] 脑科学方法的具体要求
> 核心内容的教学逻辑可以还原为一个简化链条：新手大脑 ≠ 专家大脑 → 教学必须按照大脑的认知规律设计 → 自主学习和探究式学习不符合新手大脑的特征 → 因此必须被排除。这一链条将教育决策的依据从多元的教学研究转向了单一的脑科学叙事。

但这种脑科学方法将学习简化为大脑内部的信息处理活动，忽视了维果茨基社会文化理论（Vygotsky's sociocultural theory）所强调的社会互动和情境因素。OECD（2007）也指出，神经科学"绝非万能药"（no silver bullet），需要真正的跨学科方法（p.7）。
...
报告未讨论神经科学的任何局限性或历史风险。这一沉默在WPR分析中具有重要意义：被政策省略的议题往往比被纳入的议题更能揭示权力运作的方向（Bacchi, 2009）。

神经推理（neurological reasoning）在历史上曾被用于为压迫性政策提供"科学"依据。在澳大利亚，"被偷走的一代"（Stolen Generations）政策曾借助神经科学话语为强制同化原住民儿童辩护；在纳粹德国，神经科学被用于支持强制绝育政策（p.7）。
...
> - 改革将扩大AITSL的职权范围和认证权力，反映了[[What Works Movement|what works]]运动的惩罚性问责逻辑（p.10）
