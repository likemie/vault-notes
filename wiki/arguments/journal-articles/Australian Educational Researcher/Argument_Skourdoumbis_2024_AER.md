...
>     end
> 
>     subgraph Network [中介与智库网络]
>         H[中介与跨国网络] --> D
>         I[保守智库游说] --> D
>         J[精英理念编排] --> D
>     end
> 
>     subgraph Power [惩罚性问责闭环]
>         D --> K[认证机构评估扩权]
>         K --> L[绑定绩效资金问责]
>         L --> M[教育异化为因果度量]
>     end
...
> [!warrant]- 推理桥梁
> 政策制定者必须为公众所关切的“教师短缺”危机给出一个可见的解决方案。然而，面对“提高薪酬、削减行政工作、改善教师劳动条件”等需要政府支出 and 制度重构的结构性方案，[[Policy Network\|政策网络]]更倾向于选择阻力较小、成本较低的替代方案——将矛头指向大学的教师教育项目（ITE）。通过将“流失问题”表征为“质量和技术准备不足的问题”，政府得以把责任推卸给大学和 职前教师，同时通过强制灌输科学化的神经科学课程，制造出政府正在采取高科技、前沿行动的政治表演效果。
...
> [!critique-logic] 生物学[[Determinism\|决定论]]与国际组织预警的冲突
...
> - **排他性教学法指引** 附录D（p. 95）强制要求掌握新手/专家脑差异、生物初级/次级知识特征，并明确反对[[Learner Autonomy\|自主学习]]与[[Inquiry-Based Learning\|探究式学习]]，导致教学法走向单一化。
> - **背离 OECD 预警历史**
...
### 论证步骤三：历史的沉默：神经推理与优生学、赤字话语的历史关联
...
> [!claim] 步骤四主张
> 神经科学这一问题表征并非自发形成，而是由[[Australian Education Research Organisation\|澳大利亚教育研究组织]]（AERO）这一[[Educational Brokerage Agency\|证据中介机构]]深度编排并直接起草的。AERO在改革中扮演了“自己出题、自己答题、自己判卷”的封闭角色，其背后潜藏着庞大的英澳跨国政策移动网络与惩罚性问责的制度偏好。
...
### 论证步骤六：惩罚性问责的逻辑闭环：AITSL认证扩权与教育存在论转向

> [!claim] 步骤六主张
> 改革将认证机构 AITSL 的行政监控权力推向了新的高度。通过将强制课程、惩罚性资金划拨和毕业生合格标准绑定，建立起表演性问责的逻辑闭环。这最终破坏了大学教师教育的[[Ontology\|本体论]]与存在论基础，从根本上消解了教学的专业性和灵活性。

> [!proc] 惩罚性问责的制度死锁路径
> 1. **核心内容强制硬嵌入** AITSL 将“大脑与学习”等核心课程强制列为国家 ITE 项目认证标准的附表（建议1，p. 17）。
> 2. **常态化行政合规审查** 建立全新的“ITE 质量保证委员会”（建议3，p. 10）审查大学项目执行合规情况。
> 3. **绩效资金行政手段挂钩** 将绩效拨款与 ITE 项目执行结果强制关联（改革2），若不达标将面临取消项目认证与停拨资金的生存惩罚。
...
> 3. **脑科学的简化主义和国际警示遗忘** 报告强制灌输“新手 vs 专家大脑”等生物简化二元论，排斥[[Inquiry-Based Learning\|探究式学习]]，无视社会文化情境，且完全隐瞒了 [[OECD]] (2002, 2007) 关于神经科学可能导致过度顺从、科学神话与被滥用（如 eugenics 历史）的警示（pp. 6–7）。
...
> - **32%** 报告选择性提取的 GOS 2022 调查中认为需要更好更相关课程内容的比例，以此作为大修全国课程的核心证据。（p. 23）
> - **75%** GOS 2022 调查中毕业教师对 ITE 课程的真实整体满意度，表明所谓“培训质量低下”是个政策伪命题。（p. 30）
> - **200次** 报告中“证据/循证”（evidence/evidence-based）出现的频次，与其仅出现2次的“工作量”（workload）形成刺眼对比。（p. 6）
> - **197次** 报告中“认证”（accreditation）出现的频次，凸显了行政监视与表演性问责是本次改革的实质手段。
> - **370万澳元** [[Australian Council for Educational Research\|ACER]] 从独家运营 职前教师准入测试（[[LANTITE]]）中获取的估算年均收益，揭示了循证政策背后的巨额市场化经济利益。（p. 10）
...
> [!warning] 作者的[[Theoretical Standpoint\|理论立场]]边界与政策外推
> - **并非全盘否定科学研究**
>   - 作者明确指出，其分析并非试图证明[[Scientific Method\|科学方法]]或[[Quantitative Research\|量化研究]]在教育调查中是绝对无效的。
