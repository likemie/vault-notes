...
> ### 结论：共享的"构建块"作为整合媒介
>
> 两种适应的兼容性在于：随机化评估[[Transfer Translation Transformation|转移]]性机制产生稳健可靠的因果估计→这些机制作为"构建块"指导改进网络中的教师探究→网络实践洞见反馈回新的机制假设进入实验测试。"机制标签"将"什么有效"从极少被实施的程序性干预重新导向更高杠杆和更可靠类型的"什么"——最接近影响学习的因素（p. 308）。
