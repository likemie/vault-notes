...
summary: "基于卡拉汉的效率崇拜历史视角，批判性论证澳大利亚学校领导力对哈蒂可见的学习（Visible Learning，VL）品牌的盲目顺从，剖析其如何倒退为控制课堂的新泰勒主义科学管理。"
type: argument
...
>     Solve["解法<br/>引进约翰·哈蒂的VL<br/>以 d=0.40 效应量为决策账本"]
...
在VL的逻辑规训下，原本深藏于师生认知内部的隐性教学过程被强制拉扯到外部可观察的数据层面上。这催生了行政监控上的绝对教条：“无数据即无学习，无学习即无教学”（p.420）。教学过程不再是复杂的互动，而被归入绩效赤字和需要行政干预的“管理问题”。举证责任被彻底倒置：教师必须向校长展示其教学对学生学习的数据影响，校长也必须向系统展示其资源配置的数据成效（pp.420–421）。

早在 1950 和 60 年代，以库伯森（Jack Culbertson, 1981）为代表的“理论运动”曾试图引入赫伯特·西蒙（[[Herbert A. Simon|Herbert Simon]]）的行政行为学说和逻辑[[Positivism|实证主义]]，建立一门预测性的教育行政科学，但以失败告终。哈蒂则通过创建一门看似可操作的教学科学，实现了这一夙愿（p.419）。哈蒂本人长期担任 [[Australian Institute for Teaching and School Leadership|AITSL]] 主席，使VL和绩效数据逻辑直接[[Transfer Translation Transformation|转译]]为国家教师与校长专业标准、以及学校年度绩效考核的铁律。墨尔本大学甚至开发了 TeacherSelector 软件，在入口端对初始教师教育（ITE）申请者进行“科学筛选”（p.421）。至此，从入职筛选、国家标准到日常考核，哈蒂品牌完成了与国家科层行政权力的合谋（p.421）。
...
为了深层次理清哈蒂VL管理主义的[[Neo-Taylorism|新泰勒主义]]本质，本研究将 100 多年前泰勒的科学管理与哈蒂的VL框架在管理控制维度上进行了结构性对比：

> [!contrast-table] 泰勒制与“VL”管理主义的跨时代对比
> | 比较维度 | 弗雷德里克·泰勒的科学管理 (Taylor's Scientific Management) | 约翰·哈蒂的“VL”管理主义 (Hattie's Visible Learning) |
> |---|---|---|
...
> [!finding-cards] 核心发现
> 1. **理性修辞的主导与[[School Leadership|学校领导力]]的行政退化** 澳大利亚在面临 NAPLAN 和 [[PISA]] 成绩缓慢下滑时，行政系统出于规避衰退的理性恐慌，将改进窄化为寻找某种标准化、确定性的技术工具，[[John Hattie|哈蒂]]的[[Visible Learning|VL]]填补了管理者的“行政话语饥渴”（p.415）。
