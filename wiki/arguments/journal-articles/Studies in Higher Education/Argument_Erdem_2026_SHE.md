---
summary: "基于20项一阶元分析与469项原始研究开展二阶元分析，证实问题本位学习对高等教育学生理论性知识、临床技能、批判性思维、态度与满意度的总体高效应，并揭示结果类型、地域、抽样方法、质量、报告类型与年份的显著调节作用"
type: argument
authors:
  - "Erdem, C."
  - "Kaya, M."
  ...
  - "Altunbaşak, İ."
source_language: en
citation: "Erdem, C., Kaya, M., Tunç Toptaş, H., & Altunbaşak, İ. (2026). Problem-based learning and student outcomes in higher education: A second-order meta-analysis. Studies in Higher Education, 51(4), 950–971. https://doi.org/10.1080/03075079.2025.2498084"
year: 2026
doi: "10.1080/03075079.2025.2498084"
citation_aliases:
  - "Erdem et al., 2026"
  - "Erdem et al. (2026)"
isbn: ""
...
related_arguments: []
sources:
  - "[[sources/Erdem_2026_SHE/Erdem_2026_SHE|Erdem_2026_SHE]]"
part_of: ""
status: draft
created: 2026-08-24
updated: 2026-08-24
...
> - **结果单一** 许多 FOM 只针对单一结果，如[[Critical Thinking|批判性思维]]（Kong et al., 2014; Liu & Pásztor, 2022）或[[Academic Achievement|学业成就]]（Jensen, 2015; Sugano & Nabua, 2020; Wilder, 2015）；
> - **情境单一** FOM 覆盖不同国家、学科、年龄组与实施方式，关于 PBL 与讲授式教学孰优孰劣的争论持续未决（Moallem, 2019）；
> - **缺量化综合** 唯一在 2009 年由 Strobel & Van Barneveld 完成的综合针对质性数据，尚无研究对 PBL 高等教育 FOM 的量化结果进行二阶综合。
>
> 因此需要以[[Meta-meta-analysis|二阶元分析]]整合多个结果类型上的 FOM 证据，回答两个问题：（1）PBL 对高等教育学生结果的影响水平如何？（2）该影响是否随调节[[Variable|变量]]变化？（pp. 950–952）

> [!claim] 核心主张
> 基于 20 项一阶元分析（涵盖 469 项独立原始研究、47 个独立[[Effect Size|效应量]]）的[[Meta-meta-analysis|二阶元分析]]（Second-Order Meta-Analysis）表明，PBL 对高等教育学生结果具有显著且高的总体影响（调整后效应量 $ES = 0.60$，95% [[Confidence Interval|置信区间]]（Confidence Interval，CI）为 $[0.49, 0.71]$）。其中临床技能（$ES = 1.06$）与学生满意度（$ES = 1.10$）效应很高，理论性知识（$ES = 0.59$）、[[Critical Thinking|批判性思维]]（$ES = 0.56$）与态度（$ES = 0.57$）效应较高。效应变异受结果类型、地域、一阶研究抽样方法、FOM 质量、报告类型与发表年份显著调节，而高等教育专业类型无显著调节。（pp. 950, 961–962）

> [!concept-lens] 阅读透镜
> - **对象** 截至 2024 年、以英文发表、覆盖高等教育、以传统教学为对照的 20 项 PBL 一阶元分析及其包含的 469 项独立原始研究。
> - **张力** 一阶元分析碎片化与二阶宏观证据整合之间的张力；PBL 总体高效应与其高[[Heterogeneity|异质性]]、轻微[[Publication Bias|发表偏倚]]之间的张力；中国情境效应明显偏高所提示的地点偏倚。
> - **贡献** 首次在二阶统计层级定量综合 PBL 高等教育 FOM，按结果类型分列效应，并系统分解结果类型、地域、抽样方法、质量、报告类型与年份的调节作用。
...
> | **学习结果分类框架** | 将学生结果[[Operationalization\|操作化]]为理论性知识、临床技能、[[Critical Thinking\|批判性思维]]、学生态度与学生满意度五类，并依据一阶[[Meta-analysis\|元分析]]报告方式补充“综合”与“其他”编码，为调节分析提供分类学基础。（pp. 954–956, 959） |
...
> | 维度 | 传统讲授式教学 | 问题本位学习 |
> |---|---|---|
> | 学习起点 | 先系统讲授学科知识，再补充技能 | 先呈现经过选择的真实问题 |
> | 学生角色 | 接受知识、按考试要求组织 | 主动建构、自导学习、小组协作 |
> | 教师角色 | 知识传授者 | 促进者，引导而不直接提供答案 |
> | 认知取向 | 侧重行为主义与认知主义的知识传递 | 建构主义，整合元认知与深层加工 |
> | 预期结果 | 短时知识覆盖 | 深层理解、长期保持与迁移应用 |

> [!warrant]- 理论如何支撑论证
> PBL 的建构主义机制（以问题为出发点、小组协作、自我导向学习）既解释了其对深层理解、临床推理与批判性思维的正向作用，也提示效应可能因实施情境、学科与结果类型而异。学习结果分类框架则为跨 FOM 合并[[Heterogeneity|异质性]][[Effect Size|效应量]]提供操作化基础，使“按结果类型分列效应”成为本研究的核心分析策略。（pp. 952–956）
...
> | 模块 | 材料与处理方式 |
> |------|----------------|
> | **方法定位**<br>Second-Order Meta-Analysis | 以整合 FOM 统计结果为目标，将一阶[[Meta-analysis\|元分析]]报告的分析单位（独立[[Effect Size\|效应量]]）作为本研究的分析单位，在[[Fixed-Effect and Random-Effects Models\|随机效应模型]]下进行二阶综合（Oh, 2020; Schmidt & Oh, 2013）。（p. 956） |
...
> | 样本层面 | 构成 |
> |----------|------|
> | **数据集规模** | 20 项 FOM，涵盖 469 项独立原始研究；每项 FOM 纳入 5–82 项独立研究，均值 23.45，标准差 18.49；分析含 47 个[[Effect Size\|效应量]]。（p. 957） |
...
> [!ref-table]- 纳入一阶元分析特征全量清单（Table 1）
> | 一阶元分析研究 | 结果类型 | ES [95% CI] | k | 学科范围 | 报告类型 | 地区 | 抽样方法 | 质量 | 年份范围 |
> |---|---|---|---|---|---|---|---|---|---|
...
> | Wang et al. (2016) | 理论性知识 | .76 [.33, 1.19] | 13 | 临床医学 | 文章 | 中国 | RCT 与非 RCT | 中等 | 2007–2014 |
...
> | Bi et al. (2021)* | 理论性知识 | 3.17 [2.28, 4.07] | 17 | 妇产科 | 文章 | 中国 | RCT | 高 | 2015–2020 |
> | Bi et al. (2021)* | 临床实践 | 2.17 [1.63, 2.71] | 7 | 妇产科 | 文章 | 中国 | RCT | 高 | 2015–2020 |
> | Bi et al. (2021) | 临床操作 | 1.15 [.93, 1.37] | 5 | 妇产科 | 文章 | 中国 | RCT | 高 | 2015–2020 |
> | Zhang et al. (2015) | 理论性知识 | .76 [.65, .88] | 10 | 医学 | 文章 | 中国 | RCT 与非 RCT | 高 | 2014 前 |
> | Wei et al. (2023) | 批判性思维 | .47 [.33, .61] | 19 | 护理 | 文章 | 伊朗、韩国、中国、土耳其 | RCT 与非 RCT | 中等 | 2004–2021 |
...
>
> RCT 表示随机对照试验；非 RCT 表示非随机对照试验；* 表示离群值；** 表示以 OR 报告；*** 表示以 Hedges' g 报告。表内部分数值按原刊表格[[Transcription in Qualitative Research|转录]]，个别单元格存在排版不清。（pp. 958–959）

> [!ref-table]- [[Variable|变量]][[Coding in Qualitative Research|编码]]程序规范（Table 2）
> | 编码分组 | 编码类别与[[Operationalization\|操作化]]定义 |
> |---|---|
> | **研究** | 研究者（发表年份）。 |
> | **结果** | 按 FOM 中报告的原始分数编码、不合并；结果类型包括理论性知识、临床技能、批判性思维与学生满意度；合并报告时编码为“综合”；某结果类型效应量不足（k < 3）时编码为“其他”；技能与知识以外的结果（如倾向、兴趣）编码为学生态度。 |
> | **[[Blue Skies Research\|基础研究]]地点** | FOM 覆盖特定国家或地区时按覆盖地点编码；不限定特定地点时编码为“非特定”。 |
> | **高等教育专业** | 医学、牙科、护理、理科和文科。 |
> | **基础研究抽样方法** | 仅含随机对照组（RCG）编码为 RCG；同时含随机与非随机对照组编码为 RCG 与非 RCG。 |
> | **FOM 质量** | 采用 R-AMSTAR 评分，划分为不充分、低、中等与高。 |
> | **年份范围** | 2010 前、2011–2020、2021 后。 |
> | **报告类型** | 文章与博士论文。 |

> [!example]- 图1：数据流图（Data [[Flow]] Diagram）
> ![](https://img.mylikemie.icu/sources/Erdem_2026_SHE/figures/Erdem_2026_SHE_Fig1_Data_Flow_Diagram.jpg)
...
> ```mermaid
> flowchart LR
>     A["21世纪技能需求与PBL引入高等教育"] --> B["一阶元分析碎片化：单结果、单情境、争议持续"]
>     B --> C["既有综合仅针对质性数据，缺量化二阶综合"]
>     C --> D["PRISMA检索、R-AMSTAR质控、随机效应模型 (20 FOM, 469研究, k=47)"]
>     D --> E["总体高效应：调整后 ES = 0.60；高异质性 I²=93.7%，轻微发表偏倚"]
>     E --> F["结果类型调节：临床技能(1.06)与满意度(1.10)最高"]
>     E --> G["地域(中国1.10)、抽样、质量、报告类型、年份均显著调节"]
>     E --> H["专业类型不显著调节"]
>     F --> I["结论：PBL应在高等教育采用，临床相关领域尤为适合，但推广需谨慎"]
>     G --> I
>     H --> I
> ```
...
> [!warrant]- 推理桥梁
> 既然问题解决与高阶认知已成为高等教育的核心目标，而 PBL 被广泛采用为达成这些目标的模式，那么系统评估 PBL 究竟在多大程度上、在哪些结果上改变了学生表现，就成为课程决策必需的知识。这正是本研究要回答的问题。（pp. 950–951）
...
> 既有 FOM 多限于单一结果（[[Critical Thinking|批判性思维]]或[[Academic Achievement|学业成就]]），且覆盖不同国家、学科、年龄组与实施方式；PBL 实施方式的多样、学习概念与结果定义的不清晰、问题类型的多样性共同造成研究间的[[Heterogeneity|异质性]]。碎片化的局部证据无法裁决 PBL 的整体价值。（pp. 951–952）

> [!chain-link] 证据到判断
> - 部分 FOM 只针对批判性思维（Kong et al., 2014; Liu & Pásztor, 2022），部分只针对学业成就（Jensen, 2015; Sugano & Nabua, 2020; Wilder, 2015）。（p. 951）
> - Hallinger (2021) 指出近期 PBL 研究的主题重心已从学业表现转向批判性思维与态度等其他结果。（p. 951）
...
> [!warrant]- 推理桥梁
> 每个 FOM 只是单一结果或单一情境上的局部估计，其相互冲突的结论不能靠逐篇阅读裁决；把 FOM 作为分析单位进行量化综合，才能把多个结果与情境整合为总体估计，并检验哪些研究特征系统性地改变效应。争论存在本身即为开展二阶综合的理由。（pp. 951–952）
...
> 已有研究以质性系统评价或元分析方式综述 PBL，但唯一跨层级的 Strobel & Van Barneveld (2009) 综合针对[[Qualitative Research|质性研究]]结果；尚无研究把 PBL 高等教育 FOM 的定量汇总[[Effect Size|效应量]]作为分析单位进行二阶综合。（pp. 951–952）
...
> - 基于 FOM 的量化[[Meta-meta-analysis|二阶元分析]]尚未出现；本研究采用二阶元分析整合 FOM 结果，使不同情境的数据获得整体视角。（pp. 951–952）

> [!warrant]- 推理桥梁
> 量化 FOM 数据代表不同情境下的实证效应，将其综合能提供文献的整体图景并加深理解；质性综合无法回答“总体效应量多大”的问题，因此二阶元分析是填补该空缺的合适方法。（pp. 951–952）
...
> 从 495 项检索结果经去重与筛选得到 43 项候选，再按纳入标准最终保留 20 项 FOM（469 项独立研究）。R-AMSTAR 质量得分作为调节[[Variable|变量]]，双人[[Coding in Qualitative Research|编码]]一致率 κ = 0.89，OR 与 Hedges' g 统一转换为 SMD，为[[Fixed-Effect and Random-Effects Models|随机效应模型]]合成奠定数据基础。（pp. 956–960）

> [!chain-link] 证据到判断
> - 六项纳入标准排除了富化 PBL、混合其他教学模式、覆盖 K-12、缺乏传统对照组或统计信息不足的 FOM，并采用 Cooper & Koenka 低于 25% 重叠率门槛控制文献重叠。（pp. 956–957）
> - 20 项 FOM 覆盖 469 项独立研究，每项 FOM 纳入 5–82 项研究，均值 23.45、标准差 18.49。（p. 957）
> - R-AMSTAR 量表 11 个章节剔除 8A/8B 临床条目后计分，质量得分纳入调节检验；编码一致率 Cohen's κ = 0.89。（p. 957）
> - 数据集以 SMD 为主（k = 47），另含 OR（k = 2）与 Hedges' g（k = 1），OR 均转换为 SMD；随机效应模型下分析含 47 个效应量。（pp. 957–960）

> [!exegesis]- 为什么重叠率与效应量尺度重要
> 二阶元分析的最大风险是 FOM 之间原始研究重叠导致同一研究被重复计入，人为压缩联合[[Standard Error|标准误]]、使[[Confidence Interval|置信区间]]虚假变窄；另一风险是 OR、Cohen's d 与 Hedges' g 尺度不一导致合并无意义。低于 25% 重叠率门槛与 OR 向 SMD 的转换分别处理这两个问题。（pp. 956–960）

> [!warrant]- 推理桥梁
> 只有保证纳入的 FOM 彼此独立、效应量处于同一尺度，47 个效应量在随机效应模型下才可能被有意义地合成；否则任何总体估计都可能被文献重叠或测度混乱扭曲。（pp. 956–960）
...
> 观测平均效应量为 $ES = 0.68$（$CI = [0.57, 0.79], p < .001$），但数据集异质性极高（$Q(46) = 730.67, p < .001, I^2 = 93.70\%$）。发表偏倚检验结果相互补充：Begg 秩相关未提示偏倚，Egger 回归与剪补法提示轻微偏倚；剪补法建议补入 6 个负效应量后，调整效应量为 $ES = 0.60$（$CI = [0.49, 0.71]$），与观测值差约 0.08。（pp. 960–961）
...
> [!stat-cards]- 核心综合数据
> - **$ES = 0.60$** PBL 对高等教育学生结果的调整后总体效应量（$CI = [0.49, 0.71]$）。（pp. 950, 961）
> - **$ES = 0.68$** 观测平均效应量（$CI = [0.57, 0.79], p < .001$）。（p. 960）
> - **$I^2 = 93.70\%$** 总异质性比例（$Q(46) = 730.67, p < .001$）。（p. 960）
> - **ΔES ≈ 0.08** 观测与调整效应量之差，提示轻微发表偏倚。（p. 961）

> [!warrant]- 推理桥梁
> 即使考虑发表偏倚、将缺失的负效应研究补入，PBL 的总体效应仍保持在 0.60 的“高”水平，说明正效应并非由选择性发表单独制造。但 93.70% 的异质性提示平均效应掩盖了实质变异，因此必须通过调节分析解释变异来源。（pp. 960–962）

---

### 论证步骤六：调节分析分解异质性来源

> [!claim] 结果类型、地域、抽样方法、质量、报告类型与年份显著调节 PBL 效应，专业类型不显著
> 效应量随结果类型（$Q(6) = 14.65, p = .02$）、地域（$Q(2) = 19.03, p < .01$）、一阶研究抽样方法（$Q(1) = 4.20, p = .04$）、FOM 质量（$Q(1) = 15.25, p < .01$）、报告类型（$Q(1) = 23.36, p < .01$）与发表年份区间（$Q(2) = 11.42, p < .01$）显著变化；高等教育专业类型无显著差异（$Q(5) = 1.17, p = .95$）。（pp. 961–962）
...
> | | 综合 | 4 | .88 | .44 | 1.33 | | | |
> | | 其他 | 4 | .31 | −.08 | .70 | | | |
> | **专业类型** | 医学 | 28 | .68 | .54 | .83 | 1.17 | 5 | .95 |
> | | 护理 | 10 | .67 | .44 | .90 | | | |
> | | 药学 | 3 | .50 | .09 | .91 | | | |
> | | 牙科 | 2 | .77 | .21 | 1.33 | | | |
> | | 理科 | 2 | .79 | .21 | 1.38 | | | |
> | | 文科 | 2 | .80 | .27 | 1.34 | | | |
> | **地域** | 中国 | 11 | 1.10 | .88 | 1.32 | 19.03 | 2 | < .01 |
> | | 伊朗 | 3 | .74 | .34 | 1.15 | | | |
> | | 非特定 | 33 | .55 | .43 | .66 | | | |
> | **一阶研究抽样方法** | RCG 与非 RCG | 34 | .61 | .48 | .73 | 4.20 | 1 | .04 |
> | | RCG | 13 | .84 | .65 | 1.04 | | | |
> | **FOM 质量** | 高 | 26 | .82 | .70 | .93 | 15.25 | 1 | < .01 |
> | | 中等 | 21 | .46 | .32 | .59 | | | |
> | **报告类型** | 文章 | 40 | .77 | .67 | .87 | 23.36 | 1 | < .01 |
> | | 博士论文 | 7 | .19 | −.02 | .40 | | | |
> | **年份区间** | 2010 前 | 5 | .29 | .05 | .53 | 11.42 | 2 | < .01 |
> | | 2011–2020 | 22 | .77 | .63 | .91 | | | |
> | | 2021 后 | 20 | .70 | .55 | .84 | | | |
>
> RCG 表示仅随机对照组。（pp. 961–962）

> [!chain-link] 证据到判断
> - **结果类型** 临床技能（$ES = 1.06$）与学生满意度（$ES = 1.10$）效应“很高”，理论性知识（$ES = 0.59$）、批判性思维（$ES = 0.56$）与态度（$ES = 0.57$）效应“高”，组间差异显著。（pp. 961–962）
> - **地域** 覆盖中国的 FOM 效应最高（$ES = 1.10$），伊朗次之（$ES = 0.74$），非特定地区较低（$ES = 0.55$）。（pp. 961–962）
> - **抽样方法与质量** 仅含随机对照组的 FOM（$ES = 0.84$）高于混合抽样（$ES = 0.61$）；高质量 FOM（$ES = 0.82$）高于中等质量（$ES = 0.46$）。（p. 962）
> - **报告类型与年份** 文章形式（$ES = 0.77$）远高于未发表博士论文（$ES = 0.19$）；2010 年前研究（$ES = 0.29$）低于 2011–2020（$ES = 0.77$）与 2021 后（$ES = 0.70$）。（p. 962）

> [!warrant]- 推理桥梁
> 高异质性在很大程度上可由研究特征解释：不同结果类型对应不同效应水平，中国情境与较近年份、仅含随机对照组与高质量 FOM 均伴随更高效应。地点偏倚提示国家课程与实施经验的差异；报告类型差异提示发表偏倚；专业类型不显著则表明 PBL 的总体效果跨健康科学与人文学科具有一致性。（pp. 962–965）

---

### 论证步骤七：各结果效应与机制解释

> [!claim] PBL 的机制分别解释知识、技能与情感结果上的高效应
> 临床技能效应很高，因其直接对应真实临床问题解决；满意度与态度效应很高，来自 PBL 的主动参与机制。理论性知识效应高但需注意 PBL 可能降低短期知识获取而强化长期保持；批判性思维效应高，来自问题解决过程的深层认知加工。（pp. 963–964）

> [!case] 临床技能的机制案例
> 临床技能与临床情境中遇到的问题直接相关，PBL 聚焦真实问题的解决因而对其有强促进。Wosinski et al. (2018) 报告 PBL 促进护理学生的临床推理。早期研究（Albanese, 2001）曾报告 PBL 对临床技能效应小，可能与实施困难或教师能力有关；近年来效应上升，提示模型交付改善且临床技能的测量工具更完善。（p. 963）

> [!chain-link] 证据到判断
> - **临床技能** $ES = 1.06$ 与护理临床推理证据一致，源于 PBL 对真实问题的聚焦（Wosinski et al., 2018）。（p. 963）
> - **满意度与态度** $ES = 1.10$ 与 $ES = 0.57$ 来自主动参与机制：PBL 鼓励学生积极参与问题解决，培养积极态度与热情（Ferreira & Trudel, 2012; Shin & Kim, 2013），进而增强内在动机与学习能力（Li et al., 2024）；Song (2008) 比较发现 PBL 在满意度、态度与动机上优于传统教学。（pp. 963–964）
> - **理论性知识** $ES = 0.59$ 需结合“短期获取较低、长期保持更好”的既有发现解读：Dochy et al. (2003) 报告 PBL 学生知识获取较低但长期保持更优，Strobel & Van Barneveld (2009) 报告短期保持欠佳而长期保持与表现提升更优；PBL 促进[[Surface and Deep Learning|深层学习]]而非表层学习（Dolmans et al., 2016）。（p. 963）
> - **批判性思维** $ES = 0.56$ 得到问题解决与批判性思维关系的支持：批判性思维可被定义为问题解决过程（Paul & Elder, 2003），PBL 的问题解决环境促使学生深入思考、评价多样视角并综合信息（Ellerton, 2022; Saunders-Stewart, Gyles, & Shore, 2012）。（pp. 963–964）

> [!note] 关键限定
> 批判性思维的培养可能需要长期暴露（Masek & Yamin, 2011），短期[[Intervention Research|干预研究]]可能低估其效应；研究者对批判性思维定义不一致也造成混合结果（Thorndahl & Stentoft, 2020）。（p. 964）

> [!warrant]- 推理桥梁
> 各结果效应都能由 PBL 的机制（真实问题、主动参与、自我导向学习）加以解释；即便理论性知识存在“获取—保持”的权衡，本研究的高效应仍与 PBL 促进深层理解的目标一致。（pp. 963–964）

---

### 论证步骤八：地点、报告类型、质量与年份的作用机制

> [!claim] 地点偏倚、发表偏倚、研究控制与质量机制解释调节模式
> 中国效应最高可归因于长期实施经验与文化因素；未发表博士论文效应更低提示发表偏倚；仅含随机对照组的 FOM 效应更高源于对实施变量的更强控制；高质量 FOM 效应更高反映方法学严谨性。（pp. 964–965）
...
> - **抽样与质量** 仅含随机对照组的 FOM 效应更高，因为[[Random Assignment|随机化]]对实施过程变量控制更充分（Bonell et al., 2018）；高质量 FOM 效应更高与二阶元分析研究一致（Young, 2017; Martin et al., 2022）。（p. 965）
...
### 论证步骤九：结论、PBL 之争与推广建议

> [!claim] PBL 应在高等教育中采用，尤其适合临床技能相关专业，但推广需结合偏倚与异质性审慎解释
> 尽管关于 PBL 认知基础的争论持续，证据表明 PBL 毕业生具备相当或更强的专业能力，且 PBL 同时促进学术、实践与情感类结果。结论支持 PBL 在高等教育中的使用，并建议通过教师在职培训缓解满意度与态度维持问题。（pp. 965–966）
...
>
> > [!axis] PBL 课程毕业生的专业能力
> > 支持方证据表明，PBL 课程毕业生相对传统课程毕业生具备相当或更优的专业能力（Neville, 2008）。本研究亦报告 PBL 在学术表现之外，对实践类结果（临床技能、批判性思维）与情感类结果（态度、满意度）均具正效应。（p. 966）
> >
> > - **Neville (2008)** PBL 毕业生具备相当或更强的专业能力。（p. 966）

> [!chain-link] 证据到判断
> - PBL 同时促进学术表现与实践类输出（临床技能、批判性思维）及情感类输出（态度、满意度），不仅限于学业成绩。（p. 966）
> - 结论建议：高等教育应使用 PBL 以促进理论性知识获取、临床与批判性思维技能以及积极态度与满意度；若专业与临床技能相关，PBL 是最佳教学模式。（p. 966）
> - 为难以维持满意度与积极态度的教师组织 PBL 在职培训。（p. 966）
> - 仍需进一步研究以确定 PBL 在其他高等教育专业中的全部潜力（Stentoft, 2017）。（p. 966）

> [!implication]- 推论后果
> 二阶元分析的结论同时指向研究议程：未来 FOM 应纳入不同地域与数据库以降低地点偏倚，纳入未发表博硕士论文以缓解发表偏倚，开展高等教育与 K-12 的比较，并覆盖工程、教师教育、法学、社会科学与人文学科。（pp. 965–966）

> [!warrant]- 最终推理桥梁
> 把总体高效应、各结果机制解释与调节模式结合，作者收束为“PBL 应在高等教育中采用”的判断，并同时强调发表偏倚与高异质性要求谨慎推广。该判断既来自统计证据，也来自 PBL 机制与既有研究的一致支持。（pp. 963–966）
...
> 2. **临床技能与学生满意度效应最高，其余结果效应较高** 临床技能（$ES = 1.06$）与学生满意度（$ES = 1.10$）属“很高”，理论性知识（$ES = 0.59$）、[[Critical Thinking|批判性思维]]（$ES = 0.56$）与态度（$ES = 0.57$）属“高”。（pp. 961–962）
> 3. **效应变异受结果类型、地域、抽样、质量、报告类型与年份显著调节** 中国情境（$ES = 1.10$）、仅含随机对照组的 FOM（$ES = 0.84$）、高质量 FOM（$ES = 0.82$）、文章形式（$ES = 0.77$）与 2011 年后发表（$ES \approx 0.70–0.77$）均伴随更高效应；专业类型无显著调节。（pp. 961–962）
...
> - **$ES = 1.10$ / 1.06** 学生满意度与临床技能效应量（$CI = [0.62, 1.59]$ 与 $[0.75, 1.37]$）。（p. 962）
> - **$Q(46) = 730.67, I^2 = 93.70\%$** 总异质性检验。（p. 960）
> - **$k = 47$** 纳入分析的独立效应量（20 项 FOM、469 项独立研究）。（pp. 957, 960）
...
> 该研究得出结论：[[Problem-Based Learning|PBL]] 对学生结果具有显著且高的影响。平均[[Effect Size|效应量]]为 ES = .60 [CI = 0.49; 0.71; Q(t) = 757.75]。此外，分析显示，影响 PBL 效应变异的调节变量包括学生结果类型、地理位置、[[Blue Skies Research|基础研究]]所采用的抽样方法、研究质量、发表年份与发表类型。（p. 950）
>
...
> [!citation-card]- 中国情境效应偏高的文化解释
> 本研究中中国观察到的效应量显著高于其他地点。这可能归因于 PBL 自 1970 年代以来在中国高等教育机构得到实施……此外，中国在 PBL 上的长期经验以及中国学生的自导向学习、成就动机与集体主义倾向可能共同解释了这一结果。（pp. 964–965）
>
...
> 1. **仅比较 [[Problem-Based Learning|PBL]] 与传统教学模型** 未覆盖以网络工具、计算机、团队工作等富化的 PBL，也未与项目本位学习、案例本位学习等其他模式比较。
> 2. **仅限于高等教育** 未覆盖 K-12 层面，无法进行高等教育与 K-12 的比较。
> 3. **仅限于英文发表的 FOM** 未纳入其他语言研究。
> 4. **非健康科学专业 FOM 数量有限** 工程、教师教育、法学、社会科学与人文学科的 FOM 覆盖不足。
> 5. **仅基于量化数据** 未综合质性系统评价的发现。
> 6. **存在轻微[[Publication Bias|发表偏倚]]** 纳入 FOM 普遍报告正且大的效应，可能是偏倚来源，解读需结合偏倚报告。
> 7. **医学与护理专业被过度代表** 其他专业[[Effect Size|效应量]]较少，泛化到所有高等教育专业时需谨慎。
