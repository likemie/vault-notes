...
> | 理论工具 | 解释功能 |
> |----------|----------|
> | **[[Informationalism]]**<br>[[Manuel Castells]] | 区分两种本质不同的发展模式。工业化（industrialism）依赖重工业物质投入的线性扩张，即钢铁、水泥、石油等重工业产品；信息化（informationalism）依赖基于知识和信息优化生产要素组合与使用的质化能力。成功完成前者不自动导向后者。 |
...
> 同样的逻辑也发生在物理学领域。爱因斯坦的相对论被苏联官方斥为"资产阶级的、反动的、与马克思列宁主义不相容"（Vucinich, 2001, p.5）。然而一个讽刺性的转折发生了：制造核弹的现实需求迫使苏联科学家不得不接受爱因斯坦物理学的工具价值。这一案例揭示了苏联科学意识形态化中的一个深层悖论：当意识形态与国家安全发生直接冲突时，实用需求可以暂时压倒意识形态正统，但这种"例外"并不改变体制对科学自主性的系统性压制。
