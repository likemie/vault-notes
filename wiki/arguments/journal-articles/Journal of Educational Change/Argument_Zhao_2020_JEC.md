...
> [!abstract]
> 这是一篇综述文章，系统梳理近二十年来对 [[PISA]] 的批评。采用的方法是文献综合，将分散在学术期刊和技术报告中的批评汇集为一篇非技术性语言的总结。专注于 PISA 的三个根本缺陷：其对教育的基本观点、其实施、以及其对全球教育的解释和影响。
...
PISA 巧妙地利用了这种焦虑，提出了三个问题：年轻人是否准备好迎接未来挑战？他们能否有效分析、推理和沟通？他们是否有终身学习的能力（OECD 1999, p.7）？这些话语从 1999 年引入 PISA 的文件开始，几乎在所有 PISA 报告中被重复（Sjøberg 2015b）。
...
>
> **统计方法**。PISA 使用 [[Rasch Measurement|Rasch]] 模型推导结果，但 Kreiner 和 Christensen (2014) 发现 Rasch 模型不适合 PISA 的阅读素养数据，因此国家排名不稳健。Kreiner 认为这意味着 PISA 的国家比较是无意义的（Stewart 2013）。
