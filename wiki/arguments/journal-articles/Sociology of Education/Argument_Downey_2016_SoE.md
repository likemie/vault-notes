...
>    - 如何判断学校不平等是否超过非学校不平等——传统的学校间比较框架忽略了[[Counterfactual|反事实]]（"如果没有学校会怎样？"）
>
...
> [!success] 主要发现
> - **SES 成就差距主要在学校入学前形成**：ECLS-K 1998 数据显示，收入基础的 90/10 阅读差距在幼儿园至八年级间仅增长约 12%，数学差距实际上缩小了(Reardon, 2011, pp.7–8)
...
> - [[Seasonal Comparison|季节性比较]]方法的[[Hypothesis|假设]]（无处理溢出、等距量表、暑假作为有效[[Counterfactual|反事实]]）值得更多学术讨论
