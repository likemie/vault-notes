...
> - 特刊论文涵盖主题：[[Randomised Controlled Trials|RCT]] 设计改进（[[Cluster Randomized Trials|CRT]]、部分嵌套设计）、[[Meta-analysis|元分析]]与超级综合、过程评估整合、"什么有效 2.0"、教师对研究的回应、超越综合影响链

## 核心论证

> [!example] 核心论证
> 1. **前提**：尽管 EEF（£125M）和美国 DOE 等大量资助 [[Randomised Controlled Trials|RCT]]，"至今很少有显著正向的教育实践在大规模上出现"（Pampaka et al., 2016, p.231）
> 2. **方法论进展有限**：Spybrook 等展示 [[Cluster Randomized Trials|CRT]] [[Jing (Refined Mastery)|精]]度十年间有所提高；Schweig & Pane 提供部分嵌套设计中 [[Intent-to-Treat Analysis|ITT]] 分析的建模方案——但这些技术改进未必能解决根本问题（p.233）
...
> - [[Cluster Randomized Trials|CRT]] 设计[[Jing (Refined Mastery)|精]]度在过去十年间有所提高（Spybrook 等），但 RCT 领域弥漫"萎靡感（malaise）"（p.233）
