...
>
> - **步骤二：识别全球化的新要求。** 全球化改变了教育转移的性质：(a) 需要关注前转移能动性——谁在引入外国范例、如何使用、为何目的；(b) 行动者激增——国家不再是唯一行动者，超国家组织、智库、顾问、[[Policy Entrepreneur|政策企业家]]、排行榜、媒体、资助来源等纷纷介入；(c) 转移的不仅是政策文本，更是政策话语（policy discourse）。（p. 226–228）
>
...
>   - **[[Cross-National Attraction|跨国吸引]]力的"火花"（Sparks）：** 四种使用外国范例的动机——丑闻化（scandalize）、合法化（legitimate）、警示（caution）、颂扬（glorify）——按修辞力度和改革／抵制取向排列
>
