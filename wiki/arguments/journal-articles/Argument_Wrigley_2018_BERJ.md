...
> - **Pawson (2006) 的现实主[[Rightness|义]][[Appraisal Theory|评估理论]]** — 社会项目通过人的推理（而非物理因果）产生效果；呼吁"实在论综合"取代统计平均
...
> - [[Matching|匹配]]子集分析显示：治疗组和控制组的低分学生进步几乎完全相同
> - **"三个月的额外进步"是随机化失败的幻象**
...
>
> 1. **苹果和橙子**：不同定[[Rightness|义]]、年龄、学科、地区的异质研究被混合计算平均效应量。Feinstein (1995) 称之为 "statistical alchemy for the 21st Century"，差异被"埋在统计泥浆中"。
>
...
> ### 政治定位
>
> Wrigley 将 [[Evidence-Based Education|EBE]] 方法论[[Jing (Refined Mastery)|精]]简定位于**新自由主义政策框架**：
...
>
> **影响**：此全面不信任的基调使 Wrigley 的论文在 [[Evidence-Based Education|EBE]] 方法论辩论中容易被对手定位为"反量化"而非"方法多元"——削弱了其作为建设性替代方案的可信度。Slavin (2019) 可以将 Wrigley 的立场所概括为"怀疑论者认为我们根本不应该进行教育实验"——尽管 Wrigley 的立场更为[[Jing (Refined Mastery)|精]]细。
>
...
> - Wrigley 将前者解读为"新自由主[[Rightness|义]]的草根捕获"，但这一解读可能低估了教师作为知情主体的选择能力
>
