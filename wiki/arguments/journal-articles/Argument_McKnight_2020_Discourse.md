...
> [!info] 研究问题
> [[Visible Learning]] 作为一种全球教育论述，在文化政治层面"运作"（puts to work）了什么？具体而言：Visible Learning 的隐喻本身与哪些权力关系结盟？它在性别、能力和新自由主[[Rightness|义]]议程方面产生了什么效应？
>
...
>
> - **新自由主[[Rightness|义]]批判**：Ball（2003）的"新管理全景监狱主义"和"本体论不安全"概念；Springer（2016）的新自由主义暴力分析四问框架（什么在凝结？暴力是什么？资本流向何处？抵抗在哪里？）
...
> - **能力批判研究**：[[Campbell Collaboration|Campbell]]（2009）的能力主义定义——"两个截然不同的本体论区域"；Michalko（2001）对视力的批判性分析；Slee（2011）的包容性教育理论
...
> - **局限性（作者自认）**：由于专门批评 VL 文化政治的文献匮乏，论文直接进入批评而非常规文献综述（McKnight & Whitburn, 2020, p.34）
...
> 视觉作为主导性和殖民性感官，在新自由主[[Rightness|义]]语境中并非中性选择。VL 暗示教师和学生是全能的行动者——命运在自己手中，从而否定了国家强制课程、测试制度、排名表等的结构性暴力。VL 创造了"每个人都可以监视其他所有人"的监控文化（教师-学生、家长-教师、校长-教师、学者-教师、国家-教师、国家-学者）。教师被保持在"本体论上不安全"的状态以被去政治化（Ball, 2003）。提出问题：VL 使什么具体化了？谁的获益？暴力和资本流动在哪里？
>
> ### 2. Visible Learning 模拟色情片逻辑
> VL 由一位单一的、上帝般的男性权威主导，痴迷于"射[[Jing (Refined Mastery)|精]]式的结果"（McKnight, 2017），在以女性为主的职业中强加异性恋规范、性别歧视和能力主义的教育建构。一种"学习的色情化"通过为男性化凝视生产可见证据而实现。将青少年色情自查问题改编为教师数据成瘾自查，揭示两者共享的"可见性的狂热"（Williams, 1989）。
>
...
> 单一教义统治教师和课堂？Foucault 的警告被忽视——"可见性是一个陷阱"。VL 是"有组织的遗忘"（Kundera, 1981）——对其做法本质是教师做法的事实进行系统性遗忘。Pinar（2011）的警告：不加理解地应用课程→法西斯主义。在 Gramsci 意义上 VL 是景观式霸权性的。VL 殖民教师的"表演性教学想象"（McKnight, 2016）。
>
> ### 6. Visible Learning 过度简化
> "Impact"一词等于"有力的接触"（子弹、炮弹）。"Know thy impact"带有[[Sage|圣]]经式语气——是在后结构主义质疑之后对确定性的加固。"眼睛将其不足隐藏在傲慢背后"——眼睛本质上是脆弱的（玻璃体冻胶），需要好斗。实证主义科学的纪律只是另一种虚构——众多研究叙事之一。
>
...
> [!success] 主要发现
> 1. [[Visible Learning]] 的论述与新自由主[[Rightness|义]]、性别歧视和能力主义议程深度结盟，这三者在学校中"运作以实施排斥并在女性化工作中去专业化教师"（McKnight & Whitburn, 2020, p.32）
...
> [!warning] 局限性与批评
> - **论文自认局限**：非实证课堂研究，而是理论性参与；由于专门批评 VL 文化政治的文献匮乏，未进行常规文献综述（p.34）；作者承认自己也可能同样"将教师定位为匮乏者、未被意识到的被接管者、被学者发声的腹语术人偶"（p.42）
