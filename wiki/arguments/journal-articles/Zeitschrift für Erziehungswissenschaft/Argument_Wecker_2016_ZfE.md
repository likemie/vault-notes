...
>
> 具体案例：Olson & Wisher (2002) 的 15 项主要研究中有 14/15 项（93%）同时出现在 Sitzmann et al.(2006)的元分析中。另一案例：三项（共四项）Hattie 纳入的同一主题元分析存在主要研究重叠。Hattie 将它们汇总为算术平均值 0.59；正确加权（处理重叠后）为 0.23。Hattie 承认存在可能重叠但辩称重叠程度低，但 Wecker et al.证明"Hattie 完全忽略了重复的问题"。
>
...
> - 使用加权均值和修正重叠的计算是"对[[John Hattie|哈蒂]]结果稳健性的合理怀疑"(p.30)
>
> ### 方法论基础设施层面
>
...
> - 关节点 d=0.40："0.3 几乎不对应于一学年课程中能力提升的幅度"(p.33)
>
> ### 建设性方向
>
