...
> Nelson & Campbell 作为 *Educational Research* 特刊导言，围绕三个核心问题组织该领域的讨论：(1) [[Evidence-Informed Practice|EIP]] 如何被不同利益相关者定义和理解？(2) 有效的[[Knowledge Mobilisation|知识动员]]（knowledge mobilisation）需要什么条件？(3) EIP 的成果应如何测量？(p. 128)
...
>
> 论文识别了 EIP 领域的根本性张力：
> - **Goldacre (2013) 立场**：教育不是证据本位的，因为缺乏通过 [[Randomised Controlled Trials|RCT]] 收集的稳健"什么有效"证据 → 推动英国 What Works Centres 和美国联邦政府的"什么有效"方法论
> - **Bredo (2006) 的反驳**：将教育研究窄化为"什么有效"的实验排除了"什么重要"（what matters）的更大问题(p. 128)
> - **Bryk (2015) 的中间立场**：提出"基于实践的证据"（practice-based evidence），认为教育者产生的细粒度、实践相关的知识可以有形塑性地支持专业学习和学生成就(p. 129)
>
...
>
> ### 4. [[Knowledge Mobilisation|知识动员]]的四种策略框架
>
> 论文从特刊论文中归纳出 KMb 的四类核心策略(pp. 130–131)：
>
> 1. **沟通与传播**：研究发表和发现的传播是长期关注点，但仅仅"推出"研究发现不够——需要注意证据的可及性、吸引力和可使用性
> 2. **能力建设**：教育者需要发展"分析立场"和"评估技能"以理解多种形式的证据；研究者也需要提高更清晰、更可及地动员其工作的能力
> 3. **伙伴关系与网络**：个体（如学校和系统领导者）和组织（如专业协会和研究机构）可扮演重要的**中介角色**，调解什么证据被沟通和连接到实践
> 4. **系统化方法**：鉴于获取、理解和使用证据的时间和资源持续挑战，需要发展系统层面的 EIP 文化和基础设施
>
> ### 5. 测量挑战：需要中间成果 + 长期成果的多维评估
>
> 论文指出 EIP 测量的两个知识缺口：(a) 如何测量教学行业 EIP 的程度；(b) EIP 对教学实践和学习者成果的影响（如果有的话）。(p. 131)
>
> Wentworth et al. (2017)提出区分：
> - **中间成果**：教育者行为或"思维模式"
> - **长期成果**：工具性成果（对实践的影响）；概念性成果（对思维的影响）；象征性成果（使用证据来合法化方法或说服他人其价值）

## 主要发现

> [!success] 主要发现
> - **共识**：特刊论文一致认为"证据"构成多种类型和来源的知识和信息——包括专业知识和判断，以及数据和研究。尽管"黄金标准"方法论辩论持续，最常使用的证据来源往往来自专业经验和同事，而非原始研究。(p. 132)
> - **持续性挑战**：获取高质量证据的渠道、专业参与和探究的时间、所有参与者的专业发展和能力建设（理解、分享、共同开发和应用证据）——以及评估 [[Evidence-Informed Practice|EIP]] 策略和成果的方法。(p. 132)
> - **[[Knowledge Mobilisation|KMb]] 的互惠性**：研究者和实践者都需要发展 KMb 能力——"具有讽刺意味的是，我们仍然需要更多关于 EIP 在实践中的应用和成果的证据"。(p. 132)
...
> ("The process of being evidence-informed requires both rigorous evidence and a rigorous process of professional judgement.") (Campbell, 2016, p. 132)
>
