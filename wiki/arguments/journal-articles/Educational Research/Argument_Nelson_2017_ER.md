---
summary: "2017年《Educational Research》特刊导言，系统构建证据知情实践（EIP）的“定义—应用—测量”三维理论框架，阐明以专业判断为核心的四源整合机制与知识动员四类核心策略"
type: argument
...
tags:
  ...
  - theme/research-use
  - theme/measurement-of-research-use
...
> |---|---|---|---|
> | **概念问题（1）** | 什么是证据知情实践（EIP）？有哪些不同理解？ | **主题一：EIP 的定义** | 语义分歧、EIP 四源整合界定、实践本位证据与多元证据观。 |
> | **应用问题（4）** | 证据知情学校或教师如何开展实践？哪些条件能促进进展？ | **主题二：EIP 的应用与知识动员条件** | 教师与领导者角色、组织与系统级基础设施、肥沃土壤培育。 |
> | **应用问题（5）** | 哪些策略能够实现有效的“知识动员”？促成或阻碍成功的因素为何？ | **主题二：EIP 的应用与知识动员条件** | 四类 KMb 策略（传播、能力建设、伙伴关系与网络、系统化方法）。 |
> | **概念问题（2）** | EIP 的相关成果是什么？我们如何概念化与识别这些成果？ | **主题三：相关成果与测量挑战** | 成果的情境性与多层级性、中间成果与长期成果的解构。 |
> | **概念问题（3）** | EIP 如何被有效测量？测量面临哪些伴随挑战？ | **主题三：相关成果与测量挑战** | 国际前沿测量倡议、调查工具开发、定性与定量多维测量及反单纯量化主义。 |
...
> | 模块 | 材料与处理方式 |
> |------|----------------|
> | **特刊导言（Special Issue Editorial）** | 作为 2017 年《Educational Research》（Vol. 59, No. 2）特刊的导言，系统综合特刊收录的 7 篇学术论文并展开宏观述评。（pp.127–135） |
> | **概念综合（Conceptual Synthesis）** | 围绕定义、应用（知识动员条件）、成果与测量三大主题，横向整合来自澳大利亚、加拿大、英格兰、荷兰与美国的实证与理论研究，并嵌入四十年来的宏观 EIP 谱系（Weiss, 1979; Hargreaves, 1996; Goldacre, 2013; Bryk, 2015 等）。（pp.127–133） |
> | **[[Analytic Framework\|分析框架（Analytic Framework）]]** | 将特刊 5 大征稿核心问题提炼为三大核心主题：EIP 的定义（问题 1）；EIP 的应用与[[Knowledge Mobilisation\|知识动员]]条件（问题 4–5）；相关成果与测量挑战（问题 2–3）。（pp.127–128） |
...
> | **课堂数据** | [[Formative Assessment\|形成性评估]]、课堂观察记录、学生作业表现与师生互动质性反馈。 | 反映微观教学现场即时动态，为差异化教学与过程性调整提供形成性依据。 | 容易过度依赖终结性测试，缺乏多源定性[[Triangulation\|三角验证]]。 |
> | **研究证据** | 经学术研究程序系统产出的知识，涵盖实证研究、理论综合与二阶[[Document\|文献]]。 | 提供普适性规律、干预机制解释与概率性效果参考，拓展教师认知视野。 | 脱离情境直接套用会导致教条化执行与实践水土不服。 |
>
...
> | **主导方法** | [[Randomised Controlled Trials\|随机对照试验]]（RCT）、严谨准实验与元分析 | 教师[[Action Research\|行动研究]]、专业学习共同体探究、课堂观察 |
...
> 2. **习惯依赖与适切性断裂** 经验表明，政策与实践两端均存在严重依赖熟知证据（well known）而非任务适切证据（appropriate to task）的认知惰性。
> 3. **可得证据 vs 适切证据** 借用 Earl & Timperley (2009) 的概念，明确区分可得证据（available evidence）与适切证据（appropriate evidence）；证据的适切性不能由外部统一预设，而必须结合具体政治、文化与教学情境进行动态研判。（pp.129–130）

> [!implication]- 推论：证据从单数走向复数的实践与政策后果
> 将证据内涵由狭隘的学术论文（单数）扩展为涵盖系统数据、课堂信息与实践知识的复合体（复数），彻底动摇了自上而下的线性证据输送模式；它要求将有效性探索的系统学习深度嵌入教育治理全过程（Becheikh et al., 2009; Gough, 2013; Sharples, 2013），为多维知识动员战略奠定了认识论基础。（pp.128–130）
...
> | **长期成果**<br>（Long-Term Outcomes） | **概念性成果**<br>（Conceptual Outcomes） | 研究证据潜移默化地重塑教育者的思维框架、[[Problem Finding\|问题界定]]方式与长远教育哲学观念。 | 表现隐蔽且渐进，需依托深度[[Qualitative Interview\|质性访谈]]与长周期[[Discourse Analysis\|话语分析]]进行识别。 |
