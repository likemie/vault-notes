---
summary: "以英格兰教育捐赠基金会（EEF）前八年实践为例，系统拆解在国家教育体系中快速扩展学校随机对照试验（RCT）、确立独立评估防火墙与透明注册标准的可行性，同时深度剖析实施与过程评估（IPE）整合、常态教学基线高企、测验外部效度危机、学校与教师选择替代设计以及规模化推广效应断崖衰减等方法学挑战"
type: argument
...
> [!question]
> 在国家教育体系中，国家级证据中介机构如何有效推动大规模学校[[Randomised Controlled Trials|随机对照试验]]（RCT）的制度化开展？在产生、规范与传播何种干预有效的实证证据过程中，中介机构面临哪些关于评估独立性、[[Implementation and Process Evaluation|实施与过程评估]]（IPE）、测量工具[[External Validity|外部效度]]、[[Business as Usual|常态教学]]对照基线以及大规模推广（scale-up）的核心方法学挑战？

> [!claim] 核心主张
> 英国[[Education Endowment Foundation|教育捐赠基金会]]（EEF）前八年的实践表明，依托独立资助与委托机制、严格的方案[[Preregistration|预注册]]及国家数据库链接，在单一国家快速推进大规模学校 [[Randomised Controlled Trials|RCT]] 并确立极高的透明度与独立性标准是完全可行的；然而，单纯追求头条因果[[Effect Size|效应量]]（ES）存在显著的方法学局限，必须向整合[[Implementation and Process Evaluation|实施与过程评估]]（IPE）、深化对[[Business as Usual|常态教学]]基线与真实成本的理解、探索多样化适应性设计（如[[School Choice|学校选择]]与教师选择），以及破解推广规模越大、效应量越趋近于零的规模化瓶颈演进。

> [!concept-lens] 阅读透镜
> - **对象** 英国教育捐赠基金会（EEF）自 2011 年创设至 2019/2020 年前八年间的循证资助体系与评估实践（覆盖英格兰逾 14,000 所学校与 150 多项 RCT）。
> - **张力** [[Causality|因果推断]]标准（高[[Internal Validity|内部效度]] RCT、追求统计功效的大样本）与基层复杂现实（项目可接受度、开发者与评估者利益冲突、[[Implementation Fidelity|实施保真度]]稀释、测验工具与全国统考脱节、常态对照组高水平教学常规）之间的实践张力。
> - **贡献** 从内部高级评估决策者视角系统解构了全球最具规模的[[Evidence-Based Education|循证教育]]试验资助机构的方法学演进逻辑，明确了从单一 RCT 走向[[Realist Evaluation|现实主义试验]]（realist trials）、过程机制深耕与多元研究设计的方法学方向。

---

## 理论框架

> [!framework-table] 理论与概念工具箱
> | 理论工具 | 解释功能 |
> |---|---|
> | **[[Evidence Ecosystem\|证据生态系统理论]]**<br>[[Evidence Ecosystem]] | 解释 EEF 如何突破传统研究机构单纯供给证据的线性模式，通过因果生成、通俗转译（工具包）与基层落地网络（[[Research Schools Network\|研究学校网络]]）双向培育证据供需关系。（pp. 47–49） |
> | **[[Realist Evaluation\|实在论评估框架]]**<br>[[Realist Evaluation]] | 提供超越黑箱因果分析的理论指引，强调因果效应是机制在特定情境中触发的结果，支撑 [[Randomised Controlled Trials\|RCT]] 整合[[Implementation and Process Evaluation\|实施与过程评估]]。（pp. 53–54, 57） |
...
> | 模块 | 材料与处理方式 |
> |---|---|
> | **机构案例研究**<br>[[Case Study]] | 以英国[[Education Endowment Foundation\|教育捐赠基金会]]（EEF）为单一[[Unit of Analysis\|分析单位]]，系统梳理其自 2011 年成立以来在英格兰基础教育体系中开展的循证资助演进历程与治理实践。（pp. 46–48） |
> | **评估管理档案与微观数据分析** | 汇总分析 EEF 资助的 150 余项 [[Randomised Controlled Trials\|RCT]] 试验、95 篇已发表独立评估报告、以及归档于[[National Pupil Database\|国家学生数据库]]（NPD）的 105 项完整试验数据集。（pp. 48–52） |
> | **国际政策与方法学横向对比** | 系统对比美国[[Institute of Education Sciences\|教育科学研究院]]（IES）[[National Center for Education Evaluation and Regional Assistance\|国家教育评估与区域援助中心]]（NCEE）支持的[[Investing in Innovation Program\|投资创新项目]]（i3）与 [[What Works Clearinghouse\|什么样的有效清算所]]（WWC）审查标准，辨析英美在独立评估机制与评级标尺上的异同。（pp. 50–51, 57） |

> [!sample-panel]- 样本与材料快照
> | 样本层面 | 构成 |
> |---|---|
> | **体系样本** | 英格兰公立学校体系共计 20,217 所学校、800 余万名学生及 45.3 万名全职教师。（p. 48） |
> | **卷入规模** | 截至 2020 年 3 月，超过 14,000 所学校（占英格兰公立中小学半数以上）及 158 万名儿童青少年参与 EEF 资助的[[Evaluation Research\|评估研究]]。（pp. 48–49） |
> | **试验样本** | 资助开展 150 余项 RCT，占过去十年全球已知教育试验的 19%；其中 70% 以上试验样本超过 1,000 人，平均试验规模逾 8,000 人。（p. 49） |
...
> ```mermaid
> flowchart LR
>     A["国家级循证需求与机构设立"] --> B["大规模学校 RCT 动员可行性确立"]
>     B --> C["独立三方契约、预注册与 NPD 归档治理"]
>     C --> D["引入 IPE 过程评估与国家统考外部效度锚定"]
>     D --> E["二阶证据合成与工具包决策转化"]
>     E --> F["常态教学高基线反思与证明无效价值"]
>     F --> G["规模化保真度稀释与多元准实验转向"]
> ```

---

### 论证步骤一　国家尺度的大规模学校 RCT 完全可行，且依托独立三方协议与全链条透明治理能有效根除利益冲突与发表偏倚

> [!claim] 步骤一核心主张
> [[Education Endowment Foundation|EEF]] 实践证实，在单一国家教育体系中快速规模化开展学校现场 [[Randomised Controlled Trials|RCT]] 具备高度可行性；通过组建评估者专家库、订立三方独立资助协议、强制实施统计分析计划（SAP）与方案[[Preregistration|预注册]]，以及建立[[National Pupil Database|国家学生数据库]]（NPD）纵向归档，能够有效破除传统教育研究中的利益冲突与[[Publication Bias|发表偏倚]]。（pp. 48–52）

#### 1. 内在专业声誉动员与外在经济补偿相协同，破除学校伦理阻力并将试验流失率控制在安全阈值

要确立国家尺度大规模教育试验的可行性，首要前提在于在实证层面击碎一线学校对“抛硬币[[Random Assignment|随机化]]”的伦理抵触与高[[Attrition|流失]]风险。（pp. 48–49）

> [!challenges] 大规模学校试验启动初期的制度与伦理屏障（Oakley, 2006; Styles & Torgerson, 2019）
> - **伦理禁忌假定** 传统学界断言对未成年学生进行[[Random Assignment|随机分配]]存在伦理禁忌，公立学校绝无可能自愿配合严格的对照试验。
...
> [!case] 动员机制创新：从 24% 早期高[[Attrition|流失]]到 EEF 研究伙伴学校认证
...
#### 2. 评估者专家库竞标与三方资助协议强制切断利益捆绑，彻底终结研发者自评偏倚

确立独立评估制度构成了防范利益冲突的第二道刚性支柱，其核心论证在于切断评估者对项目研发团队的学术与经济依附。（pp. 50–51）

> [!critique-fatal] 传统教育评估中的研发者自评偏倚机制（NRC, 2004; Ginsburg & Smith, 2016）
...
> | **资金拨付与管理** | EEF 分别与开发者、评估团队签订独立资助协议，直接管理评估款项 | 联邦资助款全部拨付给项目申报者，由其二次转拨和管理评估经费 |
> | **机构角色定位** | EEF 担任中立居间调解方，化解设计研商争议 | 评估者在经济上依附于项目受资助者，面临迎合资助者的隐性压力 |
> | **核心评估环节掌控** | 强制规定随机化分配、主数据采集、统计建模与报告撰写独家归属[[Evaluator Independence\|独立评估者]] | 仅要求至少一项结局指标由独立评估者采集或分析（97% 达标） |
> | **利益冲突核查** | 建立刚性冲突排查机制，禁止任何经济、产权或人际依附关联 | 制度上缺乏对评估机构与开发者潜在利益冲突的实质审查 |
> | **因果设计分布** | 89% 的已发表评估采用严格的 RCT 设计；85% 达到 3 锁以上（总流失率 $<30\%$） | 开发者更偏好准实验设计（[[Quasi-Experimental Designs\|QED]]）；19 项影响评估中仅约三分之二（13 项）达到 WWC 无保留标准（总流失率 $<55\%$） |
...
#### 3. 方案预注册、统计分析计划公开与 NPD 纵向归档消解发表偏倚，并倒逼出刚性统一建模指南
...
微观数据归档不仅支撑了独立可复现性审计，更直接倒逼出全行业统一建模标准的建立。（pp. 52–53）

> [!case] 杜伦大学利用 NPD 归档开展的 17 项试验四模型复算（Xiao et al., 2016）
> - **方法学分歧与数据黑箱背景** 在 EEF 成立初期的头三年中，各独立评估团队大多由来自全英不同高校的学者组成，各团队习惯沿用自身母学科的统计建模传统。有的团队采用简单的实验组与对照组后测均值对比，有的团队倾向于采用引入基线前测的回归模型，还有的团队使用复杂的层层嵌套模型，导致不同试验报告的效应量因底层统计假定不同而无法横向比较，动摇了循证汇总的科学根基。
> - **国家学生数据库（NPD）归档支持下的全量复算** 得益于 EEF 依托英格兰国家学生数据库（NPD）建立的微观试验档案库（覆盖 105 项完成试验的个体考分档案），杜伦大学学者齐·肖（ZhiMin Xiao）、[[Steve Higgins|史蒂夫·希金斯]]（Steve Higgins）与阿迪特·卡西姆（Adetayo Kasim）获得了对 17 项早期完成的 RCT 试验微观原始数据进行二次审计的机会。他们分别应用了四种主流统计模型进行全量并行复算：
>   1. [[Simple Difference in Means Model|简单均值差异模型]]；
>   2. 引入基线前测的普通[[Ordinary Least Squares|最小二乘回归模型（OLS）]]；
>   3. 校正学校与班级两级集群效应的[[Hierarchical Linear Model|多层线性模型（MLM / HLM）]]；
>   4. [[Generalized Estimating Equations|广义估计方程模型（GEE）]]。
...
### 论证步骤二　单维度效应量黑箱易将实施失败误判为理论无效，必须深度融合过程评估并锚定高外部效度的国家统考基准

> [!claim] 步骤二核心主张
> 单纯度量主指标效应量的黑箱 RCT 无法解释教育复杂干预的内在机制，易将现场执行不力误判为理论根本无效；必须将量化试验与[[Implementation and Process Evaluation|实施与过程评估]]（IPE）深度融合，并采用高[[External Validity|外部效度]]的标准化测量工具与二阶证据合成。（pp. 53–55）
...
> - **理论根本无效** 干预底层的[[Theory of Change|变革理论]]假设存在根本性硬伤；即便现场实现高保真度递送，亦无法在常态课堂中转化为学业增益。

全球教育试验中包含过程评估的比例仅为 38%（Connolly et al., 2018），早期 EEF 试验同样深陷因果黑箱；为此 EEF 将实施与过程评估（IPE）确立为刚性支柱，要求方案对照 [[TIDieR]] 清单系统解构要素（Humphrey et al., 2016; The EEF, 2019b）。（pp. 53–54）

> [!index-table] 实施与过程评估（IPE）六大核心核查维度（基于 Humphrey et al., 2016 与 EEF, 2019b，pp. 53–54）
> | 评估维度 | 核心核查内容 | 方法学支撑文献与工具要求 |
> |---|---|---|
> | **干预方案要素界定** | 明确界定干预的核心要素（Active Ingredients）、理论变革模型（[[Theory of Change\|Theory of Change]]）与不可替代的操作规程 | 对照 [[TIDieR]] 准则（Hoffmann et al., 2014）进行标准化解构，避免方案模糊不清。 |
> | **[[Implementation Fidelity\|实施保真度]]与适应性** | 评估教师在多大程度上忠实执行了原设计；识别基层学校做出的良性校本调试与破坏性执行偏离 | 依据 Durlak & DuPre (2008) 框架，通过课堂观察[[Coding in Qualitative Research\|编码]]与培训出勤追踪落地保真度。 |
> | **干预剂量与参与依从性** | 记录参与者实际接受干预的频次、时长与课时达标率；测量从意向性分析（[[Intent-to-Treat Analysis\|ITT]]）到实际处理的依从衰减 | 线上学习日志、签到表；在统计上采用工具变量[[Complier Average Causal Effect\|依从者平均因果效应]]（CACE）估计实际接受干预效应。 |
> | **对照组常态活动追踪** | 详尽调查对照组学校在实验期间开展的[[Business as Usual\|常态教学]]具体内容，排查是否存在自发竞品污染 | 对照组教师专项[[Questionnaire\|问卷]]与访谈，准确判定干预组相比于常态教学的真实净差异。 |
> | **因果机制与中介路径** | 检验理论预设的中介变量是否被干预激活；探究干预如何通过师生互动、认知或动机路径最终影响学业 | 过程测验、定性访谈；在模型中验证因果中介效应与[[Hypothesis\|假设]]路径。 |
> | **情境适应性与实施成本** | 探究不同生源背景、学段与学校文化对干预落地的制约；精确核算时间、物资与财政成本 | 财务审计、校长访谈，为工具包提供直观的成本分级参数。 |

过程评估的核心功能不仅在于采集定性反馈，更在于与量化统计模型有机嵌合，使黑箱试验演进为机制透明的严密求证。（p. 53）
...
> - **理论范式破局：区分“实施失败”与“理论根本无效”** 针对这一方法学死结，EEF 全面引进了英国医学研究理事会关于复杂干预评估的核心框架（Craig et al., 2008, p. 980）。该框架明确指出：教育项目具有高度的人际交互性与情境嵌入性，干预缺乏显著学业效应往往并非源于教学理论本身的根本无效，而是源于现场递送走样、教师培训稀释或初入校园的磨合期阻力等引发的实施失败。若缺乏对现场实施过程的微观度量，资助机构极易轻率裁汰本具潜力的前沿教学理论。
...
> |---|---|---|---|
> | **外部效度** | 极高（全国家长、高校与雇主公认的高利害学业基准） | 中等（具备一定跨校通用性，但与官方统考常模存在脱节） | 极低（高度特异化，无法推广至常态教学大纲） |
> | **效应量虚高风险** | 极低（客观独立评判，彻底杜绝教学贴合溢价） | 较低（非项目方自主掌控题目设定） | 极高（题目与干预要点同构，效应量平均虚高 50%–100%） |
> | **心理计量属性透明度** | 经过国家考试院超大样本校准，[[Reliability\|信度]]与效度极强 | 报告不全（多仅报告内部一致性 $\alpha$，预测效度偏低） | 通常未做严格效度检验，常模参照系缺失 |
> | **测验量程风险** | 分布良好，区分度充分 | 频发天花板效应与地板效应 | 针对干预难度定制，缺乏全量程区分力 |
> | **EEF 制度采纳态度** | **刚性首选**（要求主要结局指标优先绑定统考数据） | **严格限制**（须证明与国家统考高相关并接受审查） | **绝对禁止**（一律不得作为评价主要效应的合规工具） |
...
> - **测量工具库战略推进与经验镜鉴** 2014 年起，EEF 将资助领域从学科认知进一步拓展至学前教育与非认知领域（如[[Self-control|自我控制]]、心理韧性与社交情绪）。针对市场上非认知量表良莠不齐的严峻现实，EEF 委托曼彻斯特大学迈克尔·威格斯沃思（Wigelsworth, 2017）开展超大规模系统文献综述，正式构建了[[SPECTRUM|非认知与社会情感测量工具库]]（SPECTRUM，全称“社会、心理、情感、自我概念与韧性：理解与测量”），并同步启动全英学业[[Achievement and Aptitude Tests|成就测验]][[Systematic Review|系统综述]]，建立权威准入目录。实践表明：若资助机构在创立初期就前置建立严格的[[Scale of Measurement|标准化测量工具库]]，便能大幅避免数以百万英镑计的试错成本，为全球循证资助机构树立了关键方法学镜鉴。（p. 54）

确立了严密的因果机制与客观独立的测量基准后，单次试验[[Internal Validity|内部效度]]仍需通过二阶证据合成，方能转化为一线校长的实践决策工具。（pp. 54–55）

#### 3. 二阶证据合成与活态数据库消解研究异质性，以额外学习月数向基层校长提供直接决策支撑

单一试验的特定样本与微观情境无法直接推论出全系统的外部效度，系统综述与[[Meta-analysis|元分析]]构成了确立循证结论普适性的二阶合成基石（Shadish et al., 2002）。（pp. 54–55）

> [!challenges] 传统学术综述向一线实践决策转化的双重瓶颈（Shadish et al., 2002; pp. 54–55）
> - **专业术语壁垒与转化脱节** 传统学术综述篇幅冗长、统计术语晦涩，时间紧迫的中小[[School Leadership|学校领导]]难以直接提取可操作的决策参考。
> - **底层试验[[Heterogeneity|异质性]]与质量混杂** 混合不同研究质量、学段与国别的原始试验极易诱发严重的证据异质性，削弱二阶合成结论的客观性。

为解决实证研究与一线教育决策脱节的顽疾，EEF 构建了面向校长的通俗工具包与面向专业研究者的活态数据库双重载体。（pp. 54–55）

> [!row-contrast] 证据合成载体功能对比：《[[EEF Teaching and Learning Toolkit|教学与学习工具包]]》 vs 实时教育数据库
> | 考察维度 | 《[[EEF Teaching and Learning Toolkit\|教学与学习工具包]]》 | 实时教育数据库（EEF Education Database） |
> |---|---|---|
> | **构建底层** | 综合 30 余类通用教学策略底层的数千项[[Meta-analysis\|元分析]]与高质量实证研究 | 组织数十名专业编码员对工具包底层约 10,000 项独立试验进行逐一深度编码 |
> | **指标表达** | 独创额外学习月数（Months of Progress）、实施成本（£）与[[EEF Padlock Security Rating\|挂锁安全级别]] | 提取试验精确效应量、样本特征、干预实施时长、被试背景与微观测量参数 |
> | **目标功能** | 为时间紧张的中小学校长与高级管理团队提供一页纸式的直观排序决策支撑 | 构建全球首个动态活态证据库，实现全球最新教育试验成果的动态实时吸纳 |
> | **政策辐射** | 成为全英格兰超 70% 中学校长分配[[Pupil Premium\|学生津贴]]的法定参考指南 | 消除底层元分析中由于混合不同质量、学段与国别研究而引发的证据[[Heterogeneity\|异质性]]偏误 |

> [!warrant]- 步骤二论证逻辑收束：从黑箱因果效应向机制深耕与通俗决策的跨越
> 评估设计的演进证明：单纯追求表观效应量的[[Positivism|实证主义]]黑箱无法服务于复杂的教育实践。唯有以实施与过程评估（IPE）澄清因果链条并排除实施失败假象、以国家学生数据库（NPD）客观统考筑牢测量效度底线，并依托[[Meta-meta-analysis|二阶元分析]]与通俗转化工具包直接辅助基层，量化试验才能真正从单纯的学术证明工具演进为具有现实指导价值的循证决策支持体系。（pp. 53–55）

---

### 论证步骤三　微弱效应量源于常态教学高基线与规模化递送稀释，循证科学必须确立“证明无效”的同等价值并开辟多元准实验路径

> [!claim] 步骤三核心主张
> 面对极少有干预能显著超越[[Business as Usual|常态教学]]以及试验规模越大、效应量越趋近于零的实证挑战，循证运动必须跳出单一 RCT 迷思，深刻理解常态教学高基线与无效证据的实践价值，并探索[[School Choice|学校选择]]与教师选择的多样化适应性设计。（pp. 55–58）

#### 1. 宏观组织变革与日常微观决策不适宜强行随机化，必须依托自然变异转向严密的准实验与被试内设计

RCT 绝非全能的方法学灵丹妙药，强推随机化在特定决策层级面临坚硬的伦理阻力与操作瓶颈。（pp. 55–56）

> [!boundary] 随机对照试验（RCT）的两大方法学适用边界（Edovald & Firpo, 2016）
> - **宏观组织变革边界** 涉及学校核心治理体制、深层组织架构及家长敏感关切的宏观领域（如[[Tracking|能力分组]]、到校作息调整），强制抛硬币随机分组极易引发集体抗拒与招募瘫痪。
> - **教师日常微观决策边界** 属于教师日常教学微习惯（如电话家访、[[Homework|作业]]批改模式），不涉及采购外部手册化商业项目，经典跨校 RCT 周期过长且成本高昂。

面对不同层级的决策需求，必须建立因地制宜的多样化研究设计架构。（pp. 55–56）
...
> [!case] 宏观制度选择招募失败案例：能力分组与上课时间试验（Roy et al., 2014, 2018; Robinson, 2016）
...
> - **制度化转向：开辟“研究学校选择”准实验资助流** 这两起惨痛的招募灾难彻底打破了对单一 RCT 范式的教条崇拜。EEF 深刻认识到，评估宏观组织决策绝不能强行削足适履。2019 年，EEF 正式开辟了“[[Researching School Choices|研究学校选择]]”专属资助流。该资助流不再依赖人为随机化，而是充分利用英格兰教育生态中自然存在的政策演变与校本选择差异，依托国家学生数据库（NPD）庞大的纵向普查数据，采用回归断点设计（[[Regression Discontinuity Design|RDD]]）、[[Difference-in-Differences|双重差分法（DID）]]与[[Propensity Score Matching|倾向得分匹配（PSM）]]等严密的准实验设计（[[Quasi-Experimental Designs|QED]]）估算因果效应，使循证科学在学校宏观决策领域获得了全新的方法学生命力。（pp. 55–56）

除了学校层面的宏观组织架构，当微观经济学金钱奖惩机制强行引入校园日常教研时，同样遭遇了坚硬的职业伦理反弹。（p. 55）

> [!case] 教师激励与辅导试验（ICR）的伦理抵制与招募流产（Sutherland et al., 2017）
> - **微观经济学假设的校园移植** 受到国际发展经济学关于教师[[Performance Pay|绩效工资]]激励（如 Muralidharan & Sundararaman, 2011）积极成果的启发，EEF 资助了由 RAND 欧洲机构负责独立评估的“教师绩效工资激励与辅导试验”（简称 ICR 试验，Sutherland et al., 2017）。该研究旨在探索：在英格兰公立中学常态环境中，向接受[[Structured Teaching|结构化教学]]辅导且达成学生成绩增长目标的教师直接发放差异化经济奖金，是否能够显著激发教师教学效能并转化为学业提振。
> - **职业伦理反弹与教研文化排斥** 然而，试验方案在招募阶段遭遇了前所未有的强烈道德反弹与教师工会抵制。一线教职人员与校长普遍指出，在同一所学校、甚至同一个学科教研组内部，人为通过“抛硬币”式的随机化分配来决定哪些教师有资格争取奖金、哪些教师被剥夺奖励机会，在职业伦理上是极端不公的。这种做法被指责为将机械的外在金钱刺激强行植入校园，严重破坏了学校长期赖以维系的教师同行信任、专业协作与学术共同体文化，极易诱发教师之间的恶意防范与职业倦怠。
> - **招募全面溃败与《关闭报告》的制度化发布** 面对全英各学区公立学校的集体拒绝与抵制，参试教师与学校数量远远无法满足统计分析计划（SAP）预设的样本底线。在多轮动员努力均告失效后，EEF 果断终止该项目，并由评估团队出具了在循证领域极具警示意义的《招募失败因素分析与关闭报告》（Sutherland et al., 2017）。
> - **专业利他认同与可行性审查机制确立** ICR 试验的关闭成为教育评估领域的经典教案。它无可辩驳地证明：教育系统具有独特的专业文化，教师的行为决策深受内在专业自尊与利他动机（Tirole & Benabou, 2006）驱动，对粗暴的外部物质刺激具有天然的排异反应。违背教师职业伦理与团队协作生态的量化设计，必将在实践落地中遭遇坚硬的现实反弹。这一事件直接推动 EEF 建立了更为严格的前置干预可行性论证与参与者伦理可接受度审查机制。（p. 55）

组织与伦理边界界定了哪些领域不宜采用 RCT；而在适宜开展 RCT 的成套教学干预中，大量试验呈现的微弱效应量引发了深层的方法学论争。（pp. 56–57）

#### 2. 微弱效应量实质映射出常态教学的高质量基线，以严格量化试验“证明何者无效”具备巨大公共财政价值

针对英美教育试验平均效应量仅为 0.06、被指责“缺乏实质信息量”的严厉批评，EEF 从统计功效与教育生态两个维度展开了强力辩护。（pp. 56–57）

> [!evidence-grid] 对微弱效应量（d=0.06）与无效发现的方法学辩护（回应 Lortie-Forgues & Inglis, 2019，pp. 56–57）
> - **超大[[Effective Sample Size|有效样本量]]提升统计推断精度** 仅仅将头条效应量的置信区间宽度作为衡量标准是片面的；EEF 试验的[[Effective Sample Size|有效样本量]]翻番显著提升了统计功效，使微弱效应得以被高精度可靠识别（Sanders, 2019; Nevill, 2019a）。
> - **常态教学高水准基线构成严苛参照** 商业干预难以大幅超越对照组，关键在于英格兰学校现存的[[Business as Usual|常态教学]]本身已具备相当高的专业成熟度与教学质量，缺乏显著增益绝不等于干预本身毫无价值。
> - **证明何者无效具备重大公共财政价值** 循证运动的核心使命不仅在于证实何者有效，更在于明确告知学校何种做法徒劳无功，从而有效阻断商业培训噱头，防止公共教育经费在虚假神话中浪费。

超大[[Sample Size Determination|样本量]]带来的高精度统计推断，使试验能够对风靡全球的时髦教学流派进行客观去魅。（pp. 54, 57）

> [!case] 流行教学神话的严格去魅：[[Lesson Study|课例研究]]与[[Growth Mindset|成长型思维]]的零效应（Murphy et al., 2017; Foliano et al., 2019）
> - **神话一：日本“[[Lesson Study|课例研究]]”的大规模零效应（Murphy et al., 2017）** [[Lesson Study|课例研究]]源自日本，长期被[[International Education|国际教育]]界推崇为促进教师专业发展与教研协作的最理想范式。然而，EEF 资助开展的大规模两级集群 RCT（Murphy et al., 2017）为这一流行风尚带来了沉重的实证检验。过程评估（IPE）显示，干预组教师普遍对课例研究表达了极高的满意度与协作热情；然而，当评估团队以英国国家统考 Key Stage 4 / GCSE 的数学与阅读统考成绩作为客观主要结局指标，并严格校正基线前测协变量与集群标准误后，干预效应量净值为零（$ES \approx 0.00, p > .05$），没有任何统计学显著的学业增益。深入分析揭示，教师在主观协作层面的良好感受未能穿透至微观课堂认知互动，且密集研讨产生了挤占常态备课与个别辅导的负面时间替代效应。
...
> | **保真度损耗机制** | 教师疑问能得到即时矫正，核心要素执行度高 | 递送层级增加导致培训信息严重衰减，基层产生大量破坏性随意变异 |
> | **组织参与管理** | 样本规模小，项目方与学校保持高频互动，依从性得到充分保障 | 样本跨越数百所学校，沟通链条拉长，学校依从度急剧下降 |
> | **最终表观效应量** | 极易呈现显著的正向效应量（如阅读增加 2 个月进展） | 效应量普遍大幅缩水、甚至完全退化为统计学零结果（$d \to 0$） |

这种大样本规模化与实施保真度之间的内在撕裂，在多项耗资巨大的标杆性国家级试验中得到了触目惊心的印证。（p. 57）

> [!case] 效力试验到实效试验的断崖式衰减：[[Thinking, Doing, Talking Science|“思考、动手、对话科学”（TDTS）]]的大规模复制危机（Hanley et al., 2015 vs Kitmitto et al., 2018）
> - **小规模效力试验的显著提振** 在第一阶段由资助方与牛津布鲁克斯大学等开发团队紧密配合开展的效力试验中，[[Thinking, Doing, Talking Science|“思考、动手、对话科学”（TDTS）]]针对小学五年级科学课堂，通过探究性实验操作与高阶对话教学激发学生的科学思维。该试验覆盖牛津郡 42 所小学，开发团队原作者亲自全程驻场提供密集的[[School Inspection|教学督导]]与即时反馈。最终评估显示：TDTS 带来了显著的学业提升，干预组五年级学生的科学统考成绩相当于额外获得了约 3 个月的学习进展（效应量 $ES = +0.22, p < .05$），在享受免费学校午餐（FSM）的贫困弱势学生中，学业增益更是高达约 5 个月，展现出巨大的转化潜力。
...
> - **规模化脆弱性与递送稀释的机制反思** 结合实施与过程评估（IPE）的深度追踪，成效归零的深层结构性动因在于：在大样本统计功效要求与现场实施保真度之间存在不可回避的内在对抗。在小规模效力阶段，核心研发专家与少量参试教师保持高频互动，方案的精髓规程得以百分之百保真落地；但当项目在短时间内强行铺开至数百所学校时，提供方被迫在外部匆忙招募大量缺乏成熟经验的新培训师，采用多级“瀑布式”递送模式。培训信息层层衰减，加之基层学校日常繁杂行政事务的干扰，一线教师在常态课堂中严重简化了原本要求极高的深度对话与反思环节，干预退化为走形式的常规活动。世界卫生组织与 ExpandNet 网络（WHO & ExpandNet, 2009）的理论在此得到了残酷印证：规模化绝非简单的学校数量乘法累加，而是一场伴随着严重稀释风险的微观生态脆弱重构。（p. 57）
...
> | **对基层决策的适应** | 专为时间匮乏的中小学校长与教师定制，极大降低了统计学门槛 | 面向专业政策分析师与联邦采购官员，技术条文繁复晦涩 |
> | **内在方法学争鸣** | 将多元复杂偏倚压缩为单一分值，易掩盖不同偏倚维度的异质性 | 保持了方法学严格性，但阻碍了基层实践者的直观理解 |
> | **对待统计不确定性** | 正在反思学术界对 $p < 0.05$ 门槛的机械迷信与置信区间沟通难题 | 长期以假设检验显著性作为划分干预推荐等级的核心标尺 |

> [!warrant]- 步骤三论证逻辑收束：走向多元范式与理性审慎的第二代循证科学
> 循证实践的方法学反思彻底打破了“唯 RCT 独尊”的教条主义。极少干预能超越常态教学的现实，反向确证了学校常态教学的高水准基线，赋予了“证明何者无效”以重大的财政防损与科学去魅价值；而规模化递送中的保真度稀释与宏观制度的随机化抗拒，倒逼循证体系必须开辟准实验设计与微型试验等多元路径。唯有超越单一的头条效应量与机械的显著性阈值，将严谨因果推断、微观情境机制与[[Scientific Uncertainty|科学不确定性]]沟通相融合，才能构筑起兼具科学稳健性与实践适应力的第二代循证科学体系。（pp. 55–58）
...
> [!stat-cards]- 核心量化指标（pp. 48–56）
> - **20,217 所 / 800 万人** 英格兰公立中小学总数与在校学生总规模。
> - **14,000+ 所 / 158 万人** 截至 2020 年 3 月卷入 EEF 资助研究的学校与学生累计规模。
> - **150+ 项** EEF 资助的学校随机对照试验总数，占全球近十年教育 RCT 约 19%。
> - **70% vs 25%** EEF 试验中[[Sample Size Determination|样本量]]超过 1,000 人的比例，远超全球同类基准。
> - **24% 到 <30%** 早期平均流失率（24%）通过指南规范被控制在 30% 以内（85% 试验达 3 锁以上）。
> - **105 项** 关联[[National Pupil Database|国家学生数据库]]（NPD）的完整试验微观数据归档。
> - **d = 0.06 SD** 重新分析 141 项英美教育 RCT 得出的平均[[Effect Size|效应量]]（CI 平均宽度 0.30 SD）。

---

## 关键引用

> [!citation-card] 独立评估的制度隔离原则
> 随着研究进入总结性评估阶段，当评估者与设计团队过于紧密挂钩时，对偏倚的担忧便显而易见；但从历史上看，由项目开发者主导的评估却极其普遍。[[Education Endowment Foundation|EEF]] 从一开始便认识到确立独立评估先例的价值……强制规定[[Random Assignment|随机化]]分配、主要结局数据收集、统计分析与结果报告撰写必须全部由[[Evaluator Independence|独立评估者]]主持完成。（p. 50）
>
...
> [!citation-card] [[Realist Evaluation|现实主义试验]]与情境机制互动
> 现实主义试验要求分别以及组合检验干预组件的成效；采用多臂研究与[[Factorial Design|析因设计]]；探索变化机制，例如分析路径[[Variable|变量]]如何中介干预效果；利用跨越多种情境的多次试验来检验干预成效如何随情境发生变异。（Bonell et al., 2012, p. 2299, 引用见 Edovald & Nevill, 2021, pp. 53–54）
>
> *Examine the effects of intervention components separately and in combination; using multi-arm studies and factorial trials; explore mechanisms of change, for example analysing how pathway variables mediate intervention effects; use multiple trials across contexts to test how intervention effects vary with contexts.*

> [!citation-card] 常态对照基线与无效证据的实践价值
> What Works 运动不仅要能指出什么有效，更必须明确什么无效，因为耗费在低效做法上的公共资源本可用于更需要的地方。绝大多数流行项目并不显著优于学校正在开展的[[Business as Usual|常态教学]]，这一信息极具价值；而缺乏干预影响恰恰可能反映了常态教学本身的高质量。（p. 57）
>
...
> [!citation-card] [[EEF Padlock Security Rating|挂锁安全评级]]与不确定性沟通挑战
> 尽管用单一标尺总结头条结果的质量可能存在争议，但这代表了一项重要的努力，旨在让时间匮乏的一线实践者尽可能容易地获取证据，从而更好地用证据指导教学。当前分析与报告实践中存在的基础性问题加剧了传播挑战：学术界仍存在对 p 值和显著性检验的误解，以及在接纳不确定性与报告[[Confidence Interval|置信区间]]方面的不足。如何在充分报告不确定性与向终端用户传达可操作成果之间取得平衡，是长期的关键挑战。（pp. 57–58）
>
> *While it might be controversial to summarize the quality of a headline finding in a single scale, it represents an important attempt to make evidence as accessible as possible to time-poor practitioners, so that they can better use it to inform their practice... An ongoing challenge for the EEF is to balance the adequate reporting of uncertainty with the need to communicate actionable results to end users.*
...
> [!warning]
> - **机构行动者的内在视角局限** 论述基于 [[Education Endowment Foundation|EEF]] 评估部门主管与执行人员在机构内部工作与决策的直接经验，带有内部行动者的观察视角与经验边界。（p. 58）
> - **[[Publication Bias|发表偏倚]]的外部再发生风险** 尽管 EEF 实行了无条件全量公开报告制度，但当项目遭遇零结果时，外部开发者仍可能绕开 EEF 另行在学术期刊发表粉饰后的积极结果，基金会在评估周期结束后对此类外部再发表缺乏实质约束力。（p. 52）
> - **[[EEF Padlock Security Rating|挂锁安全评级]]的单指标争议** 挂锁评级将复杂的研究质量、[[Attrition|流失]]风险与效度威胁压缩为单一维度的序数评分，在学术界存在简化方法学复杂性与忽视[[Confidence Interval|置信区间]]精度的争议。（p. 57）
> - **[[Randomised Controlled Trials|RCT]] 设计对特定政策问题的局限** 大规模学校 RCT 无法回答学校拒绝[[Random Assignment|随机分配]]的宏观组织变革（如能力分班、上课时间调整）以及教师日常微观决策（如[[Homework|作业]]批改方式），替代性设计（[[School Choice|学校选择]]与教师选择）仍处于机制探索与试点阶段。（pp. 55–56）
