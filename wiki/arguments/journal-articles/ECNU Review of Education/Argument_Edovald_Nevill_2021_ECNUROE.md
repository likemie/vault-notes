---
summary: "以英格兰教育捐赠基金会（Education Endowment Foundation, EEF）前八年实践为例，系统拆解在国家教育体系中快速扩展学校随机对照试验（Randomised Controlled Trial, RCT）、确立独立评估防火墙与透明注册标准的可行性，同时深度剖析实施与过程评估（Implementation and Process Evaluation, IPE）整合、常态教学基线高企、测验外部效度危机、学校与教师选择替代设计以及规模化推广效应断崖衰减等方法学挑战"
type: argument
subtype: journal-article
publication_type: journal-article
title: "Argument_Edovald_Nevill_2021_ECNUROE"
...
sources:
  - "[[sources/Edovald_Nevill_2021_ECNUROE|Edovald_Nevill_2021_ECNUROE]]"
confidence: high
status: completed
created: 2026-09-14
updated: 2026-09-18
...
> | **评估管理档案与微观数据分析** | 汇总分析 EEF 资助的 150 余项 [[Randomised Controlled Trials\|RCT]] 试验、95 篇已发表独立评估报告、以及归档于[[National Pupil Database\|国家学生数据库]]（National Pupil Database, NPD）的 105 项完整试验数据集。（pp. 48–52） |
> | **国际政策与方法学横向对比** | 系统对比美国[[Institute of Education Sciences\|教育科学研究院]]（Institute of Education Sciences, IES）[[National Center for Education Evaluation and Regional Assistance\|国家教育评估与区域援助中心]]（National Center for Education Evaluation and Regional Assistance, NCEE）支持的[[Investing in Innovation Program\|投资创新项目]]（Investing in Innovation, i3）与[[What Works Clearinghouse\|有效清算所]]（What Works Clearinghouse, WWC）审查标准，辨析英美在独立评估机制与评级标尺上的异同。（pp. 50–51, 57） |
...
> [!claim] 步骤一核心主张
> [[Education Endowment Foundation\|EEF]] 实践证实，在单一国家教育体系中快速规模化开展学校现场 [[Randomised Controlled Trials\|RCT]] 具备高度可行性；通过组建评估者专家库、订立三方独立资助协议、强制实施[[Statistical Analysis Plan\|统计分析计划]]（Statistical Analysis Plan, SAP）与方案[[Preregistration\|预注册]]，以及建立[[National Pupil Database\|国家学生数据库]]（NPD）纵向归档，能够有效破除传统教育研究中的利益冲突与[[Publication Bias\|发表偏倚]]。（pp. 48–52）
...
> [!case] 动员机制创新：从 24% 早期高[[Attrition\|流失]]到 EEF 研究[[Partnership Schools Kura Hourua\|伙伴学校]]认证
...
> | **因果设计分布** | 89% 的已发表评估采用严格的 RCT 设计；85% 达到 3 锁以上（总流失率 $<30\%$） | 开发者更偏好[[Quasi-Experimental Designs\|准实验设计]]（Quasi-Experimental Designs, QED）；19 项影响评估中仅约三分之二（13 项）达到 WWC 无保留标准（总流失率 $<55\%$） |
...
> - **官方独立评估的零结果判决** 经过严格的全样本追踪与[[Covariate Adjustment\|协变量调整]]，独立评估团队最终发布了权威报告：该同行观察项目对学生普通中等教育证书（General Certificate of Secondary Education, GCSE）全国统考的数学与英语成绩均未产生统计学显著的积极促进作用，效应量点估计值紧密贴近于零（$ES \approx 0.00, p > .05$），证实该干预在[[Business as Usual\|常态教学]]条件下未能带来实质性学业附加值。依据强制全量公开原则，该零结果报告被无条件公布于 EEF 官网。
...
> - **发表偏倚防范边界与预注册权威基准** 该典型案例深刻揭示了即便建立了最严格的独立评估隔离墙，研发者为迎合学术锦标赛与商业推广而制造外部[[Publication Bias\|发表偏倚]]的风险依然顽固存在。它有力证明了强制方案预注册（[[ISRCTN\|国际标准随机对照试验编码]]平台，International Standard Randomised Controlled Trial Number, ISRCTN）与无条件公开独立评估报告的基石价值：若无官方独立报告作为公开锚定基准，决策者与学校管理层极易被研发者筛选发表的外部期刊论文所误导。EEF 为此在立项协议中增设了“期刊投稿前由基金会先行技术审查”的刚性条款，以制度化手段捍卫因果证据的纯洁性。（pp. 51–52）
...
> - **方案预注册与 ISRCTN 登记** 借鉴[[Clinical Trial\|临床试验]]规范，试验开展前必须公开发布预先制定的评估方案与[[Statistical Analysis Plan\|统计分析计划]]（SAP），并在国际标准随机对照试验[[Coding in Qualitative Research\|编码]]平台（ISRCTN）完成登记。
> - **CONSORT 报告标准全面推行** 基于试验报告统一标准（Consolidated Standards of Reporting Trials, CONSORT）制定模板，深度对接社会与心理干预扩展版（Consolidated Standards of Reporting Trials - Social and Psychological Interventions, [[CONSORT-SPI]]）标准，无论成效显著与否，所有评估报告均无条件全量公开（Nevill, 2016; Montgomery et al., 2018）。
...
>   2. 引入基线前测的普通[[Ordinary Least Squares\|最小二乘回归模型]]（Ordinary Least Squares, OLS）；
...
全球教育试验中包含过程评估的比例仅为 38%（Connolly et al., 2018），早期 EEF 试验同样深陷因果黑箱；为此 EEF 将实施与过程评估（IPE）确立为刚性支柱，要求方案对照干预描述与复现模板（[[TIDieR|Template for Intervention Description and Replication]], TIDieR）清单系统解构要素（Humphrey et al., 2016; The EEF, 2019b）。（pp. 53–54）
...
> | **干预剂量与参与依从性** | 记录参与者实际接受干预的频次、时长与课时达标率；测量从[[Intent-to-Treat Analysis\|意向性治疗分析]]（Intent-to-Treat, ITT）到实际处理的依从衰减 | 线上学习日志、签到表；在统计上采用工具变量[[Complier Average Causal Effect\|依从者平均因果效应]]（Complier Average Causal Effect, CACE）估计实际接受干预效应。 |
...
> [!claim] 步骤三核心主张
> 面对极少有干预能显著超越[[Business as Usual\|常态教学]]以及试验规模越大、效应量越趋近于零的实证挑战，循证运动必须跳出单一 RCT 迷思，深刻理解常态教学高基线与无效证据的实践价值，并探索[[School Choice\|学校选择]]与[[Teacher Choices\|教师选择]]的多样化适应性设计。（pp. 55–58）
...
> - **制度化转向：开辟“研究学校选择”准实验资助流** 这两起惨痛的招募灾难彻底打破了对单一 RCT 范式的教条崇拜。EEF 深刻认识到，评估宏观组织决策绝不能强行削足适履。2019 年，EEF 正式开辟了“[[Researching School Choices\|研究学校选择]]”专属资助流。该资助流不再依赖人为随机化，而是充分利用英格兰教育生态中自然存在的政策演变与校本选择差异，依托国家学生数据库（NPD）庞大的纵向普查数据，采用回归断点设计（[[Regression Discontinuity Design]], RDD）、[[Difference-in-Differences\|双重差分法]]（Difference-in-Differences, DID）与[[Propensity Score Matching\|倾向得分匹配]]（Propensity Score [[Matching]], PSM）等严密的准实验设计（QED）估算因果效应，使循证科学在学校宏观决策领域获得了全新的方法学生命力。（pp. 55–56）

除了学校层面的宏观组织架构，当微观经济学金钱奖惩机制强行引入校园日常教研时，同样遭遇了坚硬的职业伦理反弹。（p. 55）

> [!case] [[Incentivised Pay and Coaching Trial\|教师绩效激励与辅导试验]]（Incentivised Pay and Coaching Trial, ICR）的伦理抵制与招募流产（Sutherland et al., 2017）
> - **微观经济学假设的校园移植** 受到国际发展经济学关于教师[[Performance Pay\|绩效工资]]激励（如 Muralidharan & Sundararaman, 2011）积极成果的启发，EEF 资助了由兰德欧洲机构（RAND Europe）负责独立评估的“[[Incentivised Pay and Coaching Trial\|教师绩效激励与辅导试验]]”（Incentivised Pay and Coaching Trial, ICR；Sutherland et al., 2017）。该研究旨在探索：在英格兰公立中学常态环境中，向接受[[Structured Teaching\|结构化教学]]辅导且达成学生成绩增长目标的教师直接发放差异化经济奖金，是否能够显著激发教师教学效能并转化为学业提振。
...
从效力试验向[[Effectiveness Trial|实效试验]]推进的过程中，干预效果的大幅缩水是国际循证科学普遍面临的严峻规律。（p. 57）

> [!tension-table] 统计功效大样本诉求与现场实施保真度稀释的内在张力（基于世界卫生组织 [World Health Organization, WHO] & ExpandNet, 2009 与 Edovald & Nevill, 2021）
...
> 4. **常态基线高企与规模化稀释催生多元设计转型** 商业干预平均效应微弱（$d=0.06$）反映了[[Business as Usual\|常态教学]]的高基线，而规模化推进极易因培训稀释而丧失效应；未来亟需转向[[Realist Evaluation\|现实主义试验]]及学校与[[Teacher Choices\|教师选择]]的差异化设计。（pp. 55–57）
...
> - **d = 0.06 SD** 重新分析 141 项英美教育 RCT 得出的平均[[Effect Size\|效应量]]（CI 平均宽度 0.30 个标准差 [Standard Deviation, SD]）。
...
> 复杂教育干预需要深入理解[[Causal Processes\|因果过程]]。英国医学研究理事会指出：必须对干预如何引发改变具备扎实的理论理解；干预缺乏效果可能反映的是实施失败（或磨合期问题），而非干预策略本身的根本无效。正因如此，EEF 颁布了《EEF 评估者[[Implementation and Process Evaluation\|实施与过程评估]]指南》（Implementation and Process Evaluation Guidance for EEF Evaluators; The EEF, 2019b），重点加强理论检验、成效与过程整合及依从性测量。（p. 53）
>
...
> - **[[Randomised Controlled Trials\|RCT]] 设计对特定政策问题的局限** 大规模学校 RCT 无法回答学校拒绝[[Random Assignment\|随机分配]]的宏观组织变革（如能力分班、上课时间调整）以及教师日常微观决策（如[[Homework\|作业]]批改方式），替代性设计（[[School Choice\|学校选择]]与[[Teacher Choices\|教师选择]]）仍处于机制探索与试点阶段。（pp. 55–56）
