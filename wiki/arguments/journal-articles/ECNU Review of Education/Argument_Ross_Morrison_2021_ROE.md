...
3. 证据运动确实带来好处：[[Praxis|实践]]者更关心可信研究，WWC and Evidence for ESSA 扩展了证据可及性，州和学区也开始用证据标准审查项目(p.110)。
...
9. 因此，正式证据审查若只报告[[Effect Size|效应量]]和显著性，就会遗漏实践决策的关键维度。Ross and Morrison 建议证据审查应加入实施要求、成本、情境特征、研究限制和用户经验，否则实践者会继续绕开正式证据来源(p.121)。
