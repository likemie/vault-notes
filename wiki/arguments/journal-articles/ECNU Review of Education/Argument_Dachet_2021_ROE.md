...
八个工作组列出的 425 个工具/项目中，只有 61 个曾被教育研究者测试，只有 13 个约 3% 采用实验设计（Dachet & Baye, 2021, p.175）。如果直接套用 [[Education Endowment Foundation|EEF]]、[[What Works Clearinghouse|WWC]] 或 [[Best Evidence Encyclopedia|BEE]] 那类较强的证据层级，几乎 97% 的本地候选工具会被排除，这在科学上可辩护，却在政治和专业协作上难以实施（Dachet & Baye, 2021, pp.175-176）。
