...
> [!question]
> 学生的科学知识确定性信念（认为科学理论是绝对确定、不可改变的永恒真理）能否在严格控制一般认知推理能力（General Cognitive Ability，$g$ 因子）、性别与家庭社会经济地位（Socioeconomic Status，SES 及[[Cultural Capital\|文化资本]]）的前提下，独立预测其中学[[Academic Achievement\|学业成就]]？同时，不同大学专业门类学生之间显著的[[Epistemological Beliefs\|认识论信念]]分化，究竟是由进入大学前的“自我选择效应”（Self-Selection Effect）所致，还是由大学专业环境长期浸润的“[[Disciplinary Socialization\|学科社会化]]效应”（Disciplinary Socialization Effect）所致？
...
> [!concept-lens] 阅读透镜
> - **对象** 德国巴登-符腾堡州 90 所代表性高级文理中学（Gymnasium）高三毕业生在高中毕业阶段（Time 1，T1，样本量 Sample Size $N = 2854$）及其在升入全德近百所高校两年后的大学追踪阶段（Time 2，T2，$N = 1094$）的队列（中等教育转型与学术职业追踪项目 [[TOSCA\|Transformation of the Secondary School System and Academic Careers]]，[[TOSCA]]）。
...
> - **贡献** 首次基于大规模代表性两波纵向追踪数据，运用潜变量结构方程模型（Structural Equation Modeling，[[Causal Modeling\|SEM]]）确立了确定性信念对学业表现的独立净效应与中介机制，并从纵向因果面板上证实了学科专业分化中的“先验自我选择—后继学科社会化”复合发展机制。
...
> [!claim] 确定性信念与[[Academic Achievement\|学业成绩]]及背景[[Variable\|变量]]呈显著负相关
...
>   - **认知能力与毕业成绩（$r = .33$）** 中等强度的正相关，说明一般智力与推理能力仍然是[[Academic Achievement\|学业表现]]最强劲的基础预测源。
>   - **家庭 SES 与文化资本（$r = .52$）** 高度正相关，表明父母职业地位高的家庭，其家庭文化资源（藏书量）也普遍更丰富。
> - **潜变量（Latent Variable）校正测量误差** 人类的认知观念与家庭背景无法像身高体重那样被无误差直接测量。如果使用普通[[Questionnaire\|问卷]]均分，测量误差会把真实的相关性“稀释”（即所谓的衰减效应）。本研究在统计模型中通过多个题目构建潜变量，剥离了随机测量误差，测得的是更接近真实的内在特质关联。
> - **为什么不能直接用相关推断因果？** 由于认知能力（$r = -.18$）和家庭文化资本（$r = -.17$）本身就与确定性信念负相关，这就产生了一个经典的“第三变量陷阱”——究竟是“确定性信念阻碍了成绩”，还是仅仅因为“聪明、家里书多的学生既不迷信确定性、又本来就能考高分”？要回答这一疑问，必须使用能同时控制多个变量的结构方程模型（[[Causal Modeling\|SEM]]）。
...
> 大学专业训练对学生的认识论信念具有显著的[[Disciplinary Socialization\|学科社会化]]塑造效应；在严格控制了 T1 初始信念水平后，工科与商科环境仍持续强化学生的确定性信念，而人文与社会科学环境则加速解构确定性信念，证实了学科社会化假说。（p.361）
...
>   2. **Model 2（大学就读 T2，横截面现状模型）** 在大学二年级进行[[Cross-sectional Study\|横截面调查]]时，工科学生的系数高达 $b = 0.63$。但这无法直接证明是大学教出来的，因为他们入学前信念本来就高。
>   3. **Model 3（纵向追踪控制模型，社会化塑造模型）** 这是最具因果解释力的核心模型。统计上**把高中毕业时的初始信念（T1 确定性信念）作为自变量强行纳入控制**。此时各学科的回归系数反映的是排除了生源初始差异后，大学两年间信念的“净变化量”：
>      - 工科（$b = 0.40, p < .001$）和商科（$b = 0.22, p < .05$）的系数依然显著为正！这证明：即使控制了入学前的先验偏好，工科和商科两年的大学训练仍持续把学生推向更笃信确定真理的立场（学科社会化效应）。
...
> 帮助学生建立成熟的认识论信念系统本身就是一项核心的教育终极目标。在课堂或讲堂上直面知识的不确定性，不仅不会削弱学生对科学的信任，反而能解除“寻求确定标准答案”对[[Higher-Order Thinking Skills\|高阶思维]]的禁锢：持有成熟非确定性信念的学生更倾向于采用深层精加工策略（Elaboration），在面对未定课题时展现出更强的认知韧性与跨学科批判力，进而为其长期的学术探究与创新实践提供底层认知动能。（p.362）
...
> [!finding-cards] 核心发现
> 1. **确定性信念净负向预测高中毕业[[Academic Achievement\|学业成就]]** 在严格控制认知能力、家庭 SES 和[[Cultural Capital\|文化资本]]后，科学知识确定性信念对高中毕业总评成绩仍具有显著负向预测力（标准化路径系数 Standardized Path Coefficient $\beta = -0.15$），并部分中介了智力与文化资本的学业效应。（p.358）
> 2. **大学专业选择存在显著的先验自我选择效应** 高中毕业生在选择未来专业时已表现出[[Epistemology\|认识论]]分化，未来攻读工科（未标准化回归系数 $b = 0.38$）、商科（$b = 0.33$）、自然科学（$b = 0.39$）和医学（$b = 0.38$）的学生其确定性信念显著高于人文艺术类学生。（p.360）
> 3. **大学专业环境发挥了显著的[[Disciplinary Socialization\|学科社会化]]塑造效应** 在控制 T1 初始信念后，大学工科（$b = 0.40$）与商科（$b = 0.22$）学习显著强化了知识确定性信念，而人文与社会科学学习（$b = -0.26$）则进一步瓦解了确定性信念，拉大了软硬学科间的认识论鸿沟。（p.361）
...
> 帮助学生建立关于人类知识的成熟信念系统，其本身就是一项重要的教育目标，同时也是提升[[Academic Achievement\|学业成就]]的重要途径。如果课堂或讲堂上使用的教学材料能够体现人类知识的暂时性与未定性，这一目标就更有可能实现。（p.362）
>
...
> 1. **测量维度的局限性** 仅测量了[[Epistemological Beliefs\|认识论信念]]中关于“知识本质”的“确定性”单一维度，未涵盖认识论信念的其他维度（如知识结构、[[Source of Knowledge\|知识来源]]、辩护方式），且仅采用了领域一般性（Domain-General）测量，未能整合[[Domain Specificity\|领域特殊性]]（Domain-Specific）量表。
> 2. **微观中介机制未直接检验** 研究虽然证实了确定性信念对成绩和专业选择的宏观因果效应，但未直接测量大学课堂微观教学环境、动机以及具体学习策略在其中的动态中介过程。
> 3. **自陈式量表的方法学限制** 采用自陈式[[Questionnaire\|问卷]]虽然适合大规模代表性抽样，但相比于基于复杂真实任务的个别化[[Reflexivity\|反思性]]判断访谈（[[Reflective Judgment Model\|Reflective Judgment]] Interview，RJI），在探测个体深层[[Epistemology\|认识论]]推理过程上存在[[Ecological Validity\|生态效度]]（Ecological Validity）不足的可能。
