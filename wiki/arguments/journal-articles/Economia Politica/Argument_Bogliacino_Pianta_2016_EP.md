...
作者通过三个层次的实证检验论证了修订的合理性，每一层都比上一层更深入：
...
> [!line-a] 服务业分类的指标验证
> 归入 SB 的服务业（通信、计算机、研发）拥有最大的研发密集度（每员工 $0.72$、$2.40$、$7.9$ 千欧元）和最高的创新产品占比（$24\%$、$27\%$、$36\%$）。归入 SII 的服务业（金融中介、保险、金融辅助）拥有服务业中最高的设备支出（每员工 $0.76$、$1.34$、$2.35$ 千欧元）。归入 SS and SD 的服务业同样在创新指标上与对应制造业类别保持一致（pp.165-167）。
