...
> [!stat-cards]+ 一页读懂
> - **对象**：三轮社区创新调查（社区创新调查（Community Innovation Survey，CIS） 2、3、4），覆盖 7 个欧洲国家和挪威，22 个制造业和 17 个服务业两位数 NACE 行业
...
> | **时间跨度** | [[Centre for Independent Studies\|CIS]] 2、3、4 三轮调查（每轮覆盖当年及前两年） |
...
Pavitt（1984）基于对英国 SPRU 创新数据库中制造业企业的系统分析，按照三个维度——**创新来源**（内部研发 vs 外部供应商）、**创新类型**（产品 vs 流程）和**企业特征**（规模和技术强度）——将制造业划分为四个类别。每一类代表了创新如何在产业中"发生"的一种根本不同的方式：
...
> 生产资本品（设备和仪器）供给其他行业使用。核心特征是创新通过**设计改进**和**与客户的持续互动**产生，而非通过正式的研发项目。企业通常为中小企业，研发密集度中等偏高，但创新的关键投入是专业知识和工程能力而非大规模的研发支出。
>
...
> 创新嵌入在大规模生产流程中，**规模经济**是核心驱动力。创新既包括流程创新（通过持续改进降低单位成本）也包括产品创新（渐进式改进而非根本性突破）。企业以大企业为主，通常运营连续流程或大规模装配线。
>
...
> 内部研发能力最弱，创新主要由**设备和材料供应商**引入。创新多为流程改进——通过采用供应商开发的新设备和材料来降低成本和提升效率——而非自主产品创新。企业通常为小企业，在高度竞争的市场中运营。
>
...
Bogliacino 和 Pianta（2016）通过三个层面的实证检验论证了修订的合理性：

> [!line-a] 主成分分析：检验分组有效性
> 对创新来源[[Variable|变量]]（内部研发、外部知识获取、设备投资）和创新目标变量（产品创新、流程创新）进行主成分分析，比较不同分组方案（原始 Pavitt 分组 vs 替代分组）下各组[[Internal Consistency and Cronbach's Alpha|内部一致性]]和组间差异。结果表明 Pavitt 分组在降低组内变异、保留组间差异方面优于[[Random Assignment|随机分组]]和单一维度分组（pp.165-170）。

> [!line-a] 回归分析：检验创新-绩效关系
> 以创新投入（研发强度、设备投资强度）和创新产出（新产品占比、专利数）为自变量，以经济绩效（生产率、就业增长）为因变量，加入 Pavitt 类别虚拟变量及其与创新变量的交互项。结果确认不同 Pavitt 类别在创新投入如何转化为经济绩效方面存在显著且系统性的差异——这证明了分类法不仅仅是描述工具，还具有**因果解释力**（pp.170-175）。

> [!line-a] 跨国家与跨时间稳健性
> 在七个国家和三轮 社区创新调查（Community Innovation Survey，CIS） 调查中分别运行相同模型，Pavitt 分类的核心结构——科学基础型在产品创新和专利上的优势、供应商主导型对设备投资的依赖、规模密集型在流程创新上的偏向——在所有国家和时间段上保持一致。唯一的系统性变化是 ICT 密集型服务业的崛起使得原"规模密集型"定义不再充分（pp.170-175）。
