...
> 2. **可合并性假设**：两个或更多不同研究的效应量可以被合并，产生对该类别干预教育显著性的有意[[Rightness|义]]的估计
>
> 论文的核心论证是：这两项假设均不成立。
>
> ### 3. 违反假设的三个系统性偏差来源
...
>
> 测量设计通过两个渠道影响效应量：**聚焦度**（focus）和**[[Jing (Refined Mastery)|精]]确度**（precision）（Simpson, 2017, pp.11–14）。
>
...
> - **仅在同一比较组、同一样本范围、同一测量工具和同一分析的极端条件下，合并效应量才具有意[[Rightness|义]]**——"在现实中，这种直接复制和比较并不会发生，也不是'证据本位政策'的基础"（Simpson, 2017, p.15, citing Simpson 2019）
