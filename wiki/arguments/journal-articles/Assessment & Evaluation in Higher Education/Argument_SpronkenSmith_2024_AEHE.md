...
> [[Questionnaire|问卷调查]]数据显示，博士生在读期间的能力发展呈现出显著的“研究者偏向”：研究技能（均值为 4.4）、分析技能（均值为 4.4）、学术严谨性（均值为 4.3）、学习意愿（均值为 4.2）等直接与开展研究相关的特质发展得分最高（pp. 89–90, Figure 1）。相比之外，与人协作及社会关联度较高的特质发展得分极低，如环境素养（均值为 2.8）、团队合作（均值为 2.9）、实施变革的技能（均值为 3.1）（p. 89）。这反映了博士培养活动和课程资源高度向学术研究技能倾斜的现状（p. 91, Table 2）。
...
> 虽然全球公民属性（如环境素养、文化理解、全球视野）的发展得分和职场应用评分均偏低，但访谈表明学生普遍认可其重要性，倾向于将其视为融入具体学科日常实践中的隐性成分，而非脱离学科单独开设的课程（p. 96）。鉴于这些核心能力的脱节，需要建立一个更具系统性的评估框架，将毕业生特质整合为七个维度：知识、研究、沟通、人际技能、[[Higher-Order Thinking Skills|高阶思维]]、个人资源丰富性（包含职业生涯管理）和全球公民素养，以实现博士培养质量的系统提升与评估（p. 98, Table 5）。
> 
