...
> 筛选流程：SSCI and Scopus 数据库检索，初始 2,199 篇，去重后 1,754 篇，摘要与结论初步筛选后 625 篇，全文下载并二次筛选，排除不回应研究问题的 18 篇，最终纳入 **85 篇**。二次筛选标准：（1）全文可下载；（2）聚焦 PISA 对教育政策的影响；（3）聚焦基础教育阶段。
