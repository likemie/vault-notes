...
> [!claim] 核心主张
> PISA 通过追求教育质量、数据驱动的比较分析和循证[[Paradigm|研究范式]]，推动全球教育质量与公平的政策讨论。PISA 的影响远超其最初测量国家间教育质量的功能，通过软治理深刻影响全球教育治理格局。这一影响机制并非 [[OECD]] 到国家的线性传递，而是在**超国家组织**（软治理与[[Reference Society in Education|模范社会]]塑造）、**国家层面**（自我认知落差、文化-制度[[Transfer Translation Transformation|转译]]与[[Policy Borrowing|政策借用]]）和**内部行动者网络**（政策制定者、政党、协会、媒体的信息诠释与传递）三个层级的**双向互动**中实现的。
...
> | **[[Actor-Network Theory\|行动者网络理论]]** | 将权力视为与知识、主体地位和参与者身份交织的治理网络。Sellar & Lingard（2018）指出政治情感（political sentiment）是[[Theories of Policy Change\|政策变革]]的重要杠杆；情感理论框架和批判话语分析有助于分析文本材料中的支配、权力和控制结构关系。 |
...
> | 模块 | 材料与处理方式 |
> |------|----------------|
> | **系统综述**<br>[[Systematic Review]] | 按照 PRISMA 框架执行（Newman & Gough, 2020; Xiao & Watson, 2019）。系统综述作为独立研究方法，通过严格定义的检索策略、[[Document\|文献]]筛选流程、系统数据提取和分析方法、透明的报告标准，批判性评估相关文献以推动理论发展和创建目标研究领域的关键知识源。 |
...
> | **第二阶段筛选** | 全文下载后基于三项标准二次筛选：（1）全文可下载；（2）聚焦 PISA 对教育政策的影响；（3）聚焦基础教育阶段。排除 18 篇不回应[[Research Question\|研究问题]]的文献，最终纳入 **85 篇**。 |
> | **纳入标准** | 同行评审、英文、期刊论文、实证研究（质性/量化/[[Mixed Methods Research\|混合方法]]）、聚焦基础教育。 |
> | **排除标准** | 重复文献、非英文、全文不可获取、非期刊论文、[[Literature Review\|文献综述]]/评论/[[Meta-analysis\|元分析]]、非基础教育领域。 |
> | **方法分布** | 49 篇质性数据分析，36 篇混合研究方法。主要设计：[[Case Study\|案例研究]]、历史比较研究、国际比较研究。量化数据来源：TIMSS、PISA 分数和排名数据；质性数据来源：教育部等中央部门官方政策文件、国家媒体报道和政治演讲、参与教育政策制定的学者咨询报告、政府官员和专家访谈。 |
> | **地区分布** | 西欧 39 篇（德国 20、法国 8、英国 5、西班牙 5、瑞士 2）、北欧 14 篇（芬兰 6、挪威 8）、亚洲 16 篇（中国 8、日韩约旦澳大利亚各 2）、北美 10 篇（美国 5、加拿大 5）、南美 6 篇（阿根廷、乌拉圭、智利各 2）。欧盟/欧洲经济区成员国合计占 62.4%。西欧占总量 45.9%。PISA 已吸引 90 多个国家和经济体参与 OECD 全球倡议（OECD, 2022b），但截至 2023 年 9 月仅有 17 个国家有相关文献，中东、非洲、南亚和东南亚构成经验研究的主要盲区。纳入文献的核心主题涵盖教育质量改革（宏观/中观/微观三层决策）、教育公平（机会/过程/结果）、政策趋同与[[Transfer Translation Transformation\|转译]]机制及影响因素（国际组织角色、国内政治、文化传统），文献数量随时间呈上升趋势。 |

> [!method-panel] 分析方法
> | 模块 | 材料与处理方式 |
> |------|----------------|
> | **数据提取与[[Coding in Qualitative Research\|编码]]** | 两步分析法。第一步：逐篇分析生成独立编码并创建具体[[Qualitative Codebook\|编码手册]]，编码维度包括年份、国家、概念框架、研究方法和研究结论。第二步：序列分析（series analysis），包括区域分布分析和核心主题分析以回应研究问题。 |
> | **质量评估** | 将纳入文献分为评价效果文献、描述性文献和解释性文献三类，分别采用不同质量标准。描述性文献按信息来源、[[Purpose Statement\|研究目的]]与方法相关性、专业权威性判断。解释性文献从研究效度（数据收集和分析方法是否清晰说明、数据源和分析过程效度检验、受访者数据效度验证、特殊或矛盾数据是否清晰描述）和研究相关性（是否提出新知识或理论、能否广泛推广）两方面评估。 |
...
> - **影响[[Reference Society in Education|参考社会]]选择**
...
> - **促进弱势群体在科技领域的平等机会**
>   法国 **Fillon 法案（Loi Fillon，全称 Loi d'orientation et de programme pour l'avenir de l'école，学校未来方向与规划法）**引入了推动机会均等和学校民主化的密集改革措施，包括将低收入家庭本科学位毕业生人数提高 20%、将科技领域女性人数提高 15%（Dobbins & Martens, 2012）。
> - **增加全日制学校数量和规模**
...
> - **引入个性化学习支持和补救教学**
>   法国教育部于 2013 年 7 月批准的《共和国学校重建方向与规划法》（Loi d'orientation et de programmation pour la refondation de l'École de la République，全称共和国学校重建方向与规划法）旨在重建法国教育体系，核心关注提升学校教育质量和公平：优先初等教育和基础技能，加强基础文化和公民教育以确认核心必要知识与能力，加强处境不利学生的优先教育，改善学习环境和校风，通过建立大学内教师教育学院提高教师初始教育和持续专业发展（Michel, 2017）。
> - **建立国家统一教学标准并实施国家课程**
>   法国通过优先初等教育和基础技能、确认核心必要知识与能力，以国家课程标准化确保过程公平。
> - **向学校下放自主权**
>   德国萨克森州（Sachsen）于 2007 年实施**强制性学校自主权（verpflichtende Schulautonomie）**，要求每所学校建立执行学校董事会以弥合学校间层级差距（Hartong, 2012）。Rautalin & Alasuutari（2009）指出芬兰教育决策权的分散化是该国政策制定者证明其教育政策和制度优越性的重要论据。全球范围内，大多数国家采纳了给予学校更多决策权和自主权的政策实践。减少中央集权有助于教育体系民主化并满足社区需求。
> - **提高教师教育水平**
...
> - **三层机制模型揭示了非线性、双向互动的政策影响机制** PISA 的政策影响不是 [[OECD]] 到国家的线性[[Causality|因果]]传递，而是在超国家软治理（国际认知共同体+[[Reference Society in Education|模范社会]]）、国家层级（自我认知落差+文化-制度[[Transfer Translation Transformation|转译]]）和内部行动者网络（信息转译+政治博弈）三层交互下的**[[Emergence|涌现]]结果**。同一 PISA 排名在不同国家的三层组合方式决定了完全不同的政策结果。
...
> [!warning] 文化偏见
> 各国在选择[[Reference Society in Education|参考社会]]和外部政策参考过程中存在文化偏见。上海的高 PISA 分数引发了西方国家关注亚洲教育实践，但这些国家可能仍受文化偏见影响，倾向于在非东方文化背景中寻找参考对象。研究 PISA 效应和全球教育改革时，需要认真考虑区域差异和文化因素的影响。
