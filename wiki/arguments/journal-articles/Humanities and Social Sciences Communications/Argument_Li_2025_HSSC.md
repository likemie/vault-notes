...
> [!case] 案例 3：法国
> Dobbins & Martens（2012）分析了法国与 OECD 的复杂关系。早期法国公众和政策制定者对 PISA 持**怀疑态度** 认为比较评估存在文化偏见、统计方法不充分、指标过度简化。然而 PISA 最终为法国教育政策带来了新动力。国际比较统计和评估不仅激发了关于法国体系缺陷的广泛公共辩论，还通过提供外国最佳实践的范例为具体教育改革提供了正当性。这一转变适用于旨在使法国教育体系与竞争性知识经济需求接轨的新近改革。在此背景下，对**芬兰模式**的暗示也为左右翼政治力量之间政策雄心的趋同提供了**机会之窗（window of opportunity）（Dobbins & Martens, 2012）**。法国和英国在 2001 年 PISA 中获得了相似结果，但此后采取了不同策略——法国的改革最终与 OECD 建议趋同，而英国进入了不同的改革路径（Baird et al., 2016）。
...
> - **三层机制模型揭示了非线性、双向互动的政策影响机制** PISA 的政策影响不是 [[OECD]] 到国家的线性[[Causality|因果]]传递，而是在超国家软治理（国际认知共同体+[[Reference Society|模范社会]]）、国家层级（自我认知落差+文化-制度[[Transfer Translation Transformation|转译]]）和内部行动者网络（信息转译+政治博弈）三层交互下的**[[Emergence|涌现]]结果**。同一 PISA 排名在不同国家的三层组合方式决定了完全不同的政策结果。
