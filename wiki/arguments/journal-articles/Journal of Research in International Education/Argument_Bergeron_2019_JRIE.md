...
>     C["探究对教师专业发展的影响"] --> D["揭示教学实践向以学生为中心和反思性转变"]
>     E["考察课程实施过程中的现实障碍"] --> F["揭示评价的主观性、排课边缘化及教师背景焦虑"]
>     B --> G["核心主张：TOK 是一门具有高教育回报的课程，不仅造福学生，也重塑教师信念，但其特殊性亟需系统性的行政与评估支持"]
>     D --> G
>     F --> G
> ```
...
> |---|---|---|
> | **连接 (Connections)** | 连接其他学科、连接内容、真实世界连接、TOK无处不在、包容性 | “我认为我们在 TOK 中关注建立连接——一旦学生开始在知识领域和认知方式之间建立这些连接，这个钟声就再也无法被撤回。” “他们会注意到一些以前永远不会注意到的事情。” |
> | **批判性思维 (Critical thinking)** | 分析、魔鬼代言人、批判性评价、批判性思维、学会处理争议 | “你不可能在一堂这样的课上无动于衷；我的意思是我们在上课时自己也能看到这一点。我认为你发起的这种讨论，实际上是相当有挑战性的，我是说我们自己也觉得有挑战性。” |
> | **教师激情点燃学生激情 (Teacher passion ignites student passion)** | 学生看重TOK、教师的激情具传染性 | (同上：由于课程的挑战性，教师自身的热情直接感染了学生) |
> | **改变人生的课程 (Life changing course)** | 充满感激、改变人生 | “如今我们作为一所文凭学校已经七年了。我越来越多地听到进入研究生院的学生发来邮件，说它正在改变他们在研究生院的生活。‘我仍然记得在研究生院里，我们在高中三年级和四年级时做的那种思考。’” |
> | **大学准备 (College preparation)** | 大学准备、准备工作、大学技能 | “[回校的毕业生]谈论 TOK 如何极好地融入了他们作为本科生正在做的事情。” |
> | **学习者培养目标 (Learner profile)** | 思想开明、[[Reflexivity|反思性]]、学会处理争议/坚持原则/多重视角 | “我认为最大的好处是拓宽了教师和学生的思维。” |
...
> [!ref-table]- Table 5. 对教师影响的主题与编码 (Themes and codes related to impact on teachers)
> | 主题 (Theme) | 编码 (Codes) | 示例引言 (Illustrative quotes) |
> |---|---|---|
> | **改善教学 (Improves teaching)** | 提升教师理解；改进教学法 | “我认为 TOK 也发展了教学法。我知道在课堂上使用的方法方面我成长了多少。我获得了心理学博士学位。所以我原以为我对如何教课了解很多……但当我开始沉浸在 [[International Baccalaureate|IB]] 理念中时，我发现了许多新事物。我发现它们是思考常规 (thinking routines)，一种结构化的探究方式。” |
> | **方法 (Methods)** | 以学生为中心的理念；明确教授技能；文本支持；在其他教学中使用 TOK 方法；连接；以讨论为基础 | “（TOK）提供了一个反思的机会，很多时候学生将他们的学科领域视为孤立的，在数学课上的事不一定会对生物课产生影响，因此这是一个建立跨课程联系的机会，并让他们反思知识本身以及构成知识的基本要素。” |
> | **协作 (Collaboration)** | 在材料和活动开发方面的协作；客座讲师；客座演讲者；分享专业知识；伙伴关系；团队教学 | “我认为实际上大家坐成小组很有趣……我们实际上是在试图一起发展想法，并从不同的视角来看待它。” |

---

### 实施困境：评估模糊与行政边缘化

> [!claim] “高期望，低支持”：特殊的评估与边缘化的处境
...
> | 主题 (Theme) | 编码 (Codes) | 示例引言 (Illustrative quotes) |
> |---|---|---|
> | **行政挑战 (Administrative challenges)** | 班级规模，上课时间，暑假[[Homework|作业]] | “但也和一些小事有关，比如把它排到早上并调整课表……今年我的课在 10 点到 11 点半，这是上 TOK 的完美时间。但我们需要非常努力地争取才能把它排在白天……” |
> | **评估挑战 (Assessment challenges)** | 评分困难，可供评分的活动有限，有限的外部问责，因为没有唯一正确答案所以很难评分；学生想要数字成绩 | “因为他们想要分数，因为他们需要知道自己做得怎么样。即使有详细的反馈……他们还是不太清楚自己做得怎样，他们想要那个数字。” |
> | **教师背景 (Teacher background)** | 内容背景对教师具挑战性，内容上有选择的余地是有益的，需要深入了解 [[IB Diploma Programme|IB DP]] | “我认为这也非常耗时……如果你想把它做好，你必须阅读并自学这些其他学科的知识。” |
...
> 2. **课程价值在于[[Epistemology|认识论]]觉醒** 促使学生反思知识建构过程并建立跨学科连接，被公认为课程带来的最大红利。
