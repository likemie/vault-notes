...
>
> 3. **结论**：Qvortrup 既维护 Visible Learning 和元分析综合的合法性，又承认其在"学习结果"概念上的限制；未来元分析需要更精确地区分不[[Tongxue|同学]]习结果，并把教学影响理解为对动态知识与学习系统的外部刺激，而非简单因果输入输出关系（Qvortrup, 2015, pp.32–33）。
...
> - 文章认为未来[[Meta-analysis|元分析]]可能朝 Glass 设想的复杂数据景观发展，即由原始数据档案呈现自变量、因变量和中介变量之间的复杂关系，而不只是输出单一平均效应（Qvortrup, 2015, p.32）。
