...
> [!example] 论证结构
> 论文以引言-访谈-参考文献的结构呈现。引言部分（Knudsen, 2017, p.253–254）阐述了四个[[Research Problem|研究问题]]的背景：丹麦 VL 实施现状、现有批评文献（Snook et al., 2009; Simpson, 2017; Biesta, 2010）、以及 Knudsen 自己的 [[Science and Technology Studies|STS]] 研究取向。访谈正文分为五个主题板块：(1) 规模化与翻译；(2) 丹麦批评；(3) 儿童与基本假设；(4) 可见性与基本假设；(5) 证据与理论；(6) 政策、研究与商业。
>
...
> ### 翻译概念
>
> - Hattie 援引 Vivian Robinson（1990s）的论点：大多数学者不承认教师有非常强的学习理论；学者忽视教师通过自身镜头解释的事实（p.254）
> - Hattie 的翻译概念是单向的：研究者说→测试教师是否理解→如果不理解就是研究者错了（p.254–255）
> - 语言是一个主要问题：斯堪的纳维亚语言不区分"teaching"和"learning"，日本也不区分（p.255）
> - 每个国家有本地人员参与翻译——"这是它运作的唯一方式"（p.255）
>
> ### 丹麦批评的回应
>
> - 承认"照本宣科"的性质，但在本地情境中的解释至关重要（p.255–256）
> - 最初在新西兰 6 个月内失去了 70% 的学校，因为阻力太强；现在情况相反（p.256）
> - 声称不喜欢"evidence-based"这个词，因为"它暗示背后没有思考"；已转向"know thy impact"（p.256）
> - 就丹麦 Grundtvig 传统的批评，Hattie 回应"know thy impact"更接近原初的丹麦理念——关注对学生的 impact（p.256）
>
> ### 学习意图与成功标准
>
> - 承认学习意图（learning intentions）常被误用——过于原子化和低水平（p.256）
...
> - 以 30 million word gap（Hart & Risley）论证需要对低资源家庭儿童进行干预（p.257）
> - 1–2 岁之间儿童发展出心理理论（theory of mind），那是"我们应该让他们接触学习概念的时机"（p.257）
> - 主张 0–8 岁是让儿童接触学习概念的最关键时期，但反对在学前教识字——应通过游戏学习（p.257）
>
> ### 可见性概念
>
> - 耗费 6–7 年才形成"可见的"这一概念（p.257）
> - 援引 Graham Nuthall 的研究——教师看不到或听不到课堂中 80% 发生的事情（p.257）
> - 核心思想是"从谈论教学方式转向谈论教学的 impact"（p.257）
...
> ### 证据与理论
>
> - 承认 VL 在理论方面相当缺乏——"如果我知道它会触及研究者以外的读者，我可能会加入更多理论"（p.258）
> - "我是测量研究者，我是统计学家，我不是理论家"——但补充"我当然有非常强的教学模式"（p.258–259）
> - 正在撰写一本关于"教学作为专业"的书（p.259）
> - 回应丹麦序言声称"终于教育变得 evidence-based 可以摆脱理论"：Hattie 明确否定——"证据不意味着不应该有理论……证据通过镜头解释，那个镜头就是理论"（p.259）
