...
>
> 3. **结论**：Visible Learning 的目的不是提供"什么有效食谱"，而是为教师提供"智能问题解决的[[Hypothesis|假设]]"(Hattie, 2009, p.247)。专业判断是 VL 中教学干预与学习成果之间的"缺失环节"——它将研究证据（知道什么最可能有效）与具体情境（在特定情况下需要什么）连接起来(p.6-7)
