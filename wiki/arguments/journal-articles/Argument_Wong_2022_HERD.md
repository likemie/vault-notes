...
## 理论框架
- 以高等教育的市场化（marketisation）为背景：大学需要向学生证明其价值和投资回报，推动了毕业生特质的产生与发展（p.1340）
...
- 样本：Universities UK 137 所成员大学中，76 所（55%）至少有一个公开网页列出毕业生特质（截至 2020 年 1 月）
- 数据来源：大学官方网站公开的毕业生特质页面
- 分析流程：三位作者独立编码相同数据（三所大学网站）→ 讨论差异达成共识 → 逐步精炼编码框架 → 超过 30 个子代码归纳为四大话语（p.1343）

## 核心论证
1. 高等教育市场化推动大学通过毕业生特质来证明自身价值（p.1340）
...
## 局限性与批评
- 论文自身承认：分析倾向内容更丰富的大学网站；部分大学可能在其他（未检索到的）页面列出毕业生特质（p.1343）
