...
> - 分析流程：三位作者独立编码相同数据（三所大学网站）→ 讨论差异达成共识 → 逐步[[Jing (Refined Mastery)|精]]炼编码框架 → 超过 30 个子代码归纳为四大话语（p.1343）
...
> [!warning] 局限性与批评
> - 论文自身承认：分析倾向内容更丰富的大学网站；部分大学可能在其他（未检索到的）页面列出[[Graduate Attributes|毕业生特质]]（p.1343）
> - 仅反映机构层面的宣称，未考察师生是否共享或知晓这些机构愿景（p.1342）
> - 未深入探讨毕业生特质在不[[Tongxue|同学]]科中的具体含[[Rightness|义]]和实施的差异性（p.1351）
