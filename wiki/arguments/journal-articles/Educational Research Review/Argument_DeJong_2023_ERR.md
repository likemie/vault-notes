...
> | **课程级长周期实验证据池** | 涵盖[[Web-based Inquiry Science Environment\|基于网络的探究科学环境]]（Web-based Inquiry Science Environment, WISE）逾 8,000 名学生队列实验、密歇根大学为期 5 年的物理课程[[Randomised Controlled Trials\|随机对照试验]]（Randomised Controlled Trial, RCT），以及美瑞跨国常态课堂对照实验。 |
...
> - **高阶主动认知加工** 学生开展深层推理与自我解释，展开高水平[[Active Learning\|主动学习]]与认知加工，主动协调概念表征，而非[[Rote Learning\|机械记忆]]现成结论。
...
> - **[[David Klahr\|戴维·克拉尔]]（[[David Klahr]]）团队的早期实验与教学特征** 
...
> |---|---|---|---|
> | **[[Marcia C. Linn\|Linn et al. (2006)]] [[Web-based Inquiry Science Environment\|WISE]] 项目** | 逾 8,000 名中学生，涵盖 6 门独立理科课程，两轮大型队列对比 | 基于网络的探究科学环境（WISE）平台，实施为期 2–10 天的结构化技术增强探究课程（基于[[Knowledge Integration\|知识整合理论]]，含动态交互可视化）对比全校常规传统课程。 | 探究队列在总体科学学业成就上显著超越常规课程队列，并在 6 门课程中的 4 门取得统计显著的学业优势。 |
...
> | **Lederman & Lederman (2009) 美瑞课堂对照** | 跨越美国与瑞典多所学校的常态物理与化学课堂实验 | 设立三组对照：纯直接教学组、纯探究组、探究与直接讲授混合组，任课教师均接受三种教学法专业培训并在不同班级交叉实施。 | 经历完整学期教学后，三组在学科知识掌握、[[Nature of Science\|科学本质理解]]（Nature of Science, NOS）以及对科学的情意态度上均未现显著差异。（p. 6） |
...
针对常态课堂中教师难以同时兼顾班级所有学生个性化探究进度的客观现实，数字化工具与人工智能（[[Generative Artificial Intelligence|Artificial Intelligence]], AI）技术提供了重要的自适应辅助路径。（pp. 9–10）
...
>   在 WISE 平台中，NLP 算法自动审阅学生撰写的开放式[[Scientific Explanation\|科学解释]]文本，诊断其论据是否充分、因果链条是否完整，并自动提供迭代修改提示。Gerard et al. (2015) 针对 41 项研究的元分析证实，此类自动化自适应指导对比常规课堂指导展现出显著的附加增益（$g = 0.34$）。（p. 9）
