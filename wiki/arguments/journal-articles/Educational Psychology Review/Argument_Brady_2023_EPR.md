...
> 本文延续 Hsieh et al. (2005)、Robinson et al. (2007) 与 Reinhart et al. (2013) 对教育心理学研究方法趋势的追踪，核心问题是：到 2020 年，教育心理学经验期刊是否继续远离干预/[[Experimental Research\|实验研究]]，并且是否继续在[[Non-intervention Research\|非干预研究]]中提出[[Recommendations for Practice\|实践建议]]（RFP）？(pp.1, 4)

## 理论框架

> [!abstract] 理论框架
> 本文没有使用独立理论框架，而是以教育心理学"研究应改善学生学习"的应用使命与因果推论边界之间的张力为论证基础。作者认为，当研究目标是指导政策与实践时，研究序列应从概念发展和描述性研究走向[[Hypothesis\|假设]]检验：早期[[Qualitative Observation\|质性观察]]和量化自陈调查可帮助理解情境，[[Correlational Research\|相关研究]]可识别可能的[[Causality\|因果关系]]，而真正的干预假设需要通过[[Intervention Research\|干预研究]]和随机实验进行正式检验(p.2)。
...
> [!example] 核心论证
> 1. **教育心理学研究序列正在停在相关阶段** 如果目标是指导实践，描述性和[[Correlational Research\|相关研究]]应通向干预[[Hypothesis\|假设]]检验；但过去 30 年[[Experiential Learning\|经验教育]]心理学期刊中[[Intervention Research\|干预研究]]下降、观察/相关研究上升，显示研究序列常在非干预阶段结束(pp.2-3)。
...
> [!success] 主要发现
> - 2020 年五本期刊中，经验文章数量比 2010 年增加 114 篇；[[Non-intervention Research\|非干预研究]]总体约占全部经验研究的四分之三，与 2010 年相近(pp.5-7)。
> - [[Intervention Research\|干预研究]]比例从 2000 年 40% 降至 2010 年 25%，2020 年仍为 25%；随机实验从 2010 年 23% 继续降至 2020 年 20%。作者指出，1983 年五本期刊中近一半经验文章使用[[Random Assignment\|随机分配]]实验，而 2020 年只有五分之一(p.7)。
> - [[Qualitative Research\|质性研究]]从 2010 年 9% 上升至 2020 年 22%；即使排除 *Journal of Educational Psychology* 2020 年质性研究 special issue，质性研究仍占 19%(pp.5-6)。
> - 观察/[[Correlational Research\|相关研究]]含 RFP 比例 2020 年达到 66%；质性研究 65%、[[Mixed Methods Research\|混合方法]]/[[Multimethod Research\|多方法研究]] 60% 含 RFP(pp.6-7)。
> - JEP 2019 与 2020 的比较显示，2020 年观察/相关研究中 RFP 比例为 67%，低于 2019 年的 82%；作者据此认为 2020 年可能低估了此类研究包含 RFP 的倾向(p.5)。

## 关键引用

> [!quote] 关键引用
> > “采用实验方法的文章比例继续下降（20%），而质性方法则有所上升（22%）。”
> ("The percentage of articles employing experimental methods has continued to decrease (20%), whereas qualitative methods have increased (22%).")(p.1)
>
> > “在结合所有路径的情况下，2020 年，大约三分之二的非干预文章中包含了[[Recommendations for Practice\|实践建议]]（RFP）。”
> ("In all approaches combined, in 2020, RFP were included in about two out of three nonintervention articles.")(p.7)
>
> > “本研究的潜在假设是，任何未建立在能识别[[Causality\|因果关系]]的严谨方法论基础上的实践建议（RFP），都是值得怀疑的。”
> ("The underlying assumption of this study is that any RFP that is not based on sound methodology that can identify causal relations is suspect.")(p.9)

## 局限性与批评

> [!warning] 局限性与批评
> - 作者没有[[Coding in Qualitative Research\|编码]] RFP 的强度与范围，只记录是否存在 RFP；因此无法区分紧贴样本、措辞谨慎的建议与广泛、强因果语气的建议(p.9)。
