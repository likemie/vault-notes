...
> 2. **d 本身不是显著性统计量。** 若要进行常规显著性判断，需要把 d 乘以观测数平方根，形成 `t=d√n`，再按 t 分布判断；以 n=25 为例，t=2.060 对应 d≈0.412，因此 Hattie 的 0.40 阈值只是在特定样本量和检验设定下接近 p=0.05（Allerup, 2015, pp.45–46）。
