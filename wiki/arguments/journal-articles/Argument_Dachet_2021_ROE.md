...
> [!info] 研究问题
> 法语比利时这样一个过去很少鼓励证据本位范式、定性研究影响较强、教育系统又面临绩效与公平压力的地区，如何把[[Evidence-Based Education|证据本位教育]]逐步嵌入一场正在进行的系统改革？这个问题的核心不是“EBE 是否应当被采纳”，而是“当本地缺少大量经过实验验证的项目时，证据本位改革还能以什么形式推进”（Dachet & Baye, 2021, pp.165-166, 170-171）。
...
> [!info] 研究方法
> - 方法：叙事案例研究。研究以法语比利时正在进行的教育卓越公约为案例，分析改革阶段以及作者所在研究中心在改革工作中的连续参与（Dachet & Baye, 2021, p.164）。
> - 资料来源：改革文本、工作组过程、教学工具/项目清单、结构性改革方案，以及作者团队参与 EBE 报告、方法类型学和项目验证工作的过程材料（Dachet & Baye, 2021, pp.170-181）。
> - 分析框架：先把计划中的结构改革与可获得教育研究证据比较，再用 Slavin 的三项杠杆判断改革在多大程度上接近证据本位改革（Dachet & Baye, 2021, pp.171, 179-181）。
...
> [!success] 主要发现
> 1. 法语比利时教育卓越公约正式把 EBE 引入改革语言，2017 年官方建议承认本系统中 EBE 几乎不存在，并提出试点、验证、扩大有效项目（Dachet & Baye, 2021, p.171）。
> 2. 结构性改革与证据之间关系不均衡：共同核心延伸和教师培养延长有一定研究支持，能力本位、定向取向和学校日历改革证据较弱，降低留级目标则低于既有证据可能支持的改革力度（Dachet & Baye, 2021, pp.171-174）。
