...
> - **科学学科的特殊性** 在跨学科对比中，科学（$r = .199$）和数学（$r = .157$）领域的效应最为稳健，这可能因为这些学科对知识的确证规则有着更为明确的界定。

> [!ma-table]- 表 8：学术领域调节变量分析
> | 学术领域 | k | 效应量 (ES) | 95% CI |
> |---|---|---|---|
> | 科学 | 49 | .199 | [.153, .243] |
> | 数学 | 19 | .157 | [.026, .282] |
...
> - **高阶成就类型的强挂钩与低阶任务脱节** 成就指标的认知加工层级越高，其与认识论认知的关联就越强：
>   - 预测**概念性知识（$r = .190$）**和**论证能力（$r = .154$）**表现出极强的正向关联；
>   - 而预测底层机械的**陈述性知识（$r = .127$）**和**程序性知识（$r = .077$）**效应量显著衰减，程序性知识甚至不显著异于 0。
...
> [!warrant]- 理论推理桥梁：为什么认识论认知与高阶思维强相关？
> 这一实证断层为认识论认知在认知架构中的定位提供了决定性的理论确证：
> - **低阶记忆任务的认识论冗余** 陈述性与程序性知识考核具有高度的闭合性与确定性，预设了标准答案。持朴素二元论的学生通过机械背诵与模式化套用即可取得高分，高阶认识论信念在此类任务中不仅无法带来收益，甚至可能因过度思辨而造成提取干扰。
> - **高阶思维的[[Metacognition|元认知]]驱动引擎** 概念性理解（涉及直觉先验的推翻与概念转变）与论证表现（涉及多源证据权衡、[[Reflexivity|反思性]]批判与漏洞识别）本质上属于开放性与不确定性认知活动，必须以成熟的认识论认知（如知识发展观、[[Justificatory Standards|确证标准]]）作为底层支撑。
> - **双向互惠的螺旋演进（Reciprocal Model）** 成熟认识论认知是高阶思维深层加工的前置引擎；反过来，开放式探究与论证[[Praxis|实践]]所制造的认知失衡也是打破学生二元论平衡、孵化认识论成熟的关键熔炉。
> - **确证[[Theoretical Validity|理论有效性]]（Theoretical Validity）** 效应量随认知层级上升而阶梯式增强，反驳了“认识论认知只是泛化学习动机或一般智力的虚假代理”的质疑，证实认识论认知具有清晰且独立的任务解释边界。（p. 1102）
