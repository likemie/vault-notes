...
> | | 2.2 学生自主提问（Students posing questions） | 4 | 0.37 | -0.02 | 0.77 | 10.99 ($p = .012$) | 72.70% | 学生对等互问生成深层探究 |
...
> [!chain-link] 证据到判断
> 对策略组合的混合效应调节分析显示，策略组合之间存在显著的梯度差异（$Q_b = 8.19, \text{df} = 3, p = .04$）：
...
> | | 沉浸模式（Immersion） | 61 | 0.23 | 0.12 | 0.34 | | |
