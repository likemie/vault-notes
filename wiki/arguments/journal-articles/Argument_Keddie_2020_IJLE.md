...
>
> 1. 市场化的哪些话语和实践构成[[School Autonomy|学校自主权]]、以损害社会正[[Rightness|义]]的方式？
...
> [!abstract] 理论框架
> - **Fraser (2009) 的再分配正[[Rightness|义]]**（redistributive justice）：将社会正义界定为"对学生的人力和物质资源的更公平分配"（Keddie et al., 2020, IJLE, p.3, 5）
...
> - **数据分析**：Nvivo 编码，主题分析，以"社会正[[Rightness|义]]"和"公平"为分析主题，部署悖论语言来叙述对立政治
> - **样本选择**：基于利益相关者在其各自组织/协会中的领导地位，及其对[[School Autonomy|学校自主权]]改革的广泛知识和经验

## 核心论证

> [!example] 核心论证
> 论文以 Dolan 的悖论框架，围绕四大悖论展开论证（Keddie et al., 2020, IJLE, p.5）：
>
> 1. **经济效率与差异化拨款**：经济效率话语和实践 + 公私部门间差异化拨款 → 构成学校"自主权" → 制造经济不公
> 2. **竞争与个人主[[Rightness|义]]**：竞争和个人主义话语和实践 → 构成[[School Autonomy|学校自主权]] → 削弱系统层面的公平（个别学校的成功以其他学校为代价）
> 3. **权力下放与经济理性主义**：权力下放和经济理性主义 → 构成学校自主权 → 使本已弱势的学校（农村/偏远、低SES、小规模）更加不利
> 4. **需求本位拨款**：需求本位拨款在缺乏透明度、[[Jing (Refined Mastery)|精]]细度和行政支持时 → 构成学校自主权 → 制造经济不公（包括资金挪用和误用）
>
> 核心结论：补偿机制（如需求本位拨款）可以去一些缓解市场话语的构成性权力，但在拨款缺乏透明度和精细度、缺乏行政支持时，其补偿能力受到根本性削弱。此外，在当前的公私混合拨款模式下，需求本位拨款对缓解嵌入系统的结构性资源分配不公"几乎无能为力"（Keddie et al., 2020, IJLE, p.12）。

## 主要发现

> [!success] 主要发现
> - 经济效率话语伴随着[[School Autonomy|学校自主权]]改革"破坏了传统上与支持公立学校相关的中央教育官僚机构的结构、资源和项目"，使学校自行管理先前由国家负责的[[Rightness|义]]务（Keddie et al., 2020, IJLE, p.3-4）
> - 竞争制造了公立系统内的分层和残余化——通过"评估（公开奖励）和贬低（公开羞辱）学校"（p.4）
> - 学校自主权没有单向地与学术成就提升相关联——"没有证据将学校自主权改革与澳大利亚学生成绩的提升单向地联系起来"（p.3）
> - 农村/偏远、低SES、小规模学校在权力下放系统中面临不成比例的不利影响（p.9-10）
> - 家长筹资能力的高度差异——高SES地区学校的家长收入可达低SES地区学校的四倍（Rowe & Perry, 2019a，引自 p.10-11）
> - 缺乏经验的校长不成比例地集中在最弱势的学校（p.10）
> - "最好的校长在错误的地方"——最有能力的校长集中在较少复杂弱势的大都市地区（Kurt, bureaucrat, Vic，p.10）
...
> [!warning] 局限性与批评
> - 论文承认其呈现的悖论"不假定它们代表了[[School Autonomy|学校自主权]]改革与社会正[[Rightness|义]]之间的所有张力"（Keddie et al., 2020, IJLE, p.13）
> - 研究发现基于项目第一年的访谈数据，后续年份的学校层面数据可能提供更细致的学校内部视角
> - 样本中校长数量有限（4人），利益相关者视角偏向系统层面
