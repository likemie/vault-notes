...
>
> 三位作者追问两个相互关联的问题。第一，科学在创新过程中的角色从线性模型到链式模型再到更完整框架，每一步突破了什么、遗漏了什么。第二，科学与大学在今天的学习经济中应当如何重新定位。
...
> | 理论工具 | 解释功能 |
> |----------|----------|
> | **线性模型**<br>Linear Model of Innovation<br>Bush (1945); Bernal (1939) | 预设基础科学 → 技术开发 → 经济增长的单向因果链条，研究（Research，白大褂科学）天然支配开发（Development，邋遢工程）。二战后成为配置公共研究资源最有力的理论依据，在工业组织内部塑造了科学家高于工程师的层级结构 (pp.862–863)。在本文中作为被批判的出发点：欧盟巴塞罗那目标（2%+1%）、欧洲悖论、大学被推向专利生产者，均源于线性模型的推导惯性。 |
> | **链式模型**<br>Chain-linked Model<br>Kline & Rosenberg (1986) | 创新始于潜在市场用途的想法而非研究。既有科学知识（K）可在任何阶段被调用，新知识（R）可在需要时创造；有时新科学催生激进应用（路径 D），有时科学反而从创新中受益（路径 I、S）。核心命题是开发（D）至少与研究（R）同等重要 (pp.863–864)。在本文中作为中间突破，揭示了线性模型的单向因果谬误，但因其遗漏组织维度、未区分知识类型、创新产出定义过窄，仍需要进一步扩展。 |
> | **[[Multi-channel Interactive Learning Model]]**<br>Multi-channel Interactive Learning Model<br>Caraça et al. (2009) | 三个核心创新构成分析网格：螺旋式学习循环不指定创新起点，产出覆盖产品、流程、新市场细分和组织常规四类；三类知识池（物理与生物科技知识、组织与治理知识、营销与顾客行为知识）取代了单一科学知识来源；界面作为解释性管道连接企业与环境，决定外部知识的识别、选择与吸收 (pp.864–866)。该模型将创新重新定位在学习经济之中。 |
> | **学习经济**<br>Learning Economy<br>Lundvall & Johnson (1994) | 在全球化与技术加速变迁的环境中，企业和经济体的竞争力越来越取决于学习能力而非静态知识存量。经验型学习和互动式学习是创新的前提条件 (p.864)。在本文中为三类知识池的并列必要性提供宏观语境，解释了为什么组织知识和营销知识不是科学知识的附庸，而是同等重要的创新投入。 |
> | **[[Systems of Innovation]]**<br>Systems of Innovation<br>Freeman (2002); Lundvall et al. (2002); Malerba (2002); Asheim & Gertler (2004) | 部门创新系统（Malerba, 2002）和区域创新系统（Asheim & Gertler, 2004）对应企业创新过程的微观与行业环境，国家创新系统（Freeman, 2002; Lundvall et al., 2002）对应宏观制度环境。在本文中，多通道互动学习模型的微观和宏观环境概念整合了上述多层分析，并进一步强调了各层次之间的共同演化和可能的制度错配 (p.865)。 |
...
> | 模块 | 材料与处理方式 |
> |------|----------------|
> | **模型回顾／文献分析**<br>Literature Review | 回顾线性模型从 Bernal（1939）和 Bush（1945）到公共品经济学论证的知识史，以及链式模型（Kline & Rosenberg, 1986）的理论突破与局限 (pp.861–863)。 |
...
> | 层面 | 说明 |
> |------|------|
> | **Rothwell 五代模型** | 作者有意简化了分析：忽略第二代需求拉动阶段，将所提模型视为整合第四代和第五代要素但更强调组织维度的框架 (p.862, footnote 2)。 |
> | **模型并存现实** | 不同模型在现实与学者心目中并存，所提模型不是一个替代性新阶段，而是一个更完整的分析网格 (p.862, footnote 2)。 |
...
>     classDef model fill:#fff3e8,stroke:#be5f2d,stroke-width:1px,color:#321;
>     classDef new fill:#f0f4ff,stroke:#3b5fc0,stroke-width:1px,color:#321;
>     classDef conc fill:#f7f7f7,stroke:#607180,stroke-width:2px,color:#222;
>     class A bg;
>     class B,C model;
>     class D new;
>     class E conc;
...
论文标题中的问号——"From Queen to Cinderella?"——不是修辞装饰，而是全文论证的起点。三位作者提出这个隐喻意在表达：科学在创新中的角色不是从一种身份单向转变为另一种身份，而是同时经历着两种方向相反的变化。隐喻的两个角色各自对应一种变化，二者并行不悖而非非此即彼 (p.862)。
...
> [!line] 灰姑娘的含义
> 童话中的灰姑娘有两个看似矛盾的特征：她承担了家中所有劳作，无处不在却毫无地位；直到王子出现她才被看见和承认。三位作者借用的是前一个特征——灰姑娘式的有用。科学的角色在最近几十年里发生了深刻的泛化。在供给端，营销研究、管理研究和组织研究对创新越来越重要，自然科学不再是唯一的知识来源。在需求端，越来越多传统意义上的低技术产业——食品加工、纺织——也需要依靠科学来保持竞争力。科学变得无处不在，渗透进创新的每一个环节，按需被调用。它比以前更有用了。

> [!line] 两种变化共存而非互斥
> 泛化的另一面正是主导地位的消解。当科学渗透进创新的每一个环节、每一个产业时，它不再是一个可以被单独识别并排在首位的独立要素。它不是被贬黜为灰姑娘——它只是不再拥有女王曾经享有的那种先天优先权。科学之所以能变得无处不在，恰恰因为它不再需要一个被单独标识并排在首位的身份。这正是三位作者用标题中的问号而非句号来收束的原因。

> [!tension] 隐喻背后的政策机制
> 这一双重变化并非学术圈内部的术语游戏。当线性模型预设科学投入必然带来经济增长而现实落空时，落差被标记为欧洲悖论。政策制定者不反思模型前提，反而反向要求科学证明经济价值——正向因果断言（科学→产业）被颠倒为反向规范性要求（市场→学术）。女王被要求充当侍女。三位作者的论证正是要揭示：问题不在于科学不够商业化，而在于线性模型本身无法解释创新过程的真实结构。

---

### 第一步：线性模型的起源、影响力与政策陷阱

> [!note] 知识史
> - J. D. Bernal（1939）率先测量英国 R&D 占 GNP 约 0.2%，主张提高到 2.0%。
> - Vannevar Bush（1945）在《科学：无尽的前沿》中为美国提出类似论证。
> - 经济学家直到 1950 年代末才基于公共品理论（非排他性、非竞争性）给出政府资助基础科学的系统性理由。
>
...
- R（白大褂科学）对 D（邋遢工程）的支配地位成为企业组织创新活动的模板（The Economist, 2007）。
- 科学家在企业内获得比工程师更高的地位和自主权，即使后者距离市场和生产问题更近。

**政策后果** (p.862)：

- 欧盟里斯本议程推出巴塞罗那目标：私人 R&D 占 GDP 2%、公共 R&D 占 GDP 1%。底层逻辑仍是线性模型。
- 创新产出未反映科学投入时，落差被标记为欧洲悖论。
- 政策反应不是反思线性模型的前提假设，而是推动科学商业化。
- 大学被推向专利生产者角色，其为产业和社会培养具有批判性思维的毕业生的根本功能被系统忽视。

> [!warning] 双重政策失败
> - **诊断错误**：经济表现不佳被归因于科学到产业的转化管道不畅，而非组织学习能力不足。
> - **药方错误**：推动大学商业化不仅无法解决真正瓶颈（不支持面向市场和生产的经验型学习的组织形式，p.867），还可能损害基础研究的长期活力。

---

### 第二步：链式模型的理论突破与未竟之处

Kline 和 Rosenberg（1986）的链式模型是对线性模型最重要的理论挑战 (pp.863–864)。核心洞见拆解为三个层次：

1. **创新的起点不是科学**，而是一个关于潜在市场用途的广泛想法。该想法通过设计或原型转化为具体方案，经历一系列反馈循环最终回到用户需求。
2. **科学在过程中按需调用或创造**。既有的经过验证的科学知识（K）可在任何阶段被调用，新知识（R）可在需要时创造。
3. **科学与创新双向互动**。有时新科学催生激进应用（路径 D），有时科学反过来从创新中受益（路径 I 和 S）。

> [!example]- 图2：链式模型
> ![](https://img.mylikemie.icu/sources/Caraca_2009_TFSC/figures/Caraca_2009_TFSC_Fig2_Chain_Linked_Model.jpg)

> [!boundary] 关键贡献：D 至少与 R 同等重要
> 链式模型将科学重新定位为过程的一部分而非必然起始步骤。开发（D）至少与研究（R）同等重要 (p.864)。这一判断在科学与开发之间划出了一条此前被线性模型遮蔽的边界：创新政策不能等同于研究政策，增加基础科学投入本身不足以提振创新绩效。

**三个局限**（三位作者寻求突破的方向）：

> [!line] 局限一：组织维度缺失
> 链式模型强调技术力量与市场动态的动态耦合，但未承认组织维度以及学习发生的更广泛制度环境。创新涉及的学习不仅关乎物理和生命现象，还关乎组织和营销问题 (p.864)。组织如何设计内部流程、管理跨职能团队互动、处理与外部伙伴的关系，这些都直接影响学习效果。

> [!line] 局限二：知识来源未做类型区分
> 链式模型区分了被调用的知识（K）和被创造的知识（R），但未区分知识的类型。现实中企业开发新产品需要来自截然不同领域的知识——材料科学的物理知识、供应链管理的组织知识、消费者行为的营销知识。这些知识来自不同的知识池，通过不同的界面流入企业。

> [!line] 局限三：创新产出定义过窄
> 主要关注产品和流程创新，遗漏了新市场细分和新组织常规。三位作者特意指出其模型与第三版《奥斯陆手册》（OECD, 2005）对创新的广义定义一致 (p.865)。将创新仅定义为产品和技术突破会遗漏服务业、低技术产业和公共部门中的大量创新活动。
...
> - 学习产出覆盖四种类型：产品创新、流程创新、新市场细分、组织业务常规的新方法 (pp.864–865)。
> - 技术快速变化和市场持续重构使开放敏捷的企业获得竞争优势。SAPPHO 项目（Rothwell et al., 1974）的经典发现是成功创新者与不成功者之间的关键差异在于对外部知识来源的开放性和内部沟通的有效性 (p.864)。

> [!evidence-grid] 创新二：三类知识池
> 取代链式模型中单一的 K（既存知识）和 R（新研究），区分三组互补知识来源 (pp.864–865)：
>
> 1. **物理和生物科学与技术知识**：自然科学和工程技术。
> 2. **组织和治理结构知识**：内部架构设计、管理流程、激励机制、治理安排。
> 3. **营销技术和顾客行为知识**：市场理解、用户细分、价值主张设计。
>
> > [!boundary] 知识池的类型学意义
...
> [!evidence-grid] 推论一：科学并非创新的默认基础
> 并非所有创新都以科学为基础，极少数是纯粹由科学驱动的。在大多数产业中，科学是多元知识来源中的一种，其重要性因产业类型、创新阶段和企业战略而异。

> [!evidence-grid] 推论二：科学在创新各环节按需使用
> 科学倾向于在创新各环节中按需使用（Kline & Rosenberg），通过界面与组织和市场知识共同进入学习循环。科学不是前置投入，而是过程中被持续调用的能力。

> [!evidence-grid] 推论三：R 即 D
> 研发正在变得无缝（R and D are becoming seamless）。企业科学家越来越熟悉实施问题，被推向创新前线。趋势是从 R&D 作为两个分离活动过渡到科学与生产的持续紧密互动，概括为 **R 即 D**。

> [!tension] 无处不在与失去王位的共存
> 科学变得无处不在——从 R&D 分离到 R 即 D。但无处不在的另一面是失去王位：当科学渗透进创新的每一个环节时，它失去了作为独立主导因素的特权地位。这不是逻辑矛盾而是互补——科学之所以能变得无处不在，恰恰因为它不再需要被单独标识并排在首位的身份。
...
> 2. **三种模型的递进与三类知识池** (pp.862–866)：线性模型预设单向因果并主导战后政策想象。链式模型突破线性预设但遗漏组织维度。[[Multi-channel Interactive Learning Model|多通道互动学习模型]]加入螺旋学习循环、三类知识池和界面概念，后两类知识（组织治理、营销与顾客行为）在传统政策中被低估但在 R 即 D 转变中日益重要。
...
> - **2% + 1%**：欧盟巴塞罗那目标，私人 R&D 占 GDP 2%、公共 R&D 占 GDP 1% (p.862)。
...
> - [[Multi-channel Interactive Learning Model|多通道互动学习模型]]是复杂的，本文仅能给出简要概述 (p.866)。模型各组成部分——螺旋学习循环、三类知识池、界面概念、双层创新环境——均值得进一步独立研究和实证检验。
