...
>
> 这个问题之所以难以回答，是因为表面上矛盾的现象同时存在。一边是市场化的喧嚣，学费上涨、营利性院校[[Emergence|涌现]]、大学竞相争取拨款和排名。另一边却是等级格局的惊人稳固，哈佛、牛津等老牌精英大学不仅没有被市场竞争削弱，反而更加牢固地占据着全球高等教育的顶端。如果这真的是"市场"，为什么赢家通吃而不是竞争出清？如果这不是"市场"，那它又是什么？
>
> 这一追问背后是对两重现状的不满：
...
- **Jessop** 通过三重思想实验区分了三种不同的市场化程度：成本效率（cost-efficiency）只是基本的预算纪律；准商品化（[[Quasi-commodification of Knowledge|quasi-commodification]]）将知识劳动转化为可交易的商品；[[Financialization of Higher Education|金融化]]（financialization）则是让金融资本直接进入并主导高等教育。关键洞见是：即便大学不成为营利企业，它们仍然可以被 Schumpeter 意义上的"[[Creativity|创造性]]破坏"所重塑，而政治资本主义（political capitalism）提供了另一种可能：国家和财富机构之间的紧密联盟。
...
- **Maesse** 展示了经济学学科中[[Elitism Dispositif|精英部署]]的运作：统一评估、资源集中和院系规模界定学科精英与边缘，且这一部署的效应溢出到政治和媒体[[Champ|场域]](p.806)。详见 [[Elitism Dispositif]]
- **Bloch & Mitterle** 提出分层应被理解为由[[Field Images|场域图像]]驱动的持续过程而非静态结构——排名教导行动者"看见"垂直的等级秩序(pp.806–807)。详见 [[Field Images]]
- **Bouchard** 追溯了法国大学排名如何从媒体公司的市场竞争策略中诞生——L'Étudiant 和 Le Monde de l'éducation 自 1970 年代末将异质机构投射到同一套质量标尺之上(pp.806–807)
- **Angermuller** 将学术交流分析为[[Positioning Practice|定位实践]]：每次发言、每篇署名、每个职称标签，都在话语中协商着"我是谁"和"你不是谁"(pp.807–808)。详见 [[Positioning Practice]]
- **Kim** 的跨国身份资本概念捕捉了流动学者在不同制度语境之间比较和翻译的能力，但这一资本的价值高度不平等——外国学者在韩国即便薪资优厚也永远无法进入学术决策圈(pp.808–809)
...
两种立场之间的张力是真实的，但并非不可沟通。Jessop 在其文章中将"知识社会的政治想象"纳入其经济分析，经济分析和[[Discourse Analysis|话语分析]]可以在同一个框架内协同工作(pp.807–808)。
...
- **话语分析视角** 学术等级始终是一套被持续建构和争议的符号秩序，谁在"上"谁在"下"不是一个固定的结构，而是在日常的评估、排名、引用和话语中被反复生产和挑战的"成就"。
...
> - **学术"市场"的运作逻辑与常规市场根本不同** [[Quasi-markets in Higher Education|准市场]]和声望竞争不依赖显性货币供需机制。公共资金与私人支出高度交织，市场化在相当程度上是国家用另一种方式继续资助高等教育，只是换了一条中间有私人机构抽成的管道(pp.797–798, 800–801)
...
> - **三种[[Theoretical Perspective|理论取向]]互补大于对立** 制度主义的"规则"视角、马克思主义的"谁受益"视角、[[Discourse Analysis|话语分析]]的"为什么接受"视角，不是三选一，而是三个光源照亮同一复杂对象的三个面。这一[[Analytic Framework|分析框架]]的核心贡献不在于选边站，而在于展示了这三种光源如何可以被组合使用(pp.807–809)
...
> [!quote]
> "金钱不是科学和教育[[Champ|场域]]中唯一的'通货'，因为学术人员之间的竞争也围绕'符号商品'(Bourdieu, 1984)，如声望、认可或区隔，展开。"(p.797)
>
> > “金钱并不是科学和教育领域的唯一‘货币’，因为学术界之间的竞争也围绕着‘符号商品’展开，如声望、认可或区分（distinction）。”
> ("Money is not the only 'currency' in scientific and educational fields, since competition among academics also revolves around 'symbolic goods', like prestige, recognition, or distinction.")
