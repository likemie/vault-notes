...
### 论证步骤三 断层线二 普遍性与情境性之争

> [!claim] 步骤三主张
> 关于信念领域一般（domain-general）或领域特殊（domain-specific）的探讨，往往掩盖了认知对具体任务情境的高度依赖。

> [!chain-link] 证据到判断
> - **链节一 [[Questionnaire|问卷]]导致的特质论假象**
>   过去通过替换问卷题目里的学科名词来测量领域差异，预设了[[Epistemological Beliefs|认识论信念]]是稳定的特质。
> - **链节二 真实情境中的动态切换**
>   实证研究发现，历史学家在面对相同文本的不同任务时，会在学术确证标准和宗教情感标准之间来回切换。
> - **链节三 作为情境资源的重新概念化**
>   认识论认知被重新概念化为对特定情境需求（situational demands）动态激活的细粒度资源网络或框架。

> [!critique-logic] 理论反思 破除颗粒度危机
> 仅仅承认领域特殊性仍有不足。用宏大的维度分数去掩盖情境微观操作中的动态跳跃，会导致极低的[[Predictive Validity|预测效度]]。需要在更细的颗粒度上捕捉学生如何根据任务灵活调配认识论标准。
