...
> [!abstract] 理论框架
> 未采用特定理论框架，继续以教育哲学和研究方法论视角进行批判性回应。重申 Dewey 的实用主[[Rightness|义]]知识观为基线立场：证据不提供行动规则，只为明智的问题解决提供假设（[[John Hattie|Hattie]], 2009, p.247, quoted p.97）。

## 研究方法

> [!info] 研究方法
> - 方法：学术回应（academic reply），非实证研究
> - 回应对象：[[John Hattie|Hattie]] (2010) 中对 Snook et al. (2009) 的直接和间接批评
...
>
> 4. **平均化掩盖复杂性**：以家庭作业为例——Hattie 最终产生 d=0.29 的平均[[Effect Size|效应量]]，"发出家庭作业不重要的信号"，尽管他自己的数据表明家庭作业对中学生、高能力学生和某些学科非常重要。废除家庭作业可能损害许多学生的教育（p.95）
>
...
>
> 6. **d=0.40 截断值**：所有截断值在某种意[[Rightness|义]]上都是武断的（Hattie 本人承认），对于许多目的而言更低的截断值可以辩护（如药物研究）。更重要的一点是：大样本随机研究中的小效应量具有重大意义，小样本的大效应量则"最好无意义，最糟是危险的"（p.96）
>
> 7. **[[Surface and Deep Learning|表层学习]]**：Snook et al. 澄清他们并未说 Hattie 更关心表层学习——相反，他们记录了 Hattie 认为概念性理解应是好教学的结果，但指出多数研究确实基于表层成就测量，因此从综合中得出的结论比评论者暗示的少（p.96）
>
...
> [!success] 主要发现
> - Snook et al. 重申他们 2009 年文章的三项目标议程：基于仔细阅读 VL 的讨论、注意 [[John Hattie|Hattie]] 本人提出的限定条件、防止研究发现被政治和意识形态利益"挪用"（p.93）
...
> [!warning] 局限性与批评
> - 论文为 Snook et al. (2009) 和 [[John Hattie|Hattie]] (2010) 之间的第三轮辩论，不引入新实证数据，侧重澄清立场和回应误读
