...
> - "什么有效"的口号将教育价值问题[[Transfer Translation Transformation|转化]]为技术效率问题，与 Biesta 的"teleological 特征"互补
...
>
> **批评内容**：Wrigley 推崇 Pawson (2006) 的"实在论综合"（realist synthesis）作为统计[[Meta-analysis|元分析]]的替代方案——但这比"计算平均[[Effect Size|效应量]]并放入排名表"复杂得多。实在论综合要求逐项理解每次干预的"受试者"特征、因果理论、结果质量、测量充分性和过程障碍——这对研究综述者是可操作的要求，但对于时间有限的一线教师和[[School Leadership|学校领导]]，如何将这种复杂性[[Transfer Translation Transformation|转化]]为可用的决策支持工具？
>
