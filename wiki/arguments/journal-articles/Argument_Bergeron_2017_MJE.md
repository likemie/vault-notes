...
>
> **[[Class Size|班级规模]]的案例**：VL 中班级规模的效应量为正（d≈0.2，小班 > 大班）。但如果反转比较方向——比较[[The Great Learning|大学]]校相对于小学校——效应量就会变成负数。此时 Hattie 的解释（"班级规模没有显著影响"）将完全不同，因为负面效应被视为"有害"（Bergeron & Rivard, 2017, p.241）。
>
