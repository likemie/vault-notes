...
>     C --> D["阶段二：政策方案设计与标准研制"]
>     D -->|"诉诸实证作为技术盾牌并借专家经验补位"| E["形成[[College and Career Readiness|大学与职业就绪]]标准终稿"]
>     E --> F["阶段三：州级法定采纳与政治过关"]
...
> - **[[American Federation of Teachers|AFT]] 骨干教师的物理剪裁实操评审** [[American Federation of Teachers|全美教师联盟]]（AFT）组织一线骨干教师对数学草案审查 4 次、对语文草案审查 3 次；数学教师团队甚至把草案条文逐条剪切、贴在墙上，整整两日反复比对推敲[[Learning Progression|学习进阶]]在实际课堂中是否行得通，并与起草团队面对面对质。（pp. 15, 22–23）
...
### 论证步骤四　理论重构：科学研究从来无法单独决定政策，真实决策必须在不同阶段将学术论文、教师经验与政治价值按需组合

> [!claim] 步骤四核心主张
> [[Common Core State Standards|共同核心标准]]推进的全过程表明，即使在最标榜用科学证据说话的理想案例中，学术研究也从来无法脱离行动者的实践经验与政治价值而单独决定政策。传统的循证决策理论假定科学家生产出论文、官员按图索骥就能制定出政策，这种单向线性的工程模型在现实世界中根本无法成立。在从立项到表决的每一个环节，决策者所面对的制度任务截然不同，必须根据阶段特点灵活调用宏观警示指标、专业学术护栏、一线教师常识以及微观对标清单，将学术论文、教师经验与政治价值三者动态结合，政策才可能既具备专业水准又切实可行。（pp. 1–3, 18–19）

#### 1. 为什么学术研究不能直接主导决策？证据形态随决策环节发生现实演变

通用标准研制与采纳的生动事实，彻底打破了把公共决策视作纯粹[[Technical Rationality|技术理性]]运算的传统迷思。（pp. 1–3, 18–19）

> [!critique-logic] 对知识直接驱动决策线性工程模型的现实反思
> - **学术研究供给与政策操作需求的脱节** 实验室与期刊文献往往具有碎片化特征，无法覆盖复杂政策的每一个操作细部；当面对具体教学次序与年级安排时，单纯依靠现有论文根本写不出完整的大纲条文。（pp. 1–3, 14）
> - **证据形态因制度任务而动态变换** 在政策的不同阶段，行动者所面临的制度门槛完全不同，证据因此呈现出完全不同的功能形态：从早期唤醒公众注意力的象征符号，演化为起草期排除政客干预的技术盾牌，最终在表决期收敛为务实的条款比对清单。（pp. 18–19）

> [!phase] 证据形态跨越决策全周期的三阶段按需演化模式
>
> - **议程设置阶段（用宏观指标和价值故事敲开大门）**
>
>   客观的统计数字不会自动变成行动。决策者动员全美统考成绩悬殊反差和国际测评落差等宏观指标，同国家经济安全与教育公平等两党核心关切深度绑定，用来击穿维持现状的制度惰性，唤醒全社会的危机感与变革共识。（pp. 8–11）
>
> - **方案设计阶段（用实证旗号当盾牌，靠专家推导与教师常识填补空白）**
>
>   高举以实证为依据的崇高旗号，实质上是为了筑起一道防范政客和利益团体夹带私货的去政治化防火墙；面对初高中缺少对照实验的现实空白，起草团队主要依靠数学家的内在学科公理推导，以及一线名师把条文贴在墙上反复推敲课堂可行性的实践经验，才完成了条文定稿。（pp. 13–16）
>
> - **法定采纳阶段（学术论文全面隐退，靠微观对标清单与财政激励快速过关）**
>
>   到了各州教育委员会表决关口，厚重的学术论文基本退出辩论现场。地方官员既无时间也无精力重读基础文献，他们只看一份简明扼要的逐条对照表（Crosswalks，比对新老标准的具体差异），并在联邦数亿美元资金激励下，将学术审读责任信任地让渡给国家级验证专家，火速举手表决。（pp. 16–18）

#### 2. 学术研究自身充满模型与方法分歧，无法充当绝对客观的唯一裁判
...
> 科学研究并非一台输入数据就能自动吐出唯一真理的机器，它本身充斥着计量模型假定与取样视角的争论。因此，负责任的循证决策绝不是消极等待学术界达成毫无分歧的终极共识，而是决策者在不确定性之中，综合专业常识、教师经验与社会核心价值作出的审慎权衡。（pp. 19, 21–22）

#### 3. 真实决策机制的核心逻辑：学术论文、教师经验与政治价值的三元共生网络

学者卡罗尔·H·韦斯（Carol H. Weiss）早就指出，研究对政策的作用更多是潜移默化的启蒙，而非立竿见影的工程图纸；通用标准案例进一步厘清了三者共生的微观因果机制。（pp. 18–19）

> [!chain-link] 现实中循证决策的运转链条
> - **现实前提 决策环节决定了证据需求** 在敲开议题大门、坐下来起草条文以及各州举手表决三个不同关口，行动者面对的制度[[Gatekeepers|把关人]]、政治压力和时间限制完全不同，不可能用同一种证据解决所有问题。（pp. 2–3, 6）
> - **核心机制 多源证据在功能上紧密互补** 学术研究提供宏观警示与去政治化盾牌，但存在细分操作空白；一线教师的课堂常识确保条文切实可行而不至于悬空；政治价值话语则赋予方案社会正义感，吸引政治同盟。（pp. 13–16, 19）
> - **理论结论 科学证据是沟通与信任的纽带** 科学证据在政策中不仅是一套分析工具，更是一种动员多方同盟、建立跨党派信任的战略资源。唯有将实证研究、一线专业经验与主流政治价值有机缝合，循证改革才能穿透错综复杂的现实政治阻力。（pp. 18–19）
