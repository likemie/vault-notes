...
> - "[[Business as Usual\|照常教学]]"（business as usual）比较——未指定的比较组——在不同研究中的含义完全不同
...
>
> **教育中的表现(pp.9–10)**
> - 大量纳入元-元分析的研究故意使用范围限制样本：选择在[[Pre-test and Post-test\|前测]]中失败的(Hornblum & Overton, 1976)、高于特定水平的(Neenan & Routh, 1986)、低前测和高前测分组的(Lacher, 1983)
> - 反馈元分析中许多研究按与结果高度相关的标准选择样本，但未进行任何范围限制调整
> - Li & Ma (2010) 将特殊需要学生样本中更高的效应量解释为"技术对特殊需要学生更有效"，而非考虑范围限制效应
>
> **系统性含义** 反馈和[[Metacognition\|元认知]]研究中容易选择限制范围的样本（如前测失败者），但延长学校日或校服研究中没有明显的方法限制样本范围。结果是反馈研究的效应量系统性地更高——不是因为反馈更有效，而是因为更容易在限制范围上进行研究(p.11)。
>
...
> - Abrami et al. (2008) 在[[Critical Thinking\|批判性思维]]元分析中发现：标准化测试的平均效应量为 0.24，非标准化（通常是研究者自编的）测试为 0.53
...
>
> **模拟证据(p.13, Figure 3)**
> - 对于 [[Cronbach's Alpha\|Cronbach's α]]=0.75 的测试，2 题替代 1 题膨胀效应量 ~20%，20 题使效应量翻倍以上
...
> ("Areas which rank highly in Marzano (1998), Hattie and Higgins et al. are those in which researchers can design more sensitive experiments.") (p.2)
>
...
> ("The numerical summaries used to develop the toolkit (or the alternative 'barometer of influences': Hattie 2009) are not a measure of educational impact.")
>
