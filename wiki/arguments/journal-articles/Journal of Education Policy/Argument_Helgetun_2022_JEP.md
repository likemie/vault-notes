---
summary: "通过对英格兰教师教育政策文本的文献分析与精英访谈，结合新制度主义合理化神话视角，揭示2010年后政策话语从测量时代转向证据时代，但科学引用与国际借用背后仍受适宜性逻辑与政府把关机制制约"
type: argument
authors:
  - "[[Jo B. Helgetun|Helgetun, J. B.]]"
  - "[[Ian Menter|Menter, I.]]"
source_language: en
...
year: 2022
doi: "10.1080/02680939.2020.1748722"
citation_aliases:
  - "Helgetun & Menter, 2022"
  - "Helgetun & Menter (2022)"
isbn: ""
tags:
...
related_arguments: []
sources:
  - "[[sources/Helgetun_2022_JEP|Helgetun_2022_JEP]]"
part_of: ""
status: draft
created: 2026-09-16
updated: 2026-09-17
...
title: "Argument_Helgetun_2022_JEP"
...
> | 理论工具 | 解释功能 |
> |---|---|
> | **合理化神话**<br>[[Rationalized Myth]] | 组织社会学与新制度主义概念（Meyer & Rowan, 1977；Scott, 2013），解释证据如何作为广泛共享、不证自明的文化认知框架为教师教育政策赋予正当性。（pp. 89–90） |
> | **新公共管理**<br>[[New Public Management]] | 提供投入产出核算与性价比（value for money）的治理逻辑底座，推动政府通过外部证据与远程监控重塑教师专业规范。 |
> | **适宜性逻辑与后果性逻辑**<br>[[Institutional Isomorphism]] | 揭示由于未来后果存在不确定性，政策选择在本质上服从于特定情境下被认为在社会与政治上适宜的规范，而非纯粹基于因果后果推导。（p. 92） |

> [!warrant]- 理论如何支撑论证
> 新制度主义理论表明，文化认知、制度规范与具体政策之间存在相互建构的共生关系。当证据被建构为一种制度性合理化神话后，政策文本采纳学术引文与实验设计修辞便成为组织获取合法性的仪式化手段。这解释了为何即使实证证据存在情境局限或方法缺陷，仍能被政策制定者迅速动员为正当性工具。（pp. 91–93）
...
> | 模块 | 材料与处理方式 |
> |---|---|
> | **政策文献分析**<br>[[Documentary Analysis]] | 收集 1983 年[[Committee for the Accreditation of Teacher Education\|教师教育认证委员会]]（Council for the Accreditation of Teacher Education, CATE）首次提出至 2019 年间英格兰教师教育领域 46 份核心政策文件、白皮书与法定规程，使用 MAXQDA 质性分析软件进行引文溯源、词频检索与文体编码。 |
> | **精英访谈**<br>[[Elite Interview]] | 针对 20 位具备深度内部准入资格的行动者（包括英国教育部高级公务员、部长外部顾问、智库负责人、教师专业团体领袖与大学学者）开展开放式[[In-depth Interview\|深度访谈]]。 |
> | **循环三角互证**<br>[[Triangulation]] | 在经验资料、政策[[Document\|文献]]、理论框架与田野现实之间进行循环往复的比对检验，交叉验证正式政策叙述与幕后决策机制。（p. 91） |
...
> | **A7** | 英国教育部（Department for Education, DfE）高级公务员 | 政策制定核心官员，掌握白皮书起草与引文决策机制 |
> | **A8** | 国家教育事务公职人员 | 负责教育政策统计与执行监督 |
> | **A9** | 教育利益组织雇员 | 专业团体政策倡导与意见反馈中介 |
> | **A10** | 教育学研究者 | 关注循证教学与实证研究方法应用 |
> | **A11** | 多学院信托（Multi-Academy Trust, MAT）与 SCITT 负责人 | 深度参与[[Teaching Schools\|教学学校联盟]]实践 |
> | **A12** | 英国教育部高级公务员、前培训与发展署（Training and Development Agency for Schools, TDA）官员 | 政策透明度与白皮书学术化引证的推动者（p. 91） |
> | **A13** | 英国教育部高级公务员、前 TDA 官员 | 长期见证英国教师培训官僚机构重组与职能演变 |
> | **A14** | MAT 与 SCITT 负责人、外部政府顾问 | 提出政策如何落地核心命题的知情人（p. 94） |
> | **A15** | 教育学研究者 | 跟踪教师劳动力市场与政策效果评估 |
> | **A16** | 大学学者、政府顾问 | 兼顾学术生产与官方咨询的双栖专家 |
> | **A17** | 罗素大学集团资深学者 | 深度介入英国教师教育政策制定的学术领袖 |
> | **A18** | 大型 MAT 的 ITT 与教师持续专业发展（Continuing Professional Development, CPD）负责人、前 Teach First 雇员 | 积极倡导与政府建设性合作、参与近期圆桌会议的改革派 |
> | **A19** | 英国教育部公务员 | 揭示政策引用依赖中介引荐而非直接阅读原著的知情人（p. 95） |
> | **A20** | 教师工会政策顾问 | 代表一线教师利益群体参与政策博弈 |
...
> ```mermaid
> flowchart TD
>     subgraph S1["第一阶段：合法化修辞演化"]
>         A1["1983–2010 测量时代<br>内部审查与 Ofsted 数据监控"] --> A2["2010 证据时代爆发<br>学术期刊引文与国际借用 (芬兰/新加坡)"]
>     end
>
>     subgraph S2["第二阶段：政治把关与适宜性逻辑"]
>         B1["英国教育部守门人机制<br>筛选顾问与扶植官方代理机构"] --> B2["政策落地考量<br>基于政策的证据制造 (PBEM)"]
>     end
>
>     subgraph S3["第三阶段：流通过程与认识论消解"]
>         C1["中介网络与社交媒体 (Twitter/博客)<br>口口相传取代系统文献审查"] --> C2["认识论链条断裂<br>去语境化操作指令与伪科学风险"]
>     end
>
>     S1 --> S2
>     S2 --> S3
...
### 论证步骤一　政策合法化话语从单一数据测量迈入全方位证据时代

> [!claim] 步骤一核心主张
> 2010 年联合政府执政后，英格兰教师教育政策文本在引用模式与论证策略上发生了质的演进，合法化[[Paradigm|范式]]超越了以大规模测验和审计为特征的测量时代，转向以密集学术引文、国际经验与因果实验为标志的[[Evidence Era|证据时代]]。（pp. 90–92）

#### 1. 政策白皮书引文实践的爆发式增长与学术化转向

在 2010 年之前，政策文件的论据来源高度封闭且不透明，正当性主要依赖政府内部科层权威。1983 年白皮书《教学质量》（DES 1983）仅包含 7 条参考[[Document|文献]]，且全为内部督学报告与委员会文件；此后至 2010 年间的 46 份核心政策文件中，仅有 1989 年的第 24/89 号通令列出 5 条引文，其余文件均未附带明确参考文献。
...
> |---|---|---|
> | **可追溯引文数量** | 仅 7 条参考文献（全部为内部委员会报告、皇家督学署 HMI 督导报告或皇家学会报告） | 仅教师教育专属章节即包含 34 条引文，通篇密集引证（pp. 91–92） |
> | **文献来源构成** | 局限于教育部体系内部视导与行政调查成果 | 涵盖大学学者同行评议期刊、商业调研、国际组织与英国广播公司（BBC）媒体报道 |
> | **合法化修辞基准** | 官僚科层与皇家督学署的行政法定权威 | 类似学术论文的标准引文格式与实证科学透明性 |
> | **对证据类型的区分** | 侧重内部系统调查结论 | 未对严谨同行评议实证与非系统性媒体数据作[[Epistemology\|认识论]]区分 |

引文实践的激增并非单纯的形式改良，而是为了回应公众对政策合理性的质疑。通过模仿学术论文的引用规范，政府为政策文本披上了客观中立的科学外衣。

#### 2. 国际参照系的修辞动员与多样化证据借用

政策制定者不再仅仅依赖本国历史经验，而是大规模调动国际高表现教育体系作为改革正当性的背书。

> [!policy-design]- 国际借用与多样化证据动员机制
...
> - **证据范畴的多样化扩张** 证据超越了单一的量化测验，广泛吸纳了同行评议论文、医学临床实践类比、[[Education Endowment Foundation|教育捐赠基金会]]（Education Endowment Foundation, EEF）倡导的[[Randomised Controlled Trials|随机对照试验]]（Randomised Controlled Trial, RCT）以及[[Action Research|行动研究]]，构筑起主导性的[[Rationalized Myth|合理化神话]]。（pp. 90–91）

---

### 论证步骤二　政府把关与适宜性逻辑重塑证据生产与流通过程

> [!claim] 步骤二核心主张
> 证据进入政策[[Champ|场域]]的过程绝非纯粹客观的[[Technical Rationality|技术理性]]演进，而是受到英国教育部强力政治把关的建构；政策过程深度受制于政治适宜性逻辑，诱发了以迎合官员预期为首要考量的[[Policy-Based Evidence-Making|基于政策的证据制造]]。（pp. 93–95）

#### 1. 英国教育部作为守门人对专业声音与咨询审查的筛选

英格兰教师教育[[Policy Network|政策网络]]中，英国教育部扮演着绝对的[[Gatekeepers|守门人]]角色，通过选择性授权与机构创设来重构行业话语格局。

> [!actor-grid] 政策网络中被赋权的代言机构与审查机制
> - **官方扶持的专业团体** 政府积极支持创设[[Chartered College of Teaching|特许教学学院]]（Chartered College of Teaching, CCOT）与[[Teaching Schools|教学学校]]理事会（Teaching Schools Council, TSC），赋予其核心政策咨询地位，以此重塑符合官方意图的行业代言声音。（p. 93）
...
这种制度环境深刻形塑了参与政策咨询的学者与专家的心理预期，促使证据生产过程发生逆向异化。

#### 2. 政策如何落地与逆向证据生产

受访者直言不讳地指出，在撰写咨询报告与评估意见时，首要考量往往不是科学严谨性或最佳方案，而是内容能否顺利被政治家接纳。

> [!tension-table] 纯粹后果性逻辑与现实适宜性逻辑之深度博弈
> | 决策维度 | 纯粹后果性逻辑（技术理性假定） | 现实适宜性逻辑（政治合法性考量） |
> |---|---|---|
> | **研究关注重心** | 干预措施的真实因果机制与长远教育成效 | 政策文本能否在部长与官员那里顺利落地（p. 94） |
> | **对方法学缺陷的处置** | 揭示信效度不足并拒绝采纳不严谨结论 | 虽承认毫无[[Reliability\|信度]]与效度，但因具有启发性仍包装发布 |
> | **与官方偏好相悖的结果** | 坚持独立证据并要求政客修正政策方向 | 面临感谢提交但永不出版的冰冻搁置命运 |

> [!warrant]- 逆向证据生产的推理桥梁
> 适宜性逻辑的绝对统治，使得证据的功能发生了根本异化：它不再是引导政策探索的前提，而是变成了为预设政策立场背书的装饰品。决策者通过有针对性地裁剪、包装与定制材料，完成了从循证政策制定向[[Policy-Based Evidence-Making|基于政策的证据制造]]的逆向演变，深刻印证了学界在[[Critique of Evidence-Based Education|循证教育批判]]中对治理技术工具化的反思。（pp. 92–94）

---

### 论证步骤三　中介网络分化与新媒体环境下认识论严谨性的消解

> [!claim] 步骤三核心主张
> 高层官僚流动频繁、[[Policy Brokerage|政策中介]]网络分化以及社交媒体与博客圈的崛起，导致政策制定极度依赖非正式人际网络与口口相传，严重割裂了学术研究从构思到应用的认识论连贯性。（pp. 94–96）

#### 1. 公务员高流动率、社交媒体意见领袖与口口相传

政策网络内部的沟通机制并未伴随引文增多而变得更加制度化，反而呈现出高度碎片化与非正式化的特征。

> [!chain-link] 证据流通过程中的认识论链条断裂
> - **环节一：学术研究生产** 学者在严格的方法学限制、特定样本情境与认识论[[Hypothesis|假设]]下生产局部有效的实证知识。
> - **环节二：中介[[Transfer Translation Transformation|转译]]与新媒体扩散** 活跃于社交网络与博客圈的极少数意见领袖及政策经纪人对研究进行脱语境化提炼，剔除关键前置条件。（pp. 94–95）
> - **环节三：官僚口口相传与工具化引用** 教育部官员在公务员频繁轮岗的背景下，未直接研读原著，仅凭中介口头推荐将结论写入政策。
> - **环节四：实践指令异化** 复杂的教育科研最终被固化为缺乏因果严谨性与跨情境效度的机械操作清单。（p. 96）

#### 2. 重建全流程认识论连贯性与学界的反思责任

面对证据的政治异化与去语境化风险，作者强调必须维护从研究生产到政策应用的完整认识论链条。

> [!implication] 学术界与公共讨论的规范性启示
> - **全流程认识论连贯性** 连贯的科学逻辑必须贯穿研究构思、观察、分析到政策转化的全过程，严格遵循单项 RCT 等实证工具的外推边界。（p. 96）
> - **厘清真知与舆论界限** 明确区分经受严谨检验的科学知识（episteme）与流于表面的流行常识或政治教条（[[Doxa]]），防范伪科学泛滥。
> - **主动夺回证据话语权** 高校与学者不应退守象牙塔，而应积极投身博客与新媒体场域，以严密的方法论清晰度与政府[[Dialogue in Education|对话]]，既抵制荒谬言论，又积极指引科学的证据边界。
