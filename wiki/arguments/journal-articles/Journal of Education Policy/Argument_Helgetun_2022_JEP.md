...
> [!warrant]- 制度合法化修辞机制
> 白皮书引文规范的激增反映了新制度主义视角下的合法化机制变迁：通过在文本形式上系统模仿实证学术规范，政府为高度争议性的政策重组披上了客观中立的科学外衣，使采纳证据成为彰显治理现代性的制度仪式。（pp. 91–93）

#### 2. 国际标杆案例与多元实证工具被修辞化动员为超越本土经验的正当性依据
...
> [!warrant]- 口口相传机制下的证据异化逻辑
> 政策网络内部的沟通与决策并未随着引文增多而建立起制度化的同行审查机制，反而由于官僚系统的快速轮替呈现出高度依赖非正式人际网络的碎片化特征。频繁轮岗的公务员由于缺乏专业学科训练与阅读全篇研究的时间，极度依赖社交媒体上的意见领袖与博客博主进行二次转译。这种口口相传的信息流通模式剥离了原始研究的样本边界、方法局限与理论假设，导致政策采纳的研究成果退化为教条式的操作口诀。（pp. 95–96）
