...
> - **张力** 一阶元分析碎片化与区域或学科偏倚与二阶元分析宏观证据整合的张力；严格实验室[[Random Assignment\|随机分配]]实验（零效应）与真实课堂常态准实验（高效应）的[[Ecological Validity\|生态效度]]冲突；科学、技术、工程与数学（Science, Technology, Engineering, and Mathematics，[[STEM Education\|STEM]]）领域过度代表与软科学（语言、社会科）元分析极度匮乏的文献图景失衡。
