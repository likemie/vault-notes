...
> [!factors] 创造力相关因素的实证效应分级与机制深度拆解
> 1. **第一级：教育项目与教学干预（$r = 0.20$）**
>    - **量化效应与核心构件** 二阶效应量 $r = 0.20$（95% 置信区间 $[0.10, 0.29]$，95% 预测区间 $[-0.20, 0.54]$），在全部外部相关因素中位列第一；涵盖创造性问题解决复合包（$d = 0.74–0.77$）、普渡思维方案（$d = 0.47–0.63$）、数学与科学问题驱动教学（$g = 0.87$）、跨学科 STEAM 项目（$g = 0.76$）及显式指导语（$g = 0.53$）。
>    - **统计特征与理论含义** 统计显著不为 0，证实创造潜能具有高度的教育可塑性与教学响应度，彻底破除创造力纯属天赋不可教的宿命论。（p. 7）
> 2. **第二级：即时情境与环境影响（$r = 0.15$）**
>    - **量化效应与核心构件** 二阶效应量 $r = 0.15$（95% 置信区间 $[-0.07, 0.35]$，95% 预测区间 $[-0.35, 0.59]$），呈现中等关联系数；涵盖支持型领导（$r \approx 0.31$）、组织创新气候（$r \approx 0.22–0.30$）、团队认知多样性（$r \approx 0.16–0.26$）与挑战性任务压力。
>    - **统计特征与理论含义** 由于不同组织形态与具体任务情境间异质性极大导致置信区间跨越 0；外部情境是激活潜能的即时催化剂，但须以心理安全感为前提。（p. 8）
> 3. **第三级：外认知与心理倾向因素（$r = 0.14$）**
>    - **量化效应与核心构件** 二阶效应量 $r = 0.14$（95% 置信区间 $[0.06, 0.22]$，95% 预测区间 $[-0.24, 0.49]$），统计显著稳定不为 0；涵盖创造力[[Self-Efficacy|自我效能感]]（$r = 0.29–0.39$）、好奇心（$r = 0.30$）、内在动机（$r = 0.28–0.32$）、经验开放性特质（$r \approx 0.25–0.30$）、积极高唤醒心境（$r \approx 0.16–0.24$）与正念（$r = 0.22$）。
>    - **统计特征与理论含义** 效应强度与认知因素相当（$0.14$ vs $0.12$），证实创造力绝非纯粹冷认知，动机、情绪与自我信念构成了创造表现的核心心理动力引擎。（p. 9）
> 4. **第四级：认知基础与思维加工能力（$r = 0.12$）**
>    - **量化效应与核心构件** 二阶效应量 $r = 0.12$（95% 置信区间 $[0.04, 0.19]$，95% 预测区间 $[-0.27, 0.47]$），统计显著稳定不为 0；涵盖远距离联想与语义距离（$r = 0.23$）、基础智力与智商（$r \approx 0.17–0.22$）、心理表象能力（$r \approx 0.19–0.27$）、酝酿与顿悟解决（$d = 0.29–0.43$）及低潜抑制。
>    - **统计特征与理论含义** 为复杂重构提供信息加工支持；基础认知是创造力的必要非[[Necessary and Sufficient Conditions|充分条件]]，智力无法单独决定创造力表现。（p. 6）
> 5. **第五级：人口学与社会背景变量（$r = 0.07$）**
>    - **量化效应与核心构件** 二阶效应量 $r = 0.07$（95% 置信区间 $[-0.10, 0.25]$，95% 预测区间 $[-0.38, 0.49]$），效应最为微弱；涵盖性别差异（$r \approx 0.02–0.05$）、出生顺序、家庭规模与宏观社会经济地位。
>    - **统计特征与理论含义** 置信区间包含 0（统计不显著），强力支持全民创造潜能观，证实创造潜能非特定阶层或特权群体所专属。（pp. 7–8）
