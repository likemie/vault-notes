...
> [!spectrum] 一阶效应量强度分布谱系（Kraft, 2020）
> **← 弱关联（|r| < 0.16）**　·　**强关联（r > 0.31） →**
>
> - **微弱效应** 背景与总体创造力（r ≤ 0.10）
> - **较小效应** 认知与[[Divergent Thinking|发散思维]]（r ≈ 0.12–0.14）
> - **中等效应** 综合效应与教育干预（r ≈ 0.17–0.20）
> - **较强效应** 过程测量与预测源（r ≈ 0.27–0.29）
> - **强效应** 特定人格与干预亚组（r > 0.31）
