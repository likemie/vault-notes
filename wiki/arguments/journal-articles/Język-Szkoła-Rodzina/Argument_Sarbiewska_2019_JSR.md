...
> - 数据来源：政府报告、学术[[Document\|文献]]、[[PISA]] 数据、教育政策文件
...
> [!success] 主要发现
> - 新西兰和澳大利亚从传统教育模型转向证据本位模型，核心变化是对教学与学习关系的重新理解(p.122–123)
...
> - VL 面临两类批评：方法论批评（[[Effect Size\|效应量]]计算"统计上不复杂"）和理论批评（属于[[Radical Constructivism\|激进建构主义]][[Paradigm\|范式]]，导致教学本质的双重崩溃）(p.121–122)
