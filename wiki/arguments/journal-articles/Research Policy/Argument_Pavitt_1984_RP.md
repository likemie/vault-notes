...
> [!question]
> 不同产业在技术创新的来源、性质和影响上是否存在系统性的相似与差异？|基思·帕维特（Keith Pavitt）基于对英国 1945 年以来约 2,000 项重大创新（significant innovations）的数据分析，试图描述和解释**产业层面的技术变迁模式（sectoral patterns of technical change）**，并在此基础上构建一个分类法和一个理论。
...
> | 模块 | 材料与处理方式 |
> |------|----------------|
> | **创新计数分析**<br>Innovation Count Analysis | 基于 SPRU 数据库约 2,000 项英国战后重大创新，按产业、企业规模和类型分类 |
> | **描述性统计**<br>Descriptive Statistics | 比较不同产业的创新来源（内部研发 vs 外部供应商）、创新企业特征（规模、专业化程度）和创新使用部门 |
...
> - **产业差异性（varied amongst sectors）** 技术[[Source of Knowledge\|知识的来源]]和方向因产业而异

> 这一[[Epistemic Stances\|认识论立场]]直接推导出产业分类的必要性：如果技术知识在产业间根本不同，就需要一个分类框架来识别和解释这些差异。

> [!note]- SPRU 创新数据库
> SPRU（Science Policy Research Unit，科学政策研究所）数据库记录了约 2,000 项英国战后重大创新，按产业来源、企业特征（规模、主业活动）和创新使用部门分类。这一数据库是 [[Pavitt Taxonomy\|Pavitt 分类法]]的经验基础。数据库覆盖制造业约一半的两位数产业，在机械工程和金属方面有充裕的代表性，在纺织、化学和电子方面略有不足。创新被归入 11 个两位数产业类别和 26 个三四位数类别。

---

### 论证步骤二：三类分类法的经验证据

Pavitt 通过三个维度的系统比较——企业规模分布、技术多样化模式和创新来源与使用——将产业归入三个基本类别，其中生产密集型进一步拆分为两个子类，实际构成四类[[Analytic Framework|分析框架]]：

> [!line-a] 供应商主导型（Supplier Dominated）——纺织、农业、印刷、传统制造
> Table 3 的数据显示，纺织产业 56% 的创新来自 10,000 人以上的大企业，但按创新企业主业分类时这一比例降至 35.1%，而 1,000 人以下小企业的贡献高达 24.1%。这意味着大量纺织创新实际上由主业在其他产业的企业（即设备供应商）产生。这些产业的技术变迁主要来自外部：制造部门提供新设备、新材料和新组件，使用部门仅进行选择性的采纳和适应。Salter 的[[Hypothesis\|假设]]——技术进步等同于资本品相对降价——在此类产业中基本成立，因为用户确实主要通过购买设备来获取新技术。

> [!line-a] 生产密集型（Production Intensive）
...
> [!info] 三类分类法的统计基础
> 2,265 项创新的总体分布是：53.2% 来自 10,000 人以上大企业，21.9% 来自 1,000-9,999 人中型企业，24.9% 来自 1,000 人以下小企业。但这背后隐藏着巨大的产业间差异——机械和仪器工程的小企业创新贡献远高于平均水平，而化学和电子的大企业集中度远高于平均水平——这些差异不是随机的，而是结构性的。
...
> [!line-a] 用户需求（Requirements of Users）
> 不同产业的用户对创新提出不同类型的要求。专业化供应商的用户（通常是规模密集型企业）需要定制化的、能够解决特定生产问题的设备，这意味着供应商必须深度理解用户的工艺流程。规模密集型企业需要能显著降低单位成本或提高产能的流程创新。科学基础型企业的用户（包括政府和消费者）对产品性能有持续提升的要求，而对成本的敏感度相对较低。

> [!line-a] 专有可能性（Possibilities for Appropriation）
> 不同产业保护创新收益的能力根本不同。科学基础型企业可以通过专利、先发优势和持续的产品差异化保护创新收益。专业化供应商通过保密、设计复杂性和客户关系保护其专业知识——"创新常常是隐性的，嵌入在工程师的头脑和手指中"。供应商主导型企业难以从创新中获得独占收益，因为它们既无专利保护能力，也无独特的设计知识——它们的竞争优势来自价格和交付效率，而非技术独占。

---
## 主要发现

> [!finding-cards] 核心发现
> 1. **技术知识不是信息** 它是企业特定的、累积性的、因产业而异的。产业间的创新模式差异是结构性的，不是随机的
> 2. **三类基本类别，实际为四类** 供应商主导型、生产密集型（拆分为规模密集与专业化供应商两个子类）和科学基础型，构成了后续所有 [[Pavitt Taxonomy\|Pavitt 分类法]]研究的基础框架
> 3. **三个解释因素** 技术来源、用户需求和专有可能性共同塑造了产业间的技术变迁模式差异

---
## 自述局限

> [!warning]
> Pavitt 本人承认分类法的经验基础主要是英国制造业数据，对服务业的覆盖不足。分类法需要根据产业结构的持续变化进行更新——特别是 ICT 技术的崛起和服务业在经济中占比的持续上升。这些局限在 Bogliacino & Pianta（2016）的研究中得到了回应和部分解决。
