...
>
> | 模型设定 | 研究数 $k$ | Hedges' $g$ [95% CI] | 标准误 $SE$ | 显著性检验 $Z\ (p)$ | 异质性检验（$Q, I^2, \tau^2, \tau$） |
> |---|---|---|---|---|---|
> | **固定效应模型（Fixed Effect）** | 29 | 0.572 [0.504, 0.639] | 0.034 | $Z = 16.645\ (p < .001)$ | — |
> | **随机效应模型（Random Effects）** | 29 | **0.628 [0.446, 0.809]** | 0.092 | **$Z = 6.788\ (p < .001)$** | $Q(28) = 178.507^{***}, I^2 = 84.314\%, \tau^2 = 0.189, \tau = 0.435$ |
...
> <span class="concept-meta-analysis-table-marker" aria-hidden="true"></span>
>
> | 创造力构念子维度 | 效应数 $N$ | Hedges' $g$ [95% CI] | 标准误 $SE$ | 显著性检验 $Z\ (p)$ | 响应位次与效应特征 |
> |---|---|---|---|---|---|
> | **创造性思维（Creative thinking）** | 24 | **0.671 [0.439, 0.903]** | 0.118 | $Z = 5.675\ (p < .001)$ | 增益居首（发散认知激活） |
> | **图形创造力（Graphic creativity）** | 27 | **0.644 [0.439, 0.849]** | 0.105 | $Z = 6.153\ (p < .001)$ | 具象表达强增益（视觉重组） |
> | **词汇创造力（Words creativity）** | 16 | **0.641 [0.339, 0.943]** | 0.154 | $Z = 4.156\ (p < .001)$ | 远距离语义激活与重组 |
> | **言语创造力（Verbal creativity）** | 23 | **0.606 [0.407, 0.805]** | 0.102 | $Z = 5.966\ (p < .001)$ | 观念流畅性与非常规用途 |
> | **问题解决（Problem-solving）** | 10 | **0.539 [0.316, 0.762]** | 0.114 | $Z = 4.730\ (p < .001)$ | 中等稳健促进（结构突破） |
> | **情绪创造力（Emotional creativity）** | 9 | **0.397 [0.208, 0.587]** | 0.097 | $Z = 4.106\ (p < .001)$ | 低效应（非认知响应滞后） |
> | **合并子维度效应（Total effect size）** | 109 | **0.569 [0.480, 0.658]** | 0.045 | $Z = 12.544\ (p < .001)$ | 中等显著综合效应 |
...
>
> | 调节维度 | 亚组分类 | 效应数 $N$ | Hedges' $g$ [95% CI] | 标准误 $SE$ | 显著性检验 $Z\ (p)$ |
> |---|---|---|---|---|---|
