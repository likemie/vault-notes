...
> | Ritter & Mostert (2017, 荷兰) | AUT, RAT | 前后测设计（b: 替代训练） | < 1 周 | 小组协作 | 技术型训练 |
...
> | Lubart (2014, 法国) | EPOC | 实验组/对照组（b: 替代训练） | < 1 周 | 小组协作 | 综合训练 |
...
> | Karwowski & Soszynski (2008, 波兰) | TCI, TCT-DP | 实验组/对照组（b: 替代训练） | < 2 个月 | 独立练习 | 综合训练 |
...
> [!ma-table]- 不同创造力子维度的干预效应量分布（Table 2）
> <span class="concept-meta-analysis-table-marker" aria-hidden="true"></span>
>
> | 创造力构念子维度 | 效应数 $N$ | Hedges' $g$ | 标准误 $SE$ | 95% 置信区间 | 检验统计量 $Z\ (p)$ | 认知机制与效应特征 |
> |---|---|---|---|---|---|---|
> | **创造性思维（Creative thinking）** | 24 | **0.671** | 0.118 | [0.439, 0.903] | $Z = 5.675\ (p < .001)$ | 增益居首（发散认知激活） |
> | **图形创造力（Graphic creativity）** | 27 | **0.644** | 0.105 | [0.439, 0.849] | $Z = 6.153\ (p < .001)$ | 具象表达强增益（视觉拓扑重组） |
> | **词汇创造力（Words creativity）** | 16 | **0.641** | 0.154 | [0.339, 0.943] | $Z = 4.156\ (p < .001)$ | 远距离语义联想与概念重构 |
> | **言语创造力（Verbal creativity）** | 23 | **0.606** | 0.102 | [0.407, 0.805] | $Z = 5.966\ (p < .001)$ | 观念流畅性与非常规用途生成 |
> | **问题解决（Problem-solving）** | 10 | **0.539** | 0.114 | [0.316, 0.762] | $Z = 4.730\ (p < .001)$ | 中等稳健促进（突破不良结构） |
> | **情绪创造力（Emotional creativity）** | 9 | **0.397** | 0.097 | [0.208, 0.587] | $Z = 4.106\ (p < .001)$ | 低效应（非认知响应相对滞后） |
> | **全域合并效应（Total effect size）** | 109 | **0.569** | 0.045 | [0.480, 0.658] | $Z = 12.544\ (p < .001)$ | 综合中等显著促进效能 |
...
>
> | 调节变量与亚组分类 | 效应数 $N$ | Hedges' $g$ | 标准误 $SE$ | 95% 置信区间 | 检验统计量 $Z\ (p)$ | 效应特征与组间解释 |
> |---|---|---|---|---|---|---|
> | **训练周期** · < 1 周 | 37 | 0.576 | 0.078 | [0.424, 0.728] | $Z = 7.415\ (p < .001)$ | 快速策略启动（内化不足） |
> | **训练周期** · **< 2 个月** | 30 | **0.844** | 0.101 | **[0.647, 1.042]** | **$Z = 8.382\ (p < .001)$** | **黄金干预窗口（解释 13.4% 方差）** |
> | **训练周期** · < 4 个月 | 24 | 0.642 | 0.101 | [0.444, 0.840] | $Z = 6.356\ (p < .001)$ | 维持中高效应（技能巩固） |
> | **训练周期** · < 1 年 | 9 | 0.233 | 0.076 | [0.085, 0.381] | $Z = 3.083\ (p = .002)$ | 边际效用递减（教学常规化） |
> | **训练周期** · < 2 年 | 4 | 0.418 | 0.092 | [0.237, 0.599] | $Z = 4.518\ (p < .001)$ | 低水平平台期 |
> | **训练周期** · < 3 年 | 5 | -0.122 | 0.190 | [-0.493, 0.250] | $Z = -0.641\ (p = .522)$ | 习惯化定势（干预效应归零） |
> | **学段层次** · 本科生（Undergraduate） | 107 | 0.613 | 0.049 | [0.517, 0.709] | $Z = 12.502\ (p < .001)$ | 绝大多数实证样本基准 |
> | **学段层次** · **研究生（Graduate）** | 2 | **0.991** | 0.267 | **[0.468, 1.515]** | **$Z = 3.712\ (p < .001)$** | **高阶思维与专业知识积累增益** |
> | **组织形式** · 小组协作（Group） | 61 | 0.567 | 0.054 | [0.462, 0.673] | $Z = 10.539\ (p < .001)$ | 易受生产力阻塞与从众影响 |
> | **组织形式** · **独立练习（Alone）** | 48 | **0.682** | 0.092 | **[0.501, 0.863]** | **$Z = 7.375\ (p < .001)$** | **独立沉思与无干扰专注优势** |
> | **训练方式** · **言语训练（Verbal）** | 15 | **0.998** | 0.286 | **[0.437, 1.560]** | **$Z = 3.485\ (p < .001)$** | **增益居首（语言符号即时外化）** |
> | **训练方式** · **思维训练（Thinking）** | 13 | **0.762** | 0.149 | **[0.469, 1.055]** | **$Z = 5.102\ (p < .001)$** | **发散思维与元认知监控驱动** |
> | **训练方式** · 任务型训练（Task-based） | 5 | 0.685 | 0.195 | [0.302, 1.068] | $Z = 3.503\ (p < .001)$ | 真实工程挑战与跨学科项目 |
> | **训练方式** · 技术型训练（Technique-based） | 20 | 0.552 | 0.121 | [0.314, 0.789] | $Z = 4.550\ (p < .001)$ | 创新技法工具箱（TRIZ/SCAMPER） |
> | **训练方式** · 综合训练（Combined） | 54 | 0.513 | 0.053 | [0.410, 0.617] | $Z = 9.728\ (p < .001)$ | 多模态融合（认知负荷略高） |
> | **训练方式** · 情绪训练（Emotional） | 2 | -0.066 | 0.171 | [-0.401, 0.269] | $Z = -0.384\ (p = .701)$ | 非认知调适脱离任务支架无效 |
...
> - **< 3 年（g = -0.122, 不显著）** 认知定势重构与注意力耗竭，干预效应归零
