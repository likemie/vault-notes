...
这篇论文追问：芬兰 [[Phenomenon-Based Learning]] 的历史与哲学根源是什么？为什么它既不是新发明，也不能只从建构主义、PBL 或 IBL 来理解？作者希望通过芬兰案例说明，PhBL 的整体教育潜力与当代测量/问责政策之间存在内在张力（Schaffar & Wolff, 2024, pp.1-2）。
...
- 建构主义 / PBL / IBL — 用于说明芬兰 PhBL 在教育心理学中的近代发展，尤其是 Rauste-von Wright 的实用主义建构主义（Schaffar & Wolff, 2024, pp.7-8）。
...
1. **PhBL 的"现象"概念需要哲学澄清**：现象学传统说明，现象不是一个中立对象，而是人与生活世界、身体、情绪和他人关系中的意义生成对象（Schaffar & Wolff, 2024, pp.2-3）。
...
3. **芬兰 PhBL 同时继承大陆教育哲学和教育心理学**：它既有 [[Bildung]] 与 [[Didaktik]] 的开放未来和时代关键问题传统，也有 Rauste-von Wright、Dewey、Mead、PBL 和 IBL 的建构主义学习资源（Schaffar & Wolff, 2024, pp.5-8）。
...
- 芬兰课程仍然按传统学科组织，并未用 PhBL 取代学科；国际上"芬兰取消学科"的说法是误读（Schaffar & Wolff, 2024, p.2）。
- PhBL 在芬兰课程文本中的术语地位并不稳定：芬兰语原版不直接使用"phenomenon-based learning"，但大量使用"phenomenon/ilmiö"及相关表达（Schaffar & Wolff, 2024, p.2）。
- Rauste-von Wright 在 1990 年代末推动芬兰 PhBL 发展，她把 Dewey 和 Mead 整合为实用主义建构主义，并把 PhBL 称为"课程的自我修正模型"（Schaffar & Wolff, 2024, pp.7-8）。
...
- 论文不是实证评估，不能回答 PhBL 对学生学习结果、教师实践或学校组织的具体效果。
- 作者采用哲学与规范性批判立场，强项是澄清概念和政策张力；弱项是没有系统比较不同学校的 PhBL 实施模式。
- 对建构主义、PBL 和 IBL 的处理主要服务于思想史定位，没有展开这些学习理论内部差异。
