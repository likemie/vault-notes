...
> - **教学模型的政治解读** Hattie 描绘的是"一种现代化和精致的权威性、教师中心教学形式"——教师处于支配地位但以学生中心的方式"驯化或隐藏其支配"(p.434)。"传统的、公开的治理和支配形式已转变为一种精致的、不可见的、现代的形式。如果我们把它放在 Foucault 思想的语境中，这是显而易见的"。视觉隐喻——"互看、互见、互相被观察"——被置于教与学理论的中心，其象征是眼睛(p.434, Figure 2)。
> - **[[Evidence-Based Education|证据本位教育]]的根本困境** "元分析是能够将来自复杂研究领域的结果或多或少地压缩的工具。如果一个领域已经有多个元分析怎么办？……一个更适当的策略是改变层次，组合元分析，尝试开发一个元-元分析（mega-analysis）。参照范围确实扩大了，但同时也变得更加复杂、混乱和充满不一致。……通过反复累积，原始的详细经验信息消失"。
>
> 3. **结论** Hattie 没有找到圣杯。他正在建造一个巨大的金字塔——"一方面稳固地放置，已经具有相当大的宽度和高度和相当稳定的形式……另一方面，金字塔在某些部分不断被修复，且……在其所有维度上不断被扩展"。这是**稳定性假说**（进一步研究将提供相似结果，继续累积只是渐近逼近已知结论）与**变异性假说**（某些领域的发现已经过时，新的和不同的结果已出现）之间的根本困境。
...
>
> > "由于他的[[Meta-meta-analysis|元-元分析]]同时支持稳定性假说和变异性假说，很明显 Hattie 事实上没有找到研究学校、教学和教师的圣杯。"
