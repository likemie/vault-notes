...
> - 范围：Hattie (2009) *[[Visible Learning]]* 全书及其新西兰政策背景
...
>    - **[[Didaktik|教学理论]]批评**：Hattie 的教学理论建立在 Bereiter 对 [[Karl Popper|Popper]] 三个世界理论"联想式和非传统"的使用之上(p.430-431)。其对学习的理解是形式上的——[[Bildung]] 的物质面（教育的实质内容）被忽略：""教育不仅是教人思考——也是教人值得学的东西"(p.27)。这可能是一个起点……但 Hattie 没有沿着这条可能的思路走下去"(p.430)。课程内容问题"被完全忽略"(p.431)。
>    - **教学模型的政治解读**：Hattie 描绘的是"一种现代化和精致的权威性、教师中心教学形式"——教师处于支配地位但以学生中心的方式"驯化或隐藏其支配"(p.434)。"传统的、公开的治理和支配形式已转变为一种精致的、不可见的、现代的形式。如果我们把它放在 Foucault 思想的语境中，这是显而易见的"(p.434)。视觉隐喻——"互看、互见、互相被观察"——被置于教与学理论的中心，其象征是眼睛(p.434, Figure 2)。
...
> - **纳入标准不透明**：Hattie 未提供选择元分析的质量标准——"大概，Hattie 拉入了所有可及的元分析，但它们每个可能有且确实有不同的针对个体研究的严格纳入标准"(p.429)。
> - **[[Didaktik|教学理论]]局限**：Hattie 使用 [[Karl Popper|Popper]] 的三个世界理论"以一种相当联想和顽固的方式穿越学习理论领域"，但与德国 [[Bildung]] 概念有可关联之处——然而 Bildung 的实质面被忽略(p.430-431)。
...
>
> > "由于他的[[Meta-meta-analysis|元-元分析]]同时支持稳定性假说和变异性假说，很明显 Hattie 事实上没有找到研究学校、教学和教师的圣杯。"(p.436)
