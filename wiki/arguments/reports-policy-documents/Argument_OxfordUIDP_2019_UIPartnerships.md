...
> - 大学通过参与标准制定间接促进新技术的扩散——标准在创新系统中发挥重要的技术扩散作用
>
> 峰会代表还指出了重要的**网络效应**（network effects）：前沿内部企业看到越多同行采用新技术、与大学合作，自己越可能跟进——这意味着早期的成功案例具有超出自身的扩散价值（pp.18–19）。
