...
> [!abstract]
> 本章为理论讨论／文献综述，未采用单一实证理论框架。Ryan 综合运用以下批判性概念作为分析工具：
...
**例：** 澳大利亚大学里 24% 的学生是国际学生，主要来自中国和儒家文化圈国家（Ryan, 2010, p.38）。老师们每天面对这些学生，但他们依赖的"中国学习者指南"往往还是 1990 年代的刻板描述。就像用 1990 年的手机说明书来操作今天的智能手机——工具和对象已经变了，说明书却原地踏步。
...
**例（Ballard & Clanchy 案例）：** Ballard 和 Clanchy（1991, 1997）的著作在澳大利亚大学图书馆中是被翻阅最多、标注最多的国际学生参考书。Ryan（2010, p.41）亲自检查了这些书的标注状况：被划线和折角最严重的地方，恰恰是描述 CHC 学习者"缺乏什么"的那些段落。而 Ballard 和 Clanchy 原文中其实明确警告过不要刻板化——但这些警告的段落几乎没有被标注。学者们有选择性地只看到了"缺陷"，忽略了"谨慎"。

> 这说明刻板印象的再生产不是简单的"有人写了偏见"，而是一个更微妙的机制：**即使是试图平衡的学术著作，读者也会带着先入之见去有选择性地吸收**——他们看到了自己期待的"差异"和"不足"，而对复杂性和谨慎置之不理。
