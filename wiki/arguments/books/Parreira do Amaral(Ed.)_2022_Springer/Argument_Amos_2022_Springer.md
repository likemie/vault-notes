...
>
> 整章的论证结构可理解为三次对比：**过去 vs 现在**（从国家中心到市场中心）、**技术路径 A vs B**（超人类主[[Rightness|义]] vs 后人类主义）、**描述 vs 规范**（正在发生什么 vs 我们希望教育走向哪里）。
>

## 理论框架

> [!abstract] 理论框架
> - [[Transitology]] — Cowen (1996, 2000) 的转型学概念是整章的分析骨架：教育在宏观社会转型中扮演"摧毁过去、重新定[[Rightness|义]]未来"的象征性和重构性角色。Amos 以此判断：从国家中心到市场中心的教育关系转变，就是当下的 transitology（Amos, 2022, pp.53–54）
...
>
> **(2) 正[[Rightness|义]]与平等（Justice and Equality）**：这看起来令人意外——数字化怎么可能跟正义有关？但 UNESCO 的逻辑是这样的：虽然开发数字教材和格式的前期成本很高，但一旦开发完成，它们可以被几乎无限复制和适配（anytime, anywhere 原则）。对于缺乏实体校舍的地区，数字教育是唯一的选择。
>
...
>
> 1. **以生命[[Luhmann's Systems Theory|系统理论]]理解和应对 wicked problems**——不是将问题简化为单个变量
...
>
> Haraway 的生活伴侣 Rusten Hogness 创造了一个词：**[[Humosity]]**（腐殖性）——描述一个人类被彻底去中心化的世界，人类的生死不过是巨大的物质循环中的一环，就像森林地面上腐殖质的形成和分解（Amos, 2022, p.62）。这个形象虽然令人不适，但它[[Jing (Refined Mastery)|精]]确地表达了后人类主义与超人类主义的分界线：超人类主义追求被增强的人类站在宇宙中心；后人类主义则把人类放回生态系统中，只是众多物种之一。
>
...
> ### Cowen 双轴模型的诊断力
>
> Cowen (1996, pp.160–162) 的双轴模型[[Jing (Refined Mastery)|精]]确地标示了现代教育→晚期现代教育的结构转型。关键转型参数：纵轴从 polis-driven 到 market-driven，核心价值从"教育机会平等"到"内部效率与外部效能"，合法性基础从"国家文化认同"到"劳动力分化"（Amos, 2022, p.55）。
>
> ### 知识市场化的时间深度
>
...
> ### 数字化的三重不可逆驱动力
>
> 利润（Google/Apple/Microsoft 的教育部门、EdTech 股票市场、Coursera/Udacity）、正[[Rightness|义]]平等叙事（UNESCO 的 anytime/anywhere 逻辑）、专业发展（[[Learning Analytics|学习分析]]、个性化学习）同时推动数字化。这三重逻辑相互强化，使"去数字化"日益不可能——即便认识到数字化的不平等效应（Amos, 2022, pp.56–58）。
>
...
> [!warning] 局限性与批评
> - Amos 自认 §4.5 [[Posthumanism|后人类主义]]部分属于"高度推测"（highly speculative），Haraway 和 Escobar 均未将教育作为论述重点，教育与后人类主[[Rightness|义]]的对接仍是开放问题（Amos, 2022, p.61）
