...
>
> 超人类主义的核心信念是：人类的生物局限（寿命、认知能力、体能）不是既定的——它们可以通过技术被超越。"人类物种可以超越自身——不是零星的，而是一整个地、作为人类整体来超越"（[[Julian Huxley]], 1957, p.17, p.59）。这个定义有两个关键点：一是声称的**普遍性**（对全人类开放），二是其**乌托邦色彩**（"作为整体"的超越）。
>
...
> 核心工具是"设计"——不是在"设计一把更好看的椅子"的意义上，而是在"如何应对 wicked problems"的意义上。所谓 wicked problems（棘手问题）指气候变化、不平等、殖民遗产等无法被单一学科或单一行动领域解决的问题。转型设计的核心洞见是：**转型不是被设计出来的，而是涌现的**——它依赖大量地方行动的交互，没有中央计划者来"指挥"这个过程(Escobar, 2018, p.152, p.61]])。
>
...
>
> Amos 还引入了第三个概念资源：Simone Weil 的 **[[Mondialisation]]**（世界化），作为对 globalisation（全球化）的替代。比利时生物学家 Ovide Decroly 在 1929 年创造"全球化"一词时，本意是一种**认知功能**——在不预先知道各组成元素的情况下，整体把握现实的能力。这个含义后来被市场和劳动力灵活化的含义覆盖了。Mondialisation 试图恢复这个被遗忘的含义：将星球视为一个整体，尊重生命的多元形式(Supiot, 2019, p.61)。
>
