...
>
> > 例：今天欧洲关于难民儿童入学权的争论，就是这一历史逻辑的当代回响。如果你的父母没有合法居留身份，你是否"属于"这个国家的公立教育系统？这个问题之所以如此棘手，正是因为现代教育的 DNA 里就[[Coding in Qualitative Research|编码]]了"内外之分"。(p.55)
>
...
> - 横轴右端：国际知识竞争
>
> > 例：想象今天一所英国大学——纵轴上端不再是"如何让更多人上大学"，而是"我们的排名多少、毕业生就业率多高、每个学生的培养成本多少"。纵轴下端"劳动力分化"意味着教育不再追求统一的公民身份，而是根据市场需求将学生分流到不同层级和类型的岗位。[[School Autonomy|学校自主权]]改革（学校为自己的"竞争力"负责）和跨国排名系统正是这个新模型的操作工具。(Cowen, 1996, pp.160–162; [[Argument_Amos_2022_Springer|Amos, 2022, p.55]])
>
...
>
> > 例：Sputnik Shock 是理解"教育和地缘政治如何始终纠缠"的经典案例。1957 年苏联先于美国把卫星送上太空，美国举国震惊。反应是什么？不是增加军费（那是后来的事），而是大规模改革科学教育和数学课程——因为决策者相信，苏联的"知识优势"来自更好的教育。这就是 Amos 所说的"早在市场话语流行之前，经济与知识的关联已被锻造"。(p.56)
>
> Amos 还借德国小说家 Günther Grass 的自创词 **[[Vergegenkunft]]**（Vergangenheit/Gegenwart/Zukunft = 过去/现在/未来的合成词）来说明：过去、现在和未来并非线性排列，而是彼此纠缠。你无法理解今天的 [[Educational Technology Industry]] 热潮，除非你看到 1950 年代的"知识=生产力"话语和 Sputnik 之后 OECD 对 STEM 的持续关注(p.56)。
>
...
>
> > 例：撒哈拉以南非洲的偏远村庄可能没有合格的物理教师，但如果有一部能上网的手机，学生就能观看可汗学院或 Coursera 的物理课程。"Anytime, anywhere"在理想情况下是包容性的——不需要全日制在校，不需要固定时间表，对有工作、有家庭责任的学生尤其有益。但 Amos 紧接着指出，这个叙事的盲点是基础设施：没有稳定电力和网络，"anytime, anywhere"就是空话。(p.57)
>
...
>
> > 例：Natasha Vita-More 的"身体设计"（body by design）项目是超人类主义的典型表达——不满足于健身和营养来改善身体，而是主张通过技术干预"重新设计"身体。在教育领域的类比是认知增强（cognitive augmentation）：不是通过学习来提升思维能力，而是通过神经技术或药物直接增强大脑功能。如果这种技术只对能支付得起的人开放——显然如此——那么"全人类一起超越"的宣称就只是修辞。(p.58)
>
> Amos 将超人类主义定位为**高度现代性（high modernity）的激进延续**：它把现代性的核心梦想——不朽、理性、自主、"做自己命运的主人、设计自己的模样"——推到了逻辑终点。而这一梦想的历史渊源值得注意：Julian Huxley——UNESCO 的第一任总干事——既是科学人文主义和优生学的倡导者，也是人权的推动者。超人类主义的"普世"宣称与优生学传统之间存在着令人不安的连续性(p.59)。
>
...
>
> Amos 接着指出，超人类主义与 Cowen 的**市场驱动模型**高度兼容：它是 hyper-individualist 的（每个人自己做自己的优化项目）、成本密集的（只有少数人能支付顶级增强技术）、以"劳动力分化"为教育目标的（不是培养平等公民，而是培育不同层级的"增强型"劳动者）。如果超人类主义成为主导，我们将看到高端全球 EdTech 产业设定教育标准和节奏(pp.58–59)。
>
> ### 第五步：描绘第一种愿景的后果——教育愿景 I（§4.4.1）
>
> Amos 随后给出一个推测性预测：**大众教育的权威将持续弱化**。COVID-19 疫情期间的全球"居家学习"实验是一个意外加速器——当家庭教育（home schooling）突然成为全球现实，国家作为教育组织者和认证者的地位就受到了挑战(p.59)。
>
...
>
> 更根本的是，**教育的"成员身份创造"功能在弱化**。大型公立学校承担着最重要的社会化任务——把年轻人培养成公民、培养他们对"共同善"的担当。但如果未来教育变成了高度个性化的微证书和自导学习路径的拼贴，那么"共同经验"在哪里？民主社会需要公民共享的基础知识和公共叙事，而超个性化的教育对这一基础构成威胁(pp.60–61)。
>
...
> 核心工具是"设计"——不是在"设计一把更好看的椅子"的意义上，而是在"如何应对 wicked problems"的意义上。所谓 wicked problems（棘手问题）指气候变化、不平等、殖民遗产等无法被单一学科或单一行动领域解决的问题。转型设计的核心洞见是：**转型不是被设计出来的，而是涌现的**——它依赖大量地方行动的交互，没有中央计划者来"指挥"这个过程(Escobar, 2018, p.152; [[Argument_Amos_2022_Springer|Amos, 2022, p.61]])。
>
...
>
> Haraway 将她的核心概念命名为 **sympoiesis**（共同制造）——与 [[Humberto Maturana]] 和 [[Francisco Varela]] 的 **[[Autopoiesis]]**（自我制造）形成对照。Autopoiesis 强调生命系统是自我指涉、自我生产的；Sympoiesis 强调生命只能通过"与他人一起"来生产——"回应彼此的需求"，也就是 **[[Response-ability]]**（既是"responsibility"责任，也是"ability to respond"回应的能力）(p.62)。
>
...
>
> Haraway 的生活伴侣 Rusten Hogness 创造了一个词：**[[Humosity]]**（腐殖性）——描述一个人类被彻底去中心化的世界，人类的生死不过是巨大的物质循环中的一环，就像森林地面上腐殖质的形成和分解(p.62)。这个形象虽然令人不适，但它精确地表达了后人类主义与超人类主义的分界线：超人类主义追求被增强的人类站在宇宙中心；后人类主义则把人类放回生态系统中，只是众多物种之一。
>
...
>
> 她给出两个相互加强的解释：第一，大众教育——无论是国家中心还是市场中心——是问题的**一部分**而非解决方案。它的 DNA 里编码了竞争、增长和"粗野个人主义"（rugged individualism），正是制造了 Haraway 和 Escobar 所批评的全球问题的那种心态。第二，他们似乎**把社会化视为理所当然**——教育会随着共同体的转型而自动发生(p.63)。
>
...
>
> Amos 并没有简单地否定大众教育。她明确指出：**大众教育是现代性的重大成就之一**——它创造了一个公共领域，在其中教什么、怎么教是可以被观察、批评和修订的。从 Illich (1971)、Bowles & Gintis (1976) 到 Bourdieu & Passeron (1977)——每一次对大众教育的激烈批评，本身也证明了它的力量：它仍然是**可问责的**（accountable），不能一走了之(p.64)。
>
...
>
> 她的最终立场可归结为一个研究和实践的议程：**我们需要一种新的教育理论**——不是关于"怎么教"（[[Didaktik]]）的技术理论，而是在更根本的层面回答"我们想怎样一起生活"（How do we want to live together?）的理论。这个理论的特征是：拒绝知识的区隔化组织、以 connectivity 和 response-ability 为组织原则、鼓励协作、对人类中心主义的意识形态持批判态度、提倡非二元思维和自我的非固化、关注物质和非物质的多元纠缠(pp.60, 64)。
>
...
> ### Cowen 双轴模型的诊断力
>
> Cowen (1996, pp.160–162) 的双轴模型精确地标示了现代教育→晚期现代教育的结构转型。关键转型参数：纵轴从 polis-driven 到 market-driven，核心价值从"教育机会平等"到"内部效率与外部效能"，合法性基础从"国家文化认同"到"劳动力分化"(p.55)。
>
> ### 知识市场化的时间深度
>
...
>
> Escobar (2018) 的核心主张是本体论层面的：转型不是被设计的，而是涌现的。具体手段是 Irwin (2015) 的十条转型设计原则——以日常生活为设计的最根本情境、基于地方的全球化联网、放大草根方案、最大化最广泛需求的满足(pp.61–62)。
>
...
>
> Escobar 和 Haraway 没有将教育作为论述重点，因为在他们看来，大众教育的 DNA（竞争、增长、rugged individualism、西方理性作为唯一有效知识）本身就是问题的一部分。Amos 的诊断是：需要保留大众教育的公共问责性，但用 connectivity 和 [[Response-ability]] 作为组织原则重建其理论基础(pp.63–64)。
>
...
> [!warning] 局限性与批评
> - Amos 自认 §4.5 [[Posthumanism|后人类主义]]部分属于"高度推测"（highly speculative），Haraway 和 Escobar 均未将教育作为论述重点，教育与后人类主义的对接仍是开放问题(p.61)
