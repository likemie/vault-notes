...
> Amos 的出发点是两个互相牵连的"未知[[Variable|变量]]"：我们既不知道教育——包括其制度和组织形式——将变成什么样，也不确定生活在晚期现代性（late modernity）中到底意味着什么（Amos, 2022, p.53）。
>
...
> ### 数字化的三重不可逆驱动力
>
> 利润（Google/Apple/Microsoft 的教育部门、EdTech 股票市场、Coursera/Udacity）、正义平等叙事（UNESCO 的 anytime/anywhere 逻辑）、专业发展（[[Learning Analytics|学习分析]]、个性化学习）同时推动数字化。这三重逻辑相互强化，使"去数字化"日益不可能——即便认识到数字化的不平等效应（Amos, 2022, pp.56–58）。
>
...
> [!warning] 局限性与批评
> - Amos 自认 §4.5 [[Posthumanism|后人类主义]]部分属于"高度推测"（highly speculative），Haraway 和 Escobar 均未将教育作为论述重点，教育与后人类主义的对接仍是开放问题（Amos, 2022, p.61）
