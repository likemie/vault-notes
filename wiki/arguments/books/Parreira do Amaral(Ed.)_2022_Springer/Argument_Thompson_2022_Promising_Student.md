...
当前高等教育政策话语中一个显著模式是：从"大学 4.0"愿景到各类政策文本，学生被描绘为大学竞争力和创新驱动的关键节点。"The Future of Universities Thoughtbook"（FUT, 2018）提供的愿景是典型代表——大学被视为知识驱动发展的网络枢纽，"学术人员和学生"被描绘为大学的驱动力（Thompson et al., 2022, pp.217–218）。
...
OSA 不能被简化为一种"限制入学"的方法——它通过"[[Matching|匹配]]"和"和谐"的承诺重新定[[Rightness|义]]了"学习的场所"（location of study）。大学被呈现为"完美的环境"，能够帮助学生实现他们的潜力（Thompson et al., 2022, p.223）。
...
- **[[Digital Self|数字自我]]的建构**：通过收集和评估学生的兴趣、期望、动机和认知技能数据，OSA 构建了一个"数字自我"（digital self）——一个"统计人造物"（Bächle, 2016, p.194）。但这一过程不是中立的"反映"——正如 Kitchin（2014）和 Espeland & Stevens（2008）对量化所做的批判性分析所示，数据并不"为自己说话"，测量也不"提供通向真实的特权通道"（Thompson et al., 2022, p.225）
- **[[Digital Optimum|数字最优]]的生成**：算法理性在持续应用于评估环境的同时，也优化和标准化了评估过程——产生一个"数字最优"（digital optimum），即"完美起点"的理想形象（Thompson et al., 2022, p.226）
...
- **高等教育的缩小**：那些更麻烦、更具困扰性的学习体验——阅读和写作中的延迟、尚未准备好被提出的问题——既是障碍，也是资源。高等教育需要对学科进行批判性参与：学生在面对被呈现为知识的东西时采取立场。处于危险之中的正是**批判的实践**（the exercise of critique）——从[[Immanuel Kant|康德]]到法兰克福学派到 Foucault，批判一直被视为高等教育中重新打开思考和探索空间的核心知识实践（Thompson et al., 2022, p.227）
...
- OSAs 作为治理工具重新定[[Rightness|义]]了从中学到大学的过渡——从集体性的约定转变为个体化的自我反思情境（p.222）
