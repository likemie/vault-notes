...
Partaken 在此援引 Foucault《规训与惩罚》(1995)中 Bentham 全景敞视监狱的核心洞察来分析两种模式共享的运作逻辑："有意识和永久性可见的状态确保权力自动运行……监视在其效果上是永久性的，即使其行动是间断的"(p.201, 引自 p.81)。因此，国家支持的全民监视的"最严重损害"不是曝光了多少信息，而是"以安全为名——且不乏悖论地以自由为名——对一个精英治理文明的[[Virtue-Oriented Learning Process|美德导向]]价值论的贬低"(p.81)。
