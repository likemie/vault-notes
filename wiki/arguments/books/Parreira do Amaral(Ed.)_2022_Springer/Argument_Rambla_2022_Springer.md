...
> 欧盟的 [[Innovation Union]] 与 [[EU Skills Agenda]] 两项旗舰政策如何通过"[[Performance Indicators|绩效指标]]"这一特定政策工具，建构关于"区域"（regions）的教育与创新想象（imaginaries）？在这一建构过程中，绩效指标体系在哪些方面系统性地优先了某些政策议题，又使哪些议题被边缘化？(p.163–164)
>
...
> - **通过区域指标展示可测量成果**：指标将复杂的政策现实转化为直观、可比较的排名和颜色[[Coding in Qualitative Research|编码]]地图，使任何公民和政治家都能一目了然地识别自身区域在创新和教育方面的相对位置。这种可视化能力使指标成为高效的政治沟通工具(p.165)。
...
>
> 2. **通过区域指标展示可测量成果**：指标将复杂的政策现实转化为直观、可比较的排名和颜色[[Coding in Qualitative Research|编码]]地图，使任何公民都可以一眼识别自身区域在创新和教育方面的相对位置。这种可视化能力使指标成为高效的政治沟通工具，也使其被行动者视为"客观现实"——"行动者既不能凭空发明，也不能随意改变"(p.165)。
...
>
> **变化二：决策权力的多向迁移。** 自主权债务危机以来，欧盟在金融监管和货币政策上获得了更大的决策权；但与此同时，欧盟又要求成员国与区域和地方政府合作来处理就业、创新和教育等对空间差异高度敏感的政策领域(Keating, 2009)。结果是权力同时在向上（向欧盟）、向下（向区域）和横向（向公民社会网络）三个方向流动。区域政府被赋予了更多政策责任，但也面临更严格的"事前条件"（ex-ante conditions）和自上而下的评估约束(Sbaraglia, 2017; p.167)。
...
>
> **选择性一：创新的同质化。** 区域创新记分牌将北欧的创新领先区与南欧的"一般创新者"纳入同一个"创新生态体系"[[Analytic Framework|分析框架]]。但一个瑞典[[Innovation Park|科技园区]]与一个希腊农村地区面临的"创新"问题是根本不同的——前者需要监管协调和国际专利保护，后者可能需要基础设施投资和基本技能普及。将两者统称为"创新生态体系"，实际上是用前者的问题定义遮蔽了后者的真实处境(p.174)。
>   > 例：将一个家庭医生与一个心脏外科医生置于"医生排行榜"中比较，排名的逻辑会驱动你追问"为什么家庭医生的手术量这么低？"而非"家庭医生的价值是否应该用手术量来衡量？"指标体系对"创新"的[[Operationalization|操作化]]定义具有同样的效应——它使某些问题变得可问，另一些问题变得不可问。
>
...
>
> **选择性三：区域[[Heterogeneity|异质性]]的遮蔽与固化。** 区域创新记分牌的分类（"创新领导者""强创新者""一般创新者""温和创新者"）不仅描述了差异，还通过年复一年的重复发布固化了这些差异。一个被标记为"一般创新者"的区域，很难在下一轮吸引到与"创新领导者"同等水平的投资和人才——分类由此从描述性标签演变为自我实现的预言(p.174)。这与 [[Spatial Sortings]] 的机制相通：知识密集型资本主义系统性地将地点和人口划分为"赢家"与"输家"。
...
>
> 1. **绩效指标是权力工具，而非[[Value Neutrality|价值中立]]的测量仪。** 它们不仅衡量政策成果，还通过操作化定义确立了"什么是好的创新"和"什么是好的教育"。当政策制定者依据排名做出决策时，他们同时接受了嵌入指标体系中的价值判断——而这些价值判断从未经过民主审议。
>
> 2. **指标的选择性具有民主政治的含义。** 如果"创新 = 研发 + 专利""终身学习 = 就业匹配"这些等式被自然化为客观事实，那么本应由民主审议来决定的政治问题——"我们希望生活在什么样的社会？""应当鼓励何种类型的创新？""教育的目标是培养劳动者还是培养人？"——就被技术化为"数据告诉我们该怎么做"。这是对民主审议空间的结构性压缩，与 [[Scientization of Politics]]([[Argument_Zapp_2022_Springer|Zapp, 2022]])的诊断相通。
>
...
> - 区域创新记分牌显示北欧、德语区和西大西洋区域为"创新领导者"，南欧和东欧区域为"一般创新者"或"温和创新者"(Hollanders & Es-Sadki, 2017; p.174)
