...
> - **嵌入政治关系并实施选择性(Jessop, 2007)** 指标间接重塑了政府、企业、非营利组织与公民之间的关系——通过发布排名和最佳[[Praxis|实践]]，政府试图说服多元利益相关方同时展开竞争与协作来提升排名，而非通过具有约束力的立法来固定各方角色。与此同时，指标的选择性机制决定了什么被算作"进步"、什么被忽略(p.166, 174)。详见 [[Selectivity]]。
...
> Rambla 引入 Le Galès(2016)的政策工具理论作为分析棱镜，其核心命题为：**政策工具同时包含技术成分和权力成分，两者互相关联但不可互相还原**。技术成分（统计公式、数据采集方法、指标设计）具有自身的内在理性，但[[Praxis|实践]]中通过（权力不平等的）行动者之间的社会关系被实施(p.164–165)。
>
...
>   > 例：一个在斯德哥尔摩工作的工厂技术员和一个在那不勒斯工作的工厂技术员——前者可能每天参与讨论如何改进生产流程（工作场所中的[[Learner Autonomy|自主学习]]），后者的工作内容主要是按指令操作。EUROSTAT 的排名将两者纳入同一个比较框架，但无法捕捉导致这种差异的深层制度原因（劳动组织方式、福利国家模式、技能形成体制等）。
>
...
>
> **选择性二：终身学习的就业化。** 除芬兰外，大多数欧盟成员国的终身学习专业人员将这一政策理解为"帮助青年尽快找到工作"的就业工具。从指标体系的视角来看，这一理解是完全合理的——指标追踪的是就业率、在学率和早期辍学率。如果一个人通过社区志愿服务发展了组织能力，或在照护家人中获得了同理心和沟通技能，这些学习在指标中不存在，也就不在政策考虑的范围内。
...
>
> **选择性三：区域[[Heterogeneity|异质性]]的遮蔽与固化。** 区域创新记分牌的分类（"创新领导者""强创新者""一般创新者""温和创新者"）不仅描述了差异，还通过年复一年的重复发布固化了这些差异。一个被标记为"一般创新者"的区域，很难在下一轮吸引到与"创新领导者"同等水平的投资和人才——分类由此从描述性标签演变为自我实现的预言。这与 [[Spatial Sortings]] 的机制相通：知识密集型资本主义系统性地将地点和人口划分为"赢家"与"输家"。
...
> - 绩效指标的 [[Selectivity]] 体现在两个关键方向：将创新窄化为研发和技术指标（排斥社会创新和文化创新）；将[[Lifelong Learning|终身学习]]窄化为就业安置（排斥个人发展和公民参与维度）。除芬兰外，绝大多数欧盟成员国的[[Praxis|实践]]反映了"就业优先"（employment-first）的逻辑(p.174–175)
