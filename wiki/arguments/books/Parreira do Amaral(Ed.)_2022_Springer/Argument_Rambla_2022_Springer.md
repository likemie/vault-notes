...
>
> 3. **变革理论的嵌入** 指标不只是给分，还隐含了一套[[Causality|因果]]叙事。欧盟的 Education and Training 2020 战略假定：降低早期辍学率 + 促进创新 → 智能、可持续与包容性增长。这一因果链被嵌入指标体系中，使增加研发投入、降低辍学率等路径在认知上被自然化为"理所当然"。详见 [[Theories of Policy Change]](p.165–166)。
...
> - 欧盟政策话语将"创新"与"教育"之间的互联视为[[Doxa|不言自明]]的增效关系（减少辍学 + 促进创新 → 智能、可持续与包容性增长），但这些 [[Theories of Policy Change]] 的核心[[Causality|因果]][[Hypothesis|假设]]并未经过严格的实证检验——它们更像是政策工具的内在成分，被嵌入而非被验证(p.165–166, 170–172)
