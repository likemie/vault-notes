---
summary: "凯利（Gregory J. Kelly）与利科纳（Peter Licona）基于科学实践研究，主张科学教育应引导学生作为微观协商共同体参与认识论实践。研究构建了提出、沟通、评估与合法化主张的四维行动框架，确立了交互性、情境性、互文性与后果性特征；对比了探究科学、工程教育与社会科学议题的异质性；结合家族相似性进路（FRA）、实践认识论分析（PEA）与回溯推测，解构了教条线性的科学方法神话，为培育批判性公共科学素养奠定了实践基础。"
type: argument
...
> [!warrant]- 理论如何支撑论证
> 本章理论框架由“宏观社会认识论转向—中观三维课程目标—微观课堂[[Practical Epistemology|实践认识论]]”三层支柱有机咬合而成：海伦·朗基诺（Helen Longino）与凯利（Gregory J. Kelly）确立了认识论主体的社会性与规范性基准；理查德·杜施尔（Richard Duschl）的三维目标论为剖析探究科学、工程教育与社会科学议题（SSI）提供了统一的课程分析坐标；而维特根斯坦（Ludwig Wittgenstein）与佩尔-奥洛夫·威克曼（Per-Olof Wickman）的实践认识论则将分析直接下沉到课堂微观话语互动的语言游戏之中。
...
> | **科学模型评价准则**<br>(Pluta et al., 2011) | 初中科学：科学模型质量评判与论证 | 学生对竞争性模型的评价标准草案、认识论准则编码（解释功能、实证数据契合、细节完整性）（p. 153） |
...
> ```mermaid
> flowchart LR
>     Step1["步骤一<br/>认识论主体转向<br/>社会协商共同体"] --> Step2["步骤二<br/>四维行动环节与<br/>原生态案例拆解"]
>     Step2 --> Step3["步骤三<br/>认识论实践确立<br/>四大本体特征"]
>     Step3 --> Step4["步骤四<br/>三大教学取向呈现<br/>学科认识论异质性"]
>     Step4 --> Step5["步骤五<br/>引入FRA与PEA<br/>培育公共科学素养"]
> ```
...
科学认识论研究经历了一场根本转向：从探讨孤立心智如何表征外部客观世界，转向考察社会群体如何在特定历史文化情境中确立知识的正当性。

#### 1. 科学认识论主体是情境化社会协商群体而非笛卡尔孤立知者

传统的认识论[[Paradigm|范式]]建立在[[René Descartes|笛卡尔]]孤立知者（Cartesian Subject）假说之上，倾向于将知识理解为个体大脑中的信念与心智表征。然而，科学社会学、人类学与认知科学的实证研究表明，知识的生产本质上是一种集体性、协商性的社会活动。
...
> | **教育考量** | 概念记忆测试、标准化[[Questionnaire\|问卷]]测量（如科学本质观问卷 [[Views of Nature of Science Questionnaire\|VNOS]]） | 引导学生参与真实科学文化与学科论辩实践 |

#### 2. 描述性科学社会学记录不能直接等同于规范性教学目标

在将科学社会学的实证发现引入教育学时，必须明确区分描述性记录（descriptive [[Accounts]]）与规范性目标（normative goals）。科学实践研究记录了科研人员真实的社会互动过程，但这并不意味着教育应当直接复刻职业科学家的所有实际行为。

> [!dimension] 吸纳科学实践研究成果的三重理论辩护（pp. 143–144）
> - **区分描述性记录与规范性教学目标**
>   记录科学活动中的实际社会互动并不等同于将所有实际行为直接当作教学标准。教育目标必须统合伦理、育人与认知发展等多重考量，实证研究旨在深化对[[Knowledge Production|知识生成]]过程的理解，而非盲目复制职业科学家的利益博弈。
> - **立足教育学视角吸纳[[Epistemic Value|认识论价值]]**
>   吸纳科学实践研究是为了揭示知识生产的内部运作逻辑（如文本修改、实验检验、[[Peer Debriefing|同行审议]]与证据辩护），这些洞见能够为课程设计提供生动滋养，无须陷入相对主义的极端争议（Allchin, 2004, 2011）。
> - **借鉴微观交互[[Ethnography|人种志]]的[[Qualitative Observation|质性观察]]工具**
>   跨学科科学实践研究考察行动中的科学（science-in-the-making）所采用的[[Qualitative Observation|田野观察]]与[[Discourse Analysis|话语分析]]方法，为教育研究考察课堂中师生如何共同确立知识提供了成熟有效的方法工具。

> [!warrant]- 推理桥梁：从个体信念向社会规程的转变
> 当认识论主体定位于共同体时，科学教育的重心便发生根本转变：学习科学不仅是记住现成的概念定义，更是学会参与特定学科的交流实践，掌握共同体用来提出、检验与确立知识的社会规程。
...
> [!claim] 步骤二核心主张
> [[Epistemic Practices|认识论实践]]是群体成员提出、沟通、评估与合法化知识主张的社会组织化方式；这四个环节相互支撑，在课堂中具体展现为言语、具身动作与文本的互动过程。（pp. 140, 144–147）

凯利与利科纳将认识论实践[[Operationalization|操作化]]为由四个核心环节构成的动态循环系统。在真实的科学探究与学习情境中，知识主张在提出、沟通、评估与合法化之间持续迭代演进。

```mermaid
flowchart LR
    P["<b>提出主张</b><br/>陈述假说 · 具身动作 · 初步直觉"] --> C["<b>沟通主张</b><br/>适应受众 · 多元情境 · 修辞协商"]
    C --> E["<b>评估主张</b><br/>组织证据 · 逻辑检验 · 准则审查"]
    E --> L["<b>合法化主张</b><br/>达成共识 · 权威确认 · 身份赋予"]
    L -.->|反思迭代| P
```

#### 1. 四项原生态课堂实证案例详尽拆解了认识论实践的微观行动机理

研究团队通过横跨基础教育与高等教育的四个典型案例，深入剖析了四维行动环节在课堂话语中的具体展开过程：

> [!feature] 认识论实践四维行动的课堂实证案例深度剖析（pp. 144–147）
> - **提出主张：高中物理简谐振动实验（Kelly et al., 2001）**
>   - **实验情境与技术中介** 4 个高中生物理小组利用弹簧振子与超声波传感器探究振动规律。计算机屏幕实时绘制出位移、速度与加速度随时间变化的连续曲线。这些即时图表具有显著的解释灵活性（interpretative flexibility, Knorr-Cetina, 1995），为学生提供了持续讨论的焦点。
>   - **具身动作与言语互动** 学生并非直接推导出物理公式，而是在空中用手势上下摆动，模仿弹簧振子的物理运动，并将身体动觉与屏幕波形的波峰、波谷及平衡位置进行对照。
>   - **认识论机制** 学生提出一系列包含误解、试错与直觉判断的粗糙假说。正如天文学家在射电望远镜图谱前发现脉冲星的过程（Garfinkel et al., 1981），科学主张的原初提出高度依赖具身动作与仪器读数的微观对质，这些初步尝试构成了小组开展后续审议的关键支点。
> - **沟通主张：小学三年级太阳能装置设计（Kelly & Brown, 2003）**
>   - **设计任务与多元语境** 小学三年级学生分组设计能够实际烹饪或集热的太阳能装置。学生必须在多种言语情境中穿梭：在小组内部[[Brainstorming|头脑风暴]]并就材料成本与集热效率进行折中协商；在全班展示中向同学汇报装置的聚光与保温机制；并以实测升温曲线回应指定“科学小记者”的严苛质询。
>   - **修辞适应与证据表达** 学生根据不同受众的需求调整语言风格与论证策略，从最初的感性描述逐步转变为使用数据图表与物理原理解释设计方案。
>   - **认识论机制** 沟通不是探究完成后的包装外壳，而是知识生成的关键中介。学生在面向特定受众进行说服的过程中，被迫澄清概念模糊之处，这与职业科学家撰写论文和应对同行答辩时的修辞工作完全同构（Bazerman, 1988; Traweek, 1988）。
> - **评估主张：大学海洋地质学论文写作（Takao & Kelly, 2003）**
>   - **学术写作与证据评判** 大学本科地质学学生利用全球地震震源深度、洋底地磁条带与海底地形数据集，撰写支持板块构造学说的论证论文。
>   - **认识论层级分析** 研究开发了认识论层级（Epistemic Level, EL）[[Coding in Qualitative Research|编码]]框架（从 EL I 的原始地震波观测数据，到 EL II/III 的中阶形态描述如贝尼奥夫带倾角，再到 EL IV/V 的宏观理论模型如大洋板块俯冲与地幔对流）。高水平论文展现出跨越不同认识论层级的严密逻辑融贯性。
>   - **认识论机制** 对知识主张的评估依赖于特定学科的体裁规范（genre specificities）。实证发现，即使经验丰富的高年级[[Teaching Assistant|助教]]，也往往仅凭直觉给分而难以清晰说出高分论文好在哪里。话语分析将这种隐性、默会的证据评估标准显性化，为科学论证教学提供了可操作的分析工具。
> - **合法化主张：小学科学课堂教师元话语（Reveles et al., 2004）**
>   - **课堂互动与教师引导** 小学三年级教师 Cordova 在关于物质状态与热现象的探究课中，面对学生提出的各种朴素观念，并不以绝对权威直接宣布标准答案。
>   - **元话语的赋权功能** 教师巧妙运用元话语（meta-discourse，即对课堂话语本身展开评述），明确向全班指出：“大家注意到了吗？刚才某某同学并不是在凭空猜测，而是调用了我们昨天实测的温度变化记录，这正是科学家在面对分歧时确立结论的做法。”
>   - **认识论机制** 在基础教育情境中，合法化知识的核心功能在于塑造学生的科学学术身份（science identity）。通过教师的元话语点拨，边缘背景的学生体验到了自己的发声受到学科规范的支持，从而建立了作为科学知者的智识自信（Latour, 1987; Myers, 1989, 1997）。

#### 2. 交流表达贯穿于探索发现与证据论证的全过程而非探究事后包装

科学哲学传统长期严格区分“发现的情境”（Context of Discovery）与“辩护的情境”（Context of Justification）。然而，跨学科科学实践研究揭示出，在真实的科学活动与课堂探究中，还存在着同等重要的“交流表达的情境”（Context of Communication & Presentation）。

> [!quad-grid] 科学学习的三重情境及其相互交织（p. 147）
> - **探索发现的情境（Context of Discovery）**
>   充满尝试、困惑与初步直觉。学生在操作仪器、观察反常现象的过程中，体会想法如何从杂乱无章的实验探索中逐步形成（Norman, 1998）。
> - **证据论证的情境（Context of Justification）**
>   强调严密的逻辑推理与证据支持。学生学习如何调动实测数据支持自己的论断，理解理论模型必须在公认标准下接受检验（Duschl & Grandy, 2008）。
> - **交流表达的情境（Context of Communication & Presentation）**
>   强调面向不同受众的说服力与修辞协商。从提出假说、小组辩驳到最终撰写报告，知识主张始终在与他人的互动交流中不断调整与完善。
> - **三种情境的动态交织**
>   交流表达并不是探究全部结束后的总结汇报，而是从头到尾嵌入在探索发现与证据论证的每一个环节中，推动知识主张的持续演进。
...
认识论实践不是抽象的行为清单，而是深植于微观互动与宏观制度之中的社会过程。研究从[[Ontology|本体论]]层面提炼出认识论实践的四大核心特征：

#### 1. 认识论实践兼具当场交互、情境嵌入、历史互文与制度后果四大本体特征

> [!feature] 认识论实践的四大本体特征（pp. 156–159）
> - **交互生成性（Interactional）**
>   知识不是单个大脑闭门造车的结果，而是在人与人之间的协同活动、即时争论与手势动作中共同建构的。物理实验小组对反常波形的合力排查，鲜明体现了实践的交互性。（p. 156）
> - **多尺度情境性（Contextual）**
...
#### 2. 课堂微观话语协商通过多尺度互文塑造学生的科学学术身份与归属感

认识论实践的四大特征在课堂中形成了一条严密的逻辑推导链条，揭示了微观话语互动如何逐步转化为学生的深层[[Scientific Literacy|科学素养]]与身份认同：

> [!chain-link] 微观话语协商塑造科学学术身份的机制链条
> - **前提：微观课堂互动是认识论实践的原初发生场景**
>   学生在具体实验与设计情境中，围绕实验材料、仪器读数与反常数据开展面对面的言语和具身协作。（p. 156）
> - **中间推论：符号互文将即时对话连接至广阔学术传统**
>   讨论过程不断指涉官方学科概念、数学公式与体裁规范，使微观对话超越即时情境并获得历史连贯性。（pp. 158–159）
> - **机制：群体关于合法知识的裁决直接分配智识权威**
>   当某一知识主张被共同体判定为有效证据并被采纳时，提出与辩护该主张的学生便获得了集体的智识认可。
> - **结论：持续参与认识论实践塑造了学生的科学身份与归属感**
>   学生在意义协商中从边缘走向中心，逐步建立起作为科学知者的[[Self-Efficacy|自我效能]]与学术身份认同。（p. 159）
...
科学教育绝非铁板一块。理查德·杜施尔（Richard Duschl, 2008）提出的三维学习目标（概念、认识论、社会）在不同教学取向中呈现出差异化的侧重点。

#### 1. 探究科学、工程设计与社会科学议题在三大学习目标上呈现显著分化

> [!row-contrast] 表 5.1 三种科学教学取向在三大学习目标上的侧重差异（p. 143）
> | 学科取向（Disciplinary Approach） | 概念目标（Conceptual） | [[Epistemic Aims\|认识论目标]]（Epistemic） | 社会实践目标（Social） |
> |---|---|---|---|
...
> | **社会科学议题<br>（Socioscientific Issues, SSI）** | 构建并理解科学概念，同时综合考量道德、伦理、个人与宗教等多重视角（Sadler, 2004） | 统合多元视角（科学、伦理、经济等），构建支持争议性立场的连贯推理链 | 掌握在争议性议题中支持特定立场时，生成、交流和评估多元论据的公共审议程序（Zeidler, 2014） |

#### 2. 不同学科取向在提出、沟通、评估与合法化主张上遵循异质的行动规程

当落实到具体的认识论实践四维行动时，三种教学取向所要求的实践活动表现出清晰的领域边界：

> [!row-contrast] 表 5.2 三种科学与工程教育取向中的认识论实践矩阵（pp. 156–157）
> | 认识论实践维度 | 探究式科学（Inquiry Science） | 工程教育（Engineering Education） | 社会科学议题（Socioscientific Issues, SSI） |
> |---|---|---|---|
> | **提出主张** | - 提出科学探究问题<br>- 设计探究方案以回应问题<br>- 开展具身与仪器观察<br>- 设想探究所需的相关证据基础<br>- 构建并迭代修正理论模型 | - 识别实际工程与技术问题<br>- 在具体生活情境中审视工程问题<br>- 综合应用科学概念与工程逻辑<br>- 应用数学建模与定量推理<br>- 设想多种竞争性备选方案<br>- 保持坚韧并在设计失败中学习迭代<br>- 运用全局系统思维（systems thinking） | - 提出跨领域综合问题（兼涉科学、经济、道德、宗教与生态）<br>- 设计多元调查方案以探寻答案<br>- 权衡并协调多元推理线索<br>- 预先构建反驳与抗辩论据（rebuttal） |
> | **沟通主张** | - 发展严密的科学推理链条<br>- 为知识主张提供学科特异的论证辩护<br>- 撰写规范的科学解释（实验报告）<br>- 进行口头科学阐释与现场辩驳<br>- 基于证据与推理建构因果说明 | - 在工程项目团队内部开展高效协同沟通<br>- 针对既定物理与成本约束为设计方案辩护<br>- 面向委托客户（client）进行专业汇报与展示 | - 基于实地与文献调查构建证据网络<br>- 明确阐述个人或群体的价值与政策立场<br>- 基于证据与价值考量构建多重复合论据<br>- 开展公众演讲与正式论辩陈述<br>- 深入参与角色扮演（role-play）与公共辩论 |
> | **评估主张** | - 评估科学主张、证据或模型的效度与优缺点<br>- 审视科学推理链条的逻辑严密性<br>- 评估科学解释对异常数据的包容度<br>- 严谨考量竞争性的备择解释（alternatives） | - 在设计指标与物理/成本约束之间进行权衡取舍（tradeoffs）<br>- 运用测试数据驱动工程方案的优化决策<br>- 评估技术约束与委托客户实际需求的契合度 | - 评估科学事实主张的有效性与内在局限<br>- 评估多元证据效力（界定何者在道德、伦理或科学上算作有效证据）<br>- 审视跨学科推理链条的融贯性与偏见<br>- 对论辩体系进行全局整体性评估 |
> | **合法化主张** | - 就科学合理的因果解释建立群体共识<br>- 赋予最符合既有公认科学理论的解释以权威价值<br>- 寻求相关学科认识论共同体的正式承认 | - 综合权衡工程技术方案的多维社会后果<br>- 做出基于坚实数据证据的工程决策<br>- 获得委托客户对技术方案落地成功的最终确认 | - 在公共论争中建立对最具说服力论据的广泛共识或审议接纳<br>- 承认辩论各方所持价值立场的正当性与合理性 |

#### 3. 转基因玉米案例表明不同取向在探究问题、证据范围与裁决准则上边界鲜明

为了直观展现三者差异，作者以转基因生物（Genetically Modified Organism, GMO）玉米为例进行了对比对质：

> [!tension-table] 转基因玉米在三种取向下的认识论实践对质（pp. 154–155）
> | 维度 | 探究式科学（Inquiry Science） | 工程教育（Engineering Education） | 社会科学议题（SSI Approach） |
> |---|---|---|---|
> | **核心探究问题** | 转基因玉米在控制光照下是否比野生玉米[[Growth\|生长]]得更好？ | 如何改良玉米基因以满足特定抗旱与低成本加工的工业约束？ | 是否应该允许将实验室培育的转基因玉米大规模引入自然生态系统？ |
> | **证据考量范围** | 仅限于生物学受控实验测得的株高、生物量与抗虫数据。 | 关注基因转化效率、种子生产成本与农机收割兼容性。 | 综合考量生态多样性风险、跨国种业专利垄断、食品安全与伦理道德。 |
> | **结论裁决准则** | 遵循单[[Variable\|变量]]控制原则与[[Statistical Significance\|统计显著性]]检验。 | 寻求多约束条件下的最优设计平衡与可行性。 | 综合权衡不同价值诉求，在非形式推理与公共审议中寻求合理的民主共识。 |
...
长久以来，科学教育教材往往将科学方法简化为由“观察、提问、假说、实验、结论”构成的线性五步法，严重扭曲了真实的[[Nature of Science|科学本质]]。

#### 1. 家族相似性进路与学科异质性彻底消解了普适线性的科学方法神话

真实科学的各个分支在问题类型、数据形态与推理方式上高度异质，不存在一套普适通用的操作清单。

> [!critique-method] 科学方法的线性教条与跨学科认识论[[Heterogeneity|异质性]]（pp. 144–145, 151–153）
> - **科学本质的家族相似性进路（Family Resemblance Approach, FRA）**
...
> - **生命科学的概率特征**
>   遗传学教学要求学生理解多基因相互作用与概率因果，区分[[Determinism|决定论]]与不确定性，这对于公民理性参与基因克隆与基因筛查等社会议题至关重要（Jiménez-Aleixandre, 2014）。

#### 2. 实践认识论分析（PEA）与主张构建-批判双重视角揭示了微观意义建构机制

在微观层面，学生并不是将抽象的科学方法法则直接套用到实验中，而是在具体情境中摸索建立意义：

> [!proc] 实践认识论分析（Practical Epistemological Analysis, PEA）的微观运作机理（pp. 149–150, 154）
> 1. **识别立足点（Stand Fast）** 找出师生在当前对话与操作中共同认可、无需争论的基础概念与常识（Wickman, 2004）。
> 2. **遭遇认知裂隙（Encounter Gaps）** 当观察到反常现象或遇到理解障碍时，原有共识出现分歧或空白。
> 3. **搭建关系桥梁（Build Relations Across Gaps）** 学生调动实验教具、生活经验与概念资源跨越理解障碍（例如 Lidar et al., 2010 在关于重力和地球形状的讨论中，儿童通过操作天球仪与地图修补理解裂隙）。
> 4. **确立科学模型的[[Epistemic Ideals|认识论标准]]（Epistemic Criteria for Models）** 学生在教师引导下自主确立评价模型的准则，包括解释功能、实证数据契合度、细节完备性与观察吻合度（Pluta et al., 2011; Giere, 1999）。
> 5. **承担构建者与批判者双重角色（Constructors and Critiquers）** 引导学生既学习构建解释，又扮演怀疑论视角的批判者，从而形成对科学实践的深层领悟（grasp of practice, Ford, 2008）。

#### 3. 教师显性元话语与社会认识论规范将动手操作升华为公共科学素养

单纯的动手探究并不能自发让学生领悟科学本质；反之，若缺乏反思，甚至会加固教条认知。

> [!feature] 朗基诺社会知识建构规范在课堂中的教学转化（p. 148）
> - **公共论坛（Venues）** 提供公开展示与辩论证据的小组讨论、展示海报与答辩平台。
> - **吸收批评（Uptake）** 鼓励学生在面对合理反驳时主动修正自己的假说。
> - **公认标准（Standards）** 师生共同确立评估证据有效性与解释说服力的准则。
> - **平等智识权威（Tempered Equality of Intellectual Authority）** 鼓励学生基于事实和逻辑平等参与讨论，克服盲从权威的心态。

> [!critique-method] 教师话语修辞对科学本质观念的隐性塑造（pp. 153–154）
> 教师在课堂对话中使用的模糊限制语（hedges）与确定性强化语（boosters）会隐性传递科学确定性程度与权威色彩（Oliveira et al., 2012）。若教师仅机械照搬教材步骤，会强化科学绝对权威的错误观念；唯有通过教师显性的[[Reflexivity|反思性]]元话语（meta-discourse），将实践经验与朗基诺规范结合，才能引导学生发展出兼具基础文本读写与派生决策能力的[[Scientific Literacy|科学素养]]（Norris & Phillips, 2003; Norris et al., 2014）。

#### 4. 认识论实践研究正向学习进阶、跨领域迁移、文化认知资源与民主审议素养深度拓展

> [!ref-table] 科学教育认识论实践未来研究的四大开拓方向（pp. 159–161）
> | 研究方向 | 核心探究问题 | 实践与教学意涵 |
> |---|---|---|
> | **认识论实践的学习进阶**<br>(Learning Progressions) | 探究认识论实践（如提出假说、检验证据）如何与具体概念知识协同发展；研究学生在不同年龄段的实践能力进阶轨迹（Manz, 2014）。 | 指导中小学各学段科学与工程课程标准的有机衔接，避免实践技能与知识内容脱节。 |
> | **学科异质性与跨领域迁移**<br>(Disciplinarity & Transfer) | 探究学生在一个学科（如流行病学异常数据识别）中获得的认识论经验，能否有效迁移到其他领域（如大气科学或工程设计）。 | 评估综合科学与跨学科 [[STEM Education\|STEM]] 教学的实际效果，明确通用技能与特定学科规范的边界。 |
> | **多语言与多元文化认知资源**<br>(Cultural & Linguistic Diversity) | 考察不同语言与文化背景的学生如何将日常生活中的经验与知晓方式（funds of knowledge）转化为课堂学习资源（González et al., 2006; Varelas et al., 2008, 2012）。 | 推进包容性科学教学，帮助多元背景的学生建立科学学术身份与归属感。 |
> | **民主公民审议与公共决策**<br>(Civic Participation & Epistemic Agency) | 探究通过实践培养的证据评估能力，如何帮助公众在面对转基因、气候变化等复杂社会议题时做出理性判断（Aikenhead et al., 2011; Rorty, 1991）。 | 弘扬[[Enlightenment\|启蒙运动]]倡导的理性精神，依靠理性说服优于强制、开放思想优于教条的价值观支撑民主社会生活。 |
...
> 我们在本章中的核心论断是：参与认识论实践乃是稳健科学教育不可或缺的基石。参与认识论实践的必要性，在很大程度上源于汲取知识生产共同体的崇高价值：说服优于强制的价值、思想开放优于教条盲从的价值，以及审慎考量备选解决方案的价值等等。科学解释与论证并非纯粹的技术程序，因为它们不存在能够轻易被直接平移到科学教学法中的机械公式。通过将此类实践参与和精心设计的教学法深度交织，学生方能积聚充沛的认识论能力，在公共领域中作为有见识、有[[Bildung|教养]]的现代公民积极发声。（p. 161）
>
