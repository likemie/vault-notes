...
>   - **认识论机制** 基础教育中合法化知识的核心在于塑造学生的科学学术身份，赋予边缘背景学生基于证据平等发声的智识自信（Latour, 1987; Myers, 1989, 1997）。
...
> |---|---|---|---|
> | **提出主张** | - 提出科学探究问题<br>- 设计探究方案以回应问题<br>- 开展具身与仪器观察<br>- 设想探究所需的相关证据基础<br>- 构建并迭代修正理论模型 | - 识别实际工程与技术问题<br>- 在具体生活情境中审视工程问题<br>- 综合应用科学概念与工程逻辑<br>- 应用数学建模与定量推理<br>- 设想多种竞争性备选方案<br>- 保持坚韧并在设计失败中学习迭代<br>- 运用全局系统思维 | - 提出跨领域综合问题（兼涉科学、经济、道德、宗教与生态）<br>- 设计多元调查方案以探寻答案<br>- 权衡并协调多元推理线索<br>- 预先构建反驳与抗辩论据 |
> | **沟通主张** | - 发展严密的科学推理链条<br>- 为知识主张提供学科特异的论证辩护<br>- 撰写规范的科学解释（实验报告）<br>- 进行口头科学阐释与现场辩驳<br>- 基于证据与推理建构因果说明 | - 在工程项目团队内部开展高效协同沟通<br>- 针对既定物理与成本约束为设计方案辩护<br>- 面向委托客户进行专业汇报与展示 | - 基于实地与文献调查构建证据网络<br>- 明确阐述个人或群体的价值与政策立场<br>- 基于证据与价值考量构建多重复合论据<br>- 开展公众演讲与正式论辩陈述<br>- 深入参与角色扮演与公共辩论 |
> | **评估主张** | - 评估科学主张、证据或模型的效度与优缺点<br>- 审视科学推理链条的逻辑严密性<br>- 评估科学解释对异常数据的包容度<br>- 严谨考量竞争性的备择解释 | - 在设计指标与物理/成本约束之间进行权衡取舍<br>- 运用测试数据驱动工程方案的优化决策<br>- 评估技术约束与委托客户实际需求的契合度 | - 评估科学事实主张的有效性与内在局限<br>- 评估多元证据效力（界定何者在道德、伦理或科学上算作有效证据）<br>- 审视跨学科推理链条的融贯性与偏见<br>- 对论辩体系进行全局整体性评估 |
...
> 2. **遭遇认知裂隙（Gaps）** 当观察到反常现象或遇到理解障碍时，原有共识出现分歧或空白。
> 3. **搭建关系桥梁（Relations）** 学生调动实验教具、生活经验与概念资源跨越理解障碍（例如 Lidar et al., 2010 在关于重力和地球形状的讨论中，儿童通过操作天球仪与地图修补理解裂隙）。
> 4. **确立科学模型的[[Epistemic Ideals|认识论标准]]** 学生在教师引导下自主确立评价模型的准则，包括解释功能、实证数据契合度、细节完备性与观察吻合度（Pluta et al., 2011; Giere, 1999）。
> 5. **承担构建者与批判者双重角色** 引导学生既学习构建解释，又扮演怀疑论视角的批判者，从而形成对科学实践的深层领悟（grasp of practice, Ford, 2008）。
...
> | 研究方向 | 核心探究问题 | 实践与教学意涵 |
> |---|---|---|
> | **认识论实践的[[Learning Progression\|学习进阶]]** | 探究认识论实践（如提出假说、检验证据）如何与具体概念知识协同发展；研究学生在不同年龄段的实践能力进阶轨迹（Manz, 2014）。 | 指导中小学各学段科学与工程课程标准的有机衔接，避免实践技能与知识内容脱节。 |
> | **学科异质性与跨领域迁移** | 探究学生在一个学科（如流行病学异常数据识别）中获得的认识论经验，能否有效迁移到其他领域（如大气科学或工程设计）。 | 评估综合科学与跨学科 [[STEM Education\|STEM]] 教学的实际效果，明确通用技能与特定学科规范的边界。 |
> | **多语言与多元文化认知资源** | 考察不同语言与文化背景的学生如何将日常生活中的经验与知晓方式转化为课堂学习资源（González et al., 2006; Varelas et al., 2008, 2012）。 | 推进包容性科学教学，帮助多元背景的学生建立科学学术身份与归属感。 |
> | **民主公民审议与公共决策** | 探究通过实践培养的证据评估能力，如何帮助公众在面对转基因、气候变化等复杂社会议题时做出理性判断（Aikenhead et al., 2011; Rorty, 1991）。 | 弘扬[[Enlightenment\|启蒙运动]]倡导的理性精神，依靠理性说服优于强制、开放思想优于教条的价值观支撑民主社会生活。 |
