...
> - [[Triple Helix]] — Rossoni et al.（2023）以三重螺旋为第一个[[Theoretical Perspective|理论视角]]评估 UI 合作的障碍因素，另两个视角为关系社会资本和[[Technology Transfer|技术转移]]（p.316）
...
> [!warning] 第二层：合作经验与渠道（Know-how）——从"想合作"到"能合作"的能力缺口
> 即使双方目标对齐，许多机构仍缺乏启动国际合作的实务经验（p.312）。具体表现为：不知道如何找到合适的技术专家、不了解对方的预算和决策日历、不清楚国际项目的合同范式和合规要求。
>
> 可用的辅助工具包括：Halo（AI 驱动的产学研对接平台）、Elsevier SciVal（覆盖 24000 所研究机构的合作分析工具）、EU Funding and Tenders Portal（欧盟资助项目与研究者检索），以及美国 [[National Science Foundation|NSF]]、NIH、DOE 的资助数据库（pp.312–313）。但这些工具的介入前提是双方已经有了初步的合作意向——它们解决的是"找谁合作"的问题，而不是"为什么要合作"的问题。后者需要回到第一层的目标对齐。
...
> [!warning] 第四层：地缘政治（Geopolitical Considerations）——合作无法控制的外部约束
> 地缘政治不仅影响合作的启动，还可能中断已有的合作。Charpin et al.（2024）发现，政治分歧对跨境研究合作的负面冲击是真实的（p.315）。实证数据支持这一判断：Marinoni 和 Cardona（2024）对 100 多个国家 700 余所大学的调查显示，11% 的机构因政府新规修订了研究伙伴关系，3% 主动中止了与特定国家的合作（p.315）。
>
...
> [!warning] 第五层：文化、沟通与物流（Culture, Communication, Logistics）——合作能否持续的操作基础
> 跨时区、跨文化的团队在早期阶段尤其脆弱。信任不是合作的前提，而是合作的产物，需要时间来建立（p.315）。Bruneel et al.（2010）指出，学术和产业研究者必须在早期投入时间了解和接纳对方组织的文化和规范，弥合差异以建立共同理解。
>
> 一个具体的策略建议是：从规模小、复杂度低的项目起步，逐步增加合作深度（Rossoni et al., 2023, cited on p.316）。这一策略的逻辑是：小项目降低了双方的风险敞口，成功的小项目积累信任，信任为更大项目的合作提供基础。这形成了一个正向反馈循环——而急于启动大型复杂项目则可能因信任不足而崩溃，形成负向循环。

---

### 第三步：两个现有框架提供了互补的分析视角，但各有盲区

> [!info] Dollinger et al.（2018）三因素框架：环境、技术、管理
> 该框架将影响国际 UI 合作的因素分为环境因素（政策法规、文化与劳动力背景）、技术因素（研发能力、基础设施）和管理因素（治理结构、沟通机制、信任建设）（p.316）。其优势在于操作的清晰性——三个维度可对照评估任何具体合作的进展。其盲区在于：它更适合评估一个已经启动的合作，对"如何启动一个合作"提供的指导较弱。
...
> [!info] Rossoni et al.（2023）三视角评估：宏观制度、中观关系、微观操作
> Rossoni 等从[[Triple Helix]]（宏观制度层面）、关系社会资本和价值创造（中观关系层面）、以及[[Technology Transfer|技术转移]]和文化差异（微观操作层面）三个[[Theoretical Perspective|理论视角]]，系统梳理了 UI 合作的障碍（p.316）。这一框架的独特贡献在于层次性——它展示了不同层面的障碍之间的嵌套关系，弥补了 Dollinger 框架将各因素并列处理的局限。但其抽象程度较高，缺乏直接操作性。

---

### 第四步：共同选址（Co-location）是五重挑战的系统性应答

> [!note] 为什么是空间策略而非制度策略
> 共同选址的论证逻辑在于：它不是逐一回应五个挑战，而是通过一个空间决策同时降低多个挑战的难度。[[University Industry Demonstration Partnership|UIDP]]（2019）将其定义为"产业与大学人员在专用空间中有目的地结合，通过减少物理距离带来的沟通和文化壁垒来促进思想交流"（p.317）。
>
> 物理邻近的机制效应是多重的：（1）短路径的日常互动降低了沟通成本，直接作用于第五层挑战；（2）共享设施和联合活动增进了对彼此制度和文化的理解，间接触及第一层挑战（目标对齐）；（3）共处一处的产业人员成为企业内部 IP 和法律团队的"前线翻译者"，降低了第三层挑战的摩擦。

> [!example]- 三个不同深度的共同选址案例
> | 案例 | 选址深度 | 关键参数 |
> |------|---------|---------|
> | **联合利华 Hive**（瓦赫宁根大学） | 最深 | 500 名员工、18000 m²、2019 年启用，含中试车间、实验室和厨房（p.317） |
> | **FrieslandCampina [[Innovation Hub\|创新中心]]**（瓦赫宁根大学） | 中等 | 2010 年起集中研发团队，含中试车间、体验中心和实验室（p.317） |
> | **拜耳 BRIC**（Broad Institute 附近） | 较浅 | 非严格共同选址，但物理邻近性促进了十多年癌症疗法合作（pp.317–318） |
>
> 瓦赫宁根大学同时吸引了两家全球消费品巨头的共同选址，说明这种模式的效果不是个例——当一所大学在特定领域积累足够深的科研资产时，产业方有强烈动机将研发团队迁入以获取知识溢出。
...
> [!success] 案例一：水稻干湿交替灌溉（AWD）——从卫星数据到一个农业实践标准的建立
> **起点**：Mars 植物科学负责人在分析加州氮评估的卫星数据时，注意到北加州稻田上空的氮氧化物云。这一观察触发了 Mars、UC Davis 和加州水稻委员会的对话（pp.319–320）。
>
> **研究过程**：Mars 与 UC Davis（后加入阿肯色大学）合作研究国际水稻研究所（IRRI）开发的 AWD 技术——在安全生长期内允许稻田水自然消退至土表，而非持续淹灌。2011–2016 年间进行了系统研究和发表（Nalley et al., 2015）。早期结果说服了 USDA 自然资源保护局于 2018 年向阿肯色州 White River 灌区拨款，在约 10% 的水稻面积上推广类似水管理方案（p.320）。
>
> **跨国扩展**：UC Davis 将原位排放测量方法转移给 Mars 的欧洲稻米研究伙伴，Mars 随后将 AWD 推广至其亚洲供应链中的种植户（p.320）。
>
> **论证含义**：AWD 案例验证了几个关键条件：（1）大学提供了企业不具备的研究基础设施（阿肯色大学的农业试验田）；（2）企业的市场需求提供了研究方向的聚焦点；（3）严谨的公开数据是说服政府资助机构的关键；（4）但资金连续性和人事变动可能威胁长期稳定——这是一个尚未解决的结构性问题（p.320）。

---

> [!success] 案例二：非洲孤儿作物联盟（AOCC）——从双边合作到多边发展网络的跃升
...
>
> **截至目前的产出**（p.321）：
> - 已完成 75 种作物的全基因组测序，46 种已发表
> - UC Davis 协调的非洲植物育种学院（AfPBA）培训了超过 172 名非洲科学家
> - AfPBA 校友获得超过 1.75 亿美元竞争性资助
> - 正在研发 143 个改良作物品种，其中超过 40 个为 AOCC 指定的孤儿作物
> - 发表超过 665 篇同行评审论文
> - 校友开发了 62 门研究生级别植物育种课程
>
> **论证含义**：AOCC 展示了从双边合作（Mars-UC Davis）向多边合作（30+ 机构跨国网络）的跃升路径。关键差异在于：AOCC 的合作结构不再是"产业资助大学做研究"，而是"产业、大学、政府和非政府组织共同定义问题、共同投入资源、共同分享产出"。所有科学成果免费公开在互联网上——这一 IP 策略完全倒置了传统的产学保密逻辑，恰恰证明了在特定目标（消除饥饿）下，开放获取可以成为比独占更强的合作驱动力。

---

> [!success] 案例三：食品与健康创新研究所（IIFH）——合作从项目到平台的制度化
> **起点**：2015 年 Mars 与 UC Davis 共同建立 IIFH，Mars 提供资金承诺，UC Davis 部分配套（p.321）。与 AWD 和 AOCC 不同，IIFH 的目标不是研究一个具体问题，而是建立一个能够持续产生和孵化创新项目的平台。
>
> **四重路径**（p.321）：
> - 培养食品与健康领域的未来创新人才
> - 运用新技术开发更健康的食品
> - 促成"不寻常的合作"（uncommon collaborations）
> - 支持新产品和新公司
>
> **十年成果**（pp.321–323）：
> - 已吸引 21 个额外技术和投资伙伴
> - 代表性项目——**天然青色色素**：利用计算模拟和大阵列光谱技术，从红甘蓝花青素中发现了此前未被表征的天然青色色素（cyan blue）。研究团队运用合成生物学和计算蛋白质设计工具，开发了将红甘蓝花青素酶转化为目标色素的工艺。发表了同行评审论文（Denish et al., 2021），申请了两项专利，并联合创立了初创公司 Peak B 以继续扩大生产和获取安全数据（pp.322–323）
> - **周期性食物表倡议**（Periodic Table of Food Initiative, PTFI）：2022 年启动的全球项目，旨在标准化食品分析以理解食品对人类健康、农业和营养的影响。每个大洲设立"卓越中心"（Centre of Excellence），由大学和公共卫生机构主导（p.322）
>
> **论证含义**：IIFH 代表了合作形式的第三次跃升——从问题驱动的项目（AWD），到使命驱动的多边网络（AOCC），再到制度化的创新平台（IIFH）。平台的核心价值不在于任何一个具体产出，而在于它降低了未来每一个新合作项目的启动成本——已有的法律框架、信任关系、共享设施和学生培养管道使新的合作项目可以更快启动。
...
> Mars 与 UC Davis 的合作经历了"嵌入一个人（2004）→ 成立一个院（MARI, 2013）→ 建立一个所（IIFH, 2015）"的渐进深化路径。每一步深化以前一步的成功和信任积累为前提。这与第二步第五层挑战的分析形成呼应——信任是合作的产物而非前提，小项目成功→信任增加→更大项目启动的正反馈循环是合作演化的核心动力。

---

> [!success] 规律二：IP 策略的灵活性随合作成熟度提升
> AOCC 的完全开放获取策略和 Peak B 的专利+初创公司策略共存于同一合作生态中。这说明：成熟的产学关系不需要在所有项目上采用统一的 IP 策略——可以在不同类型的目标之间灵活选择。但这一灵活性本身是长期信任积累的产物，而非合作的起点。

---

> [!success] 规律三：互利（mutuality）是共同选址的制度内核
> 作者反复强调 Mars 的"互利原则"（principle of mutuality）和 UC Davis 的"变革性教育"使命在合作中的对齐（p.320）。互利在这里不仅是道德主张，也是操作性机制——合作对双方的回报不需要在每一个具体项目中精确对等，但需要在长期和整体上可感知地公平。没有这种长期互利的制度承诺，共同选址的空间策略就会沦为地产安排。
...
> [!info]- 核心数据
> - 过去二十年，涉及三个及以上国家的国际合作出版物显著增加（Maher & Van Noorden, 2021, cited on p.311）
> - 11% 的大学因政府新规修订了研究伙伴关系，3% 主动中止了与特定国家的合作（Marinoni & Cardona, 2024, cited on p.315）
> - AOCC 培训了超过 172 名非洲科学家，获得超过 1.75 亿美元资助，发表超过 665 篇论文（p.321）
...
> [!warning]
> - 作者声明与 Mars（Wolf 和 Stevenson 所属机构）和 UC Davis（Siegel 所属机构）的雇佣关系，案例选择基于作者自身参与经验，可能偏向正面呈现，无法代表所有类型的国际 UI 合作模式（pp.323–324）
> - 本章未提供系统性的文献检索方法或纳入排除标准，论据筛选标准不透明
> - 三个案例均属于食品与农业领域，该领域的[[University-Industry Collaboration|产学合作]]的 IP 敏感性可能低于制药或国防技术领域，因此"开放获取"策略的可推广性有限
