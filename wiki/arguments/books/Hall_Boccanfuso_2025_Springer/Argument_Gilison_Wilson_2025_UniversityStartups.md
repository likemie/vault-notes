...
> [!example]
> 想象一所大学的教育学院与一家大型教育出版公司签订了[[Sponsored Research Agreement\|赞助研究协议]]，研究"人工智能（[[Generative Artificial Intelligence\|Artificial Intelligence]], AI）辅助写作反馈的有效性"。出版公司的目标是把这个功能嵌入到它已有的在线写作平台中，而不是孵化一家新公司。在研究协议中，出版公司会要求：产生的所有 AI 算法和训练数据归它独占使用，不可转让给第三方；如果有衍生企业，出版公司保留一票否决权。三年后，研究团队发现这个 AI 反馈引擎其实可以独立成为一个跨平台的教学工具，不仅适用于写作，还能用于科学探究和数学解题，市场远大于出版公司原有的写作产品。但协议已经锁死了 IP，研究团队无法拿这个技术去创业，出版公司也只对它原有产品线的应用感兴趣，不会投资开发科学和数学方向。一个潜在的衍生企业就这样被扼杀在摇篮里。
...
9. 对大学研究者而言，为什么不去抗争或另找出路？因为现状其实挺舒服的(p.144)。研究得到了资助，不用自己去申请竞争激烈的联邦基金；可以与产业合作发表成果，有时企业还鼓励发表以验证其产品方向；研究有可能通过产业伙伴进入市场，虽然是进入别人的管道而非自己创业，但至少不是停留在论文里；而这一切都**不需要承担创业风险**，不用辞职、不用找风投、不用面对 75% 的失败率。于是，激励结构就这样完美地不支持衍生企业创建。研究者、企业、大学三方都没有强烈的动机去推动衍生，所以产业赞助研究这条路上几乎看不到衍生企业，"雪人"只存在于传说中。
...
> [!example]
> 继续"教师课堂话语分析系统"的例子。团队遇到的天使投资人通常有两类：一是本地的科技创业者，他们了解软件开发但不懂教育市场的采购逻辑（学区预算周期、州级课程标准、教师工会合同）；二是退休的教育局长，他们懂教育市场但对 AI and SaaS（Software as a Service，软件即服务）商业模式不熟悉。两类人都愿意帮忙，但都不知道怎么帮。团队真正需要的是一个既了解教育科技又做过创业退出的人，而这种人在大多数城市不超过五个。
...
20. SBIR and STTR 计划同样内置了产业反馈要求。SBIR（小企业创新研究）的申请条件中明确要求"收集客户声音"（voice of the customer），这意味着申请团队在提交申请之前就必须去跟潜在客户对话(p.149)。这一要求的逻辑和 I-Corps 一致：不要假设市场需要什么，出去问。
