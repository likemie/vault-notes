...
这一章不是文献综述，而是通过"框架建构 → 网站分析 → 问卷调查"三步设计，同时回答"应该怎么组织"（框架）和"实际上怎么组织"（实证）两个层面的问题。
...
- **第二步（网站分析）**：对 65 所 UIDP 成员大学的产学参与中心网页进行系统内容分析，按组织模式分类，统计办公室名称中的关键词频率，评估各办公室在八项产学活动（教育、学生参与、研究、经济发展、许可与[[Technology Transfer|技术转移]]、临床、辅助、捐赠）中的权限级别——从"未提及"到"直接负责"共六级（p.56）
...
- **教育**：产业从业者作为兼职讲师或实践教授授课、产业参与课程设计、实习与合作教育（co-ops）、面向产业员工的高管教育、在线项目、产业导向的学生社团
...
- **经济/社区发展**：孵化器、创新园区、技术许可、初创企业投资、小企业技术支持、标准制定
...
- **服务（Services）**：创新园区硬件、跨多个研究者的知识产权打包（降低企业逐一谈判的成本）、C 级高管对接、礼宾服务（concierge service）、主动接触潜在产业伙伴（而非坐等企业找上门）、产业关系官员对合作关系全生命周期的管理
...
- 中心办公室的职责范围**极其有限**：平均仅覆盖 12 个活动领域中的 3.5 个。最常见的覆盖是产业赞助研究（68%）和产业联盟（65%）；最罕见的覆盖是高管/[[Further Education|继续教育]]、校友亲和团体和面向产业员工的学分课程——这些"教育"维度的活动几乎不在中心办公室的雷达范围内
...
- 企业希望一次谈判拿到多个[[Observational and Correlational Research|相关研究]]者的知识产权组合，而不是和五个教授分别谈五次——这是**效率驱动的逻辑**
...
- 大学存在五种常见的中心办公室组织模式（科研办公室、经济发展/政府关系、企业/基金会关系、伙伴关系、全面模式），但**没有任何一个模式是真正全面的**——中心办公室的角色是"导航者"或"礼宾"而非"执行者"（pp.60–63）
- 产学双方都高度组织碎片化：大学的产业关系官员分布在学院、科研办公室、发展部门等多处；企业的大学关系官员职责同样分散。这种碎片化使得"对接"本身变成了一个高成本活动（pp.64–67）
- "互利关系"是双方的压倒性共识（>80% 选择）；企业第二重视"灵活克服障碍"（73.2%），大学第二重视"跨单位合作"（63.9%），两者可通过礼宾服务来同时满足（pp.67–68）
