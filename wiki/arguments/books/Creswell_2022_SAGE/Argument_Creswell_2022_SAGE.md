...
第2章的逻辑线是：**确定研究主题 → 审查可行性 → 理解文献综述在不同路径中的角色 → 实际检索 → 加工文献 → 呈现规范。** Creswell 坚持一个核心信念：文献检索不能盲目开始，必须先有明确的方向。

---

**第一步：确定研究主题——为什么从"一句话标题"开始？**

Creswell 观察到一个常见失误：研究者往往跳过草拟标题，直接进入文献检索。工作标题是研究中的"路标"（road sign），一个让研究者在项目推进中不断重新聚焦的锚点——用一句话完成"My study is about . . ."，控制在 10 到 12 个词以内。

> [!note] 简单 vs 复杂的张力
> 初学者容易用复杂晦涩的语言表述主题，但"Good, sound research projects begin with straightforward, uncomplicated thoughts." 发表的期刊文章之所以读起来干净清晰，是因为经过了大量修改，而非一开始就如此。

---

**第二步：可行性审查——"可以做"和"应该做"是两回事。**

"可以做"（can）是实操层面（参与者、资源）；"应该做"（should）的核心则是对文献的贡献。Creswell 描绘了一个典型失败场景：研究在技术层面无可挑剔，但因为没有为已有研究增加任何新东西，得不到委员会支持。他列举了六种提供新角度的方式（不寻常的地点、不寻常的群体、反向预期、新颖的数据收集方式、不寻常的呈现方式、时效性强的议题）以及两条辅助标准（广泛兴趣、与个人目标一致）。

---

**第三步：文献综述的目的。**

[[Literature Review|文献综述]]是对某一主题已有研究的系统检索、评估和总结，旨在将研究置于学术对话之中。Creswell 论证的关键转折在于：目的之后是"怎么组织"——而组织方式因研究路径而异。

---

**第四步：三种路径的组织逻辑。**

Creswell 的核心论断：文献综述的组织方式不是中性技术选择，而是由认识论立场决定的。

量化研究以演绎方式使用文献，典型结构按"引言 → 自变量文献 → 因变量文献 → 变量间关系文献 → 总结"五部分组织。关键在于第三部分（连接自变量与因变量的文献）——它应相对简短且极其接近计划研究。

> [!warning] 五部分结构的隐藏风险
> 如果第三部分已经有很多高度相关的研究，计划研究的"贡献"就需要重新论证。第三部分的空白或稀疏，恰恰为计划研究提供了合法化空间。

质性研究将文献的角色从"提供方向"转为"不限制参与者的视野"。Creswell 提出三种位置选择：

> [!example]- 图片占位
> 表2.1：质性研究中文献的使用方式  
> ![](https://img.mylikemie.icu/books/Creswell_2022_SAGE/figures/Table_2-1_Using_Literature_in_Qualitative_Study.png)

三种位置对应不同认识论立场：开头框定问题接近后实证主义；独立章节迎合传统读者；结尾比较发现最符合归纳逻辑。选择本质上取决于受众。

> [!note] 质性研究不是铁板一块
> 在以理论为导向的设计中（如民族志、批判民族志），文献在开头作为导向框架引入；而在扎根理论、案例研究和现象学中，文献在开头使用频率要低得多。设计类型本身决定了文献的摆放策略。

混合方法研究中，如果以量化阶段开始则文献详实，以质性阶段开始则文献较少且更多放在结尾——Creswell 的实用主义在此最明显：不是"应该怎样"，而是"取决于你用什么设计以及受众偏好"。

---

**第五步：实际检索——七步流程和背后的取舍。**

文献检索从确定关键词开始，经数据库搜索、筛选、制图、摘要到最终组织为综述，共七步。这里关注三个设计层面的判断：

数据库选择遵循一条隐藏原则：同时使用免费和付费资源，跨学科搜索，优先全文访问。ERIC 的介绍最详细，因其在线词表支持精确检索。

文献优先级从概括到具体、从易获取到难获取、从已沉淀到最新。会议论文排在期刊之后，因为尚未经过完整同行评审。

质量评估标准构成过滤机制——在网络文献泛滥的时代，Creswell 特别警告要评估其研究严谨性。这反映了 21 世纪学术写作的新挑战。

---

**第六步：加工文献——摘要与地图。**

文献摘要需区分实证研究（提取问题、目的、样本、结果、方法缺陷）和非实证研究（提取问题、主题、结论、论证缺陷）。[[Literature Map|文献地图]]是 Creswell 自己开发的工具，其逻辑不是简单分类，而是论证装置：通过可视化展示"已有研究的版图是什么样的，我的研究将延伸哪一部分"，详见该条目。
...
图 2.1 以 Janovec (2001) 为例展示层级式地图结构。底部的"Need to Study"框与上方已有文献分支之间的连线，本身就是对"本研究为何必要"的视觉论证。具体绘制程序、设计原则与[[Recommendations for Practice|实践建议]]详见 [[Literature Map]] 条目。

---

**第七步：呈现规范——格式手册与术语定义。**

格式手册为学术写作提供统一规范，社会科学领域以 APA 第7版为通行标准，Creswell 的立场明确：格式统一不是装饰，而是让读者"专注于内容而非格式"。术语定义的核心原则是操作化——具体到研究者如何使用该术语，而非照搬词典。
