...
**混合方法研究计划：最全面的格式。** 混合方法格式（Example 4.4）将量化和质性要素整合在一个框架中，其结构最长。独有要素包括：混合方法的定义和使用理由、混合方法设计类型及其效度挑战、设计流程图、整合声明（integration statement）、[[Joint Display|联合展示]]模板（joint display template）和预期整合推论（metainferences）。研究问题分三层——量化问题或假设、质性问题和混合方法整合问题。此外，研究者的混合方法研究资源和技能也需要专门说明。
...
**第二部分：写作策略。** 这部分从最宏观的写作过程，逐层收束到写作习惯、段落组织、[[Coherence in Writing|连贯性]]，最后抵达句子和词语层面的打磨。
...
| 思想类型 | 功能 | 常见问题 |
|---|---|---|
| 伞式思想（[[Narrative Thought Types\|umbrella thoughts]]） | 文本试图传达的总体或核心观念 | 初学者常有太多伞式思想而内容不足以支撑——表现为引言中的短小、断裂段落 |
...
**连贯性（Coherence）：从句子到章节。** 连贯性意味着观念相互联结、句子之间逻辑流动、段落之间自然衔接。在量化研究中，标题、目的陈述、研究问题和文献综述标题中重复同一变量名称，本身就是连贯性的体现。[[Hook and Eye Technique|钩眼技术]]将连贯性检查操作化为一个可以逐句执行的过程：在每句话中圈出关键词（眼），用线（钩）连接相邻句子的关键词，连接顺畅表明连贯良好，连接困难则需添加过渡词（详见 [[Hook and Eye Technique]] 条目）。
...
关于期刊阅读的建议：好的量化研究可阅读 Administrative Science Quarterly、American Educational Research Journal、Journal of Applied Psychology 等；好的质性研究可关注 Journal of Contemporary Ethnography、Qualitative Health Research、Qualitative Inquiry 等；混合方法研究可查阅 Journal of Mixed Methods Research、[[Champ|field]] Methods、Quality and Quantity 等。
...
- 通过 [[Institutional Review Board|IRB]] 审批——提交研究方案和[[Informed Consent|知情同意书]]，由委员会评估参与者风险
