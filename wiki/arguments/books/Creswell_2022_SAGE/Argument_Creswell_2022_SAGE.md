...
> [!note] 简单 vs 复杂的张力
> 初学者容易用复杂晦涩的语言表述主题，但"Good, sound research projects begin with straightforward, uncomplicated thoughts." 发表的期刊文章之所以干净清晰，是因为经过了大量修改，而非一开始就如此。
...
**第四步：三种路径的组织逻辑。** 核心论断：文献综述的组织方式不是中性技术选择，而是由认识论立场决定的。
...
混合方法研究取决于设计类型和两类成分的相对权重。Creswell 的实用主义在此最明显：不是"应该怎样"，而是"取决于你用什么设计以及受众偏好"。
...
**第六步：加工文献。** [[Abstract|文献摘要]]区分实证与非实证研究的不同要素，是"读文献"到"写综述"的桥梁。[[Literature Map|文献地图]]不是简单分类，而是论证装置：底部的"Need to Study"框与上方文献分支之间的连线，本身就是对"本研究为何必要"的视觉论证。详见各自条目。

---

**第七步：呈现规范。** APA 格式提供统一的学术写作规范，Creswell 强调格式不是装饰而是让读者"专注于内容而非格式"。[[Definition of Terms|术语定义]]的核心原则是操作化而非抽象——量化研究倾向于在开头"锁定"术语意义，质性研究则允许意义在研究过程中"涌现"。详见各自条目。
