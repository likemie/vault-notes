...
文献摘要需区分实证研究（提取问题、目的、样本、结果、方法缺陷）和非实证研究（提取问题、主题、结论、论证缺陷）。[[Literature Map|文献地图]]是 Creswell 自己开发的工具，以可视化方式呈现已有研究的分组关系与计划研究的定位。其逻辑不是简单分类，而是论证装置：底部的"Need to Study"框与上方文献分支之间的连线，本身就是对"本研究为何必要"的视觉论证。示例与绘制程序详见该条目。
