...
全书为研究者提供设计研究计划或研究方案的框架、流程和写作方法，覆盖量化、质性和[[Mixed Method and Multi-method Research|混合方法]]三种研究路径。这一比较从三个路径共有的初步要素（哲学假设、[[Literature Review|文献综述]]、理论使用、写作与伦理）出发，再逐一拆解研究设计的各个关键组成部分，包括引言撰写、目的陈述、[[Research Problem|研究问题]]与假设，以及数据收集、分析和解释的方法程序。
...
第5章的逻辑线是：**理解引言的重要性 → 撰写研究摘要 → 区分三种路径的引言差异 → 学习[[Deficiencies Model for an Introduction|引言缺陷模型]] → 逐一拆解模型的四个组成部分。**
...
**第二部分：研究摘要的撰写。** 在介绍引言缺陷模型之前，需要先讨论置于引言之前的摘要。摘要概括研究内容，让读者快速识别项目的核心要素，出现在研究方案、学位论文和期刊文章中。APA 出版手册指出摘要可能是研究中最重要的单个段落（American Psychological Association, 2020），必须准确、非评价性、连贯、可读和简洁。大多数摘要约 250 词。
...
4. **基本发现**：量化研究包括[[Effect Size|效应量]]和显著性；质性研究说明主要发现及情境
