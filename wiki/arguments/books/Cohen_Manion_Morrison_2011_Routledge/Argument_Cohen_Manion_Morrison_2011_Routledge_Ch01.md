...
> [!phase] Box 1.4　科学方法的八阶段模型（Hitchcock & Hughes, 1995）
>
> - **探索设计与经验观测（阶段 1–3）**
>
>   - **阶段 1** 提出假设、直觉预感与猜想
>   - **阶段 2** 设计实验方案、抽取样本、严格隔离变量
>   - **阶段 3** 系统观测相关性、识别数据模式
>
> - **假说构建与检验证伪（阶段 4–6）**
>
>   - **阶段 4** 构建假说以解释观测到的规律性
>   - **阶段 5** 经验检验因果解释与未来预测、接受证伪
>   - **阶段 6** 确立普适法则，或遭遇证伪并推翻假说
>
> - **理论外推与体系生成（阶段 7–8）**
>
>   - **阶段 7** 做出理论概括与外推
...
> 4. **[[Unit of Analysis|分析单位]]的根本重构** 弗里乔夫·卡普拉（Fritjof Capra）指出，教育研究必须摆脱将孤立个体、单一班级或孤立制度作为基本分析单位的旧习，将分析单位全面转向围绕特定关注焦点（**奇异吸引子，strange attractors**）所织就的**动态关系网络与生态系统**（Capra, 1996, p. 301）。
...
> 1. **动态、涌现与自组织的实在** 社会实在处于永恒生成之中，必须通过多元立体视角方能捕捉；
> 2. **知者与被知者的共生演化** 研究者绝非置身事外的超然看客，其认知介入本身即构成复杂适应系统演进的动力要素；
> 3. **假说的时间与情境深度依赖** 任何假说与研究结论均具有不可抽离的时空边界与情境附着性；
> 4. **因果关系的不可分割性** 各系统实体互为因果、共同演化（co-evolution），线性单向因果链在复杂系统中彻底失效；
> 5. **探究必然的价值涉入** 任何探究活动均不可避免地携带特定价值倾向与立场投射。
