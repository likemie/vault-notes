...
> [!proc] 量化研究（假设检验型）
> > [!step] 文献综述
> > [!step] 生成和表述假设/待检验理论/研究问题
> > [!step] 设计检验假设/理论的研究（如实验或调查）
> > [!step] 实施研究
> > [!step] 分析结果
> > [!step] 考虑替代解释
> > [!step] 报告假设/理论是否得到支持，和/或回答研究问题
> > [!step] 考虑发现的推广性
>
...
> > [!step] 设计研究问题和研究及数据收集
> > [!step] 定位研究场域和研究者的角色
> > [!step] 定位信息提供者、守门人、信息来源
> > [!step] 与参与者建立工作关系
> > [!step] 同时实施研究和数据收集
> > [!step] 数据分析——与研究同时进行，或在研究结束后进行
> > [!step] 报告结果和涌现的扎根理论或对研究问题的回答
> > [!step] 生成供进一步研究或检验的假设
>
