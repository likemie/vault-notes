...
> [!conclusion] 操作化的产出
> 这些问题已将研究从兴趣表达转化为可在具体层面调查的议题。现已能识别不仅具体问题，还能识别所需工具，半结构化访谈、问卷评分量表或文献分析。通过操作化，一般目的变得可经调查转化（Rose and Sullivan, 1993: 6）。操作化后的问题数量可能很大，需缩减到最多**四到五个**以使研究可控（p.138）。
