...
> - **规划即前瞻性约束**
>   尽可能提前规划研究的每一个阶段。在研究开始后中途改变"游戏规则"必然导致问题。研究的条件和运作机制必须在事前敲定，研究才可信、合法且可行（p.118）。

---

> [!claim] 规划的本质：平衡计划可能性与工作实践
> 研究的设置是一种平衡行为——需要在"计划的可能性"与"可操作的连贯实践"之间取得协调，即调和"可以做/想做的事"与"真正能实行/能真正做到的事"之间的差距。归根结底，研究必须可行（research has to work）（p.118）。
...
整个框架可以经由建立一套规划议题来实现——这正是后文的核心任务。
...
> [!dimension] 范式-本体论-认识论的对应关系
>
> **D1 实证主义与后实证主义**
> 本体论：客观主义的；认识论：科学的、经验的、假设检验的
>
> **D2 量化、科学和假设检验**
> 延续实证主义传统，以可测量、可检验为知识标准
>
> **D3 诠释与自然主义**
> 本体论：主观主义、互动论、社会建构的；认识论：承认多重实在、能动者行为、通过参与者之眼理解情境
>
> **D4 现象学与存在主义**
> 关注体验本身的结构和意义
>
...
>
> **D6 复杂性理论**
> 本体论：自组织涌现和不可预测的相互作用；认识论：理解多重因果方向、需要整体性理解现象并通过互动过程和结果来审查
>
> **D7 意识形态批判**
> 本体论：现象在权力关系和不平等中被组织；认识论：明确政治性，批判意识形态根基，结合批判与参与式行动以推动社会正义
>
> **D8 混合方法**
> 本体论：承认现象复杂到单一方法可能产生片面理解；认识论：要求实用主义的方法组合——顺序、平行或综合——以充分把握现象的多重面向

> [!claim] 从机械操作到知识反思
> 研究者不仅需要考虑所研究现象的本质，还需要考虑支撑它的本体论前提，以及研究它的认识论基础。这些是需要反思和决策的关键点——正是它们将研究规划从单纯的机械或实践操作，转变为对知识本质和存在本质的反思（p.120）。
...
> [!line-a] 量化研究（假设检验型）
> 文献综述 → 生成和表述假设/待检验理论/研究问题 → 设计检验假设/理论的研究（如实验或调查） → 实施研究 → 分析结果 → 考虑替代解释 → 报告假设/理论是否得到支持，和/或回答研究问题 → 考虑发现的推广性（p.121）。

> [!line-b] 质性或民族志研究
> 确定感兴趣的主题/群体/现象 → 文献综述 → 设计研究问题和研究及数据收集 → 定位研究场域和研究者的角色 → 定位信息提供者、守门人、信息来源 → 与参与者建立工作关系 → 同时实施研究和数据收集 → 数据分析与研究同时进行（或在研究结束后进行） → 报告结果和涌现的扎根理论或对研究问题的回答 → 生成供进一步研究或检验的假设（pp.121–122）。

> [!line-c] 混合方法研究
> 确定拟调查的问题或议题 → 确定研究问题 → 识别几种数据类型和收集方法，这些数据合在一起和/或分别将产生对研究问题的回答 → 规划混合方法设计（如平行混合设计、完全整合混合设计、顺序混合设计，见第1章） → 实施研究 → 分析结果 → 考虑替代解释 → 回答研究问题 → 报告结果（p.122）。
...
> - **③ 研究问题（Research questions）** 模型的核心，受参与者关切、资助方目标、伦理标准、研究范式影响
> - **④ 方法（Methods）** 受研究范式、研究者技能和偏好风格、研究情境、伦理标准、资助方目标、参与者关切影响
...
> | 典型研究类型 | 量化研究（如调查方法）——需要确定问卷项目、撰写和试点问卷、做最终调整 | 质性研究（如民族志）——研究者可能没有特定的研究问题，希望进入情境后随时间发现关键动态 |
> | 经典案例 | — | Turnbull (1972) 对 Ik 部落的研究（*The Mountain People*）——进入后发现惊人的人性堕落；Willis (1977) 的 *Learning to Labour*——"工人阶级孩子如何得到工人阶级工作" |

> [!concept-lens] 混合方法研究的中间地带
> 在"前载型"和"后载型"之间，混合方法研究可能包含多个阶段，每个阶段有不同的时间要求。表 7.2 给出了三种混合方法数据收集时间规划的示例（pp.125–126）：
...
> [!feature] 好假设的三特征
> - **方向性清晰** 方向性假设陈述差异或关系的**方向**（如"当学生受到内在激励时，表现会提高"）→ 单尾检验。非方向性假设仅预测**存在**差异或关系，不陈述方向 → 双尾检验。方向性假设用于已有研究提示特定方向时；非方向性假设用于已有研究不清、矛盾或无法预测时（pp.138–139）。
> - **可检验形式** 以使得研究者能够清晰设计研究来检验假设的方式撰写（p.139）。
> - **可测量结果** 以可产生可测量结果的形式撰写（p.139）。
...
> [!goal] 三项研究目的
> - **i** 呈现学校内组织文化（和子文化）的整体和深入图景，包括主导文化和子文化
> - **ii** 提供组织文化强度的指示
> - **iii** 就学校组织文化及其发展提出建议和推荐
...
>
> **D1 底层价值与假设（Underlying values and assumptions）**
> 最深层的文化——研究者需要探测这些而非直接观察
>
> **D2 展示价值与表现行为（Espoused values and enacted behaviours）**
> 组织成员表达和展现的价值和行为
>
> **D3 人工制品（Artefacts）**
> 物质环境、物体、文件、语言等可见符号
...
> [!conclusion] 示例总结
> 这个示例展示了一种系统的研究规划和实施方法——从学校的感知需求出发，在给定约束下运作，并清晰说明将"交付"什么。虽然研究没有指定待检验的假设，但如果偏好这种研究风格，将研究问题转化为假设并不困难（p.156）。
...
> [!example]- Box 7.3：研究规划检查清单（35条）
> | # | 问题 |
> |---|---|
> | 1 | 你是否已考虑到被研究现象的本体论和认识论特征？ |
> | 2 | 你是否已澄清研究目的？ |
> | 3 | 你想让研究做什么、交付什么、发现什么？ |
> | 4 | 研究的目的和目标是什么？ |
> | 5 | 你是否已识别研究的约束？它们是什么？ |
> | 6 | 你的研究在所需时间框架内是否可行？ |
> | 7 | 哪些研究途径（方法论）最适合研究——就被研究现象的本体论和认识论以及研究目的而言？ |
> | 8 | 研究建立在什么方法论和范式之上？它们与研究目的和现象性质有多大契合？ |
> | 9 | 你的研究是试图检验理论或假设、发展理论、调查探索、理解、描述、开发特定实践、评估，还是调查？ |
...
> | 21 | 你的研究是公开的还是隐蔽的？如果是隐蔽的或涉及故意欺骗，这如何被正当化？ |
> | 22 | 你是否已进行了文献综述，文献综述如何为你的研究提供信息？ |
> | 23 | 你的研究是否需要研究问题？如果不需要，为什么不？如果需要，它们是什么，是否已被全面、具体和公平地操作化？ |
> | 24 | 你是否已将研究目的操作化为研究问题？ |
> | 25 | 研究不同阶段的时间尺度是什么？ |
> | 26 | 你是否已确定在研究不同阶段需要什么类型的数据，为什么？ |
> | 27 | 你是否已确定在研究不同阶段需要什么工具进行数据收集？ |
> | 28 | 就规划、实施和分析而言，你的研究是"前载型"还是"后载型"？ |
> | 29 | 参与者是谁？ |
> | 30 | 你需要样本还是总体？总体是什么，样本和抽样策略是什么？ |
> | 31 | 你是否已规划如何分析数据，以及在研究的什么阶段？ |
> | 32 | 你是否已规划如何验证你的数据和你对数据的解释？ |
> | 33 | 你是否已规划何时和如何报告和呈现研究发现，以及向谁？ |
> | 34 | 你是否已规划如何传播你的研究发现？ |
> | 35 | 你是否已确定将对研究发现的发布施加什么控制，向谁、为何、多长时间，以及谁拥有研究和数据？ |
...
> - (a) "可信度"（trustworthiness）；(b) "对知识的贡献"；(c) 设计与报告的"明晰性"；(d) "合宜性"（法律和伦理要求）；(e) "范式依赖性"
>
> **D2 技术维度（Technological dimension）** — "使用价值"（value for use）
> - (a) "显著性/时效性"；(b) "合目的性"（purposivity）；(c) "具体性和可及性"；(d) "对促成影响的关注"；(e) "灵活性和可操作化性"
>
> **D3 能力建设维度（Capacity building and value for people）**
