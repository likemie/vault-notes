...
以 Morrison (1993, pp. 31–3) 为例（pp.135–138）：
...
> | **传记和生命史（Atkinson, 1998）** | 以个体生命历程为[[Unit of Analysis\|分析单元]]，关注转折事件、自我叙事与社会结构的交互 |
...
30个问题每个内部都包含若干子问题。例如问题5（"研究目的是什么？"）需区分主要和次要目的、显性和隐性目的、服务于谁的目的和利益（p.146）。此时规划者仍处于发散阶段（Morrison, 1993, p. 19）；在"决策"列中则走向收敛阶段。
