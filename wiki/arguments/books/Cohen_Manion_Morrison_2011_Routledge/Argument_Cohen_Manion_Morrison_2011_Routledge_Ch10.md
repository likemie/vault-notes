...
在民族志研究中，内部效度可通过多种方式解决（LeCompte & Preissle, 1993, p. 338）（p.166）：
...
Lincoln & Guba (1985, p. 219, 301) 认为[[Interpretive Paradigm|自然主义探究]]中的可信性（credibility）可通过以下六种方式实现（p.167）：
...
在自然主义研究中，可推广性被重新解释为**可比较性（comparability）**和**可迁移性（transferability）（Lincoln & Guba, 1985; Eisenhart & Howe, 1992, p. 647）**（pp.171–172）。这些作者建议评估情境、参与者和环境的**典型性（typicality）**，识别可能的比较群体，并说明数据如何转化为不同环境和文化的意义（LeCompte & Preissle, 1993, p. 348）。
...
Lincoln & Guba (1985, p. 189, 300) 列出了自然主义研究的外部效度威胁（p.172）：
...
> 催化效度的议程是帮助参与者**理解他们的世界，以便转变它**。议程是明确的政治性的——需要揭露**谁对情境的定义在情境中运作**。Lincoln & Guba (1986) 建议（a）增进和改善参与者对世界的体验，以及（b）增进参与者的赋权。研究应关注**可能是什么（what might be——创新和未来趋势的前沿）**和**可以是什么（what could be——理想的、可能的未来）（Schofield, 1990, p. 209）**。
...
> [!def] 内容效度的定义
> 内容效度要求工具必须显示它**公平且全面地**覆盖了它声称要覆盖的领域或项目（Carmines & Zeller, 1979, p. 20）（pp.175–176）。它关乎**覆盖（coverage）**和**代表性（representativeness）**而非回应模式或分数。
...
**质性构念效度**必须证明研究者使用的范畴对参与者本身是**有意义的（Eisenhart & Howe, 1992, p. 648）**——范畴反映的是参与者**实际体验和解释**研究情境的方式——通过行动者的眼光看情境（p.177）。
...
> - **生态谬误（ecological fallacy）** 将在聚合数据中发现的关系（如均值分数）假定适用于个体——假设群体中的每个个体表现出与群体整体相同的特征（一种**刻板印象**形式）（Morrison, 2009, p. 62）。核心警告：在群体层面发现的不一定等同于在个体层面也会发现
...
> [!tip]- 增强回译效度的变体
> - **双人翻译双人回译（Banville et al., 2000, p. 379）** 在译入和回译阶段各使用多人（各自独立工作），比较各自版本并讨论差异——避免单一译者的偏差
> - **专业译者**Banville et al. (2000) 报告使用专业译员而非简单回译以确保翻译中相似项目的可区分性
> - **去中心化（decentring）** 当目标语言中不存在完全对等的词汇时，可能需要对**原始语言和译文语言双方**做出妥协——原文和译文的语言同等重要（Liu, 2002, p. 81），且都对所有群体友好
...
> [!note]- 步骤 4 的操作要点
> **双语参与者同时完成两种语言版本**，然后比较两套答案寻找差异（Liu, 2002, pp. 81–2）。这要求研究者能接触到足够大的双语参与群体——对于独立研究者可能不可行。
...
文化效度（Morgan, 1999）与跨文化研究和生态效度相关，定义是**"一项研究对将要进行研究的文化环境的恰当程度"（Joy, 2003, p. 1）**（pp.186–187）。它适用于研究的**所有阶段**——规划、实施和传播——涉及对参与者、文化和被研究环境的**敏感度**。

> [!quote] Morgan (2005, p. 1) 的文化效度定义
...
Joy (2003, p. 1) 提出了十二个贯穿研究全过程的文化效度问题：
...
在教育中，生态效度对于追踪政策如何实际"在粉笔层面"（at the chalk face）发生尤为关键（Brock-Utne, 1996, p. 617）（pp.187–188）。
...
生态效度在此方面更同情质性研究和"厚描述"（Geertz, 1973），而非那些试图在人为情境中隔离、控制和操纵变量的定量实证研究方法。一个伦理张力在于：需要在**提供情境的丰富描述**和**增加情境或机构被识别的可能性并违反匿名性**之间取得平衡（Brock-Utne, 1996, p. 618）。
...
>   使用**多于一位观察者（或参与者）**在研究环境中。独自工作的观察者和参与者各有自己的观察风格，这反映在结果数据中。因此，谨慎使用两位或更多独立工作的观察者或参与者可以产生更有效和更可靠的数据（Smith, 1975）。Silverman (1993, p. 99) 强调数据应被多于一位观察者**独立发现**。
...
> | **最小化反应性效应** | 受访者在被审视或被置于新情境时行为不同（Lave & Kvale, 1995, p. 226） |
...
Guba & Lincoln (1994) 认为信度概念主要是实证主义的。虽然广泛持有的信度观点确实更贴近实证主义而非质性研究，但**并非排他如此**。质性研究也必须像实证主义研究一样可靠——不过以不同方式：信度的标准和类型在量化和质性研究中是不同的。Brock-Utne (1996, p. 613) 强调：既不是质性研究_per se_能保证信度，也不是信度在质性研究中无关紧要。信度作为效度的**前提或必要条件（sine qua non）（Brock-Utne, 1996, p. 614）**——对量化和质性研究都相关（p.200）。
...
> [!ref-table] 量化信度提高策略（Cooper & Schindler, 2001, p. 218）
> | 策略 | 说明 |
> |---|---|
...
> [!claim] 质性信度作为"吻合度"
> Bogdan & Biklen (1992, p. 48) 提出：质性研究中的信度可被视为**"研究者记录为数据的内容与在被研究的自然情境中实际发生的内容之间的吻合度"**——即一定程度的准确性和覆盖面的全面性。但这**不是追求一致性**——经典例证是 Nissan 英国汽车工厂研究（p.206）：Wickens (1987) 发现了"良性循环"（灵活性、团队合作），而 Garrahan & Stewart (1992) 发现了"恶性循环"（剥削、控制）——**同一现实的两个版本共存，因为现实是多层次的（Eisenhart & Howe, 1992）**。

---

#### 确保信度：质性操作策略

> [!ref-table] 可依赖性的构成策略（Lincoln & Guba, 1985, pp. 108–9; Brock-Utne, 1996）
> | 策略 | 说明 |
> |---|---|
...
> [!tension] 访谈权力的不对称
> - **标准观点：访谈者拥有更多权力** Scheurich (1995, p. 246) 和 Kvale (1996, p. 126) 认为访谈者生成问题、受访者回答；受访者被审视而访谈者不被审视——存在明确的**不对称性**。访谈者倾向于定义情境、话题和访谈进程。
...
Kvale (1996, pp. 148–9) 列出了熟练访谈者应具备的素质（pp.214–215）：
...
信度问题不仅存在于访谈的准备和进行中——它们还延伸到访谈的**分析**方式。Lee (1993) 和 Kvale (1996, p. 163) 评论了**"[[Transcription in Qualitative Research|转录]]者选择性"（transcriber [[Selectivity]]）**问题（pp.215）：访谈转录——无论多么详细和完整——仍然是**选择性的**，因为它们是社会情境的**解释**。它们变为**去情境化的、抽象的**——即使记录了沉默、语调、非语言行为等。因此问题不在于它们是否完全可靠，而在于它们对研究者的**整体有用性**。
...
1. **填写者是否准确、诚实和正确地完成**——可通过**深层访谈方法（intensive interview method）**核查，包含十二项主要策略：[[Familiarization|熟悉化]]（familiarization）、时间重构（temporal reconstruction）、探查（probing）和挑战（challenging）等。详见 Belson (1986, pp. 35–8）
...
测验面临多方面的信度问题。Wolf (1994) 提出了影响信度的四个主要因素：**被测试群体的范围、群体的熟练水平、测量的长度**（测试越长，错误机会越大）和**信度的计算方式**。Fitz-Gibbon (1997, p. 36) 认为，在其他条件相等的情况下，**更长的测试比更短的测试更可靠（pp.220–226）**。
...
> [!dimension] 教师评估不一致的六种来源（Harlen, 1994, pp. 140–2, p.225）
...
> [!warning] Box 10.1：生命史研究偏差的主要来源（改编自 Plummer, 1983, p. 103, table 5.2）
>
> **来源：信息提供者（Informant）**
> - 是否给出了错误信息（非故意）？
> - 是否有回避（evasion）？
