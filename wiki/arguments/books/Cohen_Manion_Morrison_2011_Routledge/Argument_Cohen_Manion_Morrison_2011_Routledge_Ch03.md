...
> ```mermaid
> flowchart LR
>   A["研究与评估<br>共享方法论基础"] --> B["8项共享特征<br>Norris (1990): 评估是研究的延伸"]
>   A --> C["科学方法7步骤<br>Smith & Glass (1987)"]
>   B --> D["Smith & Glass (1987) 8点差异"]
>   C --> D
>   D --> E["Glass & Worthen (1990) 11点差异"]
>   D --> F["Morrison (1993) 评估定义<br>5个关键特征"]
>   E --> F
>   F --> G["MacDonald (1987): 评估者的政治立场<br>专制型/官僚型/民主型<br>评估≠研究的分支"]
>   G --> H["边界模糊化<br>分类资助 + 政治化"]
>   H --> I["顺应性评估<br>Stronach & Morris (1994) 8特征"]
>   H --> J["学校微观政治<br>Hoyle (1986); Barton (2002)<br>行动研究的政治化"]
>   I --> K["研究、政治与政策制定<br>第3.2节"]
>   J --> K
>   K --> L["研究利用4模型<br>Weiss (1991b)"]
>   K --> M["研究者 vs 决策者张力<br>Levin (1991); Radford (2008)"]
>   L --> N["知识政治学<br>Usher & Scott (1996)"]
>   M --> N
> ```
...
>
> 这恰好对应了 Smith 和 Glass（1987）8点差异中的多数维度——分类资助在操作上将研究推向评估的一端。
...
> 2. 概念上确实存在差异（Smith & Glass, 1987 的8点差异；Glass & Worthen, 引自 Norris, 1990 的11点差异；MacDonald, 1987 的政治类型学），但**实践中边界严重模糊**。
