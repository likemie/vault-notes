...
研究与评估共享社会科学的全部方法论和方法工具。具体而言，涵盖以下8个方面（p.30）：
...
> | 4 | 发展研究设计，操作化研究问题，陈述零假设 | 将概念关系转化为可检验的操作定义 |
> | 5 | 实施研究 | 按设计收集数据 |
...
> | **价值立场**（Values） | 追求 value neutrality（价值中立） | 必须呈现**多重价值立场**并包含关于这些价值的数据 |
...
> [!implication] 顺应性评估不是个体道德失败，而是结构性产物
> Stronach 和 Morris 的分析指向一个系统性问题：当评估者的**未来资助**取决于当前评估报告的**政治可接受性**时，评估者面临的不是"是否应该保持独立"的道德选择，而是**结构性的[[Conflict of Interest in Research|利益冲突]]**。第6条（合同关系）是其他7条的制度根源——只要合同赋予赞助方对发表和数据所有权的控制，评估者在报告中的每一步都承受着顺应性压力。这不是个别评估者的职业操守问题，而是高度政治化的委托评估生态系统的内在特征。
...
> [!abstract] 核心结构
> 前一节的讨论已表明教育研究具有不可逃避的政治维度。本节从三个层面展开这一判断：（1）**宏观政治**层面——资助安排、传播控制和数据所有权如何政治化研究；（2）**[[Research Utilization|研究利用]]**层面——研究产生的多种知识类型如何通过不同模型进入政策制定过程；（3）**[[Epistemology|认识论]]**层面——研究政治性的最深层次体现：谁定义什么算作有价值的研究知识。
...
> [!line-a] 环节一：资助决定研究什么
> Burgess（1993）注意到一个系统性转变：从**研究者指定研究主题**向**赞助方指定研究焦点**的转变。资助被限定在"政策相关"的范围内——即研究必须"指导政策决策、改善政策制定者关注的领域质量、促进政策实施、评估政策执行效果"。这意味着：如果[[Research Problem|研究议题]]不涉及政策问题，就很难获得资助。
...
> [!framework-table] Table 3.4：Weiss（1991b）的研究利用四模型
> | 模型 | 隐喻 | 研究在政策中的角色 | 典型场景 |
> |------|------|--------------------|----------|
> | **研究与开发模型**（R&D Model） | 流水线 | 研究通过线性阶段——基础研究→应用研究→开发→推广——逐步转化为政策方案。假定知识可以像产品一样被"制造"和"交付"。 | 医学领域的[[Randomised Controlled Trials\|随机对照试验]]→临床指南→医保政策 |
...
> 核心概念参见：[[Research Utilization|研究利用]]。
...
> | **方法论偏好** | 多元方法论，根据问题选择方法 | 偏好实证主义方法——追求"简单影响模型"（Simple Impact Model），常通过不合法汇总降低数据质量（Cartwright, 1991; Cook, 1991; Radford, 2008: 506） |
> | **对研究的评价** | 研究是需要时间、资源和谨慎判断的复杂活动 | 研究发现太不确定（Kerlinger, 1991; Cohen & Garet, 1991）、处理的是世界观（Weltanschauung）而非具体问题、设计太复杂、适用性有限（Finn, 1991） |
>
> 表中核心概念参见：[[Positivism|实证主义]]。
...
>
> 知识的社会建构必须考虑不同群体定义何为有价值研究知识的**不平等权力**。这不是在研究之外附加的政治议题，而是研究本身的构成性条件。
