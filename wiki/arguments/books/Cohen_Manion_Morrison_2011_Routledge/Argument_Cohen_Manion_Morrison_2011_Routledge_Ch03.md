...
> - **利益与议程**：研究者追求知识、检验理论、理解复杂现实；决策者追求政治生存（Cook, 1991）、推进社会项目。
> - **受众**：研究者面向学术同行、研究社区；决策者面向选民、利益群体、政治上级。
> - **时间尺度**：研究者遵循内在节奏，长期开放式；决策者受选举周期驱动，短期紧迫。
> - **术语**：研究者使用专业概念、方法论文本、谨慎的条件句；决策者使用简明口号、确定性陈述。
> - **对不确定性的态度**：研究者承认复杂性，报告[[Confidence Interval\|置信区间]]和限制条件；决策者要求确定性、简单因果、不含糊的数据。
> - **方法论偏好**：研究者采用多元方法论，依问题选择方法；决策者偏好实证主义，追求简单影响模型（Simple Impact Model），常通过不合法汇总降低数据质量（Cartwright, 1991; Cook, 1991; Radford, 2008: 506）。
> - **对研究的评价**：研究者视研究为需要时间、资源和谨慎判断的复杂活动；决策者认为研究发现太不确定（Kerlinger, 1991; Cohen & Garet, 1991）、处理世界观（Weltanschauung）而非具体问题、设计太复杂、适用性有限（Finn, 1991）。
>
