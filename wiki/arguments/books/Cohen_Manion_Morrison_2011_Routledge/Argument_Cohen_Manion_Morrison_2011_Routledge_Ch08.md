...
> - **Borg & Gall（1979: 195）的五条大样本规则**：当以下条件成立时样本量应大——变量多、预期差异或关系小、样本需分子组、总体在关键变量上[[Heterogeneity|异质性]]强、因变量的可靠测量不可得。
...
> [!case] 比例标准误如何改变结论
>
> 一位校长随机询问 25 名学生关于改变午休时间的意见，66% 赞成（$P = 66$），34% 反对（$Q = 34$）。计算得 $SE = \sqrt{(66 \times 34) / 25} = 9.4$。
>
> 赞成票实际可能在 56.6%–75.4% 之间，反对票实际可能在 24.6%–43.4% 之间。从 66% vs 34% 的明显多数，变成了可能只有 56.6% 赞成、可能高达 43.4% 反对，远没有那么决定性。
>
> 若将样本扩大至 100 名学生，$SE = 4.5$，范围缩小至 61.5%–70.5%（p.151）。若调查全校 1,000 名学生，$SE = 1.5$，范围缩小至 64.5%–67.5%（p.151）。
>
