...
>
> 公式直接驱动结论变化：$N$ 在分母，$N$ 每扩大 10 倍，$SE$ 缩小约 $\sqrt{10} \approx 3.16$ 倍。$N = 25$ 时连多数是否存在都无法判断；$N = 1000$ 时结论才变得可靠。这就是为什么政治民调通常基于 1,000–1,500 的样本量（Gardner, 1978），由 $SE$ 公式直接决定（p.151）。
>
