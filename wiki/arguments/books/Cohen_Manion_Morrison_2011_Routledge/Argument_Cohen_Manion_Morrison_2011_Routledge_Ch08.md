...
>
> > [!index-table] 比例标准误随 $N$ 变化
> > | $N$ | $SE = \sqrt{PQ/N}$ | 赞成范围（$P \pm SE$） | 反对范围（$Q \pm SE$） | 结论 |
> > |---|---|---|---|---|
> > | 25 | $\sqrt{2244/25} = 9.4$ | 56.6%–75.4% | 24.6%–43.4% | 无法判断 |
> > | 100 | $\sqrt{2244/100} = 4.5$ | 61.5%–70.5% | 29.5%–38.5% | 有微弱多数 |
> > | 1,000 | $\sqrt{2244/1000} = 1.5$ | 64.5%–67.5% | 32.5%–35.5% | 可靠确认多数 |
>
...
> - **阶段七：决定准入和接触方式** — 广告、信件、电话、电子邮件、个人拜访、个人联系/朋友，选择最适合目标人群的方式。
> - **阶段八：准备加权数据** — 数据收集后，可能需要按需调整权重以使样本更公平地代表总体（pp.168–169）。
