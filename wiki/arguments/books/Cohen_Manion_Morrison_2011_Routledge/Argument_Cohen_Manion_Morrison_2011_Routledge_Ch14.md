...
Yin告诫在单案例设计中要谨慎，这忽视了多案例的可能好处（复制、避免被批评为独特单一案例），研究者把所有鸡蛋放在一个篮子里可能是有风险的，面临全有或全无的局面。在考虑多案例研究时需决定需要多少个案例；通常[[Research Question|研究问题]]越微妙，可能需要越多案例（Yin, 2009, p. 58），以排除竞争性解释。一个单案例可能是多案例研究设计的一部分，而一种特定数据收集工具（如调查）可能是跨地点个案研究的一部分（pp. 284–285）。
...
记录个案研究数据收集的时间和地点非常重要：不仅因为许多行动和事件是情境特定的且属于[[Rich and Thick Description|厚描述]]的一部分，而且这将使任何复制研究能够被规划（Macpherson et al., 2000, p. 56）（p.289）。
...
Bailey（1994, p. 247）解释了两者在情境中的选择逻辑：在自然情境中，进行隐蔽研究的研究者很难不作为参与者行动——如果研究者不表现出参与，那么为什么在那里？因此许多自然情境中研究者采用参与观察。实验室或人工情境中则更适合非参与观察（如视频记录）（p. 292）。
...
> [!dimension] 规划个案研究的三类考虑事项（Adelman et al., 1980）
> - **案例的具体情况**
>   - 参与可能给个体参与者带来的干扰
>   - 谈判接触人员
>   - 谈判数据所有权
...
> - **研究对参与者的后果**
>   - 可能包括研究的匿名化以保护参与者
>   - 匿名化可能暗示个案研究的首要目标是推广而非描绘独特案例，即可能违背个案研究的核心特征。使案例不可辨认所涉及的扭曲可能过于高昂，不值得为公开发表而付出
