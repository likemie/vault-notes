...
> [!evidence-grid] Box 14.1 Adelman et al.（1980）的六项优势
> - **现实感强（strong in reality）** 个案研究数据贴近现实但难以组织；其他研究数据往往脱离现实但易于组织。这种现实感来自接地气、与读者自身经验协调，因而提供自然的推广基础
...
> - **结果更易被广泛受众理解** 常用日常、非专业语言书写，包括非学术界人士
> - **立即清晰易懂** 为自己说话
> - **捕捉独特特征** 捕捉大规模数据中可能丢失的独特特征，这些可能持有理解情境的关键
> - **现实感强** 贴近真实情境
> - **为类似案例提供见解** 协助解释其他类似情境和案例
> - **可由单一研究者承担** 不需要完整研究团队
> - **接纳未预期事件和未控制变量** 灵活应对研究过程中的意外
