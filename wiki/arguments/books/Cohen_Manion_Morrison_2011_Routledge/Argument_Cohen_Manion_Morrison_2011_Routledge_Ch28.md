...
> [!info] 是否转录的权衡
> 研究者需要考虑是否为分析而转录访谈数据。一方面，转录能提供重要细节和准确的逐字记录；另一方面，转录省略了非言语方面、访谈前后可能发生的事以及访谈的情境特征。在[[Praxis|实践]]层面，传统人工转录非常耗时，一小时访谈可能需要五到六小时来转录；如今 AI 语音识别已能自动转写音频，准确率很高，人工转录多被 AI 转写加人工校对取代。一个替代方案仍是直接从视频或音频录音中书写分析，从原始来源而非转录这一中介来源中选取重要材料，从而避免陷入细节而看不见整体图景。（28.1）
...
> [!warning] 转录的准确性与语音识别
> 无论人工转录还是 AI 转写，转录者都需核验准确性，因为听错或混淆词语并不罕见（Gibbs, 2007, p. 19 提供了许多此类例子）。现代 AI 语音识别已高度成熟，可自动转写语音并大幅节省时间，但多说话者、口音与噪音情境下仍可能出错，输出须经人工校对。（28.1）
...
> | 概括 | 诠释 |
> | 发现模式 | 生成主题 |
> | 理解个体（[[Idiographic\|个例式]]） | 理解群体（[[Nomothetic\|通则式]]） |
> | 提出问题 | 证明或演示 |
...
> 找到立足点是一桩令人不安的事，它从不会真正成功，至多只是远远地接近成功；作为个人经验，民族志研究恰恰就在于这件事。（Geertz, 1973, p. 13）（28.2）
