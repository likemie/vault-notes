...
> [!contrast-table] 方法优先 vs 目的优先
> | 维度 | 方法优先 | 目的优先 |
> |---|---|---|
> | **出发点** | 我擅长X方法、偏好Y工具 | 研究要回答什么问题 |
> | **决策逻辑** | 选择能用X或Y方法回答的[[Research Question\|研究问题]] | 问题决定需要什么方法，我去学习或采用该方法 |
> | **常见说法** | 我喜欢问卷、我害怕数字、我偏好访谈、我觉得隐蔽研究不道德所以不做 | 研究目的决定研究类型、方法、工具、抽样和伦理立场 |
> | **根本问题** | 手段（方法）决定目的（问题） | 目的（问题）决定手段（方法） |
> | **后果** | 损害严谨性，研究可能无法回答它声称要回答的问题 | 研究设计内在一致，方法服务于问题 |

> [!conclusion] 目的适配性的操作推论
> 研究规划的操作顺序必须是**先明确目的，再选择方法**。对方法的偏好、熟悉或恐惧不应进入方法选择决策，它们只应在选定方法后作为是否需要额外训练或支持（additional training or support）的实操考量出现。
