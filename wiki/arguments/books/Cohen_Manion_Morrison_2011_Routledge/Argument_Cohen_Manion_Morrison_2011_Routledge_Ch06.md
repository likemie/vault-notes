...
选择研究课题通常是成功研究的**决定性特征**。核心论证链是一条从宏大到严谨的收窄逻辑，由三个链节串联而成：

> [!chain-link] 链节一：新手从过于宏大的课题出发
> 许多新手学生和研究者从一个**过于宏大的课题**出发。导师或指导者的任务是帮助新手将研究领域收窄和打磨，使其变得可行、有用、可操作。研究的纪律在于将其缩小到可管理／可研究的比例（cf. Hopkins, 1985: 47）。因此，严谨性的第一个前提是课题必须被框紧。

> [!chain-link] 链节二：研究不是个人观点的佐证
> 新手研究者往往让教育研究成为自己的人生故事，或为个人观点寻找文献和经验研究支撑。这不是研究的任务。研究的任务是发现（find out）、调查（investigate）、发展（develop）、检验（test out）和回答（what if、how、why、how well、what、where）。因此，研究的指向必须是外部世界的问题，而非研究者自身的意见。

> [!chain-link] 链节三：窄化通向严谨
> 研究课题只是学科领域中的一小块，必须围绕课题画出谨慎的边界。严谨性不在于宏大，而在于框得紧（tightly framed）。未经收窄的课题如同没有边界的田野，研究者在其中漫游，最终哪里也到不了。课题过于宏大会导致无法管理，无法管理则无法嵌入严谨性（[[Fitness for Purpose|目的适配性]]和方法可靠性），缺乏严谨性则研究失败。因此，规划阶段的第一个纪律就是将课题收窄到可研究的比例。
...
> [!claim] 核心主张：目的决定方法
> [[Research Purpose|研究目的]]是研究预期交付什么（what the research will deliver），即研究完成后哪些在研究开始前不知道的知识将被获得。这不同于预测研究结果，预测结果等于操纵（fix）研究。正确的做法是**声明研究所要提供的答案类型或信息类型**。
...
>
> **教师创伤研究**：医院教师对与HIV阳性儿童一起工作的反应。这些教师在工作一天结束时可能已受创伤或情感耗尽，最不想做的就是与陌生研究者继续谈论，只想回家关闭（switch off）。
>
...
> 一位研究者想研究学生抑郁症，但她内心认为学生只是懒惰或工作回避，把情绪低落当作借口，即**拒绝承认抑郁症作为临床状况或病理障碍的严重性**。这样的研究者去研究抑郁症，对研究者和参与者都可能是灾难。
>
...
>
> 这个追问将研究从想改变世界拉回到**现实可达成的目的**。在参与式研究中，这个判断尤为重要。
...
> 一个有用的方法是从一组一般目的逐步移动到一系列具体的、实质性的议题和领域，并为每个议题框定一个或多个研究问题或待辩护的论点。研究问题的**答案**构成了前文提到的交付物（deliverables）。
>
> 在决策时，审视研究问题本身的以下维度：
> - 清晰性（clarity）
...
>
> **2. 赋予研究可信度与合法性**
> 向读者展示研究者已做好功课，了解该领域最新的关键议题以及理论、概念、方法论和实质性问题。
>
> **3. 澄清关键概念、议题和术语**
...
>
> **7. 明确新领域需要在哪里突破**
> 展示拟议研究将如何在何处突破新领域和／或填补空白。这是文献综述从回顾到前瞻的关键转折。
