...
> [!challenges] Hopkins (1985, p. 47) 的提醒：影响力的边界
...
> [!warning] 研究问题的缺席
> 并非所有研究都需要研究问题。[[Ethnography\|人种志]]等研究类型可能不以研究问题开始。自然主义研究（见第11章）的特征之一是**尽量不打乱参与者的日常自然情境**。[[Open-Mindedness|开放性]]研究（如人种志、调查或焦点小组）可能在其结束阶段使用开放式研究来**提出研究问题**供后续[[Research Utilization\|研究使用]]。
>
