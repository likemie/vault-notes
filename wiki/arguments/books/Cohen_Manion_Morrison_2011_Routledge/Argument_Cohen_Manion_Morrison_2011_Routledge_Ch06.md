...
> 研究可能持续数周、数月甚至数年。选择课题时需要问：**这个议题能否在长周期内维持研究兴趣？** 如果答案是否定的，且没有非做不可的约束，就应考虑另选一个能够维持兴趣和动力的研究领域。由不情愿或感到厌倦的人进行的研究，很容易变得平庸。
...
> [!claim] 核心主张：原创性不够
> 研究必须是**原创的**、**重要的**、**非琐碎的**、**相关的**、**适时的**、**对更广泛受众有趣**且**能推进领域前进**。但仅凭原创数据和原创课题是不够的。
...
> [!warrant]- 两个案例的共同诊断
> 两个案例中，研究只产生了**原创数据**，仅此而已。研究需要超越这一点，选择一个**重要的课题**，真正为理解和实践做出重要贡献。研究应该能够推动领域前进，也许只是**小规模、零散、渐进**的方式，但无论如何要推进它：**没有这项研究，该领域将更加贫乏。
...
> 评估标准不仅包括研究对知识做出的**贡献**，还包括该知识的**影响**。资助机构通常要求说明研究将对研究界和更广范围产生什么影响，以及如何评估和了解该影响。核心追问是：研究将产生什么影响、被谁吸收、产生什么效果，以及对谁产生影响。

此外，明确研究将带来什么**益处**以及对谁有益，有助于聚焦研究及其受众。
...
> 研究规划的操作顺序必须是**先明确目的，再选择方法**。对方法的偏好、熟悉或恐惧不应进入方法选择决策，它们只应在选定方法后作为是否需要额外训练或支持的实操考量出现。
...
>
> **教师创伤研究**：医院教师对与HIV阳性儿童一起工作的反应。这些教师在工作一天结束时可能已受创伤或情感耗尽，最不想做的就是与陌生研究者继续谈论，只想回家关闭。
>
...
> [!tip] 决定是否追求某项研究的实用方法
> 一个有用的方法是从一组一般目的逐步移动到一系列具体的、实质性的议题和领域，并为每个议题框定一个或多个研究问题或待辩护的论点。研究问题的**答案**构成了前文提到的交付物。
>
> 在决策时，审视研究问题本身的以下维度：
> - 清晰性
> - 易答性
