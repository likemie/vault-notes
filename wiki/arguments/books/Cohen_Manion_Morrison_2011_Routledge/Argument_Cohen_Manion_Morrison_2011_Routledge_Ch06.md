...
> [!seq-table] 一、范围和焦点（1–5）
> | 操作建议 |
> |---|
> | **把课题做小。** 想小（small）而非大（big）。 |
> | **限制研究的范围和规模。** |
> | **想窄（narrow）而非宽（broad）。** |
> | **保持焦点清晰、有限、有边界且狭窄。** |
> | **对可用时间内能完成什么保持现实**，以及这是否或在多大程度上可能损害研究的可行性或价值。 |

> [!seq-table] 二、研究缘起与定位（6–7）
> | 操作建议 |
> |---|
> | **明确什么引发了这项研究**——为什么选择这个课题／项目。 |
> | 选择一个可能帮助你在研究或学术界**找到定位或专长**（niche or specialism），或可能帮助你**建立声誉**的课题。 |

> [!seq-table] 三、重要性与贡献（8–12）
> | 操作建议 |
> |---|
> | 决定研究为什么**重要、适时、有趣、及时、重要、原创、相关且具有积极的挑战性**。 |
> | 决定研究将对**概念、实践、实质、理论和方法领域**做出什么贡献。 |
> | 选择一个**有用的研究课题**，并决定它如何以及对谁有用。 |
> | 决定你的研究**为什么有用**以及谁将／可能对它感兴趣。 |
> | 决定你的研究可能产生什么**影响**（impact），以及对谁产生影响。 |

> [!seq-table] 四、可操作性与严谨性（13–15）
> | 操作建议 |
> |---|
> | 选择一个**可管理且可行**的课题。 |
> | 选择一个**能够行使严谨性**（rigour）的课题。 |
> | 选择一个**有清晰边界的课题**，或能够设定清晰、现实、公平边界的地方。 |

> [!seq-table] 五、研究目的与交付（16–18）
> | 操作建议 |
> |---|
> | 决定研究将**交付**什么（deliver）。 |
> | **研究将做什么？** |
...
> [!seq-table] 六、文献与准入（19–21）
> | 操作建议 |
> |---|
> | 选择**有文献存在**的课题。 |
> | 决定你是否能获得**所需准入**以及准入什么／谁以开展研究。 |
> | 决定在可用时间和时间尺度内**能做什么，不能做什么**。 |

> [!seq-table] 七、资源与研究问题（22–23）
> | 操作建议 |
> |---|
> | 决定在**个人、人际、物质、精力、财务和研究范围约束**内能做什么，不能做什么。 |
> | 考虑研究问题的**清晰性、范围、可操作性、全面性、易答性、框架、焦点、所需数据类型和可理解性**及其组合。 |

> [!seq-table] 八、影响与研究者适配（24–27）
> | 操作建议 |
> |---|
...
> | 操作建议 |
> |---|
> | 清楚你——**个人、职业、事业层面**——为什么要做这项研究，你个人想从中获得什么，研究是否能让你达成这些。研究将如何使你受益？ |
> | **研究将如何使参与者受益？** |
> | **研究将如何使教育界受益？** |
> | 选择一个能在研究期间**维持你兴趣**的课题。 |

> [!seq-table] 十、专长、复杂性与未来（32–36）
> | 操作建议 |
> |---|
> | 考虑你在想进行研究的领域中是否具备**足够的经验、技能和专长**，以便有见识地行动。 |
> | 考虑是否建议着手一项**故意不设研究问题的研究**。 |
> | 考虑研究现象、范围和执行的**必要复杂性**（在存在复杂性的地方），以及[[Research Problem\|研究议题]]、焦点和执行的**难度**。 |
> | 考虑**未来研究如何能建立在你的研究之上**——即研究开启可能性而非关闭它们。 |
