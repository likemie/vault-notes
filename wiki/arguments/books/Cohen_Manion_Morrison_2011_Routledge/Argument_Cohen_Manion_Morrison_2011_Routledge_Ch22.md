...
话语与言语行为的研究和[[Jürgen Habermas|哈贝马斯]]的[[Critical Theory|批判理论]]有深刻关联。哈贝马斯认为话语永远不只是脱离语境的句子（Habermas, 1970, p. 368），其意义来源于**主体间语境（intersubjective contexts）**（pp.454–455）。
...
>
> **研究背景** 美国南方黑人儿童与白人教师之间存在系统性的课堂误解。教师的假设是：学生和其他儿童一样会对语言常规和语言在[[Constructed Knowledge|建构知识]]与技能中的使用方式作出回应。Heath 试图理解：**为什么这些特定的儿童不像其他儿童那样回应？**
>
