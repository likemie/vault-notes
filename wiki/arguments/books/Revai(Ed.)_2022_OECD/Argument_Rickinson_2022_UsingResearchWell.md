---
summary: "基于澳大利亚莫纳什 Q 项目对 906 名教育者的两轮问卷与深度访谈，通过 QURE 框架阐释教育实践中高质量研究使用的两项核心要素、个体与组织使能条件及六大实践特征，指出改进研究利用须从证据供给侧转向实践需求端并保障专业学习与专有时间"
type: argument
subtype: book-chapter
publication_type: book-chapter
title: "Argument_Rickinson_2022_UsingResearchWell"
...
authors:
  ...
  - "[[Lucas Walsh|Walsh, L.]]"
  - "[[Joanne Gleeson|Gleeson, J.]]"
  - "[[Blake Cutler|Cutler, B.]]"
  - "[[Connie Cirkony|Cirkony, C.]]"
  - "[[Mandy Salisbury|Salisbury, M.]]"
source_language: en
...
sources:
  - "[[books/Revai(Ed.)_2022_OECD/Ch09_Rickinson_2022|Ch09_Rickinson_2022]]"
related_concepts:
...
> | 理论工具 | 解释功能 |
> |----------|----------|
> | **高质量研究证据使用框架**<br>[[Quality Use of Research Evidence Framework]] | 将质量使用界定为在复杂系统中由个体与组织使能条件混合支持的、对适切研究证据的深思熟虑参与和实施，包含核心要素、使能构件与系统影响。（pp.185–189） |
> | **证据知情实践**<br>[[Evidence-Informed Practice]] | 提供超越机械有效性教条的实践哲学，强调外部研究证据与教师[[Professional Judgment\|专业判断]]及本土情境的有机融通。（pp.183, 186） |
...
> [!method-panel] 研究设计与方法论阶段（Box 9.1: Study methodology, pp.184, 199）
> | 研究阶段与模块 | 实施方法、材料范围与分析路径 |
> |---|---|
> | **第一阶段：跨领域系统综述与框架建构**<br>[[Systematic Review]] & Narrative Synthesis | 2019 年启动前期概念研究，针对卫生保健、社会关照、公共政策与教育四大领域的[[Research Utilization\|证据使用]][[Document\|文献]]展开系统综述与叙事综合。研究发现各领域均普遍缺乏关于使用质量的直接界定，但均包含指向能力建设的间接思考。研究团队基于四份叙事综合报告提炼异同，初步建构 [[Quality Use of Research Evidence Framework\|QURE]] 框架，并通过与合作学校、教育行政部门及学界利益相关者的研讨会与工作坊迭代修订。 |
> | **第二阶段：大规模学校问卷调查研究**<br>[[Survey Research]] | 2020 年 3 月至 2021 年 10 月面向澳大利亚 4 个州开展两轮标准化问卷调查。**Survey 1** 聚焦实践中的研究认知与使用行为，回收有效问卷 492 份；**Survey 2** 聚焦促成与阻碍因素及专业发展需求，回收有效问卷 414 份。数据在统计产品与服务解决方案软件（Statistical Product and Service Solutions, SPSS 27.0）中录入，对李克特五点量表（同意与完全同意合并）及排序题进行二分类重编码，通过 Fisher 精确检验（Fisher's Exact Tests, $p < .05$）检验显著性关联。 |
> | **第二阶段：半结构化深度访谈与质性编码**<br>[[In-depth Interview]] | 针对 27 场深度访谈（共涵盖 29 名受访教育者，包含 20 名高级领导者、7 名中层管理者与 2 名普通教师）的录音文字稿，在 NVivo 12 质性分析软件中运用 Braun & Clarke (2006) 的法典式主题分析法（[[Qualitative Codebook\|codebook]] Thematic Analysis）。研究兼顾演绎理论[[Coding in Qualitative Research\|编码]]与归纳新主题[[Emergence\|涌现]]，精准捕捉实践者关于高质量与[[Poor Research Use\|劣质研究使用]]的质性定性。 |

> [!sample-panel]- 样本与材料快照（Annex Table 9.A.1: Sample details, p.199）
> | <small>划分维度与样本群体</small> | <small>Survey 1（$N = 492$）</small> | <small>Survey 2（$N = 414$）</small> | <small>深度访谈（$N = 29$*）</small> |
> |---|---|---|---|
> | <small>**新南威尔士州（New South Wales, NSW）**</small> | <small>149 人</small> | <small>158 人</small> | <small>5 人</small> |
> | <small>**维多利亚州（Victoria, VIC）**</small> | <small>195 人</small> | <small>150 人</small> | <small>13 人</small> |
> | <small>**昆士兰州（Queensland, QLD）**</small> | <small>116 人</small> | <small>83 人</small> | <small>9 人</small> |
> | <small>**南澳大利亚州（South Australia, SA）**</small> | <small>32 人</small> | <small>23 人</small> | <small>2 人</small> |
> | <small>**普通教师**</small> | <small>281 人</small> | <small>307 人</small> | <small>2 人</small> |
> | <small>**中层管理者**</small> | <small>60 人</small> | <small>32 人</small> | <small>7 人</small> |
> | <small>**高级领导者**</small> | <small>99 人</small> | <small>24 人</small> | <small>20 人</small> |
> | <small>**其他角色**</small> | <small>52 人</small> | <small>51 人</small> | <small>0 人</small> |
>
> **表格说明** 深度访谈共执行 27 场，受访者总人数为 29 人（部分场次为双人联合访谈）。量化调查总样本达 906 人次，广泛覆盖公立学校、天主教学校及独立私立学校不同学段，确保了实证结论对澳大利亚基础教育系统的代表性。
...
> ```mermaid
> flowchart LR
>     A["现实困境<br>供给驱动 (Push) 偏误<br>忽视实践使用质量 (Pull)"]
>     B["理论基石<br>QURE 框架双核互构<br>个体·组织·系统使能"]
>     C["实践特征<br>906 名教育者调查<br>六大特征 vs 劣质使用"]
>     D["组织杠杆<br>榜样型领导与互信文化<br>专业学习显著支撑实践"]
>     E["系统瓶颈<br>76% 遭遇时间赤字<br>行政繁杂挫伤循证意愿"]
>     F["行动蓝图<br>转向需求牵引与制度减负<br>协同构筑教育证据生态"]
>
>     A --> B
>     B --> C
>     C --> D
...
> [!contrast-table] 证据质量关注与使用质量关注的范式对照（pp.183–185）
> | 比较维度 | 传统证据质量关注（Quality of Evidence） | 创新使用质量关注（Quality of Use） |
> |---|---|---|
> | **问题取向** | 聚焦研究设计是否严密、实验控制是否严格、因果效应是否确定。 | 聚焦一线教育者如何理解、调适、批判并实施研究证据。 |
> | **系统定位** | 偏向研究供给驱动（Push），重视成果发表、证据库搭建与政策简报。 | 偏向实践需求牵引（Pull），重视实践者解决现场问题与专业反思。 |
> | **证据观念** | 假定证据具有脱离情境的普适性，可直接提供标准化干预处方。 | 强调证据的适切性，证据不能自行发声，须情境化诠释。 |
> | **实践者角色** | 被动接收研究结论并机械执行的技术工人或管道末端。 | 融合专业[[Phronesis\|实践智慧]]、展开集体审议与反思探究的专业主体。 |
...
> ![](https://img.mylikemie.icu/books/Revai(Ed.)_2022_OECD/figures/Figure_9-1_Quality_Use_of_Research_Evidence_framework.jpg)
>
> **图表说明** QURE 框架以适切研究证据与审慎参与及实施为双核内核，由个体使能构件（技能、心智、关系）与组织使能构件（文化、领导力、基础架构）构成支撑基底，并受外部宏观系统力量持续塑造。（pp.185–189）

> [!theory-components] QURE 框架的内核与多层使能构件（pp.185–189）
...
#### 3. 证据的有效转化依赖个体批判审思心智、多源适切性辨析与教研组协作网络的有机结合

> [!case] 专职特教教师 Alex 的个体使能实践（Box 9.2: Alex's story – Individual enablers in action, p.187）
> **任教背景** Alex 是澳大利亚一所小型公立小学的专职教师，该校绝大部分学生身处深度处境不利环境，面临身心残疾、极度贫困或家庭心理创伤等多重困境。
>
...
### 论证步骤二　一线教育者的经验认知赋予高质量使用实质内涵，确立六大实践特征并与劣质研究使用（Poor Research Use）形成鲜明对照

> [!claim] 步骤二核心主张
> 澳大利亚 906 名教育者的实证反馈表明，高质量研究使用并非空洞的学术概念，而是具备高度目的性、常态嵌入性与专业自尊的实践形态；教育工作者通过对高质量使用与劣质使用的鲜明对比，确立了六大核心实践特征。（pp.189–191）
...
#### 2. 一线共识确立高质量使用具备目标明确、常态嵌入、专业认同、集体研讨、依赖工时与好奇驱动六大特征

> [!feature] 高质量研究使用的六大实践特征（Table 9.2, pp.190–191）
> - **目标明确（Purposeful）** 使用意图与实践行为高度聚焦，拥有清晰透明的推进逻辑与情境针对性。
> - **常态嵌入（Embedded）** 成为学校文化的内在基因，深度嵌入规划周期、日常研讨与教研日程。
...
> |---|---|---|
> | **目标明确**<br>（Purposeful） | 1. 研究使用的意图与个体行为均具有明确指向性；<br>2. 实践变革拥有明确方向，对研究本身及使用过程均具备清晰透明的阐释逻辑；<br>3. 证据使用决策受教学情境、学生特质与学校环境深刻塑造。 | “这必须从最高层开始……形成属于全校的共同决策。它是透明清晰的，我们确保所有教职人员都能理解在使用研究时到底期望达到什么目标。”<br>——*公立小学高级领导者，深度访谈* |
> | **常态嵌入**<br>（Embedded） | 1. 成为学校组织文化或生态环境的内生组成部分；<br>2. 深度嵌入日常教学实践、学校规程与作息日程（如规划与评估周期、正式与非正式研讨、行政决策）。 | “用好研究意味着它已经成为你教学方法的内在本质……我们时时刻刻都在探讨研究。”<br>——*公立小学高级领导者，深度访谈* |
> | **连接专业精神**<br>（Connected to teacher professionalism） | 1. 研究使用被视为教师专业角色的内在期待；<br>2. 与教学改进、学生发展、教师自身技能与信心增强以及学校公信力紧密关联。 | “对我而言，要想觉得自己把本职工作做好了，我就必须进行能指导教学的专业研读，从而让我能深刻理解实践，确信自己做的是正确的事。”<br>——*公立小学高级领导者，深度访谈* |
> | **集体参与**<br>（Collective） | 1. 强调教职工在研究使用过程中的全员集体参与；<br>2. 包含全员协商、集体认同、小组研讨反思，以及协同互信的校风建设。 | “这绝不是关于我［学校领导者］个人的事，而是关于整个集体，关于调动教职员工共同参与到研究之中。”<br>——*天主教中学高级领导者，深度访谈* |
> | **依赖时间与精力投入**<br>（Time and effort dependent） | 1. 必须在校内正常工作时间内为研究使用专门划拨并投入充足时间与精力；<br>2. 深入审读研究、开展教学试验并评估成效的耐心在学校文化中受到高度认可。 | “鉴于我们生活在快节奏的工作与学校环境中……我认为放慢节奏以换取长远加速（slowing down to then help you speed up）正是我们当前必须做到的理念。”<br>——*公立小学高级领导者，深度访谈* |
> | **好奇心驱动**<br>（Curiosity-driven） | 1. 拥有成长型思维与好奇求知倾向，对通过研究获取新知保持开放胸襟；<br>2. 形成敢于质疑既有惯例、持续探索教学改进的学校探究文化。 | “第一位的心智倾向就是保持好奇。我不断强调探究这个词……拥有以探究为导向的行动意愿，深入探索那些研究究竟讲了什么。”<br>——*公立小学高级领导者，深度访谈* |
...
> [!conclusion] 组织支持生态对化解角色对立的决定性意义（p.191）
> 教师对行政独断的批判与管理层对教师消极防卫的抱怨，深刻折射出缺乏组织使能机制时的责任推诿。高质量使用既无法依靠单纯自上而下的行政命令推行，也不能单凭教师个体的孤立自觉，唯有构建兼顾协同参与、心理安全与资源保障的校级支持生态，才能实质弥合这一结构性断层。

---

### 论证步骤三　高质量研究使用深度依赖校级组织生态，亟需以榜样型领导力与专业学习破解深层技能与时间赤字

> [!claim] 步骤三核心主张
> 高质量研究使用深嵌于学校微观组织生态之中；实证检验表明，榜样型领导力与校内专业学习能显著提升教师常规使用研究的概率，而压倒性的时间赤字构成了阻碍教师深思熟虑使用研究的最严峻制度壁垒。（pp.191–193）

#### 1. 榜样型领导力与互信知识文化构成研究常态化嵌入的核心杠杆
...
> - **全校知识共享文化**
>   81% 受访者强调校内开放透明的专业交流机制，打破学科组与年级组的孤岛壁垒；96% 访谈指出领导力是塑造循证文化的核心支柱。

#### 2. 领导者躬身示范、制度化专有排程与校际网络协同构筑常态化循证的实践庇护所

> [!case] 特殊学校教师 Genevieve 的组织使能实践（Box 9.3: Genevieve's story – Organisational enablers in action, p.188）
> **学校使命** Genevieve 执教于一所专门招收肢体与智力残疾学生的政府公立特殊学校，学校的核心改进目标就是深化循证教学策略以最大限度改善残障儿童的学习成效。
>
> **领导示范** 该校校长 Kerrie 深入教学一线（*very hands on*）。她坚持每周与全校每一位教师进行为期 1 小时的一对一深度交流，共同研读学术文献，逐一探讨如何在个别化课堂中落地应用，并预判可能遭遇的教学挑战。
>
> **架构保障** 校长建立了制度化的专业学习共同体（Professional Learning Community, PLC），安排教师与助教定期研讨，制定全校协同的循证教学策略。Genevieve 强调这一排程的不可替代性：
> > “［我们拥有］围坐在一起探讨问题、解释要义并研读研究要点的专门时间……这让大家有机会在不确定时主动发问……而不是在教职工大会上被仓促挤兑过去。”
>
> **跨校网络** 学校并未闭门造车，Genevieve 积极参与区域校际协作网络，与其他学校联合试验循证策略并反馈成果；学区教研办公室亦定期指派专业顾问驻校指导，协助教师调适研究成果并评估改进成效。
>
> **要素印证** 该案例生动展现了组织使能三大支柱的合力：Kerrie 的躬身参与确立了**领导力示范**，常态化研读制度塑就了**组织文化**，而每周专有时间、PLC 研讨与区域网络构筑了坚实的**基础架构**。

> [!exegesis]- 组织使能三大支柱在特殊教育现场的共振机制（p.188）
> Genevieve 的实践样态清晰表明：领导者的亲身参与（每周一对一辅导）提供了试错的心理安全感；制度化的专有研读排程（PLCs）打破了行政事务对教研的碎片化挤压；跨校区域网络则打破了单一特教学校的资源孤岛。组织使能的本质是为一线教师搭建可安心开展深层探究的制度化庇护所。

#### 3. 实践者普遍存在研究素养与甄别信心赤字，校内外[[Professional Learning Community|专业学习共同体]]显著提升常规使用概率
...
> [!chain-link] 从时间赤字到高质量证据使用的制度支撑逻辑链（pp.192–193）
> - **前提：时间极度匮乏**
>   76% 的受访教育者明确表示在校期间严重缺乏接触研究的充足时间，同样有 76% 报告由于日常工作节奏过快而难以跟进最新学术成果。
> - **机制：异化为业余沉重劳作**
>   尽管 81% 的教师在学期内的校内工作时间接触研究，但由于正常作息被上课与杂务占满，高达 59% 不得不在放学后留校加班，69% 不得不在周末牺牲个人休息时间阅读学术研究。
> - **推论：主观效益感被严重挫伤**
>   近三分之二的受访者（61%）直言使用研究在现实中显得并不划算（not worthwhile），因为检索、研读并将其转化为教学方案所需付出的时间精力过于庞大。
> - **结论：必须进行系统减负与制度化排程保障**
>   72% 的受访者强烈呼吁必须在教职人员日常工作排程中内置研讨时间；一位天主教中学中层管理者沉痛指出：“时间是最大的问题，我们有一些充满善意、渴望尝试研究的教师，但他们被文书记录和行政事务彻底压垮了。”

> [!tension] 教师专业探究诉求与科层行政文书负担的系统冲突（pp.192–193）
> - **专业探究诉求（蓝方）** 72% 的教育工作者渴望在日常工作排程中刚性内置研讨时间，倡导放慢节奏以换取长远加速的深层教研伦理。
> - **科层行政重压（红方）** 繁重的填表造册、评估考核与文书杂务占满工作时间，迫使 69% 牺牲周末自发研读，引发 61% 产生使用研究不划算的身心倦怠。

---

### 论证步骤四　从供给驱动向需求牵引全面转型，构筑多元主体协同支持的教育证据生态系统

> [!claim] 步骤四核心主张
> 落实高质量研究使用不仅需要微观学校的组织重构，更要求宏观教育系统实现深层治理变革，在证据供给（Push）与需求应用（Pull）之间重建动态平衡，将倾听实践者真实声音确立为国际知识动员的核心原则。（pp.193–195）
...
#### 2. 深化循证教育治理机制变革，以制度化减负与多元协同构筑共生共育的教育证据生态

> [!implication]- 教育行政部门与系统决策者的制度改革行动要点（pp.193–195）
> - **制度化工作量减负与工时保障** 针对排课僵化与文书冗余动真碰硬，在学校日常排程与法定工作量中刚性划拨专有教研工时，消除行政杂务对循证探究的体制性挤压。
> - **重塑学术资助与成果评价导向** 调整科研考评机制，引导大学研究者由孤立发表转向与中小学建立长效合作机制，激励面向实践现场的深层知识动员。
> - **培育多跨协同的区域证据生态** 健全学区教研支持网络与跨校教研联盟，为学校配备专业中介与外部学术顾问，推动证据生态从单向推送走向共生共育。
...
> 高质量研究证据使用是在复杂系统内，由个体与组织使能成分的协同融合所支持的对适切研究证据的审慎参与和实施。适切研究证据强调优质证据的情境特异性，不仅需要方法学上的严谨，更要切合教育问题、具体情境与既定用途；审慎参与和实施则体现了教育工作者对研究的批判性解读、对内涵的共同审议以及在教学中的有效整合。（pp.185–186）
>
...
> [!citation-card] 放慢节奏以换取长远加速的时间伦理
> 鉴于我们当前生活并工作在一个快节奏的社会与学校环境之中……我认为，为了在未来实现长远加速而必须在当下放慢节奏（slowing down to then help you speed up）的理念，恰恰是我们当前在教育实践中亟需确立的行动准则。（p.190）
>
> *Because we live in this fast-paced way that we work and schooling … I think that the concept of slowing down to then help you speed up is something that we might need to do.*
