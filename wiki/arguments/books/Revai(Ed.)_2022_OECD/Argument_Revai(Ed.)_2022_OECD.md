...
> - **优先处理章节**
>   - Ch. 05（Torres）：OECD 政策调查跨国实证数据的机制障碍承载章节，详述阻碍与促进因素。
...
> - **缺口提醒** 目前已完成全书 Overview、第 1 章宏观图景、第 2 章理论模型、第 3 章中介机构演进史，以及第 4 章行动者网络实证图景；全书第一板块（Part I）与第二板块首章（Ch 04）已处理完毕。后续应重点推进 Ch 05 机制壁垒与 Ch 07 中介循证标准。
