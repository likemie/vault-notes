...
> - **[[Paul Morris]] 的教育四象限**（学术理性主[[Rightness|义]]、社会经济效率、儿童中心、社会重建）— Schmidt（第 5 章）用于论证价值观为本课程的理论定位（Slethaug, 2010, pp.6–7）
...
> [!success]
> 编者提出两个核心判断：
> - "[[Chinese Learner|中国学习者]]无处不在，各年龄段皆有。不存在单一类型的中国学习者，也无法确定单一的教学场所。最佳教学实践高度依赖于学习者文化、教师文化以及两者之间的互动。"（Slethaug, 2010, p.15）
> - [[International Education|国际教育]]已经从"地方和国家绑定"的教育模式转变为跨国市场和全球竞争[[Champ|场域]]——而这一转变"在几乎无人察觉的情况下"完成了（Slethaug, 2010, p.15，呼应标题"Something Happened While Nobody Was Looking"）
...
> - Argument_Zhu_2010_TeamTeaching — 从中方管理者视角分析中山大学"跨国主[[Rightness|义]]与美国"项目的团队教学经验与三类障碍（第 9 章）
