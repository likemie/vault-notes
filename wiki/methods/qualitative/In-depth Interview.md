...
> - **分析方法** [[Coding in Qualitative Research|编码]]、主题分析、[[Phenomenology|现象学]]分析、[[Narrative Analysis|叙事分析]]
...
> 深度访谈通常采用半结构化设计，以渐进式聚焦法从最宽阔的生活背景逐步收窄至[[Central Question|核心研究问题]]（Arksey & Knight, 1999）：
>
> | 阶段 | 聚焦范围 | 核心内容 |
> |------|---------|---------|
...
> - 深度访谈的[[External Validity|可推广性]]是分析性的（[[Analytic Generalization|analytical generalization]]），而非统计性的——将发现推广到理论，而非推广到总体
...
> - **谨慎使用** 访谈者和受访者之间存在显著权力不对称时（如访谈有权势者）；受访者的叙述能力和[[Reflexivity|反思性]]不均衡时。
> - **不适合使用** 需要大样本统计推广时；需要在严格控制条件下进行[[Causality|因果推断]]时。
