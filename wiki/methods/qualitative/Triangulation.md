...
> > Silverman (1985) 认为三角验证概念本身是实证主义的——数据三角验证尤其暴露了这一点：假设多重数据源（[[Concurrent Validity|共时效度]]）**优于**单一数据源或工具。假设单一单位总能测量多于一次，违反了互动论关于[[Emergence|涌现]]性、流动性、独特性和特定性的原则（Denzin, 1997: 320）。Denzin (1997) 回应了这一批评，坚称三角验证的效度不在于承诺达到客观真理，而在于对单一方法局限性的自觉。
> >
> > - **Silverman (1985)** 三角验证的实证主义预设——假设多种方法能交叉出一个单一真实值。
> > - **Denzin (1997)** 反驳了这一解读——三角验证的价值在于对方法论多元性的承诺，而非对客观真理的追求。
>
> > [!axis] 多重数据源是否必然增强效度
...
> >
> > - **Fielding & Fielding (1986)** 方法论三角验证不自动增加效度。
> > - **Patton (1980)** 多重数据源不确保一致性或可复制性——不同来源可能揭示现象的不同层面。
>
> > [!axis] 研究者三角验证的前提是否成立
...
> [!method-limits] 方法局限
> - **[[Positivism|实证主义]]预设** 三角验证假设存在一个可以通过多种方法逼近的真实现象——这一立场与严格的[[Constructivist Paradigm|建构主义]][[Epistemology|认识论]]之间存在张力。不应默认"趋同 = 有效、不趋同 = 无效"。
