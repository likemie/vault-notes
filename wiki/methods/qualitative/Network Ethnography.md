...
summary: "一种追踪全球化与网络化治理背景下政策流动的质性研究方法，结合传统民族志的深度沉浸与网络分析技术，通过对人员、资金、文本、数字痕迹与制度架构的跨界追踪，揭示教育政策转移背后的非正式关系与权力运作机制。"
type: method
...
>
> *Policy networks are social structures and relational processes... Network members move between sites and across the private and public sectors. They move within and across nations. Many have multiple positions, sequentially and concurrently.* (Ball & Exley, 2010, p. 155)
...
> [!method-limits] 方法局限
> - **偏误来源** 资料可及性限制（如初创企业免报审计、FOI 申请受阻导致网络部分节点处于隐蔽状态）、商业保密协议带来的信息截断。
> - **适用边界** 揭示的网络结构通常反映特定时期的动态关系快照，需警惕将静态网络图本质化为永久联盟。
> - **误用风险** 易被误解为阴谋论式的过度阐释；必须坚持以扎实客观的法定档案与公开记录为基底，避免无证据的主观推断。
> - **补救方式** 坚持材料多源比对、公开原始档案检索时间与提取号（如 ASIC 提取记录）、明确区分事实网络与批判性理论推论。
