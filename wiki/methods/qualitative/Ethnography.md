...
LeCompte & Preissle（1993）提出了民族志研究的八项核心要素：
...
> | 以参与者[[Construct\|构念]]建构框架 | 研究的框架由参与者的构念而非研究者的预设来建构。 |
...
> - **分析方法** [[Coding in Qualitative Research|编码]]、[[Domain Analysis|领域分析]]、主题分析、[[Progressive Focussing|逐步聚焦]]、[[Narrative Analysis|叙事分析]]、[[Analytic Induction|分析归纳法]]。
...
> 4. **关注共享模式** 关注群体的共享信念、价值观、行为模式、语言和[[Artefact|物质文化]]。
...
> | 阶段 | 民族志语境下的要点 |
> |------|-------------------|
> | 1. 确定研究领域 | 现场即"现象存在的地方"；有些民族志在现场选择时已有[[Purpose Statement\|研究目的]]，另一些则在长期沉浸后浮现。 |
> | 2. 形成[[Research Question\|研究问题]] | 问题在现场中形成而非通过[[Operationalization\|操作化]][[Variable\|变量]]；随田野深入迭代修改；问"如何"和"为什么"而非"什么"和"多少"。 |
> | 3. 处理伦理议题 | [[Informed Consent\|知情同意]]的悖论（知越多越不自然）；[[Covert Research\|隐蔽研究]]对研究边缘群体可能必要；保护脆弱参与者。 |
> | 4. 决定抽样 | 民族志排除统计抽样；使用目的性、理论、滚雪球等策略；抽样随理论[[Emergence\|涌现]]而调整直至饱和。 |
