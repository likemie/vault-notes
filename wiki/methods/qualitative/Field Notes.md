...
aliases:
  - 田野笔记
  - fieldnotes
summary: "质性研究中研究者在观察现场或观察后尽快记录的文字材料，是参与式观察和非参与式观察的核心数据载体"
type: method
...
> [!proc] Lofland（1971）的七条田野笔记指南
> 1. **尽快记录** 观察后尽快记录笔记，短时间内遗忘的信息量非常少，但随时间推移迅速加速
> 2. **训练快速书写** 训练自己快速写笔记，接受记录田野笔记预计需要与实际观察花费同样长的时间
> 3. **口述或书写** 如果能负担得起，口述是可以接受的，但书写有激发思考的优势
> 4. **打字优于手写** 打字记录远优于手写，更快、更易阅读，尤其是制作多份副本时
> 5. **制作多份副本** 至少制作两份副本，最好在母版上打字以供复制。原件保留供参考，其他副本用作草稿进行剪切、重组织和重写
> 6. **充分详细** 笔记应足够充分，以便数月后能充分唤起对任何描述事件的合理生动的画面。每次观察后至少写几页单倍行距的打字页
> 7. **系统归档** 笔记应按条目归档和分类，便于后续检索和分析

## 方法定位

> [!method-position] [[Praxis|实践]]原则
...
> [!method-limits] 方法局限
> - **偏误来源** 选择性记录（只记引人注目的事件）、记忆衰退（延迟记录导致细节丢失）、研究者疲劳（Wolcott 因无聊而影响记录质量）
> - **适用边界** 田野笔记的质量严重依赖研究者的书写速度和现场条件
> - **误用风险** 将田野笔记等同于客观事实；未做系统归档导致后期无法检索
> - **补救方式** 尽快记录、打字而非手写、制作多份副本、与访谈和文件交叉验证

## 使用此方法的研究

> [!evidence-grid-a] 相关研究索引
> - [[Argument_Cohen_Manion_Morrison_2011_Routledge_Ch14|Cohen et al. (2011, Ch14)]] — 教材在[[Case Study|个案研究]]章节中专设 14.9 节讨论观察记录，引述 Lofland（1971）七条指南、King（1979）五百页笔记[[Praxis|实践]]、Wolcott（1973）的实用提示，以及 Walker（1980）关于记录时机和方式的十二项选择问题（pp. 295–296）
