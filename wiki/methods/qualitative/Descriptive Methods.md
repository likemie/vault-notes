...
> [!success]
> [[Qualitative Research|描述性方法]]适用于研究者希望获得对某一现象直截了当的描述时，适合现象本身尚缺乏足够研究积累的探索性阶段，也适合需要向实践者清晰传达参与者经验的应用性研究。
...
> [!warning]
> [[Qualitative Research|描述性方法]]可能被认为缺乏理论深度，在追求理论贡献的学术发表中可能面临挑战。但 Creswell & Creswell（2022, Ch9）明确指出，这并不意味着描述性方法比使用[[Analytic Framework|分析框架]]的方法价值更低或可信度更弱——两种路径服务于不同的[[Purpose Statement|研究目的]]。
...
> [!example]
> - Creswell & Creswell（2022, Ch9）将[[Qualitative Research|描述性方法]]作为第 9 章的核心方法框架，介绍了从[[Coding in Qualitative Research|编码]]到主题分析再到[[Story Line|故事线]]发展的完整流程
