...
> [!info] 定义
> 质性访谈（Qualitative Interview）是[[Qualitative Research|质性研究]]中研究者与参与者进行开放式对话以获取其观点、经验和意义建构的数据收集方法。常见形式包括面对面访谈、电话访谈、焦点小组（每组 6–8 人）和电子邮件/网络访谈，使用非结构化或半结构化的少量开放式问题（Creswell & Creswell, 2022, Ch9, p.199）。
>
...
> [!example] Miller（1992）——新校长民族志研究
> 在一项关于四年制学院新校长第一年经历的[[Ethnography|民族志研究]]中，对校长进行了每两月一次、每次 45 分钟的录音访谈，持续四个月（2–5 月）。初始访谈问题作为附录纳入研究方案。研究还安排了两次后续访谈（5 月底），用于澄清和补充信息。该研究同时结合了观察、文件分析和参与者录音日记作为[[Triangulation|三角验证]]来源（Creswell & Creswell, 2022, Ch9）。

> [!example] [[Yajun Zheng|郑雅君]]（2023）——精英大学学生出路分化研究
...
> [!example] Teng & Wang（2025）——中国农村陪读择校研究
...
> [!example] Wang & McLaughlin（2025）——中国学校 LCE 本土化研究
