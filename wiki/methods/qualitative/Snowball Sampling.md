...
> - **有效性标准** 样本的有效性取决于社会网络的覆盖范围和种子选择的多样性。多波次、多起点的设计可以提高样本[[Heterogeneity|异质性]]。有效性不依赖统计代表性，而依赖所接触的社会网络的丰富程度。
> - **不声称回答的问题** 滚雪球抽样不能声称样本具有统计代表性。不能直接用于总体参数估计。不能从滚雪球样本推断总体中的行为发生率。

> [!method-stack] 方法层级
> - **研究设计**：[[Qualitative Research|质性研究]]、[[Mixed Methods Research|混合方法研究]]、[[Survey Research|调查研究]]的探索阶段。
> - **数据收集**：访谈、问卷、观察——依赖人际推荐链获取参与者。
> - **分析方法**：主题分析、叙事分析、内容分析——通常与质性[[Analytic Framework|分析框架]]结合。
...
> [!proc] 通用程序
> 1. **识别初始种子** 寻找少数具备目标特征的个体作为起点。种子的多样性直接影响后续样本的[[Heterogeneity|异质性]]。
...
> - **谨慎使用**：需要尽可能多波次、多起点以减少初始种子偏差；需要注意样本可能从[[Random Sampling|概率抽样]]蜕变为[[Convenience Sampling|便利抽样]]；需要评估同质性偏差——通过一个朋友网络找到的人在年龄、背景、观点上可能高度相似。
...
> Lee (1993) 指出滚雪球抽样在[[Sensitive Research|敏感研究]]中内建了安全性——每个新联系人都是已知且被信任的，这降低了研究者和参与者的风险。但安全性是有代价的：样本的同质性可能因互惠性和传递性而增加，从而限制研究发现的可转移性。
...
> - [[Argument_Cohen_Manion_Morrison_2011_Routledge_Ch09|Cohen et al. (2011, Ch. 9)]] — 将网络化（滚雪球抽样）作为 Lee 八种特殊群体抽样策略中应用最广的一种，深入讨论其在绕过[[Gatekeepers|守门人]]方面的操作实践（Morrison, 2006），以及同质性偏差、互惠性与传递性限制、和研究性质蜕变为[[Convenience Sampling|便利抽样]]的代价。
