...
> [!example]
> - vs **整全方法论（holistic approach）**：Delambre 明确区分 Ganz 与 holistic——后者暗示一个静态的、可被完整把握的整体，而 Ganz 强调整体始终在张力和运动之中，永远不能被一次性捕捉（Delambre, 2022, p.112）
> - vs **问题解决导向方法**：常规方法论以"解决问题"或"消解张力"为目标，而 Ganz-Methode 的核心是**承载张力**而非消解张力——允许新旧共存，为内部变化留出时间（Delambre, 2022, p.112）
...
> [!success]
> 该方法的实证基础为 Delambre 2013–2020 年在里约热内卢开展的多案例实践，但论文未报告系统的实证评估数据（Delambre, 2022, p.107）。

## 争议与批评

> [!warning]
> - 方法的两步法描述仍然停留在原则层面，缺乏可复制的方法论细节——例如"承载张力"的具体操作程序、时间框架、评估标准等均未明确（编者观察）
> - 方法的有效性仅基于作者个人的实践经验和案例叙述，缺乏独立评估和比较研究（编者观察）

## 相关案例／政策

> [!example]
> - **WTS Coaching** — Delambre 开发的教练项目，将 Ganz-Methode 操作化。在教练实践中，三重模型构成"整体商业"（whole business）：（1）个体和集体在局部社区中的[[Life Power|生命力量]]商业（happiness businesses within [[Whole Sustainability|whole sustainability]]）；（2）数字转型的技术资源；（3）在指数级张力和张力认识论的时代中，三者形成"智慧经济"（wisdom economy）——个体和组织利用局部知识和智慧开发创造性解决方案，为快乐、健康和幸福创造条件（Delambre, 2022, p.107, 117–120）
...
> - **巴西[[Social Museology|社会博物馆学]]**（social museology）和[[Ecomuseology|生态博物馆学]]（ecomuseology）实践 — 以居民自身为主角，自己选择展品、讲述故事、保护记忆，抵抗霸权系统对地方历史的抹除。口述性（orality）被视为[[Knowledge Production|知识生产]]和智慧传播的核心方式，与非洲和拉丁美洲的伟大传统一脉相承（Delambre, 2022, p.110）
...
> - **信息权威张力**：传统[[Knowledge Production|知识生产]]权威（[[The Great Learning|大学]]、研究机构）vs 社交媒体影响者（influencers）——没有正式可信度的人通过粉丝数量成为各领域权威（Delambre, 2022, p.116）
