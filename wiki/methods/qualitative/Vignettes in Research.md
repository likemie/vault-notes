---
title: Vignettes in Research
aliases:
  - 情境短文法
  - 研究情境卡
  - vignette technique
  - 情境问题法
summary: "敏感研究中通过简短描述一个人或社会情境来间接收集参与者判断的提问技术，将参与者的注意力从个人敏感性转移到外部情境对象上"
type: method
...
> [!method-fit] 适用判断
> - **适合** 研究话题高度敏感（如伦理决策、越轨行为、个人财务、健康行为）；参与者可能因社会期望偏差而不愿直接表态；希望了解参与者对复杂情境的整体判断而非简单态度。
> - **谨慎** 参与者可能仍然给出"社会期望"的回应；vignette 设计不当可能导致参与者认为情境与己无关。
> - **不适合** 需要精确测量实际行为频率的研究；参与者阅读或理解能力不足以处理情境描述的情况。
