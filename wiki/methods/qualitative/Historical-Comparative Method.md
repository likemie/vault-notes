...
> [!logic-map]- 比较史学非普适探索性假说双向循环检验机制
> ```mermaid
> flowchart LR
>     A["个案A：个殊与具体历史事实<br>（The Specific & Concrete）"] -->|"史料考据与中程归纳"| B["中程理论抽象<br>（非普适探索性假说 Working Hypotheses of a Limited Nature）"]
...
> | [[Hypothesis]] | 概念 | 核心产出构件；历史比较法产出的是中程“非普适探索性假说”，在个殊与一般之间建立循环解释。 |
