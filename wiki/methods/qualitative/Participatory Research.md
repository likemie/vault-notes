...
> [!principle] Hall（2005, pp. 17–19）的参与式研究原则
...
> - **谨慎使用** 需考虑权力精英的可能抵制——PR 挑战现有权力结构，参与者可能面临实质性风险（Brown and Tandon, 2005, p. 65）。研究者与社区成员之间的文化差异需被反思而非忽视。
...
> - **补救方式** 在研究启动阶段明确约定目标、方法、决策权和成果归属；保持对"谁在控制"这一核心问题的持续审视（Pinto, 2000, p. 13）。
