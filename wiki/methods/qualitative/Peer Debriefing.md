...
> | **互动方式** | 类似**交叉审问**（cross-examination）的质疑性对话 | 参与者确认、修正或补充——更像**协商**（negotiation） | 独立审查[[Document\|文件]]——更像**审计**（audit），不依赖人际互动 |
...
> - **不能独立确立可信性** 同行汇报是可信性建立过程中的**一项**策略——L&G 的六项策略构成一个相互支撑的体系。单独依赖同行汇报不能充分保证[[Qualitative Research|质性研究]]的效度。[[Argument_Cohen_Manion_Morrison_2011_Routledge_Ch10|(Cohen et al., 2011, Ch. 10)]]
