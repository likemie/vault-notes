...
> [[Argument_Zheng_2023_ShanghaiSanlian|郑雅君 (2023)]]将个案的背景特征（家庭背景、性别、学科大类、学段、就业去向）进行类别系列分解，使个案在各类别均有比较均匀的分布，以"兼顾大学生群体内部的[[Heterogeneity|异质性]]和提升结论的可外推性"（，引王宁, 2002）。


> [!example] 个案规模
> - [[Argument_Zheng_2023_ShanghaiSanlian|郑雅君 (2023)]]：两阶段累计 62 名个案
> - 个案研究不追求大样本，而追求个案的"典型性"——即个案承载的理论信息量（，引王宁, 2002）
>
