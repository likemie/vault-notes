...
> [!def] 方法定义
> 意识形态批判通过反思[[Praxis|实践]]揭示特定社会情境中被压制的可普遍化利益（generalizable interests），暴露支配群体如何以"普遍利益"之名推进其部门利益，使参与者认识到自身处境的社会根源并推动变革。[[Argument_Cohen_Manion_Morrison_2011_Routledge_Ch02|(Cohen et al., 2011, pp. 63–65)]]
...
> [!citation-card]- 关键定义
> 意识形态是来自特定支配群体的价值观和实践，权力群体通过它们推进和合法化其部门利益，牺牲被剥夺权力群体的利益。意识形态批判暴露意识形态在教育各领域中的运作——在"普遍利益"的外衣下运作的既得利益。（第2章，2.1节）
>
> Ideology — the values and practices emanating from particular dominant groups — is the means by which powerful groups promote and legitimate their particular — sectoral — interests at the expense of disempowered groups.
...
> - **知识观** 知识不可能是[[Value Neutrality|价值中立]]的。意识形态批判建立在对"客观性"主张的质疑之上，承认研究者的政治立场是方法论的一部分。
> - **研究者角色** 研究者是批判者而非中立观察者——通过反思[[Praxis|实践]]揭示参与者自身可能未意识到的意识形态运作。
> - **有效性标准** 变革效果（是否推动了实际解放）、利益分析的穿透力（是否揭示了被隐藏的权力关系）、反思深度。
...
> 4. **阶段四：[[Praxis|实践]]评估（evaluation of the achievement in practice）**——评估变革方案在实践中的实现效果。

> [!proc] Smyth 的四阶段平行框架（Smyth, 1989）
...
> - **谨慎使用** 需要与被研究者建立信任关系，避免研究者以"批判"之名行"知识支配"之实；批判分析应辅以变革[[Praxis|实践]]，而非停留在揭露层面。
...
> - **补救方式** 与[[Action Research|行动研究]]结合，确保批判通向[[Praxis|实践]]；引入参与者验证，避免研究者单向定义"压迫"。
...
> [!frames-ref] 相关理论
> - [[Critical Theory]] — 意识形态批判是批判理论的核心方法论工具。
