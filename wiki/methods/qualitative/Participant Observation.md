...
summary: "质性研究中研究者同时扮演参与者和观察者角色，通过进入被研究群体的自然情境收集数据的核心方法。"
type: method
...
> - **数据收集** 参与观察、[[Non-participant Observation|非参与观察]]、[[Field Notes|田野笔记]]、半结构化访谈、非正式对话、文档收集、日记和生命史、视听记录。
...
> | 维度 | 信息 |
> |---|---|
> | 材料来源 | 观察记录、[[Field Notes\|田野笔记]]、访谈转录、非正式对话笔记、文档、影像、实物。 |
> | 抽样或选案 | [[Theoretical Sampling\|理论抽样]]（随研究推进选择）、[[Purposeful Sampling\|目的抽样]]（最大变异、关键案例、典型/极端案例）、[[Snowball Sampling\|滚雪球抽样]]。 |
