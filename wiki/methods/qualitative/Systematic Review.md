...
> **2. 系统搜索**
>
> 使用多种数据库和搜索策略尽可能全面地识别符合条件的研究。搜索策略需要透明记录，以便他人重复。Sipe 和 Curlette（1997）的[[Meta-meta-analysis|元综合]]就是一个例子，他们从 427 项研究中通过严格纳入标准筛选出 103 项([[Argument_Higgins_2016_RE|Higgins, 2016, p.43]])。
>
> **3. 筛选与质量评估**
>
