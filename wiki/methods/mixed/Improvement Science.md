...
> 5. **反馈循环**：教师研究学生如何响应新实践，将注意力集中在真实的变化机制——学习者对其环境的感知变化及随之而来的行为变化([[Argument_Peterson_2016_IJRME|Peterson, 2016, p. 307]])
...
> DBIR（Fishman et al., 2013）研究干预措施"在什么条件下"有效。与改进科学类似，DBIR 假设任何完整规模的项目要在给定情境中"有效"都需要高度改编。DBIR 研究者正在开发跨不同项目建立成功实施条件知识的方法（Means & Harris, 2013），说明需要学习**实施作为一个持续过程**的有效性，与学习单个项目的有效性同样重要([[Argument_Peterson_2016_IJRME|Peterson, 2016, p. 306]])。
...
> [!success] 实证发现
> - 在美国，改进科学在教育中的系统性应用仍处于早期阶段，主要通过 Carnegie Foundation 推进([[Argument_Peterson_2016_IJRME|Peterson, 2016, p. 306]])
...
> - [[Argument_Peterson_2016_IJRME|Peterson (2016)]] 的论证主要是**概念性和方法论性的**——改进科学与实验科学的整合效果尚未经过大规模实证检验

## 争议与批评

> [!warning] 方法论碎片化的风险
> 改进科学强调本地情境和持续改编，可能使跨情境知识积累变得更加困难。[[Argument_Peterson_2016_IJRME|Peterson (2016)]] 的整合方案——以[[Mechanism Experiments|机制实验]]产生的共享"构建块"作为跨网络的学习媒介——试图直接回应此批评，但这一方案本身尚待实证检验。
