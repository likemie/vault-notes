...
> [!abstract] 六个定义性特征
> Creswell & Creswell (2023, p.231) 提出混合方法研究的六个定义性特征，从核心到外层依次嵌套：
>
> 1. **收集两种类型的数据**：质性（开放式）和量化（封闭式）数据，用于[[Research Question|研究问题]]或研究问题
...
Creswell & Creswell (2023, p.232) 明确区分了混合方法研究和多方法研究（Multimethod Research）：

> - **多方法研究**（Multimethod Research）指收集多种量化数据来源或多种质性数据来源，但不同时包含量化和质性数据。例如，一项研究同时使用问卷调查和官方统计数据，或同时使用访谈和观察——这些都是多方法研究，但不是混合方法研究。
...
>
> 其他文献中也出现过替代术语如 integrating、synthesis、quantitative and qualitative methods、multimethod、mixed research 或 mixed methodology，但"mixed methods"一词已在领域内通过大量著作获得了最广泛的认可。
...
> [!info] 相关理论
> - [[Non-intervention Research]] — 混合方法/多方法研究是 Brady et al. (2023) 分类中的非[[Intervention Research|干预研究]]类型之一。
