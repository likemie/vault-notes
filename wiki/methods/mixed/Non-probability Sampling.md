...
> [!taxonomy] 非[[Random Sampling|概率抽样]]七种类型
>
> | 类型 | 英文 | 核心特征 | 典型应用 |
> |---|---|---|---|
...
> [!method-limits] 方法局限
> - **偏误来源**：选择偏差、初始接触人偏差、志愿者偏差、[[Gatekeepers|守门人]]偏差。各子类型有各自的偏差特征，详见子类型条目。
> - **适用边界**：不能声称样本统计量代表总体参数；推广依赖[[Naturalistic Generalization|自然主义概括]]而非统计推论。
> - **误用风险**：最常见误用是将非概率样本的结果当作代表总体的结论来报告。
> - **补救方式**：通过[[Rich and Thick Description|厚描述]]为读者提供可转移性判断信息；控制配额层数；滚雪球采用多波次多起点。
