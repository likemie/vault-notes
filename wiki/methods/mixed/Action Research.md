...
> [!citation-card] [[Stephen Kemmis\|凯米斯]]与麦克塔格特（Stephen Kemmis & Robin McTaggart）论集体自我反思探究
...
> [!phase] 定义谱系的演进脉络
> - **操作严谨性取向（Corey ➔ Hopkins ➔ Ebbutt ➔ Cohen & Manion）** Corey (1953) 倡导实践者通过[[Scientific Method\|科学方法]]审视自身实践；Hopkins (1985) 将其界定为严谨的实践探究；Ebbutt (1985) 强调行动与反思的系统结合；Cohen & Manion (1994) 聚焦小规模情境干预与效果审视。Kemmis & McTaggart (1992, p. 10) 将其精神概括为：比日常生活更仔细、更系统、更严谨地计划、行动、观察和反思。[[Argument_Cohen_Manion_Morrison_2011_Routledge_Ch18\|(Cohen et al., 2011, pp. 264–266)]]
> - **哲学深度与批判取向（Carr & Kemmis）** Carr & Kemmis (1986) 引入于尔根·[[Jürgen Habermas\|哈贝马斯]]（Jürgen Habermas）的[[Critical Theory\|批判理论]]，将行动研究定性为旨在促进社会正义的自我[[Reflexivity\|反思性]]探究，使之由局部操作工具上升为批判性社会科学的基石。
...
> - **不是[[Scientific Method\|科学方法]]的机械应用** 科学方法存在多元视角，行动研究具有独特的[[Practical Epistemology\|实践认识论]]与方法论逻辑。

> [!info] 行动研究对教师专业发展的七重影响
> 行动研究对教师产生深远的七重专业发展影响（Noffke & Zeichner, 1987）：重塑对专业技能和角色的认知、增强[[Self-Efficacy\|自我效能]]与专业自信、提升对课堂复杂议题的敏感度、改善日常反思倾向、转变教育价值观与信念、增进实践理论与具体行动的契合度、拓宽对教学与社会的全局视野。因此行动研究是深植于工作场所的情境学习（Collins & Duguid, 1989）。[[Argument_Cohen_Manion_Morrison_2011_Routledge_Ch18\|(Cohen et al., 2011, pp. 266–267)]]
...
> [!method-stack] 方法层级
> - **研究设计** 螺旋循环设计、[[Participatory Action Research\|参与式行动研究]]（PAR）、校本准实验干预、案例行动研究。
> - **数据收集** 教学日志与[[Field Notes\|田野笔记]]、课堂录像与录音、学生[[Homework\|作业]]与测验、前[[Pre-test and Post-test\|后测]][[Questionnaire\|问卷]]、[[Nominal Group Technique\|名义小组技术]]（NGT）、[[Delphi Technique\|德尔菲技术]]、三角观察。
> - **分析方法** 循环反思分析、质性文本[[Coding in Qualitative Research\|编码]]、前后测均值与[[Effect Size\|效应量]]对比分析、行动差异归因、[[Reflexivity\|反身性]]备忘录审议。
...
> [!contrast-table] 行动研究的三种核心类型（Grundy, 1987; [[Argument_Cohen_Manion_Morrison_2011_Routledge\|Cohen et al., 2011, pp. 272–273]]）
...
> - **多元结构（Creating plural structures）** 容纳多[[Grand Theory\|元叙事]]与批评视角，维护异质声音的合法性。
...
> [!proc] [[Argument_QiMei_2015_EducationalResearchMethods\|齐梅 (2015)]] 实践九步程序
> 1. **发现问题** 从教育教学现场提炼出有价值的[[Research Question\|研究问题]]。
> 2. **分析问题** 剖析问题症结、实施可行性与衍生子问题。
> 3. **提出改进策略** 结合专业知识与现场实际研制针对性对策。
> 4. **实施改进策略** 边行动、边观察、边调整，以现场[[Problem Solving\|问题解决]]为导向。
...
> 研究者身处所探究的社会世界之中，同时扮演行动者与评估者双重角色（Hammersley & Atkinson, 1983, p. 14）。实践者可能出于向管理层展示成效或争取课题资源的现实考量，在数据记录与结果呈现中产生乐观偏倚或防御性汇报（Newby, 2010, p. 64）。保持反身性要求研究者建立持续的个人日志与[[External Auditor\|外部审计]]机制，主动解构自身的理论前设与利益诉求。
...
> - **不适合使用** 要求严格控制所有外部[[Variable\|变量]]的纯实验室实验；需要精确计算全域[[Effect Size\|效应量]]并推导无偏因果净值的[[Evaluation Research\|评估研究]]。
