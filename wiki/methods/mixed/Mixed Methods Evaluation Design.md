---
title: Mixed Methods Evaluation Design
aliases:
  - 混合方法评价设计
  - mixed methods evaluation design
  - embedded evaluation mixed methods
  - 混合方法评估设计
...
> [!info]
> 混合方法评价设计（Mixed Methods Evaluation Design）是一种[[Mixed Method and Multi-method Research|复杂混合方法设计]]，将量化和质性数据以及它们的[[Integration in Mixed Methods|整合]]嵌入评价框架的各个步骤中。这一方法的意图是在一个研究过程中，使用量化和质性两种方法及其整合来支持项目的开发、调整和评价。通常用于项目评价（program evaluation），研究者使用量化和质性取向来支持项目、实验或政策的开发、调整和评估（Creswell & Creswell, 2023, p.248）。
...
> [!abstract]
> 典型的[[Mixed Method and Multi-method Research|混合方法]]评价流程包含五个阶段（Creswell & Creswell, 2023, pp.248–249）：
>
...
> - 开发或选择合适的测量工具和指标
>
> **阶段四：项目实施检验（Program Implementation Test）** — 量化为主
> - 基于量化测量工具进行实验干预检验
>
> **阶段五：项目跟进与完善（Program Follow-up & Refinement）** — 质性为主
> - 通过访谈、观察和文件分析来跟进项目效果并完善方案
> - 整合：用质性数据解释量化结果（对应**[[Explanatory Sequential Design|解释性序列设计]]**）
...
> [!abstract]
> [[Mixed Method and Multi-method Research|混合方法]]评价设计体现了多种核心设计在一个更大过程中的嵌套使用（Creswell & Creswell, 2023, pp.248–249）：
>
