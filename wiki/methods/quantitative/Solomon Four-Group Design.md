...
> 参与者[[Random Assignment|随机分配]]至四组，操纵前测（有/无）和处理（有/无）两个因素，全部接受后测（[[Argument_Cohen_Manion_Morrison_2011_Routledge_Ch16|Cohen et al., 2011, Ch16, p. 320]]）：
>
> - **实验组** *R* ==O₁== `X` ==O₂==
> - **控制组 1** *R* ==O₃== ~~·~~ ==O₄==
> - **控制组 2** *R* ~~·~~ `X` ==O₅==
...
> | 条目 | 类型 | 关系 |
> |---|---|---|
> | [[Factorial Design]] | 方法 | 母设计——所罗门四组是 2 × 2 因子设计的特例，其中"是否有前测"作为一个因子 |
...
> - [[Argument_Creswell_2022_SAGE|Creswell & Creswell (2022, Ch8)]] — 以所罗门四组设计为例，展示如何通过操纵前测和处理来评估前测对处理效果的潜在干扰，将其定位为 2 × 2 [[Factorial Design|因子设计]]的特例。
