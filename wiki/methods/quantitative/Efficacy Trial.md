...
> | **效度侧重追求** | **内部效度至上**（确立纯粹因果连接） | **[[External Validity\|外部效度]]至上**（确立真实生态推广性） |
...
> | 条目 | 类型 | 关系 |
> |:-----|:-----|:-----|
> | [[Effectiveness Trial]] | 递进方法 | 效力试验的直接后续阶段，检验方案在大规模常规生态中的[[External Validity\|外部效度]]。 |
> | [[Randomised Controlled Trials]] | 基础框架 | 效力试验所依托的标准[[Causality\|因果推断]]实验设计。 |
> | [[Internal Validity]] | 核心指标 | 效力试验首要追求的科学有效性维度。 |
> | [[Implementation Fidelity]] | 关键机制 | 研发者驻场督导为效力试验提供了极高的实施保真度。 |
> | [[Covariate Adjustment]] | 辅助技术 | 效力试验中控制基线[[Pre-test and Post-test\|前测]]以倍增统计功效的核心量化技术。 |
> | [[EEF Padlock Security Rating]] | 评价标准 | 英国 [[Education Endowment Foundation\|EEF]] 评估效力试验数据安全等级的准入指标。 |
