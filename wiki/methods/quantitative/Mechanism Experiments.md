...
> [!note-] 历史沿革
> - 机制实验源自**发展经济学**领域的随机化实验传统——与教育领域从医学借鉴的黑箱 [[Randomised Controlled Trials|RCT]] 不同，发展经济学家（Duflo, Glennerster, & Kremer, 2006）明确倡导"使用理论作为设计评估和解释结果的必要指导"（Peterson, 2016, p. 303）
...
>
> > 例：在教师反馈项目中，黑箱 RCT 仅评估"反馈培训包"的整体效果。机制实验则隔离测试一个关键机制——例如教师是否使用详细反馈而非通用反馈——通过[[Random Assignment|随机分配]]教师接受不同形式的初始培训（Peterson, 2016, p. 304）。
...
>
> **操作方式**：受试者被随机分配接受"鼓励"以采取更高值的中介变量——例如教师被随机分配接受来自[[School Leadership|学校领导]]团队的额外提醒以执行干预的关键要素。关键假设：(1) 鼓励仅通过中介变量影响结果；(2) 鼓励对中介变量的影响是线性的（无"违抗者"或不成比例受影响的受试者）（Peterson, 2016, p. 304）。
>
