...
>
> **操作方式**：受试者被随机分配接受"鼓励"以采取更高值的中介变量——例如教师被随机分配接受来自[[School Leadership|学校领导]]团队的额外提醒以执行干预的关键要素。关键假设：(1) 鼓励仅通过中介变量影响结果；(2) 鼓励对中介变量的影响是线性的（无"违抗者"或不成比例受影响的受试者）([[Argument_Peterson_2016_IJRME|Peterson, 2016, p. 304]])。
>
