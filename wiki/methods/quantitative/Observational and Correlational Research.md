...
> [!abstract] 认识论立场
> 观察/相关研究适合描述变量关系、识别可能的因果线索，并为后续干预假设生成提供基础；但它本身不通过变量操纵来排除替代解释，因此不能单独支持强因果结论（Brady et al., 2023, pp.2-3）。

## 操作步骤

> [!example] 操作步骤
> - **选择变量与样本**：研究者在既有情境中测量学生、教师、课堂或学校变量，而不是主动设置干预（Brady et al., 2023, p.3）。
...
> - **生成后续假设**：在研究序列中，描述性和相关性研究可识别可能的因果关系，随后应通过干预或实验研究正式检验（Brady et al., 2023, p.2）。
...
> [!warning] 局限性
> - **不能单独支持强因果建议**：没有变量操纵意味着研究无法证明改变一个变量会导致另一个变量改善；因此基于观察/相关结果提出明确实践建议会超出证据边界（Brady et al., 2023, p.3）。
...
> [!info] 相关理论
> - [[Evidence-Based Education]] — 观察/相关研究可为证据链的早期阶段提供变量关系线索，但在 EBE 语境中，其结果常被要求转化为实践建议，因而产生因果推论边界问题。
...
> [!example] 使用此方法的研究
> - [[Argument_Brady_2023_EPR]] — 将观察/相关研究作为五类方法之一进行期刊趋势编码，发现其在 2020 年仍占五本教育心理学经验期刊文章的 46%，且其中 66% 包含实践建议（Brady et al., 2023, pp.6-7）。
