...
> 匹配隐含[[Counterfactual|反事实]][[Causality|因果推断]]的认识论立场：如果能找到在处理前协[[Variable|变量]]分布相同的两组主体，则两组结果的差异可归因于处理本身。这要求"自然进行的等效于在给定一组协变量条件下的随机实验"([[Argument_Berk_2011_ER|Berk, 2011, p.198]])——一个需要由过去研究和理论来论证的强[[Hypothesis|假设]]。
...
> "样本中的平衡并不意味着未观测协[[Variable|变量]]也存在平衡"([[Argument_Berk_2011_ER|Berk, 2011, p.198]])。匹配仅能基于已观测和已包含的协变量建立可比性——如果关键混杂因素未被测量或未包含在匹配中，结果的[[Causality|因果]]解释仍然脆弱。对这一[[Hypothesis|假设]]的辩护"始于过去的研究和理论"([[Argument_Berk_2011_ER|Berk, 2011, p.198]])。
