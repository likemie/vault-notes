...
> "样本中的平衡并不意味着未观测协[[Variable|变量]]也存在平衡"([[Argument_Berk_2011_ER|Berk, 2011, p.198]])。匹配仅能基于已观测和已包含的协变量建立可比性——如果关键混杂因素未被测量或未包含在匹配中，结果的[[Causality|因果]]解释仍然脆弱。对这一[[Hypothesis|假设]]的辩护"始于过去的研究和理论"。
