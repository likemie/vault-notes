...
Lazarsfeld 在 1940 年代引入了面板（panel）的概念，试图识别[[Causality|因果]]模式和追踪因果模式中的困难（Ruspini, 2002: 13）。
...
> - **[[Causality|因果]]分析** 纵向研究没有因果分析的一个主要障碍——即对记忆信息的重新解释以使其符合关于因果关系的传统观点。它也为评估效应的方向提供了手段。
