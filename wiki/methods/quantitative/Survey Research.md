...
Fowler（2009, p. 15）指出，受访者给出的答案是真实回答加上回答误差的组合，误差可能来自多种来源。

### 低回应与无回应

无回应是调查研究的一个严重问题。Dale（2006, p. 148）指出"无回应者几乎总是与回应者不同"，这影响了所获回应及其分析的效度和信度。无回应分为两类（Durrant, 2009, p. 293）：整份问卷无回应（单位无回应，unit non-response）和特定题项无回应（题项无回应，item non-response）。

如果无回应来自同质性较高的样本，问题可能较小；如果来自特定子群体（如非常低或非常高的社会经济群体），则会系统性偏倚结果。如果无回应在样本中随机分布，问题可能比系统性无回应更小（Durrant, 2009, p. 295）。
...
Cooper & Schindler（2001, pp. 314–315）和 Fowler（2009, p. 58）报告以下因素对回应率影响不大或无明显影响：个性化介绍信、撰写介绍信、匿名承诺、问卷长度（短问卷不一定比长问卷产生更多回收）、问卷尺寸、印刷和颜色、回邮截止日期。
...
**邮寄调查** 可以触及大量人群、成本较低、回收较快、保证保密性（Bailey, 1994, p. 148）。受访者可以在自己方便的时间和环境中完成，必要时查阅个人文件，并仔细思考回答。标准化措辞确保了跨回应的可比较性，且无访谈员在场消除了访谈员偏差。邮寄调查也可用于收集详细的敏感质性数据（Beckett & Clegg, 2007），因为无他人在场可以增加数据的诚实性和丰富性。其缺点包括：通常回应率较低；无法了解无回应者信息，不知样本是否具有代表性；受访者可能不够认真或误解问题而无法核查；缺乏对环境控制；缺乏对问题回答顺序的控制；某些问题可能不被回答；无法记录自发回答；难以区分无回应和不良回应；需要格式简单，因为无访谈员在场引导（Bailey, 1994, p. 149）。

**面对面访谈调查** 的吸引力在于：访谈员在场可以澄清受访者疑问，刺激受访者给出完整回答，改善回应率；可以灵活追问和更充分解释；对读写困难者更友好；可以使用非言语行为鼓励参与；对环境有更大控制（隐私、噪音、外部干扰）。但其问题在于：访谈员特征（性别、种族、年龄、民族、个性、技能、社会地位、着装、外貌）可能影响结果；访谈实施方式可能影响标准化和信度；受访者在非匿名或敏感信息被询问时可能不愿披露；在时间和差旅方面成本高昂；受访者可能不愿让陌生人入室（Bailey, 1994, p. 175）。

**电话调查** 介于邮寄问卷和个人访谈之间（Arnon & Reichel, 2009）。优点是克服了由社会特征、年龄、着装、种族等引起的偏差；降低了时间与差旅成本；受访者不在时重新拨打成本低；维持样本量相对容易。缺点是并非人人都有电话（贫困者、年轻人、受教育程度较低者），可能导致样本偏斜；许多人号码不在公开目录中；年轻人、未婚者和高职业地位群体可能使用答录机过滤来电。此外，Fowler（2009, p. 75）指出电话调查倾向于比面对面访谈引发更多社会期望性回答。电话调查不应有过多的多选题，也不应有太多回应量表点（Fowler, 2009, pp. 73–74）；建议时长控制在 10–15 分钟以内。
...
> - [[Argument_RoyalSociety_2026_ScienceForSociety|The Royal Society (2026d)]] — 综合运用 2025 年公众[[Scientific Attitude|科学态度]]调查（PAS 2025）与英国科研人员科学参与调查的全国抽样数据，评估公众参与需求、信任度及制度障碍。
> - [[Argument_RoyalSociety_2026_ScienceForSociety_Ch03|The Royal Society (2026b)]] — 依托 2025 年英国公众对科学态度调查（PAS 2025）全国成年人抽样数据（$N = 5,281$）及 BBC 受众调查，定量评估数字媒介环境下公众科学信息获取渠道、信息渴求度（62%）与真实性信任感知。
