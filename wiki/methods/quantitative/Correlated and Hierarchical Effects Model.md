...
> ```mermaid
> flowchart LR
>   A["提取一阶效应量 z_ij<br/>(第 j 个元分析中的第 i 个效应量)"] --> B["三水平随机效应模型<br/>z_ij = β_0 + X_ij β + ζ_(3)j + ζ_(2)ij + ε_ij"]
>   B --> C["构建抽样协方差矩阵 V_j<br/>对角线 V_ijj = 1/(n_ij-3)<br/>非对角线 Cov = ρ √(V_aj V_bj)"]
>   C --> D["REML 限制极大似然法<br/>联合估计 τ_3²(集群间) 与 τ_2²(集群内)"]
>   D --> E["输出最优加权矩阵 W_j<br/>W_j = (τ_3² I + τ_2² J + V_j)⁻¹"]
> ```
