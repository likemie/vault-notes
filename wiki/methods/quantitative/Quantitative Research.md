...
> [!info]
> 量化研究（Quantitative Research）是一种通过检验[[Variable|变量]]间关系或群体间比较来验证客观理论的研究路径。这些变量可以通过工具（通常是标准化量表或测量设备）进行测量，从而产生可用统计程序分析的数值数据。最终书面报告具有固定结构，包括引言、方法、结果和讨论。量化研究者以演绎方式检验理论，在研究设计中建立防止偏见的保护措施，控制替代性或[[Counterfactual|反事实]]解释，并寻求将发现推广和复制。
...
> - 研究者的个人偏见虽被程序性控制，但完全的[[Value Neutrality|价值中立]]难以实现。

## 方法变体与相近方法

> [!tip]-
> - [[Survey Research]] — 通过[[Questionnaire|问卷]]或结构化访谈从样本收集数据以推广至总体的量化设计。
