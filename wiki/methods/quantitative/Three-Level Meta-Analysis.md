...
> - [[Argument_Guo_2025_TSC|Guo et al. (2025)]] — 对 2000–2024 年间 29 项实证研究中的 109 个效应量采用多层[[Fixed-Effect and Random-Effects Models|随机效应模型]]（Hedges' $g$），检验[[Creativity Training|创造力训练]]对大学生[[Divergent Thinking|发散思维]]、言语、图形、词汇及问题解决等维度的促进效应及时间与干预类型的调节作用。
