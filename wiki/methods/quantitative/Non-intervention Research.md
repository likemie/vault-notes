...
> - **按数据类型区分子类**：[[Observational and Correlational Research|观察/相关研究]]包含量化数据；[[Qualitative Research|质性研究]]包含访谈、观察等文本数据；[[Mixed Method and Multi-method Research|混合方法/多方法研究]]同时包含量化和质性数据（Brady et al., 2023, p.4）。
