...
> 小提琴图将箱线图的汇总统计优势与核密度估计对复杂分布形态的敏感性结合在一起。它能够在一幅图形中清晰揭示被传统五数概括法所掩盖的双峰、多峰与聚类特征，使跨组分布对比更为严密与直观。(Hintze & Nelson, 1998; [[Argument_Jansen_2026_EPR\|Jansen et al., 2026]])
>
