...
> [!example]
> 抽样类型的理想层级，按方法论严格程度递减（[[Argument_Creswell_2022_SAGE|Creswell & Creswell, 2022]], Ch8）：
...
> - 在教育研究中，研究者通常只能接触到特定学校或班级的学生，便利抽样是最常见的选择——这意味着需要诚实地讨论样本对总体的代表性局限（[[Argument_Creswell_2022_SAGE|Creswell & Creswell, 2022]], Ch8）。
