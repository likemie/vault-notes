...
> [!abstract] 认识论立场
> 元分析隐含经验主义认识论：[[Hypothesis|假设]]通过对多个研究的[[Effect Size|效应量]]进行统计平均，可以产生关于干预有效性的可靠知识。[[Critical Realism|批判实在论]]从三层本体论（实在/实际/经验）角度批评这一假设——元分析停留在"经验"层面（观察到的效应量），未能深入"实在"层面（产生效应的因果机制及其激活条件）（Wrigley & McCusker, 2019, pp. 116–117）。
