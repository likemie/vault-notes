...
本章提供了四套元分析的详细操作模型，从不同角度补充了基本流程（pp.343–357）：
...
此外，Thomas & Pring（2004: 54–55）从研究设计层面补充了元分析应明确说明的内容：[[Research Question|研究问题]]、概念框架、综述协议、搜索和检索策略，以及多项研究发现被整合的具体方式（pp.362）。
