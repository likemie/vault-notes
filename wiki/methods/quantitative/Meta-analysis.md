...
>
> Hattie (2015) 对这一问题的回应不是否认异质性，而是要求把异质性转化为[[Research Problem|研究问题]]：平均效应必须继续追问 moderator（调节变量）。例如 [[Feedback]] 的平均效应很强，但 Hattie 自己也承认反馈类型、反馈方向和学生接收方式会使效果差异很大，不能用“反馈有效”替代对具体机制的判断（Hattie, 2015, p.11）。
>
> **源研究选择的纯技术标准**
>
