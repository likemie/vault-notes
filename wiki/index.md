...
> [!index-list]- Educational Psychology (16)
...
> [!index-list]- Sociology of Education (48)
...
> - [[Factor Mixture Modeling]] — 一种结合了验证性因子分析（CFA）与潜在剖面分析（LPA）的量化方法。它能够通过考察个体在多维度连续潜在因子上的模式（轮廓）表现，识别出总体数据中隐含的异质性潜在类别（群组）。
