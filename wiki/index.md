...
- [[Abstract]] — Creswell 定义的双重概念，既指文献综述中加工研究文献的短段落（文献摘要），也指置于研究开篇的全文概述（研究摘要），后者包含研究问题、数据来源、方法、发现和结论五个核心组成部分
...
- [[Deficiencies in Past Literature]] — Creswell 缺陷模型中的关键环节，指已有研究中存在的缺口、不足或忽略之处，用于为新研究提供合法化空间，涵盖未探索主题、方法缺陷和理论不足等类型
- [[Deficiencies Model for an Introduction]] — Creswell 提出的四部分引言写作模板，通过陈述研究问题、综述文献证据、指出文献缺陷和说明研究重要性来组织学术引言，在社会科学中广泛应用
- [[Definition of Terms]] — Creswell 综合多位学者提出的研究写作规范，指在研究计划中精确界定关键术语，遵循操作化、首次出现即定义、使用文献约定语言等原则，在量化、质性和混合方法研究中有不同策略
...
- [[Introduction (Research Writing)]] — Wilkinson 定义的学术研究写作文体，指期刊论文或学位论文中为读者提供研究背景信息的第一部分文字，具有建立研究框架、创造读者兴趣、确立研究问题和触及受众四大功能
- [[Inverted Triangle Literature Search]] — Creswell 提出的文献检索启发法，当研究题目过于狭窄而找不到直接相关文献时，通过从窄到宽逐层拓宽检索范围来寻找间接相关的研究，以倒三角为视觉隐喻
- [[Justified Warrants]] — 研究结论应提供暂定、可修正的担保断言而非确定性证明，可用于评估政策论证是否真正由证据支持而不是靠修辞跳跃推进
- [[Literature Review]] — Creswell 定义的研究核心步骤，指系统检索、评估和总结某一主题已有研究的过程，在量化、质性和混合方法研究中有不同的组织方式和角色
...
- [[Narrative Hook]] — Creswell 提出的引言写作技巧，指能够吸引、抓住或钩住读者进入研究的开篇语句，通过问题、数字冲击或适度概括性语言激发阅读兴趣
...
- [[Research Problem]] — Creswell 定义的研究设计核心概念，指引导研究需求的难题或议题，区别于研究问题（research questions），可来自个人经验、文献争论或政策讨论
- [[Research Topic]] — Creswell 定义的研究出发点，指计划研究的主题或题材，涉及草拟工作标题、评估研究可行性与贡献性、以及确定研究角度的方法
