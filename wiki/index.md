...
> - [[Fail-Safe N]] — 由 Robert Rosenthal（1979）提出的经典发表偏倚敏感性分析方法。通过计算将元分析汇总效应量拉低至统计不显著水平所需的无效应（零效应）未发表研究数量，评估元分析结论对抗抽屉文件效应（File Drawer Effect）的稳健性。
