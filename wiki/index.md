...
> - [[Argument_Cohen_Manion_Morrison_2011_Routledge_Ch06]] — 第6章系统拆解选择研究课题时的七个关键决策点，从研究选题的23种来源出发，依次论证研究重要性的多维评估框架、28种研究目的与方法的对应关系及目的适配性原则、研究可操作性的六个约束维度（含准入、研究者、时间、资源、影响和范围）、研究问题的30种类型谱系与质性研究无RQ的讨论、文献综述的七项目的与规模考量，最终以Box 6.1的36条操作清单收束。
