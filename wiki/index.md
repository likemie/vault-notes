...
- [[STEM Education]] — 涵盖科学（Science）、技术（Technology）、工程（Engineering）和数学（Mathematics）的跨学科教育模式，旨在培养学生的创新能力和解决复杂问题的综合素质。
...
- [[Hidden Champions]] — 指那些在特定细分市场中占据极高市场份额、掌握核心技术，但在公众中知名度相对较低的中小企业。
...
- [[Deep Integration of Sci-Tech and Industrial Innovation]] — 指科技创新作为动力，与产业创新这一载体深度互动、协同发展的过程，其核心在于通过高质量科技供给、企业创新主体地位以及成果转化应用，实现技术链与产业链的贯通。
- [[High-Quality Sci-Tech Supply]] — 指在科技创新过程中产出的具有高原创性、前沿性和颠覆性，能够有效解决关键核心技术瓶颈并满足产业转型升级需求的技术和知识成果。
- [[Principal Status of Enterprises in Innovation]] — 强调企业在技术研发、产品开发及产业化应用中发挥不可替代的核心和引领作用，是科技与经济紧密结合的关键纽带。
- [[Sci-Tech Achievement Transformation]] — 指将实验室中的基础研究和实验开发成果导入具体产业领域和产业链各环节，将其转化为实际生产力与社会财富的过程。
- [[Society 5.0]] — 日本政府提出的一种未来社会发展愿景，旨在通过深度融合网络空间与物理空间，解决经济发展与社会挑战并存的问题，被视为人类社会的第五个发展阶段。
- [[Two Separate Skins Phenomenon]] — 指在科技发展与经济建设过程中，科研活动与产业需求脱节，科研成果难以转化为实际生产力，导致科技创新未能有效支撑产业发展的现象。
