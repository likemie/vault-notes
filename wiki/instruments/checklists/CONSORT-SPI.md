...
> | **Item 5a** | 干预[[Theory of Change\|变革理论]] | 详述干预背后的理论模型（Theory of Change）、核心[[Hypothesis\|假设]]与预期因果机制 | 打开干预“黑箱”，阐明干预为何起作用 | Montgomery et al. (2018, p. 6) |
> | **Item 5b** | 干预全要素细则 | 详述干预材料、培训规程、实施频次、接触时长、物理与社会环境 | 确保干预在其他学校或区域具备可复制性 | Montgomery et al. (2018, pp. 6–7) |
> | **Item 5c** | 对照组常规状态 | 详述对照组在试验期间所接受的[[Business as Usual\|常态教学（Business as Usual）]]、替代支持与防污染措施 | 明确[[Counterfactual\|反事实]]基线，避免由于对照组悄然加码导致效应低估 | Montgomery et al. (2018, p. 7) |
