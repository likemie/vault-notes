...
> | 5 | Once a person is born, their ability to learn will not change.<br>**人一旦出生，其学习能力就不会改变。** | .39 | 1–5 | 正向计分 | — |
...
> | **独立学校子样本（Independent Sub-sample）** | 89 | -.03 (.78) | -.12 (.84) | -.28 (.82)+ |
> | **公立学校子样本（Public Sub-sample）** | 358 | .008 (.85) | .03 (.77) | .07 (.86)+ |
