...
> - **测量目的** 测量 [[International Baccalaureate|IB]] 教师与协调员对学校层面核心组件（[[Theory of Knowledge|TOK]]、[[Creativity, Action, Service|CAS]]、EE）之间并发学习（Concurrency of Learning）状态及其连贯性（Coherence）的感知、[[Praxis|实践]]策略与挑战。
