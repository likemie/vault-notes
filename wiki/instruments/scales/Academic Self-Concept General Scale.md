...
> |---|---|---|---|---|
> | [[Argument_Cole_2015_AJE\|Cole et al. (2015)]] | Marsh 1992 英文版 | 澳大利亚大学一年级学生，在线施测；DP 毕业生 n = 99，非 DP 毕业生 n = 283。作为难以跨学校标准化的实际成绩之代理指标 | 既有证据 α = .92；Byrne & Worth-Gavin (1996) 支持代理用途；当前样本信度、[[Construct Validity\|结构效度]]与测量不变性 — | DP 毕业生均值 6.25（0.96），非 DP 毕业生 5.75（1.02），t(380) = 4.24，p < .001 |
