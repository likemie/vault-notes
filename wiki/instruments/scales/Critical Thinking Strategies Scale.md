---
title: Critical Thinking Strategies Scale
aliases:
  - CTSS
  - 批判性思维策略量表
...
本文通过探索性因子分析缩减题项，但没有报告初始题项数、保留标准、载荷或因子数量。文章将十四题作为一个总量表报告，因此本页按单一报告维度记录，不据此断言量表已经证明单维。[[Argument_Cole_2015_AJE|(Cole et al., 2015, pp. 6, 9)]]
