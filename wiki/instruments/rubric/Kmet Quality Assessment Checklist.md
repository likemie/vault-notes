---
title: Kmet Quality Assessment Checklist
aliases:
  - Kmet Checklist
  - Kmet Quality Assessment
  - Kmet Checklist for Quantitative Studies
...
response_format: "3-point scale (0 = No, 1 = Partial, 2 = Yes, NA = Not Applicable)"
tags:
  - method/statistical
  - meta-analysis
  - systematic-review
...
> | 评估维度 | 核心核查指标 | 计分方式 |
> |---|---|---|
> | **[[Research Question\|研究问题]]与设计** | 研究问题是否充分明确；研究设计是否与目标匹配 | 3 点计分：满足（2 分）、部分满足（1 分）、不满足（0 分）；允许适用性标注 NA |
> | **抽样与组别等质性** | 抽样策略与分配方法是否清晰；实验组与对照组基线特征是否等质 | 0–2 分评分 |
> | **干预与[[Blinding\|盲法]]控制** | 干预措施定义是否明确；主试与被试盲法实施情况（若适用） | 0–2 分评分 |
> | **结果测量信效度** | 测量工具是否具有明确的[[Reliability\|信度]]与效度报告；结局指标是否客观明确 | 0–2 分评分 |
> | **[[Sample Size Determination\|样本量]]与统计推断** | 样本量是否充分；统计分析方法是否适切；是否全面报告方差与[[Effect Size\|效应量]] | 0–2 分评分 |
> | **结果报告与偏倚控制** | 是否报告具体统计量（均值、标准差、$t/F$ 值）；是否存在选择性报告 | 0–2 分评分 |
