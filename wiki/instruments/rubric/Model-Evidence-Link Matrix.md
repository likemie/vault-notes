---
title: Model-Evidence-Link Matrix
aliases:
  - 模型-证据关联矩阵
  - Model-Evidence-Link
  - MEL diagram
...
> [!construct-table] [[Epistemic Ideals]]
> <span class="instrument-dimension-table-marker" aria-hidden="true"></span>
>
> | 维度 | 评定内容 | 对应关联类型 | [[Epistemology\|认识论]]功能 |
> |---|---|---|---|
> | **强支持关联** | 证据直接且确定地证实模型中的关键机制 | 粗实线箭头 | 调动推论直接性与决定性理想 |
> | **弱支持关联** | 证据与模型一致，但存在混淆[[Variable\|变量]]或推论间接 | 细实线箭头 | 调动全证据拟合但提示局限 |
> | **矛盾/反驳关联** | 证据与模型的因果预测产生正面冲突 | 交叉反驳虚线 | 调动证据收敛与[[Falsification\|证伪]]排除意识 |
> | **无关关联** | 证据未针对该模型的核心假定进行有效测量 | 无连线或标记中立 | 识别表面相关但实质缺乏针对性的弱材料 |
