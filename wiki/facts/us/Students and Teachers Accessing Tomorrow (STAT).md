...
> [!abstract]
> STAT 的关键投入是面向教师、管理者和技术教练的专业发展，目标是在课堂中使用技术支持学生中心学习、高阶学习、教师备课资源和学生学习活动。评价[[Logic Model|逻辑模型]]把专业发展、课堂环境变化、教学实践变化、数字内容使用、学生参与、21 世纪学习活动和学生成就连接起来（Ross & Morrison, 2021, p.115）。
...
> [!warning]
> STAT 的争议集中在“项目成功应由什么衡量”。支持者重视数字公民、教学多样化、学生参与和技术接入公平；反对者更强调学生成就。由于测试分数没有明显上升，一部分较高收入白人家长和若干白人学校董事会成员把项目视为失败，并偏好把资金用于缩小[[Class Size|班额]]或修缮校舍（Ross & Morrison, 2021, p.123）。

> [!warning]
> STAT 也显示[[Technology Infusion|技术整合]]改革会带来[[Classroom Management|课堂管理]]挑战。教师和校长报告学生在课堂中出现玩游戏、上网浏览、用手机或社交媒体与同伴交流等离任务和干扰行为；较有经验的教师和学校能减少这类行为，说明问题可能随实施经验增加而减弱（Ross & Morrison, 2021, p.119）。
