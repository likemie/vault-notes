...
> [!abstract] 证据层级
> [[Every Student Succeeds Act|ESSA]] 将证据分为强、中、有希望三个主要项目有效性层级([[Argument_Wolf_2020_JREE|Wolf et al., 2020, p. 428]])，同时也包含第四层“有理论依据”的较弱支持形式([[Argument_Ross_Morrison_2021_ECNUROE|Ross & Morrison, 2021, p.109]])：
>
> | 等级 | 英文 | 研究方法要求 | 最低研究数量 |
> |------|------|------------|------------|
...
> [!info] 技术要求细节
> Evidence for ESSA (2019) 和 [[What Works Clearinghouse]] (2019) 对 [[Every Student Succeeds Act|ESSA]] 标准的[[Operationalization|操作化]]解释：
>
> - **测量工具** 必须独立于项目开发者或研究者
...
> [!abstract] 激励机制
> [[Every Student Succeeds Act|ESSA]] 对[[Evidence Standards|证据标准]]设有具体的财政激励机制([[Argument_Wolf_2020_JREE|Wolf et al., 2020, p. 428]])：
>
...
> [!info] [[Every Student Succeeds Act|ESSA]] 的"严格与宽松"
...
> [!success] 历史意义
> - [[Every Student Succeeds Act|ESSA]] 首次将联邦拨款与具体的项目级有效性证据绑定——从此 "evidence-based" 从理念变为有法律强制力的政策杠杆
