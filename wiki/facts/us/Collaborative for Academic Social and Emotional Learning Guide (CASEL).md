...
> [!info] 概述
> Collaborative for Academic, Social, and Emotional Learning Guide（CASEL）是 Wadhwa et al. 比较的 12 个[[Educational Evidence Clearinghouses|教育证据清算中心]]之一。它的主要焦点领域是教育，目标人群为学生，资金组织类型为 nonprofit，评级对象为项目（Wadhwa et al., 2024, p.7）。
...
> [!abstract] 证据标准
> 在设计标准编码中，CASEL 对 [[Randomised Controlled Trials|RCT]] 的描述程度为 1，对一般 [[Quasi-Experimental Designs|QED]] 为 1，对 RDD 和 ITS 均为 0（Wadhwa et al., 2024, p.10）。它和 [[Home Visiting Evidence of Effectiveness (HomVEE)|HomVEE]] 一样在流失指南上遵循 [[What Works Clearinghouse (WWC)|WWC]] 指南；这意味着其流失判断与 WWC 的总体流失和差异流失组合规则有关（Wadhwa et al., 2024, p.9）。
>
...
> [!abstract] 与其他清算中心的差异
> CASEL 的主题范围较窄，聚焦社会情感学习；它不像 [[What Works Clearinghouse (WWC)|WWC]] 或 [[Best Evidence Encyclopedia (BEE)|BEE]] 那样覆盖多个教育结果域。其方法标准在表 3 中也较简略：承认 [[Randomised Controlled Trials|RCT]] 和一般 [[Quasi-Experimental Designs|QED]]，但未列 RDD 或 ITS 标准（Wadhwa et al., 2024, pp.6, 10）。
...
> - [[What Works Clearinghouse (WWC)]] — CASEL 在流失判断上遵循 WWC 指南（Wadhwa et al., 2024, p.9）。
