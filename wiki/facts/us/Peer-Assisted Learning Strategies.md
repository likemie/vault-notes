...
> [!info] 项目定位与方案概况
> **[[Peer-Supported Learning|同伴互助学习]]策略（Peer-Assisted Learning Strategies, PALS）** 是由范德堡大学（Vanderbilt University）著名特殊教育与学习科学学者 Lynn S. Fuchs 与 Douglas Fuchs 团队于 1990 年代研发的结构化互惠同伴辅导模式，广泛覆盖学前至高中（K–12）的阅读（PALS Reading）与数学（PALS Math）教学。
>
> 在[[Evidence-Based Education|循证教育]]元[[Evaluation Research|评估研究]]中，PALS 成为 **“[[Document|文献]]池极端割裂与学科组件拆分引发评级冲突（Literature Fragmentation and Component Splitting Divergence）”** 的典型案型——被 [[National Dropout Prevention Center|NDPC]]、[[Blueprints for Healthy Youth Development|Blueprints]]、[[Best Evidence Encyclopedia|BEE]]、[[What Works Clearinghouse|WWC]] 与 [[Clearinghouse for Military Family Readiness Continuum of Evidence|CMFR]] 五大机构共同评估，得出了从“强力推荐”到“完全不推荐”的跨度性分歧结论([[Argument_Wadhwa_2024_RER|Wadhwa et al., 2024, pp. 23–24]])。
...
> - **谨慎使用** 班级纪律松散且教师未接受过[[Peer-Supported Learning|同伴互助]]流程规范培训的现场；直接外推至缺乏教师监控的课后[[Learner Autonomy|自主学习]]场景。
> - **不适合使用** 替代专业读写障碍治疗（[[Top Institute for Evidence-Based Education Research|TIER]] 3 深度障碍仍需 1 对 1 专业特教教师介入）。
