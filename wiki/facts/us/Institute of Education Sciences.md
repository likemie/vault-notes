...
aliases:
  ...
  - 教育科学研究院
  - IES
summary: "美国教育部下设的独立科研与数据统计机构，依据2002年教育科学改革法案设立，统摄四大常设国家研究中心与有效干预清算中心，主导推行教育因果实证研究、SEER卓越标准及法定分级财政资助杠杆。"
type: fact
...
> - **9** SEER 核心原则所涵盖的系统性科学与实践准则数量（大）。
> - **10 万+** 资助支持的数字学习平台所覆盖的用户规模，用于推进快速实验。[[Argument_Bangs_2022_PerspectivesOnResearch\|(Bangs et al., 2022, p. 208)]]
...
> |---|---|---|
> | **方法层级** | 视[[Randomised Controlled Trials\|随机对照试验]]为黄金标准，强调严格控制下的[[Internal Validity\|内部效度]] | 批评[[Experimental Research\|实验法]]剥离复杂的学校情境与[[Variable\|变量]]互动，难以解释发[[Conatus\|生机]]制 |
...
> >
> > - **标准无效论与教材[[Determinism|决定论]]（质疑立场）** IES 创始院长格罗弗·J·怀特赫斯特（Grover J. Whitehurst, 2009）与[[Brookings Institution|布鲁金斯学会]]研究员汤姆·洛夫利斯（Tom Loveless, 2012）基于全美宏观数据指出，各州以往课程标准的质量评级与该州实际 [[National Assessment of Educational Progress|NAEP]] 统考成绩之间完全不存在统计相关性（相关系数接近于 0）；标准评级被评为“极弱”的州与评为“极强”的州成绩无异。怀特赫斯特力陈政策层过度迷信自上而下的抽象标准，而忽视了真正进入教室的具体课程教材；课程教材的提分潜力和[[Effect Size|效应量]]远大于空泛的标准文本。[[Argument_McDonnell_2013_AJE|(McDonnell & Weatherford, 2013, p. 21)]]
