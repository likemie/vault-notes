...
> [!info] 概述
> Communities in Schools（CIS）为有辍学风险的学生提供学业和非学业支持。Wadhwa et al. 将它作为清算中心评级清晰分歧案例，因为 [[Promising Practices Network]]、[[Blueprints for Healthy Youth Development]]、[[Clearinghouse for Military Family Readiness Continuum of Evidence]]、[[National Dropout Prevention Center]] 和 [[CNCS Evidence Exchange]] 都评价了该项目（Wadhwa et al., 2024, p.25）。
...
> - [[National Dropout Prevention Center]] — NDPC 是唯一完全推荐 CIS 的清算中心，但其依据研究在 Wadhwa et al. 的描述中无法被识别（Wadhwa et al., 2024, p.25）。
> - [[CNCS Evidence Exchange]] — CNCS Evidence Exchange 的中等支持判断基于 [[Randomised Controlled Trials|RCT]] 与 ITS 证据，但 ITS 改善未超过比较组自发改善（Wadhwa et al., 2024, p.25）。
