---
title: Title I of the Elementary and Secondary Education Act
aliases:
  - Title I
  - Title I Part A
  - ESEA Title I
  ...
  - 初等与中等教育法第一条款
  - Title 1
summary: "始于 1965 年《初等与中等教育法》（ESEA）并经 NCLB 与 ESSA 再授权的美国最大联邦中小学教育财政专项，旨在弥补低收入家庭学生的学业差距；在 ESSA 框架下要求将资金投向符合法定证据标准的项目，但在学区层面面临单项研究门槛与全量证据评估之间的显著落差"
type: fact
subtype: policy
region: us
fact_region: "us"
...
> [!claim] 政策核心
> Title I 通过公式化联邦专项拨款向高贫困率学校注入补充性教育资源，并在 [[Every Student Succeeds Act|ESSA]] 再授权框架下要求地方学区将资金投向具备实证因果证据支持的教育实践与干预方案，以保障公共教育投资的学业回报与教育公平。[[Argument_Ginsberg_2024_EP|(Ginsberg et al., 2024, pp. 162–163)]]

> [!policy-design]- 政策设计
> - **政策目标** 为低收入家庭集中学校提供补偿性财政支持，改善办学条件与教学质量，提高弱势群体的阅读与数学等核心学科[[Academic Achievement|学业表现]]。
> - **适用对象** 满足贫困生比例门槛（通常为 40% 以上）的公立学校及相关服务学生；分为全校范围项目（Schoolwide Programs）与目标援助项目（Targeted Assistance Programs）。
> - **政策工具** 联邦基础拨款（Basic Grants）、集中拨款（Concentrated Grants）、针对性拨款（Targeted Grants）与教育金融激励拨款（Education Finance Incentive Grants）；在 ESSA 下硬性嵌入 Tier 1 至 Tier 4 四级法定[[Evidence Standards|证据标准]]。
...
> [!actor-grid] 实施角色分工
> - **发布与监管主体** 美国联邦教育部（负责规则制定与非强制性指南发布）及各州教育厅（负责审核学区 [[Every Student Succeeds Act|ESSA]] 方案与拨款分配）。[[Argument_Ginsberg_2024_EP|(Ginsberg et al., 2024, pp. 163–164)]]
> - **执行主体** 地方教育机构（学区中心办公室与项目管理部门）及各公立学校校长与教师。
> - **适用对象** K–12 阶段低收入、少数族裔、英语学习者（English Learner, EL）及有特殊教育需求的学生。
> - **政策工具** 联邦项目资金直拨、校级全校改进项目自主权、外购商业教学软件与专业发展合同。[[Argument_Ginsberg_2024_EP|(Ginsberg et al., 2024, pp. 167–170)]]

> [!pathways]- 实施路径
> - **中央到地方分配机制** 联邦资金按人口普查贫困数据下拨至各州，各州转拨至学区；大型学区通常将约三分之二资金按校内贫困生规模下达给各公立学校用于全校项目（采购师资编制、辅导服务、软件教材），约三分之一保留在学区中心办公室用于跨校通识培训、暑期项目及教学辅导支持。[[Argument_Ginsberg_2024_EP|(Ginsberg et al., 2024, p. 167)]]
> - **合规与实质有效性断裂** 实证审计显示，在大型城市学区中，超过 95% 的 Title I 支出能够满足 ESSA 的单项合格研究宽松门槛；然而当采用跨数据库全量证据评价时，仅有不到 60%（49%–58%）的资金投向了在广泛研究中获得稳定积极效应的实践。[[Argument_Ginsberg_2024_EP|(Ginsberg et al., 2024, pp. 174–177)]]
> - **法律实施前后无显著转变** ESSA 法定证据要求在 2017–2018 学年正式落地后，学区投向循证实践的资金占比在三年跟踪期间保持基本平稳，并未产生实质性转向。[[Argument_Ginsberg_2024_EP|(Ginsberg et al., 2024, pp. 175–177)]]
...
> [!debates] 学术与政策争议
>
> > [!axis] 财政投入是否必然转化为学业产出
> > 长期以来关于 Title I 资金对学生[[Academic Achievement|学业成就]]影响的实证研究结论高度分歧：部分研究发现积极效果，另有大量严谨因果评估发现未产生显著学业增益。Dynarski & Kainz (2015) 提出两大解释：一是资金分散导致人均强度不足以产生结构性改变；二是大量资金被投入了缺乏实效的日常教育实践中。[[Argument_Ginsberg_2024_EP|(Ginsberg et al., 2024, p. 165)]]
>
...
> [!ref-table]- Title I 资金投资循证实践比例审计（[[Argument_Ginsberg_2024_EP|Ginsberg et al., 2024]]）
> <span class="fact-title-i-empirical-marker" aria-hidden="true"></span>
>
> | 评估口径 | 资金归类与推断口径 | 2016–2017 | 2017–2018（[[Every Student Succeeds Act\|ESSA]]生效） | 2018–2019 | 3年综合均值 | 政策含义 |
> |---|---|---|---|---|---|---|
> | **ESSA 法定门槛（Tier I–III 单项研究）** | 学区全校项目统一赋分 | 99% | 98% | 99% | 99% | 极低法定门槛导致合规流于形式（p. 174） |
> | **ESSA 法定门槛（Tier I–III 单项研究）** | 四校样本实践细化外推 | 96% | 95% | 96% | 96% | 考虑具体采购细项后仍呈现 95% 以上名义合规率（p. 174） |
> | **全量证据评价（四库综合评级）** | 学区全校项目统一赋分 | 47% | 51% | 50% | 49% | 综合全量研究后获积极支持资金跌破半数（p. 175） |
> | **全量证据评价（四库综合评级）** | 四校样本实践细化外推 | 56% | 60% | 59% | 58% | 42%–51% 的联邦资金投向未获稳定积极证据支持的实践（pp. 175, 177） |
> | **保守敏感度测试（取多项搜索词最低评级）** | 学区全校项目统一赋分 | — | — | — | 20% | 小学全校项目降级导致积极资金暴跌至两成（p. 176） |
> | **保守敏感度测试（取多项搜索词最低评级）** | 四校样本实践细化外推 | — | — | — | 54% | 细化外推下积极资金比例进一步压缩（pp. 176–177） |
