...
> [!info] 概述
> Promising Practices Network（PPN）是 Wadhwa et al. 比较的 12 个[[Educational Evidence Clearinghouses|教育证据清算中心]]之一。它是多领域清算中心，覆盖社会与行为发展、健康、教育、社会和经济福利；目标人群为儿童与家庭；资金组织类型为 nonprofit；评级对象为项目([[Argument_Wadhwa_2024_RER|Wadhwa et al., 2024, p.7]])。

## 评级对象与范围

> [!abstract] 评级对象与范围
> PPN 被列入 12 个教育清算中心的标准比较，但没有进入最终 1,359 个项目的一致性分析，因为它在 2020 年中停止运行，尽管 RAND Corporation 网站仍保留部分材料([[Argument_Wadhwa_2024_RER|Wadhwa et al., 2024, p.15]])。
...
> [!abstract] 与其他清算中心的差异
> PPN 的方法标准在作者[[Coding in Qualitative Research|编码]]中较简略，且因停止运行未进入后续项目评级一致性分析。它仍在标准比较中具有意义，因为它体现了一类多领域、非营利、面向儿童与家庭项目的清算中心模式([[Argument_Wadhwa_2024_RER|Wadhwa et al., 2024, pp.7, 10, 15]])。
