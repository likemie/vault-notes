...
aliases:
  - 量子机会计划
  - QOP
summary: "Wadhwa et al. (2024) 的清算中心评级分歧案例，包含 QOP and Eisenhower QOP 两个项目版本"
type: fact
subtype: event
region: us
fact_region: "us"
...
> [!info] 概述
> Quantum Opportunity Program（QOP）旨在改善高中青少年的学业结果。Wadhwa et al. 将 QOP 及其更新版本 Eisenhower Quantum Opportunities Program（EQOP）作为中度评级分歧案例：QOP 被 [[What Works Clearinghouse]]、[[Blueprints for Healthy Youth Development]] 和 [[National Dropout Prevention Center]] 评价，EQOP 被 Blueprints 和 [[Clearinghouse for Military Family Readiness Continuum of Evidence]] 评价([[Argument_Wadhwa_2024_RER|Wadhwa et al., 2024, pp.24–25]])。
...
> [!success] 案例意义
> QOP/EQOP 案例显示，项目更新版本、具体研究可获得性和清算中心对研究质量的要求会共同改变同一项目家族的评级。一个清算中心可能依据未完整列明的多地点 [[Randomised Controlled Trials|RCT]] 给出 promising，另一个清算中心则因可纳入研究未显示足够效果而不给出正向评级([[Argument_Wadhwa_2024_RER|Wadhwa et al., 2024, pp.24–25]])。
