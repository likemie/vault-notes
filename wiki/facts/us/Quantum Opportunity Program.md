...
> [[Argument_Wadhwa_2024_RER|Wadhwa et al. (2024, pp. 24–25)]] 指出，量子机会项目案例深刻展示了清算机构在处理干预迭代与[[Document|文献]]边界时的制度张力：
>
> 1. **早期试点高效应与全国大规模复制衰减（Pilot vs Scale-up Decay）**
>    - 原始 QOP 在 1990 年代早期小规模试点（如费城单点实验）中曾展现出惊人的毕业率提升，[[National Dropout Prevention Center|NDPC]] 沿用了早期的乐观结论；然而 Mathematica（Schirm et al., 2006）开展的全国 7 个城市大型随机试验表明，在常态化大规模复制中，QOP 对高中毕业率和大学升学率并未产生统计显著或实质重要的提升，导致 [[What Works Clearinghouse|WWC]] 与 [[Blueprints for Healthy Youth Development|Blueprints]] 彻底否定了原始版本的有效性。
> 2. **同行评审期刊硬门槛 vs 灰色文献采纳（Peer-Reviewed vs Gray Literature）**
>    - 针对改良版 EQOP，Child Trends（Curtis & Bandy, 2015, 2016）的单中心 [[Randomised Controlled Trials|RCT]] 证实其能显著改善高中生 [[Academic Achievement|GPA]] 与大学录取率。Blueprints 深入审查了这份未公开发表的技术报告并授予“有望”认证；而 [[Clearinghouse for Military Family Readiness Continuum of Evidence|CMFR]] 因恪守“必须公开发表于同行评审学术期刊”的刚性准则，在检索不到期刊文章后直接裁定为“证据不足 / 不予推荐”。
> 3. **品牌笼统归类导致决策认知断层**
...
> - **Hahn et al. (1994) 早期小规模试点 [[Randomised Controlled Trials|RCT]]** 费城单点 100 名高危学生试验，报告干预组高中毕业率达到 63%（显著高于对照组的 42%），为 QOP 赢得了最初的政策声誉。
> - **Schirm et al. (2006) 全国 7 城市大规模集群 RCT** 涵盖 1,069 名高危青少年的全国示范试验，随访发现干预组与对照组在高中毕业率（62% vs 61%）与大学入学率上均无统计显著差异，[[Effect Size|效应量]]接近零。
> - **Curtis & Bandy (2015, 2016) 改良版 EQOP 随机实验** 显示 EQOP 干预组在高三 [[Academic Achievement|GPA]]（提升约 0.3 个绩点）与四年制大学录取率上呈现统计显著优势，但存在未报告基线等值性与未校正集群的局限。
