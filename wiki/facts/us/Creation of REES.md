...
> [!info] 背景
> 在 2010 年代"复制危机"（replication crisis）和"可疑研究实践"（questionable research practices）受到广泛关注的背景下，教育研究界开始寻求结构性解决方案。[[Publication Bias|发表偏倚]]、选择性报告和[[Researcher Degrees of Freedom|研究者自由度]]被认为是导致教育项目评估文献系统性高估干预效果的关键因素。2015 年 ESSA 通过后，联邦拨款与项目有效性证据的绑定进一步提高了评估结果的经济利害关系，加剧了偏倚风险。([[Argument_Wolf_2020_JREE|Wolf et al., 2020, p. 443]])
...
> [!abstract] 设计与功能
> [[Argument_Wolf_2020_JREE|Wolf et al. (2020, pp. 443–444)]] 提出 REES 可用于以下用途：
>
...
> [!success] 影响与后果
> - [[Argument_Wolf_2020_JREE|Wolf et al. (2020, p. 444)]] 评价 REES 为"教育领域无疑是积极的进步"（undoubtedly a positive advancement）
...
> - 然而，[[Argument_Wolf_2020_JREE|Wolf et al. (2020, p. 444)]] 指出 REES 不能解决全部问题：Gelman & Loken (2014) 论证研究者仍可通过"观察数据"学到很多，学校环境的干预评估常需要灵活调整
