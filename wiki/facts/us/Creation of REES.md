...
> [!info] 背景
> 在 2010 年代"复制危机"（replication crisis）和"可疑研究实践"（questionable research practices）受到广泛关注的背景下，教育研究界开始寻求结构性解决方案。[[Publication Bias|发表偏倚]]、选择性报告和[[Researcher Degrees of Freedom|研究者自由度]]被认为是导致教育项目评估文献系统性高估干预效果的关键因素。2015 年 ESSA 通过后，联邦拨款与项目有效性证据的绑定进一步提高了评估结果的经济利害关系，加剧了偏倚风险。（Wolf et al., 2020, p. 443）
...
> - **批评立场**：[[Preregistration|预注册]]不能消除所有偏倚；Wolf et al. (2020, p. 444) 主张预注册应与开放数据（open data）结合——"开放获取研究数据是减轻偏倚的最大希望，当作者发布完整数据集时（包括缺失值和所有初始参与者），其他研究者可以重新分析数据并尝试复制研究发现"
