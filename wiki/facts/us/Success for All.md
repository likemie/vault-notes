...
> [!info] 概述
> Success for All（SFA）是一个全校改革项目，旨在通过教学策略提升学生读写能力。Wadhwa et al. 将它作为多清算中心评级案例，因为 [[Blueprints for Healthy Youth Development]]、[[What Works Clearinghouse]]、[[Clearinghouse for Military Family Readiness Continuum of Evidence]]、[[Social Programs That Work]] 和 [[Best Evidence Encyclopedia]] 都评价了基本项目或其变体([[Argument_Wadhwa_2024_RER|Wadhwa et al., 2024, p.23]])。
...
> [!success] 案例意义
> SFA 案例说明，同一项目即使总体获得较正向评价，清算中心仍会因结果域、项目变体、研究纳入数量和研究质量规则而给出不同强度的证据判断。[[What Works Clearinghouse|WWC]] 对 alphabetics、reading fluency、comprehension 和 general reading achievement 的不同结论尤其显示，按结果域拆分评级会改变消费者看到的项目形象([[Argument_Wadhwa_2024_RER|Wadhwa et al., 2024, p.23]])。
