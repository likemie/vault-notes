...
aliases:
  ...
  - 人人成功
  - SFA
summary: "Robert Slavin与Nancy Madden创立的全校性读写综合改革方案（CSR），在Wadhwa et al. (2024)中作为五大清算中心均无负面评级、但因结果域细分、文献池规模与变体效应量产生多层评价分化的经典案例。"
type: fact
subtype: event
region: us
fact_region: "us"
...
> [!info] 项目定位与方案概况
> **人人成功（Success for All, SFA）** 是由著名[[Evidence-Based Education|循证教育]]学者 [[Robert Slavin]] 与 Nancy Madden 于 1987 年在约翰斯·霍普金斯大学（JHU CRRE / SFA 基金会）创立的全美旗舰全校读写综合改革模式（Comprehensive School Reform, CSR），已在全美 48 个州超过 1,500 所学校以及英国、荷兰等多国系统推广([[Argument_Slavin_2002_ER|Slavin, 2002, p. 18]])。
>
> 在循证清算体系元评估中，SFA 作为 **“结果域细分与项目变体驱动证据分化（Outcome Domains and Program Variants Driving Evaluation Differentiation）”** 的典型案型——被 [[What Works Clearinghouse|WWC]]、[[Blueprints for Healthy Youth Development|Blueprints]]、[[Best Evidence Encyclopedia|BEE]]、[[Social Programs That Work|SPTW]]、[[Clearinghouse for Military Family Readiness Continuum of Evidence|CMFR]] 及 [[California Evidence Based Clearinghouse for Child Social and Economic Welfare|CEBC]] 六家机构共同评估。所有机构均给出了积极或有望的高水平评价，但评级强度与具体结果域结论因[[Document|文献]]纳入标准与聚合规则呈现出多层分化([[Argument_Wadhwa_2024_RER|Wadhwa et al., 2024, p. 23]])。
...
## 案例核心启示：结果域与项目变体驱动的评价分化

> [!critique] SFA 案型揭示的四大循证综合机制
> [[Argument_Wadhwa_2024_RER|Wadhwa et al. (2024, p. 23)]] 指出，SFA 案例深刻展示了即使在“全机构一致正向推荐”的理想情境下，证据综合规则如何塑造评级形态：
>
> 1. **合格证据池规模的极端剪刀差**
>    - 各机构对 SFA 的实证研究池筛选呈现巨大反差：[[Blueprints for Healthy Youth Development|Blueprints]] 检索了 16 项研究但因严苛的方法学过滤规则仅认证了 1 项高质量 [[Randomised Controlled Trials|RCT]]（Borman et al., 2007）；而 [[Best Evidence Encyclopedia|BEE]] 凭借[[Meta-analysis|元分析]]包容性合成了多达 23 项达标研究，两者的[[Document|文献]]量相差达 23 倍。
> 2. **对同一标志性 RCT（Borman et al., 2007）的质量审视分歧**
>    - 针对全美规模最大的 SFA 集群 RCT，[[Social Programs That Work|SPTW]] 评审员完全认可其基线等值性与跟踪期；而 Blueprints 评审员则持谨慎态度，挑出其缺乏干预结束后长期随访与族裔构成的潜在失衡，导致同一研究在两家唯 RCT 机构中获得不同定性。
> 3. **[[What Works Clearinghouse|WWC]] 细分结果域穿透对项目形象的解构**
>    - WWC 将 SFA 拆解为多个认知维度，发现其对底层语音拼读具有极强推动力（Positive），但由于高阶阅读理解在部分样本中未达统计显著而被定为 Mixed，使得普通学校用户难以获得一目了然的“整体推荐”信号。
> 4. **BEE [[Effect Size|效应量]]阈值对项目变体的刚性排序**
>    - BEE 严格执行 $ES \ge +0.20\text{ SD}$ 门槛，基础版因加权效应量达到 $+0.29\text{ SD}$ 稳居最高级，而双语过渡项目（Transition Program）因单项研究效应量为 $+0.16\text{ SD}$ 被降至最低级，展示了定量效应量分界线的刚性过滤作用。
...
> [!debates] [[Implementation Fidelity|实施保真度]]与利益相关性讨论
>
...
> >
> > - **实证元评估回应** [[Argument_Wadhwa_2024_RER|Wadhwa et al. (2024)]] 表明，SFA 在完全独立的第三方机构（[[What Works Clearinghouse|WWC]]、[[Blueprints for Healthy Youth Development|Blueprints]]、[[Social Programs That Work|SPTW]]、[[Clearinghouse for Military Family Readiness Continuum of Evidence|CMFR]]、[[California Evidence Based Clearinghouse for Child Social and Economic Welfare|CEBC]]）中均获得了极高的独立实证认证，证明其卓越效应量并非单一机构的利益偏好产物。
