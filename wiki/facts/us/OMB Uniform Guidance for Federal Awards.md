---
title: OMB Uniform Guidance for Federal Awards
aliases:
  - "Uniform Guidance"
...
> [!abstract]
> Uniform Guidance 的核心会计规则（pp.263–264）：

> - **直接成本（Direct Costs）**：直接归属于特定资助项目的成本，包括雇员实际工资 × 工作月数 × 每月投入百分比、材料费、设备费和差旅费
> - **间接成本（Indirect Costs / F&A）**：设施与行政费用，按直接成本的一定百分比计算，费率须经过审计
> - **行政间接成本上限**：间接成本中行政部分的费率被联邦政府封顶在 26%
> - **预算透明度**：预算必须显示每位雇员的实际工资（而非律师或咨询事务所常用的打包时薪），且附带福利（fringe benefits）按工资的百分比单独计算
> - **无利润加成**：大学通常在审计成本之上不收取利润（profit / fee），以区别于商业承包商
