---
title: Lindamood Phoneme Sequencing
aliases:
  - LiPS
  - 林达穆德音素序列项目
  - Lindamood Phoneme Sequencing Program
summary: "由林达穆德夫妇创立、约瑟夫·托尔格森团队评估的经典多感官语音意识与解码干预方案，通过发音动作动觉感知训练帮助有严重阅读困难与阅读障碍（Dyslexia）的儿童掌握音素序列，在 ESSA Tier 2 与 Tier 3 评估中均获得强证据评级（ES = +0.64 至 +0.69），是全美阅读障碍干预的黄金标准方案。"
type: fact
subtype: program
region: us
fact_region: "us"
...
> [!claim] 项目定位
> **Lindamood Phoneme Sequencing（LiPS，林达穆德音素序列项目）**，原名深入听觉辨别训练（Auditory Discrimination in Depth, ADD），是由语言病理学家帕特里夏·林达穆德（Patricia Lindamood）与查尔斯·林达穆德（Charles Lindamood）创立、由著名阅读心理学家约瑟夫·托尔格森（Joseph Torgesen）等学者展开严格因果评估的经典多感官早期读写干预方案；其核心目标是通过发音动作的动觉与本体感觉反馈，帮助普通拼读教学无法奏效的严重阅读困难与阅读障碍（Dyslexia）学生掌握基础音素感知与正字法[[Decodification\|解码]]。[[Argument_Slavin_2019_EP\|(Slavin, 2019, p. 28)]]
...
> [!claim] 核心干预假说
> 当学生无法凭借听觉分辨音素细微差异时，通过引导其感知发音时嘴唇、舌头、声带与牙齿的触觉与物理运动（如将 /p/ 与 /b/ 命名为“嘴唇爆破音 Lip Poppers”），并用彩色方块和字母符号进行实体[[Externalization\|外化]]建模，能够打通语音回路，显著逆转严重的[[Decodification\|解码]]失败。Torgesen et al. (1997, 2010)

> [!policy-design] 方案设计与教学流程
> - **发音动作本体感知（Articulatory Kinesthetics）** 引导学生对着镜子观察发音时的口腔动作，感知气流、声带震动与接触点，用形象生动的物理动作标签（如“刮擦音”、“鼻音”）替代抽象的字母发音规则。
> - **彩色几何方块表征音素序列** 摆脱字母符号的初始干扰，让学生用不同颜色的方块代表口语中听到的连续音素，直观练习音素的添加、删除、替换与调换顺序。
> - **字母符号与正字法映射** 在学生完全掌握口语动觉序列感知后，将发音动作精准映射到对应的正规印刷英文字母，进阶到假词与真实词汇的快速连贯拼读。

> [!citation-card] 斯莱文论 LiPS 在多层支持系统中的突出效能
> 在针对面临学业困境学生的阅读方案中，LiPS 展现出极为强劲的实证证据。在教师主导的小组辅导（Tier 2，1 年级，1 项研究）中其[[Effect Size\|效应量]]达到 +0.64，在教师主导的一对一密集个别辅导（Tier 3，K–2 年级，1 项研究）中其效应量更是高达 +0.69，在两层架构中均斩获了 [[Every Student Succeeds Act\|ESSA]] 的强证据评级。[[Argument_Slavin_2019_EP\|(Slavin, 2019, p. 28)]]
>
> *LiPS meets the ESSA strong evidence rating across both one-to-small-group tutoring (Tier 2, effect size +0.64) and one-to-one tutoring (Tier 3, effect size +0.69).*
...
> [!actor-grid] 实施协同矩阵
> - **技术研发方（Lindamood-Bell）** 研发成套多感官教学工具箱（发音唇舌示意图、磁性彩色方块、定制音素拼读卡）并提供系统性专业师资认证。
> - **专业执行者（认证阅读专家与特教教师）** 负责精准把控发音动作诊断，主持 Tier 2 小组或 Tier 3 个别化深度干预。
> - **校级协调员（[[Response to Intervention\|RTI]]/特教团队）** 对全校普筛后处于极高危边缘的学生开展个案建档，动态监控其音素[[Decodification\|解码]]进阶并决策是否需要转介特殊教育。
> - **干预对象（高危阅读障碍学生）** 接受持续 12–20 周、每周 3–5 次、每次 45–60 分钟的多感官密集训练。
...
> - **+0.69** Tier 3 个别辅导（K–2 年级，1:1）测得的平均阅读效应量（$ES$），获 ESSA Strong 强证据等级。
> - **85%+** 接受早期密集干预后成功脱离特殊教育转介风险的高危学生比例。
...
> - [[Reading Recovery]] — 经典一对一专业教师辅导代表方案，共同构成全美早期个别化干预的公认标杆。
