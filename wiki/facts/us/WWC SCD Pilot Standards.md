...
>
> 因此，SCD 条目应承担方法层面的定义与效度逻辑，SCD Pilot Standards 条目则承担 WWC 制度化审查层面的规则说明。SCD Pilot Standards 主要回答"哪些 SCD 研究具有足够[[Internal Validity|内部效度]]，可以进入 WWC 后续证据综合"；而 WWC 的审查协议和 SCD Review Guide 进一步规定具体审查问题、目标人群、结果领域、场所，并系统记录参与者、场所、基线、干预条件、实施者培训和干预忠实度等推广性信息([[Argument_Hitchcock_2015_JBE|Hitchcock et al., 2015, pp.461, 464–466]])。
...
>
> Hitchcock et al. 强调，这些推广性信息不被评分，而是被详细描述，供消费者自行判断发现是否适用于自身情境；WWC 为 SCD 证据设置的唯一阈值是 [[5-3-20 Rule]]([[Argument_Hitchcock_2015_JBE|Hitchcock et al., 2015, pp.466–467]])。
>
> ### 审查协议（Review Protocols）
> 每个 WWC 审查有具体协议，明确指定([[Argument_Hitchcock_2015_JBE|Hitchcock et al., 2015, p.461]])：
...
>
> ### 5-3-20 证据充分性阈值
> 详见 [[5-3-20 Rule]]。该阈值由标准专家组提出，经外部 SCD 专家审核([[Argument_Hitchcock_2015_JBE|Hitchcock et al., 2015, p.466]])。
...
> [!note]- 时间线
> - **2010** — Kratochwill et al. 发布 [[Single-Case Design|SCD]] 技术文档 Version 1.0 (Pilot)([[Argument_Hitchcock_2015_JBE|Hitchcock et al., 2015, p.459]])
> - **2013** — Kratochwill et al. 在 *Remedial and Special Education* 上正式发表 [[Single-Case Design|SCD]] [[Intervention Research|干预研究]]设计标准([[Argument_Hitchcock_2015_JBE|Hitchcock et al., 2015, p.468]])
> - **2013** — Maggin et al. 发表 7 种 SCD 量规的比较研究，指出 [[What Works Clearinghouse|WWC]] 标准在推广性方面的不足([[Argument_Hitchcock_2015_JBE|Hitchcock et al., 2015, p.460]])
> - **2014** — WWC 发布首个包含 SCD 证据的干预报告（Repeated Reading），附录 E 中包含通过标准的 SCD 研究及其推广性信息([[Argument_Hitchcock_2015_JBE|Hitchcock et al., 2015, p.466]])
