...
>
> > 该立法将"经过验证"（proven）定[[Rightness|义]]为基于实验-对照组比较的、使用标准本位测量工具的证据。据 Slavin (2002, p. 15) 所述，这是**历史上首次将联邦教育拨款与有效性证据直接挂钩**。
>
...
> [!note]- 时间线
> - **1997** — Slavin 在 *Educational Researcher* 发表"Design Competitions"，提出将证据标准纳入联邦教育拨款的方案（Slavin, 1997, cited in Slavin, 2002, p. 15）
> - **1998** — Obey-Porter 立法通过，CSR 拨款 USD 150M/年启动
> - **1999** — 美国研究院（AIR）发布对 24 个全面改革模式的研究审查（Herman, 1999），将各类模式分为：强证据、有希望、边际、混合、弱/无效果、或无研究
> - **1998–2002** — 共发放 2,665 笔 CSR 拨款，但仅 20.8% 流向强证据项目，63.2% 流向混合/无研究项目或未纳入 AIR 审查的自创/地方模型（Southwest Educational Research Laboratory, 2002, cited in Slavin, 2002, p. 15）
> - **2001** — CSR 拨款增至 USD 310M/年；[[No Child Left Behind Act 2001|NCLB]] 通过，收紧"经过验证"和"全面"的定[[Rightness|义]]，更强调科学本位证据
> - **2002** — 美国教育部发布 CSR 更新指南，但州级官员仍保留广泛裁量权

## 实施情况

> [!example] 实施情况
> CSR 项目由美国教育部管理，通过州教育机构向地方学校发放竞争性拨款。接受拨款的学校需选择并在全校范围内实施一个"全面改革模式"——一个涵盖课程、教学、评估、专业发展和学校组织的一体化方案。
>
> 审查 24 个模型的最广泛引用的 AIR 报告（Herman, 1999）分类标准：
> - **强证据**（如 [[Success for All]]、[[Direct Instruction]]）
> - **有希望/边际**
> - **混合、弱或无效果**
> - **无研究**：被大量采用的模型可能没有任何研究基础
...
> - **政策信号 vs 政策执行**：CSR 的法律意图（首次将拨款与证据挂钩）具有历史意[[Rightness|义]]，即使其执行效果令人失望——它建立了"证据可以作为拨款条件"的先例，为后续的 [[Investing in Innovation (i3) Program|i3]] (2009) 和 ESSA (2015) 证据标准铺平了道路。
