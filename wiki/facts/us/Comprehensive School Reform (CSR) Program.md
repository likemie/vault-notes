...
type: fact
subtype: policy
tags: [evidence-based-education, school-reform, Comprehensive-School-Reform, federal-funding, region/us, level/k12]
...
- **2001** — CSR 拨款增至 USD 310M/年；NCLB 通过，收紧"经过验证"和"全面"的定义，更强调科学本位证据
...
- **政策信号 vs 政策执行**：CSR 的法律意图（首次将拨款与证据挂钩）具有历史意义，即使其执行效果令人失望——它建立了"证据可以作为拨款条件"的先例，为后续的 i3 (2009) 和 ESSA (2015) 证据标准铺平了道路。
