...
> [!info] 概述
> Social Programs That Work（SPTW）是 Wadhwa et al. 比较的 12 个[[Educational Evidence Clearinghouses|教育证据清算中心]]之一。它是多领域清算中心，覆盖教育、健康、社会和经济福利、劳动、社会与行为发展；目标人群为 all；资金组织类型为 nonprofit；评级对象为项目([[Argument_Wadhwa_2024_RER|Wadhwa et al., 2024, p.7]])。

## 评级对象与范围

> [!abstract] 评级对象与范围
> SPTW 在作者的教育项目一致性分析中贡献了 24 个项目，主题包括 prenatal/early childhood、K–12 education 和 postsecondary education([[Argument_Wadhwa_2024_RER|Wadhwa et al., 2024, p.16]])。
