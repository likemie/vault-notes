...
>
> CMFR 和 [[California Evidence Based Clearinghouse for Child Social and Economic Welfare|CEBC]] 只纳入同行评审研究。它在 RCT 流失标准上接受总体流失低于 20%；在 QED 方面，它对[[Matching|匹配]]比较组设计和统计控制比较组设计使用不同标准（Wadhwa et al., 2024, pp.8–11）。
