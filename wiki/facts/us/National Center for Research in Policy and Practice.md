...
> - **问题背景** 尽管美国推行《[[No Child Left Behind Act 2001|不让一个孩子掉队法案]]》（NCLB）与《[[Every Student Succeeds Act|每一个学生成功法案]]》（ESSA），投入数十亿美元资[[Teaching Assistant|助教]]育研究，但全美学区行政长官与[[School Leadership|学校领导]]究竟如何搜索、理解和使用这些证据，长期处于“黑箱”状态。
...
> [!claim] [[Research Utilization|研究使用]]类型学与 [[Research-Practice Partnership|RPP]] 影响评估框架
> NCRPP 团队（Coburn, Penuel et al.）克服了以往仅将研究利用视作机械落实政策指标的狭隘视角，构建了多层级研究使用[[Analytic Framework|分析框架]]，并研发了全美首套测量研究-实践伙伴关系（[[Research-Practice Partnership|RPP]]）对学区证据决策影响的实证调查量表。[[Argument_Nelson_2017_ER|(Nelson & Campbell, 2017, p. 132)]]

> [!policy-design]- 成果产出双层结构
> - **中间成果（Intermediate Outcomes）** 考察 RPP 合作是否改变了教育者的日常行为（behaviours）与思维定势（mindsets），例如是否更主动在教研会议上索取实证依据。
> - **长期多维成果（Long-Term Outcomes）** 细分为三类经典研究使用形态：
>   1. **[[Conceptual, Instrumental, and Symbolic Use of Research|工具性使用]]（Instrumental Use）** 直接依据研究证据调整课程大纲或教学采购；
>   2. **概念性使用（Conceptual Use）** 研究改变了教育者看待学习本质与学生能力的底层认知框架；
>   3. **象征性/合法化使用（Symbolic / Legitimating Use）** 策略性利用研究证据为既有改革辩护或说服利益相关者。
...
> - **确立中层系统（Middle-TIER）的枢纽地位** 实证证明了 [[Research-Practice Partnership|RPP]] 等中间层协作网络在改善学区[[Evidence-Informed Decision-Making|证据知情决策]]中的决定性价值。[[Argument_Nelson_2017_ER|(Nelson & Campbell, 2017, p. 132)]]
...
> - [[Argument_Nelson_2017_ER|Nelson & Campbell (2017)]] — 评述 NCRPP 框架对界定 [[Evidence-Informed Practice|EIP]] 成果与测量影响的理论贡献。
> - [[Conceptual, Instrumental, and Symbolic Use of Research]] — 核心概念条目。
> - [[Research-Practice Partnership]] — RPP 伙伴关系条目。
