...
> - **2001 — [[No Child Left Behind Act 2001|NCLB]] 法案出台** 《[[No Child Left Behind Act 2001|不让一个孩子掉队法案]]》（NCLB）提出“基于科学的研究（Scientifically Based Research）”，直接推动建立国家级审查中心([[Argument_Ross_Morrison_2021_ROE|Ross & Morrison, 2021, p. 109]])。
> - **2002 — IES 依据 ESRA 正式创立 WWC** 确立以医学[[Clinical Trial|临床试验]]为蓝本的教育证据审查标准与 Handbook 体系。
> - **2010 — 单一被试标准试点** WWC 发布[[Single-Subject Design|单一被试设计]]（[[Single-Case Design|SCD]]）试点标准，确立[[Internal Validity|内部效度]]门控机制([[Argument_Hitchcock_2015_JBE|Hitchcock et al., 2015, p. 460]])。
> - **2015 — ESSA 法案法定绑定** 《每个学生都成功法案》（ESSA）确立四级证据体系，WWC 成为学区申请联邦第 1 篇（Title I）学校改善拨款时认定“强证据（[[Top Institute for Evidence-Based Education Research|TIER]] 1）”与“中等证据（Tier 2）”的法定基准。
> - **2022 — Handbook v5.0 升级** 进一步优化[[Attrition|流失]]模型、集群校正与[[Regression Discontinuity Design|断点回归设计]]（RDD）审查标准。
...
> - **公共智库协作网络** 由 Mathematica Policy Research、SRI International、Development Services Group (DSG) 等权威第三方智库以联邦采购合同形式承担常态化[[Document|文献]][[Coding in Qualitative Research|编码]]与质量审查。
...
> - **全学科与全学段覆盖** 纳入主题涵盖早期读写（Literacy）、中小学数学（Mathematics）、幼儿早教、英语学习者（ELL）、科学教育、课堂行为、[[Partnership Schools Kura Hourua|特许学校]]、高等教育、特殊教育（Disabilities）、教师卓越（Teacher Excellence）及毕业路径等([[Argument_Wadhwa_2024_RER|Wadhwa et al., 2024, p. 16]])。
> - **20 年[[Document|文献]]追溯期** 主题特定综述协议设定了严格的检索边界（通常系统回溯综述开展前 20 年的英文实证文献），同时开展学术期刊与未发表灰色评估报告筛查([[Argument_Wadhwa_2024_RER|Wadhwa et al., 2024, pp. 8–9]])。
...
> 3. **[[Complier Average Causal Effect|CACE]] 顺从者估计** 在满足严格工具变量排除性约束前提下，允许报告顺从者平均因果效应（CACE）([[Argument_Wadhwa_2024_RER|Wadhwa et al., 2024, p. 9]])。
> 4. **[[Single-Subject Design|单一被试设计]]（[[Single-Case Design|SCD]]）门控与 5-3-20 规则** 确立[[Internal Validity|内部效度]]门控程序，要求至少 5 项达标研究、3 个独立团队、涵盖 20 个被试方可综合评级([[Argument_Hitchcock_2015_JBE|Hitchcock et al., 2015, pp. 464–466]])。
...
> > 争论 WWC 是否过于聚焦因果[[Internal Validity|内部效度]]，而忽略了一线学校采购最需要的现实维度。
> >
