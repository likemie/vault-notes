...
> - **认识论治理效应**：该政策不仅影响了研究资助的分配结果，更深刻地影响了知识生产本身的条件、方向和验证标准——即所谓认识论治理（epistemic governance）。SSH 研究的认识论自主性和方法论多样性在此框架下面临制度性压力（Parreira do Amaral, 2022, pp.42, 49）

## 知识地缘政治分析

> [!warning] 知识地缘政治分析
> Horizon 2020 的 SSH 整合被 Parreira do Amaral（2022）用作论证"新知识地缘政治"的关键实证案例，因为它集中体现了当代知识治理中两条脉络的共同运作：
>
> **从[[Critical Geopolitics|批判地缘政治学]]视角看**，该政策是[[Geopolitics of Knowledge|知识地缘政治]]在超国家治理层面的典型运作：欧盟通过研究资助框架——一种空间化的治理技术——将研究按照其对经济竞争力和创新的潜在贡献进行排序和配置。这反映了[[Knowledge-Based Economization|知识经济化]]逻辑对学术知识生产的深刻渗透：知识只有在能够转化为经济价值时才被赋予优先权。该政策也是[[Global Regionalisms in Higher Education|全球区域主义]]的具体制度表现——通过区域研究框架重塑高等教育和研究的知识生产秩序（Parreira do Amaral, 2022, pp.40–42）。
>
...
>
> > 一个具体的例子：在 Horizon 2020 框架下，一项关于欧盟移民政策的人类学研究必须将其提案框定为对"社会凝聚力"或"劳动力市场效率"的贡献才能获得资助——研究的认识论自主性在制度层面被消解，批判性的学术探究被置换为政策问题的工具性求解（编者类比）。
>
...
> [!success] 效果与评价
> 该政策对比较与国际（高等）教育研究的社会认识论（social epistemology）产生了深远影响：研究知识的生产条件、验证标准和学科边界在此框架下被重新定义（Parreira do Amaral, 2019, cited in Parreira do Amaral, 2022, p.42）。Parreira do Amaral（2022, pp.48–49）呼吁学界关注这一进程中认识论治理的深层效应——当研究资助的结构性条件系统性地偏好特定类型的知识和方法论时，学术研究本身的多样性、批判性和自主性就面临根本性的制度威胁。
