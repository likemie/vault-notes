...
> [!warning] 争议与评论
> - [[Argument_OConnor_2020_AJLL|O'Connor (2020)]]的批评有一部分正是从这一政策现实出发的：如果 [[Visible Learning]] 对[[Whole Language|全语言]]等领域的评估存在方法论缺陷和先验偏见，则基于 VL 的官方政策建议可能引导教师做出不适当的教学选择
