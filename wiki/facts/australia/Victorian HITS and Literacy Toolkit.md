...
aliases:
  ...
  - 维州HITS与读写工具包
  - HITS
summary: "维多利亚州教育部发布的高影响教学策略和识字工具包，以可见的学习（Visible Learning，VL）效应量排名为最高证据支持，在澳洲教育政策中引发了证据本位与教师自主权的激烈争议。"
type: fact
subtype: policy
region: australia
...
> | **政策工具**<br>推出 10 项高影响教学策略（High Impact Teaching Strategies, HITS）指导指南，以及覆盖 Foundation 至 Level 6 的读写教学工具箱（Literacy Teaching Toolkit）(p.141, p.149)。 | **约束方式**<br>由维多利亚州教育部官方发布并监督执行，将 Hattie 的《VL》效应量作为每项教学策略的首要参考文献与合法性依据 (p.141)。 |
...
>   - 政策错误地采纳了存在数据严重算错与先验偏见的“[[Meta-analysis|元分析]]”结论，将识字教学扭曲为纯粹技术主义的[[Decodification|解码]]训练，抹杀了阅读作为社会文化实践的本质 (p.149)。
