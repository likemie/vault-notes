...
> - **关键主体** 证据与实施中心（CEI）。
> - **制度背景** 自我定位为一个“全球性的、非营利证据中介机构”（global, not-for-profit evidence intermediary），旨在通过中介评估和知识转换，推动研究证据在公共服务和教育政策中的应用。
> - **触发条件** 新自由主义治理下，政府部门与决策委员会倾向于向外部非政府专业证据中介机构（Evidence brokers）外包研究审查。
...
> - **证据决策垄断的演化** 作为外部中介，其研究免受学术共同体和大学教师教育者的同行评审，却依靠[[Policy Network|政策网络]]直接在全国教师教育大纲中获得了法定真理的优先引述地位。
...
> - **批判社会学视角** 揭示了 CEI 作为公私合营证据经纪人的一部分，协助 [[Australian Education Research Organisation|AERO]] 垄断了什么是有效证据的解释权，将公共决策重构为闭环的技术化运作。
> - **学术评审视角** 指出其桌面审查未经广泛学术共同体的双盲同行评审，且[[Document|文献]]仅仅锚定于特定的小众期刊上，科学可靠度存疑。
...
> | [[What Works Movement]] | CEI 和 AERO 共同隶属并推动的跨国标准化教学证据评级运动。 | |
