...
> [!info] 定义
> Education at a Glance (EAG) 是 OECD 的年度旗舰出版物，汇集 30 项国际教育指标，以 230 张表格、140 张图表和超过 100,000 个数据点描述 OECD 成员国及部分非成员国的教育系统状况。尽管名为"概览"，实际上是一份约 550 页的深度报告（Gorur, 2014, p.4）。
>
...
> [!note-] 历史沿革
> - **1992 年**：首版 EAG 出版，英法双语合订，仅 150 页（Gorur, 2014, p.14）
> - **1993 年**：第二版翻倍至 300 页（Gorur, 2014, p.14）
> - **1995 年**：英法版本分开发行，各 370 页（Gorur, 2014, p.14）
> - **2002 年**：概念框架重组，绩效指标从最后一节移至第一节，标志从"广泛趋势分析"转向"以产出/绩效为核心"（Gorur, 2014, p.13–14）
> - **至今**：约 550 页，涵盖更多教育系统和新指标（Gorur, 2014, p.14）
...
> [!info] 理论基础
> - **[[Science and Technology Studies (STS)]]** — Gorur 以 STS 视角分析 EAG 的发展历程，将指标开发视为"正在制造中的科学"（science in the making）（Gorur, 2014, p.6）
> - **[[Performativity of Measurement]]** — EAG 指标不仅是描述性的，更是生产性的：一旦存在，就改变了各国的政策优先事项和行为（Gorur, 2014, p.16–18）
...
> [!warning] 从谨慎到自信的演变
> 早期 EAG 包含大量脚注、警示前言和技术手册，但随着指标被制度化，这些谨慎被淡化。Bottani 反思：指标本应用于"全球趋势的广泛分析"而非"狭隘的即时管理目的"，但这一希望显得天真——"事实的命运掌握在使用者手中"（Latour, 1987）（Gorur, 2014, p.12）


> [!warning] 指标无法控制的使用
> OECD 官方虽然声称"我们不提供建议"，但同时表示"我们应当给决策者一些方向"（Gorur, 2014, p.15）。Bottani 质疑这种立场的一致性和指标的认知中立性（Gorur, 2014, p.18）。


> [!warning] 绩效指标的霸权
> 2002 年后绩效指标地位的急剧上升，Bottani 批评为"在没有真正民主辩论的情况下"改变了概念框架，心理测量学共同体以"特定方法论"主导了指标方向（Gorur, 2014, p.14）。
