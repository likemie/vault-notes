...
aliases:
  ...
  - 多指标聚类调查
  - UNICEF MICS
summary: "联合国儿童基金会（UNICEF）于 1995 年设立的全球性多阶段入户抽样调查体系，是衡量全球南方儿童与妇女微观生存、健康、受保护及教育福祉的核心实证数据库。通过面对面入户调查收集学前早期保育、基础识字算术、儿童劳动、辍学及家庭社会经济处境数据，为联合国千年发展目标（MDGs）及可持续发展目标（SDG 4）提供不可替代的家庭层级微观公平监测基准。"
type: fact
subtype: program
region: global
period: "1995–至今"
...
> - **发起方与资助机制** 联合国儿童基金会纽约总部与因诺琴蒂研究中心统筹指导，各国国家统计局与政府部门共同资助，多边信托基金提供配套补贴。
> - **覆盖范围与对象** 累计在 118 个国家和地区开展了超 350 次大型全国性入户调查，重点覆盖低收入国家与冲突危机边缘的千万级住户家庭、育龄妇女及 0–17 岁未成年人。
> - **核心问题导向** 破解全球南方国家教育行政普查数据失真、忽视校外极端贫困儿童、缺乏早期儿童综合发育测量指标等严峻挑战，为落实国际人权条约提供可核验微观证据。
...
> [!actor-grid] 实施协同矩阵
> - **发起与资助方** [[UNICEF]] 数据、分析、规划与监测司（DAPM），负责全球技术手册与软件开发。
> - **研发与数据中心** 纽约总部 MICS 团队、佛罗伦萨因诺琴蒂研究中心以及各区域办事处统计顾问。
> - **一线执行机构** 各受测国国家统计局（NSO）、卫生部与教育部联合专班，动员数万名专业实地入户调查员。
> - **受试与受益对象** 全球低收入与中等收入国家千万底层农村家庭、流离失所儿童及政策智库。

> [!pathways]- 实施路径与管理
> - **纵向传导与支持** 联合国儿童基金会派遣区域技术顾问团队开展高强度驻地封闭培训，确保每一位入户调查员掌握标准的儿童能力测试流程。
> - **横向跨部门协同** 强制要求国家统计局打破部门藩篱，将教育部门学籍数据与卫生部门出生免疫记录进行入户实地核验。
> - **动态反馈与调整** 在面临战乱或流行病突发情境时，敏锐部署卫星地理标记与电话辅助远程抽样替代技术。
...
> [!indicators]- 评估指标体系
> - **投入指标** 家庭教育性读物拥有量、早期幼儿启蒙照顾时长。
> - **过程与依从性指标** 学前教育参与率、学校出勤率、家庭暴力管教暴露率。
> - **产出与结果指标** 幼儿全面发展达标率（ECDI）、7–14 岁儿童基础识字与计算通过率、小学及初中完成率。

> [!finding-cards] 核心实证结论
> - **家庭微观生态对学习贫困的决定性** 实证揭示，在撒哈拉以南非洲和南亚，即便小学入学率达到 90%，在贫困农村家庭中，超过 70% 的三年级在校儿童仍完全无法读懂一句简单的完整句子，证实“在校不等于在学”。
> - **早期幼儿保育投资的巨大公平红利** 接受过早期保育照料的儿童，其进入小学后认知达标概率提高近两倍，且该正向补偿效应在极度贫困阶层中表现得尤为剧烈。
...
> | 条目 | 类型 | 关系 |
> |:-----|:-----|:-----|
> | [[UNICEF]] | 事实 (机构) | MICS 调查的发起、组织与全球数据库维护管理中枢。 |
> | [[UNESCO]] | 事实 (机构) | 与 UNICEF 共享 MICS 数据以共同测定联合国 [[UN Sustainable Development Goals\|SDG 4]] 进展的专门机构。 |
> | [[World Bank]] | 事实 (机构) | 与 UNICEF 联合推进[[Learning Data Compact\|学习数据契约]]以整合宏微观教育数据的开发中枢。 |
> | [[Learning Data Compact]] | 事实 (项目) | MICS 作为家庭微观数据基石深度参与其中的全球学习数据联盟。 |
> | [[UN Sustainable Development Goals]] | 事实 (政策) | MICS 服务于其儿童受教育权与公平指标核验的核心全球政策目标。 |
