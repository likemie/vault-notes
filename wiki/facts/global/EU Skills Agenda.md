...
> [!info]
> EU Skills Agenda（欧盟技能议程）全称"欧洲新技能议程"（A New Skills Agenda for Europe），由欧盟委员会于 2016 年发布，是 [[Europe 2020 Strategy]]（2010–2020）的两大旗舰倡议之一。该议程融合了积极劳动力市场政策（Active Labour Market Policies, ALMPs）与欧盟教育培训战略（EU Education and Training Strategy），旨在同时提高就业率和生产率水平（European Commission, 2016; Rambla, 2022, p.168）。
>
> Skills Agenda 的提出回应了三重挑战：技能短缺与技能错配（skills mismatches）、数字转型对劳动力技能的冲击、以及早期辍学（early school leaving）对社会凝聚力的威胁。议程的核心理念是：技能形成既需要教育培训体系的支撑，也需要积极劳动力市场政策的介入——这两者不再被视为独立的政策领域（Rambla, 2022, p.168–169, 170）。
...
>
> **技能情报与可见性**：提出"技能情报"（skills intelligence）概念，使其成为学校、培训提供者和雇主的工具。国家和区域政府、基层组织和欧盟层面的行动者共同提高对技能短缺和错配的认识，确保"没有人被落下"（European Commission, 2016, 2018; Rambla, 2022, p.171）。
>
...
Skills Agenda 与 [[Innovation Union]] 共享一个核心变革理论（[[Theories of Change (Policy)]]）：创新生态体系与教育培训体系协同演化 → 产生互利增效 → 实现智能、可持续与包容性增长。这一因果叙事未经独立实证检验，而是作为 [[Performance Indicators (Policy Instruments)]] 的内在成分被嵌入政策工具中（Rambla, 2022, p.166, 170–171）。
...
> [!example]
> Skills Agenda 的实施依赖多层次治理网络（详见 [[Network Governance in Education]] 中欧盟部分）（Rambla, 2022, p.172–173）：
>
...
- **奥地利和德国**：地方专业人员以"学徒制系统"的变革理论来理解和实施终身学习政策。政策网络包含传统的新社团主义伙伴——政府、雇主协会和工会的三方合作，在一定程度上缓冲了绩效指标的 [[Selectivity (Governance)]] 效应（p.172–173）
...
- **南欧和东欧**：政策网络较弱，专业人员缺乏系统的 [[Theories of Change (Policy)]] 支撑，倾向于依赖对青年受益人的负面刻板印象组织服务。选择性效应在此更为显著——"帮助青年尽快找到任何工作"成为压倒性的实践取向（Rambla, 2022, p.173–174）
...
> [!warning]
> - **就业优先偏向**：除芬兰外，大多数欧盟成员国的终身学习专业人员将 Skills Agenda 的核心目标理解为就业优先——即短期内帮助青年获得工作。政策的个人发展和公民参与维度在实践中被显著边缘化。这一偏向并非决策者有意的偏见，而是 [[Selectivity (Governance)]] 的结构性效应——绩效指标体系使就业安置在操作上比个人发展更容易被衡量和奖励（Rambla, 2022, p.174）
> - **绩效指标的窄化效应**：EUROSTAT 的教育培训指标只能捕捉各年龄段人群的"在学状态"，无法反映非正式学习、公民教育和整个生命历程中学习的丰富性。指标在定义"教育培训体系"的同时也窄化了终身学习的内涵（Rambla, 2022, p.170, 174–175）。详见 [[Performance Indicators (Policy Instruments)]]
...
> - [[Theories of Change (Policy)]] — 与 Innovation Union 共享"创新+教育协同演化"的因果叙事
> - [[Network Governance in Education]] — Skills Agenda 在地方层面的实施呈现官僚制与网络治理的混合模式
