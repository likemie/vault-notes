---
title: Poverty Reduction Strategy Papers
aliases:
  - 减贫战略文件
  - 减贫战略规划
  - PRSPs
  - PRSP
summary: "世界银行与国际货币基金组织自1999年起在全球南方受援国推行的宏观综合政策规制框架。作为借贷国获得重债穷国债务减免与国际开发协会软贷款的前置条件，PRSPs要求各国制定包含量化教育指标、财政支出审计与公共部门治理的多年期规划，成为世界银行实施管理主义-科学效率规制的核心工具。"
type: fact
subtype: policy
region: global
fact_region: "global"
...
> - **适用对象** 受援国教育部、财政部、基层公立中小学师生及地方教育行政官僚。
> - **政策工具** 债务减免基金（HIPC Initiative）、中期支出框架（MTEF）、部门联合审查（JSR）与公私伙伴（[[Public-Private Partnership in Research|PPP]]）招标机制。
...
> [!pathways]- 实施路径
> - **中央多部委协同编制** 由受援国财政部牵头，依照华盛顿总部制定的标准模版整合教育、卫生与农业减贫方案。
> - **华盛顿集中化审议交割** 报告送交华盛顿总部接受联合评估，技术官僚比对世行内部数据库（如 [[Systems Approach for Better Education Results|SABER]] 指标）确定最终放贷额度。
> - **按指标进度分期解付** 资金严格分批拨付，受援国若未能按期完成特定指标（如消减教师薪资占财政比重、扩大合同制教师比例），世行有权扣留后续信贷。
...
>
> **关键分歧** 是将教育优先视作受制于国际债务清偿的财政成本控制对象，还是不可让渡的基本公民人权。[[Argument_Steiner-Khamsi_2024_CE|(Steiner-Khamsi et al., 2024, p. 542)]]
...
> [!indicators]- 评价指标
> - **投入指标** 基础教育占公共财政预算比重（通常要求达 20% 左右）、官方发展援助落地率。
> - **过程指标** 教育管理信息系统（EMIS）数据填报完整率、教师出勤率审计达标率。
> - **结果指标** 初等教育净入学率（NER）、初等教育完成率、男女入学性别均等指数（GPI）。
...
> >
> > - **管理效率论者** 认为以低成本快速扩张师资队伍是低收入国家在财政逼仄下确保穷人孩子有学可上的唯一务实出路。
