...
> [!info]
> 全球大学排名几乎全部以研究产出指标为核心，没有任何全球排名使用直接反映教育结果质量的指标（唯一的例外是 ARWU 中以诺贝尔奖和菲尔兹奖校友数量作为指标）。为弥补这一空白，经济合作与发展组织（OECD）启动了"高等教育学习成果评估"（AHELO）项目，试图建立类似 PISA（国际学生评估项目）的高等教育阶段学习成果统一测量工具（Boyadjieva, 2022, pp.135–136）。
