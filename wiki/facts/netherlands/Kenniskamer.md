...
title: Kenniskamer
aliases:
  - Dutch Knowledge Chamber
  - 知识室
  - 荷兰教育部知识室
summary: "荷兰教育部于2000年代内设的政策咨询机制，直接服务部长议程与教育部施政优先项，因高度依托特定部长的政治意愿而缺乏制度沉淀，随内阁重组而停摆，是Burns & Schuller（2022）论述政治预算周期导致中介机构高夭折率的荷兰本土案例。"
type: fact
...
org_type: "教育部内设政策咨询机制"
headquarters: "荷兰海牙（Den Haag）"
established: "2000s"
tags:
  - region/netherlands
...
> [!dev-timeline]- 组织发展历程
> - **2000年代初期 — 创设与初期运作** 荷兰教育部在循证政策浪潮影响下设立 Kenniskamer，紧密对齐主导部长的施政优先议程，在部委框架内提供研究证据咨询与政策建议服务；机构成效高度依赖推动设立的部长个人的政治承诺与行政推力。
> - **部长离任 — 失去高层推力与休眠停摆** 随着发起部长离任及荷兰内阁重组，Kenniskamer 失去核心的政治推动力与行政主持者，在缺乏法定授权或跨党派法律锚点的情况下，机构陷入休眠停摆状态，无法在新政治格局中重建存续的制度依据。([[Argument_Burns_Schuller_2022_BrokerageAgencies|Burns & Schuller, 2022, p. 62]])
...
> [!actor-grid] 组织治理架构
> - **主管机构** 荷兰教育、文化与科学部（Ministerie van Onderwijs, Cultuur en Wetenschap, OCW），最高权威为在任教育部长。
> - **内部运作团队** 由教育部内部政策研究人员与受委托的外部学术顾问共同构成，以部长优先事项为驱动力组织研究综合与咨询报告撰写。
> - **与外部学术社群的关系** Kenniskamer 的边界较为封闭，主要在政府行政体系内运作，对外部研究者的开放程度远低于 [[EPPI-Centre]] 等大学依托型中介机构。

> [!pathways]- 核心业务运行机制
> - **政策对齐型知识咨询** 针对部长施政优先议题提供定制化证据综合报告，确保研究证据与当届政府政策议程的高度吻合。
> - **内部快速综述** 在政策决策窗口期内迅速整合可得研究证据，以简报、报告或口头汇报等形式呈递决策层，区别于外部公开发布的[[Systematic Review|系统综述]]。
...
>
> *"The Dutch Knowledge Chamber (Kenniskamer) was similarly located within the Ministry and designed to respond to Ministry goals and priorities."*
...
> | 条目 | 类型 | 关系 |
> |:-----|:-----|:-----|
> | [[Educational Brokerage Agency]] | 概念 | Kenniskamer 是"部委直属嵌入型"中介的荷兰典型案例，在 Burns & Schuller 的三维治理谱系中居于最高政治对齐度、最低独立性的极端位置。 |
> | [[Kennisrotonde]] | 机构事实 | 同为荷兰教育[[Knowledge Mediation\|知识中介]]，两者分别代表"政策高层服务型"（停摆）与"基层实践服务型"（持续活跃）的制度两极，形成鲜明的荷兰本土对比案例。 |
> | [[Danish Clearinghouse for Educational Research]] | 机构事实 | 与丹麦清算中心同属"依托部委合同、随政治更迭而夭折"的中介类型，共同支撑 Burns & Schuller 关于政治预算周期的核心命题。 |
> | [[Best Evidence Synthesis]] | 机构事实 | 新西兰 BES 同样是部委嵌入型中介，其职能收缩与 Kenniskamer 停摆共同构成部委依附型中介的国际比较证据谱系。 |
> | [[Argument_Burns_Schuller_2022_BrokerageAgencies\|Burns & Schuller (2022)]] | 论证条目 | 将 Kenniskamer 作为"部委嵌入型中介因政治人物依附而停摆"的荷兰典型案例，论证政治预算周期是中介机构高夭折率的根本驱动力。 |
