...
aliases:
  ...
  - 知识环岛
summary: "荷兰国家教育研究所（NRO）于2015年设立的实践导向知识中介门户，面向一线教师与学校管理者提供荷兰语通俗研究摘要与定制化咨询服务，建立知识环岛问答机制，是国际上将证据转化为基层实践的代表性中介创新。"
type: fact
...
> - **创设背景与政策诉求** 荷兰作为高度分权的教育体制国家，教师与学校管理者长期面临研究报告语言壁垒（多为英文）、术语艰涩与实践转化路径不清晰的困境。NRO 通过设立 Kennisrotonde，意在打通学术证据与一线课堂决策之间"最后一公里"的转化鸿沟。
> - **法人属性与经费基础** 作为 NRO 旗下的业务功能单元运作，NRO 由荷兰教育、文化与科学部（Ministry of Education, Culture and Science）拨款资助，Kennisrotonde 享有稳定的公共经费支持，无需每年独立竞标。
> - **核心服务对象** 主要面向荷兰基础教育与中等教育阶段的在职教师、学校校长、教学辅导员及地方教育行政人员。
...
> | 条目 | 类型 | 关系 |
> |:-----|:-----|:-----|
> | [[Educational Brokerage Agency]] | 概念 | Kennisrotonde 是"基层实践导向型"中介模式的国际标杆，被 Burns & Schuller 列为代表性案例。 |
> | [[Knowledge Mediation]] | 概念 | 以母语通俗化与需求驱动问答机制，代表了面向一线教师的知识中介前沿实践形态。 |
