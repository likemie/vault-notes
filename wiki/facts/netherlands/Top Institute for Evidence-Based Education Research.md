...
> [!abstract]
> TIER 旨在开展严谨教育研究，并生产可供教育实践和政策使用的研究结果。它的工作把干预开发、实验评价、社会情境分析、元分析、知识传播和教师培训连接到同一个证据基础设施中（Pellegrini & Vivanet, 2021, p.34）。
...
> [!example]
> TIER 有四个行动领域：开发教育干预并用实验研究评价；研究教育的社会情境以连接教育和劳动力市场；通过元分析和知识传播连接学术界与政策世界；创建 Teacher Academy，把研究证据转移到学校（Pellegrini & Vivanet, 2021, p.34）。

## 效果与评价

> [!success]
> TIER 是欧洲证据基础设施中接近 [[Evidence-Based Reform|证据本位改革]] 四环节的案例：它既开发和评价干预，也通过元分析、知识传播和教师学院把研究结果推向政策和学校实践（Pellegrini & Vivanet, 2021, p.34）。
...
> - [[Knowledge Mobilisation]] — TIER 通过元分析、知识传播和 Teacher Academy 支持证据进入学校。
