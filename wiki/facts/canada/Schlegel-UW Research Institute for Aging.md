...
**创新模型（[[RIA Model for Innovation]]）** 包含四个阶段——[[Knowledge Production|知识生成]]（Knowledge Generation）、孵化（[[Incubation]]，发现和开发创新）、加速（Acceleration，在新环境中扩展和评估创新）、动员（Mobilization，分享知识惠及各地老年人）。
