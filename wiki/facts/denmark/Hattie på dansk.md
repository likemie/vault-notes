...
>
> Rømer 在此书中声称 Hattie 的反馈概念"具有集权化效应，最终有可能将一个国家的教学活动改变为一个巨大的、层级化的、计算机化的有机体"——Qvortrup 指出此断言"without any kind of factual support"([[Argument_Qvortrup_2019_NordSTEP|Qvortrup, 2019, p.4]])。
