---
title: 1922 Educational System Reform
aliases:
  - 1922年学制改革
  - 壬戌学制
  - 1922 educational system
  - 1922 school system reform
summary: "1922 年由中华民国教育部颁布的学制改革，以七项灵活标准取代固定教育宗旨，引入美国式六-三-三学制与1923年学分制课程，深受杜威思想影响但在实施中淡化民主政治内涵"
type: fact
subtype: policy
region: china
...
6. 使教育易于普及（easy popularization）
7. 多留各地方伸缩余地（local flexibility）
...
> - **1923** — 颁布新学制中小学课程纲要，引入学分制和课程[[Integration in Mixed Methods|整合]]（Zhou & Westberg, 2024, p.618）

## 实施情况

> [!example]
> **学制结构**：采用美国式六-三-三学制（小学六年、初中三年、高中三年），取代此前以日本-德国为蓝本的旧体系。

> [!example]
> **课程改革（1923）**：小学课程只规定每学年最低课时数和各科课时比例；中学采用美国高中式学分制，学生可根据兴趣和需要选课。科目层面，将历史、地理、公民、卫生合并为"社会"科，并增设园艺、工艺美术、形象艺术等职业和艺术科目（"General Manual" 1923, pp.2–3，引自 Zhou & Westberg, 2024, p.618）。
...
> - 课程[[Integration in Mixed Methods|整合]]呼应杜威反二元论的知识连续性主张（Dewey [1916] 2018, pp.73, 353–354）。
...
> - 引入学分制与课程[[Integration in Mixed Methods|整合]]，突破了此前僵化的科目-课时安排（Zhou & Westberg, 2024, p.618）。
