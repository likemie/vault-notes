...
>
> 2000 年前后，芬兰在 OECD and World Economic Forum 报告中成为教育"榜样国家"。这种由 [[Performance Indicators]] 和国际比较强化的声誉反过来影响国内政策表述：课程改革常以"保持领先""避免落后于竞争者""让最好的变得更好"等语言包装。PhBL 的课程化也可放在这一语境中理解：它既回应复杂未来与横向能力的需要，也服务于芬兰教育模式持续更新的国际叙事([[Argument_Schaffar_2024_CogentEdu|Schaffar & Wolff, 2024, pp.8-9]])。
...
> [!success] 效果与评价
> [[Phenomenon-Based Learning|PhBL]] 的评价呈现"双重性"。一方面，整体取向、合作和相互责任使它适合回应复杂挑战；它能够把学科知识、学生好奇心、现实问题和共同责任联系起来([[Argument_Schaffar_2024_CogentEdu|Schaffar & Wolff, 2024, pp.1, 11]])。另一方面，PhBL 既不是全能方案，也不是可快速复制的方法；它更像一种促使学校重新反思当代教育意义的教学工具([[Argument_Schaffar_2024_CogentEdu|Schaffar & Wolff, 2024, p.11]])。
>
> 从课程政策角度看，2014 课程的价值不只在于引入一个新方法，而在于把"学科深度"和"跨学科广度"同时放进基础教育目标。PhBL 若只被理解为技能训练或项目活动，会削弱其哲学根基，并滑向 [[Atomisation of Knowledge and Skills]]；若能与 [[Bildung]]、[[Didaktik]] 和 [[Phenomenology]] 连接，则可成为学生面对未知未来、复杂社会问题和地方生活世界的学习方式([[Argument_Schaffar_2024_CogentEdu|Schaffar & Wolff, 2024, pp.5-7, 10-11]])。
