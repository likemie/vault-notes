...
> [!note]- 时间线
> - **2014**：芬兰语与瑞典语版基础教育国家核心课程发布，并将跨学科与[[Phenomenon-Based Learning|现象本位学习]]纳入课程框架（Schaffar & Wolff, 2024, p.2）。
> - **2016**：英文版基础教育国家核心课程发布；国际讨论中 PhBL 的能见度进一步上升（Schaffar & Wolff, 2024, p.2）。
> - **2018-2023**：赫尔辛基[[The Great Learning|大学]] [[SveaSus Project]] 以 Suomenlinna 世界遗产地为学习环境，围绕可持续性探索现象本位学习、具身学习、艺术本位和多语方法（Schaffar & Wolff, 2024, p.1）。

## 实施情况

> [!example] 实施情况
> 芬兰学校和教师对 [[Phenomenon-Based Learning|PhBL]] 的理解与实施存在差异。Leppiniemi (2016) 的教师观点研究显示，课程并未给出一个清晰、单一的 PhBL 解释，学校实践因此呈现多样化（Schaffar & Wolff, 2024, p.2）。
>
> 这种多样化与芬兰课程治理结构有关：国家核心课程提供总体价值、目标和框架，但学校和教师仍需要把框架转译为具体学习项目。PhBL 因此可能表现为跨学科主题周、围绕地方环境的项目、世界遗产[[Champ|场域]]学习、可持续性探究、艺术本位学习、具身学习或多语方法等不同形态（Schaffar & Wolff, 2024, p.1）。
>
> 赫尔辛基[[The Great Learning|大学]] [[SveaSus Project]] 提供了一个高等教育与教师教育语境中的实践案例。项目以 Helsinki 附近的 Suomenlinna 世界遗产地为主要学习环境，围绕地点、时间和可持续性组织 PhBL，并尝试具身学习、艺术本位和多语方法。该案例说明 PhBL 可从真实场域出发，把可持续性、世界遗产和学习环境结合起来（Schaffar & Wolff, 2024, p.1）。

## 效果与评价

> [!success] 效果与评价
> [[Phenomenon-Based Learning|PhBL]] 的评价呈现"双重性"。一方面，整体取向、合作和相互责任使它适合回应复杂挑战；它能够把学科知识、学生好奇心、现实问题和共同责任联系起来（Schaffar & Wolff, 2024, pp.1, 11）。另一方面，PhBL 既不是全能方案，也不是可快速复制的方法；它更像一种促使学校重新反思当代教育意义的教学工具（Schaffar & Wolff, 2024, p.11）。
>
