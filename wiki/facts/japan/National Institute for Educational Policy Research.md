---
title: National Institute for Educational Policy Research
aliases:
  - NIER
  - 国立教育政策研究所
  - 日本国立教育政策研究所
summary: "日本文部科学省同楼并存的国立教育政策研究所（NIER），兼具法定学术独立性与高层政策配合的独特双轨定位，是亚太地区最具代表性的政府资助自治型教育知识中介机构，承担国家宏观教育政策研究与国际大规模测评参与协调职责。"
type: fact
...
> - **总部地点** 位于东京千代田区霞关，与文部科学省同处同一建筑群，形成独特的"同楼独立"制度格局。
> - **法人属性与经费** 依据《独立行政法人通则法》设立的独立行政法人（Incorporated Administrative Agency），由文部科学省主管，享有经常性国家预算拨款，同时可承接竞争性研究项目。
> - **核心宗旨** 为文部科学省教育政策决策提供科学实证依据，开展教育课程、学力评估、教师发展、国际比较及教育统计等领域的综合政策研究，并承担日本参与国际大规模教育测评的协调职责。
...
> | 条目 | 类型 | 关系 |
> |:-----|:-----|:-----|
> | [[Educational Brokerage Agency]] | 概念 | NIER 是"政府资助自治型"中介的亚太标杆案例，在 Burns & Schuller 三维治理谱系中体现了"物理邻近 + 法律自治"的平衡。 |
> | [[Teaching and Learning International Survey]] | 机构事实 | NIER 作为日本 TALIS 国家协调机构，直接参与工具开发与数据采集，是 TALIS 在日本落地实施的核心技术支撑。 |
> | [[Kennisrotonde]] | 机构事实 | 同属"政府资助自治型"中介，与 NIER 的东亚模式形成欧洲-亚太跨文化比较，共同例证了非部委嵌入型中介的制度韧性优势。 |
> | [[Kenniskamer]] | 机构事实 | 与 NIER 形成鲜明对比——同样具有政策对齐取向，但 Kenniskamer 依附于特定部长而夭折，NIER 则凭借法定独立性跨越政治周期持续运作。 |
> | [[Argument_Burns_Schuller_2022_BrokerageAgencies\|Burns & Schuller (2022)]] | 论证条目 | 以 NIER 为"政府资助自治型"中介的亚太代表，论证物理邻近与行政自治并行的制度设计如何实现政策对齐与学术独立的双重目标。 |
