---
title: Clearing House Unterricht
aliases:
  - 德国教学研究清算中心
  - 慕尼黑工业大学教学清算中心
  - CHU
...
established: "2017"
issuing_organization: Technische Universität München
tags:
  - region/germany
  - region/eu
...
> - **跨学科专职研发团队** 汇聚来自教育心理学、一般教学论（Allgemeine [[Didaktik]]）、学科教学论（Fachdidaktik）与媒体教育学领域的跨学科研究人员，承担高阶实证文献综合与数字交互资源开发。
> - **外部资助与协同网络** 早期依托 BMBF 与 QLB 国家公法资助，当前依托威廉·施特默基金会长效公益资助，横向联结全德各州师资进修学院、弗劳恩霍夫学会相关项目以及国际比较中心（ZIB）。[[Argument_Knogler_2025_BB|(Knogler et al., 2025, pp. 14, 16)]]
...
> - **专业研究合成与动态证据库维护** 建立并持续更新涵盖数理学科教学有效性元分析的专门数据库，团队不仅二次提炼外部顶级文献，亦自主开展并发表系统性元综述（如 Knogler et al., 2022a, 2022b）。
> - **标准化通俗转译规程（11-Step Protocol）** 专家团队严格推行从学术元分析到教学简评的 11 步转译标准：解构复杂统计参数，转化为实践行动发问、结构化核心要点、决策参数概览框与实施边界条件。
> - **需求导向与非线性反馈迭代** 常态化开展针对高校教师教育者与在岗教师的需求调查与效用评估，针对实践现场严峻的时间挤压与资源门槛，动态迭代短评与微课模块。[[Argument_Knogler_2025_BB|(Knogler et al., 2025, pp. 14–16)]]

---

## 核心业务与协同范式

> [!feature] 核心中介业务与转译产品矩阵
...
> [!citation-card] 机构法定宗旨与使命表述
> 目标是提供科学立论的服务，支持将课堂与教学研究的最新科研成果转移至教师教育及学校实践中，从而增强教育系统中的证据知情行动。[[Argument_Knogler_2025_BB|(Knogler et al., 2025, p. 14)]]
>
> *Ziel der an der Technischen Universität München angesiedelten Initiative ist es, einen wissenschaftlich fundierten Service bereitzustellen, der den Transfer aktueller Forschungserkenntnisse aus der Unterrichtsforschung in die Lehrkräftebildung und schulische [[Praxis]] unterstützt – und so zur Stärkung evidenzorientierten Handelns im Bildungssystem beiträgt.*
...
> 1. **用户群体的高度效用认可** 针对受访高校教师教育者的实证调查显示，平台在个人效用、自身教学实践适用性、知识深化以及备课时间减负等核心维度均获高度评价。
> 2. **大学与跨机构教学集成** 平台开发的简评与培训模块被德国多所综合性大学教师教育学院深度嵌入至职前师范生研讨课与教师进修课程中。
> 3. **奠定德语区循证中介[[Paradigm|范式]]** 作为德语区首个看齐美国[[What Works Clearinghouse|有效干预清算中心]]（WWC）与英国[[Education Endowment Foundation|教育捐赠基金会]]（EEF）的专业机构，成功探索了面向欧陆学科教学论（Didaktik）语境的证据转化范式。[[Argument_Knogler_2025_BB|(Knogler et al., 2025, pp. 14–16)]]

> [!stat-cards]- 核心效用评估数据
> - **4–5 分（满分 6 分）** 教师教育者对 CHU 平台在个体效用、自身教学适用性、知识拓展与时间减负等维度的平均积极评分，且无论使用者原本的知识或资源储备高低均给出稳定积极评价。[[Argument_Knogler_2025_BB|(Knogler et al., 2025, p. 16)]]
> - **2017 年** 机构正式创设并在慕尼黑工业大学上线开放服务。[[Argument_Knogler_2025_BB|(Knogler et al., 2025, p. 14)]]
> - **2029 年** 威廉·施特默基金会（Wilhelm Stemmer Stiftung）当前确立的战略资助保障期截止年份。
...
> > 德国乃至欧洲诸多教育清算机构（如丹麦 DPU 清算所）均依附于政府为期 2–3 年的短期课题合同，在合同期满后往往面临资金断裂甚至实体解散的困局；CHU 创设早期同样依托联邦 QLB 阶段性课题（2015/2016–2023），但其通过迅速建立高质量产品矩阵与广泛用户网络，在联邦项目收官之际成功获得威廉·施特默基金会延续至 2029 年的长期慈善注资，开辟了“政府项目孵化—高校常设支持—私人基金会长期护航”的混合中介治理新范式。
>
> > [!axis] 乘数群体的支持依赖与最终穿透链路
> > 将资源重点配置于教师教育者与进修负责人（乘数群体）虽能实现杠杆扩散，但这批骨干群体自身同样高度依赖成套易用的教学工具，且从大学研训课堂向中小学常态教学法渗透的链路较长，仍需各州在职进修督导体制的深度机制协同。[[Argument_Knogler_2025_BB|(Knogler et al., 2025, p. 16)]]
...
> | 条目 | 类型 | 关系 |
> |:-----|:-----|:-----|
> | [[Zentrum für internationale Bildungsvergleichsstudien]] | 事实 (机构) | 同设于 TUM 的战略协同伙伴，结成 CHU x ZIB 宏微观证据转化双轨网络。 |
> | [[Federal Ministry of Education and Research]] | 事实 (机构) | 平台创设初期的国家立项与全额专项资助部委。 |
> | [[Qualitätsoffensive Lehrerbildung]] | 事实 (项目) | 平台创设所依托的全国性重大教师教育质量攻坚工程。 |
> | [[Tina Seidel]] | 人物 | 慕尼黑工业大学讲席教授，平台的学术发起人与首席科学家。 |
> | [[Educational Evidence Clearinghouses]] | 概念 | 德语区首个常设清算实体，代表高校依托与混合资助模式的创新范本。 |
> | [[Educational Brokerage Agency]] | 概念 | 实践知识中介理论的典型机构实体，以教师教育者为核心乘数载体。 |
