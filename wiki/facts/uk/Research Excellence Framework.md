...
> [!abstract]
> Schulze-Cleven et al.（2017, pp.801–802, 809）以及 相关的多项分析 揭示了 REF 的多重制度效应：
...
- **制度化马太效应**：作为制度化马太效应运作——评估指标偏向已有资源优势的机构（更多博士生和博士后 → 更多发表 → 更高评估得分 → 更多拨款 → 更多博士生和博士后）。[[Bertrand Russell|Russell]] Group 大学在 REF 中持续占据评估得分顶端
