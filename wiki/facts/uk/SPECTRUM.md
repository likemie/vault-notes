...
> [!claim] 项目定位
> 英国[[Education Endowment Foundation|教育捐赠基金会]]（EEF）委托曼彻斯特大学研究团队开展的大规模系统[[Document|文献]]审查与测量工具库建构工程，旨在系统梳理、评定并准入儿童与青少年非认知、心理韧性及社会情感技能的标准化测量工具，为高规范教育试验提供可信的测量学基准。[[Argument_Edovald_Nevill_2021_ECNUROE|(Edovald & Nevill, 2021, p. 54)]]
...
> - **核心问题导向** 伴随 EEF 资助领域向学前教育与非认知领域（如[[Self-control|自我控制]]、抗逆力）扩展，市场上非认知量表良莠不齐、心理测量学属性薄弱，严重威胁试验主要结局的[[Causality|因果推断]]效度。[[Argument_Edovald_Nevill_2021_ECNUROE|(Edovald & Nevill, 2021, p. 54)]]
...
> [!claim] 核心干预／机制假说
> 通过建立严格的心理测量学筛选漏斗与循证准入目录，能够有效终结评估团队随意选取劣质非认知量表的混乱局面，大幅降低教育试验因测量工具失效导致的试错成本。[[Argument_Edovald_Nevill_2021_ECNUROE|(Edovald & Nevill, 2021, p. 54)]]

> [!policy-design] 方案设计
> - **项目目标** 构建权威的非认知结局测量工具库，确立统一的心理测量学准入标准（[[Reliability|信度]]、[[Construct Validity|结构效度]]、[[Predictive Validity|预测效度]]与学校情境可行性）。[[Argument_Edovald_Nevill_2021_ECNUROE|(Edovald & Nevill, 2021, p. 54)]]
> - **覆盖五大核心领域** SPECTRUM 框架涵盖五大心理与行为维度：
>   1. **社交技能（Social Skills）** 同伴交往、亲社会行为与协作沟通；
>   2. **心理健康与幸福感（Psychological Wellbeing）** 积极情绪、焦虑抑郁筛查与心理适应；
>   3. **情绪调节与理解（Emotional Regulation & Understanding）** 情绪认知、表达控制与压力管理；
>   4. **自我概念体系（Concepts of Self）** 自尊、[[Self-control|自我控制]]、学术[[Self-Efficacy|自我效能感]]与自我意象；
...
> [!citation-card] 非认知工具库的战略推进与前置防范价值（[[Argument_Edovald_Nevill_2021_ECNUROE|Edovald & Nevill, 2021]]）
> 2014 年起，[[Education Endowment Foundation|EEF]] 将资助领域从学科认知进一步拓展至学前教育与非认知领域（如自我控制、心理韧性与社交情绪）。针对市场上非认知量表良莠不齐的严峻现实，EEF 委托曼彻斯特大学迈克尔·威格斯沃思（Wigelsworth, 2017）开展超大规模系统[[Literature Review|文献综述]]，正式构建了“社会、心理、情感、自我概念与韧性测量工具库”（SPECTRUM，即非认知与社会情感测量工具库），并同步启动全英[[Academic Achievement|学业成就]]测验系统综述，建立权威准入目录。实践表明：若资助机构在创立初期就前置建立严格的标准化测量工具库，便能大幅避免数以百万英镑计的试错成本，为全球循证资助机构树立了关键方法学镜鉴。[[Argument_Edovald_Nevill_2021_ECNUROE|(Edovald & Nevill, 2021, p. 54)]]
>
...
> - **2017 — 成果发布与数据库上线** 正式发布 SPECTRUM 综合操作指南《[A brief guide to the selection, use, and interpretation of SPECTRUM measures](https://educationendowmentfoundation.org.uk/public/files/Evaluation/SPECTRUM/V6_Guidance_document.pdf)》与[在线检索数据库平台](https://educationendowmentfoundation.org.uk/spectrum-essential-skills-and-non-academic-outcomes/spectrum-database)，为全英教育评估机构提供推荐工具清单与五星评级标准。[[Argument_Edovald_Nevill_2021_ECNUROE|(Edovald & Nevill, 2021, p. 54)]]
...
> [!actor-grid] 实施协同矩阵
> - **发起与资助方** 英国[[Education Endowment Foundation|教育捐赠基金会]]（EEF） — 顶层规划资助标准，提出非认知测评的制度化需求并保障科研经费。[[Argument_Edovald_Nevill_2021_ECNUROE|(Edovald & Nevill, 2021, p. 54)]]
> - **学术研发团队** 曼彻斯特大学（迈克尔·威格斯沃思教授领衔） — 制定综述方案、执行证据提取、评定测量学等级并搭建数据库框架。
> - **应用执行机构** 独立评估团队与高校研究中心 — 在竞标 EEF 评估课题及制定[[Preregistration|预注册]]方案时，必须基于库内准入工具选择结局指标。
> - **最终受试对象** 参与[[Randomised Controlled Trials|随机对照试验]]的全英中小学校与学龄儿童。
...
> [!critique] 外部批评与方法挑战
> - **非认知[[Construct|构念]]的情境敏感性与跨情境变异** 批评者指出，心理韧性与[[Self-control|自我控制]]等构念受学校环境、家庭支持与社会阶层影响极大，标准化量表在常态课堂环境中的[[Ecological Validity|生态效度]]依然面临挑战。
> - **施测负担与自陈报告偏倚** 非认知测评高度依赖自陈量表（[[Questionnaire|问卷调查]]），容易受到学龄儿童的社会赞许性偏差与主观理解偏差的侵蚀。

> [!warning] 适用局限
> SPECTRUM 工具库主要针对大规模群体评估与实证试验设计，不宜将其机械挪用为对个体学生进行临床心理诊断或高利害分流考核的依据。
