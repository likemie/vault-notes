...
> [!claim] 项目定位
> 英国[[Education Endowment Foundation|教育捐赠基金会]]（EEF）委托曼彻斯特大学研究团队开展的大规模系统[[Document|文献]]审查与测量工具库建构工程，旨在系统梳理、评定并准入儿童与青少年非认知、心理韧性及社会情感技能的标准化测量工具，为高规范教育试验提供可信的测量学基准。[[Argument_Edovald_Nevill_2021_ROE|(Edovald & Nevill, 2021, p. 54)]]
...
> [!policy-design] 方案设计
> - **项目目标** 构建权威的非认知结局测量工具库，确立统一的心理测量学准入标准（[[Reliability|信度]]、[[Construct Validity|结构效度]]、[[Predictive Validity|预测效度]]与学校情境可行性）。[[Argument_Edovald_Nevill_2021_ROE|(Edovald & Nevill, 2021, p. 54)]]
...
> [!actor-grid] 实施协同矩阵
> - **发起与资助方** 英国[[Education Endowment Foundation|教育捐赠基金会]]（EEF） — 顶层规划资助标准，提出非认知测评的制度化需求并保障科研经费。[[Argument_Edovald_Nevill_2021_ROE|(Edovald & Nevill, 2021, p. 54)]]
