...
aliases:
  - EEF
  - 教育捐赠基金会
summary: "英国2011年由萨顿信托联合创立的准独立慈善证据中介旗舰，依托1.25亿英镑政府种子基金，通过《教学与学习工具包》、大规模RCT资助及研究学校网络，开创了循证教育生态系统模型。"
type: fact
...
> - **2014 — 跨国原型输出与 [[Evidence for Learning\|E4L]] 联合资助** EEF 联合澳大利亚联邦银行（Commonwealth Bank of Australia）共同注入巨资，资助[[Social Ventures Australia\|澳大利亚社会创投]]（SVA）设立全资中介子公司[[Evidence for Learning\|证据学习中心]]（Evidence for Learning，E4L），由商业律师 Matthew Deeble 掌舵，直接引进并[[Going Native\|本土化]] EEF 的[[EEF Teaching and Learning Toolkit\|教学与学习工具包]]，率先在维多利亚州教育部试水并开展学校循证干预试验，作为国家级证据中介的样板试验田（[[Argument_Rowe_2022_IJER\|Rowe, 2022, p. 3]]；[[Argument_Rowe_2023_ECNUROE\|Rowe, 2023, pp. 525, 530]]）。
> - **2016–2020 — 跨国政策辐射与制度输出** SVA 以 E4L 的运行成效作为样板原型，向联邦生产力委员会及 [[Gonski 2.0]] 审查委员会递交多份专项建议书，系统推销以英国 EEF 和美国 [[Institute of Education Sciences\|IES]] 为蓝本的独立证据中介模式，直接促成国家级法定中介[[Australian Education Research Organisation\|澳大利亚教育研究组织]]（AERO）的建立（[[Argument_Skourdoumbis_2024_AER\|Skourdoumbis & Rowe, 2024, p. 8]]；[[Argument_Rowe_2022_IJER\|Rowe, 2022, p. 7]]；[[Argument_Rowe_2023_ECNUROE\|Rowe, 2023, p. 525]]）。
...
> - **2020–2023 — 跨国高管旋转门与因果证据输出** EEF 首任首席执行官[[Sir Kevan Collins\|柯文·科林斯爵士]]（Sir Kevan Collins）兼任 SVA 顾问并受邀出任澳大利亚 AERO 首届专家委员会委员，深度主导跨国因果[[Evidence Standards\|证据标准]]与工具包框架向国家科研体制的输入，形成跨国[[Policy Network\|政策网络]]与[[Network Governance\|网络治理]]的人事与知识回路（[[Argument_Skourdoumbis_2024_AER\|Skourdoumbis & Rowe, 2024, p. 11]]；[[Argument_Rowe_2022_IJER\|Rowe, 2022, pp. 9–10]]；[[Argument_Rowe_2023_ECNUROE\|Rowe, 2023, p. 531]]）；2023 年发布《课堂中的认知科学》专题综述，系统推进基于[[Cognitive Load Theory\|认知负荷理论]]（Cognitive Load Theory）的显性教学规程。
...
> - **信托受托人理事会（Board of Trustees）** 机构最高决策权力层，由[[Peter Lampl\|彼得·兰普尔爵士]]担任主席，[[Sutton Trust\|萨顿信托]]代表、[[Impetus\|动力基金会]]（Impetus）代表、顶尖教育学者、前高级政务官及商界资深人士组成，统筹战略资助与资金配置。
> - **跨国企业资本与资助网络** EEF 虽以公共慈善形象示人，但其资金与治理底座深深锚定于跨国金融与法律资本：资助母体萨顿信托由美洲银行、高盛集团、摩根大通、普华永道等巨头支持；Impetus 由贝恩资本、KKR、黑石集团等跨国私募股权财团主导；并获[[BHP Foundation\|必和必拓基金会]]数百万英镑专项资助，形成公私模糊的跨国资本拓扑网络（[[Argument_Rowe_2022_IJER\|Rowe, 2022, pp. 6–8]]）。
...
> - **证据生产与独立评估防火墙** EEF 严格实行干预开发者与评估者彻底剥离的“独立三方协议”制度：项目干预开发者负责教学创新方案的开发与交付，评估者专家库（顶尖大学科研团队）通过公开竞标独立主持实施大规模 [[Randomised Controlled Trials\|RCT]] 试验，并将方案在[[ISRCTN\|国际标准随机对照试验编码]]（ISRCTN）[[Preregistration\|预注册]]、微观数据接入[[National Pupil Database\|国家学生数据库]]（NPD）纵向归档。
...
> - **跨国辐射与全球镜像网络** EEF 跨国输出中介模式，出资扶持澳大利亚[[Social Ventures Australia\|SVA]]旗下中介原型[[Evidence for Learning\|E4L]]并促成澳国家级机构[[Australian Education Research Organisation\|AERO]]创设；携手必和必拓基金会共建拉美中介[[SUMMA]]；牵头协调覆盖 20 国的全球[[Evidence for Education Network\|教育证据网络]]（EEN）。
...
> [!stat-cards]- 核心规模数据
> - **1.25 亿英镑** 初始财政种子捐赠基金，开创准独立公共中介资助范式
> - **400+ 项** 截至最新官方评估报告累计资助执行的教育研究、现场试验与创新试点项目总数（[EEF Impact Report](https://educationendowmentfoundation.org.uk/impact-report)）
> - **80% (4/5)** 全英格兰公立中小学校实际参与过 EEF 资助项目的累计比例
> - **85%** 英格兰中小学校长依据 EEF 指导报告制定针对弱势学生教育策略的比例
> - **158 万名** 早期卷入 EEF 资助研究项目的学生累计规模
> - **200+ 项** 资助执行的大规模教育[[Randomised Controlled Trials\|随机对照试验]]（占全球近十年教育 RCT 的近两成）
> - **2 倍** 2014 年后试验[[Effective Sample Size\|有效样本量]]提升幅度，大幅提高检验统计功效（Sanders, 2019）
> - **10,000+ 项** 全球教育活数据库（EEF Education Database）深度[[Coding in Qualitative Research\|编码]]的全球实证研究规模
> - **70% vs 25%** EEF 试验中[[Sample Size Determination\|样本量]]超过 1,000 人的比例，远超全球同类平均水平（25%）
...
> [!debates] 核心学术与政策争议
>
> > [!axis] 官方绩效辩护 vs 管理主义异化（“[[Governing by Numbers\|以数字治理]]”）
> > 探讨客观证据评级是否沦为新自由主义官僚问责的遮羞布。
> >
> > - **官方与支持者立场** 认为工具包提供了客观、清晰的量化标尺，帮助弱势学校摆脱商业推销忽悠，实现财政资源的最优配置。
> > - **管理主义批判** [[Argument_Bainbridge_2022_ROE\|Bainbridge et al. (2022)]] 与 [[Argument_Cowen_2019_ERE\|Cowen (2019)]] 指出，在实际制度运作中，EEF 工具包往往被异化为迎合督导机构（[[Ofsted]]）问责的以数字治理（Governing by Numbers）合规工具；当学术证据与政治利益冲突时，政府甚至会主动搁置证据。
>
> > [!axis] 实证科学标杆 vs [[Evidence Era\|证据时代]]“[[Rationalized Myth\|合理化神话]]”的工具化风险
> > 探讨 EEF 所代表的实验证据究竟是提升了政策理性，还是被政府作为获取合法性的仪式化象征符号。
> >
> > - **[[Argument_Helgetun_2022_JEP\|Helgetun & Menter (2022)]]** 指出，EEF 的 [[Randomised Controlled Trials\|RCT]] 证据与工具包在客观上构建了[[Evidence Era\|证据时代]]的主导性[[Rationalized Myth\|合理化神话]]；但当证据进入政治[[Champ\|场域]]时，政府通过[[Gatekeepers\|把关人]]机制和适宜性逻辑选择性采纳，甚至催生了[[Policy-Based Evidence-Making\|基于政策的证据制造]]，使严谨实验往往被异化为预设立场的合法化修辞。
> > - **EEF 官方及[[Positivism\|实证主义]]支持者** 强调[[Preregistration\|预注册]]、[[Evaluator Independence\|第三方独立评估]]与全样本 NPD 归档建立了最严格的科学防火墙，有效遏制了虚假干预，为公共财政与弱势学生提供了最可靠的保护。
>
> > [!axis] 跨国私人资本渗透与教育[[Knowledge Production\|知识生产]]自主性危机
...
> 
> 然而[[Critical Realism\|批判实在论]]学者深度核查底层数据发现，由于试验初期随机分配严重失衡，干预组[[Pre-test and Post-test\|前测]]基线成绩系统性低于对照组。当研究者剔除偏差、筛选出前测完全相同的低分学生配对子集时，干预组与对照组后测进步**完全一致（效应量净值为 $+0.00$ SD）([[Argument_Wrigley_2018_BERJ\|Wrigley, 2018, p. 5]])**。所谓的 3 个月学业增益纯属随机分配缺陷导致的虚假统计幻象。

> [!critique-method]- 案例二：[[Teaching Assistant\|助教]]（Teaching Assistant，TA）类目的去情境化抹杀
> 工具包长期将助教（TA）归入低影响、高成本（效应量仅 $+0.08$ SD）的排行榜垫底位置，险些导致财政紧缩背景下英格兰中小学对助教岗位的大规模裁撤。
> 
> 深度质性实证表明，助教显效不彰的根源在于学校未能为其预留与任课教师沟通备课的时间，且制度性将后进生直接甩给助教照看，剥夺了弱势学生接受合格专业教师教学的机会。工具包脱离微观组织情境的单纯数值排序，极易给政策制定者提供危险的裁减误导([[Argument_Wrigley_2018_BERJ\|Wrigley, 2018, p. 12]])。

> [!critique-logic]- 案例三：实验控制设计与教育能动性（Agency）的[[Ontology\|本体论]]冲突
> EEF 主导的 RCT [[Paradigm\|范式]]倾向于将教师的主观教学热情、[[Reflexivity\|反思性]]调整以及学生的能动性推理视为需要被严加控制的干扰噪声或混淆[[Variable\|变量]]，盲目追求干预方案的标准化（Teacher-Proof）。
> 
...
> | 条目 | 类型 | 关系 |
> |:---|:---|:---|
> | [[Educational Evidence Clearinghouses]] | Concept | EEF 是当代最具全球影响力的综合证据清算与生态型中介机构之一。 |
> | [[Educational Brokerage Agency]] | Concept | 本机构所归属的核心组织形态（准独立慈善基金会型中介）。 |
> | [[What Works Movement]] | Concept | EEF 创设的历史运动脉络与政策动因。 |
...
> | [[Network Governance]] | Concept | EEF 模式通过公私伙伴关系、跨国慈善资本资助及政商专家旋转门在英澳两国所展现的网络化治理样态。 |
> | [[Argument_Rowe_2023_ECNUROE\|Rowe (2023)]] | 关键论证 | 揭示 EEF 如何联合联邦银行资助 SVA/E4L 搭建试验原型，并由 Collins 跨国任职 AERO 实现因果证据量规向国家科研体制的捕获与转译。 |
...
> - [[Argument_Rowe_2023_ECNUROE\|Rowe (2023)]] — 追踪[[Venture Philanthropy\|风险慈善]]在公立教育中的兴起，揭示 EEF 创始背景与麦肯锡全球网络的渊源、联合澳大利亚联邦银行向 [[Evidence for Learning\|E4L]] 注资搭建私营试验原型的机制，以及 EEF 创始 CEO 凯文·柯林斯入驻 [[Australian Education Research Organisation\|AERO]] 专家委员会实现跨国[[Policy Network\|政策网络]]闭环的制度过程。
