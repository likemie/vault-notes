...
> [!example] 实施影响
> CATE 后，教育社会学不再作为所有准教师必须接触的基础学科进入教师教育，而更常被学生在高等学位阶段自行选择并付费学习；这些内容往往被包装进政策、行为管理、评价或课程类课程中([[Argument_Ball_2008_SR|Ball, 2008, p.659]])。

## 效果与评价

> [!success] 制度效果
> CATE 压缩了 [[New Sociology of Education|NSE]] 依托教师教育扩张而形成的制度空间，也改变了教师专业知识的构成：教师教育从社会学、哲学等基础学科取向，转向更偏课堂技能和能力的训练模式([[Argument_Ball_2008_SR|Ball, 2008, pp.658-659]])。
