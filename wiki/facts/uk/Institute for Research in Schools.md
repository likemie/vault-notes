...
> - **Genome Decoders（基因组测序与注释）** 与威康桑格研究所合作，中学生直接参与对寄生虫及热带病原体 DNA 序列进行生物信息学人工注释。
> - **Earth Watch & Climate Models（地球环境监测）** 结合卫星遥感数据与校园气象站，开展气候变化对地方生态系统影响的纵向建模。
...
> - **激发对前沿 [[STEM Education\|STEM]] 学科的深层抱负** 显著提升学生修读物理、计算生物学及数据科学的高阶学术志向。
...
> | 条目 | 类型 | 关系 |
> |:-----|:-----|:-----|
> | [[Practical Inquiry in Science Education]] | 概念 | IRIS 构成了真实科研探究在基础教育中落地的先锋模式。 |
> | [[Science Capital]] | 概念 | 为学生提供了直接接触前沿科学家与真实科研共同体的社会资本通道。 |
