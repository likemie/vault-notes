...
aliases:
  ...
  - EPPI Centre
  - EPPI
summary: "1995年设于伦敦大学学院教育学院（UCL IOE）的国际先驱证据中介机构，经合组织2007年追踪机构中唯二保持十五年完全活跃的标杆之一，开创了从线性转译向多方参与综述、软件平台及元中介网络协同演进的学术中介范式。"
type: fact
...
> [!actor-grid] 组织治理架构
> - **学术决策与管理层** 设于 UCL 教育学院，由知名循证学者组成核心指导委员会，保障[[Research Problem|研究议题]]的学术中立性与高度方法论自主权。
> - **执行与方法学研发组** 常设[[Systematic Review|系统综述]]方法学专家、统计学顾问与信息检索科学家团队，专职承担证据综合规程的研制与迭代。
> - **软件研发与技术支持单元** 专门组建数字化工程团队，自主研发并常态化运维全球通用的系统综述软件平台（EPPI-Reviewer）。
> - **跨界合作与咨询网络** 与中央政府部门（如英国教育部、卫生部）、国际组织（[[OECD]]、世界卫生组织）及基层专业团体建立紧密的项目咨询合作网络。
...
> [!finding-cards] 核心业务矩阵与技术产品
> - **EPPI-Reviewer 智能[[Systematic Review|系统综述]]软件平台** 自主研发的端到端综述管理系统，集成机器学习[[Document|文献]]筛选、定性[[Coding in Qualitative Research|编码]]、[[Effect Size|效应量]][[Meta-analysis|元分析]]与报告生成功能，被坎贝尔协作网（[[Campbell Collaboration]]）及全球数千个研究机构广泛采购采用。
> - **方法论专著与前沿审查指南** 连续发布《系统综述导论》（An Introduction to Systematic Reviews）等权威指南，奠定了国际跨学科系统综述的方法学教科书标准。
> - **高利害教育与公共政策专题综述** 针对教师留任、小班化教学、贫困学生学业干预及早期教育等重大议题受托发布百余项深度系统综述，直接进入英国国会辩论与政府白皮书。
...
> [!indicators]- 影响力维度与指标
> - **学术与方法论引领** 奠定了全球社会科学[[Systematic Review|系统综述]]的黄金规程，开创的质性综合与主题综合方法被引用数万次。
> - **国际软件生态占有率** EPPI-Reviewer 成为仅次于医学界 RevMan 的国际权威综述管理平台，深度赋能全球循证研究者。
> - **政策与制度渗透** 为英国《每一个孩子都重要》（Every Child Matters）等重大国家政策法案提供了底层实证证据基础，并作为母体孵化了英国多项公共中介机制。

> [!finding-cards] 关键成效与[[Paradigm|范式]]重塑
> - **打破医学循证范式的机械移植** 成功证明系统综述不应沦为狭隘的[[Randomised Controlled Trials|随机对照试验]]垄断工具，证明质性证据在揭示教育干预微观机制与情境阻力上具有同等关键的证据权重。
...
> | 条目 | 类型 | 关系 |
> |:---|:---|:---|
> | [[Educational Evidence Clearinghouses]] | Concept | EPPI-Centre 是英国较早制度化的教育与社会科学证据清算与中介机构典范。 |
> | [[Educational Brokerage Agency]] | Concept | 本机构所归属的核心组织概念（大学学术依托型中介机构）。 |
> | [[Knowledge Mobilisation]] | Concept | 机构职能贯穿证据综合、数字化工具赋能与多边关系型动员全过程。 |
