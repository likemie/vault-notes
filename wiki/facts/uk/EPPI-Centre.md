...
> [!info]
> EPPI-Centre 由 University College London 的 Institute of Education 于 1995 年创建。它最初开展医疗保健领域综述，后来扩展到社会照护、公共卫生、就业、社会和经济发展以及教育等领域([[Argument_Pellegrini_2021_ROE|Pellegrini & Vivanet, 2021, p.33]])。
...
> [!success]
> 在欧洲证据政策生态中，EPPI-Centre 是英国较早制度化的证据基础设施。Pellegrini & Vivanet 将其与 [[What Works Clearinghouse]] 并列为知识中介机构例子，用来说明研究证据需要被[[Transfer Translation Transformation|转译]]成可获得、可使用的信息([[Argument_Pellegrini_2021_ROE|Pellegrini & Vivanet, 2021, pp.29, 33]])。
