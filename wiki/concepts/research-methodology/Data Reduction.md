...
> - **用途** 帮助研究者克服认知容量限制与数据过载难题，建立从原始繁复文本通往理论推论的审计追踪与分析通道。
...
> [!boundary]- 概念边界
> - 不等于 [[Winnowing|数据筛选]] — Winnowing（Creswell 框架）主要指在编码后期选择聚焦少数核心主题、略去非核心细节的选择性过滤；数据缩减（Miles & Huberman 框架）则是一个贯穿研究设计、数据采集、转录编码与模型建构的持续转化与分析流。
> - 不等于 随意删减或数据损耗 — 缩减过程受研究问题和理论视角引导，须通过审核追踪（[[Audit Trail|audit trail]]）确保缩减决策可追溯、可审计。
...
> [!feature] 数据缩减的四大演进要素
> - **前期预缩减（Anticipatory Reduction）** 在数据收集前即已自发启动，通过研究问题选定、概念框架确立、个案与抽样边界界定、访谈提纲编制等先验决策，对潜在数据范围施加首次结构性缩减。[[Argument_Cohen_Manion_Morrison_2011_Routledge_Ch29|(Cohen et al., 2011, p. 537)]]
> - **过程单位化与粗编码（Unitizing and Coarse Coding）** 将连贯连续文本划分为可独立分析的意义单元（Lincoln & Guba, 1985），剔除冗余修辞并赋予宽泛的描述性代码（Bogdan & Biklen, 1992），实现第一波文本密度压缩。[[Argument_Cohen_Manion_Morrison_2011_Routledge_Ch30|(Cohen et al., 2011, p. 560)]]
> - **层级归并与范畴化（Hierarchical Subsumption and Categorization）** 依据类属相似性或逻辑包含关系将粗编码不断合并归拢（Gibbs, 2007），控制层级树深度，将数以百计的原始代码收敛为少数核心范畴及其维度属性。[[Argument_Cohen_Manion_Morrison_2011_Routledge_Ch30|(Cohen et al., 2011, p. 562)]]
...
> - **1984/1994 — 交互分析流模型的奠基** Miles & Huberman 提出质性数据分析的三联交互框架（数据缩减、数据展示、结论得出/验证），首次将“数据缩减”确立为正当、系统、全生命周期的方法论核心概念，打破了只有量化才能缩减数据的偏见。
> - **2007 — 缩减与膨胀的双向张力反思** Gibbs（2007）对单一的缩减说提出学理修正，指出质性分析在编码、反思备忘录与理论阐释阶段往往伴随着材料体量与复杂度的局部膨胀（expansion），数据缩减与解释膨胀共同构成了分析的动态循环。[[Argument_Cohen_Manion_Morrison_2011_Routledge_Ch30|(Cohen et al., 2011, p. 562)]]
> - **2011 — 教育研究多元分析体系的整合** Cohen、Manion & Morrison 将数据缩减与矩阵展示、内容分析11步流程深度整合，以学校教育中的大量实证案例系统示范了质性数据缩减的操作化路径。[[Argument_Cohen_Manion_Morrison_2011_Routledge_Ch29|(Cohen et al., 2011, p. 537)]]; [[Argument_Cohen_Manion_Morrison_2011_Routledge_Ch30|(Cohen et al., 2011, p. 559)]]
...
> - **伪实证主义量化陷阱** 将缩减等同于粗糙的频数计数或词频统计，容易使质性分析退化为缺乏理论深度的伪量化指标，忽视文本背后的隐喻、情感与权力关系。[[Argument_Cohen_Manion_Morrison_2011_Routledge_Ch30|(Cohen et al., 2011, p. 564)]]
