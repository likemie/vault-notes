...
Rømer 用此概念描述 Hattie 的元-元分析：评价被抽出时间和地点，重构为全球性、数字化的结构。

## 核心要素

- **去情境化**：评价脱离具体教育政策和教育目标
- **元层次**：不连接具体情境，而是汇总大量基于不同情境目标的评价报告
- **自指系统**：数据从学习者眼中提取的目标中产生，用于确认和巩固目标本身
- **全球结构**：评价重构为全球数字系统，可在任何地方运作
...
- Rømer (2018) 以 Hattie 的 VL 为 Pure Evaluation 的典型案例：138 个变量被原子化、去情境化，在元-元分析中汇总为一个全球性的 d>0.4 基准
