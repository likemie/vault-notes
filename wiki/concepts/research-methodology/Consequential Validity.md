...
> - **边界**：结果效度是规范性标准（规定研究应该带来变革），而非描述性标准（描述研究带来的所有后果）。它预设研究具有政治议程——这一预设本身在声称[[Value Neutrality in Research|价值中立]]的研究传统中是被争议的。
...
> [!warrant]- 命题的支撑理由
> 如果研究声称[[Value Neutrality in Research|价值中立]]和客观，它就可能成为维护现状的工具——"价值中立"的研究恰好服务于那些从现状中受益的群体。结果效度将这一批判转化为方法论的正面标准：既然所有研究都有政治后果，那么研究者应该为这些后果负责，并以解放性后果作为研究质量的标志。
...
> - **政治化的风险**：Gillies and Alldred（2002: 45）警告，将研究政治化可能适得其反——提升参与者对约束的意识却无法改变结构性条件，可能使他们比之前更脆弱，实际上削弱而非赋权。
