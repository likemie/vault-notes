...
> - **边界**：结果效度是规范性标准（规定研究应该带来变革），而非描述性标准（描述研究带来的所有后果）。它预设研究具有政治议程——这一预设本身在声称价值中立的研究传统中是被争议的。
...
> [!warrant]- 命题的支撑理由
> 如果研究声称价值中立和客观，它就可能成为维护现状的工具——"价值中立"的研究恰好服务于那些从现状中受益的群体。结果效度将这一批判转化为方法论的正面标准：既然所有研究都有政治后果，那么研究者应该为这些后果负责，并以解放性后果作为研究质量的标志。
