...
> [!boundary]- 概念边界
> - 不等于 医学安慰剂（Placebo） — 医学安慰剂是生理与认知惰性的零效应物，常态教学则是充满能动性、专业实践与既有资源投入的活跃生态。
> - 不等于 无教育介入的教学真空 — 对照组学生同样接受全额课时、完整课程大纲与教师日常辅导，绝非被剥夺受教育权利。
> - 不等于 单一均质的标准对照流 — 各校在师资力量、校本文化与生源构成上的差异，使得常态教学天然具备情境敏感性与内在异质性。
> - 不适用于 纯粹实验室微观认知操纵 — 在脱离学校日常运营的数十分钟短期心理测量中，控制条件通常为精确剥离变量的任务，而非生态化的常态教学。

---

## 概念辨析

通过对比不同研究传统与实验设计中的对照条件，可以清晰界定常态教学的[[Epistemology|认识论]]定位与方法论特征。

> [!contrast-table] 常态教学与邻近对照概念辨析
> | 维度 | 本概念：常态教学（Business as Usual, BAU） | 医学安慰剂（Placebo） | 替代性积极干预（Active Alternative） | 实验室受控对照（Lab Control） |
> |---|---|---|---|---|
> | **对照性质** | 真实活跃的常规专业实践与日常教学生态 | 生理与认知无活性的惰性对照剂 | 接受另一种明确命名的竞争性教改方案 | 严格剔除目标[[Variable\|变量]]的人为简化任务 |
> | **基线水准** | 具备成熟经验与校本资源的高专业基准 | 理论上的绝对零效应基线 | 已知效能的标准化教法或旧版方案 | 人为冻结外部输入的基线状态 |
> | **[[Ecological Validity\|生态效度]]** | **极高**（直接根植于日常真实课堂） | 低（教育场景中无法设立无感知假教学） | 中至高（取决于新方案在真实学校的适配度） | 极低（脱离学校组织、学期时间与师资脉络） |
> | **偏倚风险** | 对照组竞品污染、补偿性竞争与黑箱不可知 | 破盲效应、受试者依从性脱落 | 两组干预组分混淆、[[Implementation Fidelity\|实施保真度]]不均衡 | 实验情境过于狭隘导致不可推广 |
> | **过程监测** | **必须开展[[Implementation and Process Evaluation\|实施与过程评估]]（IPE）详实记录** | 仅需确保双盲操作无破损 | 需对两组干预分别开展保真度监控 | 严格实验室仪器监控与标准化记录 |
...
>     end
> 
>     subgraph 外部实验干预 ["实验干预组（Intervention）"]
>         D["新型教学法 / 培训 / 技术工具"]
>         E["实施保真度与专业发展支持"]
>         D --- E
>     end
> 
>     subgraph 评估机制 ["实施与过程评估（IPE）与反事实推断"]
>         F["追踪对照组活动（排查竞品污染与补偿行为）"]
>         G["反事实对比：测定净效应量（Net Effect Size）"]
>         H["决策判定：干预是否在经济与成效上超越高基线"]
>     end
> 
>     真实学校生态 ==> G
>     外部实验干预 ==> G
...
围绕常态教学的[[Epistemology|认识论]]基线地位、试验透明度治理规约以及在真实课程实验中的[[Ecological Validity|生态效度]]，学界确立了三项系统性理论命题。
...
> | 命题类型 | 核心指向 | 适用情境 | 代表学者 |
> |---|---|---|---|
> | **认识论地位与效度基准** | 缺乏显著正效应往往映射常态教学的高质量基线，证明无效具备保护公共财政的治理价值 | 公立成熟教育系统中的大规模循证政策试验 | Edovald & Nevill |
> | **报告透明度与反事实界定** | 未界定的常态教学黑箱侵蚀因果可解释性，必须通过过程评估进行同步跟踪 | 教育现场试验设计与实施过程评估规范 | Simpson; Edovald & Nevill |
> | **课程实验生态效度与对照基准** | 真实学校常态直接讲授由资深教师熟练实施，构成打平即具高生态效度的严苛检验基准 | 宏观长期课程改革与教学法实效实验 | De Jong et al.; Edovald & Nevill |
...
围绕常态教学的基线测量、实验室纯净对照与真实学校[[Ecological Validity|生态效度]]的权衡，学界展开了持续的交锋。
...
> >
> > - **[[Direct Instruction\|直接教学]]倡导派（[[Argument_Zhang_2022_SE|Zhang et al., 2022]]）** 批评真实学校课程实验缺乏干净无杂质的实验室对照组，认为常态教学对照包含过多未经控制的学校[[Variable\|变量]]与师生交互，无法准确分离核心教学机制。
...
> | Lortie-Forgues & Inglis (2019)（引自 [[Argument_Edovald_Nevill_2021_ECNUROE\|Edovald & Nevill, 2021, p. 56]]） | 英美 141 项中介资助大样本教育 RCT vs BAU | 学科学业表现 | 141 项大型 RCT，跨越英美数万名学生与数百所学校 | 绝大多数干预未能取得大幅度增量 | 中位 $d = 0.06$ | 效应量总体极度微弱 | 揭示在公立教育体系坚实的常态基线之上取得大幅度净增益面临极高生态门槛 |
...
> | [[Direct Instruction]] | 核心概念 | 在真实学校生态中，常态教学主要由资深教师实施熟练的传统直接讲授构成。 |
> | [[Inquiry-Based Learning]] | 核心概念 | 宏观探究课程实验通过与常态讲授对照，确立了高[[Ecological Validity\|生态效度]]的循证优势。 |
