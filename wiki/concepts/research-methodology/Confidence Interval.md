...
> [!abstract] 核心要素
> - **点估计**：点估计给出一个数值，但不说明估计精度；[[Effect Size|效应量]]排名若只给 d 值，就无法呈现该估计可能的误差范围（Allerup, 2015, p.47）。
...
> [!example] 与相关概念的区别
> - vs [[Statistical Significance]] — 显著性检验通常给出是否拒绝零[[Hypothesis|假设]]的判断；置信区间直接呈现估计误差范围，使点估计的精度可见。
