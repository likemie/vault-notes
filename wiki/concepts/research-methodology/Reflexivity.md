...
> - **用途** 帮助研究者显性化和披露自身对研究情境与文本诠释的塑造作用；在教育现场促使教师审思关键决策背后的深层[[Hypothesis\|假设]]，防范形式主义空转。
...
> 高质量研究证据使用要求教育者保持批判性反思与探究好奇心，并在组织内营建倡导日常反思、宽容试验风险并具备心理安全感的研究文化。唯有在反思性[[Organizational Culture\|组织文化]]的支撑下，实践者才能持续质疑行动背后的深层假设与习惯做法，使证据真正契合复杂的实践情境。[[Argument_Rickinson_2022_ER\|(Rickinson et al., 2022a, pp. 142–144)]]
>
...
>         C --> D["深层反身性：审视深层假设与行动理论"]
>         D --> E["防范认知偏误与活动陷阱"]
>         E --> F["多元证据比对与因果验证"]
>     end
>     subgraph Presentation ["呈现与改进"]
>         F --> G["第一人称叙事与透明修辞"]
>         G --> H["双重反身性审计追踪与组织文化积淀"]
>     end
> ```
...
### 命题一　研究者在社会世界之中且不可消除，其主观性构成了质性分析的认知透镜与工具基石
...
### 命题三　行动研究与实践者探究将反身性确立为认知重构基石，审视深层假设以防范活动陷阱
...
> **深层[[Hypothesis\|假设]]审思与抵御[[Activity Traps\|活动陷阱]]** 在教育[[Action Research\|行动研究]]与校本专业探究中，反身性要求实践者超越对教学技术的表层修补，深入反思影响关键决策的潜在假设（underlying assumptions）与行动理论（theories of action）。若缺乏深层反身性审视，教师极易被高频的表层尝试和忙碌研讨所蒙蔽，陷入盲目寻求解决方案却未确立根本成因的[[Activity Traps\|活动陷阱]]。英格兰小学基线调查表明，教师尝试新方法的活跃度高达 82%，但深层假设的反身性审思率仅为 55%，实证证明了实践者反身性是维系有意义校本探究的决定性防线。[[Argument_Brown_Greany_2018_LPS\|(Brown & Greany, 2018, pp. 124–125, 131)]]
...
### 命题四　计算分析与人机协同重构了反身性责任，技术自动化凸显了人类研究者与学习者在意义赋予与偏误防范中的人在回路主体地位

> [!concept-lens] 智能算法时代的人在回路方法论审慎
> 本命题探讨计算机辅助软件与大语言模型普及背景下，反身性如何演进为防范算法黑箱、保留意义解释权以及在学习中维持认知监控的核心防线。
...
> | **人机协同命题** | 计算工具无法替代生命体验，反身性确立人在回路、算法规约与自我认知监控 | 人在回路（HITL）、防范算法幻觉、方法代码留痕、接收者自我监控 | Bogdan & Biklen (1992); [[Argument_Cohen_Manion_Morrison_2011_Routledge\|Cohen et al. (2011)]]; [[Argument_Du_Yuan_2026_AIS\|Du & Yuan (2026)]]; [[Argument_Han_Gutierez_2026_IJSE\|Han & Gutierez (2026)]] |
...
> - **2026 — 人机协同学习中的算法自省与接收者自我反思** [[Argument_Du_Yuan_2026_AIS\|Du & Yuan (2026)]] 确立人机共生中的算法影响反身性规约；[[Argument_Han_Gutierez_2026_IJSE\|Han & Gutierez (2026)]] 实证揭示反思性提问提示语如何驱动中学生在[[Scientific Explanation|科学解释]]人机协同中开展多模态因果反思与接收者认知监控。
...
> - **敏捷微调立场（蓝方）** 强调一线实践充满不确定性，教师应根据直觉与短期反馈快速调整战术，过度的深层假设反思容易导致行动瘫痪（Analysis Paralysis）。
...
> 
> 实证表明，一线教师往往乐于在表层行动上频繁试错（82%），但在触及教育哲学和决策根因的“深层假设反身性审视”上存在明显的认知滞后（55%），印证了实践者反思性缺乏将导致学校陷入“只顾开会尝试、不顾因果根因”的组织病理。[[Argument_Brown_Greany_2018_LPS\|(Brown & Greany, 2018, pp. 130–131)]]
...
> 4. **撰写呈现阶段：第一人称叙述与审计链留存** 采用第一人称和透明修辞呈现研究发现，解构权威[[Objectivism\|客观主义]]外衣，并将全部反思手记纳入[[Audit Trail\|审计追踪]]以供外部独立查验。
