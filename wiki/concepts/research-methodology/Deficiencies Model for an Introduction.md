...
在确立研究问题之后，讨论已有[[Document|文献]]中涉及该问题的先前研究。这一部分不是完整的[[Literature Review|文献综述]]——完整的文献综述出现在研究计划的后面部分。引言中的文献综述应该总结大的研究群组，而非逐一详述个别研究。研究者可以反思自己的[[Literature Map|文献地图]]，查看地图顶部的宽泛类别，这些类别就代表了需要总结的大研究群组。
...
- **对[[Praxis|实践]]的意义** 说明研究如何帮助实践者改善工作方式
...
该示例对应缺陷模型的四部分结构：第一部分提供统计证据确立问题的严重性——这是[[Narrative Hook|叙事钩子]]（[[Narrative Hook]]），以"500 万儿童过早死亡"创造读者兴趣；第二部分用四个主题总结已有研究（吸烟起始、预防、戒烟、社会情境），体现了在引言中总结大研究群组而非单个研究的写法；第三部分指出现有文献的研究方法缺口——缺乏质性视角、缺乏学生作为协同研究者、缺乏多元学校情境的比较；第四部分分别向研究者（隔离变量、发展模型）、[[Praxis|实践]]者（行政人员和教师规划干预）和政策制定者（学校官员协助戒烟项目）三类受众说明研究的意义。
