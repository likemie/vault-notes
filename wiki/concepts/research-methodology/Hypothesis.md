---
title: Hypothesis
aliases: [假设, 研究假设, hypotheses, research hypothesis]
...
> [!feature] 齐梅 (2015, Ch.2) 提出的假设特点
> - **有确切的理由** 基于某种理论或事实依据的假设才是有价值的假设
> - **直接说明变量之间的关系** 假设应该直接说明变量之间的关系，而不是模棱两可的陈述
...
齐梅 (2015, Ch.2) 按研究假设的性质和复杂程度，将其分为三个阶段递进的类型：
