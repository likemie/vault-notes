...
> - **不替代置信区间** 仅报告 p 值而不报告[[Confidence Interval|置信区间]]或[[Standard Error|标准误]]，无法判断估计的稳定性。

### 与效应量的数学关系

Fitz-Gibbon（1985）在元分析发展早期即主张以效应量替代统计显著性作为评估研究的主要指标，将统计显著性重新定位为"内部效度众多可能威胁中的一个"（[[Argument_Cohen_Manion_Morrison_2011_Routledge_Ch17|Cohen et al., 2011, Ch17, pp.339–340]]）。
