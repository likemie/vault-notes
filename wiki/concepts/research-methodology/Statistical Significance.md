...
> - **t 值与[[Sample Size Determination|样本量]]**：在[[Effect Size|效应量]] d 已知时，若观测数为 n，可构造 `t=d√n`；样本量越大，同样 d 值对应的 t 值越大，也越容易达到统计显著。
> - **p 值** p 值表示在零假设成立时获得当前或更极端 t 值的概率。研究报告常把 p 值作为统计分析结果呈现的核心。
