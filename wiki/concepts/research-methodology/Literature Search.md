...
**按公开性划分**：正式文献指正式出版的专著、论文、期刊、教科书等，由政府或出版社遵循出版物管理程序向国家新闻出版管理机构登记取得许可。非正式文献指未正式出版的各种论著、研究报告、统计资料，以及私人通信、日记、笔记、手稿等；硕博士论文因未正式出版也属于此类。研究者应以正式出版的文献为主，非正式文献因取得不易且难以判断真伪，尽量少引用。

**按加工程度分**：一般性参考资料包括索引（indexes）和摘要（abstracts），列出论文的作者、题目、出版地点等；初级文献（第一手资料）是研究者将研究结果直接提出发表的出版物，大部分来自期刊或集刊；次级文献（第二手资料）是对初级资料加以分析、比较和整理后提出的综合资料，如教材、教育大辞典、研究述评和教育年鉴。进行文献检索时最好直接参考第一手资料（齐梅, 2015, Ch.1）。
...
> - **绵延法（Citation Tracking）** 从研究问题所属领域的重要文献着手，尽量搜集引用此篇文献的所有文献。如通过社会科学引注索引（SSCI）或其他索引搜集。
...
> - **关注已有研究在方法运用方面的不足** 例如研究过程中某些变量是否得到适当控制，若文献中的研究方法需要修正，则为研究者提供了值得进一步探讨的问题。
