...
**按加工程度分**：一般性参考资料包括索引（indexes）和摘要（abstracts），列出论文的作者、题目、出版地点等；初级文献（第一手资料）是研究者将研究结果直接提出发表的出版物，大部分来自期刊或集刊；次级文献（第二手资料）是对初级资料加以分析、比较和整理后提出的综合资料，如教材、教育大辞典、研究述评和教育年鉴。进行文献检索时最好直接参考第一手资料（[[Argument_QiMei_2015_EducationalResearchMethods|齐梅, 2015]], Ch.1）。
