...
> | 分析角色 | 从[[Axial Coding\|主轴编码]]通往[[Selective Coding\|选择性编码]]的认知桥梁 | 理论模型的最终核心轴心与解释枢纽 | 数据初筛与初步归纳的描述性汇总 |
> | 时序与情境 | 高度保留生活史时序、行动脉络与情境细节 | 剥离具体细节以达成高度概括的理论建构 | 易割裂文本连续性与前后[[Causality\|因果关系]] |
...
按[[Qualitative Research|质性研究]]的应用场景，故事线的分析运作划分为[[Descriptive Analysis|描述性分析]]的多层级叙事与[[Grounded Theory|扎根理论]]的选择性迭代规程两大维度：
