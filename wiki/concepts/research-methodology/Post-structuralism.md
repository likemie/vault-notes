...
> - **数据即文本即话语（data can be regarded as texts, as discourses）**在相关取向下，数据（如[[Dialogue in Education|对话]]、观察）甚至[[Artefact|人工制品]]（Burman and Parker, 1993）可被视为文本（texts），视为通过话语（discourses）建构和表演的话语，对不同的意义和解释开放（Francis, 2010, p. 327）
...
后结构主义通过知识–权力的关系与[[Critical Theory|批判理论]]相连，但[[Jürgen Habermas|哈贝马斯]]（Habermas, 1987）反对批判理论与[[Postmodernism|后现代主义]]或后结构主义的亲缘性（[[Argument_Cohen_Manion_Morrison_2011_Routledge|Cohen et al., 2011]], Ch. 1）。
