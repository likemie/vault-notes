---
summary: "回溯推测（Retrodiction，亦称历史溯因）是指在地质学、古生物学、天体物理学等历史科学（Historical Sciences）中，基于当下留存的痕迹与多重独立收敛证据链，反向推断与重构过去发生的不可重复事件的认识论推理策略。与经典物理和化学以受控实验向前“预测”（Prediction）未来状态不同，回溯推测强调在宏大时空尺度上对外推系统施加歧义性约束，是破除单一实验科学方法神话的关键概念。"
type: concept
...
> - **用途** 确立历史科学独特的认识论合法性，破除将“受控实验预测”视为唯一科学检验标准的机械主义观念。
...
> | **时间指向** | 从当下已知结果反推过去未知的初始条件与过程 | 从当前已知初始条件推导未来尚未发生的状态 |
> | **研究对象** | 独特、不可逆、不可重复的大尺度历史事件 | 可在实验室中反复操纵、隔离[[Variable\|变量]]的受控系统 |
> | **检验机制** | 寻找地层化石或遗留痕迹的“多重证据收敛” | 设定对照实验检验因果假说与定量测量值是否吻合 |
> | **典型案例** | 依据洋底地磁倒转条带反推大洋中脊扩张历史 | 依据牛顿力学方程精确计算日食发生的准确时刻 |
...
> - **时空尺度整合** 
>   将微观矿物晶体结构（如锆石微区测年）与大陆板块宏观漂移等宏大时空尺度进行多层级因果嵌套。
> - **系统时间外推** 
>   基于均变论与灾变论的辩证统合，将当前正在发生的自然地质作用速率向数亿年地质历史进行理性外推。
...
### 命题一　回溯推测具有与实验预测同等坚固的认识论客观性与检验力

> [!concept-lens] 历史科学哲学地位维度
...
> [!contrast-table] 回溯推测核心命题归纳
> | 命题类型 | 核心指向 | 适用情境 | 代表学者 |
> |---|---|---|---|
> | **方法论辩护命题** | 证据收敛性、歧义性约束与时空尺度外推 | 地质学调查、古气候重构、演化古生物学 | Ault (1998); Cleland (2002) |
> | **课程认识论命题** | 解构普适实验方法教条，弘扬学科[[Heterogeneity\|异质性]] | 中小学地球与空间科学课程、综合科学教学 | [[Argument_Kelly_Licona_2018_EpistemicPractices\|Kelly & Licona (2018)]] |
