...
- **2021** — Slavin, Cheung & Zhuang 在 *ECNU Review of Education* 发表首个中美英证据本位改革国际比较研究，系统记录中国教育实证研究的制度化发展（ECNU 论坛 2015-2019、2017 华东师范[[The Great Learning|大学]]宣言、[[Best Evidence in Brief|BEiB]] 中文网络），首次翻译并呈现中国学者对证据本位研究的五类内部质疑（定义之争、统计主义、价值不可量化、数据困境、实证≠定量），将四项核心活动框架应用于中国情境分析（Slavin et al., 2021）
...
以"教育实证研究"为关键词检索中国最大期刊数据库 CNKI，结果从 1990 年 2 篇增长至 2018 年 477 篇，总量约 5,000 篇（Slavin et al., 2021, p.11）。然而证据本位研究占总研究产出的比例仍然很低：Wang (2017) 分析五种 CSSCI 期刊（*高等教育研究*、*清华[[The Great Learning|大学]]教育研究*、*中国高教研究*、*北京大学教育评论*、*复旦教育论坛*）2012-2016 年出版物，发现证据本位研究仅占约 20%（范围 15.6%-29.1%）。袁振国（2017）估计总体不到 10%——"但这些比例可能是准确的，美英也可能类似，因为证据本位研究成本高昂"（Slavin et al., 2021, p.13-14）。
