...
> [!case] 脚大与手大的虚假相关
> 一个人的手可能因脚大而被预测为大——但手大并不导致脚大。共同原因在于对二者的遗传倾向。这体现了筛选隔离的基本逻辑：表面相关掩盖了一个共同的（遗传）[[Causality|因果]]来源（[[Argument_Cohen_Manion_Morrison_2011_Routledge_Ch04|Cohen et al., 2011, p. 60]]）。
