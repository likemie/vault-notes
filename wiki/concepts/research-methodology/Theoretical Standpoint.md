...
> [!tip]
> Rossman & Rallis (2012) 概括了质性探究中批判视角和后现代视角的核心主张：（1）研究本质涉及权力问题；（2）研究报告并非透明，而是由具有种族、性别、阶级和政治取向的个体所撰写；（3）种族、阶级和性别（以及性取向、身体状况、第一语言等）对理解经验至关重要；（4）历史上，传统研究压制了受压迫和边缘化群体的声音（p.91）。
