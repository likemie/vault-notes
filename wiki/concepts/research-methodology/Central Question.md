...
> [!info]
> 质性研究的核心问题（central question）是询问核心现象的主要开放性问题，通过访谈参与者、观察环境或审阅文件来回答（Creswell & Creswell, 2022, p.146）。它是质性研究中最宽泛的问题，旨在鼓励参与者表达自己的观点。
...
核心问题通常为一至两个，以"什么"（what）或"如何"（how）开头传达开放和涌现的设计。以"为什么"（why）开头暗示因果解释思维，属于量化研究的范式，可能限制参与者的回答而非开放它们（Creswell & Creswell, 2022, Ch7）。
...
> [!info]
> 质性子问题（qualitative sub-questions）是将核心问题的核心现象进一步细分收窄的问题，通常五至七个，成为数据收集（如访谈）中的具体问题（Creswell & Creswell, 2022, p.146）。

Miles & Huberman (1994) 建议研究者总共编写不超过 12 个质性研究问题（核心问题 + 子问题）。子问题随后成为访谈协议或指南中的具体问题，访谈通常以破冰问题开始，以总结性问题结束（Asmussen & Creswell, 1995）（Creswell & Creswell, 2022, Ch7）。

## 核心要素

> [!abstract]
> 撰写质性核心问题的规则（Creswell & Creswell, 2022, Ch7）：
>
> 1. **以一个或两个核心问题为主**：提出最宽泛的问题——"在我的研究中，我能提出的最宽泛问题是什么？"
> 2. **辅以五至七个子问题**：将核心问题收窄为数据收集用的具体问题
> 3. **关联特定的质性路径**：民族志、现象学、扎根理论、案例研究的问题形式各有不同
> 4. **以 what 或 how 开头**：传达开放和涌现的设计
> 5. **聚焦单一核心现象或概念**：深入研究一个焦点
> 6. **使用探索性动词**：report/reflect（叙事研究）、describe the essence（现象学）、discover/generate（扎根理论）、seek to understand（民族志）、explore（案例研究）、describe the themes（描述性分析）
> 7. **预计问题会演变**：质性研究中的问题处于持续审查和重写的状态
...
- **[[Ethnography|民族志]]**：Spradley (1980) 提出了民族志问题的分类，包括文化共享群体的微型导览、经历、本土语言使用、与其他文化群体的对比以及数据准确性验证。批判民族志的研究问题可建立在已有文献体系之上（Thomas, 1993）。
...
- **[[Case Study|案例研究]]**：问题可包括对案例的描述以及研究案例中涌现的主题
...
> [!example] 民族志核心问题范例
> Mac an Ghaill & Haywood (2015) 研究了一组英国出生的工薪阶层巴基斯坦和孟加拉裔年轻男性在三年间的文化状况变化。虽未明确构建研究问题，Creswell & Creswell 建议的核心问题为：
>
...
>
> "How do participants engage in an intergenerational playgroup (IGP) within the context of a residential aged care facility (RACF)?"（Creswell & Creswell, 2022, Ch7）
>
> 分析中涌现的主题包括相互学习（learning from each other）、欣赏当下体验（appreciating experience in the moment）和通过游戏建立连接（connecting through play）。

> [!example] 质性子问题范例
> Creswell & Bàez (2020) 以校园多样性氛围为例展示了子问题如何细分核心问题（Creswell & Creswell, 2022, Ch7）：
>
> 核心问题：What is the campus climate toward diversity?
>
> 子问题：
> - What are students' attitudes on campus toward forming diverse social groups?
