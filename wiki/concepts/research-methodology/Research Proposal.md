...
> [!feature] 课题的三种功能
> - **反映研究的价值** 课题是[[Praxis|实践]]向理论发展的必经之路。它不仅反映了现有理论推动社会发展的程度，也反映了向未知研究领域的探索。爱因斯坦指出，提出一个问题比解决一个问题更重要。
...
> [!proc] 选定课题五步法
> 1. **[[Survey Research|调查研究]]，提出问题** 通过查阅资料（考察、论证所选课题是否有研究价值）、现场调查（到教学[[Praxis|实践]]现场发现实际问题）和专家咨询（征询专家学者的意见，从中受到启发）三种方式，了解前人研究情况和发展趋势。
