...
> 加芬克尔（Harold Garfinkel, 1967）在[[Ethnomethodology|俗民方法学]]中提出的核心概念：行动和陈述与产生它们的社会语境相关联，其意义为参与者所共享但不一定被明确陈述。同样的词或行为，在不同语境中可以意味着完全不同的事——参与者通常不需要明确说出这些语境含义，因为它们已经是共享的隐性知识（[[Argument_Cohen_Manion_Morrison_2011_Routledge|Cohen et al., 2011]], Ch. 1）。
