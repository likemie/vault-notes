...
> [!contrast-table] 索引表达式 vs 客观（脱域）表达式 vs 形式逻辑命题
> | 维度 | 索引表达式（Indexical Expressions） | 客观／脱域表达式（Objective Expressions） | 形式逻辑命题（Formal Logical Propositions） |
> |---|---|---|---|
> | **语境依赖度** | 绝对依赖产生它的微观时空与互动历史 | 刻意剥离具体情境，追求跨场合通用 | 完全独立于时空、心理与物理经验世界 |
> | **典型范例** | “草莓，草莓！”（课堂师生共享隐喻） | “该学生在作文讲评中发起了非任务性发言” | “若 P 则 Q；非 Q 则非 P” |
> | **意义稳定性** | 换一个班级或场合，表达立即失去意义或被曲解 | 在标准化同行交流中保持基本共识 | 具有绝对、恒常且必然的真值 |
> | **社会功能** | 确认群体归属、分享默契、维系微观秩序 | 形成学术报告、标准化档案与行政记录 | 建立数理演绎模型与公理体系 |
...
> ```mermaid
> flowchart LR
>     A["微观互动历史与共享生活世界"] --> D["情境索引性"]
>     B["特定物理时空与在场关系"] --> D
>     C["行动者的主体间默契与修辞意向"] --> D
>     D --> E["言语与行动的本土意义理解"]
>     D -->|形式化行为编码 (如 FIAC)| F["意义剥离与误读"]
> ```
...
> [!claim] Garfinkel, H.
> **日常生活的惊人索引性** 加芬克尔强调，日常生活的理性并非形式逻辑推演，而是行动者在具体情境中展示的实践成就；一切日常陈述均带有惊人的索引性，任何试图脱离具体情境去追问“一句话到底是什么意思”的努力，都是对社会现实本性的背离。[[Argument_Cohen_Manion_Morrison_2011_Routledge_Ch01|(Cohen et al., 2011, Ch. 1, p. 19)]]

> [!claim] Bar-Hillel, Y.
> **索引表达式的普遍性** 巴尔-希勒尔在语言哲学中指出，自然语言中绝大多数陈述都属于索引表达式；试图用非索引性的理想语言完全替代日常语言，在社会实践中是注定无法达成的乌托邦。

---

### 命题二　索引性的顺畅运作依托于行动者共享的常识知识库与未言明默契

> [!concept-lens] 认知与微观秩序维度
