---
title: Kitwood's Paradox
aliases:
  - Kitwood 矛盾
  - Kitwood 悖论
  - 信度效度权衡
  - reliability-validity tradeoff in interviews
...
> [!concept-lens] 概念透镜
> - **含义** Kitwood 矛盾揭示了结构化访谈中一个方法论悖论：你越是试图通过标准化程序来保障信度（每个受访者获得相同的问题、相同的措辞、相同的顺序），你就越是在消除访谈中使人们愿意**真实地、深入地、自发地**披露自己的那个独特元素——人际信任和对话的自然流动。
> - **用途** 这一概念提醒研究者：访谈设计中的信度-效度权衡不是可被消除的"方法论缺陷"，而是一种需要被**有意识地管理**的内在张力。
> - **边界** Kitwood 矛盾不是信度-效度逻辑关系（信度是效度的必要非[[Necessary and Sufficient Conditions|充分条件]]）的简单重述——它是访谈这一特定方法中两者的**操作性冲突**。在其他方法（如问卷、测验）中信度和效度可能协同增强，但在访谈中它们处于根本的张力之中。

---

## 核心要素

> [!claim] 矛盾的根源：访谈效度依赖人际性
...
> [!tension] 矛盾的普适性争议
> - **Kitwood 立场** 访谈中[[Reliability|信度]]与效度的矛盾是**内在的**和**不可消除的**——它源于访谈作为人际方法的本质特征。任何试图通过标准化完全解决这一矛盾的[[Conatus|努力]]都会将访谈变成一种劣质的问卷。
