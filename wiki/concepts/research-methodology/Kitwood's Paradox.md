...
> - **边界** Kitwood 矛盾不是信度-效度逻辑关系（信度是效度的必要非[[Necessary and Sufficient Conditions|充分条件]]）的简单重述——它是访谈这一特定方法中两者的**操作性冲突**。在其他方法（如[[Questionnaire|问卷]]、测验）中信度和效度可能协同增强，但在访谈中它们处于根本的张力之中。
