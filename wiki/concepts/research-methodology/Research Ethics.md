...
- **选择对参与者有益的研究问题**：通过需求评估或非正式对话，确保研究问题不仅对研究者有意义，对参与者也有价值（Punch, 2014）
- **披露研究目的**：向参与者如实说明研究目的；如果参与者被告知的与研究者的真实目的不一致，即构成欺骗
- **不强求签署同意书**：详见 [[Informed Consent|知情同意]]
...
- **使用无偏见和非歧视性语言**：在报告结果时使用精确描述——如年龄用具体数值或范围、残障用具体状况名称、性别用带修饰词的具体类别、种族用具体来源地区、性取向用具体名称、社会经济地位用具体指标而非宽泛标签（APA, 2020）
...
1. **囚犯越狱信息**：接受访谈的囚犯告诉研究者当晚监狱可能发生越狱。研究者的伦理守则（因学校和监狱而异）通常保护参与者和相关人员的隐私——这需要研究者在事前就预见此类情境并依据所在机构的伦理守则制定应对预案。

2. **团队成员抄袭**：团队中一名研究人员从另一项研究中复制了句子并纳入最终书面报告。抄袭不仅是复制大量材料的问题——改写他人作品也需要注明出处（APA, 2020）。使用引号和页码标注原文、对改写内容加注引用，是对他人工作的基本尊重。
