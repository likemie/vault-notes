...
> - **用途** 帮助研究者在设计访谈方案时预见和规划自身特征可能带来的偏差，并通过访谈者培训、匹配策略和[[Reflexivity|反思性]][[Praxis|实践]]来减轻负面影响。
...
> | 如何操作访谈中的权力与控制 | 六种情境需区分：(a)访谈者地位高于、低于或等于受访者；(b)访谈者想要信息但无权命令提供；(c)有权者将访谈作为冗长自我展示的机会；(d)访谈结束后访谈者掌握可能使受访者感到脆弱的敏感信息；(e)参与者提供可能违背自身利益的信息；(f)访谈风格——[[Dialogue in Education\|对话]]式、正式、高度结构化或高度指令式。 |
