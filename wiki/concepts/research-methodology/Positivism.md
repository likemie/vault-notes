...
> [!def] 实证主义（Positivism）
> 一种哲学立场，主张所有真正的知识都基于感官经验（sense experience），只能通过观察和实验来推进。它摒弃形而上学的思辨，将自然科学视为人类知识的[[Paradigm|范式]]（Duncan, 1968）（Cohen et al., 2011, Ch. 1）。

## 起源

实证主义在西方思想史上反复出现，但其作为明确哲学立场的历史与19世纪法国哲学家孔德（[[Auguste Comte]]）紧密相连。孔德是第一位将"实证主义"一词用于哲学立场的思想家，并由此催生了作为独立学科的社会学（Beck, 1979）。他的实证主义转向观察和理性作为理解行为的途径——社会现象可以像自然现象一样被研究，产生可通过经验考察的法则和理论（Oldroyd, 1986）（Cohen et al., 2011, Ch. 1）。

## 核心主张

Giddens（1975）识别出实证主义包含两个相互关联的假设（Cohen et al., 2011, Ch. 1）：
...
实证主义指导下的科学工作基于四项隐含假设（Cohen et al., 2011, Ch. 1）：
...
Mouly（1978）将[[Scientific Method|经验科学]]进程分为五个阶段：经验（experience）→ 分类（classification）→ 量化（quantification）→ 发现关系（discovery of relationships）→ 逐步逼近真理（approximation to the truth）（Cohen et al., 2011, Ch. 1）。
...
实证主义在自然科学领域取得巨大成功，但在应用于人类行为时面临根本性挑战——人类行为的极度复杂性和社会现象的难以捉摸与自然世界的秩序和规律性形成鲜明对比（Cohen et al., 2011, Ch. 1）。
