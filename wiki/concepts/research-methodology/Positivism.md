...
> [!def] 实证主义（Positivism）
> 一种哲学立场，主张所有真正的知识都基于感官经验（sense experience），只能通过观察和实验来推进。它摒弃形而上学的思辨，将自然科学视为人类知识的[[Paradigm|范式]]（Duncan, 1968）（[[Argument_Cohen_Manion_Morrison_2011_Routledge|Cohen et al., 2011]], Ch. 1）。

## 起源

实证主义在西方思想史上反复出现，但其作为明确哲学立场的历史与19世纪法国哲学家孔德（[[Auguste Comte]]）紧密相连。孔德是第一位将"实证主义"一词用于哲学立场的思想家，并由此催生了作为独立学科的社会学（Beck, 1979）。他的实证主义转向观察和理性作为理解行为的途径——社会现象可以像自然现象一样被研究，产生可通过经验考察的法则和理论（Oldroyd, 1986）（[[Argument_Cohen_Manion_Morrison_2011_Routledge|Cohen et al., 2011]], Ch. 1）。
...
Mouly（1978）将[[Scientific Method|经验科学]]进程分为五个阶段：经验（experience）→ 分类（classification）→ 量化（quantification）→ 发现关系（discovery of relationships）→ 逐步逼近真理（approximation to the truth）（[[Argument_Cohen_Manion_Morrison_2011_Routledge|Cohen et al., 2011]], Ch. 1）。
...
>
> **假设**被 Kerlinger（1970）定义为[[Variable|变量]]之间关系的推测性陈述。好假设的两条标准：陈述变量之间的关系，且蕴含明确的检验含义。Medawar（1972, p. 22）将假设描述为"一次思辨的冒险，一种对什么可能是真的的想象性预想"。
...
> - **内部批评** 实证主义未能考虑人类的自我解释能力（Giddens, 1976）；将人视为被动的、被决定的，忽略了意图和自由（Chomsky, 1959）；实验室发现往往琐碎平庸，对[[Praxis|实践]]者几乎没有实际意义
