...
> [!warning] 争议与批评
> Bainbridge et al.（2022）认为 justified warrants 与 Van Leeuwen（2007）的 legitimation 理论 相互支撑：证据若要在政策制定中被接受，需要在接收群体的结构、过程和道德假设中获得合法化（legitimation）。但这同时也意味着，即使一项研究提供了良好的正当化担保，如果其结论与既有权力结构的价值假设不一致，仍可能被排斥([[Argument_Bainbridge_2022_ROE|Bainbridge et al., 2022, p.9]])。
>
