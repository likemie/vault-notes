...
> [!info] 定义
> Justified warrants（正当化担保）是 Malone & Hogan（2020）基于 [[John Dewey|Dewey]] 知识论发展的概念，主张研究应提供经得起批评的、附有保留条件的担保性断言（warranted assertions），而非确定性的"证明"。与追求可复制性和确定性的线性证据观不同，该概念将研究证据视为开放的、可修正的可能性陈述。
>
...
> [!example] 概念辨析
> - vs 传统证据观中的"证明"（proof）：传统[[Evidence-Based Education|证据本位教育]]主张追求可复制、可推广的确定性结论；justified warrants 则强调所有研究类型的证据同等值得考虑，关键是断言与其现实应用之间的逻辑推进是否合理（Bainbridge et al., 2022, p.6–7）
> - 与 "anything goes" 的区别：正当化担保不意味着"什么都可以"——学界有责任确保研究断言被审慎地持有，避免误导性的确定性（Bainbridge et al., 2022, p.6）
>

## 核心要素

> [![[Abstract]]] 核心要素
> - **暂定性（provisionality）**：担保而非确定，对批评和意外发现保持开放（Bainbridge et al., 2022, p.6–7）
> - **逻辑推进（logical progression）**：研究的质量不仅取决于"如何做的"，更取决于从证据到担保性断言的逻辑推进是否合理，以及是否附有防止不切实际主张的保留条件（Bainbridge et al., 2022, p.7）
> - **多元方法平等**：所有研究类型（量化、质性、混合）的证据均被视为同等有效且值得政策制定者考虑（Bainbridge et al., 2022, p.6）
> - **研究者责任**：Gorard（2002）指出许多关于研究证据及其适用性的混淆源于研究者做出了糟糕且不正当的担保——过度强调或混同了潜在的结论（Bainbridge et al., 2022, p.7）
> - **打破学科与党派壁垒**：正当化担保的优势在于允许学者或政治家走出狭隘的研究壁垒和党派偏见（Bainbridge et al., 2022, p.7）
>

## 理论基础

> [!info] 理论基础
> - [[John Dewey|Dewey]] 的交易认识论（[[Transactional Epistemology]]）——实验产生的知识是关于过去行动与后果关系的记录，提供可能性而非确定性。Malone & Hogan（2020）对此进行了详细的认识论和本体论阐述（Bainbridge et al., 2022, p.6）
>
