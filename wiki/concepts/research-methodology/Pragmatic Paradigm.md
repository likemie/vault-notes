...
> [!warning] 实用主义不是无原则的折中
> 实用主义不是一种散漫的"怎么都行"（anything goes）的取向。它有自己的严格标准：研究必须回答[[Research Question|研究问题]]，并且"交付"（deliver）研究提出的问题的有用答案（Denscombe, 2008）。方法论多元主义（methodological pluralism）——而非对单一[[Paradigm|范式]]的忠诚——是当务之急（Johnson et al., 2007: 116），因为这使单一方法中的错误能够被识别和纠正。
