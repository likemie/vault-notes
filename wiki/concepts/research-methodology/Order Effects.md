...
Krosnick和Alwin（1987）发现了"**首因效应**"：受访者倾向于选择列表中较早出现的选项，而非较晚出现的选项。这尤其影响多选问题中的选项排列——将某个选项放在列表开头会显著增加其被选择的概率。Dillman等人（2003: 6）报告了网球与足球的兴趣研究：当网球选项在足球选项之前呈现时，网球被评为比足球更不令人兴奋；当顺序反转后，网球被评为更令人兴奋（p. 123）。
