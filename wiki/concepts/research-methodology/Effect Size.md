...
> [!info] 最小可检测效应量
> [[Argument_Pampaka_2016_IJRME|Pampaka et al. (2016, p.233)]]介绍了与效应量密切相关的另一个概念：在给定统计功效下，研究设计能够检测到的最小效应量。最小可检测效应量是研究精度的度量（[[Argument_Pampaka_2016_IJRME|Pampaka et al., 2016, p.233]]）：
>
