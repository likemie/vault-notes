...
**[[Class Size|班级规模]]的案例**：VL 中班级规模效应量为正（小班 > 大班，d≈0.2）。如果反转比较方向——比较[[The Great Learning|大学]]校相对小学校——效应量就变为负数。Hattie 的解释（"班级规模没有显著影响"）将完全改变，因为负面效应在 VL 框架中被视为"有害"（Bergeron & Rivard, 2017, p.241）。
