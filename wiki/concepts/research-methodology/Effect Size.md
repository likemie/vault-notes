...
>
> [[Lars Qvortrup]]（2015）从支持者立场强调效应量的"相对效果"功能：即使不同研究没有共享同一个学习结果定义，研究者仍可比较干预组与控制组之间或干预前后之间的相对变化([[Argument_Qvortrup_2015_Paideia|Qvortrup, 2015, p.27]])。但这一比较也会把学习结果抽象化：效应量能说明"有多大相对效果"，却不直接说明效果发生在表层知识、深层理解、社会能力还是概念性学习上([[Argument_Qvortrup_2015_Paideia|Qvortrup, 2015, p.27；参见 [[Dynamic Knowledge & Learning Model]]]])。
>
...
> [!warning] [[Sample Size Determination|样本量]]越大，效应量越小
