...
> - **边界** 效应量不直接说明效果的实质教育意义——同一个 d 值可能对应表层知识记忆或深层概念理解（[[Argument_Qvortrup_2015_Paideia|Qvortrup, 2015, p.27]]）。[[Adrian Simpson]]（2017, 2018, 2019）进一步论证效应量实际测量的是试验清晰度（experimental clarity）而非干预有效性，详见 [[Critique of Effect Size]]。
