...
> [!example]
> d=0.40 更像体检报告里的参考范围，而不是红绿灯。它能提醒教师“这里值得[[Probes|追问]]”，但不能替代[[Professional Judgment|专业判断]]。若一个中学阶段干预达到 d=0.30，它可能低于 VL 总平均，却高于某些中学同类干预的常见水平；反之，一个 d=0.45 的项目若只测量短期记忆，也不能自动说明它促进了[[Surface and Deep Learning|深层学习]]。
