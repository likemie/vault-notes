...
> [!abstract]
> 操纵检查的核心逻辑（[[Argument_Creswell_2022_SAGE|Creswell & Creswell, 2022]], Ch8）：
...
> - 若两组在操纵检查上无显著差异，说明操纵未成功——后续对因变量的任何组间差异都无法归因于自尊操纵（[[Argument_Creswell_2022_SAGE|Creswell & Creswell, 2022]], Ch8）。
...
> - 因此操纵检查通常在时间上靠近操纵但尽可能不影响主要结果测量的位置施测。有些研究者将操纵检查放在所有因变量测量之后，以避免干扰，但这又可能引入操纵效应随时间衰减的问题（[[Argument_Creswell_2022_SAGE|Creswell & Creswell, 2022]], Ch8）。
