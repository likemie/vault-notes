...
> | **量程截断风险** | 分布良好，区分度充分 | **高发[[Floor and Ceiling Effects\|天花板效应]]与地板效应** | 针对特定干预难度定制，缺乏全量程区分力 |
...
[[Quantitative Research|量化研究]]经典方法论（Stevens, 1946; Kerlinger, 1979; Keppel, 1991; Thorndike, 1997; Thompson, 2006; Creswell & Guetterman, 2018; [[Argument_Creswell_2022_SAGE|Creswell & Creswell, 2022, p. 56]]）将测量尺度系统划分为分类（Categorical）与连续（Continuous）两大维度、四种层级：
...
> | **等距尺度（Interval）** | 等距单位，无绝对零点 | 标准化考试分数（Z 分）、量表合成总分 | 均值、标准差、Pearson 相关、[[Analysis of Variance\|ANOVA]]、[[Ordinary Least Squares\|OLS]] 回归 | 遭遇[[Floor and Ceiling Effects\|天花板与地板效应]]量程截断 |
...
> | [[Operationalization]] | 操作过程 | 将[[Construct\|理论构念]]映射到特定测量尺度的具体研究方法学步骤。 |
> | [[Construct]] | 测量客体 | 测量尺度旨在准确量化和呈现的潜在理论实体。 |
> | [[Quantitative Research]] | [[Paradigm\|研究范式]] | 测量尺度作为量化数据生成与统计分析的基石技术载体。 |
> | [[SPECTRUM]] | 审查数据库 | [[Education Endowment Foundation\|EEF]] 建立的评估与准入非认知测量尺度标准化的国家级工具库。 |
> | [[Education Endowment Foundation]] | 规约机构 | 制定测验选用指南、强制测量尺度锚定国家统考的循证中介机构。 |
> | [[National Pupil Database]] | 标杆数据 | 为教育试验提供高[[External Validity\|外部效度]]、连续客观测量尺度的国家普查库。 |
> | [[Floor and Ceiling Effects]] | 测量偏差 | 测量尺度有效量程受限时导致[[Causality\|因果推断]]失真的典型心理计量现象。 |
> | [[Construct Validity]] | 效度准则 | 评估测量尺度是否真正测量了目标理论构念的核心效度维度。 |
> | [[Predictive Validity]] | 效度准则 | 检验测量尺度能否准确预测个体未来长期[[Academic Achievement\|学业表现]]的关键指标。 |
