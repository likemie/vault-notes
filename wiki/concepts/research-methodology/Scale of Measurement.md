...
> [!tip]
> 测量尺度的选择直接影响研究者可使用的统计方法。名义和顺序数据适合非参数检验（如[[Chi-Squared Test|卡方检验]]、Mann-Whitney U 检验）；等距和比率数据适合参数检验（如 t 检验、[[Analysis of Variance|ANOVA]]、回归分析）。量表类型的误判可能导致统计推论的严重错误。
