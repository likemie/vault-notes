...
> [!info]
> 评分者间信度（Inter-Rater Reliability）是[[Quantitative Research|量化研究]]中一种信度形式，指多位独立评判者或专家使用同一工具对相同对象进行评分时，彼此评分之间的一致性程度。它适用于研究设计中涉及多位评判者进行观察评定的情境，而非受试者自填问卷的情境（[[Argument_Creswell_2022_SAGE|Creswell & Creswell, 2022]], Ch8）。

> [!quote]
> "Inter-rater reliability in these studies is an important form of reliability to establish and refers to the degree to which different independent judges agree in their ratings."（[[Argument_Creswell_2022_SAGE|Creswell & Creswell, 2022]], Ch8）

## 核心要素

> [!abstract]
> 评分者间信度的适用情境与评估方法（[[Argument_Creswell_2022_SAGE|Creswell & Creswell, 2022]], Ch8）：
...
> - 评分者间信度的计算需要足够数量的评分者和/或评定对象才能产生稳定的估计值（[[Argument_Creswell_2022_SAGE|Creswell & Creswell, 2022]], Ch8）。
