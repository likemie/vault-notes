...
> [!dimension] 视觉数据的三重维度
> - **图像的生产（production）**
>   图像由特定技术（油画、录像、摄影器材、计算机软件）、特定构图特征（视觉形式、色彩、质感、象征等）与特定社会语境共同生产，制作方式本身携带意义。
> - **图像本身（the image）**
>   图像具有自身的形式与效果，这些属性会影响观看者；图像是"现实呈现"而非"现实复制"，需经解读。
> - **图像的受众（audiences）**
>   受众是图像的基本特征——受众以自身价值观、传记、文化与背景去观看和"阅读"图像，同一图像因此存在多重解读。
