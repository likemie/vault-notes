...
> | 使用建议 | 自填问卷中应多于开放题 | 探索性研究或对可能答案未知时有用（Bailey, 1994, p. 120） |
...
开放题也是生成后续封闭式问题题项的来源——在[[Pilot Testing|预测试]]中使用开放题收集回应类别，随后转化为封闭式题项（p. 114）。Oppenheim（1992, pp. 56–57）建议**句子补全题**作为开放题的有用补充（如"一位有效的教师……"）。
