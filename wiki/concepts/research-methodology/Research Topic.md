...
更复杂的判断，核心标准是**该主题是否对已有研究知识库有贡献**。Creswell & Creswell (2022) 特别强调了一个典型失败场景：研究在各方面都很完备——研究问题清晰、数据收集全面、统计分析精良——但因为没有为已有研究增加任何新东西，得不到导师和委员会的支持。
...
> [!example] 角度选择
> 六种方式各自打开不同的贡献路径：前两种通过更换情境和人群来检验已有理论的边界；第三种通过颠倒[[Hypothesis|假设]]来揭示被忽略的机制；后三种通过方法、呈现或时机的创新来提供新知识。
...
> [!tip] 一页草图
> 在正式进入研究设计之前，将研究问题或议题、核心研究问题、数据收集类型和研究总体意义写成一页草图，征求同事、权威学者、导师和委员会成员的反馈。
