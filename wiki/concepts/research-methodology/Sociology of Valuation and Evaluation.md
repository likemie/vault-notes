...
> [!abstract]
> Schulze-Cleven et al.（2017, pp.798–799）概括了该领域的几项核心发现：
...
- **公平标准的学科差异**：Lamont（2009）的经典研究 How Professors Think 展示了不同学科如何在同行评审中培育出不同的公平标准——人文学科强调阐释的丰富性，自然科学强调方法的严谨性，社会科学寻求两者的平衡。这提示公平不是一套通用标准，而是在具体学科文化中被持续协商的实践。
...
> [!warning]
> - **"评估必要论"的风险**：Schulze-Cleven et al.（2017）指出，评估与赋值社会学在揭示评估工具的负面效应的同时，也面临一个微妙的风险——在分析评估工具如何"成功"制造合法性和信任时，可能隐性地接受评估的必要性。Reitz（本特刊）从功能主义角度论证学术评估对[[Knowledge Capitalism|知识资本主义]]是功能必要的——这一立场与评估社会学内部的批评性立场存在张力（pp.804–805, 809）
> - **理论综合不足**：虽然 Espeland & Sauder（2007）的"排名的履行性与反应性"分析和 Münch 的"学术卓越的社会建构"研究推动了实践理论和后结构主义在评估社会学中的运用，但 Schulze-Cleven et al. 认为"需要更多的理论综合来有效探索学术绩效测量和评估的起源与功能"（p.798）
