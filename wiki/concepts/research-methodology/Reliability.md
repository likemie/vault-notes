...
齐梅 (2015, Ch.5) 将问卷调查研究中的信度分为四种类型，与上述三分法互补：
...
信度是效度的必要条件而非充分条件。信度低则效度不可能高，但信度高时效度却未必高。二者存在一定冲突——提高信度可能降低效度，反之亦然。效度甚至比信度更为重要：测量首先需要有效性，其次才是可信性的问题，没有效度的信度是没有测量意义的（[[Argument_QiMei_2015_EducationalResearchMethods|齐梅, 2015]], Ch.5）。
