...
IRB 审批通常要求研究者提交知情同意书作为审批材料的一部分，但两者是不同的制度环节。知情同意不是一次性签字即告完成——研究者在整个研究过程中持续负有告知义务，如果研究方案发生变化，可能需要重新获得同意（[[Argument_Creswell_2022_SAGE|Creswell & Creswell, 2022]]）。

---

## 核心要素

Diener & Crandall (1978) 的定义涉及四个前提要素（[[Argument_Cohen_Manion_Morrison_2011_Routledge_Ch05|Cohen et al., 2011, pp. 77–79]]）：

> [!feature] 知情同意的四个前提要素
> - **能力（Competence）**
>   负责任的成熟个体在获得相关信息后将做出正确决定。研究者有责任确保不涉及因不成熟或某种形式的心理障碍而无法做出此类决定的个体。
> - **自愿（[[Voluntarism]]）**
...
当研究者无法告知参与者一切信息时，适用合理知情同意策略（US Department of Health, Education and Welfare, 1971）（[[Argument_Cohen_Manion_Morrison_2011_Routledge_Ch05|Cohen et al., 2011, p. 79]]）：
...
> [!tip]- 针对年幼儿童和无法决策的儿童
> - **非常年幼的儿童** 即使他们不理解什么是研究，也应给予某种解释。例如"一个大人会看着他们并和他们一起玩"可能足以提供与儿童理解力一致的知情同意程度。Fine & Sandstrom (1988) 评论："应该尽可能多地告诉儿童，即使他们中的一些人无法理解完整的解释。他们的年龄不应削弱他们的权利"
> - **无法满足能力标准的儿童**（如心理障碍儿童群体）：遵循机构或地方当局指南。在缺乏这些指南的情况下，可通过获得校长作为 in loco parentis 或由家长委托负责提供知情同意的代理人的许可
...
> > 核心问题是：知情同意是否适配质性研究的[[Emergence\|涌现]]性和[[Open-Mindedness|开放性]]特征？反对者认为同意应是持续的协商过程，而非一次性签署。
> >
...
> - [[Sensitive Research]] — 敏感研究中的知情同意与隐蔽研究的正当性争论
...
> [!warning] 匿名化与许可
> 匿名与保密在视觉图像中可能极为棘手，因为图像的全部意义就在于人物、地点或机构本身，无法伪装（Prosser et al., 2008, p. 15）。匿名化的方式包括模糊识别特征、使用化名、只拍摄人物背面，或使用背光阴影的照明；Clark（2006）提供了详细的匿名化指南。
>
> 许可不仅涉及拍摄行为本身（如公共场所拍摄），还涉及复制许可（来自个人与机构）、说明图像将被如何使用，以及是否对图像作某种修改。另需注意，有些参与者可能故意希望被识别（Prosser et al., 2008, p. 11）。
