...
> [!concept-lens] 概念透镜
> - **含义** 知情同意既是法律要求（美国 [[Common Rule 2018]] 对 [[Institutional Review Board|IRB]] 审批的规定），也是研究伦理的基石。参与是自愿的，研究者不得强迫参与者签署同意书。
> - **用途** 保护参与者的自主决定权，确保他们对[[Purpose Statement|研究目的]]、程序、风险和权利有充分了解后再决定是否参与。在 [[University-Industry Collaboration|产学合作]]中，因 Common Rule 的大学-企业适用不对称，知情同意成为协议谈判中的不可协商前提。
> - **边界** 知情同意不等于一次性签字即告完成——在质性、[[Emergence|涌现]]性研究中必须持续协商。知情同意也不等于 [[Institutional Review Board|IRB]] 审批，后者是机构层面的审查机制，前者是研究者与个体参与者之间的程序。
