...
> [!def] 核心定义
> 评估研究（evaluation research / evaluative research）是应用社会科学的工具和方法，为回答项目或政策的有效性和效果问题提供证据的研究分支。它在本质上是**应用研究（applied research）**，即在理论已被给定的前提下使用研究方法，而非对理论本身进行审问或检验（Plewis & Mason, 2005, p. 192）。
...
> [!feature] 评估研究的构成特征
> - **给定问题** 评估研究回答的是已被预先设定的特定问题，而非研究者自己提出的问题（Morrison, 1993, p. 2）。
...
> 过去二十余年，"分类资助"（categorical funding）——即政府或赞助方预先设定[[Research Topic|研究主题]]和边界、研究者通过竞标承接——大幅增长，推动了教育研究中评估研究占比的上升。Burgess（1993, p. 1）指出："研究者不过是合同工……教育研究必须与政策相关。"这标志着从研究者自主设定研究主题向赞助方指定研究焦点的系统性转变。
...
> 评估研究为决策提供证据的力量是有限的。如果信息不支持当时主导的政治议程，决策者总能找到理由忽视或高度选择性地使用评估结果（James, 1993, p. 135）。评估研究的实际影响力取决于其结论与决策者政治议程的契合度（Thomas, 1991; Cook, 1991）。
...
> [!case] 应用案例索引
> - 英国 TVEI（技术与职业教育倡议）项目评估：政策决定在评估报告完成之前就已公布，展示评估研究与政策制定之间的"非理性"关系（Norris, 1990, p. 135）。
