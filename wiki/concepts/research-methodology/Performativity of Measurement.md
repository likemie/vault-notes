...
> - 使世界变得可计算需要首先标准化多样化世界——使用分类机制、数学公式、选择和删除——在此过程中世界已被改变(Scott, 1998; [[Argument_Gorur_2014_Discourse|Gorur, 2014, p.15–16]])
> - 描述之前需要生产：世界必须先被改变才能变得可描述([[Argument_Gorur_2014_Discourse|Gorur, 2014, p.15]])


> [!abstract] 对批判实践的意义
> 如果测量是 productive 而非 descriptive，那么对测量的批判就不仅仅是认识论练习，而是政治论和存在论（ontological）的干预，是一种道德事业([[Argument_Gorur_2014_Discourse|Gorur, 2014, p.18]])。

## 与相关概念的区别

> [!example] 与相关概念的区别
> - vs **[[Sociology of Measurement]]** — Sociology of Measurement 包含 instrumentalism 和 performativity 两个维度；Performativity 是其生产性/世界制造维度
> - vs **Representationalism（再现论）** — 再现论认为测量的作用是准确描述或代表现实；performativity 立场认为测量制造现实
> - vs **Bias / Inaccuracy（偏差 / 不准确）** — 偏差批判仍属再现论框架（认为测量未能准确代表现实），performativity 批判则关注测量如何改变世界
> - vs **[[Atomisation of Knowledge and Skills]]** — 测量的施行性说明测量如何重塑教育现实；知识与技能原子化说明这种重塑在课程内容和学习目标层面如何把整体教育目的拆成可治理碎片
...
> - **Bottani 的认识论** — "没有认知方法能使其观察、测量、分析、比较、解码的对象完全不受影响……在科学和技术之间、在认知现实及其修改之间，不存在清晰的存在论分界"(Bottani, 2008, p.22; [[Argument_Gorur_2014_Discourse|Gorur, 2014, p.18]])

## 实证发现

> [!success] 实证发现
> [[OECD]] 指标的 performativity 表现在多个层面([[Argument_Gorur_2014_Discourse|Gorur, 2014]])：
...
> **对批判实践的意义**：
>
> VL 案例将 Gorur 的"两个层面的生产性"框架拓展至第三个维度——**隐喻层面的生产性**：不仅是测量行为本身制造世界（层面一），不仅是赋予可计算性特征改变世界（层面二），命名和隐喻的选择本身也在制造世界——"Visible Learning"这个名字不是中性的描述，而是一种施行性行动，为多层监控提供了合法性语言([[Argument_McKnight_2020_Discourse|McKnight & Whitburn, 2020, p.33-34]])。该隐喻将视觉特权化为唯一的认知方式，同时系统性抹除不可见、不可量化的教育维度——关怀、关系、情感、包容。对 VL 的批判因此不仅是认识论练习，而是"道德事业"([[Argument_Gorur_2014_Discourse|Gorur, 2014, p.18]])，必须同时审问测量隐喻的文化政治。
>
> > 例：维多利亚州教育部要求职前教师进入教室后立即走向白板张贴学习意图（learning intentions），学校管理层禁止以任何其他方式开始上课（McKnight, 2016，引自 McKnight & Whitburn, 2020, p.39）。这不是因为研究表明这一做法最有效，而是因为"可见性"的施行逻辑要求学习必须是可展示的——测量的存在（学习意图的可见证据）改变了教学行为本身。
...
> - Johnson & Janzen 将此定性为 VL 如何将教学从"an ethical, relational profession"重塑为"tightly managed franchises, staffed by teacher technicians, delivering a checklist of best practice teaching strategies"([[Argument_Johnson_2023_CE|Johnson & Janzen, 2023, p.29]])
>
...
> [!warning] 中立性的不可能
> Bottani 质疑指标是否能被视为中立的认知工具："我们真的能坚持认为指标的使用构成中立的认知方法、不以修改教育系统为目标吗？……生产和发布一套指标，并得到教育当局的支持和鼓励，这完全是中立的吗？"(Bottani, 2008, p.21; [[Argument_Gorur_2014_Discourse|Gorur, 2014, p.18]])


> [!warning] 批判的道德维度
> Gorur 论证，既然测量是制造世界的过程，仅挑战数字的准确性或指出其简化是不够的——需要理解测量的 instrumentalism（提供干预的潜在切入点）及其 world-making 功能（提供承担此类研究的道德和伦理动力）([[Argument_Gorur_2014_Discourse|Gorur, 2014, p.18–19]])。
...
>
> > 例：在以 [[PISA]] 排名为导向的政策环境中，学校可能将资源集中于处于及格线边缘的学生（以最大化达标率），而忽视最弱势和最强学生的需求——测量的存在改变了优先事项，即使这一改变并非测量的设计者所意图。

## 相关案例／政策

> [!example] 相关案例／政策
> - [[Visible Learning]] — [[Argument_McKnight_2020_Discourse|McKnight & Whitburn (2020)]] 论证 VL 是"新管理全景监狱主义"的完美工具，其隐喻本身就是施行性装置
> - [[Visible Learning Branding and Global Influences]] — VL 商业产品（workshops、认证、Visible Classroom App）是 performativity 在商业层面的制度化体现
> - [[Victorian HITS and Literacy Toolkit]] — [[Argument_Johnson_2023_CE|Johnson & Janzen (2023)]] 记录的澳大利亚 HITS 实施中教师被迫执行"simplistic performative technical actions"
> - [[Education at a Glance]] — [[Argument_Gorur_2014_Discourse|Gorur (2014)]] 的核心案例，[[OECD]] 指标的 performativity 如何在政策层面制造世界
