...
> [!concept-lens] 概念透镜
> - **含义** 零假设是统计检验中被尝试拒绝的稻草人命题。它所陈述的是如果研究假设不成立、世界按照随机状态运作时数据应该呈现的模式。
> - **用途** 为假设检验提供可操作的否定基线——通过检验数据是否显著偏离零假设预测，间接支持[[Alternative Hypothesis|备择假设]]。
> - **边界** 零假设不是研究者真正主张的理论，不用于直接支持研究结论。在研究方案写作中通常不单独列出零假设。

> [!boundary]- 概念边界
> - 不等于 [[Alternative Hypothesis|备择假设]]：零假设预测无关系或无差异，备择假设预测存在关系或差异。两者逻辑互斥，构成假设检验的完整框架
> - 不适用于探索性质性研究（通常不预设假设进行检验）
...
> - **与备择假设配对** 零假设和备择假设成对出现，两者的逻辑关系是：如果零假设不被支持，则备择假设被支持
...
> - [[Argument_Creswell_2022_SAGE|Creswell & Creswell (2022)]] — Ch.7 系统介绍零假设的定义、形式及其在量化研究方案写作中的位置
> - [[Argument_Cohen_Manion_Morrison_2011_Routledge_Ch07|Cohen et al. (2011, Ch.7)]] — 给出零假设的典型场景示例，并与备择假设成对呈现在操作化框架中
