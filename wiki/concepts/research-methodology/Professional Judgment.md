...
> [!abstract] 证据解释中的专业判断
> [[Students and Teachers Accessing Tomorrow (STAT)]] 案例说明，专业判断也发生在“证据已经产生之后”。STAT 的形成性评价显示教师准备、数字资源使用、学生参与和学生中心教学有积极进展，但学生成就结果并不明确；是否继续支持该项目，取决于决策者如何权衡数字公民、技术公平、学生参与、教师实践改变和标准化成绩（Ross & Morrison, 2021, pp.121-123）。
>
