...
> - **探究是价值负载的** 研究受研究者价值观影响于四个层面：问题、评价对象或政策选项的选择与框架界定；指导研究的范式选择；指导数据收集和分析的实质理论选择；情境中固有的价值观。探究要么是价值一致性的，要么是价值不一致的。问题、范式、理论和情境必须展现出一致性（[[VALUE Rubrics|VALUE]]-resonance）才能产生有意义的结果。
