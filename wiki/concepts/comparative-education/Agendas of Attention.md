...
> [!def] 核心定义
> **注意力议程（Agendas of Attention）** 指比较教育研究由于受到特定国际关系传统（[[Realism in International Relations|现实主义]]、[[Rationalism in International Relations|理性主义]]、[[Revolutionism|革命主义]]）的影响，而在[[Knowledge Production|知识生产]]中有选择地关注某些问题（在场）并排斥、遗忘另一些问题（缺席）的过滤与控制机制。([[Argument_Klerides_2023_CE|Klerides, 2023, p. 416]])
...
>
> *the three traditions offer different '[[Readings of the Global]]' and make possible 'multiple comparative educations'.*

> [!boundary]- 概念边界
> - 不等于 [[Readings of the Global|阅读全球]] — 考恩的“阅读全球”强调阅读行为本身的多重主体性，而“注意力议程”则进一步解构这一阅读所带来的政治选择性后果（即“在场”与“缺席”的分布状态）。
> - 不等于 研究议程（Research Agenda） — 研究议程通常指学者或机构有意识规划的研究项目与范围，而“注意力议程”更深层地植根于底层对国际秩序性质的不自觉政治哲学[[Hypothesis|假设]]，其过滤机制通常在无意识中形塑着[[Research Scope|研究边界]]。
...
> [!contrast-table] 概念辨析
> | 维度 | 注意力议程 | [[Readings of the Global\|阅读全球]] | 研究议程 |
> |---|---|---|---|
> | **分析焦点** | [[Knowledge Production\|知识生产]]中“在场”与“缺席”的政治选择性后果 | 跨国空间中多重阅读全球的能动行为与体验 | 具体的有意识科研规划、项目设立与学科热点 |
> | **底层动力** | 对国际社会性质（权力/权威/武力）的不自觉政治哲学[[Hypothesis\|假设]] | 晚期现代性社会系统翻转与学术[[Revoicing\|话语重构]] | 学术体制需求、资金支持与学者个人兴趣 |
> | **典型表征** | 现实主义工具、理性主义治理或[[Revolutionism\|革命主义]]批判的分野 | 将全球化视为多重文本并加以折射的阅读 | 学科指南、课题分类与论文选题规划 |
...
> [!feature] 核心要素
> - **在场（Presences）** 指在特定国关传统影响下，在比较教育研究中被高度强调、制度化显现并占据统治地位的主题（如[[Realism in International Relations|现实主义]]下的民族国家、借用吸引与[[Reference Society|参考社会]]；或[[Rationalism in International Relations|理性主义]]下的[[Governing at a Distance|远处治理]]与大数据评估）。([[Argument_Klerides_2023_CE|Klerides, 2023, pp. 420–425]])
...
> ```mermaid
> flowchart TD
>     A["国际关系底层预设"] -->|过滤| B["注意力议程"]
>     B -->|选择性强调| C["在场 (Presences)"]
>     B -->|系统性屏蔽| D["缺席 (Absences)"]
>     C <-->|实践中交叉互动| D
>     C & D -->|共同决定| E["比较教育学术形态的呈现"]
> ```
...
### 命题类型一　不同的国际关系预设通过注意力议程决定了比较教育的在场与缺席分布

> [!concept-lens] [[Knowledge Production|知识生产]]的过滤透镜
> 探讨注意力议程如何在中介底层政治[[Hypothesis|假设]]与表层学术选题之间起作用。学者们普遍倾向于揭示学术客观性背后的选择性偏差。

> [!claim] [[Eleftherios Klerides|Klerides, E.]]
> **注意力过滤** 对国际社会是处于“自助竞争”（[[Realism in International Relations|现实主义]]）、“规则合作”（[[Rationalism in International Relations|理性主义]]）还是“压迫抗争”（[[Revolutionism|革命主义]]）的不同设定，通过注意力议程在无意识中过滤了比较教育学者的视野，规定了什么是可以被看见并讨论的“在场”，以及什么是必须被排除并遗忘的“缺席”，由此决定了什么值得比较、如何比较以及比较服务于什么目的。([[Argument_Klerides_2023_CE|Klerides, 2023, p. 431]])

---

### 命题类型二　现实主义注意力议程在关注国家竞争借用的同时屏蔽了权力不对称与殖民扩张历史

> [!concept-lens] 实力竞争与殖民盲区
...
> 探讨理性主义下技术治理话语如何构建起中立合作幻象。学者们共同解构量化基准评估下的软性权力垄断。
...
### 命题类型四　革命主义注意力议程在聚焦去殖民解放时低估了国家权力约束与渐进改良价值

> [!concept-lens] 压迫斗争与激进批判
...
> [!contrast-table] 注意力议程在三大传统下的在场与缺席
> | 思想传统 | 核心概念 | 议程在场 (Presences) | 议程缺席 (Absences) | 典型研究/历史现象 |
> |---|---|---|---|---|
> | **现实主义** | 权力 (Power) | 民族国家单位、工具性借用与吸引、工业竞争力与国防安全、参考社会的建构 | 非国家行动者、地缘权力不对称、比较教育参与帝国扩张与文明化工程的黑暗史 | [[Michael Sadler\|萨德勒]]的德国教育调查、明治维新借用、人造卫星冲击与国防教育重组 |
> | **理性主义** | 权威 (Authority) | 跨国与全球治理网络、基准测试与远处治理、多行动者互动、国际理解与[[International Mind\|国际心智]] | 全球治理中的权力集中与地缘控制、去政治化的技术评估面纱、多边合作的盲目乐观 | 诺沃亚论远处治理、两次大战间的教科书修改运动、[[Comparative Education Society in Europe\|欧洲比较教育学会成立]] |
> | **革命主义** | 武力 (Force) | 中心-边缘剥削模型、殖民遗产的隐蔽延续、学科自身的殖民认识型、南南交流与南方理论 | 国家间竞争的现实约束、体制内的改良性渐进改革、非西方的帝国地缘扩张 | 依附理论对心智奴役的批判、卡诺伊论去殖民化教育、去殖民比较教育的开辟 |
...
> > - **分析工具的纯粹性** [[Realism in International Relations|现实主义]]、[[Rationalism in International Relations|理性主义]]和[[Revolutionism|革命主义]]的注意力议程通常作为“理想类型”存在，用于协助学者剥离复杂的思想线索。
...
> - **后冷战时期国际组织远程评估的注意力重构** 随着多边协商与[[Governing at a Distance|远处治理]]成为[[Rationalism in International Relations|理性主义]]全球化的主导，世界银行和[[OECD|经合组织]]等通过基准测试和[[PISA|国际学生评估项目]]（PISA），将复杂的跨国教育比较重塑为技术性的全球排名。它选择性地让跨国治理指标和人力资本效能占据在场，同时掩盖了数据霸权背后的西方主导权，将政治权力冲突成功“技术化”。
