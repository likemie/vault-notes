...
> - **用途** 帮助研究者透视 1970 年代方法论大论战后比较教育学的分化与重构，解释后[[Positivism|实证主义]]、[[Critical Theory|批判理论]]、[[Postmodernism|后现代主义]]、历史诠释学与新制度主义等多范式争鸣的合法性来源。
> - **边界** 它不等于虚无主义的学科瓦解，亦不否认量化共变范式在跨国测评（[[IEA]]、[[PISA]]）与政策合法化领域的顽强延续；它揭示的是学术共同体内部真理体制的复数共存格局。

> [!citation-card] 马修论单一全包容范式的终结与复数比较教育学的确立
> 到 1980 年代，人们完全有理由断言“比较教育学中已然存在众多学派，但没有任何一个学派居于支配地位”（Altbach, 1991: 493）；因此，今天更为准确的表述应当是复数的“多个比较教育学”（comparative educations），而非单数的“比较教育学”（Cowen, 2000）。[[Argument_Mattheou_2009_ScientificParadigm|(Mattheou, 2009, pp. 68–69)]]
>
> *Already by the 1980s one could rightfully suggest that ‘there are now many schools of thought in comparative education and none has dominance’ (Altbach, 1991: 493); consequently it would be more accurate to speak today about comparative educations rather than about comparative education (Cowen, 2000).*

> [!boundary]- 概念边界
> - 不等于 [[Scientific Paradigm]] — 后者在 1960 年代特指以大样本跨国共变、[[Hypothesis|假设]]检验与普遍社会学规律为追求的单一统治范式，而复数比较教育学是该霸权解体后形成的学术多极格局。
> - 不等于 [[Agendas of Attention]] — [[Robert Cowen|罗伯特·考恩]]的“关注议程”侧重不同历史阶段主导比较教育学科的核心关切主题（从[[Policy Borrowing|教育借用]]到人力测算再到认同建构），而复数比较教育学聚焦于同一时代内部认识论、方法论范式的并立与真理体制多元化。
...
> [!contrast-table] 概念辨析
> | 维度 | 复数比较教育学（Comparative Educations） | 科学范式（[[Scientific Paradigm]]） | 关注议程（[[Agendas of Attention]]） |
> |------|---|---|---|
...
>
> *Referring to the development of national systems of education Hans had argued that every system corresponds to a complex edifice of various architectural styles, each related to the historical period its different apartments were built... Ever since, new buildings have been erected, each following different architectural styles... From the very beginning some of those buildings were occupied by tenants related to policy making. Yet the rest remain in the hands of the academic community... the place where episteme, the art of endless, laborious but intellectually rewarding search for truth resides.*

> [!logic-map]- 单一范式衰落与复数比较教育学演进机制图
> ```mermaid
> flowchart TD
>   subgraph 外部与内部危机驱动
>     A["现实治理危机: 经济滞胀、失业与社会流动承诺破灭 (Husén, 1982)"]
>     B["认识论危机: 量子力学确立不确定性，破除机械因果律"]
>     C["学术思潮转向: 后现代将宏大理论贬黜为宏大叙事"]
>   end
>   A & B & C --> D["单一全包容实证科学范式失去垄断地位"]
>   D --> E["复数比较教育学格局形成 (Altbach, 1991; Cowen, 2000)"]
>   subgraph 学科大厦的空间分化 (Hans & Mattheou)
>     E --> F["政策租客的建筑: 实证量化共变范式延续 (IEA, PISA)"]
>     E --> G["学术共同体的居所: 批判、解释、多元真理体制探索 (Episteme)"]
>   end
> ```
...
### 命题一　全包容实证范式霸权的瓦解源于外在政策承诺落空与内在自然科学认识论质变的双重共振

> [!concept-lens] [[Paradigm|范式]]霸权瓦解的内外动力机制
> 围绕战[[Postpositivism|后实证主义]]单一正统何以在 1970 年代中叶迅速失去统摄动能展开，揭示治理失效与自然科学哲学断裂的协同效应。

> [!claim] Mattheou, D.
> **外在治理失败与内在[[Epistemology|认识论]]质变的双重动因** 马修指出，单一[[Scientific Paradigm|科学范式]]的衰退并非偶然，而是现实世界危机与自然科学哲学断裂协同作用的产物。在实践层面，实证规划不仅未兑现消除不发达与促进代际流动的诺言，反而在 1970 年代西方经济滞胀面前暴露出其方案的虚妄；在认识论层面，物理学量子力学范式证明了不确定性与混沌才是自然法则的常态，彻底终结了社会科学通过模仿物理学确立普遍必然因果律的独断论调。[[Argument_Mattheou_2009_ScientificParadigm|(Mattheou, 2009, p. 68)]]

> [!claim] Husén, T.
> **实证科学规划承诺的系统性[[Falsification|证伪]]** [[Torsten Husén|托斯滕·胡森]]指出，战后西方将实证规划作为解决一切教育与社会矛盾的万灵丹，但冷酷的社会事实证明，过度学校化与机械规划非但未能消除阶级壁垒，反而引发了深刻的合法性危机，使得实证研究作为客观无误政策良方的学术声誉荡然无存。（Husén, 1982; 引自 [[Argument_Mattheou_2009_ScientificParadigm|(Mattheou, 2009, p. 68)]]）

---

### 命题二　复数化比较教育学体现为多元真理体制共存与政策租客和学术共同体的空间分化

> [!concept-lens] 学科空间的权力分立与真理体制重构
...
> | 命题类型 | 核心指向 | 适用情境 | 代表学者 |
> |---|---|---|---|
> | **范式瓦解动因命题** | 揭示外在社会治理失效（滞胀）与内在自然科学[[Epistemological Break\|认识论断裂]]（量子转向）如何协同摧毁单一实证神话。 | 比较教育学科史 1970 年代范式危机与方法论大论战分析。 | Mattheou; Husén |
> | **空间与体制共生命题** | 论证学科已走向“多学派并立且无一支配”的复数状态，并形成政策借口租客与学术探索共同体的空间并存。 | 当代多元范式格局、跨国测评治理与学科认识论反思。 | Cowen; Altbach; Mattheou; Hans |
...
> | 条目 | 类型 | 贡献 |
> |:-----|:-----|:-----|
> | [[Scientific Paradigm]] | 概念 | 单数霸权形态，其在 1970 年代的解体直接催生了复数比较教育学格局。 |
> | [[Positivism]] | 概念 | 单一科学[[Paradigm\|范式]]的哲学基石，其被量子物理学与后现代思潮动摇促成范式转向。 |
> | [[Social Science as Legitimation Alibi]] | 概念 | 解释实证量化范式在学术垄断破裂后，为何依然能稳固盘踞在政策大厦内部。 |
> | [[Torsten Husén]] | 人物 | 提供 1970 年代西方教育规划失效与学校危机的一手[[Falsification\|证伪]][[Document\|文献]]，推动范式反思。 |
> | [[Agendas of Attention]] | 概念 | 与复数化概念互补，共同构成把握比较教育学科历史演进的核心分析透镜。 |
