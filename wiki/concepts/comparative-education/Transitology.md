...
>
> Cowen 的界定包含四个要素：国家机器的崩溃与重建、社会经济分层体系的瓦解与重组、未来政治愿景的重构，以及教育在其中被赋予的象征性和重构性角色（Amos, 2022, p.53）。
>

## 概念演变

> [!note-] 概念演变
> Amos 指出，我们很少看到国家机器像柏林墙倒塌那样戏剧性地崩溃。但若将 Cowen 的术语做更宽松的使用，从国家中心到市场中心的教育关系转变可被视为当前的 transitology（Amos, 2022, pp.53–54）。
>
> Cowen 以双轴模型将这一转型可视化：现代模型以 polis-driven（城邦驱动）为纵轴——上端为教育机会平等、下端为国家文化认同，水平轴左端为国际教育关系、右端为经济增长；晚期现代模型中，纵轴从 polis-driven 转为 market-driven（市场驱动）、教育机会平等被内部效率与外部效能取代、国家文化认同被劳动力分化取代，水平轴变为国际经济与国际知识竞争（Cowen, 1996, pp.160–162；Amos, 2022, p.55）。
>
...
> [!info] 理论基础
> - [[Robert Cowen]] — transitology 概念的原创者，以比较教育视角分析教育与社会转型的关系
>

## 相关案例／政策

> [!example] 相关案例／政策
> - 晚期现代教育中从国家中心向市场中心的转向——以新公共管理话语和实践在教育中的深度嵌入为典型表现（Amos, 2022, p.56）
