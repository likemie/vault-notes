...
> [!info]
> 政策科学（Policy Science）是 [[Robert Cowen]]（Cowen 2023）所识别的比较教育四种长期并存的理解形式之一，认为比较教育可以且应该是政策科学。这一命题是关于比较教育本质的陈述，它在挣扎着成为、现在已经几乎成为、并将更好地成为政策科学，这是其正当的[[Epistemology|认识论]]形式和功能([[Argument_Cowen_2023_CE|Cowen, 2023, p.333]])。
...
> [!note]-
> **1960 年代的经典[[Ontology|本体论]]争论与规划结盟**。政策科学这一理解形式在 1960 年代科学化大论战中达到顶峰。不仅包括 [[Brian Holmes]] 与 [[Edmund King]] 对政策科学与预测功能的理论倡导([[Argument_Cowen_2023_CE|Cowen, 2023, p.333]])，更体现为美国经验实证学派与战后国家规划体制（如中央五年计划、人力资本扩张、世界银行与发展教育援助）的深度结盟([[Argument_Mattheou_2009_ScientificParadigm|Mattheou, 2009, pp. 64, 67–68]])。
>
...
>
> **进退交替**。这一期望时而清晰时而模糊，它反复出现在比较教育的学科讨论中。
...
> - **战后规划体制的合法化借口（Alibi）**。实证量化取向的政策科学之所以在现实中压倒复杂的语境哲学研究，根源于其产出的“科学硬事实”恰好迎合了官僚机器推行预设教育扩张、规避决策政治责任的合法化需求，蜕化为既定政治正统的便利说辞([[Argument_Mattheou_2009_ScientificParadigm|Mattheou, 2009, pp. 67–68]])。
...
> - **技术官僚意识形态的庇护所**。迪米特里斯·马修指出，政策科学对量化因果确定性的虚假承诺，使实证研究长期沦为政客与技术官僚推行既定方针的辩护词；而那些揭示情境复杂性、权变不确定性与深层文化矛盾的审慎学术方案（如霍姆斯的问题法），反而因无法提供速效政策安慰剂而遭到官方体制的冷遇([[Argument_Mattheou_2009_ScientificParadigm|Mattheou, 2009, pp. 67–68]])。
