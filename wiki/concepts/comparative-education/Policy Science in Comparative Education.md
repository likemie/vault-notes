...
> - **关键决策时刻的服务**。这一联盟的核心体现是 c 所宣称的在国家决策的“关键决策时刻”（critical points of decision），由学者向权力机器提供专业比较建议，提供危机处理的技艺。
> - **战后规划体制的[[Social Science as Legitimation Alibi|合法化借口]]（Alibi）**。实证量化取向的政策科学之所以在现实中压倒复杂的语境哲学研究，根源于其产出的“科学硬事实”恰好迎合了官僚机器推行预设教育扩张、规避决策政治责任的合法化需求，蜕化为既定政治正统的便利说辞([[Argument_Mattheou_2009_ScientificParadigm|Mattheou, 2009, pp. 67–68]])。
...
> - **技术官僚意识形态的庇护所**。迪米特里斯·马修（Dimitris Mattheou）指出，政策科学对量化因果确定性的虚假承诺，使实证研究长期沦为政客与技术官僚推行既定方针的辩护词；而那些揭示情境复杂性、权变不确定性与深层文化矛盾的审慎学术方案（如霍姆斯的[[Problem Approach|问题法]]），反而因无法提供速效政策安慰剂而遭到官方体制的冷遇([[Argument_Mattheou_2009_ScientificParadigm|Mattheou, 2009, pp. 67–68]])。
