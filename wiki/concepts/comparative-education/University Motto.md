...
> [!tip]
> Li 从中西校训对比中提炼出三个核心洞察（Li, 2012, pp.33-34, 54-55）：
...
中国校训的核心语义集中在：
- **修身与德行**：清华"自强不息，厚德载物"、港大"明德格物"——"明确且一致地强调，道德和自我的修养必须先于对世界的探究"（Li, 2012, p.55）
- **勤奋与刻苦**：北大以"勤奋"开头（Li 特意标注了其位置），新加坡国立"通过艰苦努力达成伟业"——与[[Learning Virtues|学习美德]]中的勤奋和刻苦直接呼应
- **儒家经典的直接引用**：大多数校训"直接取自或浓缩自儒家文本"。即使有"求是"（truth seeking）和"创新"（creativity），它们通常被放置在儒家学习目的与过程之后（Li, 2012, p.55）

### 3. 反直觉的历史事实：中国大学校训的"儒家性"是主动选择

> [!important]
> Li 指出了一个重要的反直觉事实：**中国的大学制度本身不是本土产物**——"大多数中国大学是在 19 世纪末 20 世纪初仿照西方大学建立和建模的，当时中国正经历剧烈的政治、社会和经济变革"（Li, 2012, p.55）。然而，这些新建的西式大学在校训上选择了儒家经典而非西方概念。这意味着：尽管制度形式已被西化，但教育使命的文化内核保持了连续性。校训的选择是一种**文化自主性**的表达。
...
校训不是死去的遗迹——它构成了每一代大学成员重新协商"教育所为何事"的文化场域。
