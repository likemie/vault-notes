...
- 2006 年 Krücken & Meier 在 *Globalization and Organization* 中首次提出分析框架，关注大学如何在全球化压力下"转变为组织行动者"——即获得统一决策、自我管理和对外代表的能力。这一研究的背景是欧洲博洛尼亚进程和新公共管理改革对大学自治提出的新要求（Zapp, 2022, p.148）
...
- Ramirez (2006) 从世界社会理论视角论证大学的理性化（rationalization）趋势：大学日益通过使命陈述、品牌营销和形式结构改革寻求独特身份，但实质上在全球范围内趋同于一种标准化组织形态。这一表面"求异"实则"趋同"的悖论是世界社会理论的核心发现之一（Zapp, 2022, p.148）
...
> - **问责性（accountability）**：大学对其行为和绩效承担责任，接受外部评估和排名。这体现在研究评估体系（如英国 REF 中的"影响"权重持续增加）、全球大学排名（[[THE Impact Ranking 2019]]、ARWU、THE-WUR）、以及大学 CSR 报告的发布（Zapp, 2022, pp.146–147, 152–153）
...
> [!tip]
> - [[World Society Theory]] — 组织能动者身份是世界社会理论的核心概念之一，用于解释在全球文化模型扩散过程中，各类组织（包括大学）如何获得标准化但同时又寻求独特性的组织身份（Bromley & Meyer, 2015）
...
> - SDGs 为大学的组织能动者身份提供了全球性"演练场"：大学通过四种机制——研究对齐、教学对齐、内部政策对齐和网络对齐——系统性地将组织议程与全球治理目标绑定，详见 [[Argument_Zapp_2022_Springer#第四步：SDGs 作为催化剂——四种嵌入机制]]（Zapp, 2022, pp.150–154）
...
> - **世界社会理论视角的回应**：Zapp 承认上述批判的有效性，但认为更深刻的转型正在发生——大学正从根本上被重新概念化，从公共行政的特定单位转变为具有自我身份和策略的组织行动者（Zapp, 2022, p.148）

---
## 相关案例／政策

> [!example]
> - [[UN Sustainable Development Goals 2015]] — SDGs 为大学的组织能动者身份（尤其是社会嵌入性维度）提供了全球性议程框架
> - [[THE Impact Ranking 2019]] — THE 影响力排名将大学的社会嵌入性和全球公民身份转化为可量化的排名指标
