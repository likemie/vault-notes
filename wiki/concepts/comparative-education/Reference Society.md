...
> | 维度 | 参考社会（Reference Society） | [[Policy Borrowing\|政策借用]]（Policy Borrowing） | [[Cross-National Attraction\|跨国吸引力]]（Cross-National Attraction） | [[Externalization\|外化]]（Externalisation） |
> |:---|:---|:---|:---|:---|
> | **分析焦点** | 被选定为效仿或辩护模板的客体社会 | 跨国移植、引介与[[Recontextualization\|再脉络化]]的行为全流程 | 国内体制对外国经验产生关注的初始驱动力 | 系统借调外部权威以解决内部合法性危机的机制 |
> | **理论渊源** | 施赖弗比较方法论、[[Niklas Luhmann\|卢曼]]系统论、[[PISA]] 排名 | 比较教育政策转移理论（Phillips & Steiner-Khamsi） | 菲利普斯（[[David Phillips]]）四阶段政策借用模型 | 施赖弗（Jürgen Schriewer, 1990）[[Luhmann's Systems Theory\|系统理论]] |
> | **时间节点** | 持续充当象征灯塔，随排名与地缘格局更迭 | 贯穿吸收、决策、实施至本土内化的生命周期 | 存在于借用周期的第一阶段（跨国吸引期） | 在国内决策陷入严重阻滞或争议的相持节点爆发 |
> | **典型表述** | “看看芬兰是如何做教师教育的” | “我们立法引进了芬兰式的综合学校法案” | “本国学生数学成绩滑坡引发对亚洲体系的浓厚兴趣” | “国际[[OECD\|经合组织]]建议我们采纳这一标准” |
...
> [!claim] 命题三：[[Policy Borrowing\|政策借用]]具有高度选择性，借用的是象征声望而非制度实体
...
> - [[Argument_Klerides_2023_CE\|Klerides (2023)]] — 运用[[Wight's Three Traditions of International Theory\|国际关系三大传统]]解构现实主义比较教育中的参考社会与反参考社会，剖析地缘霸权与制度榜样的共生关系。
...
> | [[Soft Power by Hard Facts]] | 概念 | 规制机制，国际组织借建立量化模范社会行使非强制性跨国[[Soft Power\|软权力]]。 |
