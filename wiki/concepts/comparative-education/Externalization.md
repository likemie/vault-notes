...
> 依据系统论的语言，系统对“外部参照点的内部建构”（Mangez and Vanden Broeck 2020）能够产生额外的意义，有助于再生产自身的认同，并制造出确定性。根据卢曼（Luhmann 1995, 481）的观点，外化或对这类拟似外部参考点的建构，充当了‘规制性理念’；在更细致的考察下，它们实际上是‘只有当它们“仿佛”有效时才具有效力的投射’。‘芬兰的成功’就是一个绝佳的例证。对于芬兰学生为何能在国际大规模学生评估中取得优异成绩，人们给出了长长的解释清单。取决于政策行动者究竟要为哪项争议性政策议题寻找（内部诱导的）拟似外部权威来源，芬兰的成功被交替归因于其扎实的高校[[Normal School|师范教育]]体系、极少进行学生分流的包容性学校教育，或是学生讽刺性地极少面临高利害标准化测验的关怀型校园环境。[[Argument_Steiner-Khamsi_2024_CE|(Steiner-Khamsi et al., 2024, p. 546)]]
>
