...
> [!def] 核心定义
> 政策中介（Policy Brokerage）是指在公共政策与教育治理场域中，行动者连接科学研究社群与政治决策系统，通过对繁杂科研成果的选择性提取、包装转化与定向转译，为政策制定提供确定性证据支撑与合法性辩护的制度化治理机制。与侧重技术性信息扩散的中立知识中介不同，政策中介深度嵌入全球与国家治理网络；当特定跨国组织或智库在内部自行生产知识、以科学理性包装知识，甚至同时为推介的改革方案提供项目资助时，中立中介便异化为兼具议程设置特权与自身制度利益诉求的政治化政策中介，依靠量化指标与理性表象施展软性政策规制。[[Argument_Steiner-Khamsi_2024_CE|(Steiner-Khamsi et al., 2024, pp. 538–539)]]

> [!concept-lens] 概念透镜
> - **含义** 揭示知识向政策转化过程中的非中立性，阐明中介机构如何将自身偏好的研究转化为不可置疑的决策依据。
> - **用途** 帮助研究者透视国际组织、咨询公司与智库在全球教育政策流动中的网络节点权力与议程设置手法。
> - **边界** 不等于纯学术性的科学传播，亦不同于国家行政体系自上而下的法定权力命令。

> [!citation-card] 政策中介的政治化定性
> 当同一组织对其在内部生产的知识进行中介，甚至更明显地以科学理性为依据自主生产、中介推销并资助其项目时，知识中介与政策中介之间的界限便具有了流动性。因此，在考察全球治理工具时，使用政策中介而非更为中立的知识中介是更为准确的概念表述。[[Argument_Steiner-Khamsi_2024_CE|(Steiner-Khamsi et al., 2024, p. 538)]]
>
> *The differentiation between knowledge brokerage and policy brokerage is fluid when the same organisation brokers knowledge it previously produced in-house or, even more blatantly, produces, brokers, and funds its projects with recourse to scientific rationality. Therefore, we propose to use the term 'policy brokerage' rather than the more neutral term 'knowledge brokerage' throughout this article.*

> [!boundary]- 概念边界
> - 不等于 [[Boundary Spanner]] — 跨界者侧重于微观组织社会学中跨越部门边界的个体协调行为；政策中介侧重于宏观治理中连接科学与政治、制度化生产与包装政策证据的系统机制。
> - 不等于 [[Policy Borrowing]] — 政策借用聚焦于输入国主权行动者的策略性选择与本土合法化动机；政策中介聚焦于中介行动者如何输出、打包与推销政策知识。
...
> [!contrast-table] 概念辨析
> | 维度 | 政策中介（Policy Brokerage） | 知识中介（Knowledge Brokerage） | [[Policy Borrowing\|政策借用（Policy Borrowing）]] |
> |------|--------|----------------|----------------|
> | **行动主体** | 兼具知识生产、倡导与资助能力的跨国组织与智库 | 相对中立的学术传播机构、第三方评估中心与知识翻译者 | 主权国家政府内部的政策制定者、行政官员与政治联盟 |
> | **核心机制** | 选择性提取数据，以科学理性包装特定改革方案 | 双向沟通、证据传播与学术研究成果去术语化普及 | 依据本土政治冲突与合法性危机，策略性引入外部参考 |
> | **运作特征** | 利益关联性强，呈现硬事实软权力与话语标准化 | 侧重研究发现的保真度与实践转化效率 | 侧重外部范式的本土转译、意义重塑与再脉络化 |
...
> - **以硬事实施展软权力（Soft Power by Hard Facts）** 政策中介依靠数字而非叙事构筑理性、精确与普适的制度表象，通过可测量、可比较、标准化的测评指标形成软性比较压力与治理杠杆。[[Argument_Steiner-Khamsi_2024_CE|(Steiner-Khamsi et al., 2024, pp. 538–539)]]
> - **差异化中介工具打包（Instrument Bundling）** 各国际组织将核心评测工具与不同辅助产品打包，形成组织利基：经合组织以 PISA 为核心绑定同行评议与国别经验横向对照；世界银行则依靠系统性基准工具搭配自指性最佳实践仓库。[[Argument_Steiner-Khamsi_2024_CE|(Steiner-Khamsi et al., 2024, pp. 543–545)]]
...
### 命题一　信息过量并未消除决策歧义而是强化了对政策中介的筛选需求
...
### 命题二　政策中介依赖数字工具构筑理性表象以消解教育领域的民主争议
...
### 命题三　跨国政策中介在知识利用上呈现鲜明的组织利基与自指性分化
...
### 命题四　主权国家在政策转移空间中呈现议程借力与行政出台阶段的戏剧性过滤断裂
...
> | 命题类型 | 核心指向 | 适用情境 | 代表学者 |
> |---|---|---|---|
> | **信息过载与筛选需求** | 揭示知识过剩反向激发中介机构选择性证据包装的机制 | 数字化信息过量与跨国政策转移 | [[Gita Steiner-Khamsi\|Steiner-Khamsi]] et al. |
...
> | **两阶段行政过滤断裂** | 揭示主权国家在议程动员与法定颁行之间对中介知识的剧烈筛选与特定偏好 | 国家政策借用与本土化立法转化 | Steiner-Khamsi et al. |
...
> [!dev-timeline] 概念演变
> - **1979 — 双社群理论奠基** Caplan 提出科学社群与政治社群之间存在文化壁垒与认知鸿沟，强调需要桥梁行动者克服知识流动阻碍。
> - **2010 — 知识-行动联结三代模型** Best & Holmes 梳理知识利用演进阶段：第一代单向推送模式、第二代行动者关系共建模式，以及第三代关注组织生态、制度能力与政策周期的系统性程序模式。
> - **2018–2021 — 跨国网络治理与硬事实软权力** Niemann & Martens 指出以经合组织为代表的国际组织凭借量化指标体系扮演知识经纪人，通过 hard facts 行使 soft governance。
> - **2024 — 数字治理 2.0 与政策中介理论成型** [[Argument_Steiner-Khamsi_2024_CE|Steiner-Khamsi et al. (2024)]] 正式提出数字治理 2.0 议程，将研究焦点从去情境化的测验指标推进至信息过载时代的“政策中介”，揭示国际组织自我生产、推销与资助方案的一体化运作。
...
> |---|---|---|---|---|---|---|
> | [[Argument_Steiner-Khamsi_2024_CE\|Steiner-Khamsi et al. (2024)]] | 挪威能力课程改革（5 个专家委员会 vs 部长令）；全球 30 个涉教育政府间组织历时数据 | 政策咨询引用网络分析；组织机构分类数据库追踪 | 专家报告采纳率；经济协调类国际组织在教育中的占比 | 专家委员会共列入 464 篇文献，行政法令最终仅引用 22 篇（其中 20 篇来自经合组织审查组）；涉教育国际组织中三分之一属于经济合作协调组织 | — | 证实国家行政当局在法定出台阶段对政策中介的强力政治过滤，以及非专门组织跨界主导政策中介的格局 |
...
> - [[Argument_Steiner-Khamsi_2024_CE|Steiner-Khamsi et al. (2024)]] — 提出数字治理 2.0 框架，系统解构经合组织与世界银行将政策中介作为全球治理工具的演进逻辑与国家回应机制。
