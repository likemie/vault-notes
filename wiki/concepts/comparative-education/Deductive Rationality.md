...
> [!example]
> - vs [[Totally Pedagogised Society|全盘教育化社会]] — 全盘教育化社会是社会学分析概念，描述教育关系从学校扩展到整个社会的结构性变迁。演绎理性是控制机制概念，描述学术管理话语如何通过压缩的政策话语来控制大学和[[Knowledge Production|知识生产]]。
> - vs [[New Public Management|新公共管理]]（New Public Management） — 新公共管理是更宽泛的治理改革理念。演绎理性是 Cowen 对学术管理话语特定形态的理论命名，强调其压缩性和控制性。
