...
> [!info]
> Code switcher（代码切换者）是 John 和 Michael Bishop 在其美国中学生同伴文化的大规模研究中使用的术语，指那些为了在 [[Nerd (School Peer Culture)|nerd 同伴文化]]中生存而采用双重行为策略的学生：**在学校公开表态遵守"try but not too hard"（不要太努力）的同伴规范，但回家后偷偷努力学习**（Li, 2012, p.91）。
