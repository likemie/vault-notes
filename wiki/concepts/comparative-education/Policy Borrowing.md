...
> - **[[Argument_Rappleye_2006_RCIE|Rappleye (2006)]]** — 在 Phillips & Ochs 基础上提出跨国吸引力情境概念地图（Conceptual Map），系统区分结构／人双层推力与阻力，以四种"火花"（丑闻化／合法化／警示／颂扬）分类吸引力动机，回应全球化对转移研究的能动性和新行动者要求
...
6. **前转移与后转移能动性**：[[Argument_Rappleye_2006_RCIE|Rappleye (2006)]] 在响应 Steiner-Khamsi 的呼吁时区分了两种能动性——**后转移能动性**（政策实施后的抵制和本土化，Phillips & Ochs 模型已涵盖）和**[[Pre-Transfer Agency|前转移能动性]]**（外国范例进入国内教育话语之初的引入者及其动机，此前未被充分理论化）。前转移能动性在跨国吸引力阶段即开始运作，行动者包括民选官员、[[Policy Entrepreneur|政策企业家]]、专家、智库、媒体、超国家组织等([[Argument_Rappleye_2006_RCIE|Rappleye, 2006, p. 227]])。Rappleye 强调："教育改革的本质不是科学，而是一个高度规范性的努力——也许是社会价值观话语的首要竞技场"（p. 228）。

### 借用行为的特征

7. **选择性借用**：不照搬整个体系，而是选取适合国内议程的特定元素。正如 Forestier et al. (2016) 对 [[Liberal Studies|LS]] 与 IBDP 的比较所揭示的——LS 参照了 IBDP 的"跨学科整合"和"独立探究"（IES 对应 Extended Essay），但选择性地排除了 IBDP 的国际化知识观、全球多元文化开放态度和批判性哲学内核。LS 中的"跨学科"被改造为服务于香港本地政策议程（培养"通才"以适应与内地经济整合），而非 IBDP 原意中的[[Global Citizenship|全球公民]]培养。([[Argument_Yan_2025_JCS|Yan & Morris, 2025, p. 487]])

8. **翻译与变异**：[[Argument_Cowen_2009_CE|Cowen (2009)]] 论证"改革在转移中变形"（reforms morph as they move）——借用的政策元素在进入本地语境时发生实质性形态转化。前述 LS 对 IBDP"跨学科"的改造即为典型案例：同一标签下承载了完全不同的教育目的和政治意图。

9. **吸引力"火花"**：Ochs (2005) 将政策辩论中使用外国范例的动机分为四种，按修辞力度从激烈到克制排列([[Argument_Rappleye_2006_RCIE|Rappleye, 2006, p. 233]])：
...
[[Argument_Rappleye_2006_RCIE|Rappleye (2006)]] 在 Phillips & Ochs 第一阶段的基础上，将跨国吸引力中的情境要素系统化为一个概念地图（p. 228–234）：
...
概念地图的三种应用方式：(1) 在政策借用各阶段绘制情境快照，追踪情境演变；(2) 比较不同历史时期吸引力和转移的动态变化；(3) 帮助比较教育学者有意识地定位自身研究对政策辩论的影响([[Argument_Rappleye_2006_RCIE|Rappleye, 2006, pp. 236–238]])。
...
> - **中国晚清对日本教育的借用（历史案例）**：[[Argument_Rappleye_2006_RCIE|Rappleye (2006)]] 记录了中国在甲午战争后大规模借用日本教育体系的案例——改革派视日本为现代化成功典范，保守派视日本为保存儒家秩序的范例，这种"不可能联盟"使借用得以大规模推进（Abe, 1987; Hayhoe, 1992，引自 Rappleye, 2006, p. 233–234）。该案例表明，当对立阵营出于不同理由都同意外国范例是好模型时，吸引力最有可能转化为实际借用。
...
**争议背景**：[[Argument_Beech_2015_GSE|Beech & Artopoulos (2015)]] 指出，政策借用概念倾向于只关注国家政策（通常是书面政策文本），但如果我们只将注意力集中在国家政策上，就会错过教育话语权力扩散的大部分机制。在从政府到治理的转变中，权力的流通方式发生了变化：有些直接与国家政策相关，有些松散相关，有些则绕过国家政策。此外，「借用」一词在语言上暗示了暂时性（Phillips, 2000），不如「复制」准确。

**目前状态**：[[Argument_Beech_2015_GSE|Beech & Artopoulos (2015)]] 建议使用[[Relational Space|关系性空间]]概念和[[Actor-Network Theory|行动者网络理论]]来扩展经验视野，超越国家政策的局限。

### 适用范围有限：高压政治语境下的分析失效

**争议背景**：[[Argument_Yan_2025_JCS|Yan & Morris (2025)]] 发现政策借用框架在 LS 案例中表现出阶段不对称性——成功解释创立（2009）但无法解释废除（2021）。废除阶段，港府不再借用全球话语来合法化 [[Citizenship and Social Development|CSD]] 的设立，而是直接以"国家安全"为唯一逻辑。

- **框架适用性的经验限制**：[[Argument_Yan_2025_JCS|Yan & Morris (2025, p. 491)]] 明确指出，政策借用框架仅在"政府仍需借助全球话语来获取合法性"的条件边界内有效。当政府拥有足够强的国内政治权力（如《国安法》提供的法律框架），它不再需要通过[[Externalization|外化]]来降低国内阻力——此时政策借用框架失去了分析对象。
- **可能的框架修正**：并非框架本身的缺陷，而是其适用范围的条件边界——任何理论都有边界条件。该发现为政策借用研究提出了一个重要问题：该框架是否预设了一定程度的政治开放性和公民社会空间？在威权或高压政治语境下，是否需要补充其他分析工具？

**目前状态**：[[Argument_Yan_2025_JCS|Yan & Morris (2025)]] 的发现尚未引发对框架的系统修正，但已揭示其条件边界。

### "形态变异"的操作化困难

[[Argument_Cowen_2009_CE|Cowen (2009)]] 论证"改革在转移中变形"，但这一理论主张的经验测量极具挑战性：当政策在本地以不同形式出现时，如何区分它是因为"被有选择地借用"还是因为"在实施中自然适应"？
