...
学业投入（Academic Engagement）是学生投入理论的两大核心维度之一，指学生向大学中与学术相关的教育性实践活动投入的时间和精力——包括上课、完成作业、与教师讨论学术问题、遵守学术规范要求等（郑雅君，2023）。在郑雅君（2023）的"大学过程"分析框架中，学业投入与 [[Social Engagement|社会性投入]] 并列构成"投入过程"的两大分析轴：
...
郑雅君（2023）在附录二的背景问卷和附录三的访谈提纲中，对学业投入进行了多指标三角互证设计：

| 指标类型 | 具体指标 | 说明 |
|---------|---------|------|
| 量化指标 | GPA | 学业投入的结果性量化代理指标 |
| 量化指标 | 归属感 0–10 自评 | 学业融入的主观感受指标 |
| 质性追问 | P2-Q2（专业喜欢程度与原因） | 通过被访者对专业的喜欢程度和理由，判断其学业投入的情感质量和认知深度 |
...
郑雅君（2023）第4章揭示，学业投入在两种大学生活组织模式中呈现系统性差异：
...
关于两种模式下学业投入的详细案例材料，分别参见 [[Goal-Controlled Mode#学业投入：学以致"用"的策略]] 和 [[Intuition-Dependent Mode#学业投入："绩点无用论"背后的优等生惯性]]。
