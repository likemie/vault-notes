...
Kline & Rosenberg（1986）提出了耦合模型（也称"链环模型"），其核心突破是强调**反馈与互动**——创新过程的各个阶段之间存在持续的往返沟通，而非从 A 到 B 的单行道。这一模型将关注焦点从"谁先启动创新"转向"各阶段之间的知识流动"。

> 模型间的关键差异：前两代问"创新从哪里开始？"（是科学推动还是市场拉动？）；第三代问"创新不同阶段之间如何沟通？"（反馈回路在哪里？）

### 第四代：系统集成与网络化（Systems Integration & Networking，1990s）

> 新产品设计与开发理论的进展将创新重新构想为**并行而非顺序**的过程——企业的多个职能部门同时参与。数字工具、快速原型和信息通信技术的兴起推动了这一转变。模型开始明确认识到：供应商、客户和联盟伙伴在创新过程中扮演关键角色；知识、[[Creativity|创造力]]和学习是创新的来源。
...
> [!important]
> Caraça 等人（2009）指出，尽管上述模型通常被呈现为五代"代际更替"，但在现实中它们是共存的——不同情境调用不同的理解方式。例如：制药行业的药物"发现"阶段仍然很像第一代技术推动（基础生物学突破→寻找药物靶点），但[[Clinical Trial|临床试验]]阶段高度依赖第四代[[Snowball Sampling|网络化]]协作（与医院、监管机构、患者群体同时互动）。"同一家公司、同一种药，前一半走线性、后一半走系统。"
...
| 1990s | 系统集成与[[Snowball Sampling|网络化]] | 多职能部门并行+供应商/客户/联盟参与 | "谁一起参与创新？" |
