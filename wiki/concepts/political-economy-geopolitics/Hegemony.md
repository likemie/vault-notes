...
> - **不等于[[World-Systems Theory|世界体系理论]]的结构决定论** — 世界体系理论偏重宏观经济地缘结构的客观定位；霸权理论聚焦文化部门的半自主性、主观共识制造及反霸权抵抗空间[[Argument_Marginson_2025_ROE|(Marginson, 2025, pp. 13–14)]]。
...
> | **自主性与张力** | 文化部门具半自主性，始终存在反霸权空间 | 无自主性，展现为直白的国家硬实力 | 倾向于再生产统治，对主体反思抗争关注较少 |
> | **典型装置** | 国家教科书、[[Global Universities Rankings\|全球大学排名]]、学术标准 | 警务、监禁、军队、法庭强制判决 | 宗教教会、学校体系、家庭结构 |
...
> ```mermaid
> flowchart LR
>     A["统治阶级／国家"] --> B["硬实力：直接强制<br/>(军队/警察/法庭)"]
>     A --> C["软霸权：文化部门<br/>(教育/教科书/大学/媒体)"]
>     C --> D["话语自然化<br/>(官方知识 / 师生隐喻)"]
>     D --> E["制造被统治者的<br/>‘积极同意’"]
>     C -.-> F["文化半自主性<br/>与知识分子张力"]
>     F -.-> G["反霸权抵抗<br/>(不完整同意 / 跨文化反思)"]
> ```
...
### 命题一　权力通过文化制度与教育装置制造共识而非纯粹依赖强制

> [!concept-lens] 强制与同意的双重运作
...
### 命题二　文化部门具备半自主性且霸权始终面临不完整同意与抵抗

> [!concept-lens] 半自主性与反霸权空间
...
### 命题三　霸权通过修辞语法与空间叙事自然化中心—边缘的[[Cultural Hierarchy|文化等级]]

> [!concept-lens] 官方知识与空间中心—边缘等级
> 分析霸权如何将文化差异重构为支配者（中心/老师）与被支配者（边缘/学生）的空间等级。

> [!claim] Yu, T. & Zhao, Z.
> **“师生隐喻”与文化等级的自然化** 霸权不仅制造国族认同，更组织空间化的文化等级。217 册必修教材统一采用“非汉政权学习汉儒”的修辞模板，通过动词“学习”将汉族定格为“施教的教师”、将非汉族群定格为“受教的学生”。这种[[Bildung|教化]]叙事将中心—边缘的不平等等级包装为“文明化的善意帮助”[[Argument_Yu_2024_CE|(Yu & Zhao, 2024, pp. 67–68)]]。
...
> [!dev-timeline] 概念演变
> - **1929–1935 — 狱中提出阶段** Gramsci 在法西斯监狱中撰写《狱中[[Memos|札记]]》，提出霸权概念，用以解释为何意大利工人阶级未发起革命——答案在于天主教会与教育系统成功制造了对现行秩序的“同意”。
...
> [!ref-table]- 其他实证结果：国家课程霸权与边缘学生同意度调查
> <span class="concept-other-empirical-table-marker" aria-hidden="true"></span>
>
> | 研究 | 样本与情境 | 研究设计 | [[Variable\|变量]]或指标 | 关键结果 | 不确定性或显著性 | 解释边界 |
> |---|---|---|---|---|---|---|
> | [[Argument_Yu_2024_CE\|Yu & Zhao (2024)]] | 217册必修教材；37名少数民族/信教大学生 | 批判[[Discourse Analysis\|话语分析]] (CDA) + [[In-depth Interview\|深度访谈]] | 教科书汉儒等价化；学生对霸权同意度 | 86%拒绝儒家垄断中华性；43%批判其男权等级性；33%质疑现实相关性 | 实证访谈数据 (N=37, pp. 68–70) | 揭示国家课程霸权面临边缘群体的反霸权解构与不完整同意 |
