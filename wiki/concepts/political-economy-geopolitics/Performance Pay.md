...
> - 1985–86 年新西兰议会选择委员会发布《教学质量调查报告》（[[The Scott Report 1986|Scott Report]]），主张迫切需要教师表现测量但承认过程将"漫长而复杂"，建议在大学设立研究单位开发可靠测量工具——该建议从未落实（Snook et al., 2009, p.103）
...
> 例：当教师的薪酬取决于学生的测试成绩时，教师之间分享有效教学策略的动机被削弱；承认错误和寻求帮助变得更加困难，因为错误可能直接导致经济惩罚。

## 争议与批评

> [!warning] 争议与批评
> - **支持方**：部分政策制定者从 Hattie "教师是学校内最重要变量"的结论推导出应按表现付酬（Snook et al., 2009, p.103）
...
> - 目前状态：持续争论；缺乏可靠测量工具是根本性障碍（[[The Scott Report 1986|Scott Report]] 1986 年即指出此问题，至今未解决）
