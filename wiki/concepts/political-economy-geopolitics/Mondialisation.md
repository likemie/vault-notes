...
> [!info] 定义
> Mondialisation（世界化）是作为 globalisation（全球化）的**替代概念**被提出的。在 [[Argument_Amos_2022_Springer|Amos (2022, p.61)]] 的使用中，它指的是以"对生命的顾及和对多元形式的尊重"为核心的全球意识——与将全球化等同于市场扩张、劳动力灵活化和文化同质化的主流理解形成对抗。
>
