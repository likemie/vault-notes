...
[[Argument_Partaken_2022_Springer|Partaken (2022)]] 在[[Geopolitics of Knowledge|知识地缘政治]]（GPK）语境中对 4IR 话语进行了批判性审查——论证该概念并不符合 [[Thomas Kuhn|Kuhn]] 关于科学革命的核心标准（[[Incommensurability|不可通约性]]），其实质是霸权性"[[Knowledge Production|知识生产]]"论述的自我包装，服务于既有权力结构的合法化([[Argument_Partaken_2022_Springer|Partaken, 2022, p.70]])。
...
> - **[[Thomas Kuhn|Kuhn]] [[Incommensurability|不可通约性]]的缺失** 4IR 所描述的技术变革不存在与第三次工业革命的不可通约性——算法、数据、连接性都仍在既有数字[[Paradigm|范式]]内部
