...
> - **边界** 它不限于传统公共教育的狭义私有化形式（如[[Partnership Schools Kura Hourua|特许学校]]或教育券），而是一个涵盖教育供给、研究、政策论证和认知想象被市场逻辑全面渗透的广泛场域（[[Argument_Parreira do Amaral_2022_geopolitics-knowledge|Parreira do Amaral, 2022, pp. 42–43]]）。
...
> GEI 中的数字学习平台（如专有软件、App）并不是中立的工具，而是承载了特定资本主义企业理念的“硅谷帝国主义”（Silicon Valley imperialism）载体。它们通过代码设计限制了教学的可能性，将[[Knowledge Production|知识生产]]的手段集中于少数跨国技术寡头手中，在全球推广标准化的学习行为模式，否认地方文化与课程体系的多样性（[[Argument_Jornitz_2022_Bildung_algorithmic|Jornitz & Klinge, 2022, pp. 231–232, 246]]）。
...
> [!dev-timeline] 概念演变
> - **1990年代 — 危机驱动的[[New Public Management|新公共管理]]改革与[[Corporate University|企业大学]]起步**
...
>   - **美国企业大学兴起** 第一所企业大学由通用汽车（GM）建立，随后 Motorola、Apple、IBM 等企业跟进，将内部培训整合为 brand 化教育项目，使[[Corporate Education|企业教育]]发展为 GEI 的关键支柱（[[Argument_Hartmann_2022_CorporateEducation\|Hartmann, 2022, p. 189]]）。
...
> - **2000年代 — [[PISA]]测试“夺冠”效应与芬兰政策转化** 芬兰在 PISA 测试中意外取得卓越名次，这不仅确立了其全球教育改革“最佳模型”的地位，也催生了其对丧失优势的焦虑。政策制定者开始积极吸纳 OECD “[[21st Century Skills and Competencies Discourse|21世纪技能]]”与欧盟“横向能力”等新自由主义工具，加速了[[Phenomenon-Based Learning|现象本位学习]]（PhBL）等课程理念在国家核心课程中的指标化与绩效化吸收（[[Argument_Schaffar_2024_CogentEdu\|Schaffar & Wolff, 2024, pp. 8–9]]）。
...
- [[SveaSus Project]] — 赫尔辛基大学的可持续世界遗产学习项目。该项目代表了旨在通过具身、艺术与主体间性[[Dialogue in Education|对话]]，抵制技能原子化的[[Phenomenon-Based Learning|现象本位学习]]（PhBL）实践探索（[[Argument_Schaffar_2024_CogentEdu|Schaffar & Wolff, 2024, pp. 1, 4]]）。
