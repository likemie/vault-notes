---
title: Quasi-markets in Higher Education
aliases:
  - 高等教育准市场
...
> [!example]
> - vs 自由市场：自由市场中价格由供需决定、利润是核心驱动力、竞争者可以自由进入和退出。准市场中价格（拨款金额）由行政标准决定、核心驱动力是排名和指标得分、进入门槛由认证和政府认可控制。
> - vs [[Academic Capitalism]]：学术资本主义描述制度逻辑层面的市场化转型，大学如何像企业一样运作。准市场则描述一种特定的政策工具，政府如何用"市场式"的拨款机制替代直接拨款，同时保留对资源分配的最终控制。
> - vs [[New Public Management]]：NPM 是准市场的管理哲学基础，强调竞争、绩效测量和问责。准市场是 NPM 在高等教育拨款领域的具体制度形式。
...
政府或政府委托机构建立一套评估学术产出的标准化指标，研究评分、影响因子、引用数、博士生培养数量等。这些指标将高度异质的学术活动（[[Blue Skies Research|基础研究]]、[[Evaluation Research|应用研究]]、教学、社会服务）压缩为可比较的、可排序的数字。指标的选择本身就是一个政治过程，哪些学术活动"算数"，哪些被系统地排除在外。
...
由于评估指标倾向于奖励已经拥有资源、声誉和人力的机构（它们有更多博士生、更多发表、更高引用、更广的国际网络），拨款进一步向这些机构集中。集中的资源再投入于提升下一轮评估的指标得分，形成自我强化的循环。未被选中的机构不仅失去了额外资源，还在声望上遭受双重打击，未被选中本身就是不够卓越的信号，从而在学生招募和师资招聘上面临更大困难。
...
英国的 [[Research Excellence Framework|Research Assessment Exercise]]（RAE，1998–2008）及其继任者 [[Research Excellence Framework]]（REF，自 2014 年起）是准市场最成熟的制度形式。REF 的评估结果，将各学科的研究产出评为 4*（世界领先）到 unclassified，直接决定了[[Higher Education Funding Council for England|英格兰高等教育拨款委员会]]分配的数亿英镑 QR 研究拨款。院系的招聘、晋升和资源配置策略被系统性地重塑以最大化 REF 得分。
