...
> [!info]
> 在治理和政策分析中，选择性（selectivity）指政策工具和制度安排系统性地优先某些政策替代方案、同时使其他方案被边缘化的过程。此概念源自 Jessop（2007）的策略关系国家理论（strategic-relational approach）：政策工具并非中立的筛选器，而是嵌入特定的权力关系，使某些政策选择比其他选择在操作上更可行、在话语上更"自然"（Rambla, 2022, p.166, 174）。
>
> Jessop 的关键洞见在于：选择性不是决策者有意的偏见或偏袒，而是政策工具本身的结构性特征。在自由主[[Rightness|义]]经济秩序的框架下——即 Jessop 所描述的"欧盟就业和经济政策的深层预设"——政策工具"不可避免地使决策者聚焦于某些议题而忽略其他"（Jessop, 2007; Rambla, 2022, p.166）。
...
> [!tip]
> - **Jessop（2007）的策略关系国家理论**：选择性是嵌入制度结构和政策工具中的结构性特征，并非个人选择的结果。在自由主[[Rightness|义]]经济秩序框架下，政策工具不可避免地使某些议题被优先、另一些被边缘化。
...
在德国和 [[Neocorporatism]] 传统较强的邻国，政策网络包含政府、雇主协会和工会等传统伙伴，选择性在一定程度上被制度多元性所缓冲——多元行动者的参与使更多维度的政策考量得以进入议程（Rambla, 2022, p.173–174）。
...
意大利和西班牙的第二机会学校案例表明，地方层面可以通过自主发展替代变革理论来突破绩效指标的选择性框架。但这些突破高度依赖地方创新能力——而这恰恰是许多被标记为"落后"的区域最缺乏的资源（Rambla, 2022, p.173）。
...
> [!warning]
> - **去政治化风险**：选择性通过将价值判断（如"研发密集型创新优于其他创新""就业优先于赋权"）嵌入看似中立的指标体系，使本应属于民主审议的政治选择被技术化为"客观标准"。这与 [[Scientization of Politics]]（Zapp, 2022）的诊断相通——科学知识从信息来源转变为治理合法性的构成性要素（Rambla, 2022, p.175–176）
> - **区域不平等的固化**：[[Performance Indicators|绩效指标]]体系将区域分类为"领先创新者"和"一般创新者"，分类本身可能进一步固化而非缩小区域不平等——"领先"区域更容易吸引投资和人才，形成自我强化的循环（p.174）
...
> - [[Europe 2020 Strategy]] — 战略框架隐含的自由主[[Rightness|义]]经济秩序预设本身就是一种结构性选择
