...
> - vs 优先级设定（priority-[[Tracking|setting]]）：优先级设定是明确的议程选择（如"本年度重点推进创新政策"），而选择性是隐性的——它是政策工具运作中产生的系统性效应，常不被行动者意识到（Jessop, 2007）
...
> 例：社区组织发起的互助创新网络或传统手工艺的文化创新，即使对当地社区有显著价值，也无法在区域创新记分牌上被展示为"[[Innovation Ecosystem|创新生态]]体系"的组成部分——因为它们不在研发支出和专利指标的捕捉范围内。
