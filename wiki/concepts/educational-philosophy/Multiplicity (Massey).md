...
> - **全球化加剧多重性** — 全球化是"一个通过连接来分化世界的共享历史过程"（Gupta & Ferguson, 1992, p. 16）。趋同产生越来越频繁的与他者相遇——例如国际教育使学生和学者接触不同的知识传统，但这并不导致同质化，反而使差异更加可见（Marginson, 2025, p. 6）
...
> [!note]
> 多重性概念植根于 Massey 对 20 世纪末全球化讨论的介入。她反对两种对立的简化论：一是"全球同质化"论（认为全球化使世界变得相同），二是"地方抵抗"论（认为地方文化可以免疫于全球化）。Massey 的贡献在于提出第三种立场：全球化通过连接来分化世界——更多接触产生更多差异而非更少。Marginson（2025）将这一逻辑应用于高等教育，指出国际教育的扩张并未导致全球大学的同质化，各国系统的差异反而更加显著（Marginson, 2025, pp. 5–7）。
