...
> [!success] 实证发现
> - Qvortrup（2019, p.6）基于 Luhmann 的理论框架推断：可以识别统计概率（如 Hattie 的[[Effect Size|效应量]]），但不能识别简单的、[[Causality|因果性]]的教学干预与学习成果之间的机制。这一推断的实质意义在于：效应量作为概率信息具有实践价值，但不应被解释为因果知识。
