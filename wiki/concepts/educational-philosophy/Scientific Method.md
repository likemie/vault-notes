...
传统[[Positivism|实证主义]]将科学方法定义为一套以客观经验为根基的标准化推论程序，但在当代科学哲学与社会建构论视阈下，它被重新审视并置于具体的历史情境与多元学科实践之中。

> [!def] 核心定义
> 科学方法（Scientific Method）传统上被界定为一套以系统观察、提出[[Hypothesis\|假设]]、隔离[[Variable\|变量]]、受控实验检验以及逻辑推理为核心的经验探究程序，其关键特质在于操作程序的可复制性与结论的[[Falsification\|可证伪性]]（Cuff & Payne, 1979; Hitchcock & Hughes, 1995）。然而，在当代科学哲学、科学社会学与科学教育界，单一标准化的“法则性方法”神话已被瓦解，科学方法被重构为一套包含观察建模、历史推演、模型建构与共同体辩护的多样化、情境化社会[[Epistemology\|认识论]]实践。[[Argument_Cohen_Manion_Morrison_2011_Routledge\|(Cohen et al., 2011, Ch. 1)]]；[[Argument_Sandoval_2005_SE\|(Sandoval, 2005)]]；[[Argument_Kelly_Licona_2018_EpistemicPractices\|(Kelly & Licona, 2018, pp. 144–145, 154)]]

科学方法在教育学术探究与认识论评估中承担着多重功能。

> [!concept-lens] 概念透镜
> - **含义** 科学共同体生成、验证、修正与积累系统化经验知识的核心路径与规范体系。
> - **用途** 在经典实证主义中，它是保障知识客观中立性与普遍有效性的最高判准；在当代[[Nature of Science\|科学本质]]（Nature of Science, NOS）教育中，它是评估学生[[Formal Epistemology\|形式认识论]]成熟度与指导[[Practical Epistemology\|实践认识论]]探究的关键透镜。
> - **边界** 科学方法既不等于实验室流水线式的死板实验步骤，也不适用于裁决超验哲学、道德伦理或审美价值等非经验性存在论命题。

实证主义传统将方法的公共性与可复制性置于中心位置。

> [!citation-card] 程序可复制性与经验证伪
...
理解科学方法的本质，需要将其置于[[Epistemology|认识论]]光谱中与相近[[Paradigm|范式]]和意识形态进行结构性对比。

> [!contrast-table] 概念辨析
> | 维度 | 科学方法（Scientific Method） | 科学主义（[[Scientism]]） | 实践认识论（[[Practical Epistemology]]） | 诠释学探究（[[Interpretive Paradigm]]） |
> |:---|:---|:---|:---|:---|
> | **认识论前提** | 经验观察、逻辑推论与[[Hypothesis\|假设]][[Falsification\|证伪]]相统一 | 将经验科学方法视作获取真理的唯一合法途径 | 探究者在具体情境行动中内隐运用的求知信念 | 现实由具有能动性的人类主体主观建构与赋义 |
> | **主客体关系** | 主张研究者保持客观中立，降低主观干扰 | 确立科技专家对社会客体的[[Absolute Knowing\|绝对认知]]支配 | 探究者在活动情境中与工具、同伴深度互动 | 研究者与研究对象处于“主体-主体”交往[[Dialogue in Education\|对话]]中 |
> | **真理检验标准** | 经验可重复性、[[Predictive Validity\|预测效度]]与可证伪性 | 凡不能被量化测量的命题皆被判定为无意义 | 知识能否有效解决当下行动困境并达成理解 | 阐释是否具有丰富情境深度与反思共鸣感 |
> | **方法论取向** | 假设检验、受控观察、建模与论证综合 | 机械套用数理量化与自然科学实验外壳 | 具身参与、行动反思与局内人情境决策 | [[In-depth Interview\|深度访谈]]、[[Participant Observation\|参与观察]]、文本阐释与意义还原 |
> | **主要风险或局限** | 容易被教条化为去情境的配方式实验步骤 | 剥夺人文价值与道德批判，蜕变为技术极权 | 难以自发自动转化为高阶专业[[Formal Epistemology\|形式认识论]] | 结论具有高度情境依存性，缺乏普遍因果法则 |
...
围绕科学方法的有效性、适用范围以及[[Epistemology|认识论]]地位，学者们形成了三组核心理论命题。
...
> 该维度关注[[Positivism\|实证主义]]如何将自然科学的技术[[Paradigm\|范式]]外推为统辖人类社会事务的普遍准则，强调外部因果规律发现与客观预测。
...
> [!concept-lens] [[Scientism\|科学主义]]批判与教育[[Ontology\|本体论]]遮蔽
> 该维度聚焦现代性[[Technical Rationality\|技术理性]]膨胀对人类主体能动性、复杂交往理性与教育本质属性的消解。
...
> **[[Evidence-Based Education\|循证教育]]对科学方法的教条化与教学本体论抽空** 当代[[Evidence-Based Education\|循证教育]]改革狂热标榜所谓“科学方法”，将教学有效性简化为[[Meta-analysis\|元分析]][[Effect Size\|效应量]]（Effect Size）与统计显着性；这种做法不仅是对真实科学方法的极端教条化，更在本体论上抹杀了课堂教学作为师生人际交往、文化创生与情境生成的复杂生态，使教育研究退化为去专业化的技术测量拜物教。[[Argument_Skourdoumbis_2024_AER\|(Skourdoumbis & Rowe, 2024, pp. 320–327)]]

> [!claim] [[Alec Peterson\|Peterson, A. D. C.]]
> **[[Theory of Knowledge\|知识论]]视域下科学方法的认识论边界划定** 科学方法是人类智识工具箱中极具威力的分析武器，但其本身包含着严整的认识论界限；[[General Education\|通识教育]]与[[International Baccalaureate\|国际文凭]]知识论课程（TOK）教学的首要任务，是让学习者清晰分辨科学方法“能够支持哪些结论，以及哪些价值抉择、神学与形而上学命题根本超出其检验边界”，避免将科学方法误用为裁决人类存在意义的伪宗教。[[Argument_Peterson_1987_OpenCourt\|(Peterson, 1987, pp. 41–42)]]
...
> | 命题类型 | 核心指向 | 适用情境 | 代表学者 |
> |---|---|---|---|
> | **普遍法则预设命题** | 实证主义预设科学方法具有跨越自然与社会领域的普遍法则性与产物同构性 | 社会物理学、量化[[Causal Modeling\|因果建模]]、比较教育发端[[Proto-Scientific Motif\|准科学范式]] | Comte; Giddens; [[Argument_Kaloyannaki_Kazamias_2009_ModernistBeginnings\|Kaloyannaki & Kazamias (2009)]] |
> | **多元实践建构命题** | 科学探究依赖于学科家族相似性、情境化实践认识论与共同体社会论证 | [[Nature of Science\|科学本质]]教学、学科认识论实践分析、探究教学法改革 | [[Argument_Sandoval_2005_SE\|Sandoval (2005)]]; [[Argument_Kelly_Licona_2018_EpistemicPractices\|Kelly & Licona (2018)]]; Kuhn |
> | **技术异化遮蔽命题** | 将科学方法窄化为去情境的技术操作会诱发科学主义并抽空教育人文生态 | [[Critique of Evidence-Based Education\|循证教育批判]]、工具理性批判、通识教育知识论边界划定 | Habermas; [[Argument_Skourdoumbis_2024_AER\|Skourdoumbis & Rowe (2024)]]; [[Argument_Peterson_1987_OpenCourt\|Peterson (1987)]] |

---

## 发展脉络

科学方法的内涵演变贯穿了近代西方启蒙理性建立、[[Positivism|实证主义]]鼎盛、反实证哲学挑战以及当代[[Nature of Science|科学本质]]反思的完整历程。
...
> > 
> > - **[[Objectivism\|客观主义]]实证论者** 坚信研究者能够且必须通过标准化控制消除个人偏见，充当外部世界的冷酷镜像。
> > - **[[Critical Theory\|批判理论]]与后实证学者** 指出科学问题选择、变量界定与数据解释无不渗透着理论预设与社会权力，必须引入批判反思与伦理警觉。[[Argument_Cohen_Manion_Morrison_2011_Routledge\|(Cohen et al., 2011)]]

> [!critique] 对科学教育中“配方式实验规程”的认识论批判
> - **僵化学生的[[Epistemological Beliefs\|认识论信念]]** 中小学科学教育长期将科学方法教条化为“一步步执行的实验室步骤”。这导致学生发展出了极为幼稚的[[Formal Epistemology\|形式认识论]]——他们误以为做实验就是“为了证明预设是正确的”，把理论视为“不需要证据的猜测”，完全忽视了科学方法背后的[[Creativity\|创造性]]、暂定性与模型建构的复杂本质。[[Argument_Sandoval_2005_SE\|(Sandoval, 2005, p. 642)]]；[[Argument_Kelly_Licona_2018_EpistemicPractices\|(Kelly & Licona, 2018, pp. 144–145)]]
...
> - [[Argument_Wrigley_2018_BERJ\|Wrigley (2018)]] — 反思[[School Effectiveness\|学校效能]]研究与量化评价中过度借用实证科学方法的认识论陷阱，揭示指标驱动的评价模式对微观教育复杂性的遮蔽。

---

## 领域应用

科学方法在教育学术探究体系中连接着基础哲学[[Paradigm|范式]]与具体技术工具。

> [!entry-map]
> 
> | 条目 | 类型 | 贡献 |
> |:-----|:-----|:-----|
> | [[Positivism]] | 概念 | 为科学方法提供[[Objectivism\|客观主义]][[Ontology\|本体论]]与实证[[Epistemology\|认识论]]支撑，确立经验检验与普遍法则导向。 |
> | [[Hypothesis]] | 概念 | 作为科学方法的核心推理构件，将理论推测转化为可检验、可[[Falsification\|证伪]]的[[Variable\|变量]]关系陈述。 |
...
> | [[Quantitative Research]] | 方法 | 贯彻实证科学方法的标准化程序，通过变量测量、统计推断与[[Causal Modeling\|因果建模]]呈现规律。 |
> | [[Mixed Methods Research]] | 方法 | 融合科学方法的量化检验与质性情境诠释，实现对复杂教育现象的多视角[[Triangulation\|三角互证]]。 |
> | [[Randomised Controlled Trials]] | 方法 | 实验科学方法的黄金标准在教育领域的应用，通过[[Random Assignment\|随机分配]]控制无关变量以确认因果效应。 |
