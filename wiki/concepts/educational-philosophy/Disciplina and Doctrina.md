...
> - **用途**：帮助课程研究者辨析为什么某些改革（如跨学科[[Phenomenon-Based Learning|现象本位学习]]）容易在政策操作中退化为刻板的指标检测（即被 `disciplina` 侵蚀），并揭示课程背后的权力与知识再生产逻辑。
...
> 优秀的教育设计不能抛弃学科，因为学科分类是人类探索现象的历史沉淀，具备[[Ontology|本体论]]深度（disciplina）；但教学不能止步于此，必须引导学生围绕“[[Epochal Key Problems|时代关键问题]]”（如可持续性发展）开展跨学科的协同探索，激发知识的创造（doctrina）（[[Argument_Schaffar_2024_CogentEdu|Schaffar & Wolff, 2024, pp. 4–6, 10]]）。
