...
> [!def] 核心定义
> 实证主义（Positivism）是一种主张人类所有真正的知识都必须基于感官经验、系统观察与受控实验的哲学[[Epistemic Stances\|认识论立场]]。它坚决扬弃神学玄想与形而上学的第一因思辨，将自然科学的探究规范确立为人类知识的典范（Duncan, 1968）。实证主义不仅预设外部物理世界具有独立于观察者的客观规律，更坚信人类社会现象同样服从不可逆的[[Determinism\|因果决定论]]法则，因而可以通过客观测量与归纳推演建立普遍的实证定律。[[Argument_Cohen_Manion_Morrison_2011_Routledge_Ch01\|(Cohen et al., 2011, Ch. 1, p. 113)]]

在教育探究与社会[[Scientific Method|科学方法]]论中，实证主义构成了连接微观测量与宏观政策设计的认知底座。

> [!concept-lens] 概念透镜
> - **含义** 指向一种[[Objectivism\|客观主义]]、[[Empiricism\|经验主义]]与自然主义相统一的世界观，预设社会事实可以如同物理客体一样被客观测定与[[Causal Modeling\|因果建模]]。
> - **用途** 为教育量化调查、实验干预（如 [[Randomised Controlled Trials\|RCT]]）、大规模跨国测评（如 [[PISA]]）以及政策预测提供合法性辩护；确立[[Causality\|因果推断]]、可重复性与预测控制的方法论准则。
> - **边界** 实证主义擅长揭示[[Variable\|变量]]之间的经验共变与概率相关，但不适用于理解人类主体的内在意图赋义、主观生存体验、道德价值承诺以及阶级权力的深层压迫机制。
...
> [!boundary] 概念边界
> - **不等于纯粹经验主义（Empiricism）** 经验主义是一种主张[[Source of Knowledge\|知识来源]]于感官体验的认识论哲学，而实证主义则是一种更为庞大的系统性社会科学学说，它将经验主义与自然主义因果律、数学模型化以及社会重组的政治工程深度绑定。
...
将实证主义置于社会科学四大核心[[Paradigm|研究范式]]的谱系中，能够透视其[[Ontology|本体论]]、[[Epistemology|认识论]]与方法论的基本特征。

> [!contrast-table] 概念辨析
> | 维度 | 实证主义（Positivism） | 后实证主义（[[Postpositivism]]） | 诠释学范式（[[Interpretive Paradigm]]） | 批判理论（[[Critical Theory]]） |
> |:---|:---|:---|:---|:---|
> | **本体论前提** | 实在独立存在，遵循确定不变的客观因果律（幼稚实在论） | 实在客观存在，但由于人类局限只能被不完美地把握（[[Critical Realism\|批判实在论]]） | 现实由具有能动性的人类主体主观建构，具有多元情境意义 | 现实被历史、阶级、性别与权力结构所扭曲和固化 |
> | **认识论关系** | 主客严格二元分离，研究者保持中立客观镜像 | 观察带有理论负荷，追求渐进逼近真理与概率[[Falsification\|证伪]] | 研究者与对象处于“主体-主体”[[Dialogue in Education\|对话]]交往中，意义共生 | 认识论与政治利益不可分割，以反思批判与意识形态解构为导向 |
> | **研究旨趣与目标** | 解释（Erklären）、预测与有效[[Societies of Control\|控制社会]]规律 | 检验假说、证伪错误[[Hypothesis\|假设]]与构建概率模型 | 理解（Verstehen）、深度阐释与主观经验复原 | 解放（Emanzipation）、揭示压迫机制并促进社会正义变革 |
> | **典型方法论** | 大规模[[Questionnaire\|问卷调查]]、受控实验、统计回归与测量 | [[Quasi-Experimental Designs\|准实验设计]]、结构方程模型、[[Mixed Methods Research\|混合方法]]多重[[Triangulation\|三角互证]] | 参与式观察、[[In-depth Interview\|深度访谈]]、[[Narrative Analysis\|叙事分析]]与[[Epoché\|现象学还原]] | 批判性[[Discourse Analysis\|话语分析]]、[[Action Research\|行动研究]]、[[Ideology Critique\|意识形态批判]]与历史考掘 |
> | **主要批评或局限** | 抽空人类主体能动性，演变为去情境的技术极权 | 仍未摆脱[[Empiricism\|经验主义]]底色，难以回应深层规范价值命题 | 结论缺乏跨情境[[External Validity\|可推广性]]，容易陷入相对主义泥潭 | 带有强烈价值偏向，容易以政治正确替代严谨经验论证 |
...
>         A["客观实在与自然决定论<br>(Objective Reality & Determinism)"] --> B["感官观察与事实收集<br>(Empirical Observation)"]
>         B --> C["概念界定与操作化测量<br>(Variables & Operationalization)"]
>         C --> D["提出假说与因果模型<br>(Hypothesis & Causal Modeling)"]
>         D --> E["受控实验与统计检验<br>(Controlled Testing & Verification)"]
>         E --> F["确立普遍因果法则<br>(Laws & Generalizations)"]
>         F -->|"预测与社会控制"| A
>     end
>     subgraph 外部反思与挑战 [反实证主义批判]
>         G["诠释学与存在主义<br>(人类能动性与自我赋义)"] -.->|断裂| B
>         H["法兰克福学派批判理论<br>(科学主义与工具理性殖民)"] -.->|批判| F
>         I["19世纪古典启蒙现代性<br>(经验分类服从全人道德教化)"] -.->|伦理统摄| D
>     end
> ```
...
围绕实证主义的核心预设、历史变异及其[[Epistemology|认识论]]局限，学术界形成了四组关键理论命题。

### 命题一　经典实证主义确立了跨越自然与社会领域的方法论统一与普遍法则预设

> [!concept-lens] 跨领域方法论统一与法则概括
...
> [!concept-lens] 战后比较教育科学化运动与历史主义围剿
...
> [!concept-lens] [[Scientism\|科学主义]]批判与主体能动性遮蔽
...
实证主义从 17 世纪的归纳思想萌芽，历经启蒙现代性、工业革命体系化、20 世纪[[Paradigm|范式]]危机，直至当代新实证主义回潮，呈现出波澜壮阔的思想图景。
...
围绕实证主义的合法性限度与意识形态属性，学术界展开了持续至今的深刻论辩。

> [!debates] 学术争议
> 
> > [!axis] 自然主义[[Determinism\|因果决定论]] vs 人类行动主体的自我诠释
...
实证主义构成了连接[[Paradigm|研究范式]]、分析工具与政策治理的枢纽概念。

> [!entry-map]
> 
> | 条目 | 类型 | 贡献 |
> |:-----|:-----|:-----|
> | [[Scientific Method]] | 概念 | 为实证主义提供系统的操作程序，贯穿[[Hypothesis\|假设]]提出、[[Variable\|变量]]隔离与经验检验全流程。 |
> | [[Value Neutrality]] | 概念 | 构成实证主义[[Quantitative Research\|量化研究]]效度的核心规范，要求排除研究者主观价值与政治立场。 |
> | [[Postpositivism]] | 概念 | 对经典实证主义幼稚实在论的修正范式，引入理论负荷与概率[[Falsification\|证伪]]观念。 |
> | [[Interpretive Paradigm]] | 概念 | 作为实证主义的主要论敌，主张理解人类主观意图与情境意义建构。 |
