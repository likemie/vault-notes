...
> [!boundary]- 概念边界
> - **不等于客观性（Objectivity）** 客观性指向研究结论与外部实在经验事实的符合程度，而价值中立指的是研究者在推论过程中是否刻意清除了主观偏好的干预。
> - **不等于意识形态真空（Ideological Vacuum）** 批判社会科学指出，声称中立的尝试往往预设了现有社会体制的合理性，在客观实效上容易走向维护既得利益现状的意识形态立场。
> - **不适用于教育终极目的（Educational Ends）** 价值中立只能说明“特定手段能否达成既定技术目标”，根本无法回答教育“为了什么目的”（To what ends）、“为了谁的福祉”等核心规范伦理问题。

---

## 概念辨析

将价值中立与[[Educational Meliorism|教育改良主义]]、多重价值呈现以及批判解放立场进行对照，能够透视其[[Epistemology|认识论]]底色。

> [!contrast-table] 概念辨析
> | 维度 | 价值中立（Value Neutrality） | 教育改良主义（[[Educational Meliorism]]） | 多重价值呈现（Multi-value Stance） | 批判解放立场（Critical Emancipatory） |
> |:---|:---|:---|:---|:---|
> | **核心立场** | 排除一切主观偏好，追求无党派立场的客观事实 | 科学服务于伦理规范，以经验分类诊断社会病理 | 承认价值在行动中的首要性，系统呈现多方诉求 | 知识不可中立，研究应致力于揭露压迫与赋权弱者 |
> | **主要应用领域** | [[Positivism\|实证主义]]理论研究与数理统计分析 | 启蒙现代性早期公共教育建制与制度借用 | 项目评估（Evaluation）、公共政策咨询与社区规划 | [[Critical Pedagogy\|批判教育学]]、[[Feminist Research\|女性主义研究]]与后殖民话语解构 |
> | **研究者角色定位** | 超然的外部客观旁观者与纯粹裁判员 | 兼具实证严谨性与社会良知的全人道德[[Bildung\|教化]]者 | 协调者、呈现多元利益矛盾的系统记录员 | 具有鲜明政治立场的有机知识分子与社会批判者 |
> | **方法论[[Hypothesis\|假设]]** | 事实与价值可以且必须彻底二分 | 事实收集从属于道德哲学与全人教化目的 | 事实与价值深度交织，描述必然内嵌价值预设 | 声称中立即是伪装客观，实为维护既有权力秩序 |
> | **主要批评或风险** | 沦为为新自由主义数字审计背书的技术工具 | 先验道德假设容易削弱对反常经验数据的敏锐度 | 难以在冲突的价值立场中做出决定性的行动裁决 | 容易导致学术研究被政治意识形态完全绑架 |
...
围绕价值中立的历史起源、方法论合法性及其当代异化，学术界形成了四组核心理论命题。
...
价值中立在教育治理、评价工具与[[Epistemology|认识论]]思辨中占据着复杂的方法论位置。

> [!entry-map]
> 
> | 条目 | 类型 | 贡献 |
> |:-----|:-----|:-----|
> | [[Positivism]] | 概念 | 将价值中立确立为量化效度的核心基石，推行经验事实与规范价值的彻底分离。 |
> | [[Governing by Numbers]] | 概念 | 借助价值中立的客观数据修辞推行去政治化的量化问责与行政审计监控。 |
> | [[What Works Movement]] | 概念 | 宣称以价值中立的实证证据指导教学改良，排斥关于教育根本目的的民主辩论。 |
> | [[Educational Meliorism]] | 概念 | 与价值中立形成鲜明对照，主张教育研究天然具有诊断社会危机与改良道德的伦理使命。 |
