...
> [!claim] Cartiff et al.
> **因果干预对确定性信念的解构与提分机制** 认识论认知教学干预的元分析证实，打破学生将知识视为确定、绝对与现成答案的朴素信念，是撬动深层学业成就的关键认知机制。当干预通过指导式探究和证据确证训练，引导学生认识到科学知识是依赖经验证据不断修正的动态解释产物时，能够大幅促进高阶论证建构与概念理解，证实了解构绝对确定性信念在基础教育阶段的可教性与因果促进效能。[[Argument_Cartiff_2021_JEP|(Cartiff et al., 2021, pp. 485–488, 492)]]
...
> - **2021 年 — 认识论干预元分析确立解构确定性信念的因果提分价值** [[Argument_Cartiff_2021_JEP|Cartiff et al. (2021)]] 针对认识论认知干预展开首个因果元分析，实证证实以解构绝对确定性信念为核心的多维干预对学业成就具有中等强度促进效应（$d = 0.509$），中小学阶段效果显著，且在延时测试中持续发酵（$d = 0.966$）。
...
> |---|---|---|---|---|---|---|
> | [[Argument_Cartiff_2021_JEP\|Cartiff et al. (2021)]] | 干预靶向：包含解构知识确定性（由绝对固定到动态演进）的多维认知干预对学业成就的因果效应 | 28 篇（59 个效应量） / 4,373 | Cohen's $d$，随机效应模型 | 总体效应 $d = 0.509$ $[0.334, 0.684]$；延时后测 $d = 0.966$ $[0.802, 1.131]$ | $Q(58) = 459.739, p < .001$；延时组间 $Q_b = 16.737, p < .001$ | 证实解构知识绝对确定性信念并建立证据确证准则，能显著因果促进高阶论证与概念理解 |
...
> - [[Argument_Cartiff_2021_JEP|Cartiff et al. (2021)]] — 认识论干预因果元分析证实，以解构确定性信念、引导学生认识知识为证据推论动态产物的教学干预，对学业成就具有显著促进效应（$d = 0.509$），且在延时测试中效应持续翻倍。
