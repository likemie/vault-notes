...
> - **[[Immanuel Kant|康德]]**：《纯粹理性批判》区分了先验知识与后天知识。他通过纯粹思维推导出了心智范畴（量、质、关系、模态），声称人类心智装置总是通过这些范畴来理性地过滤经验([[Argument_Li_2012_Cambridge|Li, 2012, pp.25-26]])
> - **现代**：现代认识论动摇了知识的确定性，绝对真理的标准已变为概率性程度、模式和趋势。但 Li 指出，"我们在任何科学领域对任何事物的认知有多确定，仍然是区分可靠知识与不可靠信息的常用标准。而没有任何知识可以脱离可靠的推理来评估"([[Argument_Li_2012_Cambridge|Li, 2012, p.26]])
...
> 4. **真理的永恒性**：追求"永恒且精确的真理以及超感官的、可理解的世界"([[Argument_Li_2012_Cambridge|Li, 2012, p.24]])
> 5. **现代的延续**：即便确定性被现代认识论动摇，数学和逻辑推理在科学中的核心地位"至今不容置疑且可能在西方长久持续"([[Argument_Li_2012_Cambridge|Li, 2012, p.26]])
...
> [!warning]
> - Li 本人在书中对确定知识持审慎态度：现代认识论"将知识的确定性抛入怀疑"，但"基本问题"仍存在——"任何科学领域中的可靠知识与不可靠信息之间，仍需以确定性程度来衡量"([[Argument_Li_2012_Cambridge|Li, 2012, p.26]])
