...
> [!def] 核心定义
> **科学不确定性（Scientific Uncertainty）** 指在科学探究、实证测量、理论建构与预测推论过程中，由于客观世界的随机复杂性、测量工具的精度局限、样本抽样的代表性波动、理论模型的抽象简化以及人类认知条件的局限，导致科研产出的证据、假说与结论无法达到完全必然性与绝对确定性的[[Epistemology\|认识论]]与方法论状态。它既包括可通过收集更多数据予以缩减的“认知不确定性（Epistemic Uncertainty）”，也涵盖现实世界内在的“随机不确定性（Aleatory Uncertainty）”。在现代科学哲学与循证实践中，不确定性被视为科学探索的内在属性与知识动态演进的前提，而非研究质量低劣的表征。[[Argument_RoyalSociety_2026_ScienceForSociety\|(The Royal Society, 2026, pp. 61–62)]]

> [!concept-lens] 概念透镜
> - **含义** 指向科学知识的“暂定性（Provisionality）”与概率推论边界，即任何科学断言都依附于特定的样本、方法、模型[[Hypothesis\|假设]]与[[Confidence Interval\|置信水平]]。
...
> [!contrast-table] 科学不确定性核心维度与相近概念辨析
> | 维度 | 认知不确定性（Epistemic Uncertainty） | 随机不确定性（Aleatory Uncertainty） | 激进不可知论 / 虚无怀疑论（Radical Skepticism） |
> |---|---|---|---|
> | **本质属性** | 由于现有知识、测量技术或数据不足所致的主观认知局限 | 系统内部固有的客观随机性、混沌性与不可预测波动 | 彻底否认人类认知能力与科学真理可能性的哲学立场 |
> | **可缩减性** | **可缩减** 随样本扩大、观测精度提升与理论迭代逐步降低 | **不可缩减** 属于物理或社会系统的内在涨落，无法完全消除 | **无意义** 拒绝承认任何经验证据与反思缩减的有效性 |
> | **量化与表达方式** | 参数估计的[[Confidence Interval\|置信区间]]、模型后验分布、敏感性分析 | 概率密度函数、方差、随机误差分布项（Residuals） | 质问“一切皆是建构”，拒绝承认概率与置信层级 |
> | **应对与治理路径** | 资助多中心重复实验、大样本前瞻队列、[[Meta-analysis\|元分析]]证据合成 | 构建系统容错冗余、安全裕度设计、概率化风险预警 | 剖析其认知偏见，开展批判性[[Scientific Literacy\|科学素养]]与认识论教育 |
...
>   end
>   subgraph Path2["建设路径：透明不确定性沟通"]
>     C --> G["坦诚披露局限与假设前提"]
>     G --> H["公众理解科学暂定性与试错本质"]
>     H --> I["科学公信力稳固 + 批判性理性素养形成"]
>   end
> ```
...
### 命题一　科学不确定性是知识动态演化与假说自我修正的认识论内在属性而非瑕疵

> [!concept-lens] 科学哲学与知识演进机制
...
### 命题二　透明坦承科学不确定性不仅不会削弱社会权威，反而显著增进受众对科学家的诚实信任

> [!concept-lens] 证据沟通与受众认知心理机制
> 传统新闻编辑与机构公关普遍持有陈旧[[Hypothesis\|假设]]，误以为向公众告知“结论存在 95% [[Confidence Interval\|置信区间]]”或“尚有未解决的未知因素”会导致公众认知混乱甚至拒绝接受科学建议。这一假设在实证上已被现代传播心理学所颠覆。

> [!claim] Kerr et al. (2022)
> **透明披露对公众信任的正向增益** 针对数千名受众的大型在线代表性[[Randomised Controlled Trials\|随机对照实验]]表明，无论在报道中以数值形式列出置信区间，还是以定性词句明确指出研究的局限性与证据的不确定性，受众对核心事实的接受度不仅没有统计学意义上的滑坡，反而对研究团队与新闻报道的“诚实度（Honesty）”与“值得信赖度（[[Trustworthiness]]）”给予了显著更高的评价。[[Argument_RoyalSociety_2026_ScienceForSociety\|(The Royal Society, 2026, pp. 61–62)]]

> [!claim] [[Argument_RoyalSociety_2026_ScienceForSociety\|The Royal Society (2026)]]
> **虚假确定性营销对公共信用的毒化反噬** 为了追求媒体轰动效应而在新闻通稿中抹除研究局限、将初步动物实验夸大为人体确证疗效的做法，是导致公众产生反智怀疑主义的祸首；当后续临床实验修正或推翻早期被绝对化吹捧的成果时，受众会感到被欺骗，从而对整个科学共同体的信誉产生系统性动摇。[[Argument_RoyalSociety_2026_ScienceForSociety\|(The Royal Society, 2026, p. 62)]]

---

### 命题三　理解并接纳科学不确定性构成现代批判性科学素养与抵御虚假信息的核心分水岭

> [!concept-lens] 认知发展与课程素养机制
...
> | **算法伪确定性批判** | 算法伪确定性抹平证据冲突，诱发探究过早闭合与不确定性耐受力退化 | 人机协同探究、界面透明性设计与[[Problem Solving\|复杂问题解决]]学习 | Du & Yuan |
...
> - **2026 — 算法伪确定性批判与不确定性容忍度重塑** [[Argument_Du_Yuan_2026_AIS\|Du & Yuan (2026)]] 揭示[[Generative Artificial Intelligence\|生成式人工智能]]以表面流畅统一的回答抹平学术证据内在不确定性的机制，指出过度依赖算法将严重削弱学生对不确定性的耐受力，提出技术界面与教学设计必须显性化呈现不确定性与对立解释，将认识不确定性转化为培育深层评价判断的探究支架。

---

## 争议与批评

> [!debates] 科学不确定性的社会与治理争议
>
> > [!axis] 不确定性武器化（Weaponization of Doubt） vs 科学教条主义
...
> [!ref-table]- 科学不确定性沟通与受众认知实证数据表
> <span class="concept-other-empirical-table-marker" aria-hidden="true"></span>
>
> | 调研 / [[Experimental Research\|实验研究]] | 样本与情境特征 | 核心[[Variable\|变量]]与测量指标 | 关键实证数据 | 政策含义与理论洞见 |
> |---|---|---|---|---|
> | **Kerr et al. (2022) PNAS Nexus** | 英国与美国代表性成年公众大样本[[Randomised Controlled Trials\|随机对照实验]] | 披露不确定性（数值[[Confidence Interval\|置信区间]] vs 定性限定 vs 确定性断言）对受众信任的影响 | • 对事实可信度无显著负向影响（$p > .05$）<br>• 对科学家诚实度与报道透明度评价**显著提升** | 彻底推翻了“披露不确定性会破坏公众信心”的新闻界陈腐假定，为透明沟通提供金标准证据。[[Argument_RoyalSociety_2026_ScienceForSociety\|(The Royal Society, 2026, pp. 61–62)]] |
> | **[[Public Attitudes to Science\|PAS 2025 全英调查]]** | 英国代表性成年公众（$N = 5,281$） | 科学冲突信息感知与真实性信任 | • **48%** 受访者感到相互冲突的科学信息过多导致难辨真伪<br>• 仅 **40%** 认同所接触科学信息通常为真 | 表明当公众缺乏对科学不确定性与争论机制的理解时，多源冲突信息易引发受众认知迷茫与倦怠。[[Argument_RoyalSociety_2026_ScienceForSociety\|(The Royal Society, 2026, pp. 58–59)]] |
> | **Sumner et al. (2014) BMJ** | 20 所大学 462 篇科研通稿及 668 篇媒体报道追踪 | 通稿刻意抹除研究局限与夸大推论的比率 | • **33%** 通稿在缺乏因果设计下直接抹除相关性局限改写为因果结论<br>• 通稿抹除局限时媒体报道失真率暴增 **6.5–56 倍** | 确凿实证揭示高校科研公关部门刻意掩盖不确定性是大众媒介虚假夸大新闻的首要污染源。[[Argument_RoyalSociety_2026_ScienceForSociety\|(The Royal Society, 2026, p. 62)]] |
...
> - [[Argument_Du_Yuan_2026_AIS\|Du & Yuan (2026)]] — 阐明[[Generative Artificial Intelligence\|生成式人工智能]]抹平科学不确定性所导致的认知过早闭合与容忍度退化危机，提出在人机交互界面中显性表征不确定性与备择解释的治理路径。
