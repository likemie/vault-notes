...
> | 命题类型 | 核心指向 | 适用情境 | 代表学者 |
> |---|---|---|---|
> | **自组织微观生成命题** | 复杂全局秩序由底层行动者遵循的简单局部规则微观互动自发派生 | 复杂适应系统、学校[[Organizational Culture\|组织文化]]、计算仿真建模 | Waldrop; Lewin; Kauffman; Reynolds |
> | **整体不可还原命题** | 涌现的高阶整体具有全新属性与不可逆质变，不可向下分解还原 | 系统哲学、教育生态系统、宏观制度演变 | Davis & Sumara; Bar-Yam; Goodwin |
> | **质性方法论奠基命题** | 涌现公理统摄理论扎根生成与研究设计的实地动态演进 | [[Interpretive Paradigm\|自然主义探究]]、扎根理论、逐步聚焦策略 | Lincoln & Guba; Glaser & Strauss; Flick |
> | **实证因果解构命题** | 开放世界的动态涌现性彻底否定受控实验“保持变量恒常”的逻辑基础 | [[Randomised Controlled Trials\|随机对照试验]]反思、教育政策干预评估、方法论争鸣 | Morrison; Kuhn |
...
> |---|---|---|---|---|---|---|
> | [[Argument_Cohen_Manion_Morrison_2011_Routledge_Ch19\|Reynolds (1987) via Cohen et al. (2011)]] | 计算机拟合空间中的多主体鸟群群落 | 基于主体建模（[[Agent-based Modelling\|ABM]]）仿真实验 | 最小距离、速度匹配度、中心凝聚力三项局部规则参数 | 三条简单规则自发稳定涌现宏观集群飞行模式，碰撞率为 0 | 确定性算法下的非线性稳态 | 模拟虚拟空间中的生成秩序，推广至人类真实社会时需考虑反身能动性 |
> | [[Argument_Brady_2023_EPR\|Brady et al. (2023)]] | 2010–2020 年五本顶级教育心理学期刊（JEP, CE, AERJ 等）论文 | 历时性[[Document\|文献]]计量与方法学[[Coding in Qualitative Research\|编码]] | [[Qualitative Research\|质性研究]]占比与[[Recommendations for Practice\|实践建议]]（RFP）分布 | 质性研究占比由 2010 年的 9% 显著攀升至 2020 年的 22% | $p < .05$ | 验证了质性探究中涌现取向在主流心理学阵地中的合法性扩张 |
...
> | [[Interpretive Paradigm]] | 理论 | 为涌现提供[[Phenomenology\|现象学]]与主体间性[[Epistemology\|认识论]]支持，强调意义的动态流动生成。 |
> | [[Agent-based Modelling]] | 补充方法 | 研究宏观涌现现象的标准量化计算仿真工具，以微观主体规则派生全局秩序。 |
> | [[Grounded Theory]] | 补充方法 | 涌现原则在质性实操中的核心方法载体，确保概念与理论从实地数据中涌现。 |
> | [[Qualitative Research]] | 补充方法 | 依托[[Emergent Design\|涌现式设计]]与[[Progressive Focussing\|逐步聚焦]]策略，深入捕捉行动者情境中涌现的主观意义。 |
> | [[Randomised Controlled Trials]] | 替代方法 | 传统线性因果实验方法，假定[[Variable\|变量]]恒常，受到涌现动态实在论的深刻批判。 |
