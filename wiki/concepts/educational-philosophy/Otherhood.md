...
> - vs 慈善／利他主[[Rightness|义]] — 慈善和利他主义主要描述个体的道德行为；otherhood 是[[World Society Theory|世界社会理论]]中解释**组织层面**社会运作的机制性概念——它不依赖组织成员的道德品质，而是现代组织身份建构中的结构性特征（Zapp, 2022, p.149）
...
> - **为现代性原则（principles of modernity）行使代理权**：科学（尤其是社会科学）在追求方法论客观性的同时，不可避免地内嵌了倡导人权、民主和正[[Rightness|义]]的规范性原则——即自由社会的核心价值（Suárez & Bromley, 2012，引自 Zapp, 2022, p.149）。"我为'什么是对的'提供证据"——一位教育社会学家研究教育不平等，其研究设计追求方法论上的中立，但选择"不平等"作为研究对象本身就隐含了一个规范性立场：不平等是有问题的，需要被改变。Zapp 指出这就是 otherhood 在社会科学中的内置属性
...
> [!tip]
> - [[World Society Theory]] — otherhood 是世界社会理论的核心机制：由于世界社会缺乏传统的控制与权威机制，它本质上通过 otherhood 建构——即通过围绕进步与正[[Rightness|义]]等宏大目标的[[Cultural Models|文化模型]]扩散与模仿来运作（Meyer et al., 1997，引自 Zapp, 2022, p.149）
