...
> - **用途** 用于打破自上而下的灌输，提供认知冲突、反思脚手架与多元视角协商的互动载体。
...
> [!contrast-table] 对话教学与相近互动形态辨析
> | 维度 | 教育对话（Dialogue） | 传统课堂问答（IRE 模式） | 自由闲聊（Casual Chatting） |
> |---|---|---|---|
> | **互动结构** | 多向网状交流、共同探究与追问 | 教师起始（I）-学生应答（R）-教师评估（E） | 松散无结构的话题漫谈 |
> | **认知要求** | 阐明理由、审查[[Hypothesis\|假设]]、反思矛盾 | 检索并复述教师心中的标准答案 | 无特定认知目标或反思要求 |
> | **权力动态** | 民主平等的探究伙伴 | 教师垄断评价权与真理裁决权 | 纯社交对称关系 |
> | **教育功能** | 激发[[Critical Thinking\|批判性思维]]与深层理解 | 检查记忆与课堂纪律维持 | 情感联结与社交破冰 |
...
> - **教师引导类结构化对话** 教师提供即时反馈与认知脚手架，包括教师全班研讨、教师小组讨论、针对性启发提问与个别化指导。
...
>
> | 策略大类 | 编号与具体技术 | [[Operationalization\|操作化]]定义与教学特征 | 证据规模 $k$ | 效应量 $g+$ (95% CI) | 关联条目 / 代表[[Document\|文献]] |
> |---|---|---|---|---|---|
> | **教师引导类** | 2.1 教师针对性启发提问<br>（Teacher posing questions） | 教师使用高阶探究性提问激活学生深层思考与理由阐明 | $k = 19$ | $0.38$ $[0.21, 0.56]$ | [[Argument_Abrami_2015_RER\|Abrami et al. (2015)]] |
...
### 命题一　结构化对话是促进批判性思维技能发展的核心教学机制

> [!concept-lens] 认知与互动机制
...
> [!concept-lens] 组织与引导边界
> 探讨自由放任讨论与结构化对话之间的效果差异。

> [!claim] Abrami, P. C., et al.; King, A.
> **支架与规则决胜于放任漫谈** 实证数据表明，缺乏教师介入且无结构化支架的全班/结对漫谈效应极低（$g+ = 0.04–0.19$）；相反，当引入提问句干支架（学生提问 $g+ = 0.37$）、辩论规则约束（$g+ = 0.32$）或[[Socratic Dialogue|苏格拉底对话]]质询流程（$g+ = 0.27$）时，同伴互动的认知增益显著提升，证明对话必须依托明确的认知脚手架才能避免流于表层。[[Argument_Abrami_2015_RER|(Abrami et al., 2015, pp. 285–286)]]
...
> |---|---|---|---|---|---|---|
> | [[Argument_Abrami_2015_RER\|Abrami et al. (2015)]] | 干预因素：对话教学对通用[[Critical Thinking\|批判性思维]]技能的促进效应 | $k = 114$（实验组高于对照组） / $N = —$ | Hedges' $g+$ / 随机效应模型 | $g+ = 0.32$ $[0.23, 0.42]$ | $Q_b(1) = 4.53, p = .03$（对比无差异组 $g+=0.19, k=87$） | 严格纳入真实验与[[Quasi-Experimental Designs\|准实验设计]]；通用批判性思维标准化测试结果 |
...
> |---|---|---|---|---|---|---|
> | [[Argument_Abrami_2015_RER\|Abrami et al. (2015)]] | 干预因素 | 教师主导对话：教师全班讨论 vs 教师小组讨论 vs 教师提问 | 全班讨论 $k = 16$；小组讨论 $k = 14$；教师提问 $k = 19$ | 全班讨论 $g+ = 0.42$ $[0.20, 0.64]$；小组讨论 $g+ = 0.41$ $[0.19, 0.63]$；教师提问 $g+ = 0.38$ $[0.21, 0.56]$ | 均 $p < .001$ 显著大于 0 | 教师直接引导和结构化推进能够最大程度激活认知反思 |
> | [[Argument_Abrami_2015_RER\|Abrami et al. (2015)]] | 干预因素 | 学生自主互动与特定对话：无教师小组讨论 vs 正式辩论 vs [[Socratic Dialogue\|苏格拉底对话]] vs 学生自主提问 | 无教师小组 $k = 24$；辩论 $k = 8$；苏格拉底 $k = 8$；学生提问 $k = 4$ | 无教师小组 $g+ = 0.26$ $[0.09, 0.43]$；辩论 $g+ = 0.32$ $[0.03, 0.61]$；苏格拉底 $g+ = 0.27$ $[-0.01, 0.55]$；学生提问 $g+ = 0.37$ $[-0.02, 0.77]$ | 均大于 0 | 结构化规则（辩论）或自主提问句干脚手架显著优于无组织的自由讨论 |
