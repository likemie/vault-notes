...
> - **理论用途** 解释为何单纯向学校单向推送高严密性科研成果（Push）无法自发诱致教学变革，揭示接收端组织使能条件在知识有效转化中的瓶颈性制约。
> - **适用边界** 吸收能力深嵌于组织结构与人际网络中，不等于个体员工的孤立智力或单一检索技能；亦不能被简单化为一种可以脱离情境独立测度的静态技术指标。

> [!citation-card] Cohen & Levinthal 论吸收能力奠基定义
> 组织识别新外部信息的价值、吸收同化该信息并将其应用于商业目的的能力，对于企业的创新能力至关重要。（Cohen & Levinthal, 1990, p. 128）
>
...
> [!boundary]- 概念边界
> - **不等于 [[Implementation Fidelity|实施忠实度]]** 忠实度强调对既定方案指令的机械依从；吸收能力强调组织对外部证据的审慎理解、批判反思与因地制宜改编。
> - **不等于 本土[[Local Knowledge in Evidence-Based Policy|地方知识]]** 本土知识是学校与社区内部既有的经验与价值存量；吸收能力是组织将外部新知识与已有本土知识进行有机融合的转化机制。
> - **不等于 孤立的个体[[Research Literacy|研究素养]]** 研究素养偏重教师个体的[[Literature Search|文献检索]]与质量判断技能；吸收能力还依赖校级领导支持、互信文化与专有研讨时空等组织基础架构。
...
> | **低吸收力后果** | 盲从网络时髦、产生教工怨气或置之不理 | 评价报告被束之高阁，无法用于项目优化 | 合作无法提升企业创新，导致研发浪费 | 情报无法转化为全要素生产率增长 |
> | **关键机理解释** | 组织使能决定外部证据能否内化为行动 | 组织学习条件改善证据使用机会 | 吸收能力差的企业被系统排斥在资助外 | 接近前沿的部门受益最大，证实认知基础前提 |

---

## 核心要素

跨领域研究表明，吸收能力并非单一技能，而是由认知基础、沟通架构、领导示范与资源保障构成的系统性网络。
...
> ```mermaid
> flowchart LR
>     A["外部新知识 / 学术研究证据"] --> C["组织吸收能力系统<br>认知存量 · 开放沟通 · 领导示范 · 工时保障"]
>     B["已有本土经验与实践智慧"] --> C
>     C --> D["知识同化与批判性情境调适"]
>     D --> E["实践终端应用与创新产出"]
>     E -.生成内生认知存量.-> C
...
### 命题一　外部知识的实践价值无法自发实现，其有效转化受制于组织既有认知存量与内部沟通架构

> [!concept-lens] 认知基础与沟通通道机制
...
### 命题二　在教育知识动员中，单向供给推送无法替代以吸收能力为核心的需求牵引与组织使能条件

> [!concept-lens] 需求牵引与学校吸收使能
...
### 命题三　产学研发与技术转移中，吸收能力呈现马太效应并对合作创新绩效具有决定性调节作用

> [!concept-lens] 协同创新与吸收能力调节
