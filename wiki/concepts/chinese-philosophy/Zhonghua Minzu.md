...
> [!def] 核心定义
> 中华民族（Zhonghua Minzu / Chinese nation）是一个现代民族建构概念，最初由梁启超（Liang Qichao）于 1902 年引入，用以指代涵盖中国境内所有 56 个民族的单一国族共同体。1988 年，社会学家[[Fei Xiaotong|费孝通]]（Fei Xiaotong）在其经典的“多元一体格局”（duoyuan yiti）论述中对其进行了重构，强调中华民族作为一个整体是一体，内部 56 个民族是多元。这一定义试图将一个宪法上界定为多民族国家的中国，转变为一个具有“族裔”多样性的单一“国族”。([[Argument_Bulag_2024_CE|Bulag, 2024, p. 101]])

> [!concept-lens] 概念透镜
> - **含义** 该概念指向中国官方主导的、以汉文化为核心并吸纳所有少数民族的单一国族共同体建构。
> - **用途** 协助研究者分析中国民族政策的演变轨迹、教科书历史话语的建构模式，以及推广国家通用语言等整合政策的合法性基础。
> - **边界** 不等于汉族或特定的少数民族，后者被官方定义为构成中华民族多元要素的从属元素。
...
> | **领土性质** | 领土是表达性的（可变的），取决于汉文化的扩张范围 | 领土是构成性的，自远古以来相对固定 |
> | **各族关系** | 汉文化居于中心与同化主体，周边群落被动融入 | 56个民族平等且历史上共同居住在这片土地上 |
...
> [!debates] 学术争议与政治交锋
> 
> > [!axis] “[[Second-generation Ethnic Policy|第二代民族政策]]”与熔炉同化
> > - **胡鞍钢 (Hu Angang) 和胡联合 (Hu Lianhe)（2011）**：提出以“交往、交流、交融”为核心的第二代民族政策，主张模仿美国的国族“熔炉”同化模式，废除民族区域自治制度。这一主张模仿的是已被西方抛弃的陈旧熔炉同化论，而非现代多元文化主义。([[Argument_Bulag_2024_CE|Bulag, 2024, pp. 102–103]])
> 
> > [!axis] 概念转换中的“非意图合谋”
> > - **中西学界的概念置换** 西方学界推动以“族群（ethnicity/zuqun）”取代宪法中的“民族（nationality/minzu）”以解构国家阶级大叙事，却在客观上被中国同化政策学者挪用为废除民族自治权的依据，即“既然民族是建构的假实体，就可以通过政策予以拆除”，达成非意图的话语合谋。([[Argument_Bulag_2024_CE|Bulag, 2024, pp. 101–103]])
> 
> > [!axis] 新清史与文明底色的冲突
> > - **清朝身份的主权争议** 中华民族的历史大叙事无法容忍新清史学者强调清朝满族统治者的内陆亚洲特异性身份的研究，官方将其定性为西方意图“分裂中国”的学术阴谋。([[Argument_Bulag_2024_CE|Bulag, 2024, p. 106]])
> - **社会主义与文明传统的张力** 以彻底反传统起家的中共，今天试图通过提倡“中华优秀传统文化”和修复性怀旧来重构国族身份，其时间结构中存在着逻辑上的根本断裂。([[Argument_Bulag_2024_CE|Bulag, 2024, p. 104]])
