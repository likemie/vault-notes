...
> [!abstract]
> 五种关系及对应德目([[Argument_Li_2012_Cambridge|Li, 2012, pp.38-39]])：
...
> [!abstract]
> **家庭关系的优先性**：前三种关系位于家庭内部，被[[Confucius|孔子]]及其追随者视为"最重要"的——"如果不能在家庭关系中获得成功，一个人不太可能达成其他两种关系"([[Argument_Li_2012_Cambridge|Li, 2012, p.38]])。
...
> [!example]
> **关系的相互性（mutuality）**：每种关系都不是单向的义务，而是双向的。如父子关系中，"无条件的爱和孝道是相互构成的。道德义务在于这种相互性之中"([[Argument_Li_2012_Cambridge|Li, 2012, p.38]])。这意味着父母对子女的慈爱与子女对父母的孝敬是对等的道德义务，而非单方面的服从。

> [!example]
> **敬 ≠ 社会礼仪或政治服从**：夫妇关系中的"敬"，不是西方意义上的 [[Affect-Respect and Ought-Respect|ought-respect]]（基于政治和法律权利的、面向所有人的尊重），而是 affect-respect——一种"尊重对方为完整的人，同时表达爱与钦佩"的情感性尊重([[Argument_Li_2012_Cambridge|Li, 2012, p.39]])。

> [!example]
> **信 ≠ 表面的信任**：友谊中的"信"，其儒家强调在于对友谊的承诺和使友谊持久的方式——"相信朋友能经得起好与坏的时光（荣辱与共，共患难），这种信任在理想条件下不取决于实际相处的时间、物理距离、情感波动和环境变化"([[Argument_Li_2012_Cambridge|Li, 2012, p.39]])。
...
> [!warning]
> - 五伦中的等级因素（父子、夫妇、兄弟间的尊卑）在现代平等主义框架下面临张力。但 Li 强调，儒家传统中的关系义务是相互的，而非单向的服从——"这些义务将持续一生"，且以"滋养彼此的福祉"为目的([[Argument_Li_2012_Cambridge|Li, 2012, p.38]])
