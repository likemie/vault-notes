...
```mermaid
flowchart LR
    Content["<b>学科核心知识情境</b><br>(如历史史料、科学实验)"] --> Hook["<b>显性思维概念引入</b><br>(如'何为可信证据/认知偏误')"]
    Hook --> Scaffold["<b>脚手架结构化探究</b><br>(思维句干、质疑清单、论辩图)"]
    Scaffold --> Meta["<b>元认知自观复盘</b><br>(反思思维策略在学科中的有效性)"]
```
