...
> [!info] 定义
> Epochal Key Problems（时代关键问题）是 [[Wolfgang Klafki]] 在 [[Didaktik]] 传统中提出的课程组织思路：课程规划不应只问"未来需要哪些可预设知识和技能"，而应围绕当代人类共同面对的重大问题来组织学习，例如环境危机、社会不平等和战争([[Argument_Schaffar_2024_CogentEdu|Schaffar & Wolff, 2024, pp.6-7]])。
>
> 这一概念的核心不是把重大问题当作跨学科装饰，而是用它们连接学科深度与跨学科广度。复杂问题要求学生理解不同学科内部的知识结构，同时能在多个知识传统之间移动、提问、论证和协作([[Argument_Schaffar_2024_CogentEdu|Schaffar & Wolff, 2024, p.7]])。
...
> - **学科深度与跨学科广度并行** 时代关键问题要求学生既进入学科内部逻辑，也跨越学科边界处理复杂现实。
