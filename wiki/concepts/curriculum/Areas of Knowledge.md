...
> | **课程功能** | 保证广度并容纳专业深度 | 提供具体[[Knowledge Production\|知识生产]]情境和比较对象 | 解释知识形成与审查所调用的资源 | 组织论文和展示的中心问题 | 规定[[Domain Analysis\|领域分析]]的共同维度 |
> | **主要关系** | 为 TOK 提供多学科经验材料 | 为认知方式提供领域标准 | 跨越多个领域参与[[Knowledge Building Theory\|知识建构]] | 调动 AOK and WOK 形成[[Epistemology\|认识论]]论证 | 使跨领域比较围绕一致问题展开 |
...
[[Gerard Renaud|杰拉德·雷诺]]（Gerard Renaud）和迪娜·德雷福斯（Dina Dreyfus）把法国哲学传统转化为国际课程的初始形态。第四版《[[International Baccalaureate|国际文凭]]总指南》所列八个板块显示，早期结构把语言与逻辑、学科知识形式、价值判断和真理问题放在同一框架中，尚未形成整齐的学科目录。[[Argument_Peterson_1987_OpenCourt_Ch03|Peterson (1987, Ch. 3, pp. 46–48)]]
...
> | **与个人知识的互动** | 共同体知识如何进入个人经验，个人位置又如何影响理解 | 认知者的经验、身份和责任如何参与[[Knowledge Building Theory\|知识建构]] |
>
...
> |---|---|---|---|---|---|---|
> | [[Argument_Kuhn_2000_CD\|Kuhn et al. (2000, pp. 316–319)]] | 研究一 N=129，含五年级至成人及教育哲学专家 | 跨年龄横断比较；15 对冲突主张，覆盖五个判断领域 | 各领域的绝对论、多元论、评价论水平及跨领域组合 | 107 人，占 83%，呈现符合理论顺序的跨领域模式；统一模式中 MMMM 为 37 人、EEEE 为 13 人、AAAA 为 2 人 | 原文未报告本条结果的[[Confidence Interval\|置信区间]]或显著性检验 | 频数支持领域差异具有系统顺序，横断设计不能证明个体随时间按同一路径发展 |
...
> | [[Argument_Kuhn_2000_CD\|Kuhn et al. (2000, pp. 324–325)]] | 本科生、社区大学成人、工商管理高级管理人员硕士及教育哲学专家 | 群体间描述性比较 | 物理事实与价值观领域达到评价论的比例 | 工商管理高级管理人员硕士组在物理事实和价值观领域分别为 44% 与 22%，教育哲学专家组分别为 100% 与 80%；年龄和一般学历未自动消除价值判断领域的多元论停滞 | 专家组 n=5，原文未报告置信区间或正式组间检验 | 群体教育背景差异与[[Sample Size Determination\|样本量]]限制了因果解释，结果只能支持训练与领域表现相关 |
