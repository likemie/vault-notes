...
> [!def] 核心定义
> 知识领域是 [[International Baccalaureate|IB]] [[Theory of Knowledge|知识论]]课程中对主要知识传统的分类框架，用于考察不同领域如何界定研究对象、形成概念、生产证据、选择方法并建立判断标准。课程以我们如何知道为中心追问。2013 年指南列出数学、自然科学、人文科学、历史、艺术、伦理、宗教知识体系和本土知识体系八个领域，并把它们视为人类建构知识的主要[[Champ|场域]]。[[Argument_Darwish_2009_Queens|(Darwish, 2009, p. 17)]] [[Argument_Hughes_2014_JRIE|(Hughes, 2014, p. 36)]]

> [!concept-lens] 概念透镜
> - **含义** 知识领域把学科和知识传统转化为可比较的[[Epistemology|认识论]]情境，关注各领域如何获得、验证和组织知识。
> - **用途** 它帮助学生比较证据、方法、概念和解释标准，识别领域差异及跨领域的共同问题。
> - **边界** AOK 是课程分类，未必等同于学校科目、大学院系或封闭的知识领地。领域之间共享方法、概念和[[Ways of Knowing|认知方式]]，其边界具有历史性和可渗透性。
...
> [!claim] Hughes, C.
> **领域具有不同的知识生产方式** 2013 年指南把 AOK 描述为人类建构知识的主要领域，并要求学生通过范围、概念、方法、历史及个人知识互动进行考察。领域差异由研究对象、正当化规则和知识共同体共同形成，因而会改变同一主张所需的证据和解释标准。[[Argument_Hughes_2014_JRIE|(Hughes, 2014, pp. 36, 38–39)]]
...
> [!claim] Hughes, C.
> **领域标签可能制造排他性认识论** 过度强调领域特异性会产生数学等于推理、艺术等于表达、科学等于[[Falsification|证伪]]等简化判断。这类标签压缩领域内部多样性，也遮蔽信念、创造、解释和模型在多个领域中的共同作用，限制迁移与更广阔的概念理解。[[Argument_Hughes_2014_JRIE|(Hughes, 2014, p. 39)]]
