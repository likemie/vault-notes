...
> [!warning] 证据使用与道德侧步
> 尽管研究证据高度一致地不支持选择性教育，Bainbridge et al.（2022）发现英国议会辩论中政策制定者系统性地回避这些证据，转而使用道德侧步（[[Moral Sidestep]]）——将文法学校等同于 Ofsted 评级意义上的、进而道德意义上的"好学校"。保守党议员在议会辩论中将文法学校与"好学校"关联的频率远高于工党议员（125 次 vs 30 次），表明这一话语策略具有明显的党派属性（Bainbridge et al., 2022, p.15）。
...
> [!example] 相关案例／政策
> - [[Selective Schools Expansion Fund 2018]] — 保守党政府允许现有文法学校扩展的 £50M 基金
