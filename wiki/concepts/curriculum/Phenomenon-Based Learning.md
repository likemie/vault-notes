...
> [!concept-lens] 概念透镜
> - **含义** 该概念指向以生活世界中的现象体验为起点，通过跨学科与学科深度的协同，建构对现实世界复杂问题的认知与社会性理解。它以现象学（Phenomenology）为底色，认为“现象”是主体在以意向性（Intentionality）为特征的意识与生活世界（Lifeworld）中所体验到的意义整体，绝非价值中立的客观实体，且包含具身认知（Embodied cognition）与主体间性（Intersubjectivity）的情感和社交特征。[[Argument_Schaffar_2024_CogentEdu|Schaffar & Wolff, 2024, pp. 2–4]]
...
> - 不适用于去情境化的机械训练 — 它反对脱离学生生活经验的碎片化技能原子化训练。[[Argument_Schaffar_2024_CogentEdu|Schaffar & Wolff, 2024, pp. 9–10]]

> [!citation-card]- 关键表述
> 现象学学习观将学习视为具身的、情绪化的和 experimental 的，而非能够被量化或项目化的东西。[[Argument_Schaffar_2024_CogentEdu|(Schaffar & Wolff, 2024, p. 4)]]
>
...
> - **跨学科深度的关键（Critical Realism 视角）**：批判现实主义主张，学科理论是人类探索生活世界不同现象过程中沉淀出的理论秩序，具备自身的本体论深度（Ontological depth）。PhBL 并非通过消解学科来减负，而是通过“现象”将 `disciplina` 与 `doctrina` 有机整合。[[Argument_Schaffar_2024_CogentEdu|Schaffar & Wolff, 2024, p. 5]]
...
> - **跨学科整合与学科深度协同**：反对学科的自我封闭，但强调每门科目具有其独特的理论结构与本体论深度，跨学科探索应当是学科深度的横向协同，而非学科逻辑的消解。[[Argument_Schaffar_2024_CogentEdu|Schaffar & Wolff, 2024, pp. 3–5]]
> - **生活世界与经验体验的嵌入性**：强调学习主题应直接关联学生的邻近环境，释放反思性主体能动性（Agency），使知识建构基于活泼的日常经验。[[Argument_Schaffar_2024_CogentEdu|Schaffar & Wolff, 2024, pp. 2, 4]]
> - **具身经验与主体间性情绪整合**：遵循 Merleau-Ponty 现象学，将身体感官经验与实践置于纯粹智力认知之前；同时关注主体间性（Intersubjectivity）的社交与情绪交互，如信任、尊重、困惑、怀疑及关系焦虑。[[Argument_Schaffar_2024_CogentEdu|Schaffar & Wolff, 2024, p. 4]]
...
> [!concept-lens] 现象学体验与反思性主体生成
> 这类命题关注现象本位学习（PhBL）在哲学层面的本源目的，强调其作为连接学生“生活世界”、激发反思性主体能动性以及重审教育意义的教学入口。

> [!claim] Rauste-von Wright, M.
> 现象本位学习作为一种“自我修正的课程模型”，将 John Dewey 的反思性探究与 George Herbert Mead 的具身社会互动论融合为实用主义建构主义（Pragmatic Constructivism）。它主张教学应当从预设的课程大纲导向转向基于学生自身世界观的生成，将学习视为“情境化与语境化的互动过程”，以弥合理论与实践的传统鸿沟。[[Argument_Schaffar_2024_CogentEdu|Schaffar & Wolff, 2024, pp. 7–8]]
...
> [!concept-lens] 跨学科深度与新自由主义技能原子化
> 这类命题关注现象本位学习在实施过程中的边界条件与政策拉扯，聚焦在跨学科整合中如何维护学科自身的本体论深度，以及如何抵御新自由主义下的技能原子化侵蚀。

> [!claim] Wheelahan, L.
> 跨学科探究必须以尊重学科自身的内在理论逻辑与本体论深度为前提。学科理论是人类探索世界不同维度的历史积淀与系统化秩序，若将系统知识拆散为碎片化的能力指标或活动模块，将侵蚀学科的内在教育价值。[[Argument_Schaffar_2024_CogentEdu|Schaffar & Wolff, 2024, p. 5]]

> [!claim] Klafki, W.
> 政策制定者与教师无法预测未来学生所需的具体知识、认知与态度。为防止课程降维为对科学知识的狭隘简化，教学必须围绕“时代关键问题”（如环境危机、社会不平等、战争）来组织，以此作为统合学科深度与跨学科广度的 Didactic 工具。[[Argument_Schaffar_2024_CogentEdu|Schaffar & Wolff, 2024, pp. 6–7]]

> [!claim] Schaffar, B., & Wolff, L.-A.
> 现象本位学习在政策化与课程化过程中面临“整体性教化理想”与“新自由主义绩效治理”之间的内在对立。全球绩效问责制与 OECD 21世纪技能政策话语正试图通过指标化和测量技术将课程知识“原子化”为细碎可控的技能包，从而阉割了 PhBL 探索未知和生活世界整体体验的批判潜能。[[Argument_Schaffar_2024_CogentEdu|Schaffar & Wolff, 2024, pp. 9–10]]
...
> | 命题类型 | 核心指向 | 适用情境 | 代表学者 |
> |---|---|---|---|
> | **现象学与教化逻辑下的教学设计与目的** | 视学习为在生活世界中通过具身互动与反思重建世界观、唤醒主体能动性并重新追问教育意义的过程 | 教师教育中的教学设计反思、反思性探究项目设计 | Rauste-von Wright, M.; Schaffar, B., & Wolff, L.-A. |
> | **学科深度与全球治理的工具化张力** | 主张以学科本体论深度和时代关键问题为跨学科整合前提，批判新自由主义测量将知识技能原子化 | 评估跨学科课程设计、批判基于全球教育治理（如 OECD 指标）的技能课程改革 | Wheelahan, L.; Klafki, W.; Schaffar, B., & Wolff, L.-A. |
...
> - **2014年 — 芬兰国家课程政策化**：芬兰正式发布《基础教育国家核心课程 2014》（瑞典语与芬兰语版），将跨学科探究与现象本位作为实现课程核心价值的官方推荐教学取向，但在学校实施中呈现极高异质性。[[Argument_Schaffar_2024_CogentEdu|Schaffar & Wolff, 2024, p. 2]]
...
> 
> > [!axis] 整体教化价值与横向能力测量的工具化张力
> > PhBL 扎根于现象学和欧陆教化（Bildung）传统，旨在培养面对未知开放未来的主体自治性。但其在课程化过程中遭遇了新自由主义绩效管理（Performativity）的侵蚀。以 OECD 和欧盟为代表的21世纪技能政策话语倾向于将知识与技能原子化为可量化的绩效指标，这使得 PhBL 的整体教学理想面临被碎片化和工具化的风险。[[Argument_Schaffar_2024_CogentEdu|Schaffar & Wolff, 2024, pp. 9–10]]

> [!warning] 适用局限
> - **概念定义的模糊性与实施的高异质性**：芬兰国家核心课程文本中并未给 PhBL 提供统一、清晰的操作性定义。这导致各地区学校和教师在实践转译中呈现极高的实施异质性。[[Argument_Schaffar_2024_CogentEdu|Schaffar & Wolff, 2024, pp. 2, 10–11]]
