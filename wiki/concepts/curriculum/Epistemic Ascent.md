...
> [!info]
> 认识论上升（Epistemic Ascent），也称概念进阶（Conceptual Progression），指学习者在学科中从具体经验向抽象概念逐步发展的认知过程。这一概念强调课程设计应为学生提供从具体到抽象、从经验到理论的清晰路径，使学生能够掌握学科的概念性认知方式([[Argument_McPhail_2023_JCS|McPhail et al., 2023]])。
...
> [!abstract]
> - **从具体到抽象**。认识论上升强调学习者应从具体的经验和事实逐步发展到抽象的概念和理论。这一过程不是自然发生的，而是需要通过精心设计的课程和教学来实现([[Argument_McPhail_2023_JCS|McPhail et al., 2023]])。
