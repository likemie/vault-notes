...
> - **边界** 核心在于**缺乏显性化规则（Non-explicitness）** 它与“[[Infusion Approach|学科融入模式]]”拥有相同的学科载体，但排除了显性思维[[Scaffolding|脚手架]]与[[Metacognition|元认知]]总结。
...
```mermaid
flowchart TD
    Task["<b>高难度学科任务</b><br>(沉浸于专业术语与事实细节)"] --> CogLoad["<b>极高内在认知负荷</b><br>(工作记忆被学科知识占满)"]
    CogLoad --> NoMeta["<b>缺乏显性思维脚手架</b><br>(无通用规则指导，试错归因盲目)"]
    NoMeta --> PoorTransfer["<b>无法实现抽象概念提取</b><br>(思维停留在当前学科，无法跨情境迁移)"]
```
