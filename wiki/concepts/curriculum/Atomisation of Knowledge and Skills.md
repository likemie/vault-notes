...
> [!info] 定义
> Atomisation of Knowledge and Skills（知识与技能的原子化）指在测量、问责和经济竞争逻辑下，教育内容被拆解为可评估、可比较、可交易的小单位。知识不再被理解为有内部结构、历史脉络和教育意义的整体，而被处理成可按外部目的任意组合的事实、技能或能力碎片([[Argument_Schaffar_2024_CogentEdu|Schaffar & Wolff, 2024, p.10]])。
>
> 在课程政策中，原子化常与标准化学习结果、能力本位课程和问责体系结合。它能提高治理和评估的可操作性，却可能削弱学科知识的内部逻辑、学生生活世界的意义，以及教育作为自我形成和共同体建设的内在目的([[Argument_Schaffar_2024_CogentEdu|Schaffar & Wolff, 2024, pp.9-10]])。
...
> - **知识被拆成项目** 知识被理解为小块事实或技能，可按个人或制度目的像拼图一样组合，而不是作为有内在理论结构的学科整体。
...
> - **共同学习被竞争替代** 原本面向共同责任和社区未来的教育，可能被转化为个体之间、学校之间和国家之间的竞争。
...
> - vs [[Phenomenon-Based Learning]] — PhBL 的整体取向试图把学科知识、生活世界和复杂问题重新连接起来；知识原子化则把这些关系拆散为可测单位([[Argument_Schaffar_2024_CogentEdu|Schaffar & Wolff, 2024, pp.9-11]])。

## 理论基础

> [!info] 理论基础
> - [[Phenomenology]] — 现象学把学习理解为具身、情感、认知和响应性的动态过程，反对把学习量化或项目化([[Argument_Schaffar_2024_CogentEdu|Schaffar & Wolff, 2024, pp.3, 10]])。
> - [[Bildung]] — Bildung 强调教育有自身目的，不能只服务外部经济或政策目标([[Argument_Schaffar_2024_CogentEdu|Schaffar & Wolff, 2024, pp.10-11]])。
> - [[Critical Realism]] — Wheelahan 的课程论强调学科知识有内部理论结构，不能随意拆成能力碎片([[Argument_Schaffar_2024_CogentEdu|Schaffar & Wolff, 2024, p.5]])。
