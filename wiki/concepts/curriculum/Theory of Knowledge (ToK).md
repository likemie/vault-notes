...
> [!finding-cards]
> 1. **年级间增长显著** 在 1,338 名澳大利亚 ToK 学生中，12 年级学生在[[Critical Thinking|批判性思维]]策略量表（CTSS）总分和 14 项技能中的 11 项上显著高于 11 年级学生（Cole et al., 2015, pp.8–9）。
> 2. **DP 毕业生的批判性思维倾向更强** 在加州批判性思维倾向问卷（CCTDI）的全部七个维度上，DP 毕业生的平均分均高于非 DP 毕业生（p.12）。
> 3. **DP 毕业生的大学准备度更高** DP 毕业生的 ATAR 分数（M=94.13 vs 89.29）、学术自我概念和预期大学成果均显著高于非 DP 毕业生（p.12）。
