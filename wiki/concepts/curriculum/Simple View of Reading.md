...
> - O'Connor（2020, p.148-149）暗示 Hattie 在 *Visible Learning* 中对全语言的负面评估可能受到简单阅读观的隐性影响——例如 Hattie 未经解释地将"理解"与"阅读"区分为不同的计算机教学类别，以及断言"语音教学通常先于理解"

## 争议与批评

> [!warning] 争议与批评
> - **Proctor（2006, p.1）**：许多研究者认为简单阅读观"过于简单，无法在理解个体学习者给阅读过程带来的巨大复杂性方面产生有意义的差异"（O'Connor, 2020, p.149）
> - **全语言理论家的反驳**：阅读并非先解码后理解，而是读者从一开始就同时使用语义、句法和字形线索（graphophonic cues）建构意义——意义的追求驱动解码，而非相反
