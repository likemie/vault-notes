...
> - **成本约束（红方）** 语言考试是年度考试中最复杂的部分，汇率、人员和高峰期文书成本迫使 IBO 放弃部分听力测验。把行政转往英国提高了可交付性，却没有消除效度与成本之间的取舍。[[Argument_Peterson_1987_OpenCourt_Ch04|Peterson (1987, Ch. 4, pp. 86, 91–92)]]
