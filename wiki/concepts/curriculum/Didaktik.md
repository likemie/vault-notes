...
> 
> 在 Gruschka (2019) 的框架中，教学设计是由 Didaktik（教学论）、[[Bildung]]（教化） 与 Erziehung（教育，指向教化目标的过程定位）三者共同构成的整合性星座（Integrated case of constellation）。教学论在此指教师决定哪部分知识在什么时间点、以什么数量以及如何向学生呈现的具体安排方式。[[Argument_Jornitz_2022_Bildung_algorithmic|Jornitz & Klinge, 2022, pp. 238–239]]
...
> - **[[Epochal Key Problems|时代关键问题]]作为课程主轴** Klafki 提出以时代关键问题（Epochal key problems）作为课程组织原则（如环境危机、社会不平等和战争危机），以此作为统合学科深度与跨学科合作的教学[[Champ|场域]]。[[Argument_Schaffar_2024_CogentEdu|Schaffar & Wolff, 2024, pp. 6–7]]
> - **学科[[Ontology|本体论]]深度的保护** 强调学科知识拥有自身的内在结构与逻辑脉络，反对能力本位课程将系统知识拆散为细碎、可测量的技能包。[[Argument_Schaffar_2024_CogentEdu|Schaffar & Wolff, 2024, p. 5]]
...
> [!claim] Wheelahan
> [[Discipline-Based Theory|学科理论]]知识并非人为的任意碎片，而是具有深层因果脉络的理论体系。课程必须维护学科自身的本体论深度与逻辑完整性，任何将系统知识拆散为横向能力或技能指标清单的能力本位改革都会损害其教化价值。[[Argument_Schaffar_2024_CogentEdu|Schaffar & Wolff, 2024, p. 5]]
...
> [!claim] Gruschka (2019)
> 教学设计是一个由 Didaktik（教学论）、Bildung（教化） 与 Erziehung（规范教育）共同构成的整合性星座（Integrated case of constellation），教师必须基于特定内容在具体时间点以何种安排方式向学生呈现，来做出教学判断。[[Argument_Jornitz_2022_Bildung_algorithmic|Jornitz & Klinge, 2022, pp. 238–239]]
...
> | **教学判断与行动机制的分野** | 关注教师在规训/生成、内容/教化/规范之间的复杂[[Professional Judgment\|专业判断]] | 剖析数字化背景下的绩效主义以及标准化教学评估 | Gruschka; Schaffar & Wolff |
...
> [!dev-timeline] 发展脉络
> - **中世纪大学时期 — 规训与生成的词义分化** 欧洲教学实践中形成 disciplina（侧重训诫与纠错）与 doctrina（侧重[[Knowledge Production|知识生产]]）的二元区分。[[Argument_Schaffar_2024_CogentEdu|Schaffar & Wolff, 2024, p. 6]]
> - **19世纪初 — 德国教学论在芬兰的发展** 伴随 Snellman 对[[Bildung|教化]]观的推动，德国教学理论开始影响芬兰的教师教育和学术构建。[[Argument_Schaffar_2024_CogentEdu|Schaffar & Wolff, 2024, p. 6]]
> - **20世纪末 — 批判建设性教学论转向** [[Wolfgang Klafki]] 提出[[Epochal Key Problems|时代关键问题]]假说，旨在通过重组课程结构，使教育能直面社会的全球性正义与危机。[[Argument_Schaffar_2024_CogentEdu|Schaffar & Wolff, 2024, p. 6]]
