...
> [!example]
> 一个学生在 [[Online Self-Assessment|OSA]] 中完成了一系列[[Questionnaire|问卷]]和认知测试。系统生成了一个报告——"你的[[Language Skills|语言能力]]得分：78/100；文化兴趣得分：92/100；数学推理得分：65/100"。这个数字组合不是该学生的"本质"——它是在特定的测量框架下、通过特定的分类和算法处理后被生产出来的一个简化版本。但学生很可能说"我的 OSA 结果是 78 分"——将这些数字接受为"自己"的组成部分。这就是数字自我的主体化运作。
...
数字自我与 [[Societies of Control|控制社会]] 的权力运作紧密相连([[Argument_Thompson_2022_Promising_Student|Thompson et al., 2022, pp.225–226]])：
...
- Deleuze 关于主体化通过调制实现的论断在此得到体现：学习平台和 [[Online Self-Assessment|OSA]] 收集并自动分析学生的兴趣、期望、动机和认知技能数据，将它们[[Assemblage|组装]]成特定的"画像"（picture）——这就是调制在主体层面的运作([[Argument_Thompson_2022_Promising_Student|Thompson et al., 2022, p.226]])
...
> [!example]
> - [[Online Self-Assessment]] — OSA 是数字自我建构的典型场景：潜在学生在入学前完成数字化[[Questionnaire|问卷]]和测试，获得一个以数字形式呈现的"自我"，并被引导与[[Digital Optimum|数字最优]]进行比较和优化
