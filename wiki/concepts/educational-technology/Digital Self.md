...
> [!example]
> 一个学生在 [[Online Self-Assessment|OSA]] 中完成了一系列[[Questionnaire|问卷]]和认知测试。系统生成了一个报告——"你的语言能力得分：78/100；文化兴趣得分：92/100；数学推理得分：65/100"。这个数字组合不是该学生的"本质"——它是在特定的测量框架下、通过特定的分类和算法处理后被生产出来的一个简化版本。但学生很可能说"我的 OSA 结果是 78 分"——将这些数字接受为"自己"的组成部分。这就是数字自我的主体化运作。
