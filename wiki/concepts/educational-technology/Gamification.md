...
从 Gruschka [[Didaktik|教学理论]] 的角度看，Gamification 奖励系统将学生简化为依赖刺激来展示特定反应的机器——教育的 [[Bildung]] 维度（学生通过内容理解来形成自身）被压缩为 Erziehung 的动机维持（"我想得更多金币"）。学习内容的内在逻辑被解构为单个任务，任务之间难以重新建立联系([[Argument_Jornitz_2022_Bildung_algorithmic|Jornitz & Klinge, 2022, p.243]])。

### 制度层面：新"货币"取代教学评分

Gamification 在课堂中创造了一套按游戏逻辑——而非教学逻辑——构造的评估"货币"。传统评分（成绩单、教师评语）至少保留了"这个人理解了什么、哪里需要改进"的意义维度；而 Gamification 的金币和星星完全与学习内容脱钩——一金币就是一金币，无论它来自解方程还是背单词。当教学的核心被替换为完成平台分发的任务时，维持传统的学校评分形式几乎不可能([[Argument_Jornitz_2022_Bildung_algorithmic|Jornitz & Klinge, 2022, pp.242–243]])。

### 开发者视角与教育者视角的结构性冲突

Zichermann & Cunningham（2011, pp.ix–x）的设计目标——使体验"可预测、可重复且具有经济回报"——与教育目标——培养自主判断、批判思维和对复杂内容的深度理解——可能存在不可调和的结构性冲突。在游戏语境中，积分和奖励是"乐趣"的一部分；但在学校语境中，同样的机制可能否定 [[Bildung]]——因为学生获得奖励的理由被边缘化，学习成为获取奖励的手段而非目的([[Argument_Jornitz_2022_Bildung_algorithmic|Jornitz & Klinge, 2022, pp.236, 243]])。
