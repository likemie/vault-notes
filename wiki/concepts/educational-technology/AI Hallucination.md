...
> > - **认识论审视论（[[Argument_Li_2026_CEAI\|Li et al., 2026]]; [[Argument_Wu_2025_ER\|Wu et al., 2025]]）** 强调只要是基于概率采样的自回归架构，幻觉就不可能完全为零，人类学习者的[[Epistemological Vigilance\|认识论警觉]]与审问责任永远是不可替代的最后防线。
> >
> > > [!axis] 幻觉容忍度：发散创意（Affordance） vs 科学严谨（Hazard）
> > 在艺术创作与隐喻生成中，幻觉被视为[[Creativity\|创造力]]的催化剂；而在 [[STEM Education\|STEM]] 与学术研究中，幻觉则是必须严厉剔除的毒素。
> 
> ---
> 
> ## 实证数据
