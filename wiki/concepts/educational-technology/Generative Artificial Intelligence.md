...
> [!citation-card] [[Scientific Literacy\|科学素养]]与数智教育视角
...
> [!citation-card] 共生学习伙伴与认识主体性演进视角
> 生成式人工智能与学习者共同构成共生学习伙伴关系。在此架构中，学习者并非单向接受算法输出的被动受体，而是通过双向互动、提示词工程与证据协调共享认识主体性。生成式 AI 的促学成效关键取决于学习者如何基于自身的[[Epistemic Stances\|认识立场]]（绝对主义、相对主义或评价主义）审视生成内容，并借助双轨教学支架发展出批判性的[[Evaluativist\|评价主义认识立场]]，在保持[[Epistemological Vigilance\|认识论警觉]]的前提下驾驭技术。[[Argument_Wu_2025_ER\|(Wu et al., 2025, pp. 358–360)]]
>
> *Generative AI acts as a co-thinker and symbiotic learning partner in human-AI [[Knowledge Production\|Collaborative Knowledge Construction]]... Strengthening human epistemic agency hinges on pedagogical scaffolding, technological prompting, and the adaptive maturation of epistemic stances.*

> [!boundary]- 概念边界
> - **不等于 [[Intelligent Tutoring Systems\|智能导师系统]]（ITS）** 传统 ITS 依赖预设的专家产生式规则与结构化题库进行良构解题的单轮分步演练；GenAI 依托大语言模型与多模态架构的统计概率[[Emergence\|涌现]]，支持多轮开放式自然语言对话、[[Role-playing\|角色扮演]]与非结构化探究共创。[[Argument_Wu_2025_ER\|(Wu et al., 2025, pp. 358–359)]]
> - **不等于 判别式/预测性人工智能（Predictive AI）** 判别式 AI 核心功能是分类、打分、过滤与标签化（如自动批改与[[Attrition\|流失]]率预警）；生成式 AI 核心功能是基于提示生成全新内容与交互式对话。
> - **不等于 自动代写与学术欺诈工具** 将 GenAI 窄化为代写工具是工具主义与[[Disciplina and Doctrina\|规训]]视角的产物；在学习科学中，它被定位于支持思维外化与[[Epistemology\|认识论]]质询的认知脚手架。
> - **不等于 彻底剥离技术的绝对独立（Radical Epistemic Autonomy）** 追求完全摆脱生成式技术支持的孤立自足是不切实际的纯洁性设想；GenAI 教育治理的核心在于相互依赖中维系关系性认识主体性。[[Argument_Du_Yuan_2026_AIS\|(Du & Yuan, 2026, p. 7)]]

---

## 概念辨析

> [!contrast-table] 四类教育技术形态的技术架构、认知交互与教学定位辨析
> | 比较维度 | 判别式 / 预测性 AI | 传统[[Intelligent Tutoring Systems\|智能导师系统]]（ITS） | 传统搜索引擎与信息检索 | **生成式人工智能（GenAI）** |
> |---|---|---|---|---|
> | **核心算法机制** | 决策树、支持向量机、深度分类网络 | 专家系统、产生式规则库、贝叶斯网络 | 基于倒排索引与 PageRank 的关键字匹配 | **Transformer、自回归语言模型、多模态扩散** |
> | **人机交互模态** | 静态结果呈现（分数、类别、预警概率） | 结构化答题面板、预设分步提示（单轮反馈） | 静态超链接列表与摘要提取 | **开放式多轮自然语言[[Dialogue in Education\|对话]]、代码与画布** |
> | **认知协同关系** | 外部评估者与诊断器 | 预设权威导师与解题教练 | 信息检索中介与资料库 | **共生学习伙伴、思维辩友与概念探究[[Scaffolding\|脚手架]]** |
> | **学生认知任务类型** | 接受诊断评估、查看预测学业画像 | 良构学科（数学、物理）单点练习与测验 | 事实性信息检索与[[Document\|文献]]定位 | **复杂问题探究、创意写作、跨学科方案设计** |
> | **[[Working Memory\|工作记忆]]负荷机制** | 不直接参与思考过程，仅作外部评价 | 逐步提示分担外在负荷，引导图式构建 | 需学生自行筛选海量链接，搜索负荷较重 | **极速生成初稿；极易诱发有害的[[Cognitive Offloading\|认知卸载]]** |
> | **核心教学治理挑战** | 算法黑箱导致评估不透明、标签化偏见 | 知识库构建成本高、难以迁移至开放领域 | 辨别信息源权威性与过滤商业推广 | **模型幻觉识别、文风均质化防范与[[Epistemological Vigilance\|认识论警觉]]维持** |
...
> - **共生学习伙伴关系与共享[[Epistemic Agency\|认识主体性]]（Symbiotic Learning Partnership & Shared Epistemic Agency）** 将生成式 AI 确立为与学习者协同构建知识的共生伙伴；认识主体性在人机协作网络中动态分布，由人类把控探究目标、设计引导提示并实施证据裁决。[[Argument_Wu_2025_ER\|(Wu et al., 2025, pp. 358–360)]]
> - **提示词工程与[[Dialogue in Education\|对话]]式[[Scaffolding\|认知脚手架]]（Prompt Scaffolding）** 将自然语言提示作为人机交互与思维[[Externalization\|外化]]的界面，通过[[Role-playing\|角色扮演]]（Role-playing）与[[Chain-of-Thought Prompting\|思维链]]（Chain of Thought, CoT）提示指令，动态调整技术对[[Zone of Proximal Development\|最近发展区]]的支持力度。[[Argument_Liu_2026_CHBR\|(Liu et al., 2026, pp. 2, 10)]]; [[Argument_Wu_2025_ER\|(Wu et al., 2025, pp. 362–365)]]
...
> - **四重社会技术中介路径（Sociotechnical Mediation Pathways）** 通过流畅权威性、无摩擦委托、不透明综合与制度化依赖四条交织路径塑造学习者的认识习惯，将界面便利性转化为隐蔽的认知顺从。[[Argument_Du_Yuan_2026_AIS\|(Du & Yuan, 2026, pp. 4–7)]]
...
>   系统以高度连贯、语法无瑕疵且结构规整的语言输出，制造出认知可信的即时表象，削弱学习者核查事实与审视逻辑的警觉性。
> - **无摩擦委托（Frictionless Delegation）**
>   系统提供极低认知阻力与零等待的即时响应，诱导学习者将耗费心力的中间论证与评价性步骤直接外包给算法。
> - **不透明综合（Opaque Synthesis）**
>   系统在不可见的统计黑箱中跨源头提取和拼接观点，掩盖了证据确证的脉络、争议与理论谱系，使事实核查难以开展。
> - **制度化依赖（Institutional Dependence）**
>   商业平台通过机构采购与日常教学流程嵌入，将生成式工具固化为学术探究与文本生产的默认基础设施，形成路径锁定。

> [!logic-map]- 生成式 AI 介入教学活动系统的中介机制
> ```mermaid
> flowchart LR
>     A["<b>生成式 AI 系统 (GenAI)</b><br>(Transformer / LLMs / 多模态中介)"] --> B{"<b>中介形态与制度规制</b>"}
>     
>     B -->|"<b>结构化脚手架与关系性主体性</b><br>• 工具型/承载型协助边界守持<br>• 对抗性查错与评价性判断自持<br>• 提示词日志透明化考核"| C["<b>维系生产性认识论摩擦</b><br>• 剥离机械性外在负荷<br>• 激发发散构想与视角转换<br>• 强化元认知监控与辩证论证"]
>     
>     B -->|"<b>四重社会技术中介渗透</b><br>• 流畅权威性与无摩擦委托<br>• 承载判断型协助全盘接管<br>• 追求表面效率与顺滑度"| D["<b>滑向有害认识依赖与认知卸载</b><br>• 评价性判断算法置换<br>• 中间认识动作剥离与马赛克化<br>• 个人学术声音被算法熨平"]
>     
...
> [!claim] Zhao et al.
> **高阶思维促进效应的子维度级差与[[Self-Regulated Learning\|自主调节学习]]（SRL）决定性门槛** 基于一阶[[Meta-analysis\|元分析]]，生成式 AI 对学生[[Higher-Order Thinking Skills\|高阶思维]]展现出显著的促学总效应，但认知成效呈现出鲜明的内部[[Construct\|构念]]分化与调节约束：① **子维度级差** 具有良构目标与外显逻辑规则的[[Problem Solving\|问题解决]]和[[Critical Thinking\|批判性思维]]获益最为显著，而高度依赖非确定性发散与顿悟的[[Creativity\|创造力]]提升相对受限；② **自主调节能力门槛** 具备高水平[[Self-Regulated Learning\|自我调节学习]]（SRL）能力的学生获得强劲认知增益，而低 SRL 学生效应急剧滑落，确立了[[Learner Autonomy\|自主学习]]能力是规避算法顺滑诱导与[[Cognitive Offloading\|认知卸载]]的内在核心防火墙；③ **干预时长倒 U 型窗口** 中期干预取得最高促学峰值，显著优于短期的新奇磨合期与超长期的技术脱敏疲劳期。[[Argument_Zhao_2025_JIntell\|(Zhao et al., 2025, pp. 10–13)]]

---

### 命题二　生成式人工智能驱动教育评估体系从“单向终稿交付”向“递归探究与认识论摩擦维持”的范式转型

> [!concept-lens] 课程评价变革与[[Epistemology\|认识论]]主体性维度
...
> [!claim] Medina, J.
> **维持生产性[[Epistemic Friction\|认识论摩擦]]以抵抗算法顺滑表象引发的心智外包** 高阶心智的锻造不可避免地需要经历认知挣扎与观点冲突。面对生成式模型极度流畅而掩盖不确定性的输出，教育系统必须主动设计“认识论摩擦”（Epistemic Friction）机制——通过要求学生对比 AI 建议并阐明采纳理由、进行对抗性查错等——强制[[Working Memory\|工作记忆]]深度参与推理，防范认知主体性的彻底丧失。[[Argument_Li_2026_CEAI\|(Medina, 2013; Li et al., 2026, p. 10)]]

---

### 命题三　生成式人工智能促学效能呈现宏观边际效益递增与文化权力壁垒破除的生态支持特征

> [!concept-lens] 宏观社会文化生态与教育公平机制
...
### 命题四　生成式人工智能中介深刻重组知识确证的劳动力分工，其教育风险在于承载判断型协助对评价性判断的算法置换

> [!concept-lens] 社会认识论与知识确证分工维度
> 该命题超越单纯认知负荷与行为使用频次的技术视角，从社会[[Epistemic Stances\|认识论立场]]揭示生成式 AI 作为认识中介对人类知识确证劳动力分工的重构机制，确立[[Evaluative Judgement\|评价性判断]]不可替代的规范边界。

> [!claim] Du, J., & Yuan, H.
> **[[Epistemic Dependence\|认识依赖]]的协助形态分层与评价性判断不可替代性** 人工智能介入的教育风险并不取决于单纯的使用频次，而取决于协助形态与认知判断之间的实质关系。生成式 AI 的介入形态涵盖工具型协助（低风险基础操作）、承载型协助（中等风险结构生成）与承载判断型协助（高风险评价委托）。当系统在没有显性人类干预的情况下直接输出质量评级、解释优劣选择或确定性结论时，学习者在不知不觉中将评价性判断（Evaluative Judgement）委托给算法，形成隐蔽而有害的[[Epistemic Dependence\|认识依赖]]；教育治理的核心不在于追求孤立绝缘的绝对认识自主，而在于在不可避免的相互依赖中维系关系性[[Epistemic Agency\|认识主体性]]。[[Argument_Du_Yuan_2026_AIS\|(Du & Yuan, 2026, pp. 3–7)]]
...
> **共生学习伙伴关系中认识立场的演进与双轨支架矩阵** 学习者与生成式人工智能的协作构成了动态共生学习伙伴关系，认识主体性在人机网络中动态流动。学习者在交互中表现出三种分层的认识立场（Epistemic Stances）：① **[[Absolutist\|绝对主义立场]]（[[Absolutist]]）** 将生成式 AI 视为全知权威，被动全盘接受输出，极易诱发严重的算法幻觉盲从与有害的认知卸载；② **[[Multiplist\|相对主义立场]]（[[Multiplist]]）** 将 AI 输出与个人直觉等同为互不相干的主观意见，随意拼贴且缺乏证据[[Justificatory Standards\|辩护标准]]；③ **评价主义立场（[[Evaluativist]]）** 将 AI 视为批判性思维辩友，主动设置探究目标、设计高阶提示、实施多源证据核验并评估观点权衡。为促成认识立场向评价主义演进，教学系统必须构建“技术提示支架（[[Role-playing\|角色扮演]]、[[Chain-of-Thought Prompting\|思维链]]分解、检索增强）+ 教学法支架（交叉核验、同行互评、反思日志）”的双轨干预矩阵，确保学习者在享受技术认知支持的同时牢固捍卫人类认识主体性。[[Argument_Wu_2025_ER\|(Wu et al., 2025, pp. 358–366)]]

> [!claim] Han, J., & Gutierez, S. B.
> **学科评价标准驱动中学生在多模态人机共建中展现认识论警觉与主体性** 针对初中科学课堂中生成式 AI（ChatGPT 与 Canva）的应用，生成式工具在生成解释与图解时极易产出表面语言流畅但省略核心机制（如水分运送途径断裂）或图表缺乏动态因果方向的制品。在显性科学解释标准支架支持下，中学生展现出高度的[[Epistemological Vigilance\|认识论警觉]]：主动识别 AI 解释中的事实遗漏、上位分类缺失与多模态表征不足，通过多轮重构提示词与手写补充，成功捍卫了在人机知识共建中的[[Epistemic Agency\|认识主体性]]。[[Argument_Han_Gutierez_2026_IJSE\|(Han & Gutierez, 2026, pp. 11–18)]]
...
> | 命题类型 | 核心指向 | 适用情境 | 代表学者 |
> |---|---|---|---|
> | **教学[[Interaction Effect\|调节效应]]命题** | 技术效应非固有，教学脚手架、[[Self-Regulated Learning\|自主调节能力]]与干预时长窗口共同决定认知增益与子维度级差 | 高等教育人机协同学习、[[STEM Education\|STEM]] 实验探究、基础教育 PBL 项目 | [[Argument_Li_2026_CEAI\|Li et al. (2026)]]; [[Argument_Liu_2026_CHBR\|Liu et al. (2026)]]; [[Argument_Zhao_2025_JIntell\|Zhao et al. (2025)]] |
...
> | **生态支持机制命题** | 低 ICT、低 SES 情境呈边际效益递增，高权力距离下破除层级威慑心理 | 跨文化教学、教育公平政策、欠发达地区高校数字化 | [[Argument_Chen_Cheung_2025_ERR\|Chen & Cheung (2025)]] |
...
> - **2026 — 教学活动系统全面重构与社会[[Epistemology\|认识论]]转向** [[Argument_Li_2026_CEAI\|Li et al. (2026)]] 提出批判性与[[Creativity\|创造性思维]]双重视角整合框架与六大教学干预规制；[[Argument_RoyalSociety_2026_ScienceForSociety_Ch01\|The Royal Society (2026)]] 正式将 AI 素养确立为面向未来社会的国家级核心课程基础设施；[[Argument_Du_Yuan_2026_AIS\|Du & Yuan (2026)]] 开启生成式 AI 的社会认识论转向，系统提出协助形态三层分类与四重社会技术中介路径，确立知识确证分工重构下维系关系性[[Epistemic Agency\|认识主体性]]与[[Evaluative Judgement\|评价性判断]]的理论纲领；[[Argument_Han_Gutierez_2026_IJSE\|Han & Gutierez (2026)]] 实证揭示初中生如何运用学科显性评价标准在人机多模态解释共建中实施微观认识论审问与提示词迭代。
...
> [!debates] 学术争议
>
> > [!axis] 认知增益论 vs 心智侵蚀退化论
> > 技术乐观派主张生成式 AI 能民主化高端知识获取、解放[[Working Memory\|工作记忆]]并激发[[Creativity\|创造力]]；批判派则警告全盘心智外包将导致新一代学习者丧失深层推理与反思能力。
> >
> > - **[[Argument_Li_2026_CEAI\|Li et al. (2026)]]** 指出两派观点各执一端，实证数据证明二者均可在特定教学条件下发生，关键在于教学系统的设计。
> > - **García-López et al. (2025)** 聚焦于缺乏引导时学生[[Critical Thinking\|批判性思维]]的普遍退化风险。
>
> > [!axis] 权威全知先知 vs 批判[[Dialogue in Education\|对话]]伙伴：人机[[Epistemic Stances\|认识立场]]的演进分歧
> > 探讨生成式 AI 在学习者心智中究竟被建构为无所不知的真理提供者，还是需要接受持续审问与证据校验的共生思维辩友。
> >
> > - **[[Argument_Wu_2025_ER\|Wu et al. (2025)]]** 指出将 AI 视为绝对权威（绝对主义）会导致算法幻觉盲从与思维外包，唯有通过双轨支架将其重塑为对话辩友（评价主义），才能实现共享[[Epistemic Agency\|认识主体性]]。
> > - **Molenaar (2022)** 强调若缺乏[[Metacognition\|元认知监控]]与双向协商机制，学习者极易将混合智能系统误设为单向指令中枢。
>
> > [!axis] 学术诚信治理：惩罚性检测 vs 过程性透明
> > 传统管理主义倾向于部署 AI 文本检测器进行惩罚性防御；新兴教学论主张检测器存在高误判率，应转向开放透明的人机[[Dialogue in Education\|对话]]日志答辩。
> >
> > - **Selem et al. (2025)** 证实严苛且模糊的作弊惩处心理恐惧会显著抑制学生的创造性探索意愿。
> > - **Boers et al. (2025)** 建议将人机多轮修改轨迹图直接作为学业考核的一部分。
>
> > [!axis] 工具性效率协助 vs [[Epistemology\|认识论]]评价外包
> > 工具论视角聚焦于生成式 AI 作为效率辅助工具的写作润色与[[Literature Search\|文献检索]]功能；社会认识论视角则警告算法在知识确证活动中承载[[Evaluative Judgement\|评价性判断]]，引发高阶审思劳动力分工的隐蔽转移。
> >
> > - **[[Argument_Chen_Cheung_2025_ERR\|Chen & Cheung (2025)]]** 从实证层面证实工具介入对语言和[[Academic Achievement\|学业表现]]的显著提升。
> > - **[[Argument_Du_Yuan_2026_AIS\|Du & Yuan (2026)]]** 揭示承载判断型协助剥离中间认识动作、侵蚀独立评价能力的系统性风险。
...
> - **无谓摩擦消除（效率优化） vs 生产性认识论摩擦维持（深度理解）** 商业生成式工具致力于消除一切交互卡顿与认知阻力（无摩擦委托），而真正的高阶学习恰恰需要保留促使学习者暂停、质疑与对比论证的生产性[[Epistemic Friction\|认识论摩擦]]。[[Argument_Du_Yuan_2026_AIS\|(Du & Yuan, 2026, pp. 4–6)]]
...
> - **商业平台采购锁定与[[Growth\|成长]]受限型[[Epistemic Injustice\|认识不公]]** 大学对主流商业闭源生成式平台的系统性采购，不仅造成对特定私营技术堆栈的制度化锁定，更在无形中将缺乏替代性数字资源的学生推向算法主导的[[Knowledge Production\|知识生成]]流水线，剥夺其经历独立挫折与认识突破的成长机会，构成结构性的认知发展限制。[[Argument_Du_Yuan_2026_AIS\|(Du & Yuan, 2026, pp. 5–7)]]
...
> - **跨学科认识规范的[[Incommensurability\|不可通约性]]** 生成式模型基于统计平均与概率关联生成跨学科内容，往往掩盖不同学科独特的证据[[Justificatory Standards\|确证标准]]与方法论辩护规范（例如人文学科的诠释学深度 vs 实证科学的可重复性检验），不可将其统摄为单一同质的通用确证机器。[[Argument_Du_Yuan_2026_AIS\|(Du & Yuan, 2026, pp. 4, 6)]]
...
> | 同上 | 干预因素（情境与文化） | 国家 ICT 水平：低（$k=20$） vs 中（$k=60$） vs 高（$k=17$）；权力距离：高（$k=73$） vs 低（$k=24$） | $k = 97$ / $N = 5{,}389$ | 低 ICT $g^+ = 1.764$ vs 高 ICT $g^+ = 0.501$；高权力距离 $g^+ = 0.859$ vs 低权力距离 $g^+ = 0.236$ | ICT: $Q_B = 21.69, p < .001$；权力距离: $Q_B = 10.97, p = .001$ | 证实数字化薄弱情境的边际效益递增及高权力距离下的自主促学机制 |
...
> |---|---|---|---|---|---|---|
> | [[Argument_Wu_2025_ER\|Wu et al. (2025, pp. 360–366)]] | 中小学科学探究与高校学术探究场景 | 概念框架与个案论证 | 人机共生[[Epistemic Agency\|认识主体性]]、三大[[Epistemic Stances\|认识立场]]（绝对主义、相对主义、评价主义）与双轨干预支架 | 阐明[[Role-playing\|角色扮演]]与思维链提示作为技术脚手架；证实评价主义认识立场是抵御算法幻觉与有害[[Cognitive Offloading\|认知卸载]]的[[Necessary and Sufficient Conditions\|必要条件]] | — | 概念与质性案例分析，揭示技术提示与教学法双轨支架协同促进认识立场向评价主义演进的机制 |
...
> | [[Argument_Han_Gutierez_2026_IJSE\|Han & Gutierez (2026, pp. 11–18)]] | 韩国 8 名初中生，两节人机协同科学课（植物[[Growth\|生长]]与真菌分类） | 质性多层[[Multimodal Discourse Analysis\|多模态话语分析]]（录像转录、数字生成物、访谈） | 学科评价标准赋能下的认识论审问与提示词重构 | 证实四项科学解释标准（相关性、因果叙事、概念框架、适切表征）能有效引导中学生识别 AI 输出的事实遗漏、机制断裂与图解缺陷，并驱动精准的提示词迭代 | 质性微观对话与多模态制品分析 | 确立显性学科标准在 K-12 人机多模态知识共建中作为维持[[Epistemological Vigilance\|认识论警觉]]与[[Epistemic Agency\|认识主体性]]的核心脚手架功能 |
...
> - [[Argument_Han_Gutierez_2026_IJSE\|Han & Gutierez (2026)]] — 针对初中科学人机多模态解释共建，揭示学生如何依托学科四维标准实施微观话语审问与提示词迭代，实证确立显性学科标准在 K-12 阶段维系认识论警觉与认识主体性的支架机制。
