---
title: Multi-channel Interactive Learning Model
aliases:
  - 多通道互动学习模型
...
> [!info] 核心定义
> 多通道互动学习模型（multi-channel interactive learning model）是 Caraça、Lundvall and Mendonça（2009）提出的创新过程[[Analytic Framework\|分析框架]]，旨在更新、补充和扩展 Kline & Rosenberg（1986）的[[Chain-linked Model\|链式模型]]。该模型将创新过程重新定位在[[Learning Economy\|学习经济]]的语境中，核心主张是：创新不是从科学到市场的线性或链式推进，而是在多元[[Source of Knowledge\|知识来源]]、多层制度环境和多通道互动学习共同作用下的螺旋式过程。[[Argument_Caraca_2009_TFSC\|(Caraça, Lundvall & Mendonça, 2009, pp. 864–866)]]
...
> [!abstract]
> 该模型在[[Chain-linked Model\|链式模型]]的基础上引入了三个核心创新，共同构成其[[Analytic Framework\|分析框架]]。[[Argument_Caraca_2009_TFSC\|(Caraça et al., 2009, pp. 864–866)]]

### 螺旋式学习循环

与链式模型不同，新模型不指定创新过程的第一步应该在哪里——它原则上可以从任何地方开始。创新被概念化为一个螺旋式学习循环，其中链条卷曲起来以充分包容学习过程的动态性。学习的结果可以是产品创新、流程创新、新市场细分的发现或组织业务常规的新方法。这一设计将学习的产物从单一的技术创新扩展到了组织创新和市场创新。

### 三类知识池

在[[Learning Economy|学习经济]]的语境中，不存在一个可以从中学习的普遍知识池，而是存在三组互补的知识池：

- **物理和生物科学与技术知识**。关于自然现象和技术原理的系统性知识，传统上与 R&D 中的 R 对应。
- **组织和治理结构知识**。关于如何设计、管理和协调组织以支持创新和学习的知识。
- **营销技术和顾客行为知识**。关于市场动态、顾客需求和行为模式的知识。

科学只是多元[[Source of Knowledge|知识来源]]中的一种。在从 R&D 向 R 即 D 的转变中，后两类知识池的重要性日益上升。
...
> [!abstract]
> 该模型将创新过程嵌入两层环境中。微观环境包括与企业直接互动的行动者和其他组织（用户、供应商、竞争者、大学）。宏观环境包括更广泛且不断演变的制度结构、宏观经济、政治、社会和生态力量。两层环境共同构成[[Innovation Ecosystem\|创新生态]]——一个复杂的多层次选择环境，对企业层面的创新过程施加持续变化的压力。[[Argument_Caraca_2009_TFSC\|(Caraça et al., 2009, pp. 864–865)]]

如果内部创新过程的速度相对较高，微观或宏观制度设置可能滞后并产生阻尼效应。如果组织层面的创新方向与既有制度框架不匹配，则可以预见动荡的过渡和调整期，最终导向新的技术-经济[[Paradigm|范式]]（Freeman & Louçã, 2001, 引自 p. 865）。
...
> [!example]
> - vs **[[Linear Model of Innovation\|线性创新模型]]** — 线性模型预设科学→技术→经济的单向因果链。多通道模型认为创新可从任何地方开始，科学只是多元[[Source of Knowledge\|知识来源]]中的一种，且创新依赖于企业与环境之间的多通道互动学习。[[Argument_Caraca_2009_TFSC\|(Caraça et al., 2009, pp. 862–865)]]
