...
> 到 1980 年代，中央实验室的地位在企业内部急剧下降。[[Argument_Ulrichsen_2025_UIR_Evolution\|Ulrichsen (2025, pp.36–37)]]总结了三个驱动力：
...
企业中央实验室的衰退引发了一个更大的结构性变化——[[Systems of Innovation|创新系统]]中出现了一种新的分工格局（Arora et al., 2020）([[Argument_Ulrichsen_2025_UIR_Evolution|Ulrichsen, 2025, pp.41–42]])：
...
> [!abstract]
> 企业中央研发实验室的运作模式包含以下关键特征（Arora et al., 2020）([[Argument_Ulrichsen_2025_UIR_Evolution\|Ulrichsen, 2025, pp.35–37]])：
...
> 这些产出不仅改变了各自公司所在的产业，更重塑了整个信息时代的技术基础设施——晶体管催生了整个半导体产业，Unix and GUI 塑造了现代个人计算的交互[[Paradigm\|范式]]。
...
- 衰退后（1980s 至今）：企业重新依赖外部[[Source of Knowledge|知识来源]]，大学成为重要的创新伙伴——"开放创新"（Chesbrough, 2003）成为共识（pp.36–37）
...
> [!warning]
> - **碎片化系统是否退步了？** Arora 等人（2020）的核心质疑——大学和初创企业的碎片化组合是否真的能替代中央实验室跨学科整合的系统性能力——至今未得到充分回答。这一张力直接关系到当代[[University-Industry Collaboration\|产学合作]]政策的设计：如果碎片化确实不如集成化有效，那么单纯增加产学合作的数量和规模可能不足以解决问题，还需要新型的组织形式来承担"系统集成"的功能([[Argument_Ulrichsen_2025_UIR_Evolution\|Ulrichsen, 2025, pp.41–42]])
> - **历史叙事可能过于美化** 对中央实验室"黄金时代"的追忆可能低估了其局限性——实验室的产出与其母公司的商业成功之间并不总是存在线性关系（Xerox PARC 发明的 GUI 最终由 Apple and Microsoft 而非 Xerox 商业化），这本身就证明了即使集成在一个组织内，从科学发现到商业价值的转化仍然困难
