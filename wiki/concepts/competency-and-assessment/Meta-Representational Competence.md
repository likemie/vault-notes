---
title: Meta-Representational Competence
aliases:
  - 元表征能力
  - 元表征胜任力
  - MRC
...
> - **用途** 衡量学生利用、设计与反思科学与数学表征工具的能力，是连接外部[[Scaffolding|教学脚手架]]与内在认知发展的核心枢纽。
...
> 外部[[Scaffolding|认知脚手架]]的促学效能取决于学习者内在元表征能力与工具结构复杂度之间的动态匹配。
