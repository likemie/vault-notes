...
> 基础科学知识的核心依然重要，但对于不大可能从事科技专业职业的普通公众而言，它绝非科学教育中最关键的维度。[[Argument_RoyalSociety_2026_ScienceForSociety|(The Royal Society, 2026, p. 116)]]
>
...
> [!citation-card] 论破除刻板[[Scientific Method|科学方法]]与面向证据审议的公共科学素养
> 认识论实践依赖于特定领域与时代变迁，根本不存在一套封闭固定的科学实践。这与教育实践中常常将科学方法机械阐释为一套线性步骤的做法形成了鲜明对比。核心宗旨绝不是去教条地规定一套固定的实践清单或机械推行科学方法五个步骤，而是去识别人们如何形成认识，并体会以系统化方式理解世界以使证据向公共审查与评价开放的崇高价值。通过将实践参与和精心设计的教学法深度交织，学生方能积聚充沛的[[Epistemology|认识论]]能力，在公共领域中作为有见识、有[[Bildung|教养]]的现代公民积极发声。[[Argument_Kelly_Licona_2018_EpistemicPractices|(Kelly & Licona, 2018, pp. 144–145, 161)]]
>
> *Since epistemic practices are [[Champ|field]]- and time-dependent, there is not a limited set of "science practices." This contrasts with how "the scientific method" is often interpreted in education as a set of linear steps. The point is not to define a given set of eight practices or the five steps of the scientific method. Rather, the idea is to identify the ways people come to know and recognize the value of making sense in systematic ways that render evidence open for public scrutiny and evaluation. Through such engagement, connected to carefully organized pedagogy, students may build capacity to participate as informed citizens in the public sphere.*
...
> |---|---|---|---|---|
> | **核心关注** | 理解科学运作、评估证据质量、接纳不确定性与理性决策 | 解释个体为何认为科学是否适合我的综合社会[[Cultural Capital\|文化资本]] | 评估日常生活与媒体中海量数据、图表、统计与风险的能力 | 理解算法推荐逻辑、识别[[AI Hallucination\|大模型幻觉]]与人机协作伦理 |
...
> [!feature] 现代科学素养四大能力支柱（[[Argument_RoyalSociety_2026_ScienceForSociety_Ch01|The Royal Society, 2026]], 2026b, 2026d; [[Argument_Kelly_Licona_2018_EpistemicPractices|Kelly & Licona, 2018]]）
...
> [!claim] [[Argument_Kelly_Licona_2018_EpistemicPractices|Kelly & Licona (2018)]]
> **破除单一[[Scientific Method|科学方法]]神话与体会公共审查价值** 真正的科学素养绝非去教条地掌握八项固定实践或所谓科学方法五个步骤，而是去识别各学科多元的知晓方式，并体会以系统化方式理解世界以使证据向公共审查与评价开放的崇高价值。[[Argument_Kelly_Licona_2018_EpistemicPractices|(Kelly & Licona, 2018, pp. 144–145)]]
...
### 命题四　立法与政策制定群体的证据素养短板构成现代循证治理的制度瓶颈

> [!concept-lens] 政策决策者的证据素养与信息中介依赖
> 科学素养并非仅仅是中小学生或普通公民的通识素养，更是高级公共政策制定者与立法者履行公职、实现[[Output-Oriented Governance|循证治理]]的前提条件。
...
>   米勒与奥斯本（Millar & Osborne, 1998）发表里程碑报告，明确提出面向公民的科学素养（Science Literacy for Citizenship），强调理解证据性质、科学解释模式与社会科技争议评估，彻底颠覆了以大学升学为唯一导向的学科中心主义。[[Argument_RoyalSociety_2026_ScienceForSociety_Ch01|(The Royal Society, 2026, p. 31)]]
>
...
> > - **知识本位立场** 认为没有充足的事实与原理解释储备，所谓批判性评估就会沦为无根浮萍与盲目怀疑。
...
> [!warning] 适用局限与警惕
> 警惕将科学素养窄化为个人的孤立逻辑思维技巧。如果抽离了对科学建制运作（如科研资金利益冲突、学术出版商业化、过度营销与科研诚信规范）的系统认知，单纯具备一般逻辑能力的个体依然极易落入经过专业包装的利益集团虚假信息陷阱。
