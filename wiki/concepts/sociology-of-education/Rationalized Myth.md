...
> 合理化神话构成了制度环境中理所当然的信念与共享理解的一部分，为组织行动者的认知表达赋予正当性，并作为模仿性变革的核心载体在场域中扩散。[[Argument_Helgetun_2022_JEP\|(Helgetun & Menter, 2022, p. 92)]]
>
> *Rationalized myths form an integral part of common beliefs and shared understandings that legitimise cognitive expression, constituting central carriers of mimetic change.*

> [!boundary]- 概念边界
> - 不等于 [[Institutional Isomorphism\|制度同构]]：合理化神话是制度环境中流通的规范信念与文化认知蓝图本身，而制度同构是组织因采纳这些神话而趋同的演化机制。
> - 不等于纯粹技术理性：技术理性追求可证实的投入产出效率，而合理化神话依赖社会认同与制度正当性。
...
> | **面对质疑时的反应** | 诉诸更高阶的理性化程序与符号仪式 | 修正因果模型与调整技术参数 | 政治辩论与权力对抗 |
