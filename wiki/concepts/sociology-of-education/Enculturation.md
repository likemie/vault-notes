...
> 政治灌输通过明确的信息传递运作——标语、课程、政治运动——目标是让个体接受特定的意识形态。濡化则通过日常抚养与互动隐性运作。二者的关键差异在于**传递层面**：政治灌输很少能穿透婴儿期的日常育儿实践（喂食、安抚、教导），而濡化恰恰在这一层面运作（LeVine, 1990; Harkness & Super, 1992，转引自 [[Argument_Li_2012_Cambridge|Li, 2012, p.12]]）。
