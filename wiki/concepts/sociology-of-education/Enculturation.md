...
> 政治灌输通过明确的信息传递运作——标语、课程、政治运动——目标是让个体接受特定的意识形态。濡化则通过日常抚养与互动隐性运作。二者的关键差异在于**传递层面** 政治灌输很少能穿透婴儿期的日常育儿[[Praxis|实践]]（喂食、安抚、教导），而濡化恰恰在这一层面运作（LeVine, 1990; Harkness & Super, 1992，转引自 [[Argument_Li_2012_Cambridge|Li, 2012, p.12]]）。
...
> - **与政治灌输的边界模糊** 濡化和政治灌输的概念区分在理论上清晰，但在[[Praxis|实践]]中二者常在同一空间（如学校）同时运作。学校既是政治标语的场所，也是日常表扬实践的空间——文化传递和政治传递的实际边界比概念辨析中呈现的更模糊
...
三个层次中，日常互动最直接地塑造儿童，但它同时受照顾者信念和物理环境的制约。宏观政治经济气候仅通过影响这三个近端层次间接作用于儿童发展（Harkness & Super, 1992，转引自 [[Argument_Li_2012_Cambridge|Li, 2012, p.12]]）。
