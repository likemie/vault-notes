...
> [!def] 核心定义
> 象征边界（Symbolic Boundary），由文化社会学家 Michèle Lamont 等人发展，指行动者通过赋予特定的行为、品味、生活方式与价值观以道德含义，在“我们”与“他们”之间划出的主观分类与区隔界限（Lamont & Molnár, 2002; Lamont et al., 2015, pp. 15341–15347）。象征边界的核心机制在于将差异**道德化**——群体之间的客观差异被转化为“正当 vs. 不正当”、“高尚 vs. 低劣”或“纯真 vs. 功利”的道德价值判断（Lamont et al., 2015）。
...
> ```mermaid
> flowchart LR
>     A["客观行为/品味/文化差异"] --> B["差异的道德化（赋予道德优劣判断）"]
>     B --> C["边界的自然化（沉淀为日常常识与制度叙事）"]
>     C --> D["排斥的正当化（道德评价免除排斥罪恶感）"]
>     D --> E["跨群体交流阻断 & 社会边界硬化"]
> ```
...
### 命题二　国家通过课程与官方知识将特定汉儒传统塑造为正统中华性，划定国家级的符号象征边界

> [!concept-lens] 宏观课程霸权与国家文化界线构建
...
> [!warning] 适用局限
> 象征边界概念适用于文化社会学、教育社会学及微观互动/宏观[[Discourse Analysis|话语分析]]，不宜将其直接代替客观的法律自治权或经济阶层指标分析。
...
> | [[Yajun Zheng]] | 人物 | 将象征边界成功运用于中国高等教育第一代大学生研究的学者。 |
> | [[Confucius]] | 人物 | 教科书叙事中被高度符号化为正统中华性边界的核心符号。 |
