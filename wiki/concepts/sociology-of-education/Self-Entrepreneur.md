...
related_concepts: ["[[Employability]]", "[[21st Century Skills and Competencies Discourse]]", "[[Geopolitics of Knowledge]]"]
...
在 21 世纪技能与素养话语的语境中，自我企业家代表了一种以**就业力和市场为导向**的主体性（Zelinka, 2022, p.260）。这种主体性正在全球范围内成为一种"心灵景观"（mindscape）——一种新型文化（Moisio & Kangas, 2016, p.275）。
...
**可弃置性**。主体是可被弃置的（disposable），除非他们拥抱并增强这种主体性。不愿或无法成为自我企业家的个体被标记为失业者、无证者或可弃置的个体（Oksala, 2015, cit. by Zelinka, 2022, p.261）。
