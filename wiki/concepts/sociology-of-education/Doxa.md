...
**[[Champ|场域]]特定性**。每个 [[Champ|场域]] 都有自身的 doxa——特定类型的知识和资本在该场域中被特权化为不言自明的标准。场域自主性的重要标志之一即其 doxa 在多大程度上独立于外部场域的常识。例如，教育场域中"证据本位策略"论述构成一种 doxa([[Argument_Eacott_2011_JEAH|Eacott, 2011, p.50]])，而经济场域的 doxa（效率、可测量、竞争）与之不同。

**结构性合法化**。Doxa 通过制度化的结构安排（晋升标准、能力框架、选拔程序、[[Tracking|分轨制]]）而非直接强制来维持。这些结构不断再生产 doxa 的常识地位，使其免受质疑([[Argument_Eacott_2011_JEAH|Eacott, 2011, p.45]])。这正是 doxa 与显性宣传或意识形态的关键区别——后者需要被说出和辩护，doxa 只需要被"安排"。

**再生产功能**。Doxa 的核心社会功能是维持现有权力关系——"在一个[[Paradigm|范式]]内的领导力培养对系统而言是（再）生产性的，维持着现有权力关系"([[Argument_Eacott_2011_JEAH|Eacott, 2011, p.51]])。通过将特定社会安排呈现为"自然秩序"，doxa 使支配关系的任意性变得不可见。
...
[[Argument_Eacott_2011_JEAH|Eacott (2011)]]分析了澳大利亚 NSW 校长培养项目中的 doxa——"证据本位策略"论述将"什么有效"视为不言自明的问题框架。这一 doxa 的前设——"学校成功的衡量标准由谁设定""谁决定什么是重要的"——被排除在讨论之外，因为答案被预设为自明的([[Argument_Eacott_2011_JEAH|Eacott, 2011, p.50]])。
