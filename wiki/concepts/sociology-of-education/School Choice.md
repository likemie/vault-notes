...
> [!concept-lens] 概念透镜
> - **含义** 指向家庭阶级习性、资源存量同公私立学校资源空间分配之间的博弈与变现机制。
...
> | **适用范围** | 普遍适用于义务教育阶段 | 主要适用于中国县域及农村 | 适用于国家公立教育体系 |
...
> [!feature] 核心要素
> - **经济资本** 决定择校的可行性门槛，在城市表现为购买高价学区房，在县域表现为支付随迁陪读的生活租房费用及脱产损失。[[Argument_Teng_2025_CE|Teng & Wang (2025, p. 308)]]
> - **社会资本** 在非正式机制下作为拦截学位的核心工具，家庭通过强弱关系网络和裙带转介干预学校招生结果。[[Argument_Teng_2025_CE|Teng & Wang (2025, p. 309)]]
> - **文化资本** 指导家庭的教育品味并提供择校甄别力，但其在注重人情和关系的县域场域中面临局部折旧。[[Argument_Teng_2025_CE|Teng & Wang (2025, p. 310)]]

> [!logic-map]- 要素关系
> ```mermaid
> flowchart TD
>     Economic["经济资本 (购买学区房/承担进城陪读成本)"] --> Choice["择校分层结果"]
>     Social["社会资本 (拉关系/强熟人网络拦截学位)"] --> Choice
>     Cultural["文化资本 (学校信息甄别/教育抱负)"] --> Choice
> ```
...
> [!concept-lens] 阶层化再生产维度
> 探讨各阶层拥有的差异化资本如何决定择校竞争的成败，指出选择自由最终演化为阶级再生产的遮羞布。
> 
> - **Teng & Wang** 论证了经济资本作为基础准入门槛，社会资本作为裙带拦截的主导机制，而文化资本在人情社会中面临局部边缘化。[[Argument_Teng_2025_CE|Teng & Wang (2025, pp. 308–310)]]
> - **Reay** 强调中产阶级母亲通过高度卷入的文化资本与阶级习性无缝衔接学校规则，实现资源代际传递。

> [!claim] Teng & Wang
> **县域择校中的资本折算** 认为在行政与关系合谋的小城镇教育市场中，社会资本（强关系网络）的作用远超文化资本，成为决定择校成功的关键拦截力量。[[Argument_Teng_2025_CE|Teng & Wang (2025, pp. 308–310)]]

> [!claim] Reay
> **家庭习性与学校场域的同构性** 论证了中产家长的文化背景与学校教育场域的评价机制高度同构，使其能轻松操纵择校游戏，而工人阶级家长则被边缘化。

---

### 2. 择校在不同体制情境中呈现出不同的驱动逻辑与变体

> [!concept-lens] 国家政策与驱动体制维度
> 探讨择校如何受地方政策环境的塑造，区分市场化分配逻辑与国家城镇化导流逻辑。
> 
> - **Teng & Wang** 划分了西方以竞争为导向的“市场化择校”与中国以人口集聚为导向的“城镇化择校”。[[Argument_Teng_2025_CE|Teng & Wang (2025, pp. 313–314)]]

> [!claim] Teng & Wang
> **城镇化择校变体** 论证了中国农村的择校并不是由特许学校或教育券等新自由主义工具驱动的，而是由地方政府通过农村学校撤并和县城资源超常集聚所引导的教育城镇化过程。[[Argument_Teng_2025_CE|Teng & Wang (2025, pp. 313–314)]]

---

### 3. 用脚投票的择校行为恶化了薄弱与农村学校的衰退循环
...
> [!claim] Teng & Wang
> **乡村学校的荒漠化恶性螺旋** 论证了择校促成的县域分流抽干了村小资金和优质师资，使留守最弱势家庭的学校陷入功能性瘫痪和不可逆的倒闭。[[Argument_Teng_2025_CE|Teng & Wang (2025, p. 312)]]

> [!claim] Ball
> **用脚投票的排斥后果** 论证了市场化择校赋予了优势学校“反向选择”学生的隐性权力，使底层薄弱学校沦为贫困和行为问题生源的垃圾桶。
...
> | 命题类型 | 核心指向 | 适用情境 | 代表学者 |
> | :--- | :--- | :--- | :--- |
> | **家庭资本筛选命题** | 择校成功率由经济、社会和文化资本的累积量决定 | 普适于各国义务教育择校行为 | Teng & Wang; Reay |
> | **体制驱动分化命题** | 区分新自由主义市场模式与行政教育城镇化模式 | 适用于比较教育与政策分析 | Teng & Wang |
> | **学校流失恶化命题** | 自由择校从薄弱学校抽干资源导致恶性衰落循环 | 适用于农村学校撤并及城市落后学区 | Teng & Wang; Ball |
...
> - **2010s — 转型国家的教育城镇化变体** 中国推进农村学校撤并与县城学校扩张，择校实践与地理迁移、农民市民化合流，演化为“以教促城”的政策抓手。[[Argument_Teng_2025_CE|Teng & Wang (2025, pp. 303–304)]]
...
> | :--- | :--- | :--- | :--- | :--- | :--- | :--- |
> | [[Argument_Teng_2025_CE\|Teng & Wang (2025)]] | G 县 814 份问卷及 128 例访谈 | 混合方法实证研究 | 择校进城成本与比例 | 县城随迁择校家庭年生活成本逾 2 万元，占家庭总收入 40% 以上 | — | 反映小城镇低门槛入学下的高昂私人财务负担 |
...
> - [[Argument_Teng_2025_CE|Teng & Wang (2025, pp. 303–314)]] — 详述了中国农村教育城镇化驱动下的陪读择校实践，解构了其中家庭资本的分层博弈。
