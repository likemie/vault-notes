...
> [!tip]-
> 代码切换揭示了一个更深层的问题：在[[Nerd]] 文化中，**公开表达学习兴趣和[[Conatus|努力]]本身就是冒险行为**。之所以冒险，是因为 [[Intellectual-Social Divide|知性-社交二分]]使理智兴趣被等同于"社交缺陷"，而 [[Zero-Sum Competition|零和竞争]]使努力被解读为"试图超越同伴"。这产生了一个悖论——学校和家长鼓励学生努力学习，但同伴文化惩罚那些公开表达努力的学生。代码切换是学生在这个矛盾中发明的自保策略。
