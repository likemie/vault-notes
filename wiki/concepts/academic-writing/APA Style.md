...
> [!info]
> APA 格式（APA Style）是美国心理学会（American Psychological Association）出版手册规定的学术写作格式规范。它为引用参考[[Document|文献]]、创建标题、呈现表格和图表以及使用无偏见语言提供了统一和一致的指导，使读者能够专注于研究内容而非格式([[Argument_Creswell_2022_SAGE|Creswell & Creswell, 2022]])。
...
引用三位及以上作者的作品时，只写第一作者名字加 "et al."，不再需要列出多位作者姓名。
...
学术论文标题分为五个层级（Level 1–5）。通常论文和项目使用三到四个层级：Level 1 为论文或项目标题，Level 2 为主要内容章节，Level 3–5 为章节内的细分。第7版对 Level 3–5 的格式进行了调整，改用粗体（bold）和缩进（indentation）以提供更清晰的视觉层次。
...
- **[[Literature Review|文献综述]]**中，[[Abstract|文献摘要]]和参考[[Document|文献]]需遵循 APA 格式，确保引文的一致性和可追溯性
