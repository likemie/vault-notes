...
除[[Literature Review|文献综述]]过程中的[[Document|文献]]摘要外，摘要还有另一层含义——置于研究报告、学位论文或资助申请开篇的研究摘要。[[APA Style|APA]] 出版手册（American Psychological Association, 2020）指出，摘要可能是研究中最重要的单个段落，需要准确、非评价性（不添加超出[[Research Scope|研究范围]]的评论）、连贯、可读和简洁。大多数摘要约 250 词（[[Argument_Creswell_2022_SAGE|Creswell & Creswell, 2022]], 第5章）。
