...
> - **适用边界** 强调以具体[[Learning Progression\|学业进阶]]与质性认知深度为导向的评价性[[Professional Judgment\|专业判断]]；严禁等同于机械照搬高效应量因子的技术清单或[[Neo-Taylorism\|新泰勒主义]]式的行为监控工具。
...
> | **边界说明** | 以效应量为统计骨架，但涵盖课堂教学论与[[Organizational Culture\|组织文化]]；不限于统计工具 | 纯粹的方法学与统计测量工具，不含教育学价值判断与教学实施逻辑 | 包含多种实证[[Paradigm\|范式]]与机构体系；VL 是循证教育运动中影响最广的具体流派之一 |

---

## 核心要素

可见的学习框架由证据统计基准、[[Academic Achievement|学业成就]]方差分解、教师思维框架、显性进阶目标与形成性反馈循环五大核心要素深度咬合构成。

> [!feature] 可见的学习五大核心要素
> - **相对有效性关节点（Hinge Point, $d=0.40$）** 基于 100 余项创新与 30 万项研究[[Meta-meta-analysis\|元综合]]确立的正态均值基准；超越“是否有效”的低阶提问，唯有增幅大于 $0.40$ 的干预才具有实质推广价值。[[Argument_Hattie_2005_ACER\|(Hattie, 2005, p. 16)]]
...
> - **教师思维框架（Teacher Mind Frames）** 以“认识自身影响（Know thy impact）”为核心，包含“我是变革推动者”、“评价是对我教学的反馈”等八项指引教师[[Professional Judgment\|专业判断]]的内隐信念图式。[[Argument_Hattie_2015_SOTLP\|(Hattie, 2015b, pp. 88–89)]]
> - **显性[[Learning Intentions\|学习意图]]与[[Success Criteria\|成功标准]]（Learning Intentions & Success Criteria）** 在任务开始前向学生充分敞开清晰的认知挑战目标与评估达成准则，消除形式主义认知盲区。[[Argument_Hattie_2005_ACER\|(Hattie, 2005, p. 17)]]
...
> **相对有效性关节点判准** 在基础教育实践中，声称某项教学方法“有效”几乎没有信息量，因为基于对 100 余项重大教育创新、30 余万项原始实证研究的[[Meta-analysis\|元分析]]综合发现，几乎所有干预措施的[[Effect Size\|效应量]]都在零点以上（$d > 0$）。所有干预的效应量呈现以 $d = 0.40$ 为中心的钟形正态分布；该均值大致对应学生自然成熟（约 0.15）与一年常规教学效应的总和。因此，真正的专业提问必须从“该方法是否有效”转向“该方法能否带来大于 $0.40$ 的相对增益”；任何低于 $0.40$ 的举措实质上是在拖累学生，因为常规环境中一半的干预都能轻易跨越该门槛。[[Argument_Hattie_2005_ACER\|(Hattie, 2005, p. 16)]]; [[Argument_Higgins_2016_ROE\|(Higgins, 2016, pp. 43–44)]]

> [!claim] Golovchin, M. A.
> **四区影响气压计** 戈洛夫钦（Golovchin）等学者基于 Hattie 的元分析数据库，系统整理了四区影响气压计（Barometer of Influence）：将干预划分为负面效应区（$d < 0$，如转学、看电视）、发展效应区（$d = 0–0.15$，如单纯教师学历）、低中效应区（$d = 0.15–0.40$，如班级规模）与期望效应区（$d > 0.40$，如[[Formative Assessment\|形成性评价]] $d=0.90$、微格教学 $d=0.88$、教学清晰度 $d=0.75$、[[Student-Teacher Relationship\|师生关系]] $d=0.72$），为教育决策提供了直观的相对效能参照。[[Argument_Golovchin_2019_ESC\|(Golovchin, 2019, pp. 232–233)]]

---

### 命题二　教师教学效能是学校系统内部可控的最大因果枢纽，测验数据本质是检验教师自身教学的镜子

> [!concept-lens] 因果归因与评价[[Epistemology\|认识论]]转型
> 剖析[[Academic Achievement\|学业成就]]的多层次方差来源，揭示数据本位模式下将评价从“判定学生资质”彻底转向“反思教学策略”的认识论跨越。
...
> [!concept-lens] [[Professional Judgment\|专业判断]]、文化重构与外部批判
> 辨析 VL 在实践落实中的两种对立取向，论证校本教研文化转型与[[Evaluative Judgement\|评价性判断]]的不可替代性。
...
> - **2024–至今 — 二阶元分析基础设施化与大模型准确性评测** 底层数据库拓展为收录 2,100 余项一阶元分析的 [[Visible Learning Meta-X]] 平台。该数据库被实证研究（[[Argument_Jansen_2026_EPR\|Jansen et al., 2026]]）作为评估大语言模型[[Automated Data Extraction\|自动化数据提取]]的基准库；该评测同时揭示了早期单人人工录入的历史局限与 57 处单方偏离（[[Intraclass Correlation Coefficient\|ICC]] = 0.81），确立了人机混合验证的质控新标准。
...
> - **数据与文化局限** 原始元分析主要基于英语国家历史[[Document\|文献]]，直接跨语境迁移到非英语国家或不同社会文化体制中存在显著适应性障碍。[[Argument_Golovchin_2019_ESC\|(Golovchin, 2019, p. 232)]]

> [!warning] 适用局限
> 元分析所汇总的标准化测验多偏向于测量表层知识与常规技能，对深层[[Critical Thinking\|批判性思维]]、概念建构与非认知福祉的测量覆盖度存在天然局限。[[Argument_Qvortrup_2015_Paideia\|(Qvortrup, 2015, p. 29)]]
...
> | [[Argument_Jansen_2026_EPR\|Jansen et al. (2026, pp. 16–18)]] | 从 [[Visible Learning Meta-X]] 随机抽取 156 项一阶元分析（468 个统计数据点） | 专家双轮仲裁金标准比对评测 | 原数据库录入 vs. 金标准[[Intraclass Correlation Coefficient\|组内相关系数]]与一致率 | 原数据库录入 $\text{ICC} = 0.81$，一致率 80%；存在 57 处单方偏离与 31 例信息遗漏 | 单方偏离度显著高于人类独立作者（$\text{ICC} = 0.95$）与大语言模型（$\text{ICC} = 0.96–0.97$） | 实证揭示早期大规模人工录入的历史局限性，论证了引入多模型与专家仲裁混合质控的必要性 |
...
> | 条目 | 类型 | 关系 |
> |:-----|:-----|:-----|
> | [[Visible Learning Meta-X]] | Fact (Program) | 承载 Visible Learning 核心实证数据的底层[[Meta-meta-analysis\|二阶元分析]]汇聚数据库（收录 2,100+ 项[[Meta-analysis\|元分析]]）。 |
...
> | [[Argument_Jansen_2026_EPR\|Jansen et al., 2026]] | Argument | 评测大模型在 VL Meta-X 数据提取准确性的最新文献，揭示原数据库录入质量与混合质控[[Paradigm\|范式]]。 |
