...
> 长期学术论战经常将探究学习误读为放任自流的纯发现。[[Document\|文献]]证据表明，辅以充分指导的探究式教学在概念知识习得与迁移上整体优于直接教学。[[Argument_DeJong_2023_ERR\|(De Jong et al., 2023, pp. 1–2)]]
>
...
> | [[Epistemology\|认识论]]定位 | 学生享有[[Epistemic Agency\|认识能动性]]，承担反思与解释责任 | 教师处于核心主导位置，学生主要负责理解消化 | 极端学习者中心，缺乏权威反馈与规范引导 |
> | 最优目标领域 | 易产生迷思概念、开放或非良构的深度概念理解与远迁移 | 良构的陈述性事实、标准化计算与基础[[Procedural Skill\|程序技能]] | 仅适用于先验知识极高的专家型自主演练 |
> | 认知负荷管理 | 依托虚拟实验、过程提示与自适应支架平衡负荷 | 通过小步子分解与示范练习直接控制外在负荷 | 缺乏支持极易导致[[Working Memory\|工作记忆]]超载与挫败 |
...
> [!claim] Cartiff et al.
> **显性证据支架对探究转化的保护机制** 在[[Epistemic Cognition\|认识论认知]]教学干预中，指导式探究通过提供结构化的实验步骤引导、表格记录支架与[[Variable\|变量]]控制规程，能有效防范劣构探究情境带来的认知超载；相比之下，缺乏结构化支架的自主[[Problem Solving\|问题解决]]与开放式辩论极易陷入表层争拗或盲目试误，唯有显性讲授证据评估规则与严谨实证规程的指导式探究，才能实质性引导学生重构深层认知图式并促进[[Academic Achievement\|学业表现]]。[[Argument_Cartiff_2021_JEP\|(Cartiff et al., 2021, pp. 485–486, 492)]]
...
> | 命题类型 | 核心指向 | 适用情境 | 代表学者 |
> |---|---|---|---|
> | **指导协同增益** | 指导式探究在概念理解与迁移上优于单一直接讲授，显性支架防范认知超载，纯发现无效 | 中小学及大学理科概念与实验技能教学、认识论认知干预 | Alfieri et al. (2011); Lazonder & Harmsen (2016); [[Argument_DeJong_2023_ERR\|De Jong et al. (2023, pp. 4–5)]]; [[Argument_Cartiff_2021_JEP\|Cartiff et al. (2021, pp. 485–486)]] |
...
> - **2021 年 — [[Epistemic Cognition\|认识论认知]]干预中的因果效应与支架必要性确立** [[Argument_Cartiff_2021_JEP\|Cartiff et al. (2021)]] 针对认识论认知干预展开首个元分析，证实提供实验[[Variable\|变量]]与记录支架的指导式探究成效突出，而缺乏支架的开放[[Problem Solving\|问题解决]]与自由辩论效果微弱，从干预设计层面确立了指导支架对探究转化的决定性意义。
...
> |---|---|---|---|---|---|---|---|
> | [[Argument_DeJong_2023_ERR\|Dean & Kuhn (2007, cited in De Jong et al., 2023, p. 3)]] | [[Control of Variables Strategy\|变量控制策略]]教学：[[Direct Instruction\|直接教学]]组 vs. 直接教学+探究组 vs. 纯探究组 | 变量控制策略即时掌握率与 13 周延迟保持率 | 六年级学生 | 13 周延迟[[Pre-test and Post-test\|后测]]保持率：直接教学组 31%；直接+探究组 83%；纯探究组 78% | — | 组间差异显著（$p < .05$） | 受控纵向实验；证实脱离持续探究练习的单一直接讲授在长效保持上极脆弱 |
...
> | [[Argument_DeJong_2023_ERR\|Chase & Klahr (2017, cited in De Jong et al., 2023, p. 3)]] | 物理概念学习：学生自主设计与探究 vs. 教师直接讲授方案 | 深度概念理解与跨情境远迁移测验 | 小学高年级学生 | 自主设计探究组在解释性因果机制与迁移任务得分显著占优 | — | 显著高于直接讲授组 | 实验室受控实验；证实自主权衡[[Variable\|变量]]关系有助于深层认知表征的重构 |
...
> | [[Argument_Cartiff_2021_JEP\|Cartiff et al. (2021)]] | 干预措施（[[Epistemology\|认识论]]干预教学框架对比） | 指导式探究（$d = 0.808$） vs. 认知支架（$d = 0.663$） vs. 问题驱动学习（$d = 0.340$） vs. 论证教学（$d = 0.134$） | $k = 7$（指导式探究） / $N = 893$ | 指导式探究 $d = 0.808$；PBL $d = 0.340$；论证 $d = 0.134$ | $Q_b(5) = 17.491, p < .01$ | 认识论认知干预中，显性讲授指导步骤与变量控制支架的探究设计显著优于缺乏支架的开放问题解决与论辩 |
