...
> [!claim] Cartiff et al.
> **显性证据支架对探究转化的保护机制** 在认识论认知教学干预中，指导式探究通过提供结构化的实验步骤引导、表格记录支架与变量控制规程，能有效防范劣构探究情境带来的认知超载；相比之下，缺乏结构化支架的自主问题解决与开放式辩论极易陷入表层争拗或盲目试误，唯有显性讲授证据评估规则与严谨实证规程的指导式探究，才能实质性引导学生重构深层认知图式并促进学业表现。[[Argument_Cartiff_2021_JEP|(Cartiff et al., 2021, pp. 485–486, 492)]]
...
> - **2021 年 — 认识论认知干预中的因果效应与支架必要性确立** [[Argument_Cartiff_2021_JEP|Cartiff et al. (2021)]] 针对认识论认知干预展开首个元分析，证实提供实验变量与记录支架的指导式探究成效突出，而缺乏支架的开放问题解决与自由辩论效果微弱，从干预设计层面确立了指导支架对探究转化的决定性意义。
...
> | [[Argument_Cartiff_2021_JEP\|Cartiff et al. (2021)]] | 干预措施（认识论干预教学框架对比） | 指导式探究（$d = 0.808$） vs. 认知支架（$d = 0.663$） vs. 问题驱动学习（$d = 0.340$） vs. 论证教学（$d = 0.134$） | $k = 7$（指导式探究） / $N = 893$ | 指导式探究 $d = 0.808$；PBL $d = 0.340$；论证 $d = 0.134$ | $Q_b(5) = 17.491, p < .01$ | 认识论认知干预中，显性讲授指导步骤与变量控制支架的探究设计显著优于缺乏支架的开放问题解决与论辩 |
