...
> [!info] 定义
> 直接教学（Direct Instruction, DI）通常指一种由教师主动组织学习过程的教学取向，核心做法包括明确说明目标、分步示范、带领练习、检查理解并通过复习巩固知识。严格来说，大写 DI 也可专指 Engelmann 等人开发的特定教学项目；在当前 vault 更常处理的是广义用法，也就是以明确讲解和清晰引导为特征的一般教学取向([[Argument_Zhao_2017_JEC|Zhao, 2017, p.7]])。
>
...
> [!abstract] 核心要素
> - 明确目标：教师先让学生知道这节课要学什么、学会之后应能做到什么([[Argument_Zhao_2017_JEC|Zhao, 2017, p.7]])。
> - 分步示范：教师把关键过程拆开，边做边解释，而不是只给结论([[Argument_Zhao_2017_JEC|Zhao, 2017, p.7]])。
> - 理解检查：在进入独立任务前，教师需要确认学生是否真的听懂，而不是默认“讲过就算学会”([[Argument_Zhao_2017_JEC|Zhao, 2017, p.7]])。
> - 有指导练习：学生先在教师支持下练习，再逐步过渡到独立完成([[Argument_Zhao_2017_JEC|Zhao, 2017, p.7]])。
> - 复习与巩固：已学内容会被回收、总结和再练习，使知识结构稳定下来([[Argument_Zhao_2017_JEC|Zhao, 2017, p.7]])。
...
> [!success] 实证发现
> - 在 [[Visible Learning]] 体系中，直接教学通常被视为高[[Effect Size|效应量]]教学策略之一，常被用来支撑“教师作为激活者”的教学图像([[Argument_Terhart_2011_JCS|Terhart, 2011, p.433]]; [[Argument_Zhao_2017_JEC|Zhao, 2017, p.7]])。
...
> [!info]- 核心数据
> - [[Argument_Zhao_2017_JEC|Zhao (2017)]]转述 Hattie 对直接教学的效应量估计约为 `d=0.59`，高于 `d=0.40` 的常用阈值([[Argument_Zhao_2017_JEC|Zhao, 2017, p.7]])。

## 争议与批评

> [!warning] 争议与批评
> - 效果与副作用并存：[[Argument_Zhao_2017_JEC|Zhao (2017)]]提醒，直接教学在短期成绩表现上常常有利，但这不自动意味着它在创造力、开放探索和复杂问题解决上也总是更优。更完整的讨论见 [[Side Effects]]([[Argument_Zhao_2017_JEC|Zhao, 2017, pp.7-10]])。
