...
> - 分步示范：教师把关键过程拆开，边做边解释，而不是只给结论。
> - 理解检查：在进入独立任务前，教师需要确认学生是否真的听懂，而不是默认“讲过就算学会”。
> - 有指导练习：学生先在教师支持下练习，再逐步过渡到独立完成。
> - 复习与巩固：已学内容会被回收、总结和再练习，使知识结构稳定下来。
...
> - 适用边界强依赖学习阶段：当学生尚未形成基础[[Knowledge Framework|知识框架]]时，直接教学往往更容易发挥作用；但若长期只保留讲解和模仿，而不给学生更高阶应用与反思空间，就可能把“清晰结构”变成“过度控制”。
