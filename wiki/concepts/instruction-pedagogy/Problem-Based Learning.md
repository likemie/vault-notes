...
>
> Biggs 将传统模式的问题定位为目标、活动与结果之间的脱节：学生积累了由考试组织的陈述性知识，处理陌生专业问题的能力却从未得到系统练习与评估。PBL 从专业能力出发，选择能够覆盖核心概念的问题，再用同类案例组织学习和评价，实现深层的[[Constructive Alignment\|建构性对齐]]。[[Argument_Biggs_1999_HERD\|Biggs (1999, pp. 70–72)]]
...
> | **教师主要作用** | 设计劣构问题、监控小组认知进程、适时提供反思支架 | 显性讲授、清晰示范、逐步推进、检查与即时纠错 | 组织生活世界现象情境、引导跨学科资源与[[Bildung\|教化]]反思 |
> | **主要边界** | 对先备知识水平、问题设计质量与导师支架能力高度敏感 | 易局限于陈述性与[[Procedural Knowledge\|程序性知识]]掌握，自主迁移难度高 | 强调具身经验与芬兰教学论传统，跨情境移植难度大 |
...
> | 形成最终问题表述 | 综合关键概念、应用于患者问题、自我监控和回应反馈 | 检验[[Knowledge Integration\|知识整合]]、专业应用与过程调节 |
>
...
> [!claim] Cartiff, B. M.
> **缺乏程序支架的 PBL 在复杂[[Epistemology\|认识论]]任务中成效受限** 在针对[[Epistemic Cognition\|认识论认知]]与高阶[[Academic Achievement\|学业成就]]的一阶[[Meta-analysis\|元分析]]中，基于问题的学习作为干预框架所取得的促进效应较为微弱且未达统计显著，显著落后于明确讲授探究规程的[[Inquiry-Based Learning\|指导式探究]]与[[Source Evaluation\|信源评估]]。元分析证实，面对多文本冲突与劣构争议情境，单纯呈现真实问题而不提供显性认知与[[Metacognition\|元认知]]支架，容易导致学生在过载的认知负荷中无所适从，印证了 PBL 必须高度依赖结构化支架与过程示范才能发挥实效的理论判断。[[Argument_Cartiff_2021_JEP\|(Cartiff et al., 2021, pp. 486, 492)]]
...
> |---|---|---|---|---|---|---|---|
> | [[Argument_Cartiff_2021_JEP\|Cartiff et al. (2021)]] | 干预教学框架：PBL 对[[Academic Achievement\|学业成就]]与[[Epistemic Cognition\|认识论认知]]的因果干预效应 | 7 项研究 / 1,250；7 个效应 | Cohen's d；[[Fixed-Effect and Random-Effects Models\|随机效应模型]] | d = 0.340 [−.080, .761] | Q(6) = 115.279, p < .001 | 作为独立干预模式效果未达统计显著（Z = 1.586, p = .113），证实劣构问题探究若缺乏显性程序支架则成效受限 |
...
> - [[Argument_Cartiff_2021_JEP\|Cartiff et al. (2021)]] 在[[Epistemic Cognition\|认识论认知]]干预因果元分析中量化对比了基于问题的学习（PBL）与其他教学框架的[[Effect Size\|效应量]]，实证揭示了缺乏显性[[Scaffolding\|认知支架]]时 PBL 的成效局限。
