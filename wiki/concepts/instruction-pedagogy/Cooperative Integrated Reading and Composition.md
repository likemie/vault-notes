...
> [!boundary]- 概念边界
> - **不等于自由默读（Silent Reading / Free Reading）** CIRC 强制要求异质同伴轮流大声朗读、相互纠正发音与即时口头复述，杜绝被动默读时的假性参与。
> - **不等于无结构的常规小组讨论** CIRC 包含严格规范的故事语法图解（Story Grammar）、标准化的同伴编辑检查清单（Peer Editing Checklists）与基于个体进步分的小组表彰机制。
> - **不等于孤立的阅读技巧训练** CIRC 将阅读解码、词汇理解与书面写作深度整合，每一阅读单元均延伸至批判性写作与故事续写。

---

## 概念辨析

> [!contrast-table] CIRC 与其他主流读写教学模式对比
> | 比较维度 | 合作整合读写 (CIRC) | 传统全班单向讲读 | 独立自定步调阅读 (Individualised Reading) | 纯粹小组自由讨论 |
> |---|---|---|---|---|
> | **课堂组织** | 教师精讲示范 + 异质结对[[Peer-Supported Learning\|同伴互助]] | 教师逐段领读讲解，全员被动听讲 | 学生各自独立默读与完成练习册 | 学生自主分组，自由交流读后感 |
> | **互动与反馈** | 伙伴即时纠音、协商词义与清单互评草稿 | 师生一对一抽查提问，多数学生处于旁观状态 | 无生生互动，完全依赖课后教师批改 | 互动自由但缺乏纠错标准与质量把控 |
> | **读写连接度** | 阅读理解与写作修改紧密整合，即读即写 | 阅读课与写作课彼此割裂分离 | 仅侧重阅读答题，缺乏深度写作循环 | 偶有口头交流，少有规范写作转化 |
> | **责任与激励** | 团队目标 + 个体独立测试，计算进步分 | 个人单独应试，竞争性排名 | 仅对个人进度负责，缺乏同伴支持 | 容易滋生“搭便车”与责任分散效应 |
...
> [!feature] 核心要素
> - **教师显性策略示范（Teacher-Led Explicit Instruction）** 教师精讲预测、主旨提炼、故事语法结构分析与写作修辞策略，进行认知建模。
> - **异质配对朗读与即时纠音（Partner Reading & Decoding）** 组内异质结对轮流朗读课文段落，同伴即时纠正发音并进行段落要点口头复述。
> - **词汇协商与故事语法图解（Vocabulary & Story Structure）** 共同研讨目标词汇语境含义，绘制故事背景、人物动机、冲突与结局的结构图表。
> - **同伴审阅与清单互评修改（Peer Editing & Writing Process）** 依据标准化清单相互审阅写作草稿，提供具体修改建议并完成定稿打磨。
> - **个体独立测试与团队进步表彰（Individual Accountability & Team Recognition）** 学生独立参加阅读理解与写作测验，依据个人进步分为团队赢取集体表彰。

> [!logic-map]- CIRC 五步读写教学闭环
> ```mermaid
> flowchart LR
>     A["1. 教师显性策略示范<br>（阅读技巧建模）"] --> B["2. 配对朗读与纠音<br>（高频口头输出）"]
>     B --> C["3. 词汇协商与故事图解<br>（深层语义建构）"]
>     C --> D["4. 同伴审阅互评清单<br>（读写迁移打磨）"]
>     D --> E["5. 独立测试与团队表彰<br>（个体责任强化）"]
> ```
...
### 命题二　作为 SFA 旗舰课程基座，CIRC 构成循证改革中全校 Tier 1 读写教学的核心支柱
...
> | 命题类型 | 核心指向 | 适用情境 | 代表学者 |
> |---|---|---|---|
> | **读写整合高效益** | 配对朗读与清单互评打破读写割裂，干预成效居合作学习各具体技术之首（$ES = 2.04$） | 中小学语言、母语及第二语言读写教学 | Stevens et al. (1987); Slavin (1995); [[Argument_Gungor_2026_CP\|Güngör et al. (2026)]] |
> | **循证全校改革基座** | 作为 SFA 项目核心 Tier 1 读写课程，依托结构化流程与教师培训支撑全校规模化提质 | 弱势学校全校性综合改革、补偿教育与循证政策推广 | [[Argument_Slavin_2019_EP\|Slavin (2019)]]; Borman et al. (2007) |
...
> > 探讨在资源有限的常规课堂中推行全套 CIRC 的可行性。
> >
> > - **全面整合取向** 强调阅读与写作本质相通，强行割裂会导致知识孤立，一体化虽然前期投入大但长期效益最高。
...
> |---|---|---|---|---|---|---|
> | Stevens et al. (1987) | 美国小学 3–4 年级语文课堂（涵盖常规班级与融合特殊教育学生） | 准实验对照设计（两学年追踪） | 标准化阅读理解、语言词汇与书面表达写作测试 | CIRC 实验组在标准化阅读理解和写作表达上显著超越传统全班讲读对照组 | $p < .05$，效应稳定 | 奠定了 CIRC 作为独立读写合作学习模式的奠基性实证基础 |
> | [[Argument_Slavin_2019_EP\|Slavin (2019)]]（汇总 SFA 大规模评估） | 全美千余所薄弱小学（涵盖高比例弱势族裔与贫困儿童） | 多项全国整群 RCT 与长期追踪评估（涵盖 Borman et al. 2007 等 5 项大型研究） | 阅读总分及阶段性读写达标率 | 作为 SFA 核心读写课程，助力项目达成 $ES = +0.41$ 的强效综合阅读增益 | 经受住多轮独立审查 | 确立其在全美联邦循证改革与 [[Top Institute for Evidence-Based Education Research\|TIER]] 1 核心教学中的标杆地位 |
