...
aliases:
  - "任务结构"
  - "well-structured and ill-structured tasks"
  - "良构与劣构任务"
  - "良构任务"
  - "劣构任务"
...
> | **认知与[[Epistemology\|认识论]]要求** | 强调信息提取、程序执行与确定性事实总结。（p.316） | 强调[[Reflexivity\|反思性]]判断、矛盾证据权衡、视角整合与不确定性容忍。（pp.316–317） |
...
> [!feature] 任务结构维度的构成要素
> - **结构表述清晰度（Structural Presentation）** 任务目标、文体规范及预期产出大纲的界定明确程度。
> - **资源可及性（Available Resources）** 学习材料是由教师预先打包提供，还是需要学生在环境中自主搜寻与筛选。
> - **教学线索与提示（Instructional Cues）** 任务中内嵌的操作指引、步骤提示与算法支持程度。
> - **评价标准明确性（Grading Criteria）** 衡量成功解决任务的标准与量规是对学生透明公开还是隐蔽开放。[[Argument_Lodewyk_2007_EP\|(Lodewyk, 2007, p. 316)]]
...
### 命题二　课堂任务结构的失衡会阻碍学生的认知迁移或引发焦虑退缩

> [!concept-lens] 教学设计的任务平衡
> 探讨过度单一的良构或劣构任务配置对学习者认知发展与动机状态的负面后果。

> [!claim] Spiro et al. (1988)
> **良构任务过载的简化错觉** 长期、过度布置高度良构的任务（如孤立记忆事实的工作表）会向学生传递该学科领域本质上简单且无需概念整合的虚假理解，促发表面化[[Student Engagement\|学习投入]]，并严重妨碍高级知识获取与远迁移能力的形成。[[Argument_Lodewyk_2007_EP\|(Lodewyk, 2007, pp. 311, 324)]]

> [!claim] Doyle (1983)
> **劣构任务超载的焦虑退缩** 过度布置高度模糊与认知挑战过大的劣构任务而缺乏必要[[Scaffolding\|脚手架]]时，会显著推高学生的焦虑水平，诱发认知逃避、自我怀疑甚至完全放弃学习任务。教学设计需要在良构与劣构任务之间维持动态平衡。[[Argument_Lodewyk_2007_EP\|(Lodewyk, 2007, pp. 311, 324)]]
...
> |---|---|---|---|---|---|---|
> | [[Argument_Lodewyk_2007_EP\|Lodewyk (2007)]] | 89名加拿大十年级中学生（基督教独立学校） | 平衡顺序组内对比设计（counterbalanced within-subject design；良构 vs 劣构癌症议题任务） | 任务结构（WST vs IST）、任务表现（量规评分+10题单选测验，满分100）、[[Reflexivity\|反思性]]判断得分（1–5分） | WST 均分 70.30（$SD = 17.61$），IST 均分 67.72（$SD = 17.93$）；两任务成绩相关 $r = .51$；认识论信念回归模型中，信念因子对 WST 无预测力（$R^2 = .04$），但对 IST 有显著预测力（$R^2 = .12$） | $t(88) = -1.38, p = .17$，效应量（effect size, ES）$ES = 0.15$（两任务成绩差异不显著）；WST 回归 $F(3,85) = 1.07, p = .37$；IST 回归 $F(3,85) = 3.80, p = .01$ | 任务均基于癌症主题，施测于同一班级，结果反映中等程度任务结构差异下的信念激活效应 |

---

## 应用案例

> [!example] 教学任务设计的经典实验案例（[[Argument_Lodewyk_2007_EP\|Lodewyk, 2007]]）
> - **良构任务案例：个人生活方式计划（Personal Lifestyle Plan）** 要求学生选择一种癌症，汇总其病因、症状、疗法及预防行为撰写结构化报告。任务前播放 20 分钟录像并完成工作表，提供预包装资料袋及细化评分量规。（p.316）
> - **劣构任务案例：专案组癌症经费分配辩护（Task-Force Issue）** 要求学生撰写议论文，为政府资金应优先投向预防宣传还是治疗科研进行立场辩护。无先行组织者，学生自行在教室检索资源，量规对学生保密，重点考核基于 King & Kitchener (1994) 的[[Reflexivity\|反思性]]判断深度。（pp.316–317）
