...
> [!info]
> Devil's advocate（魔鬼代言人）原指罗马天主教会封圣程序中负责提出反对意见、挑战候选人圣洁证据的一方。在当代用法中，它指一种说话[[Praxis|实践]]：一个人为自己并不一定赞同的立场辩护，目的纯粹是为了检验论证、暴露论证中的漏洞和弱点，从而使原有论证变得更强([[Argument_Li_2012_Cambridge|Li, 2012, p.95]])。
...
> [!warning]
> Devil's advocate 的[[Praxis|实践]]在东亚文化中几乎没有对应的社会化实践。Li 论证，东亚文化——在儒家"[[Action Better Than Words|行胜于言]]"、道家"知者不言"和佛教静思冥想传统的影响下——对口头辩论抱有根本性的不信任([[Argument_Li_2012_Cambridge|Li, 2012, pp.96-97]])。
