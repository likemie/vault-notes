...
> [!citation-card]- 关键表述：AI 时代的结构化教学支架与认知增益
...
> | **教师角色** | 学习活动的设计者、反思脚手架与[[Dialogue in Education\|对话]]引领者 | 知识示范者、步骤指令发布者与即时纠错者 | 旁观协助者或资源提供者（极少干预） | 知识垄断者与讲台中心的主导讲述者 |
> | **学生能动性** | 在清晰支架下展开主动探究、反思监控与协作 | 依循示范步骤进行模仿、训练与达标反馈 | 表面高度自主，但认知准备不足者易[[Lost Mode\|迷失]] | 处于被动接受、机械记录与应答位置 |
> | **核心认知机制** | 释放外在负荷以维持高阶[[Epistemology\|认识论]]摩擦与图式构建 | 通过精细分解步骤降低认知负荷，强化基础技能 | 认知负荷不可控，易引发认知过载或[[Cognitive Offloading\|认知卸载]] | 浅层事实记忆与程序复制，缺乏深层认知冲突 |
> | **AI 时代的表现** | 递归探究、提示词追踪与批判审订（协同增益） | 算法辅助的分步操练与自动化正误判断 | 依赖 AI 产出终稿，诱发深度认知卸载与侵蚀 | 视 AI 为作弊隐患进行机械性惩罚性封堵 |
...
>         D1["清晰目标与对齐量规 (Aligned Rubrics)"]
>         D2["递归探究任务流程 (Recursive Inquiry Task)"]
>         D3["提示词迭代与反思日志规程 (Reflection Protocols)"]
>         D4["多源反馈生态网络 (Multi-Source Feedback)"]
>     end
>     
>     D1 & D2 & D3 & D4 --> M{"认知加工调节中介"}
>     
>     subgraph 认知机制调节["认知机制调节 (Cognitive Mediation)"]
>         M -->|"优化负荷分配"| C1["剥离机械外在负荷，投入图式重组"]
>         M -->|"维持认识论摩擦"| C2["批判性审定 AI 输出，防范心智盲从"]
>         M -->|"激活双向思维"| C3["发散创意生成 (CrT) ⟷ 收敛逻辑批判 (CT)"]
>     end
>     
>     C1 & C2 & C3 --> O["高阶思维协同增益 (Synergistic Enhancement: CT ↑, CrT ↑)"]
>     
...
### 命题二　缺乏教学支架的去结构化环境诱发认知卸载与脆弱群体的学业掉队
...
> |---|---|---|---|
> | **认知发展调节中介** | 结构化设计为高质量互动提供支架；在 AI 时代驱动批判与创造思维的双向协同增益。 | 基础教育课堂组织、高校 AI 课程与教学设计 | Håkansson; Li et al. |
> | **去结构化认知风险** | 缺乏支架的放任环境诱发深度[[Cognitive Offloading\|认知卸载]]，加剧弱势群体的学业掉队与[[Higher-Order Thinking Skills\|高阶思维]]萎缩。 | 个别化学习评估、无指引技术整合环境 | Håkansson; Li et al. |
> | **动态适配与支架渐退** | 教学结构强度与学生自我调节能力成反比；随素养成熟逐步渐退以赋能自主学习。 | 差异化教学、脚手架工程与元认知培养 | Håkansson; Li et al. |
...
> > 技术决定论主张教育技术的优劣取决于算法工具本身；教学论学者则坚持技术效应完全依存于结构化教学系统的重塑。
> >
