...
> [!info] 定[[Rightness|义]]
> 有效教学（effective teaching / god undervisning）是一个综合性教学质量概念，用来概括教师如何通过明确领导、清晰目标、[[Feedback|反馈]]、学习导向气氛和适配学生前提来促进学习。Laursen (2015) 讨论的重点不是教学法排名，而是教学方法背后的质量条件：方法是否适合内容和目标，学生是否知道要学什么和下一步怎么做，课堂是否既安全又有学业要求（Laursen, 2015, pp.35–36）。
>
...
- **提供有效[[Feedback|反馈]]**：[[Feedback|反馈]]的关键不只是告诉学生表现如何，而是帮助学生知道下一步怎样改进。SFI 报告关于反馈的零效应更可能来自测量口径，而不是反馈本身在丹麦无效（Laursen, 2015, p.39）。
...
> - vs [[Feedback]] — 反馈是有效教学的重要机制之一，但不是孤立技术。反馈只有在帮助学生理解当前位置、目标和下一步行动时，才符合 Hattie 意[[Rightness|义]]上的学习促进机制（Laursen, 2015, p.39）。

## 理论基础

> [!info] 理论基础
> - [[Hofstede's Cultural Dimensions]] 为 Laursen 的跨文化问题提供了假设来源：如果丹麦文化高度个人主[[Rightness|义]]、低权力距离、女性化且低不确定性规避，那么开放、对话、弱教师控制的教学似乎应更适合丹麦学生（Laursen, 2015, pp.36–37）。
...
有效教学研究还受到概念测量方式影响。SFI 报告没有发现其问项所测的[[Feedback|反馈]]行为能提升学习，但相关问项只询问教师是否告知学生发展或表现如何，没有捕捉"下一步如何改进"这一核心。因此，这一结果更适合被理解为[[Feedback|反馈]]测量不足，而不是反馈机制本身失效（Laursen, 2015, p.39）。
...
> - **学业成绩不是教育全部目的**：SFI 报告主要以毕业考试成绩衡量学习，因此它能说明哪些教学质量提高学业成绩，却不能充分回答教育目的、学生意[[Rightness|义]]建构、创造力或民主参与等更宽问题（Laursen, 2015, p.37）。
