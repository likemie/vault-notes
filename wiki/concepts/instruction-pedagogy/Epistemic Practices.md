...
> - **用途** 帮助研究者摆脱传统科学教育只关注既定科学结论（products）的机械灌输偏误，将透镜聚焦于行动中的科学（science-in-the-making），洞察学生如何在课堂话语与实验互动中学会像科学家一样开展证据辨析与论证争辩。
> - **边界** 严格区别于心理学中去情境化的个人认知技能或刻板教条的[[Scientific Method\|科学方法]]五步法；认识论实践深嵌于具体学科文化与微观话语情境之中。

> [!citation-card] 论认识论实践的[[Operationalization\|操作化]]界定
> 认识论实践是一个群体成员用以提出、沟通、评估和合法化知识主张的社会组织化且在互动中得以实现的方式。借鉴科学研究与教育研究，认识论实践是交互生成的（由人们通过协同活动建构）、情境化的（植根于社会实践与文化规范）、互文的（通过话语、符号和标志的历史连贯性传递），且具有后果性（被合法化的知识具象化了权力与文化）。通过这些认识论实践的运用，共同体赋予知识主张以正当性理由。[[Argument_Kelly_Licona_2018_EpistemicPractices\|(Kelly & Licona, 2018, p. 140)]]
>
...
> [!boundary]- 概念边界
> - 不等于 [[Practical Epistemology\|实践认识论]]（Practical Epistemology） 实践认识论主要关注学生在探究实践中隐性持有并运用的知识信念倾向（如对知识确定性、简单性的心理[[Hypothesis\|假设]]）；认识论实践则聚焦于在公开话语互动中被执行、被观察、被集体裁决的社会化行动模式。
> - 不等于 刻板化科学过程技能（Science Process Skills） 传统技能（如单纯的观察、测量、分类）往往被割裂为去情境的算法式步骤；认识论实践强调[[Knowledge Production\|知识生成]]、评价与辩护在真实学科文化和价值规范中的不可分割性。
> - 不等于 个人认识论（Personal Epistemology） 个人认识论将认知主体预设为孤立的个体心智，依赖去情境的[[Questionnaire\|问卷]]量表测量信念发展阶段；认识论实践将主体定位于微观协商共同体，通过[[Discourse Analysis\|话语分析]]考察社会互动的规程。

---

## 概念辨析

[[Epistemology|认识论]]实践的引入推动了科学教育研究认识论基础的根本转向：

> [!contrast-table] 认识论[[Paradigm\|范式]]与相近[[Construct\|构念]]辨析
...
[[Epistemology|认识论]]实践由行动维度、本体特征与学科形态共同建构而成。

### 四维行动框架

群体的认识论实践主要体现在对知识主张（knowledge claims）的四类核心操作：

> [!taxonomy] 认识论实践的四维行动维度（[[Argument_Kelly_Licona_2018_EpistemicPractices\|Kelly & Licona, 2018, pp. 140]], 144–147）
> - **提出主张（Propose）** 针对自然现象提出尝试性构想与解释[[Hypothesis\|假设]]。包括提出科学探究问题、设计调查方案、进行具身观察与仪器测量、设想相关证据基础，以及构建和修正初始理论模型。
> - **沟通主张（Communicate）** 运用专业学科语言与符号系统呈现推理链条。包括撰写实验报告、开展口头[[Scientific Explanation\|科学解释]]、基于证据与推理展开阐述、向特定受众（同伴、教师、委托方）进行说服性表达。
> - **评估主张（Evaluate）** 对知识主张及其[[Chain of Evidence\|证据链]]条的严密性进行公共审查。包括评判主张与证据的契合度、检验推理逻辑的内在连贯性、权衡相互竞争的备择解释（alternatives）、审查模型解释力的边界与局限。
> - **合法化主张（Legitimize）** 确立知识主张在特定共同体中的公共效力。包括达成群体共识、将新解释纳入既有被科学界认可的理论谱系、接受学科共同体的标准规范检验，以及赋予学生平等的科学身份。
...
> | **社会实践目标** | 掌握科学认知文化用于生成、交流与评估主张的规程 | 掌握工程团队与委托客户之间生成与评估设计的协作规程 | 掌握在公共辩论中生成、评估与反驳竞争性主张的论辩规程 |

> [!logic-map]- 认识论实践四维行动与情境生成关系
> ```mermaid
> flowchart LR
>     subgraph Actions["四维行动环节"]
>         P["<b>提出主张 (Propose)</b><br/>问题生成 · 具身观察 · 假说建构"]
>         C["<b>沟通主张 (Communicate)</b><br/>受众调整 · 符号表征 · 修辞协商"]
>         E["<b>评估主张 (Evaluate)</b><br/>证据检视 · 逻辑排查 · 准则审查"]
>         L["<b>合法化主张 (Legitimize)</b><br/>达成共识 · 规范确认 · 身份赋予"]
>     end
>     subgraph Contexts["三重活动情境"]
>         D["发现的情境 (Discovery)"]
>         J["辩护的情境 (Justification)"]
>         M["沟通的情境 (Communication)"]
>     end
>     P --> C --> E --> L
>     L -.->|迭代修正| P
>     Actions <--> Contexts
...
### 命题一　科学知识的认识论主体是具有文化规程的微观社会协商共同体而非笛卡尔孤立知者

> [!concept-lens] [[Epistemology\|认识论]]主体转向
> 探讨认识论的核心承载者是个体心智还是社会共同体，论证科学教育必须走出孤立心理测验的狭隘视野。

> [!claim] [[Argument_Kelly_Licona_2018_EpistemicPractices\|Kelly & Licona (2018)]]
> **共同体认识论转向** 认识论主体不是孤立的个体认知者，而是处于具体情境中的微观协商共同体。决定何者算作知识与正当理由的依据，并非个体心智对客观实在的符合程度，而是共同体成员公认的标准、审议规程以及对合理批评的接纳。科学教育的核心在于引导学生参与真实科学认知文化的实践活动。[[Argument_Kelly_Licona_2018_EpistemicPractices\|(Kelly & Licona, 2018, pp. 140, 147–148)]]

> [!claim] Helen Longino (1990, 2002)
> **社会知识认识论规范** 科学知识的客观性由批判性互动的社会实践所保证。微观共同体必须具备四大规范：公开的论辩论坛（venues）、对合理批评的吸收接纳（uptake）、公开认可的评估标准（publicly recognized standards）以及适度平等的智识权威（tempered equality of intellectual authority），才能防止实证视角滑向主观相对主义。[[Argument_Kelly_Licona_2018_EpistemicPractices\|(Kelly & Licona, 2018, p. 148)]]
...
### 命题四　探究操作必须依托显性元话语反思与批判性社会规范才能转化为公共科学素养

> [!concept-lens] 实践转化与素养生成机制
...
> |---|---|---|---|
> | **认识论主体转向** | 将认识论主体由孤立知者重构为遵循批判规范的微观协商共同体 | 科学教育认识论[[Paradigm\|范式]]转型、课堂学习共同体建设 | [[Argument_Kelly_Licona_2018_EpistemicPractices\|Kelly & Licona (2018, pp. 140, 147–148)]]; Longino (1990, 2002); Duschl (2008) |
...
> [!debates] 学术争议与理论张力
>
> > [!axis] 描述性实证记录 vs. 规范性教育目标
> > 科学社会学记录的真实科研行为能否直接作为学校科学教学的规范标准？
> > - **实证还原立场** 认为教学应当尽可能还原职业科研的原真性（authenticity），让学生体验真实的科学家争论与博弈。
> > - **规范教育立场** 指出职业科研中包含激烈的利益冲突与竞争博弈，学校教学必须以育人目标和伦理关怀为前提，通过朗基诺（Longino）的批判规范引导理性协商，防范教学滑向主观相对主义。[[Argument_Kelly_Licona_2018_EpistemicPractices\|(Kelly & Licona, 2018, pp. 143–144, 148)]]
> >
...
> 2. **概念知识与实践进阶的协同机制有待深入** 认识论实践高度依赖具体学科的概念基础，缺乏概念支撑的实践容易沦为形式操作（[[Argument_Kelly_Licona_2018_EpistemicPractices\|Kelly & Licona, 2018, pp. 159–160]]）；
> 3. **跨领域实践能力的迁移范围尚缺乏充分实证** 学生在某一学科获得的证据评估能力能否有效迁移到其他领域，目前实证证据仍较有限（[[Argument_Kelly_Licona_2018_EpistemicPractices\|Kelly & Licona, 2018, p. 160]]）。

---

## 实证数据

> [!ref-table]- 课堂[[Epistemology\|认识论]]实践微观质性实证研究（无[[Effect Size\|效应量]]）
