...
> [!info] 定义
> 探究螺旋（Spirals of Inquiry）是由 Timperley, Halbert, & Kaser (2014) 开发的[[Practitioner Enquiry|教师探究]]循环模型，已在多个情境中实施。该模型的核心主张是：教师通过参与系统性[[Inquiry Cycle|探究循环]]——扫描学生的教育体验→发展探究焦点→形成关于教师行动如何改变模式的[[Hypothesis|假设]]→查阅已发表证据→采取行动→检查效果——将外部研究证据与本地证据生成过程整合([[Argument_Peterson_2016_IJRME|Peterson, 2016, p. 306]])。
>
