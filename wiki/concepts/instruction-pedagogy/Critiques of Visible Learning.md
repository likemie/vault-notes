...
> - **不是单一立场** — 这里汇集的方法论批评、教育哲学批判、文化政治分析和支持者辩护之间并不总是彼此一致；它们共享的只是“VL 不能被当作自明真理”这一基本判断。

## 批评演变

> [!note] 批评演变
> - **2009–2011**：批评首先聚焦在效应量阈值、研究质量、平均化和校外因素排除等方法论与政策外推问题（Argument_Snook_2009_NZJES；[[Argument_Terhart_2011_JCS]]）。
> - **2015–2017**：随着 VL 在北欧和英语世界进一步扩张，争议开始细化到统计前提、二级综合计算、反馈概念和教师实践转译（[[Argument_Allerup_2015_Paideia]]；[[Argument_Wecker_2016_ZfE]]；[[Argument_Eacott_2017_SLM]]）。
...
> [!warning] 主题导览
> 这一组批评围绕同一个核心追问：VL 是否真的能把高度异质的教育研究压缩为可比较、可排序、可直接转成实践建议的数字地图。
>
> 读法建议：
...
> - 想看案例式拆解，读 [[Argument_OConnor_2020_AJLL]] 对全语言的审查，以及 [[Argument_Nielsen_2021_NordPsych]] 对反馈元分析的细读。
...
**（2）效应量 d=0.40 截断值武断**：0.4 的铰链点选择任意，小效应量在高质量大规模研究中意[[Rightness|义]]重大——医学中阿司匹林降低心脏病风险的效应量仅 0.07，却意味着每 1000 人拯救 34 人（p.99）。Hattie 本人在户外教育的"跟进"效应中因效应量 0.17 而兴奋，暴露了其阈值应用的不一致（p.99–100）。
...
Terhart（2011), p.436）比后来的批评者更早地识别了元-元分析的根本问题——**信息在聚合层级间的系统性损失**：
...
> [!warning] 主题导览
> 这里的重点不是“VL 有没有证据”，而是“可见性”本身如何携带监控、支配、性别化凝视、能力主义和去政治化效果。若要进一步看 VL 的制度传播与市场化语境，和 [[Visible Learning Branding and Global Influences]] 一起读会更完整。
...
> [!warning] 主题导览
> 这一节集中处理 VL 如何从“研究综合”变成“教育大师话语”与“新泰勒主义管理技术”，重点不是某个统计值，而是权威如何被组织出来。
