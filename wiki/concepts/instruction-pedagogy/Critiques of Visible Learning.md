...
> | 元分析 | ✓ | N | *d* | 内容 |
> |--------|:---:|---:|---:|------|
> | L&W 1980 | ✗ | 4,842 | **1.17** | 39 种**强化技术**（reinforcement techniques）；Hattie 本人亦批评"奖励是否应被视为反馈值得怀疑" |
> | L&W 1982 | ✗ | 15,689 | **0.97** | **线索、参与和纠正性强化**；聚焦教学策略而非反馈 |
> | K&D 1996 | ✓ | 12,652 | **0.38** | **反馈干预**（[[Feedback\|FI]]）——唯一符合 Hattie 定义；但 *d* 仅 0.38，且 **38% 效应为负** |
> | Witt 2004 | ✗ | 24,474 | **1.15** | **教师即时性**（verbal & nonverbal immediacy）；"文本中未提及反馈"；22/34 项未发表 |
> | S&L 2001 | ✗ | 5,104 | **1.12** | **考官辅助／动态评估**；研究考官在测试中提供的"线索、暗示或提示" |
...
>
> Larsen 的核心替代方案是复兴 [[Bildung]]（教养）概念。作为 VL 的替代方案，Larsen 提出了具身化-扩展辩证法：每次学习都将学习内容具身化在身体存在中，而每次具身化值得具身化的东西，就扩展了身体与心智综合——这是一个双向运动（[[Argument_Larsen_2019_EducSci|Larsen, 2019, p.8-10]]）。
