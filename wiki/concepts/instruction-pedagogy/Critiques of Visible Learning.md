...
> [!info] 定义
> Critiques of Visible Learning 指围绕 [[John Hattie]] 的 [[Visible Learning]] 所形成的批评谱系。它不只是质疑某一个效应量或某一项排名，而是从统计方法、教育理论、教育哲学、可见性政治、教师专业性、政策使用和商业化网络等多个层面，追问 VL 如何把“学习影响”变成可排序、可管理、可推广的证据对象。
>
...
> [!abstract] 主题地图
> 对 VL 的批评可按主题阅读，而非只按年份阅读：
> - 方法论批评：效应量、元分析和元-元分析能否支撑跨干预排名。
> - 教学理论批评：VL 是否提供了足够清晰的学习、教学和知识概念。
> - 教育哲学批评：VL 是否把教育目的压缩成可评价、可测量的学习产出。
> - 可见性政治批评：让学习、教师和学校“可见”是否同时强化了监控和管理。
> - 政策与商业化批评：VL 如何进入改革、咨询、认证、工具和品牌网络。
> - 支持者辩护：Qvortrup 等支持者如何回应意识形态批评，并主张以更精细的学习模型修正 VL。
