...
**（4）平均化掩盖复杂性**：以家庭作业为例，总体 d=0.29 掩盖了小学 d=0.15、中学 d=0.64 的巨大差异，以及数学（高效应）vs 科学和社会（低效应）的学科差异（p.97）；[[Class Size|班级规模]]的平均效应量掩盖了高质量随机实验（STAR）中发现的 0.62–0.66 效应量（p.100–101）。
