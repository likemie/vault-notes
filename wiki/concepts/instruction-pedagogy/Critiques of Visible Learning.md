...
> [!example] 概念辨析
> - **不是反对一切证据使用** — 本条目批评的是 VL 作为特定项目、特定方法组合和特定政策语言的展开方式，不等于否定所有 [[Evidence-Based Education]] 或所有研究综合。
> - **不是只做统计纠错** — 对 VL 的批评不仅是“某个 d 值算错了”，还包括学习概念、教师角色、教育目的、监控逻辑和商业网络的问题。
> - **不是单一立场** — 这里汇集的方法论批评、教育哲学批判、文化政治分析和支持者辩护之间并不总是彼此一致；它们共享的只是“VL 不能被当作[[Doxa|自明真理]]”这一基本判断。

## 批评演变

> [!note] 批评演变
> - **2009–2011**：批评首先聚焦在[[Effect Size|效应量]]阈值、研究质量、平均化和校外因素排除等方法论与政策外推问题（Argument_Snook_2009_NZJES；[[Argument_Terhart_2011_JCS]]）。
> - **2015–2017**：随着 VL 在北欧和英语世界进一步扩张，争议开始细化到统计前提、二级综合计算、[[Feedback|反馈]]概念和教师实践转译（[[Argument_Allerup_2015_Paideia]]；[[Argument_Wecker_2016_ZfE]]；[[Argument_Eacott_2017_SLM]]）。
...
> - 方法论批评：[[Effect Size|效应量]]、[[Meta-analysis|元分析]]和[[Meta-meta-analysis|元-元分析]]能否支撑跨干预排名。
> - [[Didaktik|教学理论]]批评：VL 是否提供了足够清晰的学习、教学和知识概念。
> - 教育哲学批评：VL 是否把教育目的压缩成可评价、可测量的学习产出。
> - 可见性政治批评：让学习、教师和学校“可见”是否同时强化了监控和管理。
> - 政策与商业化批评：VL 如何进入改革、咨询、认证、工具和品牌网络。
> - 支持者辩护：Qvortrup 等支持者如何回应意识形态批评，并主张以更[[Jing (Refined Mastery)|精]]细的学习模型修正 VL。

> [!tip] 快速阅读路径
> 想先看“数字能不能信”，优先读 `方法论批评`；想看“教育被改写成了什么”，优先读 `教学理论与内容批评` 和 `教育哲学批判`；想看“它为何还能流行”，优先读 `可见性的政治`、`政策与制度争议` 与最后的 `辩护`。

## 方法论批评

> [!warning] 主题导览
> 这一组批评围绕同一个核心追问：VL 是否真的能把高度异质的教育研究压缩为可比较、可排序、可直接转成[[Recommendations for Practice|实践建议]]的数字地图。
>
> 读法建议：
> - 想先看最早的总批评，从 Argument_Snook_2009_NZJES 和 [[Argument_Terhart_2011_JCS]] 开始。
> - 想看技术细节，重点读 [[Argument_Allerup_2015_Paideia]]、[[Argument_Wecker_2016_ZfE]]、[[Argument_Bergeron_2017_MJE]]。
> - 想看案例式拆解，读 [[Argument_OConnor_2020_AJLL]] 对[[Whole Language|全语言]]的审查，以及 [[Argument_Nielsen_2021_NordPsych]] 对[[Feedback|反馈]][[Meta-analysis|元分析]]的细读。
...
**（1）研究质量未被评估**：[[John Hattie|Hattie]] 声称"不是一本关于研究批评的书"，但任何未排除低质量研究的[[Meta-analysis|元分析]]都是误导性的——"垃圾进垃圾出"（Eysenk）（p.94–95）。Hattie 在处理 charter schools 和 learning styles 时选择性排除低质量研究，暴露了其标准的不一致（p.95）。

**（2）[[Effect Size|效应量]] d=0.40 截断值武断**：0.4 的铰链点选择任意，小效应量在高质量大规模研究中意[[Rightness|义]]重大——医学中阿司匹林降低心脏病风险的效应量仅 0.07，却意味着每 1000 人拯救 34 人（p.99）。Hattie 本人在户外教育的"跟进"效应中因效应量 0.17 而兴奋，暴露了其阈值应用的不一致（p.99–100）。
...
**（4）平均化掩盖复杂性**：以家庭作业为例，总体 d=0.29 掩盖了小学 d=0.15、中学 d=0.64 的巨大差异，以及数学（高效应）vs 科学和社会（低效应）的学科差异（p.97）；[[Class Size|班级规模]]的平均效应量掩盖了高质量随机实验（[[Tennessee STAR Project 1985-1989|STAR]]）中发现的 0.62–0.66 效应量（p.100–101）。
...
**数据质量问题**：大多数元分析来自 1980s-1990s，基础数据"大概不是最新的"（p.428）。Hattie "没有向读者提供关于他在决定某研究是否纳入元-元分析时使用的质量标准的准确信息"——而"通常元分析作者投入大量[[Jing (Refined Mastery)|精]]力和努力讨论这个问题"（p.429）。数据库的规模令人印象深刻，"但该数据库不同区域的质量非常异质"——从实验研究到"较少控制的调查研究"（p.429）。
...
> "由于他的元-元分析同时支持稳定性假说和变异性假说，很明显 Hattie 事实上没有找到研究学校、教学和教师的[[Sage|圣]]杯。"（Terhart, 2011, p.436）
...
Wecker, Vogel & Hetmanek（2016), ZfE）发表了迄今为止对 Hattie 二级元分析方法最系统的技术评估。他们构建了一个三层分析框架（Wecker et al., 2016, p.23-24）：
...
- 计算过程重构：对照组 $M=66.53$, $[[School Effectiveness|SE]]=2.74$, $n=107$（来自 Eisenstaedt 等人的原始出版物）
...
**一级层面**（p.31-32）：
- 固定效应模型假设所有主要研究估计同一恒定真实效应——仅抽样误差导致[[Observational and Correlational Research|观察]]到的差异
...
| 个人特征 | 自我概念 | 相关研究为主，不是[[Intervention Research|干预研究]] | 不是"干预"而是"关联"——因果方向可能反向 |
...
> "哈蒂的排名有点像德甲联赛，拜[[Ren|仁]]慕尼黑和汉堡 SV 在好日子和坏日子里都有一席之地。值得怀疑的是，教师是否必须在直接'教学'和分布式实践领域的计划之间做出明智的决定，而不是两者的最佳组合。"（Wecker et al., 2016, p.34）
...
- 对直接教学的热情支持，对"[[Jean-Jacques Rousseau|卢梭]]式方法"（Rousseian inspired methods, p.258）、"促进和探究方法"（facilitative and inquiry methods）、"建构主义潮流"（constructivist fad, p.243）的明确敌意
...
Nielsen & Klitmøller（2021, NordPsych）在方法论批评中提出了一个此前被忽略的维度：**不追问 VL 的效应量或统计方法是否有问题（已知有问题），而是进入 Hattie 最核心的[[Feedback|反馈]]效应（d=0.73，位居第 10），逐项审查其基础元分析是否在研究 Hattie 所声称的现象**。
...
> [!warning] 主题导览
> 这一组批评不再问“统计上是否算得对”，而是问 VL 的教学语言到底薄在哪里：它有没有足够清楚地处理知识内容、课程价值、教师人格和教学判断这些问题。
...
[[John Hattie|Hattie]] 声称其经验分析被置于"理论语境"中——一种[[Didaktik|教学理论]]、一种学生学习和教师工作的理论。Terhart（2011, p.430-431）详细审查了这一宣称后发现严重的内容缺失：
...
**课程内容完全缺失**：在名为"课程"的章节中，读者"再次发现关于某些专门化教学方法及其[[Effect Size|效应量]]的报告。内容问题、学科的教学意[[Rightness|义]]问题、关于合法化课程决策的问题和可能性的反思（为什么包括这个——为什么排除那个？）被完全忽略"（p.431）。
...
这种"压倒性的、旺盛的乐观主义"和"对通过好的教学实现成功学习的可达成性的深深的（美国的？新西兰的？——还是仅仅是教育学的？）信念"让读者"看着数据中常常相当怀疑和悲观的意涵，有点困惑"（p.435）。Terhart 将此诊断为"以更心理学的方式建立的、对通过正确的、好的教学实现无限学习促进的信念"——一种现代版的浪漫化"天生教师"理想，只是这次建立在"科学证据和高涨的教育[[Jing (Refined Mastery)|精]]神"之上（p.435）。

## 教育哲学批判

> [!warning] 主题导览
> 这一组批评把 VL 放回更大的教育哲学问题中：教育是否能被还原成可评价的学习效果？学习是否总能在当下被看见？学生与教师是否只是可管理变量？这些批评与 [[Bildung]]、[[Learnification]]、[[Technical Rationality]] 等条目联系最紧密。
...
Rømer（2018）从教育哲学角度对 [[John Hattie|Hattie]] 的 VL 进行了五线批评，其独特贡献在于追问 VL 的**基本教育理论本身是什么**，而非其经验方法论。

#### 批评一：VL 是评价理论取代（colonize）教育理论

Rømer (2018, p.2-5) 论证 VL 不是一个学习理论甚至不是一个[[Didaktik|教学理论]]——它是当教育和学习被置于一种简单化的[[Appraisal Theory|评价理论]]之下时所发生的事情。评价被定[[Rightness|义]]为"对给定干预目标达成度的回溯性审查"，这要求目标、干预和评估必须被定义为分离的、可测量的、不允许概念上互动的实体。
...
Rømer (2018, p.6-8) 论证 Hattie 的学习理论根植于 von Glasersfeld 的 [[Radical Constructivism|激进建构主义]]（唯我论前提）。Hattie 不批评建构主义本身，而是完全接受之，试图在其上添加"教师中心的教学"。
...
Rømer (2018, p.9) 论证 Hattie 的[[Feedback|反馈]]概念（d=0.73）具有内置的集权化效应。Hattie 本人声明其关键洞察是"反馈最有力的是从学生到教师"（Hattie, 2009, p.173）——反馈不是让文化、艺术和科学对学生可见，而是让学习对教师可见。
...
- Popper 是哲学实在论者，Hattie 是主观建构主义者——两者在认识论上[[Jing (Refined Mastery)|精]]确对立
...
Hattie 和 Zierer 自身的陈述——"课堂上只有 20% 可[[Observational and Correlational Research|观察]]"（Hattie & Zierer, 2018, p.90）——被 Larsen 指出即使是这一估计也过高，且"未以论证、证据或参考文献支撑"。而更关键的是，Hattie 和 Zierer 将这一自我批判的认识论提醒转而用作呼吁更多 VL 研究的理由——Larsen 诊断这恰恰落入了 Luhmann 所描述的盲点困境（Larsen, 2019, p.3-4）。
...
Larsen（2019）的独特贡献在于将四个不[[Tongxue|同学]]科领域（现象学、神经科学、自由哲学、概念史）整合为一个统一的哲学批判框架——盲视。与 Rømer 追问"VL 的基本理论是什么？"、Nielsen & Klitmøller 追问"为什么有严重缺陷的 VL 仍主导政策？"不同，Larsen 追问的是一阶问题：**"VL 在原则上能看到什么、不能看到什么？"**——答案是盲视是教育观看的构成性条件，VL 追随者不能看见他们不能看见的东西。
...
| 任意划分 | [[Effect Size|效应量]]的划分隐藏重要区分 | 作业的多种形式被聚合 |
| 苹果与橘子 | 不同现象被聚合在同一效应量下 | 反馈的多种形式 |
| 垃圾进垃圾出 | 纳入低质量研究 | 同上 |
| 统计问题 | 效应量计算错误 | Bergeron (2017); Simpson (2017) |

尽管存在这些问题，Hattie 仍被 Mansell（2008）称为"教学的[[Sage|圣]]杯"的发现者，Evans（2012）称其为"possibly the world's most influential education academic"。丹麦学者警告："拒绝使用 Hattie 和其他人结果的人承担了实质性的道德责任"（Hansen et al., 2015, p. 7, cited in Nielsen & Klitmøller, 2021, p. 80）。
...
> [!warning] 主题导览
> 这里的重点不是“VL 有没有证据”，而是“可见性”本身如何携带监控、支配、性别化凝视、能力主[[Rightness|义]]和去政治化效果。若要进一步看 VL 的制度传播与市场化语境，和 [[Visible Learning Branding and Global Influences]] 一起读会更完整。
...
Terhart（2011, p.434）从 Foucault 的角度对 [[John Hattie|Hattie]] 的"可见的教与学"模型做出了一个早期且尖锐的政治解读：

> "他将广泛的关于成功教与学的经验证据的解释引向一种现代化和[[Jing (Refined Mastery)|精]]致的权威性、教师中心的教学概念。教师处于支配地位——但他必须以学生中心的方式驯化或隐藏其支配。传统的、公开的治理和支配形式已转变为一种精致的、不可见的、现代的形式。如果我们把它放在 Foucault 思想的语境中，这是显而易见的。"

Hattie 本人也非常清楚地表明了这一点——他将互看、互见、互相被[[Observational and Correlational Research|观察]]置于教与学理论的中心。Terhart 指出："这个理论的象征是眼睛"（p.434, Figure 2）。这一 Foucault 式的解读比 McKnight & Whitburn（2020）的全景监狱批评早了近十年。
...
- "可见的学习"在新自由主[[Rightness|义]]语境中并非中性选择。视觉作为主导性和殖民性感官，体现了上帝般的掌控（Berger, 1972; Mulvey, 1975）
...
- VL 被一位单一的、上帝般的男性权威主导（Hattie），痴迷于"射[[Jing (Refined Mastery)|精]]式的结果"（ejaculatory outcomes），否认对此类新自由主义痴迷的批评（Connell, 2013; Eisner, 2017; Grumet, 1988）
...
- 经典的民主专业主义（[[John Locke|Locke]], 2015; Sachs, 2003）关乎专长、自主和利他——VL 颠覆了这些概念
...
- "Know thy impact"带有[[Sage|圣]]经式语气，是在后结构主义和后现代对知识的质疑之后对确定性的加固——当确定性即将消融时的支撑（McKnight & Whitburn, 2020, p.40）
...
- 能力主义"设定两个截然不同且完全清晰的本体论区域：残疾的和健全的"（[[Campbell Collaboration|Campbell]], 2009, p.8）
...
> [!warning] 主题导览
> 这一节集中处理 VL 如何从“研究综合”变成“教育大师话语”与“[[Neo-Taylorism in Educational Administration|新泰勒主义]]管理技术”，重点不是某个统计值，而是权威如何被组织出来。

Eacott（2017a, 2019）从教育行政与领导力的社会认识论角度出发，提出了与前述方法论和文化政治批评维度互补的批评路径。关于 VL 品牌的具体传播网络和制度嵌入，详见上方[[#历史沿革|历史沿革]]章节。

**核心论证**：[[John Hattie|Hattie]] 的 VL 是"新时代的泰勒主[[Rightness|义]]"（Taylorism for a new time）（Eacott, 2019, p.778）。其与 Taylor（1911）科学管理的结构同源性体现在：
...
**"[[Cult of the Guru|大师崇拜]]"的分析框架**：Eacott 以 Callahan（1962）*Education and the Cult of Efficiency* 为历史框架，识别了使"大师崇拜"成为可能的三个历史条件（详见 [[Cult of the Guru]]）：(1) 时间条件——NAPLAN/[[PISA]]/TIMSS 数据引发成绩下降担忧，管理修辞围绕理性/控制逻辑凝聚；(2) 桥梁——Robinson et al.（2008）向教育行政社区引入效应量语言但仍缺操作细节；(3) 填补——Hattie 提供了"用行政语言说话"的数据（Eacott, 2017, p.414-419）。
...
VL 证据在政策过程中被多次误用。O'Neill (2012) 以 NZ Treasury 2011 年简报为案例揭示了术语定[[Rightness|义]]断裂和证据警示被忽略的机制；Terhart (2011) 记录了 VL 在新西兰政策语境中的早期争议；O'Connor (2020) 和 Blass (2020) 分别从维多利亚州和国家层面分析了 VL 在澳大利亚政策中的制度化与误用。详见 [[Visible Learning Branding and Global Influences]]。
...
Johnson & Janzen 对 [[John Hattie|Hattie]] 的[[Meta-meta-analysis|元-元分析]]方法论进行了从读者视角的透明度批判（详见 [[Argument_Johnson_2023_CE]]）：
...
- **Hattie 对教师的贬低**：记录 Hattie 在 VL 中将教学定性为"不成[[Shu (Familiarization)|熟]]的职业"、将教师的故事贬为"战争故事和轶事"的多处原文（p.28-29）
- **贬低修辞服务于私有化议程**：如果教学可被打造为不成熟、不专业、简单和技术性的，对教师及其工会的支持就会软化，私人利益便以"廉价解决方案"的承诺渗透（p.29）
- **澳大利亚 [[Victorian HITS and Literacy Toolkit 2017|HITS]] 的实施后果**：在基于 VL 的 HITS 实施地区，教师被强迫执行 simplistic performative technical actions（如在课前将课题写在白板上），教师自主性、职业乐趣和同行专业发展均下降（Lilley, 2022; Wescott, 2022）（p.29-30）

#### 角度三：新自由主义商业化——经济利益追踪

Johnson & Janzen 通过 Bates（2017）和 O'Neill et al.（2016）追踪了 VL 商业化的详细轨迹。其核心贡献在于识别了利益冲突、[[Class Size|班级规模]]作为 [[Global Education Reform Movement (GERM)|GERM]] 紧缩工具、以及"饥饿-危机-私有化"循环。详见 [[Visible Learning Branding and Global Influences]]。
...
[[Gerald Grace]]——"[[Critic and Conscience of Society]]"概念的原作者——在回应 [[John Hattie|Hattie]] (2010) 时指出，VL 刻意将非学校因素排除在分析范围之外，这与其声称的"critic and conscience of society"角色存在根本矛盾（Grace, 2010, p.90）。Hattie 在 VL 前言中明确表示："许多社会学家会不高兴非学校因素没有被放在所有主张的最前面，但我注意到这'不是因为他们不重要，实际上它们可能比书中讨论的许多问题更重要。只是我没有把这些主题纳入我的轨道'"（Hattie, 2009, pp.viii–xi，引自 Grace, 2010, p.90–91）。

Grace 的核心论点是：这种排除产生了一个"还原主[[Rightness|义]]和天真的观点"——认为仅靠改变教育安排就能解决教育成就不平等——这使政治家和政策制定者得以回避更根本的社会和经济不平等问题（Grace, 2010, p.91）。Grace 以 [[Basil Bernstein]] 的 *Education Cannot Compensate for Society*（1970）和 Roy Nash（2003）的工作为对照，说明真正的教育学术批评应当将非学校因素置于分析的核心（Grace, 2010, p.91）。
...
> - 把教育压缩成单一影响值，会系统性抹平情境、内容和意[[Rightness|义]]。
...
> - [[Treasury Briefing on Student-Teacher Ratios (NZ 2011)]] — 展示 VL 式证据如何被财政和政策逻辑选择性使用。
> - [[EEF Teaching and Learning Toolkit]] — 作为与 VL 共享“排名式证据地图”逻辑的平行案例，方便比较相似的批评为何反复出现。
> - [[Danish Public School Reform 2014]] — 展示 VL 进入国家改革后如何迅速引发支持与反弹。

> [!tip] 这一节怎么用
> 如果前面的批评显得太抽象，可以先跳到这些案例条目，再回来看各类批评如何在真实政策和学校情境里落地。

- McKnight & Whitburn 指出 [[John Hattie|Hattie]] 的统计学术研究本身和对教师的有用提醒值得肯定，但 VL 的论述转移了对教育中平等问题的关注（McKnight & Whitburn, 2020, p.42）
- O'Connor（2020）的[[Whole Language|全语言]]案例审查为批评者关于先验偏见驱动数据选择的论点提供了系统性文本证据：分类错误、不对称审查、选择性修正、不加权平均和次级文献系统性忽略
- Terhart（2011）从认识论（稳定性/变异性双重困境）、[[Didaktik|教学理论]]（[[Bildung]] 缺失）和 Foucault 政治哲学（可见性作为[[Jing (Refined Mastery)|精]]致的支配）三维度论证"很明显 Hattie 事实上没有找到[[Sage|圣]]杯"（Terhart, 2011, p.436）
...
**论证一：批评者形成了意识形态驱动的解释社群，而非进行学术反驳。** Qvortrup 以 Fish (1980) 的解释社群概念解释丹麦 [[John Hattie|Hattie]] 批评现象的起源：一个由研究者、政治家和工会代表组成的强解释社群在短期内形成，将 Hattie 从教育英雄转变为教育敌人（Qvortrup, 2019, p.5）。Qvortrup 使用 Alexander (2011) 的四种批判性政策话语框架分析丹麦批评文献，识别了其中至少两种话语——二分法话语（统计 vs 独特性）和嘲弄话语（歪曲、嘲笑、人身攻击）——论证这些批评将自己置于 Popper 的"科学游戏"之外（Qvortrup, 2019, p.3-4）。

**论证二：定量与定性方法的对立源于混淆认识论与本体论。** Qvortrup 以 von Foerster (1984) 的"[[Observational and Correlational Research|观察]]位置"和 Thyssen (2012) 的"哲学目光"为框架，论证认识论维度不是非此即彼的选择——通过[[Phenomenology|现象学]]镜片观察产生一种结果，通过统计镜片观察产生另一种结果。如果两种进路都遵循高效度标准，它们相互补充而非相互排斥（Qvortrup, 2019, p.5）。这一论证直接回应了批评者对 VL 定量方法论的根本质疑。

**论证三：专业判断是教学与学习之间的"缺失环节"。** Qvortrup 的核心理论贡献是提出 VL 中的教学干预与学习成果之间不存在简单的因果关系——两者是通过[[Structural Coupling|结构耦合]]（Luhmann, 1997）链接的两个封闭系统。教师的外部干预必须经过学生闭合的、自我指涉的反思循环，因此教师必须运用[[Professional Judgment|专业判断]]——基于[[Bounded Rationality|有限理性]]（Simon, 1969/1996），在理性赤字的条件下综合研究知识、伦理标准和方法论原则，通过[[Feedback|反馈]]持续修正（Qvortrup, 2019, p.6-7）。VL 的目的因此不是提供"什么有效食谱"，而是为教师提供"智能问题解决的假设"（Hattie, 2009, p.247）。
