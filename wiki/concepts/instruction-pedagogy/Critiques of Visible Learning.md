...
**（2）[[Effect Size|效应量]] d=0.40 截断值武断**：0.4 的铰链点选择任意，小效应量在高质量大规模研究中意义重大——医学中阿司匹林降低心脏病风险的效应量仅 0.07，却意味着每 1000 人拯救 34 人（p.99）。Hattie 本人在户外教育的"跟进"效应中因效应量 0.17 而兴奋，暴露了其阈值应用的不一致（p.99–100）。
...
**核心论证**：[[John Hattie|Hattie]] 的 VL 是"新时代的泰勒主义"（Taylorism for a new time）（Eacott, 2019, p.778）。其与 Taylor（1911）科学管理的结构同源性体现在：
...
VL 证据在政策过程中被多次误用。O'Neill (2012) 以 NZ Treasury 2011 年简报为案例揭示了术语定义断裂和证据警示被忽略的机制；Terhart (2011) 记录了 VL 在新西兰政策语境中的早期争议；O'Connor (2020) 和 Blass (2020) 分别从维多利亚州和国家层面分析了 VL 在澳大利亚政策中的制度化与误用。详见 [[Visible Learning Branding and Global Influences]]。
