...
```mermaid
flowchart TD
    C["<b>核心主张 (Claim)</b><br>图形组织器显著促进高阶思维"]
    R1["<b>支持理由 (Reason 1)</b><br>空间拓扑降低工作记忆维持负荷"]
    R2["<b>支持理由 (Reason 2)</b><br>视觉分支激活发散联想网络"]
    E1["<b>实证证据 (Evidence 1)</b><br>元分析加权效应量 g = 0.778"]
    E2["<b>实证证据 (Evidence 2)</b><br>发散思维效应量 g = 1.167"]
    REB["<b>潜在反驳 (Rebuttal)</b><br>若图示包含大量诱人细节则干扰低年级认知"]
