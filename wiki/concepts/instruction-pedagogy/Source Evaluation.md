...
> [!def] 核心定义
> 信源评估（Source Evaluation，在阅读研究中常称为 Sourcing 或 Sourcing Heuristic）是指学习者在面对单一或多重文本（特别是存在观点冲突的数字化信息与[[Generative Artificial Intelligence|生成式人工智能]]输出）时，超越表层陈述内容，主动识别、审验并评价信息提供者的专业资质、机构背景、出版动机、潜在利益冲突以及背后证据支撑力度的系统性认知规程与教学框架。在教学实践中，通过[[Direct Instruction\|直接讲授]]信源甄别准则与提供[[Reflexivity|反思性]]提问提示，能够有效帮助学生破解网络虚假信息与算法权威盲从，实现高质量的跨文本整合与论证建构。[[Argument_Cartiff_2021_JEP\|(Cartiff et al., 2021, pp. 485–486, 492)]]; [[Argument_Han_Gutierez_2026_IJSE\|(Han & Gutierez, 2026, p. 5)]]
...
> - **生成式 AI 二手信源溯源与文献追问（AI Source & Evidence Tracing）** 识别生成式 AI 作为第二手信息合成者的本质，主动追问模型输出背后的文献出处、同行评议共识及科学实验依据，对照教科书与一手权威资料排查模型捏造与断章取义。[[Argument_Han_Gutierez_2026_IJSE\|(Han & Gutierez, 2026, p. 5)]]
...
### 命题三　生成式 AI 交互重构了信源评估的认知对象，要求从单一网页核查升级为算法输出背后的文献溯源与权威对照

> [!concept-lens] 智能时代信源评估客体演化维度
...
> | 命题类型 | 核心指向 | 适用情境 | 代表学者 |
> |---|---|---|---|
> | **显性规程高增益** | 明确讲授信源评估策略能显著提升跨文本理解与学业表现，效应量居教学框架前列 | 数字化多文本阅读教学、网络探究课程 | [[Argument_Cartiff_2021_JEP\|Cartiff et al. (2021)]] |
> | **策略促成信念成熟** | 系统性信源审验实践是打破外部权威依赖、重塑底层知识来源信念的关键支架 | [[Critical Thinking\|批判性思维]]培养、科学与历史学科探究 | Bråten et al.; Mason et al. |
> | **算法二手溯源命题** | 将信源评估拓展至人机协同，通过反思提问追问 AI 背后文献与教材共识 | 生成式 AI 辅助科学学习、人机协同解释 | [[Argument_Han_Gutierez_2026_IJSE\|Han & Gutierez (2026)]] |
...
> - [[Argument_Han_Gutierez_2026_IJSE\|Han & Gutierez (2026)]] — 实证揭示显性反思提问提示语如何驱动初中生在与生成式 AI 协同建构[[Scientific Explanation|科学解释]]时开展二手信源评估与[[Document|文献]]溯源，维系核心[[Epistemic Agency|认识主体性]]。
