...
> [!def] 核心定义
> 以学生为中心的教育（learner-centred education，LCE）是一种以学生为学习主体、强调学生自主性、[[Dialogue in Education|对话教学]]和[[Critical Thinking\|批判性思维]]的教学理念。与此相对的是以教师为中心的教学法，后者由教师作为知识权威主导课堂。近几十年来 LCE 在全球范围内被广泛推广，并在不同社会文化与考试体制中经历着深刻的[[Going Native\|本土化]]再情境化。[[Argument_Wang_2025_CE\|(Wang & McLaughlin, 2025, p. 588)]]
...
> - 不等于 [[Constructivist Paradigm\|建构主义]]教学 — 建构主义是 LCE 的[[Epistemology\|认识论]]基础之一，但 LCE 是一个涵盖政策、教学法与课堂权力的更宽泛改革标签。
> - 不等于 放任式或无指导教学 — 理想或本土化 LCE 均强调教师作为促进者（facilitator）和架构支撑者，而非放弃教学引导。
...
> - **评估多元与效率重构** 评价关注学生整体发展与课堂吸收效率，在高利害环境下发展出过程性观摩与课改奖励规则。[[Argument_Wang_2025_CE\|(Wang & McLaughlin, 2025, pp. 600–601)]]

> [!logic-map]- 要素与双活动系统扩展性改造机制
> ```mermaid
> flowchart TD
>     subgraph 考试问责系统["考试问责系统 (封闭咬合)"]
>         A1["主体: 绩效压力下的校长/教师"]
>         A2["客体: 升学提分/考分排名"]
>         A3["规则: 行政考核/成绩定乾坤"]
>         A4["工具: 讲授/死记硬背/试卷诊断"]
>     end
>     
>     subgraph LCE改革系统["LCE 改革系统 (初始失调)"]
>         B1["主体: 培训骨干教师"]
>         B2["客体: 引入探究/学生自主"]
>         B3["工具: 小组讨论/探究案例"]
>     end
>     
>     A1 & B1 --> C{"建立学校特定共享目标<br>(School-Specific Shared Object)"}
>     C -->|解码一: 攻克高阶考题| D["培养批判性思维 (城市二校)"]
>     C -->|解码二: 农村课堂翻盘| E["最大化 45 分钟效率 (农村二校)"]
>     
>     D & E --> F["系统要素协同重构<br>(规则多元化 + 领导风险共担 + 工具本土化)"]
>     F --> G["扩展性改造 (Expansive Transformation)<br>LCE 与应试互惠共赢"]
> ```
...
### 命题一　高利害考试问责环境下以学生为中心教育可以通过重构活动系统共享客体实现与提分的并行协同

> [!concept-lens] 考试问责与教学改革的协同机制
