...
> [!concept-lens]- 概念透镜
> - **含义** 语言是整体的，口语和书面语的所有多样功能都是学习的合理路径；阅读不是[[Decodification|解码]]的简单累加，而是读者主动利用语义、句法和字形线索预测和建构意义的“心理语言学猜测游戏” (p.143)。
...
> 4. **技能情境化融入（Contextualized Skills）** 全语言理论家（如 Hornsby & Powell, 1993）撰写了大量如何在全语言框架内，在大书（Big Books）阅读情境下流动性地讲授拼读、拼写和[[Decodification|解码]]技巧的指南 (p.148)。
