...
> [!def] 核心定义
> 合作学习（Cooperative Learning，CL）是指一种将学生组织为[[Heterogeneity|异质性]]（能力、性别、背景多元）小组的[[Constructivist Paradigm|社会建构主义]]教学组织模式。其核心特征在于通过社会结构化的信息交流与协同互动，使学习深度依赖于组内成员的同伴支持；每个学习者既对自身的学业掌握负责，又受到共同目标的激励去促进其他成员的学习，从而达成个体与群体的共同认知、[[Higher-Order Thinking Skills|高阶思维]]与社会情感发展目标。[[Argument_Gungor_2026_CP|(Güngör et al., 2026, p. 2)]]
...
> - **[[Jigsaw|拼图教学法]]（Jigsaw / Aronson）** 将学习材料拆分为若干独立板块，组员先进入专家组共同钻研特定板块，掌握后返回母组轮流向同伴传授，拼合全貌。
...
> - **[[Cooperative Integrated Reading and Composition|合作整合阅读与写作]]（Cooperative Integrated Reading and Composition，CIRC / Slavin）** 针对语言教学的系统化技术，将教师主导的阅读理解教学与[[Heterogeneity|异质性]]同伴配对[[Decodification|解码]]、词汇研讨、同伴编辑与写作紧密整合。
...
> [!claim] Güngör et al.
> **理论素养与规范实施的决定性制约** 合作学习在课堂中的有效应用高度依赖教师对理论基础与操作技术的深刻理解。尽管多数教师主观上认为自己在组织合作学习，但实际活动往往因过于松散、脱离特定方法论规范而沦为形式化的小组扎堆。唯有教师精准落实积极互赖、个体责任与小组反思，并为学生提供充分的合作技能训练时间与结构化[[Scaffolding|脚手架]]，合作学习才能产生实质性学业与思维增益。[[Argument_Gungor_2026_CP|(Güngör et al., 2026, p. 12)]]
...
> | **技术与学科调节分化** | CIRC 与[[Group Investigation\|小组调查法]]效应更强；语言与科学学科成效突出，体育学科需专门重构教学设计。 | 学科针对性合作教学策略选型与教师培训 | [[Argument_Gungor_2026_CP\|Güngör et al. (2026)]]; Çapar & Tarım (2015); Kyndt et al. (2013) |
...
> | Fuad et al. (2023)，引自 [[Argument_Gungor_2026_CP\|Güngör et al. (2026)]] | 干预因素：[[Cooperative Integrated Reading and Composition\|CIRC]] 整合读写对语言阅读成就的干预效应 | $k = 10$ / $N = —$ | Cohen's $d$ / 随机效应模型 | $ES = 2.04$ $[1.35, 2.74]$ | — | 印尼 K-12 阶段准实验，[[Effect Size\|效应量]]极其突出 |
...
> | Özkan & Çetinkaya-Uslusoy (2024)，引自 [[Argument_Gungor_2026_CP\|Güngör et al. (2026)]] | 干预因素：[[Jigsaw\|拼图法]]（Jigsaw）对护理学业成就的干预效应 | $k = 7$ / $N = —$ | Cohen's $d$ / 随机效应模型 | $ES = 0.58$ $[0.47, 0.70]$ | — | 高等护理教育临床情境，效应稳健显著 |
