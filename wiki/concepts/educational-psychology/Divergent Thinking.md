...
> [!def] 核心定义
> 发散思维（Divergent Thinking, DT）是指认知主体在面对开放性问题或不确定情境时，不局限于单一常规路径，而是从多角度、多方向生成多样化构想、潜在解决方案与独特联结的认知探索过程。在心理测量学中，发散思维常被作为评估[[Creativity|创造潜能]]（Creative Potential）与创造力（[[Creativity]]）的核心[[Operationalization|操作化]][[Construct|构念]]（Runco, 2024）。

> [!concept-lens] 概念透镜
> - **含义** 指向个体在不受固定答案约束下生成多样、独创与非常规观念的认知生成机制。
> - **用途** 为评估与培养创造潜能提供标准化、可量化的认知任务指标（如非常规用途测验、托兰斯测验）。
...
> [!boundary]- 概念边界
> - 不等于 创造力整体：发散思维是潜能与过程构件，创造力还需结合收敛思维、动机、领域知识与环境支持。
...
> - **独创性（Originality）** 构想在样本或统计常模中的罕见度与统计独特性，是[[Creativity|创造性]]评定的核心指标。
...
> |---|---|---|---|---|---|---|---|
> | [[Argument_Runco_2026_CRJ\|Runco et al. (2026)]] | 测量类型（发散思维 vs 综合创造过程） | [[Meta-regression\|元回归]]（模型 1） | 综合创造过程[[Effect Size\|效应量]]高于单独发散思维 | $\beta = 0.16$ (过程) vs $\beta = 0.02$ (发散思维) | $F(3, 15.8) = 1.25, p = .33$ | 预设 | 各亚组间置信区间存在部分重叠 |
