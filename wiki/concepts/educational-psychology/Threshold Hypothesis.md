...
> | **低智商阶段关系** | **强正相关（$r \approx 0.30 \sim 0.50$）** | 恒定中等相关 | 决定[[Creativity|创造力]]表现的硬性上限（低 IQ 无高创造） |
> | **高智商阶段关系** | **弱相关或不相关（$r \approx 0.00 \sim 0.15$）** | 恒定中等相关 | 解除天花板约束，允许高创造与低创造并存 |
> | **宏观二阶实证** | 汇总认知关联为 **$r = 0.12$**（受高分段稀释） | 无法解释高分段方差崩塌 | 强力支持非对称必要条件结构 |
> | **教育选拔启示** | 达到基础智力门槛后，应重点考察动机与[[Divergent Thinking|发散思维]] | 盲目按智商分数从高到低单向淘汰 | 智力作为底线门槛，综合评估外认知特质 |
...
> | Gerwig et al. (2021) | 智力与[[Divergent Thinking|发散思维]]多维度的元分析 | 112 项研究 (30,555 人) | 皮尔逊 $r$ / 多水平随机效应 | **$r = 0.25$** $[0.22, 0.28]$ | 流体智力关联更强，言语与图形任务呈现分化 | 高 |
