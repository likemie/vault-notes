...
> [!info]
> 认知来源（cognitive source）是 Li（2012）在第 7 章母子对话[[Discourse Analysis\|话语分析]]中识别的一个分析概念，指母亲在引导儿童思考学习话题时所依赖的**认知框架与合法性资源**。它回答的问题是：当母亲试图让儿童接受某种关于"学习是什么""学习为什么重要"的信念时，她从哪里获得概念化和说服的力量？
...
> [!tip]- "来源"不是"心理框架"
> 心理框架（mental frame）是母亲在对话开头为儿童设置的**具体话题入口（如"你当时感觉如何？"vs"你不复习会发生什么？"）**，而认知来源是支撑这个框架的**背后文化财富([[Argument_Li_2012_Cambridge\|Li, 2012]])**。同一个认知来源（如"[[Learning Virtues\|学习美德]]"）可以生成多种不同的心理框架。

---

## 两种认知来源

Li 的跨文化比较揭示了两组母亲调用**截然不同**的认知来源([[Argument_Li_2012_Cambridge|Li, 2012]])：
...
台湾母亲几乎不触及"聪明""智力""心智过程"。她们调用的认知来源是**[[Learning Virtues|学习美德]]**——认真、专心、勤奋、恒心、刻苦。她们从"人不应该懒惰""功夫不负有心人"等儒家文化共识中获得引导儿童的合法性([[Argument_Li_2012_Cambridge|Li, 2012]])。

> [!example] 典型例证
> [[Benevolence]] 的母亲面对老师表扬儿子良好课堂表现的好消息，却不触及智力或聪明的话题。相反，她追问"你为什么要认真上课？""你睡觉也可以啊——为什么要认真？"，最终引导儿子自己说出"因为我的考试成绩挺差的"——将关于"好学习"的讨论转化为对自身不足的认识([[Argument_Li_2012_Cambridge\|Li, 2012]])。完整对话见 MCC 示例 9–10。
...
> [!success]
> Li 通过反复阅读和比较 EA and TW 两组的对话文本，从[[Discourse Analysis\|话语分析]]中**归纳**出认知来源这一分析维度——它不是事先[[Hypothesis\|假设]]的，而是在逐句审读 200 组对话后浮现出的深层结构差异([[Argument_Li_2012_Cambridge\|Li, 2012]])。
