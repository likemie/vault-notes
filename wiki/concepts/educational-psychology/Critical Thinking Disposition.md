---
title: Critical Thinking Disposition
aliases:
  - 批判性思维倾向
  - 批判性思维意向
  - 批判性思维习性
...
```mermaid
flowchart TD
    subgraph Delphi["<b>APA 德尔菲共识批判性思维倾向七大维度 (Facione, 1990)</b>"]
        direction TB
        T["<b>1. 求真性 (Truth-seeking)</b><br>基于最佳证据追求真相，即使结果挑战既有信念"]
        O["<b>2. 开放性 (Open-mindedness)</b><br>包容异见，乐于接纳并审视对立立场与多元视角"]
        A["<b>3. 分析性 (Analyticity)</b><br>警觉潜在困难与偏误，预见可能结果与逻辑漏洞"]
        S["<b>4. 系统性 (Systematicity)</b><br>面对复杂问题时保持条理、专注与有序探究"]
        C["<b>5. 思维自信 (CT Self-confidence)</b><br>信任自身的理性推理过程与论证判断力"]
        I["<b>6. 探究欲 (Inquisitiveness)</b><br>对广泛领域的事物充满好奇心与求知渴望"]
        M["<b>7. 认知成熟度 (Cognitive Maturity)</b><br>审慎权衡证据，理解知识的暂定性与相对性"]
    end
```
