...
> [!contrast-table] 虚假能力错觉与真实认知掌握对比
> | 比较维度 | **虚假能力错觉（Illusion of Competence）** | **真实认知掌握（Genuine Mastery）** |
> |---|---|---|
> | **信息加工深度** | 表层语义顺滑、被动接受、即时识别（Recognition） | 深层逻辑解构、主动提取（Recall）、图式内化 |
> | **[[Metacognition\|元认知监控]]状态** | 监控钝化，将“看得懂”直接等同于“会操作” | 监控高度活跃，能准确标定知识边界与盲区 |
> | **面对阻力时的反应** | 依赖外部即时答案，回避[[Epistemic Friction\|认识论摩擦]] | 主动承受[[Reflexivity\|反思性]]挣扎，通过试错修正图式 |
> | **独立测评表现** | 脱离 AI 或外部提示后表现断崖式下跌 | 在无辅助的迁移情境与现场答辩中表现稳健 |
> | **干预与破除途径** | 闭卷提取练习、反思性红队查错、[[Socrates\|苏格拉底]]追问 | 持续的刻意练习与变式迁移应用 |
...
>     
>     subgraph 错觉形成回路["能力错觉形成回路 (Illusion Cycle)"]
>         B --> C["触发流畅性启发式，主观加工阻力降为零"]
>         C --> D["产生虚假能力错觉：误以为自己完全掌握"]
>         D --> E["停止深入追问与多源核查 (早熟收敛 / 认知惰性)"]
>         E --> F["独立考核时能力坍塌，深层推理退化 (CT ↓)"]
>     end
>     
>     subgraph 教学破除回路["教学破除回路 (De-biasing Cycle)"]
>         D -->|"介入反思支架与提取练习"| G["设置闭卷独立推导与红队查错任务"]
>         G --> H["暴露知识盲区与模型幻觉，打破虚假自信"]
>         H --> I["激活认识论警觉与生产性认识论摩擦"]
>         I --> J["重构深度认知图式与真正的高阶思维 (CT ↑)"]
>     end
>     
...
### 命题二　生成式 AI 的即时语义流畅性加剧了学习者的能力错觉并诱发构想惰性
...
### 命题三　生产性认识论摩擦与过程性提取检验是破除能力错觉的核心教学策略
...
> | 命题类型 | 核心主张 | 适用情境 | 代表学者 |
> |---|---|---|---|
> | **元认知机理命题** | 加工流畅性启发式导致将容易理解误判为真实掌握 | 认知心理学、记忆提取与自适应学习 | Bjork et al. (2013) |
> | **技术异化命题** | [[Generative Artificial Intelligence\|生成式 AI]] 语义顺滑诱发能力错觉与构想惰性 | 生成式 AI 高校教学实证、论文写作 | Awal (2024); [[Argument_Li_2026_CEAI\|Li et al. (2026)]] |
> | **教学干预命题** | 必须引入[[Epistemic Friction\|认识论摩擦]]与提取检验强制校准元认知 | 评价改革、现场答辩与反思支架设计 | [[Argument_Li_2026_CEAI\|Li et al. (2026)]] |
...
> |---|---|---|---|---|---|---|
> | [[Argument_Li_2026_CEAI\|Li et al. (2026)]] | 67 项高等教育实证研究（涵盖全球高校本科生与研究生） | 系统综述与主题综合（PRISMA 2020） | 能力错觉、构想惰性（n=20）、被动顺从与 [[Causal Modeling\|SEM]] 路径检验 | 超过 45% 的学生在获得第一个顺滑回答后即停止深入探究（Awal, 2024; Azmi et al., 2024）；20 项实证明确报告顺从与惰性；SEM 检验表明被动工具调用显著负向预测反思（$\beta = -0.34$） | $p < .001$ | 证实语义流畅性引发的能力错觉是导致[[Generative Artificial Intelligence\|生成式 AI]] 交互中[[Critical Thinking\|批判性思维]]退化的核心心理中介 |
