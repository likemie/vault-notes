...
> [!def] 核心定义
> 知识的来源（source of knowledge）是构成[[Epistemological Theories|认识论理论]]的核心维度之一（属于“认知的本质”范畴）。它关注知识是如何产生的：知识是存在于认知者外部、驻留在全知全能的权威（如教师、专家、书本）那里并向下传递的，还是认知者作为积极的建构者，在与外界互动中从内部生成的。[[Argument_Hofer_1997_RER|(Hofer & Pintrich, 1997, p. 120)]]
> 
> > [!concept-lens] 概念透镜
> > - **含义** 衡量个体对知识产生主体的底层预设（外部权威 vs 内部自我）。
> > - **用途** 用于解释学生在课堂上的参与模式（被动接收者 vs 主动质疑与建构者）。
...
> [!concept-lens] 认知主体的觉醒
> 探讨个体是如何逐渐摆脱对全知权威的依赖，转向确认自我建构能力的。
