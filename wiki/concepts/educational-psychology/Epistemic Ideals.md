...
> - **用途** 揭示论证评估中超越表面句法结构的认识论实质，解释为何表面具备完整主张、证据与推理要素的论证依然可能属于认识论劣质论证。
...
>     
>     B --> B1["鉴别性 Discrimination"]
>     B --> B2["分类准确性 Classification"]
>     B --> B3["定量精确性 Accuracy"]
>     
>     C --> C1["全域证据契合 Fit with All Evidence"]
>     C --> C2["多源证据收敛 Convergent Evidence"]
>     C --> C3["推论直接性 Directedness"]
>     C --> C4["设计决定性 Conclusiveness"]
>     C --> C5["无高质量相悖证据 Absence of Contradictory Evidence"]
> ```
...
### 命题二　认识论理想具有深刻的学科实体知识依附性与情境特异性

> [!concept-lens] 认识论理想与学科实体知识的纠缠维度
...
### 命题三　认识论理想的有效掌握依赖共同体元认识论审议与认识主体性确立

> [!concept-lens] 认识论理想的社会协商与教学培养维度
