...
> [!def] 核心定义
> 最近发展区（Zone of Proximal Development, ZPD）指由儿童独立解决问题所决定的**实际发展水平（Actual Developmental Level）**与在成人指导或与更有能力的同伴协作解决问题所决定的**潜在发展水平（Potential Developmental Level）**之间的动态发展距离。该概念揭示了教学与儿童心智发展之间的本质联系，主张良好的教学应当走在发展的前面，通过外部脚手架引导正在成熟中的心理机能。[[Argument_Liu_2026_CHBR|(Liu et al., 2026, pp. 2, 9–10)]]; [[Argument_Wang_2025_CE|(Wang & McLaughlin, 2025, p. 590)]]
...
> [!logic-map]- 最近发展区与脚手架动态衰减（Fading）机制
> ```mermaid
> flowchart LR
>   subgraph Level1["1. 外部支架介入 (Scaffolding Induction)"]
>     direction TB
>     A1["诊断当前实际水平"] --> A2["锚定最近发展区 (ZPD)"]
>     A2 --> A3["提供自适应线索 / 微提示 / 错误矫正"]
>   end
> 
>   subgraph Level2["2. 共同调控阶段 (Co-Regulation)"]
>     direction TB
>     B1["学习者在支架中介下完成复杂推理"]
>     B2["人机交互或师生互动对话"]
>   end
> 
>   subgraph Level3["3. 支架渐进衰减 (Scaffolding Fading)"]
>     direction TB
>     C1["监测学习者技能掌握度"]
>     C2["逐步撤除外部显性提示与干预强度"]
>   end
> 
>   subgraph Level4["4. 独立内部化 (Internalization & Self-Regulation)"]
>     direction TB
>     D1["心理机能内化为自主调控"]
>     D2["原潜在水平转化为新实际水平 (ZPD 动态上移)"]
>   end
> 
...
> - [[Argument_Liu_2026_CHBR|Liu et al. (2026)]] — 将 AI [[AI Agent in Education|智能体]][[Operationalization|操作化]]为基础教育（K-12）学生的外部认知脚手架，论证其在最近发展区内自适应微提示对[[Procedural Skill|程序技能]]与[[Higher-Order Thinking Skills|高阶思维]]的赋能机制（pp. 2, 9–10）。
