...
> - **空间自排序任务（Spatial Self-ordered Task）** — 需按模式获取隐藏令牌并以递增难度排序
...
> - 3–5 岁出现大幅变化，接近 7 岁时趋于平缓
> - 4 岁儿童在三项和四项搜索的自排序更新任务中表现差于 7–8 岁儿童
> - 儿童能按顺序记住的项目数从 4 岁到 6 岁增加；倒序记忆从 1.58 增加到 2.88 个项目
> - 由于复杂更新任务的难度，大多数研究不考察 3 岁以下儿童，因此该年龄组数据较少
...
>
> 此外，Hattie & Yates 指出注意力是一种有限资源——大脑以葡萄糖为燃料，燃料耗尽后前额叶关闭、大脑切换工作模式。学生只有约 10 分钟的全神贯注时间。Fredens 补充：注意力中断时大脑转入默认网络（default network，即"社会脑"），在恢复的同时产生联想和创意发展——这种"走神"在[[Creativity|创造性]]过程中具有关键功能([[Argument_Fredens_2015_Paideia|Fredens, 2015, p.71–72]])。
