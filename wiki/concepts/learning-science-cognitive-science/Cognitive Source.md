...
> [!success]
> Li 通过反复阅读和比较 EA and TW 两组的[[Dialogue in Education|对话]]文本，从[[Discourse Analysis|话语分析]]中**归纳**出认知来源这一分析维度——它不是事先[[Hypothesis|假设]]的，而是在逐句审读 200 组对话后浮现出的深层结构差异([[Argument_Li_2012_Cambridge|Li, 2012]])。
