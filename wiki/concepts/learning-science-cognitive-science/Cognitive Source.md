...
> [!example]
> **认知来源 vs [[Causality|因果]]归因（causal attribution）** 认知来源是母亲讨论学习时所处的**认知领域（心智领域 vs 美德领域）**，它本身不一定包含对学习成败的解释。因果归因则是母亲对"**为什么**学好了 / 没学好"的明确解释——前者设定对话的"词汇表"，后者用这套词汇表构建因果推理链([[Argument_Li_2012_Cambridge|Li, 2012]])。例如，一位 EA 母亲可能在心智来源中讨论"思考"，但只有当她说"你之所以没理解，是因为你没有想清楚"时，她才在做因果归因。因果归因的文化差异见 [[Mother-Child Conversation|MCC]] 话语分析。
...
> - 认知来源的差异**先于**[[Causality|因果]]归因的差异——母亲必须先有一个认知领域，才能在这个领域内构建因果推理链
