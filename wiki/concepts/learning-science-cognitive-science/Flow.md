...
**情感输出：**
- **无聊**（boredom）：当技能超过任务要求时产生。例如，熟练的小提琴家被要求演奏初学者曲目，会感到无聊([[Argument_Li_2012_Cambridge|Li, 2012, p.59–60]])
- **焦虑**（anxiety）：当任务要求超过当前技能时产生。例如，小提琴初学者被要求演奏复杂乐曲([[Argument_Li_2012_Cambridge|Li, 2012, p.60]])

**最佳匹配：**
当技能与任务要求恰好匹配时，个体既不感到无聊也不感到焦虑，而是进入心流状态。此时体验到的是快乐、沉浸于任务中、享受过程、常常忘记时间流逝，并且不在意自己的表现如何([[Argument_Li_2012_Cambridge|Li, 2012, p.60]])。
