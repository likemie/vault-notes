...
> - **用途** 解释为什么低年龄学习者在面对富媒体或复杂视觉组织器时容易迷失重点，指导极简高效的可视化[[Scaffolding|脚手架]]设计。
...
> [!contrast-table] 诱人细节 vs 核心图示表征 vs [[Scaffolding|认知脚手架]]
...
```mermaid
flowchart TD
    A["教学材料输入"] --> B["核心概念与拓扑骨架"]
    A --> C["无关诱人细节 (装饰图/趣闻)"]
    C -->|争夺注意力通道| D["外在认知负荷激增"]
    D -->|挤占工作记忆容量| E["注意力分散与因果链断裂"]
    B -->|加工受阻| F["高阶思维与深层迁移受损"]
```
