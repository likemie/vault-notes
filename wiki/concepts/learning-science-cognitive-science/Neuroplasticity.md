...
> [!abstract] 核心要素
> - **规模性复杂性** — 人脑约含 860 亿个神经元，每个神经元可连接多达 10,000 个其他神经元，估计有约 13 万亿个突触（连接点）。Larsen 强调，甚至使用"are"来描述这些数字也是误导性的，因为"人类及其大脑始终处于成为的过程中"（Larsen, 2019, p.5）
>   > 例：试想一个拥有 13 万亿个相互关联的'未知数'的数学方程，且这些未知数极其灵活且不可预测——这就是试图[[Jing (Refined Mastery)|精]]确定位大脑中学习所面临的挑战。
> - **大脑作为"无指挥的乐团"** — Larsen 引用 Thomas Fuchs 的概念：大脑是一个中介器官（mediating organ），一个没有中央指挥的乐团（orchestra without a central conductor）。大脑不是漂浮在缸中的独立器官，而是人体的一部分（Larsen, 2019, p.5）
> - **大脑-身体-世界的不可分割性** — 复杂的脑-身体互动无法被即时描绘或累积截屏展示个体整个生命历程中的每个学习面向。Larsen 将此称为"最动态的脑-in-身体-in-世界过程本体论"——这是 21 世纪思维的重大任务和挑战之一（Larsen, 2019, p.5）
> - **去学校读书的是人，不是大脑** — "brains do not go to school—whole, incarnated, situated, and thinking individual human beings go to school—nor do brains learn in and for themselves—humans learn, deeply embedded and embodied in complex existential, social, historical, educational, political and, not least, neuroplastic contexts and settings."（Larsen, 2019, p.5）


> [!abstract] 突触可塑性的细胞机制
> 脑可塑性在细胞层面主要通过两个过程影响细胞间通信的效能（Bolton & [[John Hattie|Hattie]], 2017, p.6）：
>
> - **[[Synaptogenesis|突触发生]]（Synaptogenesis）** — 中枢神经系统中神经元之间新突触（连接）的创建。该过程涉及神经元和连接的过度生产，贯穿整个儿童期发育，在性成[[Shu (Familiarization)|熟]]年龄左右开始减少（Bolton & Hattie, 2017, p.6）。出生至 2 岁期间大脑形成最大数量的新连接，7–12 个月发生剧烈突触发生，时间上与 [[Executive Function|EF]] 任务测量的转换和抑制的改善一致（Bolton & Hattie, 2017, p.9）
...
> [!abstract] 可塑性的三种类型
> Bolton & Hattie (2017, p.6) 描述了导致成熟大脑发育的三种突触可塑性类型：
>
> - **经验独立可塑性（Experience-independent plasticity）** — 由遗传决定，发生在产前发育阶段（Bolton & Hattie, 2017, p.6）
> - **经验预期可塑性（Experience-expectant plasticity）** — 发生在发育过程中，突触发生期间过度生产的神经元和连接根据划定区域的连接性被精炼（Bolton & Hattie, 2017, p.6）
> - **经验依赖可塑性（Experience-dependent plasticity）** — 涉及与学习、经验、压力或药物相关的突触连接修改（Bolton & Hattie, 2017, p.6–7）
...
> [!example] 与相关概念的区别
> - **vs [[Visible Learning]]** — VL 试图使学习可见并测量[[Effect Size|效应量]]；Larsen 以神经可塑性论证任何将学习定位和识别于大脑中的尝试都在"制造关于学习存在公分母的神话"，将复杂神经可塑性翻译为简单信息注定失败甚至违反科学规范（Larsen, 2019, p.5）
> - **vs Neuro-myths** — 神经可塑性是真实的科学事实，但围绕它的夸大宣称（neuro-hype）催生了神经迷思——例如大脑可以被控制决定学什么、学习可以通过脑扫描被[[Jing (Refined Mastery)|精]]确测量等（Larsen, 2019, p.5）
