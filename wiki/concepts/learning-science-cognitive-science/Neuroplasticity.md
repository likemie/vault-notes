...
> [!example] 与相关概念的区别
> - **vs [[Visible Learning]]** — VL 试图使学习可见并测量效应量；Larsen 以神经可塑性论证任何将学习定位和识别于大脑中的尝试都在"制造关于学习存在公分母的神话"，将复杂神经可塑性翻译为简单信息注定失败甚至违反科学规范（Larsen, 2019, p.5）
> - **vs Neuro-myths** — 神经可塑性是真实的科学事实，但围绕它的夸大宣称（neuro-hype）催生了神经迷思——例如大脑可以被控制决定学什么、学习可以通过脑扫描被精确测量等（Larsen, 2019, p.5）

## 理论基础

> [!info] 理论基础
> - 身体现象学（Thomas Fuchs）— 大脑作为"关系器官"（Beziehungsorgan），嵌入身体和世界的生态学视角（Larsen, 2019, p.5-6）
