...
> [!abstract] 核心特征
> 转换能力通常与执行两个或多个简单"决策"任务并在特定线索或顺序下切换的能力相关（Bolton & [[John Hattie|Hattie]], 2017, p.5）。
>
...
> [!note-] 发展轨迹
> - 2–7 岁之间认知转换有快速发展（Bolton & [[John Hattie|Hattie]], 2017, p.10）
...
> 转换任务期间前额叶皮层（prefrontal-cortex）的 vlPFC 和 dlPFC 区域被激活，与个体重新聚焦注意力或切换任务的情况一致（Bolton & [[John Hattie|Hattie]], 2017, p.12）。背外侧 PFC（dlPFC）在任务需要新颖性或任务间切换时发挥作用（Bolton & Hattie, 2017, p.8）。
