...
> [!abstract]
> - **表层学习**。知晓事实、想法和内容。学生发现课程评估实际测量的是知晓很多和复述教科书或教师的主要观点，尽管教师宣称课程关乎理解、建立关系和扩展知识（[[John Hattie|Hattie]], 2015, p.80）。
> - **深层学习**。知晓想法之间的关系和连接，并将这些想法扩展到其他情境。在[[Curriculum Design Coherence Model|课程设计连贯性模型]]中，深层学习是[[Knowledge-that and Know-how-to|知其然]]和[[Knowledge-that and Know-how-to|知其所用]]连接的结果，当学生能够展示和阐述两种知识形式之间的联系时，深层学习才真正发生（McPhail et al., 2023）。
...
> - **课程设计的条件**。深层学习需要课程设计与知识的认识论结构对齐。[[Curriculum Design Coherence Model|课程设计连贯性模型]]主张，知其然和知其所用的连接应在教学开始之前的课程设计阶段被明确处理，而非留给教师在课堂上自行完成（McPhail et al., 2023）。
...
> [!success] 亚洲学习者的悖论
> Watkins & Biggs (1996, 2001) 发现的亚洲学习者悖论为表层-深层关系提供了重要例证：许多亚洲学生利用讲座吸收表层理解，随后将其用于转向深层学习；相比之下，许多[[Western Learner|西方学习者]]将记忆讲座笔记视为足够通过课程——而评估的性质常常强化了这一信念（[[John Hattie|Hattie]], 2015, p.84）。

> [!success] 对 [[Problem-Based Learning|PBL]] 效果的解释
> 表层/深层区分有助于解释为什么 PBL 在低年级效果不佳：PBL 要求学生进行深层推理（关系建立、[[Causal Modeling|因果建模]]），但低年级学生尚未具备必要的表层知识基础（Hattie, 2015, pp.84–85）。

> [!success] 评估驱动表层学习
> Brown & Hirschfeld (2008) 的研究发现：当被问及课程期望的是表层还是深层学习，大多数教师回答深层；但学生回答表层。学生主要根据评估的性质来做出判断（Hattie, 2015, p.87）。
...
> [!info]
> - [[Popper's Three Worlds Theory]] — [[John Hattie|Hattie]] (2009; 2015) 将表层/深层/建构性学习映射到波普尔的三个世界。但 Rømer (2018) 论证 Hattie 严重误读了波普尔。
