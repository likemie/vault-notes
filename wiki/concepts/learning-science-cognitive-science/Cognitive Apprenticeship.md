...
> | **思维可见度** | 高（通过导师出声思考与辩论使思维外显） | 自然可见（物理动作直接可被观察） | 较低（聚焦知识结论而非探究过程） |
> | **情境真实性** | 真实[[Task Structure\|劣构任务]]与专业文化情境 | 真实生产作坊 | 脱离情境的课本抽象例题 |
> | **指导机制** | 示范、辅导、支架渐退与自主探索 | 观察、模仿与纠偏 | 讲解、板书、被动练习与打分 |
...
> |---|---|---|---|---|---|---|
> | [[Argument_Abrami_2015_RER\|Abrami et al. (2015)]] | 理论解释模型：检验真实情境、[[Dialogue in Education\|对话]]与导师指导的协同增益 | 真实性+对话+[[Mentorship\|导师制]]（A+D+M 复合干预） | $k = 19$ | $g+ = 0.57$ $[0.38, 0.77]$ | 显著优于单独真实性（$0.25$）、单独对话（$0.23$）及 A+D（$0.32$） | 证实情境示范、社会对话与导师脚手架三者协同的最优教学效能 |
