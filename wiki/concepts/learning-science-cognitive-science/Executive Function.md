...
> [!concept-lens] 概念透镜
> - **含义** EF 是目标导向控制的高阶认知过程，是许多复杂认知任务与[[Higher-Order Thinking Skills|高阶思维]]的基础。
> - **用途** 用于解释[[Academic Achievement|学业成就]]、情绪社会发展等教育结果，并理解[[Creativity|创造力]]与[[Critical Thinking|批判性思维]]等[[Higher-Order Thinking Skills|高阶思维]]的共享认知基础。
> - **边界** EF 不是单一能力，而是涵盖抑制、转换、[[Updating and Monitoring|更新与监控]]的一组过程；其发展受[[Prefrontal Cortex|前额叶皮层]]成熟的制约。
...
### 命题一　执行功能是学业成就与情绪社会发展的重要预测因素

> [!concept-lens] 教育结果预测
> EF 的发展不仅预测[[Academic Achievement|学业表现]]，也与儿童的情绪、道德与沟通行为及社会认知相关。

> [!claim] 与[[Academic Achievement|学业成就]]的关系
> 大量证据表明 EF 的发展是学业表现的主要预测因素。多项[[Longitudinal Study|纵向研究]]表明 EF 对学业成就有贡献，而非反之；时间因素在认知发展中尤为重要，往往是比智力和 IQ 更准确的学业成就变异预测指标。（[[Argument_Bolton_2017_ArchPsych|Bolton & Hattie, 2017, pp. 4–5]]）
...
> [!dev-timeline] EF 的发展轨迹
> - **学龄期持续改善** EF 在学龄期间持续改善，约 16 岁至 30 岁出头改善速率逐渐下降（[[Argument_Bolton_2017_ArchPsych|Bolton & Hattie, 2017, p. 5]]）。
> - **成分差异与关键期** 抑制最早发展，略早于转换和更新；三种成分均在 3–5 岁出现大幅年龄相关变化或"铰链点"；EF 的发展与[[Prefrontal Cortex|前额叶皮层]]的成熟密切相关。（[[Argument_Bolton_2017_ArchPsych|Bolton & Hattie, 2017, p. 10]]）
