...
> [!info]
> 可重用性悖论最初由 Wiley 用于讨论学习对象：如果一个学习对象因为专门为某一情境设计而有效，它就难以在其他情境中复用；反过来，如果它被设计成能在很多情境中复用，它就不会特别适合任何一个具体情境([[Argument_Pellegrini_2021_ROE|Pellegrini & Vivanet, 2021, p.36]])。

Pellegrini & Vivanet 将这一悖论移用到 [[Evidence-Based Education|证据本位教育]]：一个教育项目越是为某一国家、课程、语言、学段或教学目标精细设计，它在原情境中越可能有效，但跨国或跨校复用时就越需要重新适配；一个项目越追求普遍可用，就越可能难以充分满足具体学校的教育需求([[Argument_Pellegrini_2021_ROE|Pellegrini & Vivanet, 2021, p.36]])。
...
> [!success]
> 在欧洲语境中，可重用性悖论被 43 个教育系统、不同组织模式、不同课程大纲和 24 种欧盟官方语言放大。许多经验证项目来自英语国家，不能直接在非英语国家复用，必须重新开发本地语言材料并投入教育与研究方法专业能力([[Argument_Pellegrini_2021_ROE|Pellegrini & Vivanet, 2021, p.36]])。
