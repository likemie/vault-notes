...
> - 不等于 **证据知会实践 ([[Evidence-Informed Practice|EIP]])** EIP 是一种多源证据进入决策的取向；专业判断则是实施这一取向所必需的核心专业能力。
...
> > - **应用后果** 要求我们在政策评估和学校改进中，必须警惕扁平化排行榜可能带来的破坏性决策，捍卫教师与研究者协同改进的“[[Snowball Sampling|网络化]]改进共同体”（NICs）等多元路径。([[Argument_Wrigley_2018_BERJ|Wrigley, 2018, p. 14]])
