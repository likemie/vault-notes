...
> [!citation-card] Slavin (2002, p. 15)
> 证据本位教育政策是"依赖随机化和严格匹配实验作为政策和实践的基础"——将可复制的教育项目和有前景的实践置于严格评估之下，仅推广那些被证明有效的。

> [!implication] Wiliam (2019) — "什么有效"是错误的问题
...
> 
> [[Argument_Berk_2011_ER|Berk (2011, p.192)]] 基于经手数百篇[[Evaluation Research|评估研究]]论文的经验判断："每有一项做得好且有价值的研究，至少有另一项在进行可被称为垃圾科学的工作"，但"太多评估研究的使用者难以区分二者"，且"任何易于实施的规则集都有扼杀创新的风险"。
> 
> Berk 提出了三条操作层面的对策：(1) 中立专家委员会审查；(2) 团队评估研究（如 Rand、MDRC、Mathematica 的模式）；(3) 数据科学训练至少需要硕士水平。其"精英专家模式"与 Cowen (2019) 后来提出的官僚知识问题存在未解决的张力。[[Argument_Berk_2011_ER|Berk, 2011, pp.192–200]]
...
> [!note]
> [[Argument_Møller_2017|Møller (2017, p.379)]] 援引 Berliner (2002) 的论证：教育研究是"难以完成的科学"（hard-to-do-science），因为教育研究者"必须处理限制推广的本地条件"（Berliner, 2002: 18）。学校中的学生、教师和校长嵌套在复杂且不断变化的社会互动网络中，学习过程永远不可能被完全控制。
...
> [!note] 论证结构（Goldman 区分理论应用）
> **争议核心**：Wiliam 从 Goldman (1976) 的分析认识论出发，论证 EBE 项目在原则上不可完成——不是因为方法论不足（可改进），而是因为知识本质上是局部且临时的。
> 
> 1. **知识的局部性**（locality）：Goldman 对相关替代方案的关注意味着知识可以因地点不同而不同。
> 
> 2. **知识的临时性**（provisionality）：Wiliam 以自身的[[Tracking|能力分组]]研究为例——能力分组的已有知识在 Hanushek & Rivkin (2010) 建立教师差异量级后失效。"教育研究只告诉我们曾经是什么，而非可能是什么。"
> 
> 3. **效度作为推论的属性**：继承 Cronbach (1971) 和 Messick (1989)，效度"不能是实验的属性……而只能是我们从那些结果中得出推论的属性"。
> 
> [[Argument_Wiliam_2019|Wiliam, 2019, pp.7–10]]
...
> [!note]
> [[Argument_Wiliam_2019|Wiliam (2019, pp.10–11)]] 以反馈研究作为 EBE "平均效应"逻辑失败的例证：Kluger & DeNisi (1996) 对 131 项研究的[[Meta-analysis|元分析]]发现反馈的平均[[Effect Size|效应量]]约 0.4 SD，但效应量标准差约 1，约 38% 的 607 个效应量为负——在超过三分之一的案例中，不给予反馈反而更好。Wiliam 的反驳：**不了解干预如何产生效果，在特定情境中应用干预可能产生持续负效果**。
...
> [!note]
> [[Argument_Wiliam_2019|Wiliam (2019, pp.7–9)]] 论证教师质量未测量变异是教育 [[Randomised Controlled Trials|RCT]] 中一个被系统性忽视的混淆因素：教师间一 SD 差异 ≈ 0.15 SD 学生成就差异（Hanushek & Rivkin, 2010）；更有效的教师对低成就学生不成比例地更有效（Slater, Davies & Burgess, 2012）。这意味着即使 RCT 随机分配学校，如果最有效教师被分配教高成就学生，观察到的效应可能完全是"教师分配效应"——这一混淆因素的量级很可能**远大于**任何被评估的干预效应。
...
> [!note]
> [[Argument_Terhart_2011_JCS|Terhart (2011, p.436)]] 在 [[Visible Learning|VL]] 出版仅两年后就识别了[[Meta-meta-analysis|元-元分析]]（mega-analysis）作为 EBE 最雄心勃勃的方法论工具所面临的根本困境：元-元分析扩大了参照范围，"但同时也变得更加复杂、混乱和充满不一致……通过反复累积，原始的详细经验信息消失"（p.436）。
> 
...
> 
> **方法论的三级失真**：
> - **RCT 层面**：Ginsburg & Smith (2016) 分析 27 项 WWC 高评分数学 RCT，发现 26 项存在多重严重问题
> - **元分析层面**：Simpson (2017, 2018) 论证效应量测量的是试验灵敏度而非干预有效性
> - **元-元分析层面**：Hattie 和 EEF Toolkit 将根本不同的干预聚合产生单一排名
> 
> [[Argument_Wiliam_2019|Wiliam (2019, p.11)]]："元-元分析在教育政策制定中绝对没有任何角色。"
...
> [!note] 核心论证（Wrigley & McCusker, 2019）
...
> 4. **新自由主义治理关联**：Rømer (2014) 将丹麦突然转向"证据本位教学"与全球新自由主义教育治理联系起来。
> 
> [[Argument_Wrigley_2019_ERE|Wrigley & McCusker, 2019, pp. 111–124]]
...
> [!note]
> [[Argument_ONeill_2012_NZJES|O'Neill (2012)]] 以 NZ Treasury 2011 年简报为案例，识别了 EBE 证据在政策论述中被误用的具体病理——[[Material Fallacies|实质谬误]]：政策行动者通过术语模糊（"教学质量"定义与学校教育无关）、忽视证据局限性（Hattie 本人的多处警示被忽略）和得出与原始证据矛盾的结论（建议增加生师比 vs Hattie 明确反对），将 EBE 证据转化为服务于预设政策目的的工具。该案例暴露了 EBE 的一个结构性脆弱点：即使证据本身在方法论上可靠，其在政策过程中的论述性使用仍可能产生实质谬误（详见 [[Treasury Briefing on Student-Teacher Ratios]]）。
...
> [!note] 核心论证与七点批评（McKnight & Whitburn, 2020）
...
> 2. **单一权威主导**：VL 由"上帝般的男性权威"主导，痴迷于"射精式的结果"，强化异性恋规范
> 3. **拒绝对话**：教师知识被提取→处理→打包→作为"外部专家建议"卖回——"多平台资本主义"
> 4. **忽视关怀伦理**：爱、同僚情谊、慷慨等难以测量的维度被边缘化
> 5. **过度简化**："Know thy impact"在后结构主义质疑之后对确定性的加固
> 6. **能力主义假设**：有视觉障碍的教师和学生被"只有可见的才重要"系统性排斥
> 7. **接近极权主义**：VL 被描述为"极权主义有组织的遗忘"
> 
> 贡献补充了 EBE 批判的文化政治维度，但并非全盘否定 Hattie 的统计学术贡献，而是论证 VL 论述"转移了对教育中平等问题的关注"（p.42）。[[Argument_McKnight_2020_Discourse|McKnight & Whitburn, 2020, pp.32–42]]
...
> [!note] 核心发现：议会中的证据回避（Bainbridge et al., 2022）
> [[Argument_Bainbridge_2022_ROE|Bainbridge et al. (2022)]] 将 EBE 批判推进到议会政策制定的实际话语操作层面。对 2015–2019 年英国议会 11 场文法学校辩论的分析显示：
> 
> - 政府自身定义（Coldwell et al., 2017）要求使用量化研究和系统综述，但议会内部报告和 Ofsted 评级才是实际上最有影响力的证据来源
> - 2016 年"教育与社会流动性"辩论中，19 次与非轶事证据的交换中仅 6 次真正参与了证据；5 次属于道德侧步
> - "好学校"话语（以 Ofsted 评级为"证据"）被系统性用于回避关于选择性教育效果的研究证据
> - 政府要求教师"通过引用 robust evidence base 解释其选择"，但政策制定者自己在议会中依赖 Ofsted 而非 robust evidence base
> 
> 这揭示了 EBE 的深层悖论：**政府一方面要求实践者使用严格证据，另一方面在自身政策制定中系统性地回避这些证据——在民主制度中的实际操作中存在结构性虚伪**。[[Argument_Bainbridge_2022_ROE|Bainbridge et al., 2022, pp.25–26]]
...
> [!note]
> Ross 与 Morrison 从 ESSA 证据标准和 [[Students and Teachers Accessing Tomorrow|STAT]] 技术整合评价案例出发，指出严格证据进入学校系统后并不会自动转化为统一决策，而会被地方需求、实施条件和利益相关者价值排序重新解释。
> 
