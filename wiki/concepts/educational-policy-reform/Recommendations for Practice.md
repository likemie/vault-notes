...
> [!info] 定义
> [[Praxis|实践]]建议（Recommendations for Practice, RFP）是研究论文中将研究发现转化为教育实践行动的规范性陈述。[[Argument_Brady_2023_EPR|Brady et al. (2023)]] 沿用 Reinhart et al. (2013) 的[[Coding in Qualitative Research|编码]]标准：如果论文暗示或明确说明"若采用/避免、增加/减少实践 X，则教师或学生结果 Y 会改善"，即被编码为 RFP([[Argument_Brady_2023_EPR|Brady et al., 2023, p.4]])。
>
...
> [!note-] 历史沿革
> - **1994** — 既有[[Trend Study|趋势研究]]显示，约 30% 的相关性文章包含[[Praxis|实践]]建议，说明[[Non-intervention Research|非干预研究]]中的 RFP 并非新现象，而是长期存在的出版实践([[Argument_Brady_2023_EPR|Brady et al., 2023, p.3]])。
...
> - **因果含义** 即使措辞较弱，RFP 通常仍暗含"改变[[Praxis|实践]]会改善结果"的因果结构；这使其证据要求高于单纯描述性结论([[Argument_Brady_2023_EPR|Brady et al., 2023, pp.3-4]])。
...
> [!example] 与相关概念的区别
> - **vs [[Non-intervention Research]]** — 非[[Intervention Research|干预研究]]是不操纵自[[Variable|变量]]的研究集合；RFP 是论文讨论部分或[[Praxis|实践]]意义部分中的行动性建议。[[Argument_Brady_2023_EPR|Brady et al. (2023)]] 的核心问题正是二者之间的错配：非干预设计常被用来支撑实践建议([[Argument_Brady_2023_EPR|Brady et al., 2023, pp.3-4]])。
...
> [!info] 理论基础
> - [[Evidence-Based Education]] — RFP 体现了教育研究服务[[Praxis|实践]]与政策的愿望；争议在于，哪些研究设计足以支持"应当如何做"的实践性结论。

## 相关方法


- [[Intervention Research]] — 更适合承载强 RFP 的方法环节，因为其通过操纵自[[Variable|变量]]检验[[Praxis|实践]][[Hypothesis|假设]]([[Argument_Brady_2023_EPR|Brady et al., 2023, pp.2-4]])。
...
> - 在观察/相关研究中，包含 RFP 的比例从 2000 年的 41%、2010 年的 46% 上升到 2020 年的 66%，显示非[[Intervention Research|干预研究]]中[[Praxis|实践]]建议的增长趋势仍在继续([[Argument_Brady_2023_EPR|Brady et al., 2023, pp.6-7]])。
...
> [!warning] [[Non-intervention Research|非干预研究]]能否提出[[Praxis|实践]]建议
...
> [!example] 相关案例／政策
> - [[Evidence-Based Education]] — RFP 是证据到[[Praxis|实践]]转化链条中的论文写作环节，反映"研究应指导实践"的期望及其方法论风险。
