...
> - **vs [[Randomised Controlled Trials]]** — RCT 通过[[Random Assignment|随机分配]]与变量操纵提供更强的因果证据；[[Argument_Brady_2023_EPR|Brady et al. (2023)]] 指出，在多数科学领域中，强实践建议通常需要严格 RCT 支撑，而非[[Experimental Research|实验研究]]的证据基础往往不足([[Argument_Brady_2023_EPR|Brady et al., 2023, p.3]])。
...
- [[Intervention Research]] — 更适合承载强 RFP 的方法环节，因为其通过操纵自[[Variable|变量]]检验实践假设([[Argument_Brady_2023_EPR|Brady et al., 2023, pp.2-4]])。
