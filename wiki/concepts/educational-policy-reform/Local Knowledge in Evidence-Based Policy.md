...
>
> Wiliam (2019, pp.12–13) 为本地知识的重要性提供了政治经济学基础，引用 Hayek (1945) 的经典论证："只有拥有'特定时间和地点环境的知识'的人才能决定哪些创新可能有效，哪些虽然在其他地方有效但在特定情境中可能无效甚至适得其反。"
>
...
> [!note-] 历史沿革
> 本地知识的概念在证据本位政策文献中经历了从被贬低到被重新评价的过程。早期 EBP 推动者倾向于将本地知识和[[Professional Judgment|专业判断]]视为需要被科学证据取代的"轶事"或"直觉"（Cowen et al., 2015, p.14）。然而，随着实施研究的积累，越来越多的证据表明缺乏本地知识的纯证据驱动方案往往在实践中失败。Oliver et al. (2014) 对 145 项研究的[[Systematic Review|系统综述]]发现"非正式证据"——包括本地数据和默会知识——在超过三分之一的研究中被认为是成功实施的关键因素（Cowen et al., 2015, p.12）。
...
> Wiliam (2019, pp.11–12) 提出的四个决策问题中，第四个——**"它在这里有效吗？"**——直接涉及本地知识的不可替代性。Wiliam 的论证：只有拥有 Hayek (1945) "特定时间和地点环境的知识"的人才能判断：
> - 班级缩减在教师招聘困难的地区甚至可能降低学生成就
> - 在教师供应充足的地区则可能非常有效
> - 这种判断无法从平均效应量中推导出来——它需要对本地教师劳动力市场、学校文化和制度的深入了解（Wiliam, 2019, pp.12–13）
>
> 第一个问题——**"这解决我们面临的问题吗？"**——同样依赖本地知识：不同国家面临不同问题。低收入国家教师缺勤率超过 30%，按绩效付薪可能有帮助（Duflo, Hanna, & Ryan, 2012）；但富裕国家教师已经到岗，此类激励不太可能有效。不首先诊断本地问题就应用"证据本位"方案等同于"对没有问题的问题寻找解决方案"。（Wiliam, 2019, p.12）
...
> - **被忽视不等于被否定**：Cowen et al. (2015) 并不主张用本地知识取代研究证据，而是主张二者互补。Wiliam (2019, p.11) 强化了这一立场："不存在识别和传播'什么有效'的客观程序"——利益相关者必须成为批判性消费者，将研究证据与本地知识结合运用
...
- [[EEF Teaching and Learning Toolkit]] — 作为外部证据工具，它仍需要学校判断“它在这里有效吗”，即结合学生群体、教师资源和实施条件重新解释（Wiliam, 2019, pp.12-13）。

### 外推失败与情境差异

- [[Tennessee STAR Project 1985-1989]] — 参与学校的本地特征使其结果不可直接外推；参与学校规模更大，非裔学生比例也高于全州平均（Wiliam, 2019, p.6）。
- [[California Class Size Reduction 1996]] — 加州推广小班改革时忽视教师和教室供给条件，说明“在某处有效”的证据需要经过本地可行性判断（Wiliam, 2019, p.6）。
