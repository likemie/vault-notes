...
2. **外生私有化（Exogenous privatisation）** 将私营部门带入公立学校——通过合同外包、[[Public-Private Partnership in Research|PPP]]、特许学校等形式将教育服务的提供从公共部门转移到私营部门
...
内生私有化与 [[New Public Management|新公共管理]]（NPM） 高度重叠但不等同：NPM 是内生私有化的核心操作机制——将企业管理逻辑（绩效测量、产出控制、管理问责）引入公共部门内部运作。内生私有化的范畴更广，涵盖私营部门思维和价值进入公共系统的所有方式，包括[[Venture Philanthropy|风险慈善]]、[[Policy Entrepreneur|政策企业家]]的议程设置，以及公共教育被重新想象为可交易商品的话语转变。详见 NPM > 核心要素。
...
**内生私有化**的例证：
- 政策话语从"政府资助和提供"转向"政府补贴"和"[[Social Impact Investing|社会投资]]"
...
- [[Partnership Schools Kura Hourua]]（特许学校）— 详见 [[Partnership Schools Kura Hourua]]
...
[[Argument_Rizvi_2022_Springer|Rizvi (2022)]] 将这一概念框架应用于[[Internationalization of Higher Education|高等教育国际化]]分析，揭示了**国际化如何成为驱动内生私有化的独立力量**。
...
Rizvi 以澳大利亚为最激进的案例。其高等教育机构在国际招生方面的成功使政府有底气推动一系列市场导向政策：《[[Australia in the Asian Century White Paper|亚洲世纪白皮书]]》（将亚洲崛起定位为"澳大利亚的机遇"）、《[[International Education|国际教育]]国家战略 2025》（系统性地将教育出口整合进国家经济战略）。高等教育和研究政策在此过程中不再是单纯的教育政策——它们变成了**经济政策、外交政策和安全政策**的综合体([[Argument_Rizvi_2022_Springer|Rizvi, 2022, pp.99–100]])。

### 空间架构的重塑

国际化驱动的内生私有化还彻底改造了全球高等教育的空间架构。大学建立了复杂的招生基础设施——本地代理网络遍布亚洲、大量跨国项目、特许经营安排、复杂的学分衔接和双联安排——以最大化和稳定化国际学生流动。这些安排本身就是内生私有化在空间层面的物质化：大学不再坐等学生上门，而是像跨国企业一样在全球布局供应链和分销网络([[Argument_Rizvi_2022_Springer|Rizvi, 2022, pp.97–98]])。

### 概念意义

Rizvi 的分析揭示了：私有化不仅仅是"更多私营部门进入教育"的线性叙事——它在两个维度上同时推进：既改变学校内部的运作逻辑（内生：市场化、绩效化、NPM 技术渗透），也改变学校外部的服务交付结构（外生：合同化、外包化）。两者相互强化：外生私有化创造了对内生私有化技术（如绩效测量）的需求，而内生私有化技术又使外生私有化合同的管理和监控成为可能。在国际化语境中，这一双向动态因跨国流动（学生、资金、声誉）的独特性质而获得了额外的复杂性和加速效应([[Argument_Rizvi_2022_Springer|Rizvi, 2022, pp.97–98]])。
