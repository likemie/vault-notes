...
> - **认知功能** 瓦解政客以“纯粹遵循科学”（Follow the science）为挡箭牌推卸政治责任的借口，迫使决策者公开承认证据背后的认识论局限与不确定性。
...
> [!boundary]- 概念边界
> - 不等于纯粹的 [[Scientific Uncertainty]] — 科学不确定性是测量、建模或自然认识中的客观认识论状态，而后常规科学则将不确定性与高政治赌注、伦理价值争议及制度紧迫性相耦合，特指一种社会治理与政策决策结构。
> - 不等于反智主义或后真相相对主义 — 后常规科学并不放弃科学证据，而是主张扩大证据审查的民主参与基础，以更高维度的社会透明度捍卫科学的公信力。

---

## 概念辨析

依据系统不确定性（Systems Uncertainties）与决策赌注（Decision Stakes）两个核心维度的交互程度，丰托维奇与拉维茨将科学探究划分为三种递进的实践形态：

> [!contrast-table] 科学问题与治理形态的三维分类矩阵（Funtowicz & Ravetz, 1993）
> | 维度 | 常规应用科学（Applied Science） | 专业咨询（Professional Consultancy） | 后常规科学（[[Parliamentary Office of Science and Technology\|POST]]-Normal Science） |
> |---|---|---|---|
> | **不确定性水平** | 低不确定性（可精确量化或受控消除） | 中等不确定性（依赖专家临床/工程经验补足） | 高度系统性不确定性（不可完全消除，模型存在固有分歧） |
...
> [!logic-map]- 治理破局：从封闭技术官僚走向扩展同行共同体
> ```mermaid
> flowchart LR
>     A["后常规情境<br>高赌注 + 高不确定性 + 价值冲突"] --> B{"传统技术官僚路径"}
>     B -- 封闭决策 --> C["口号化'遵循科学'<br>隐蔽政治动机 / 掩盖分歧"]
>     C --> D["民意反弹与信任崩塌<br>被质疑专家傲慢或政治操弄"]
>     
>     A --> E{"后常规科学路径"}
>     E -- 开放民主治理 --> F["扩展同行共同体<br>科学家 + 立法者 + 公众平权对话"]
>     F --> G["坦诚披露不确定性<br>公布《科学证据陈述》+ 解释未用证据"]
>     G --> H["维系公共信任<br>建立稳固的民主决策社会许可"]
> ```
...
> | 条目 | 类型 | 关系 |
> |:-----|:-----|:-----|
> | [[Scientific Uncertainty]] | 概念 | 后常规科学的[[Epistemology\|认识论]]基石，强调不确定性是复杂系统探究的固有属性而非科学缺陷。 |
> | [[Public Engagement with Science]] | 概念 | 后常规科学所倡导的“扩展同行共同体”在制度层面的具体实践载体。 |
> | [[The Green Book]] | 事实 | 英国政府在政策评估中应对后常规问题风险与不确定性的法定操作规范。 |
> | [[Scientific Advisory Group for Emergencies]] | 事实 | 英国在应对重大后常规危机（如大流行）时启动的国家科学咨询中枢机制。 |
