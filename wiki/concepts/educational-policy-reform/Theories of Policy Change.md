...
> [!info]
> 在公共政策语境中，政策[[Theory of Change|变革理论]]（theory of policy change）指政策所承载的关于因果机制的叙事——即关于特定政策干预在何种情境中激活何种机制、从而产生何种效果的信念体系。此概念源自 Pawson（2006）的[[Realist Evaluation|实在论评估]]（realist evaluation）框架，强调政策评估应揭示"什么在什么情境中对谁有效"（what works for whom in what circumstances）的因果机制，而非仅关注"是否有效"([[Argument_Rambla_2022_Springer|Rambla, 2022, p.165]])。
>
...
> [!example]
> - vs 一般意义上的"政策目标"：政策目标描述的是预期结果（如"将早期辍学率降至 10% 以下"），而[[Theory of Change|变革理论]]描述的是对因果机制的信念（如"降低辍学率将通过提升劳动力素质促进经济增长"）。前者是"要达到什么"，后者是"为什么这样做会有效"
> - vs [[Performance Indicators]]：变革理论是绩效指标的四个构成维度之一——指标不仅提供数据，还承载因果叙事。两者的关系是：绩效指标是变革理论的载体，变革理论是绩效指标的认知内核。详见 [[Performance Indicators]]

## 概念演变

> [!note]-
> - **Pawson（2006）** 在 Evidence-Based Policy: A Realist Perspective 中提出[[Theory of Change|变革理论]]概念，作为[[Realist Evaluation|实在论评估]]的核心工具——强调政策评估应打开因果机制的"黑箱"
...
> [!abstract]
> 基于 Rambla（2022, p.165–172）对欧盟政策的分析，[[Theory of Change|变革理论]]在政策运作中呈现三个层面：
...
变革理论是 [[Performance Indicators]] 的四个构成维度之一。绩效指标不仅提供可比较的数据，也承载特定的因果信念，将某些政策路径在认知上自然化为"理所当然"。在 [[Innovation Union]] 和 [[EU Skills Agenda]] 中，共同的变革理论表现为"[[Innovation Ecosystem|创新生态]]体系"与"教育培训体系"协同演化的信念：减少早期辍学 + 促进创新 → 智能、可持续与包容性增长([[Argument_Rambla_2022_Springer|Rambla, 2022, p.170–171]])。
...
> [!tip]-
> - Pawson（2006）的[[Realist Evaluation|实在论评估]]框架：强调"情境—机制—结果"（Context-Mechanism-Outcome）的配置，为[[Theory of Change|变革理论]]提供了方法论基础
> - [[Performance Indicators]] — Le Galès（2016）的政策工具理论为理解变革理论何以是政策工具的构成维度提供了框架

## 实证发现

> [!success]
> 以下发现全部来自 Rambla（2022）基于 [[YOUNG_ADULLLT|YOUNG_ADULLLT 项目]]的定性分析：
...
在南欧和东欧，[[Lifelong Learning|终身学习]]专业人员将欧盟的变革理论简化为"帮助青年尽快找到工作"的就业工具。这一"就业优先"（employment-first）理解与欧盟官方变革理论中"充分就业"的目标部分一致，但完全失去了其中个人发展和公民参与的维度([[Argument_Rambla_2022_Springer|Rambla, 2022, p.174]])。
...
> [!warning]
> - **因果链条未经检验** 许多政策[[Theory of Change|变革理论]]的核心因果[[Hypothesis|假设]]（如"促进创新将自然带动教育改善"）并未经过严格的实证检验，而是作为政策工具的内在成分被嵌入。Pawson（2006）的[[Realist Evaluation|实在论评估]]本身正是对这种"黑箱"思维的批判性回应([[Argument_Rambla_2022_Springer|Rambla, 2022, p.165]])
...
> [!example]
> - [[Innovation Union]] — 其核心[[Theory of Change|变革理论]]是"[[Innovation Ecosystem|创新生态]]体系"与"教育培训体系"的协同演化
