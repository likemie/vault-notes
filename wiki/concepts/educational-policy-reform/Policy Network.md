...
> - **理论用途** 一方面用于解构中立循证话语背后的公私利益共生、跨界[[Co-affiliation|共同从属]]与话语垄断，另一方面用于诊断国家[[Evidence Ecosystem|教育证据生态系统]]中信息流通的密度、频率与结构性梗阻。
...
> ```mermaid
> flowchart LR
>   subgraph Critical["批判社会学面向：公私共生与理念编排"]
>     A["跨界节点联盟<br>（智库·基金会·监管方）"] --> B["理念编排与话语垄断<br>（特定学说唯一科学化）"]
>     B --> C["表演性问责锁链<br>（课程认证与财政捆绑）"]
>   end
> 
>   subgraph Empirical["实证行政治理面向：政务网络解耦与偏误"]
>     D["部委征询网络扩张<br>（名义名单大覆盖）"] --> E["形式主义大网络陷阱<br>（规模与强度非线性解耦）"]
>     E --> F["生产依附偏误<br>（排斥纯中介·异化为交易采买）"]
>   end
> 
