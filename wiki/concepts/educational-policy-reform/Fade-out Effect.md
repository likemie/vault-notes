...
> [!def] 概念定义
> **效应衰退（Fade-out Effect）**，亦称**效应消退**或**干预后持续性衰减**，是指教育、心理与社会干预方案在干预实施期结束时虽然产生了显著的即时正向效果（Immediate [[Pre-test and Post-test|posttest]] Gains），但随着时间推移、干预支持撤除以及受试者重返常规环境，该正向因果优势在随访期（Follow-up Period）内逐步萎缩、衰减甚至完全归零的普遍经验现象([[Argument_Wadhwa_2024_RER|Wadhwa et al., 2024, pp. 11–15]])。
>
...
> 1. **对照组自发追赶与自然成熟（Control Group Catch-up）** 干预组学生通过高强度训练提前掌握了某些低阶基础技能（如字母拼读）；但在后续学期中，对照组学生在[[Business as Usual|常态教学]]中也逐步自然掌握了该技能，使得两组之间的相对差距被抹平。
