...
> [!def] 核心定义
> 研究利用（Research Utilization / Research Use）指科学研究产出——包括概念、命题、解释、理论、策略、经验证据和方法论（Caplan, 1991）——以不同路径、形态和程度进入公共政策制定、组织管理以及一线专业教学实践的方式、过程与治理机制（Weiss, 1991b；[[Argument_Hagevold_Forsstrom_Keles_2026_ERR|Hagevold et al., 2026, p. 4]]；[[Argument_Mausethagen_2025_ERR|Mausethagen et al., 2025, pp. 1–2]]）。

> [!concept-lens] 概念透镜
> - **含义** 关注研究如何通过多重路径渗透进决策与行动——从即时的工具性问题解决，到提供概念透镜与新视角，再到作为政治修辞或合法化依据。
> - **用途** 帮助研究者与政策制定者理解为何高质量研究常被忽视或异化，揭示促进证据在复杂社会生态中有效转化的治理机制与专业条件。
> - **边界** 反对将研究利用简化为“研究产出→政策落实”的单向线性因果输入；研究利用本质上是扩散性、互动性、情境化且受深层价值规范制约的动态协商过程。
...
>       P1["政治议程与可接受性"] <--> P2["政策研究利用（研发/问题解决/战术）"]
>     end
>     subgraph Meso["中观组织层（Meso School System）"]
>       G1["信任机制"] & G2["技能发展"] & G3["可持续结构"] & G4["伙伴关系"] --> GOV["跨层治理生态"]
>     end
>     subgraph Micro["微观实践层（Micro Professional Practice）"]
>       K1["外源研究证据"] & K2["实践经验智慧"] & K3["情境与学生需求"] --> KI["多源知识整合（Knowledge Integration）"]
>       NORM["专业伦理与价值规范"] --> ACT["教师专业能动裁决"]
>       KI --> ACT
>     end
>     Macro <--> Meso <--> Micro
> ```
...
> | 命题类型 | 核心指向 | 适用情境 | 代表学者 |
> |---|---|---|---|
> | **政治约束与议程筛选** | 研究利用受政治可接受性与权力议程决定 | 宏观教育政策制定、立法与国家级改革 | Thomas (1991); Cook (1991); James (1993) |
> | **知识渗透与传播悖论** | 异质知识类型的间接渗透与传播生态平衡 | 知识转化、智库传播、研究转译 | Caplan (1991); Knott & Wildavsky (1991) |
> | **跨层生态治理** | 信任、技能、结构与关系四机制共同治理学校研究使用 | 学校改进、学区改革、循证教研制度建设 | [[Argument_Hagevold_Forsstrom_Keles_2026_ERR\|Hagevold et al. (2026)]] |
> | **专业敏感与知识整合** | 教师立足专业规范对多源知识的主动整合与裁决 | 课堂教学决策、教师专业发展、校本探究 | [[Argument_Mausethagen_2025_ERR\|Mausethagen et al. (2025)]]; Eriksen (2022) |
