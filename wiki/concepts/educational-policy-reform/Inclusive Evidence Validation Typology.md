...
> [!info]
> 包容性证据验证类型学是 Dachet 与 Baye 在法语比利时[[Pact for Educational Excellence|教育卓越公约]]工作中建立的研究设计分类框架。它用于整理教学工具/项目的证据基础，把专家验证、案例研究、横断研究、相关或纵向研究、实验和准[[Experimental Research|实验研究]]放在同一连续框架内，同时为每类方法设置最低质量标准([[Argument_Dachet_2021_ROE|Dachet & Baye, 2021, pp.175-178]])。
...
- 案例研究或横断研究验证：案例研究可用观察、半结构访谈和内容分析理解工具特征、使用和影响；横断研究可一次性描述某[[Variable|变量]]在群体中的频率及其相关特征([[Argument_Dachet_2021_ROE|Dachet & Baye, 2021, pp.176-177]])。
...
> [!success]
> 该类型学服务两个目标：一是让工作组能够按证据水平整理候选工具/项目，二是为不同方法路径定义最低标准，包括质性方法的最低标准([[Argument_Dachet_2021_ROE|Dachet & Baye, 2021, p.178]])。

> [!info]- 核心数据
> Dachet 与 Baye 要求被测试的工具/项目至少在两个具有不同特征的课堂环境中实施，例如学校社会经济地位、教学网络和教师经验不同的环境；这个要求用于避免只在单一课堂中观察实施而过早推广([[Argument_Dachet_2021_ROE|Dachet & Baye, 2021, pp.178-179]])。

## 争议与批评

> [!warning]
> 包容性类型学的主要风险是“验证”一词可能覆盖强度差异很大的证据。专家验证和案例研究可以帮助筛选有前景项目，但不能替代实验或准实验对“效果”的判断；Dachet 与 Baye 因此强调不同研究设计回答不同性质的问题，效果、实施、教师接受度、适配和成本效益不能由同一种方法完全回答([[Argument_Dachet_2021_ROE|Dachet & Baye, 2021, pp.179-180]])。

## 相关案例／政策

> [!example]
> - [[Pact for Educational Excellence]] — 该类型学是在公约工作组筛选和验证 425 个候选教学工具/项目时建立的([[Argument_Dachet_2021_ROE|Dachet & Baye, 2021, pp.175-176]])。
