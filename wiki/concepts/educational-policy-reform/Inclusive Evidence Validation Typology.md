...
> - vs 传统证据层级 — 传统层级常把[[Experimental Research|实验研究]]置于顶端并排除较弱设计；该类型学承认实验和准实验对效果问题最有力，但同时保留专家验证、[[Case Study|案例研究]]和[[Descriptive Research Question|描述性研究]]在早期筛选、实施理解和问题生成中的作用([[Argument_Dachet_2021_ROE|Dachet & Baye, 2021, pp.175-180]])。
...
> [!warning]
> 包容性类型学的主要风险是“验证”一词可能覆盖强度差异很大的证据。专家验证和[[Case Study|案例研究]]可以帮助筛选有前景项目，但不能替代实验或准实验对“效果”的判断；Dachet 与 Baye 因此强调不同研究设计回答不同性质的问题，效果、实施、教师接受度、适配和成本效益不能由同一种方法完全回答([[Argument_Dachet_2021_ROE|Dachet & Baye, 2021, pp.179-180]])。
