...
> [!info]- 核心数据
> Dachet and Baye 要求被测试的工具/项目至少在两个具有不同特征的课堂环境中实施，例如学校社会经济地位、教学网络和教师经验不同的环境；这个要求用于避免只在单一课堂中观察实施而过早推广([[Argument_Dachet_2021_ROE|Dachet & Baye, 2021, pp.178-179]])。

## 争议与批评

> [!warning]
> 包容性类型学的主要风险是“验证”一词可能覆盖强度差异很大的证据。专家验证和[[Case Study|案例研究]]可以帮助筛选有前景项目，但不能替代实验或准实验对“效果”的判断；Dachet and Baye 因此强调不同研究设计回答不同性质的问题，效果、实施、教师接受度、适配和成本效益不能由同一种方法完全回答([[Argument_Dachet_2021_ROE|Dachet & Baye, 2021, pp.179-180]])。
