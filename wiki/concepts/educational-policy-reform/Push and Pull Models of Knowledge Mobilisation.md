---
title: Push and Pull Models of Knowledge Mobilisation
aliases:
  - 推拉模型
  - 供给推送与需求牵引模型
  - Push-Pull Models of Knowledge Mobilisation
...
> - **理论用途** 揭示传统循证政策长期将巨额资源沉淀于证据库搭建与成果单向推送（Push），却因忽视实践端吸收能力与时间保障（Pull）而导致大面积落地失效的制度根源。
...
> [!contrast-table] 概念辨析
> | 比较维度 | 供给推送机制（Push） | 需求牵引机制（Pull） | 双向互动与协同创造机制（Linkage & Exchange） |
> |---|---|---|---|
> | **主导发起者** | 研究者、学术机构、知识清除所与政府部委 | [[School Leadership\|学校领导]]者、教研组长、一线教师及实践团队 | 研究者与实践者构建的长期研发伙伴关系（[[Research-Practice Partnership\|RPP]]） |
> | **核心[[Hypothesis\|假设]]** | 严谨证据能自然指导实践，重在提高物理可及性 | 实践者具有明确问题意识，能够自主识别并转化证据 | 知识在横跨学术与实践边界的平等[[Dialogue in Education\|对话]]中协同生成 |
> | **主要载体** | 学术期刊、[[Systematic Review\|系统综述]]、证据清除所数据库、通俗简报 | 现场教学问题诊断、校级改进方案、专业学习研讨 | 联合[[Action Research\|行动研究]]、[[Embedded Researcher\|嵌入式研究员]]、跨界[[Educational Brokerage Agency\|知识中介机构]] |
> | **实践者角色** | 学术知识的被动接收者、消费者或末端执行管道 | 审慎审读证据、情境化改造并因地制宜的专业主体 | 共同界定[[Research Question\|研究问题]]、参与方案设计的研究合作者 |
> | **潜在失灵风险** | 成果脱离教学情境，产生信息过载与实践水土不服 | 实践者深陷时间赤字与素养盲区，难以维持深度探究 | 跨界合作沟通成本高昂，推进周期漫长且维系不易 |
...
> ```mermaid
> flowchart LR
>     subgraph Supply["供给侧推送 (Push)"]
>       A1["基础学术研究"]
>       A2["证据清除所与数据库"]
>       A3["转化简报与工具箱"]
>     end
> 
>     subgraph Intermediary["中介与协同 (Brokerage / Exchange)"]
>       B1["跨界中介组织"]
>       B2["研究-实践伙伴关系 (RPP)"]
>     end
> 
>     subgraph Demand["需求侧牵引 (Pull)"]
>       C1["现场教学问题诊断"]
>       C2["审慎研读与质量评估"]
>       C3["微观情境调试与教学试验"]
>     end
...
### 命题一　线性供给推送假设忽视了实践情境复杂性，单纯扩大文献供给无法自发诱致教学变革

> [!concept-lens] 供给侧偏误与线性传递失效
...
### 命题二　激活需求牵引机制要求系统治理实现战略重构，优先投资学校组织使能条件与工时保障

> [!concept-lens] 需求牵引与组织使能条件
...
> | 命题类型 | 核心指向 | 适用情境 | 代表学者 |
> |---|---|---|---|
> | **供给传递失效** | 揭示单向推送无法跨越复杂情境鸿沟，批判线性传递假设 | 教育科研成果推广与自上而下政策宣贯 | Lavis et al. (2003); [[Argument_Rickinson_2022_UsingResearchWell\|Rickinson et al. (2022)]] |
> | **需求使能重构** | 论证激活牵引机制必须优先投资实践端吸收能力与专有工时 | 基础教育学校内生改进与制度化减负 | Rickinson et al.; [[Argument_Torres_2022_KMModels\|Torres (2022b)]] |
...
> |---|---|---|---|---|---|---|
> | [[Argument_Rickinson_2022_UsingResearchWell\|Rickinson et al. (2022)]] | 澳大利亚 4 州中小学 906 名教育者（两轮标准化[[Questionnaire\|问卷]]）及 29 名访谈者 | 两轮李克特问卷调查与[[In-depth Interview\|深度访谈]]质性分析 | 供给端可及性障碍（检索困难）与需求端使能障壁（质量信心、时间赤字） | 64% 报告检索适切研究困难；44% 自陈缺乏判断质量信心；76% 遭遇日常时间赤字；61% 因转化耗时过长认为使用不划算；校内[[Professional Learning Community\|专业学习共同体]]显著提升常规使用概率 | $p < .05$（Fisher 精确检验显著） | 揭示了单向推送无法穿透实践端吸收瓶颈的现实困境，支持了向需求端使能倾斜的理论主张 |
> | [[Argument_Torres_2022_KMModels\|Torres (2022b)]] | [[OECD]] 跨国教育系统[[Knowledge Mobilisation\|知识动员]]机制综述 | 跨国比较[[Literature Review\|文献综述]]与概念[[Framework Synthesis\|框架综合]] | 各国在 Push、Pull 与 Exchange 三类机制上的制度布局与政策失衡 | 绝大多数国家政策高度偏重 Push 端成果分发与数据库，Pull 端组织使能与中介机制严重匮乏 | — | 宏观政策层面的跨国制度映射，呈现供需机制结构性失衡的普遍性 |
