...
> [!term] 知识流动[[Paradigm|范式]]的三阶演进
> - **一阶：知识转移（Transfer）** 关注知识的推送与送达，假定证据具备普遍适用性，只要被教师获知即可发生改进。
> - **二阶：知识转译（Translation）** 认识到语言与情境隔阂，强调将学术话语转化为通俗易懂的指南、工具箱与案例。
> - **三阶：知识动员与转化（Mobilisation & Transformation）** 确立知识为多元主体在信任关系、能力建设与制度保障中共同创造（Co-creation）的社会产物。[[Argument_Hagevold_Forsstrom_Keles_2026_ERR|(Hagevold et al., 2026, pp. 16–18)]]
...
> [!factors] 支撑知识动员的四大跨层治理机制
> - **组织与人际信任（Trust）** 建立研究者与实践者之间的心理安全感，克服制度性互不信任，营造开放试错的探究氛围。
> - **双向技能发展（Skill Development）** 一线教师发展研究批判与数据分析技能，研究人员发展知识转译与跨界沟通技能。
> - **可持续组织结构（Sustainable Structures）** 设立制度化中介机构、设立联合教研岗位与专门[[Research Utilization|研究使用]]时间表。
...
> [!concept-lens] 知识流动本体与共创[[Paradigm|范式]]
> 解构将知识动员视作单向管道输送的[[Technical Rationality|技术理性]]模型，确立多方主体平等参与的社会建构与共创本体。
...
> [!concept-lens] 能力赤字与双向赋权
> 揭示阻碍证据转化的深层障碍不仅存在于实践端，研究生产端同样面临转化能力缺失，必须双向赋能。
...
> [!concept-lens] 范式转型与系统治理
> 针对传统干预方案依从度模式的失效，提出以[[Teacher Professional Agency|教师专业能动性]]为核心的系统整合治理框架。
