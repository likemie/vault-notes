...
>   承认研究证据仅是公共决策知识的一部分，必须与一线教师的实践默会知识、本土情境经验及公共政策价值展开有机融合。
> - **赋权型系统领导力（Collaborative Leadership）**
>   放弃自上而下的刚性行政控制命令，转向赋权基层自组织结构、参与式行动反思与持续[[Formative Assessment|形成性评估]]。
> - **跨组织协同网络（Effective Networks）**
>   打破大学象牙塔与中小学的组织制度壁垒，将学校集群、高校研究团队与地方决策层编织进具有共同变革目标的协作网络中。
...
> - **构件交互：从孤立管道走向双层嵌套生态**
>   早期模型中生产与使用在空间上截然分割，仅依赖中介单向搬运；演进后的生态模型通过知识漏斗与行动循环建立双向流动，进而以双层嵌套结构揭示出狭义证据生态始终深嵌于充满权力博弈、资源分配与制度惯性的宏观社会政治大系统中。
> - **行动者定位：从一维标签走向多维功能复合体**
>   超越将行动者僵化固定为单一“生产者”或“使用者”的静态标签，行动者展现出多维功能复合性：一线教师既是使用者也是研究共创者，中介者承担系统催化与反馈校准，工会、专业协会与媒体亦作为合法利益相关者参与生态治理。
...
> 围绕科研体制内同行评议、高影响因子期刊发表与实践导向的知识共创之间的制度冲突展开。
