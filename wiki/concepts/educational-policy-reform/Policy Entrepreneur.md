...
tags:
  - concept/policy-entrepreneur
  - theme/educational-privatisation
...
> 政策企业家愿意投入自己的资源——时间、精力、声誉乃至金钱——来促进他们所偏好的政策主张。他们密切注视政策环境，等待时机成熟，在问题、方案与政治三条溪流汇合的短暂机会窗口期，果断促成议题的突破。[[Argument_McDonnell_2013_AJE|(McDonnell & Weatherford, 2013, p. 4)]]
>
> *Policy entrepreneurs are willing to invest their resources—time, energy, reputation, and sometimes money—in the hope of a future return. They lie in wait for a window to open, ready to attach their solutions to problems or to hitch them to political momentum.*

> [!boundary]- 概念边界
> - 不等于 前转移代理人 — 前转移代理人聚焦于将外部知识和模式引入本土系统的中介行为；政策企业家则强调整合公共、商业和非营利资源，构建自主运作的网络，将理念商业化推广或打破国家体制垄断。
> - 不适用于 — 绝对排他性的高度集权指令式、封闭科层制管理环境（如缺乏多元参与空间的传统刚性行政体系）。
...
> [!contrast-table] 概念辨析
> | 维度 | Policy Entrepreneur (本概念) | [[Pre-Transfer Agency]] | [[Policy Borrowing]] |
> |---|---|---|---|
> | **主要分析对象** | 在公共、智库与商业间跨界流动的网络化能动主体。 | 桥接国际源地和本土接纳地之间的引介中介。 | 主权国家引介或吸收外部教育体制的宏观决策行为。 |
> | **核心机制** | [[Policy Window\|政策窗口]]捕捉、跨界资源打包、证据与价值双轨对接、知识商业化。 | 政治化翻译、引介性倡导、本土合法性背书。 | [[Externalization\|外部化]]（Externalisation）、[[Transfer Translation Transformation\|转译]]（Translation）与制度重构。 |
> | **适用范围** | 分散权威空间、[[Network Governance\|网络化治理]]及多阶段公共决策倡导。 | 教育转移的初期中介与试点启动阶段。 | 宏观层面的比较教育与跨国制度比较研究。 |
...
> ```mermaid
> flowchart LR
>     A["社会危机与差距指标"] --> B["政策企业家网络"]
>     C["两党核心价值与慈善资本"] --> B
>     B -->|"公共改革路径：证据打包 + 技术护栏"| D["打破制度垄断与各州法定采纳"]
>     B -->|"市场治理路径：公私切换 + 品牌包装"| E["全球教育服务商业化与远处治理"]
> ```
...
> [!concept-lens] [[Governing at a Distance|远处治理]]与跨国网络协调
> 这一命题关注在去中心化的全球教育治理中，政策企业家如何利用数据和评估指标，绕过国家主权屏障，在跨国尺度上实施软性政策控制。

> [!claim] [[Eleftherios Klerides|Klerides, E.]]
> **多行动者交织的远处治理** 论证了二战后比较教育从国家单向借用工具演变至 2000 年代后的分散权威空间，大数据、基准测试以中立客观之名行使远处治理，政策企业家与国际组织、非政府组织和跨国公司共同交织成网络，充当[[Policy Mobility|政策流动]]和理性化规范输出的主体。[[Argument_Klerides_2023_CE|(Klerides, 2023, p. 425)]]
...
### 命题三　政策企业家在政策周期中动态整合实证证据与价值规范以打破政策垄断

> [!concept-lens] 循证倡导与制度垄断打破
...
> | 命题类型 | 核心指向 | 适用情境 | 代表学者 |
> |---|---|---|---|
> | **远处治理命题** | 关注政策企业家在分散的全球网络中如何以中立数据为名，协调并执行远处治理。 | 全球多行动者[[Policy Network\|政策网络]]及基准数据比较。 | [[Argument_Klerides_2023_CE\|Klerides (2023)]]; Ball (2012) |
> | **混合私有化命题** | 关注政策企业家如何通过无缝跨界运作，将公共教育资源与商业利润网络对接。 | 国家私有化改革、慈善资本运作与学校商业化服务。 | [[Argument_ONeill_2016_Report\|O'Neill et al. (2016)]]; Mintrom (2000) |
> | **阶段证据整合命题** | 关注政策企业家如何在政策各阶段策略性组合实证研究、专业经验与价值诉求，破解政策垄断。 | 课程标准改革、多阶段公共决策倡导与联盟构建。 | [[Argument_McDonnell_2013_AJE\|McDonnell & Weatherford (2013)]]; Stone (2012) |
...
> - **资深政界领袖穿梭协调** 前州长詹姆斯·B·亨特（James B. Hunt Jr.）与鲍勃·怀斯（Bob Wise）凭借跨党派人脉，主动邀请[[National Research Council|美国国家科学研究委员会]]（NRC）召开研讨会起草《教育领导力蓝图》，为两党州长确立国家标准改革合法性。[[Argument_McDonnell_2013_AJE|(McDonnell & Weatherford, 2013, pp. 8–9, 21)]]
...
> - **公共部门** 受教育部合同开发 [[Assessment Tools for Teaching and Learning|asTTle]] 国家课程测试系统（1999/2000），担任澳大利亚教学与[[School Leadership|学校领导力]]研究所（[[Australian Institute for Teaching and School Leadership|AITSL]]）董事会主席（2014）。[[Argument_ONeill_2016_Report|(O'Neill et al., 2016, pp. 47–50)]]
> - **非营利领域** 担任 [[Cognition Education|Multi Serve Education Trust]] / Cognition Education Trust 董事和学术顾问。[[Argument_ONeill_2016_Report|(O'Neill et al., 2016, p. 48)]]
> - **营利商业拓展** 通过 Cognition Education 将 [[Visible Learning]] 品牌商业化，开发工作坊系列、开展学校认证并拓展全球交付网络；Visible Classroom App 与商业公司合作实现全球推广。[[Argument_ONeill_2016_Report|(O'Neill et al., 2016, pp. 48–51)]]
...
> - **教育价值榨取与资本[[Attrition|流失]]** 外部财务审计表明，许多慈善性或混合性的[[Educational Management Organisation|教育管理组织]]（EMO），以政策创业提供优质服务为名，从公立教育系统中吸纳的合同金与咨询费，远远超过其通过慈善捐赠或直接服务返还给公立学校的价值。[[Argument_ONeill_2016_Report|(O'Neill et al., 2016, p. xv)]]

> [!warning] 适用局限
> 政策企业家的解释力依赖于国家治理向网络化或管理的教育市场倾斜的制度安排；在强力中央控制或科层制行政命令绝对主导的刚性体系下，政策企业家的活动空间受限。[[Argument_ONeill_2016_Report|(O'Neill et al., 2016, p. xv)]]
