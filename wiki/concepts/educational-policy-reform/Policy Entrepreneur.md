...
> [!def] 核心定义
> 政策企业家（Policy Entrepreneur，又称政策创业者）是指在教育系统内外，通过建立跨界社交网络、识别并把握政策机会（policy window）并动员多元资源，以实质性影响公共政策议程设置、文本生产与交付交付的能动行动者。这一概念由 Kingdon 引入公共政策分析，Mintrom (2000) 进一步描述了其在教育系统内部推动学校自主和改革的自下而上创业过程，而 Ball (2012) 将其扩展至跨国与全球治理维度，用以刻画在新自由主义[[Network Governance\|网络治理]]中，商业企业、慈善基金会、智库及个人代理人穿透国家主权边界、跨国流通全球化政策模板的行为模式。 (引自 [[Argument_ONeill_2016_Report\|O'Neill et al., 2016, p. viii, p. 47]])
...
>
> *Hattie's now global social networking approach might reasonably be described as a seamless fabrication of his public-good, not-for-profit and for-profit policy entrepreneurship and advocacy.*

> [!boundary]- 概念边界
> - 不等于 前转移代理人 — 前转移代理人聚焦于将外部知识和模式引入本土系统的中介行为；政策企业家则强整个合公共、商业和非营利资源，构建自主运作的全球网络，将学术知识进行品牌商业化推广。
> - 不适用于 — 传统的中央计划指令式、完全排他性国营科层制管理的封闭政策环境（如冷战时期的苏联国家教育体制）。
...
> |------|--------|----------------|----------------|
> | **主要分析对象** | 在公共与商业间跨界流动的[[Snowball Sampling\|网络化]]能动主体。 | 桥接国际源地和本土接纳地之间的中介行动者。 | 主权国家引介或吸收外部教育体制以应对国内危机的宏观行为。 |
> | **核心机制** | 机会窗口捕捉、跨界资源打包、知识产权商业化与契约软治理。 | 政治化翻译、引介性倡导、合法性背书。 | 外部化（Externalisation）、[[Transfer Translation Transformation\|转译]]（Translation）与重构。 |
> | **适用范围** | 全球[[Network Governance\|网络化治理]]与多行动者交织的分散权威空间。 | 教育转移的初期中介与启动阶段。 | 宏观层面的比较教育与跨国制度比较。 |
...
> ```mermaid
> flowchart TD
>     A["学术研究 (基础知识)"] -->|商业包装与认证| B["营利化教育品牌 (Visible Learning 等)"]
>     C["非营利基金会 (Cognition 等)"] -.支持.-> B
>     D["国家与多边机构契约 (AITSL/OECD等)"] -->|提供合法性背书| B
>     B -->|契约网络输出| E["全球学校远处治理与政策交付"]
> ```
...
> [!concept-lens] 循证倡导与政策垄断打破
> 关注政策企业家如何在不同决策阶段，将科学研究、实证指标与规范性价值诉求策略性组合，打破僵化的既有体制并构建改革支持联盟。

> [!claim] McDonnell, L. M. & Weatherford, M. S.
> **阶段权变的证据整合与去政治化倡导** 论证了政策企业家在推动重大制度变迁时，并非单向依凭纯粹学术证据，而是依据政策周期各阶段的政治目标灵活整合多元证据：在问题界定阶段，策略性筛选国际测评与州际落差指标，将其与人力资本竞争力价值框架结合以打破分散标准的政策垄断；在方案设计阶段，将“诉诸实证研究”作为去政治化策略以规避意识形态争端，并在研究证据有限处以专家和一线教师的专业经验填补空白；在采纳阶段，重构共识叙事并注入州级细分对比证据以构建法定通过联盟。([[Argument_McDonnell_2013_AJE|McDonnell & Weatherford, 2013, pp. 1–4, 18–19]])
...
> - **2013 — 政策周期中的证据利用与去政治化** [[Argument_McDonnell_2013_AJE|McDonnell & Weatherford (2013)]] 将政策企业家理论与多阶段证据利用相结合，揭示其如何在各阶段将实证研究、指标数据与价值叙事策略性打包装配，以突破政策垄断并推进共同核心标准采纳。
