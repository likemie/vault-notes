...
> - 区别于 [[Research Utilization\|研究利用]]（Research Utilization）：研究利用侧重描述知识从生产到采纳的形态（工具性、概念性或[[Conceptual, Instrumental, and Symbolic Use of Research\|象征性使用]]）；研究参与学校则侧重描述承载并维系这些行为的组织制度环境。
> - 不适用于单一决策的合法性判定：即使是一所高度成熟的研究参与学校，其日常大量即时性课堂交互仍依赖教师即兴直觉与默会智慧，不能因个别决策未查阅[[Document\|文献]]而否定学校的研究参与属性。
...
> [!contrast-table] 概念辨析
> | 比较维度 | 研究参与学校（RES） | [[Evidence-Informed Practice\|证据知情实践]]（EIP） | [[Research Utilization\|研究利用]]（RU） |
> |---|---|---|---|
> | **[[Unit of Analysis\|分析单位]]** | 学校组织系统（微观组织与制度生态） | 教师与领导者个体（决策与教学行为） | 学术知识本身（在政策与实践中的流动形态） |
> | **核心机制** | 战略规划、文化规范、[[Professional Learning Community\|PLC]] 探究与资源配置 | [[Professional Judgment\|专业判断]]引领下的经验、数据与外部研究整合 | 概念转化、工具性采纳或象征性辩护 |
> | **核心判定标准** | 是否具备全员参与的战略意图、意愿与能力 | 决策过程是否批判性地审议并结合了多源证据 | 研究成果是否被实践端感知、采纳或行动化 |
> | **核心关注问题** | 学校如何构建支持深度探究的制度环境与土壤 | 教师在课堂决策中如何审慎使用证据因材施教 | [[Knowledge Production\|知识生产]]者与使用者之间的中介转化效率如何 |

---

## 核心要素

> [!feature] 研究参与学校的四大判定特征
> - **自觉的战略性与发展性规划** 学校并非偶然或被动应对外部检查，而是将研究参与明确写入学校战略发展规划，作为持续改进的内在引擎。
> - **面向全体教职工的包容性参与** 证据知情文化要求覆盖“全体教职工”，坚决避免将[[Professional Learning Community\|专业学习共同体]]降格为少数骨干教师组成的封闭突击队（Roberts, 2015）。
> - **意图、意愿与能力三位一体** 组织不仅拥有战略愿景（意图）与文化认同（意愿），更必须系统具备[[Data Literacy\|数据素养]]、方法甄别与再情境化能力（能力）。[[Argument_Brown_Greany_2018_LPS\|(Brown & Greany, 2018, pp. 117–118)]]
> - **容许情境例外但坚持探究常态** 承认教学的不确定性，不强求每个决策都依赖研究，但要求在面对重大教学难题时建立常态化探究机制。
...
> ```mermaid
> flowchart LR
>     subgraph Input["组织使能基础"]
>         A["专业研究素养能力"]
>         B["刚性工时与正式论坛"]
>         C["变革与学习中心型领导"]
>     end
>     
>     subgraph Process["核心探究活动"]
>         D["全员包容性 PLC"]
>         E["底层教学假设质询"]
>         F["成效评价与再情境化"]
>     end
>     
>     subgraph Output["组织形态与成效"]
>         G["研究参与学校生态"]
>         H["可持续循证教学改进"]
>     end
>     
...
### 命题一　研究参与学校能够促使组织从表层工具性“技巧采纳”跃升为深层“学习文化”

> [!concept-lens] 组织学习与文化重塑
> 探讨研究参与如何重塑学校的组织学习[[Paradigm\|范式]]，论证证据知情绝非搜集现成教案的效率工具，而是推动学校思维方式转变的文化杠杆。

> [!claim] Godfrey, D.
> **从技巧清单转向探究性学习文化** 研究参与学校的核心价值在于打破将研究视为实用“锦囊妙计”（hints and [[TRIZ\|TIPS]]）的工具主义狭隘取向，推动全校形成探究性学习文化。在学习文化中，研究证据被用作重新审视教学痛点、暴露认知盲区与检验底层[[Hypothesis\|假设]]的[[Scaffolding\|脚手架]]，从而使教师专业学习与学校改进形成良性演进循环。[[Argument_Brown_Greany_2018_LPS\|(Brown & Greany, 2018, p. 118)]]

> [!claim] Handscomb, G. & MacBeath, J.; Stoll, L. 等
> **制度化日常嵌入是文化转型的物质基石** 学校能否实现向学习文化的转型，取决于组织是否将[[Research Utilization\|研究使用]]制度化嵌入教师日常专业生活，而非视作额外的外加负担。这需要[[School Leadership\|学校领导]]层在课表排程、教研空间与评价激励上提供刚性支持，依托[[Reflexivity\|反思性]]专业探究将教师默会知识转化为全校共享资源。[[Argument_Brown_Greany_2018_LPS\|(Brown & Greany, 2018, pp. 118, 124–125)]]

---

### 命题二　研究参与学校在现实推进中普遍面临“高价值认同”与“假设反思、成效评价机制断裂”的结构性失衡
...
### 命题三　研究参与学校的形成与维系依赖领导力的精准资源配置与外部高压问责框架的制度性解绑

> [!concept-lens] 领导力介入与宏观制度支持
> 探讨如何弥合组织断裂并建立可持续的研究参与生态，论证内部领导力转型与外部督导改革的协同必要性。

> [!claim] Brown, C. & Greany, T.; Ehren, M. 等
> **双重干预策略破解制度阻滞** 建设研究参与学校无法依靠自发演变，必须双管齐下：在微观组织层面，学校领导者必须将有限资源优先投向方向战略把关、问题成因诊断、干预成效评价与严谨 [[Professional Learning Community\|PLC]] 架构四维路径；在宏观制度层面，国家必须改革教育标准局（[[Ofsted]]）等高压问责框架，将证据知情改进制度化纳入督导考核，避免单一考试排名挤压学校深层探究的制度空间。[[Argument_Brown_Greany_2018_LPS\|(Brown & Greany, 2018, pp. 121–122, 132–133)]]
...
> |---|---|---|---|---|---|---|
> | [[Argument_Brown_Greany_2018_LPS\|Brown & Greany (2018)]] | 英格兰 79 所小学，696 名教师与[[School Leadership\|学校领导]]者 | 横断面基线调查（14 题项，5 级[[Likert Scale\|李克特量表]]） | (1) 研究信息在指导教学实践中发挥重要作用 | 非常同意 20%、同意 56%、不确定 21%、不同意 3%、非常不同意 1%（合计同意率 76%） | — | 超过四分之三高度认同研究的指导价值，确立了良好的认知起点 |
> | 同上 | 同上 | 同上 | (2) 发现研究信息在课堂应用新教学方法时很有用 | 非常同意 26%、同意 60%、不确定 13%、不同意 2%、非常不同意 0%（合计同意率 86%） | — | 高达 86% 肯定研究的实践功用，与评价流程的缺失形成鲜明落差 |
> | 同上 | 同上 | 同上 | (3) 学校设有评价项目或教学实践成效的正式流程（n = 694） | 非常同意 17%、同意 50%、不确定 20%、不同意 8%、非常不同意 5%（合计同意率 67%） | — | 确认率降至 67%（13% 明确持否定态度），显示[[Inquiry Cycle\|探究循环]]中评价环节最薄弱 |
> | 同上 | 同上 | 同上 | (4) 不支持在缺乏研究支撑时推行全校性变革 | 非常同意 13%、同意 37%、不确定 38%、不同意 12%、非常不同意 1%（合计同意率 50%） | — | 50%（正文按未坚定支持计为 61%）持不确定或赞成态度，表明学校极易盲从未经检验的变革风口 |
> | 同上 | 同上 | 同上 | (8) 学校经常讨论可能影响关键决策的底层[[Hypothesis\|假设]]（n = 694） | 非常同意 11%、同意 44%、不确定 30%、不同意 10%、非常不同意 4%（合计同意率 55%） | — | 全卷 14 项最低分，与乐于尝试新方法（82%）形成鲜明反差，为[[Activity Traps\|活动陷阱]]的核心表征 |
> | 同上 | 同上 | 同上 | (13) 学校建有供教职工分享与研讨信息的正式论坛（n = 694） | 非常同意 14%、同意 47%、不确定 21%、不同意 10%、非常不同意 7%（合计同意率 61%） | — | 仅 61% 确认建有正式论坛，与 82% 曾有非正式讨论对照，提示缺乏制度化交流平台 |
