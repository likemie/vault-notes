...
> [!info] 理论基础
> - [[Campbellian Validity Framework]] — "evidence-based"在清算中心实践中的意义可以被视为一个[[Construct|构念]]效度问题：如果不同清算中心对同一项目的有效性判断不能收敛，就说明 [[Evidence-Based Education|EBE]] 实践中的概念与实施方式差异过大，使用者应谨慎对待评级（Wadhwa et al., 2024, p.4）。
...
> 核心问题不是某一个清算中心质量低，而是清算中心作为整体未能对"evidence-based"形成稳定的实践意义。若一个术语具有高[[Construct|构念]]效度，那么不同清算中心在评价同一项目时至少应有较高收敛；但现有比较显示这种收敛只是有限的，因此"evidence-based"在清算中心语境中只有有限的实践构念效度（Wadhwa et al., 2024, p.26）。
