...
> [!info]
> 企业大学（Corporate University, CU）是跨国公司为其集中化的教育培训项目所使用的总称。它涵盖了从高度标准化的"学校型"培训到更复杂的管理层项目的广泛培训类型，反映了知识对这些公司的重要性以及它们大量招聘大学毕业生的现实([[Argument_Hartmann_2022_CorporateEducation|Hartmann, 2022, p.185]])。

术语"企业大学"不仅仅是将现有培训部门重新包装的营销噱头（尽管有此批评），更代表了企业模仿高等教育以提升其培训声誉的策略——这是模仿型同构（mimetic isomorphism）的典型案例([[Argument_Hartmann_2022_CorporateEducation|Hartmann, 2022, p.189]])。
...
> [!abstract]
> Martyn Rademakers（2014）将企业大学区分为三种类型，分别对应不同的 MNC 组织类型和标准化策略。三者在对标准化的强调程度、参与者的[[Knowledge Production|知识生产]]角色和排他性上存在本质差异([[Argument_Hartmann_2022_CorporateEducation|Hartmann, 2022, pp.185–188]])。
...
- **适用的 MNC 类型** 国际型 MNCs（高整合、低本地响应），总部多位于美国等自由市场经济体（LMEs），以高度标准化的"重磅炸弹"产品（如 blockbuster 药物）为特征([[Argument_Hartmann_2022_CorporateEducation|Hartmann, 2022, pp.187–188]])
...
- **适用的 MNC 类型** 跨国型 MNCs（高整合、高本地响应），在统一框架与本地适应性之间寻求平衡([[Argument_Hartmann_2022_CorporateEducation|Hartmann, 2022, p.188]])

### 高级研究院型（Academy）— 服务于最高管理层

- **特征** 标准化程度最低、排他性最强，参与者在"公司如何看待世界"的知识共同生产中扮演核心角色
- **规范扩散方式** 主要依靠模仿型同构——通过模仿顶尖大学的研究院模式来获得权威
- **典型案例** Apple University —— 前院长 Joel Podolny 曾任耶鲁管理学院院长和斯坦福、哈佛商学院教授，直接向 Apple CEO 汇报。课程涉及如何做出重要战略决策，面向最高管理层和被识别为潜力股的一小部分员工([[Argument_Hartmann_2022_CorporateEducation|Hartmann, 2022, pp.186, 189]])
- **适用范围** 所有类型 MNCs 的顶层（继任计划和最高管理层培训），不受 MNC 组织类型限制。但联邦型 MNCs（低整合、高本地响应）通常只在这一层级实现培训国际化，其余层级的培训仍深嵌于各国家制度([[Argument_Hartmann_2022_CorporateEducation|Hartmann, 2022, p.187]])
