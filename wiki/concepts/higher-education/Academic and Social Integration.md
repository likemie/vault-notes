...
> - [[Yajun Zheng|郑雅君]]的[[Operationalization|操作化]]设计通过多指标[[Triangulation|三角互证]]测量了分离（P1 个人生活史）、转折（P2-Q3 适应困难）、习得（P2-Q4 主动融入）、学业融入（GPA + 归属感自评）和社交融入（交友数量 + 师生交流频率 + 学生组织职务）五个[[Construct|构念]]。详见 [[Student Engagement]]
