...
| 层级 | 特征 | 关系性质 |
|------|------|----------|
| **Level 1: 交易**（Transaction） | 战术性、短期、可替代 | A 方有 B 方需要的东西，以某种对价交换。关系狭窄，不涉及深层信任 |
| **Level 2: 协作**（Collaboration） | 愿意分享想法、预期互惠 | 双方通过信息共享各自受益。关系中深度，需要一定信任基础 |
| **Level 3: 联盟**（Alliance） | 共享愿景、长期承诺 | 双方作为平等伙伴追求共同目标。需要实质性投入甚至牺牲，关系深度绑定 |

> [!warning] 核心原则：不是线性阶段模型
> - 双方**不需要**从 Level 1 开始逐级上升（p.7）
> - 可以从任何层级开始，也可以同时在多个层级互动
> - 可以在层级之间**双向移动**——升级、降级或跳跃都是可能的
> - 同一对合作伙伴可以在不同领域处于不同层级（例如学生招聘在 Level 1、联合研究在 Level 3，二者并行不悖）
...
- **策略导向**（strategic orientation）：框架的最终目的是帮助组织进行合作策略审计——识别现有合作组合中哪些领域和层级存在空白，并判断这些空白是"战略性地选择不做"还是"根本不知道存在这种可能性"（pp.22–23）
