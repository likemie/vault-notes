...
- **可预测性的幻觉** OSA 的逻辑预设学生的未来可以被入场数据预测，但这排除了教育的根本[[Open-Mindedness|开放性]]——[[Bildung]] 指向的是一个超越数据相关性的、开放且不可预测的未来([[Argument_Thompson_2022_Promising_Student|Thompson et al., 2022, p.227]])
