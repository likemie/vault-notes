...
> [!example]
> **vs [[Technology Transfer]]**：技术转移关注知识产权从大学向商业应用的流动（许可、专利、衍生企业），是知识交流的一个子集。知识交流的范围更广——它承认并非所有有价值的知识都具备可专利性，也并非所有产学互动都需要知识产权框架。例如，企业通过参加学术会议获取前沿洞见、通过研究生联合培养吸收隐性知识（tacit knowledge），这些都属于知识交流但不属于技术转移（Ulrichsen, 2025, pp.44–46）。
...
> [!note]
> 英国在 2000 年代后建立了系统化的知识交流支持体系，其关键特征是**从项目制竞争性资金转向公式驱动的长期稳定拨款**（Ulrichsen, 2025, pp.42–43）。这种长期稳定的资金使大学能够进行以下投资（Ulrichsen, 2024）：
