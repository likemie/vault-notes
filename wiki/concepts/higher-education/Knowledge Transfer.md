...
> - **知识转移作为[[Analytic Framework|分析框架]]的价值中立问题**：Partaken 将六种模态从"强制转移"到"知识交换"按合法性递减排列，但"交换"本身在不对等权力结构中也可能是不平等的——如南北学术合作中的知识提取。该框架对"交换"的理想化预设需要进一步检视([[Argument_Partaken_2022_Springer|Partaken, 2022, p.76]])
