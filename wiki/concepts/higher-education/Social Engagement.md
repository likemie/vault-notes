...
> - vs Tinto 的社交融入（Social [[Integration in Mixed Methods|integration]]）— Tinto 侧重**心理层面**的融入感（"社交环境与自己的偏好或期待相协调的程度"），Kuh 的社会性投入侧重**行为层面**的时间精力分配。郑雅君（2023）综合使用两者——问卷测量行为投入，访谈评估融入质量（郑雅君，2023，引 Tinto, 1993; Kuh, 1991）
...
> [!note]
> - **1993 社交融入**：Tinto 在融入理论中提出社交融入（Social [[Integration in Mixed Methods|integration]]），定义为学生发现大学社交环境与自身偏好相协调的程度（[[Yajun Zheng|郑雅君]]，2023，引 Tinto, 1993）
...
>
> **关键发现**：社会性投入不仅是结果[[Variable|变量]]（受阶层[[Habitus|习性]]影响），更可能是触发整个模式转换的**初始杠杆**——梓桐、高程等转变者均以社会性投入为转折引擎。这意味着投入不仅是**结果变量**，也可能成为**转化机制**（郑雅君，2023）。

> [!info]- 郑雅君（2023）的操作化
> 社会性投入的操作化通过量化与质性指标[[Triangulation|三角互证]]：量化方面以交友数量、师生交流频率、学生组织领导职务级别为指标，质性方面通过 P2-Q4（课外活动参与情况）和 P2-Q6（对师生的情感评价）判断投入的方向性和质量。完整操作化设计见 [[Student Engagement]]（郑雅君，2023）。
...
> - Brown 的[[Employability|就业力]]框架虽有洞察力，但将社会性投入完全工具化为就业筹码，可能忽视了社交融入对个人成长和意义建构的非工具性价值（郑雅君，2023）
