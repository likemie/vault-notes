...
> [!info]
> 社会性投入（Social Engagement）是[[Student Engagement|学生投入]]理论的两大核心维度之一，指学生向大学中人际互动、课外活动、职业探索和社会融入等方面的教育性实践活动投入的时间和[[Jing (Refined Mastery)|精]]力——包括加入学生组织与社团、参与实习和志愿服务、与教师和同伴建立关系等（[[Yajun Zheng|郑雅君]]，2023）。在[[Yajun Zheng|郑雅君]]（2023）的"大学过程"分析框架中，社会性投入与[[Academic Engagement|学业投入]]并列构成"投入过程"的两大分析轴。
...
> - vs Tinto 的社交融入（Social Integration）— Tinto 侧重**心理层面**的融入感（"社交环境与自己的偏好或期待相协调的程度"），Kuh 的社会性投入侧重**行为层面**的时间[[Jing (Refined Mastery)|精]]力分配。郑雅君（2023）综合使用两者——问卷测量行为投入，访谈评估融入质量（郑雅君，2023，引 Tinto, 1993; Kuh, 1991）
...
> [!note]
> - **1993 社交融入**：Tinto 在融入理论中提出社交融入（Social Integration），定[[Rightness|义]]为学生发现大学社交环境与自身偏好相协调的程度（[[Yajun Zheng|郑雅君]]，2023，引 Tinto, 1993）
...
> - **同伴与[[Student-Teacher Relationship|师生关系]]**：与同伴建立有意[[Rightness|义]]的人际连接、与教师建立非正式互动——这既是社交融入的指标，也是积累社会资本的渠道（郑雅君，2023）
...
> - [[Student Engagement]]（Kuh, 1991）— 提供了社会性投入的操作化定[[Rightness|义]]和行为指标
...
> [!success]
> [[Yajun Zheng|郑雅君]]（2023）第4章揭示社会性投入在两种大学生活组织模式中的系统性差异，且这一差异对毕业出路的影响可能超过[[Academic Engagement|学业投入]]差异：
> - **[[Goal-Controlled Mode|目标掌控模式]]**：社会性投入被视为**自我探寻和职业锚定的核心机制**——学生通过实习、人际网络、课外活动探索职业方向、积累雇主看重的软技能（如钦凯的"演绎"能力），并发展出顺藤摸瓜型或试错型的职业探索路径（郑雅君，2023）
> - **[[Intuition-Dependent Mode|直觉依赖模式]]**：社会性投入**被习惯性忽略**——弱势学生在名校中面临"语言包"不适配（文化语码差距）、屡次社团面试失败后的"弃疗"、对社交的根本性疏离，导致出路决策高度被动（郑雅君，2023）
>
> **关键发现**：社会性投入不仅是结果变量（受阶层[[Habitus|习性]]影响），更可能是触发整个模式转换的**初始杠杆**——梓桐、高程等转变者均以社会性投入为转折引擎。这意味着投入不仅是**结果变量**，也可能成为**转化机制**（郑雅君，2023）。

> [!info]- 郑雅君（2023）的操作化
> 社会性投入的操作化通过量化与质性指标三角互证：量化方面以交友数量、师生交流频率、学生组织领导职务级别为指标，质性方面通过 P2-Q4（课外活动参与情况）和 P2-Q6（对师生的情感评价）判断投入的方向性和质量。完整操作化设计见 [[Student Engagement]]（郑雅君，2023）。
...
> [!warning]
> - **"中立过程"假设的延续**：与社会性投入相关的概念——从 Tinto 的社交融入到 Kuh 的社会性投入——均将投入默认为由学生自主决定的中立过程。[[Yajun Zheng|郑雅君]]（2023）的经验材料表明，弱势学生的"不投入"并非个人选择，而是文化语码不适配（大成的"语言包"比喻）和屡次失败后的回避（冰倩的"弃疗"）共同导致的——结构性约束伪装成了个人能力问题
> - Brown 的[[Employability|就业力]]框架虽有洞察力，但将社会性投入完全工具化为就业筹码，可能忽视了社交融入对个人成长和意[[Rightness|义]]建构的非工具性价值（郑雅君，2023）
...
> [!example]
> - 目标掌控者案例：钦凯凭借丰富的求职面试经历提炼出"演绎"能力（情商、印象管理、"转化率"），并在与年长商界[[Jing (Refined Mastery)|精]]英的广泛交往中锻造了面试从容感。经纬通过"尝试—体验—放弃—再尝试"的试错路径最终锚定金融方向。详见 [[Goal-Controlled Mode]]
