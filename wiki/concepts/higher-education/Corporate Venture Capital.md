...
> [!example]
> 部分企业——集中在生物技术和生物制药领域——采用了不同于上述 CVC 模式的"企业孵化器"路径。Eli Lilly 的 Lilly Ventures 和 Johnson & Johnson 的 JLabs 是典型代表：这些企业选择有高潜力的大学研究项目，使用深度参与的孵化模式来加速开发周期，同时锁定母公司未来的价值获取。对于商业化路径极为有限的生物制药研究人员来说，这一模式提供了利用企业庞大资源的机会（p.146）。
