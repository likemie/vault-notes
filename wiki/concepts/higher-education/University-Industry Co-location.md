...
> [!abstract]
> 共同选址包含以下关键属性（[[University Industry Demonstration Partnership|UIDP]], 2019, cited on p.317）：
> - **联合活动与研究**：共同举办学术活动和开展研究项目
> - **双向思想交流**：产业与学术人员之间的双向知识流动
...
> [!example]
> - **联合利华 Hive**：联合利华在荷兰瓦赫宁根大学（WUR）设立的全球食品[[Innovation Hub|创新中心]]，2019 年启用，拥有 18000 平方米的合作空间（包括中试车间、实验室和厨房），约 500 名员工驻校（p.317）
...
> - **Schlegel-UW 老龄化研究所（[[Schlegel-UW Research Institute for Aging|RIA]]）**：滑铁卢大学与 Schlegel Villages 于 2005 年建立的跨学科研究机构，共同选址是其核心运作模式——临床医生、科学家和工程师在同一物理空间中并肩工作，研究者和终端用户只需走过走廊就能看到研究进展的实际应用（Dean et al., 2025, pp.251–253）。详见 [[Schlegel-UW Research Institute for Aging]]
