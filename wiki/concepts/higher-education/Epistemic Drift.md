...
> [!example]
> - **vs [[Scientization of Politics|政策的科学化]]（Scientization of Politics）** — 政策的科学化是认识漂移的制度前提：当政策制定者接受"决策应依据科学证据"时，科学知识获得治理价值，研究者随之获得将[[Research Problem|研究议题]]向政策需求对齐的制度激励。认识漂移是政策的科学化的一个潜在负面后果([[Argument_Zapp_2022_Springer|Zapp, 2022, pp.145–146, 155]])
> - **vs 证据的选择性使用** — 两者同属科学-政治关系恶化的光谱，但主体和机制不同：认识漂移的主体是研究者（供给方），通过主动调整研究议程实现；证据的选择性使用和制造的主体是政策制定者（需求方），通过只引用支持自身立场的证据来实现。认识漂移是第一级退化，证据的选择性使用是第二级退化([[Argument_Zapp_2022_Springer|Zapp, 2022, p.155]])
> - **vs 对科学的公开压制** — 科学-政治关系恶化的第三级和最高级：威权政权直接禁止某些学科研究或压制学术机构（如匈牙利性别研究禁令、中欧大学（Central European University, CEU）被迫迁离）。认识漂移是非强制性的、通过激励结构实现的研究议程转移；公开压制是强制性的、通过行政或法律手段实现的研究活动禁止([[Argument_Zapp_2022_Springer|Zapp, 2022, p.155]])

---
## 概念演变

> [!note]
> 认识漂移的概念由 Elzinga (1997) 提出，最初用于分析科学研究在外部资助条件下的议程变化。[[Argument_Zapp_2022_Springer|Zapp (2022, p.155)]] 将这一概念引入全球治理和高等教育研究领域，将其定位为科学-政治关系三级恶化光谱中的第一级——最隐蔽、最不易被察觉、但可能也是最具系统性的退化形式。

Zapp 将认识漂移与 [[Epistemic Governance|知识治理]] 的内在风险直接关联：知识治理依赖大学和研究者提供权威知识，但正是这种依赖关系创造了研究者将议程对齐治理需求的结构性激励。认识漂移因此不仅是研究者个体的行为偏差，更是知识治理作为一种治理模式的固有张力([[Argument_Zapp_2022_Springer|Zapp, 2022, pp.154–155]])。
...
- **激励结构的系统性偏向**：当政府、国际组织和慈善基金会的资助重点转向特定议题（如 [[UN Sustainable Development Goals|SDGs]]）时，研究者的职业发展路径也随之偏向这些议题。这不是个别现象，而是研究资助体系的结构性特征——研究经费的分配本身就带有议程设置功能([[Argument_Zapp_2022_Springer|Zapp, 2022, p.155]])
