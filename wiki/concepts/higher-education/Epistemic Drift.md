...
> - **vs 对科学的公开压制** — 科学-政治关系恶化的第三级和最高级：威权政权直接禁止某些学科研究或压制学术机构（如匈牙利性别研究禁令、中欧大学（Central European University, CEU）被迫迁离）。认识漂移是非强制性的、通过激励结构实现的研究议程转移；公开压制是强制性的、通过行政或法律手段实现的研究活动禁止
