...
- [[Excellence Initiative (Germany)|德国卓越计划]]（Exzellenzinitiative）和英国研究卓越框架（[[Research Excellence Framework]], REF，前身为 Research Assessment Exercise, RAE）是构建这类市场环境的典型技术([[Argument_Thompson_2022_Promising_Student|Thompson et al., 2022, p.220]])
...
- **Deleuze 的 [[Societies of Control|控制社会]]**：Deleuze（1992）描述了从规训社会向控制社会的转型——调制取代模具、网络取代封闭机构、持续追踪取代一次性考试。竞争力的治理逻辑恰恰体现了这一转型([[Argument_Thompson_2022_Promising_Student|Thompson et al., 2022, pp.221–222]])
