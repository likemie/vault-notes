...
> [!info]
> "有前景的学生"（promising student）是 Thompson、Schröder 和 Wrana（2022）在分析竞争性大学治理时提出的概念，指在高等教育的竞争性地缘政治框架中被期望和建构的一种理想学生主体形态。'Promising' 有双重含[[Rightness|义]]：既指"有前景的"（形容词），也暗示一种"承诺"（名词）——学生被赋予"将来会成功"的承诺，同时也被要求以当下的自我管理来兑现（Thompson et al., 2022, p.221）。
