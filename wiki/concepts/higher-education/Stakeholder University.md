...
> [!info]
> 利益相关者[[The Great Learning|大学]]（stakeholder university）是 Wæraas 和 Solbakk（2009, p.450）提出的概念，指现代大学从传统的学术共同体（academic community）转变为一种多利益相关者的网络节点形态。在这一形态中，学生、教师、政府机构、商业服务提供者乃至自动化计算机代理之间的连接性（connectivity）将大学转化为"地缘政治的机会节点"（node of geopolitical opportunities），可能从根本上改变大学作为学术共同体的本质（Thompson et al., 2022, pp.221–222）。
...
传统[[The Great Learning|大学]]想象以学术共同体为核心——学者和学生围绕知识追求形成相对封闭的、以学科逻辑组织的关系网络。利益相关者大学的转型标志是：大学不再以内部学术关系为组织中心，而是成为一个向多类外部行动者开放的**连接平台**（Thompson et al., 2022, pp.221–222）。
...
> [!abstract]
> Thompson 等人（2022, pp.221–222）将利益相关者[[The Great Learning|大学]]定位为 [[Competitiveness in Higher Education|高等教育竞争力]] 作为地缘政治装置运作的组织条件。关键逻辑链条为：
...
> [!warning]
> - **学术共同体本质的丧失**：当[[The Great Learning|大学]]成为利益相关者平台，学术共同体的核心实践——基于学科逻辑的知识建构、同行审议自主性、学术自由的集体捍卫——可能被利益相关者的多元竞争需求所侵蚀（Thompson et al., 2022, p.222）
