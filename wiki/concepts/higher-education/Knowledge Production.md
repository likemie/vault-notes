...
> [!example]
> - vs [[Knowledge Transfer]] — Partaken 的核心区分：知识生产关注知识"是什么"和"谁在生产"；知识转移关注知识"在被做什么"——知识一旦被生产即进入挪用、传授、窃取、审查、破坏的动态过程。Partaken 批评后殖民 GPK 传统过度关注前者而忽视后者，主张 GPK 的真正核心是知识转移而非知识生产（Partaken, 2022, p.74–75, 84）
...
> [!warning]
> - **"生产 vs 转移"是否构成虚假对立**：Partaken 将知识生产与知识转移呈现为 GPK 的"两面"，但两者在实际中是否可清晰分离存疑——知识在生产过程中已包含转移（合作研究、学术出版），而知识在转移过程中也发生着生产（教学中的知识重构）。Partaken 承认后殖民传统关注知识生产有其历史合法性，但他将两者作为分析范畴对立起来的做法，可能低估了二者的交织程度（Partaken, 2022, pp.72–75）
