...
主协议的价值不在于某一笔研究资金的数额，而在于它如何改变合作的时间成本结构。一个校企合作从初次接触到签署合同，法务审查平均耗时三到九个月。如果每次合作都从头起草协议，三到九个月的窗口足以让企业的预算周期关闭、决策者变更或[[Research Question|研究问题]]过时。主协议把这段延迟压缩到近乎零——后续项目只需签署工作说明书，通常在一到两周内即可启动（pp.107–108）。
