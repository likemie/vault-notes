...
> [!concept-lens] 概念透镜
> - **双重视角** 在**高等教育与科学计量学**中，导师制指向实验室师承网络、科研训练与学术资本积累；在**教学干预与学习科学**中，导师制指向以[[Cognitive Apprenticeship|认知学徒制]]为核心的即时反馈与反思脚手架。
...
>
> 导师制在批判性思维教学中扮演着催化剂的功能；它能极其强劲地放大其他教学策略的效能，但若孤立实施则效果有限。（[[Argument_Abrami_2015_RER|Abrami et al., 2015, p. 298]]）
...
> | **核心目标** | 科学探究训练、学术独立与职业引领 | 学术适应、认知脚手架与情感支持 | 教学质量监控与合规性评估 |
...
> [!ref-table]- 导师制主要下位策略与教学应用索引
> <span class="concept-mentorship-taxonomy-table-marker" aria-hidden="true"></span>
>
> | 策略形态 | 核心机制与实施特征 | 关键实证效应 / 代表[[Document|文献]] | 关联概念条目 |
> |---|---|---|---|
> | **[[Cognitive Apprenticeship|认知学徒制]]** | 导师出声思考示范（Modeling）、实时辅导（Coaching）与支架撤除 | 与真实情境及对话结合实现最高思维增益（$g+=0.57$） | [[Cognitive Apprenticeship]] |
> | **[[Peer Mentoring|同伴导师制]]** | 近同辈提供低焦虑认知支架与经验迁移 | 提升主动探究深度与学术融入度 | [[Peer Mentoring]] |
> | **博士后科研导师制** | 跨领域专业知识整合与独立选题训练 | 博士后导师对受训者长期成就的影响力显著高于博士导师 | [[Argument_Sandrone_2025_MEO|Sandrone (2025)]] |
...
> ```mermaid
> flowchart TD
>     subgraph Science["科学社会化与学术传承 (Sandrone 2025)"]
>         M1["优质导师指导"] --> M2["学术谱系与累积优势"]
>         M1 --> M3["博士后跨学科吸收"]
>         M3 --> M4["知识独立性 (分立主题)"]
>         M4 --> M5["重大原创突破 (诺贝尔奖等)"]
>     end
>     subgraph Instruction["教学认知干预 (Abrami 2015)"]
>         T1["真实性复杂任务 (A)"] --> T3["认知冲突与推理卡点"]
>         T2["对话研讨交流 (D)"] --> T3
>         T4["导师认知学徒指导 (M)"] -- "提供即时支架与示范 (催化)" --> T3
>         T3 --> T5["批判性思维峰值增益 (g+=0.57)"]
>     end
> ```
...
> [!concept-lens] 科学社会化与[[Creativity|创造力]]
> 探讨受训者如何从导师指导走向自主创新。
...
> [!ma-table]- 一阶[[Meta-analysis|元分析]]互补维度亚组（教学认知干预）
