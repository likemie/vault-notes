...
本科层次，[[Argument_Wong_2022_HERD|Wong et al. (2022)]]的四大话语中有两个话语大量涉及沟通与协作：
- **自我意识与[[Lifelong Learning|终身学习]]话语**（89% 覆盖）中的"有效沟通与数字素养"子维度：毕业生应能谈判、参与批判性辩论、清晰表达复杂想法；36% 的大学期望毕业生成为数字设备和在线平台的敏捷使用者（pp.1344–1345）
...
博士层次，沟通与协作是**发展与职场应用差距最大的领域**。[[Argument_SpronkenSmith_2024_AEHE|Spronken-Smith et al. (2024)]]的量化数据显示：团队合作的发展-应用差值为 1.3（发展 2.9 vs. 应用 4.2），口头沟通差值为 0.8（发展 3.7 vs. 应用 4.5）（p.93）。质性数据进一步揭示了两类学科的不同困境：科学学科的毕业生通过实验室研究获得了非正式的团队经验，但缺乏正式的冲突管理培训；HASS 毕业生则连团队工作的机会都缺乏，如历史系博士生 Sara（USU2）只能自行组建同伴小组（pp.95–96）。
...
本科层次，[[Argument_Wong_2022_HERD|Wong et al. (2022)]]的"就业能力与专业发展"话语（75%）中的领导力子维度（28%）包括有效追随力、积极影响与说服、伦理领导、分布式领导；专业知识与商业意识子维度（9%）涉及财务技能、创业精神（pp.1346–1347）。

博士层次，职业发展是最大的结构性缺失。[[Argument_SpronkenSmith_2024_AEHE|Spronken-Smith et al. (2024)]]的数据极其清晰地呈现了这一问题（pp.90–93, 96）：
...
博士毕业生特质的系统化努力始于 Senekal, Munnik, and Frantz（2022）对 35 篇论文的综述，识别出十个领域：知识、研究、沟通、人际、组织、学术声誉、[[Higher-Order Thinking Skills|高阶思维]]、个人资源fulness 和积极公民身份。该综述同时指出，已有研究缺乏[[Global Citizenship|全球公民]]和职业发展维度([[Argument_SpronkenSmith_2024_AEHE|Spronken-Smith et al., 2024, p.87]])。
...
| **沟通（Communication）** | 沟通原则、媒介、[[Language Skills\|语言技能]]、发表、教学与指导、公众参与及政策与企业 |
...
### 本科层次
- [[Argument_Wong_2022_HERD|Wong et al. (2022)]]首次对 UK 大学毕业生特质进行全国性系统映射：Universities UK 137 所成员大学中，76 所（55%）公开列出了毕业生特质（截至 2020 年 1 月）（p.1343）
...
### 博士层次
- [[Argument_SpronkenSmith_2024_AEHE|Spronken-Smith et al. (2024)]]对美新三国 136 名 PhD 校友的调查显示，93.8% 的受访者已就业，其中约 59% 进入学术圈，但学术圈中过半处于固定期合同的不稳定就业状态（pp.92, 99）
