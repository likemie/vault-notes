...
- 由双方人员混合创造的 FIP → 双方共同所有

大学通常不会直接向企业转让 IP 所有权——部分原因是联邦资助法规禁止未经联邦机构明确许可的转让——因此最多提供独家许可（p.276）。
...
> [!example]
> 为缓解产业方对许可定价"被绑架"的担忧，一些大学发展出菜单式选项。明尼苏达大学的 MN-IP Create 项目提供三种 FIP 权利方案（p.283）：

| 选项 | 预付费 | 获得权利 | 额外条件 |
|------|--------|---------|---------|
| A | 赞助研究协议价值的 10% 或 $15,000（取高者） | 排他、可分许可的商业许可 | 年净销售额超 $2000 万时支付 1% 版税 |
| B | 无 | 非商业 NERF 许可 + 6 个月选择权 | 后续协商含版税许可 |
| C | 赞助研究协议价值的 10% 或 $10,000（取高者） | 商业 NERF 许可 + 排他许可选择权 | 后续协商 |

部分协议还包含"意外收获条款"——当许可产品销售额达到特定门槛时，企业向大学支付额外费用，保护大学不因特别有价值的 FIP 而低估其价值（pp.282–283）。
