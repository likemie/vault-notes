...
> [!def] 核心定义
> 研究素养（Research Literacy）指专业人员（如教师与学校管理者）既能够理解与吸收科研成果、又能够保持独立[[Professional Judgment|专业判断]]的能力与德性。Eriksen（2022）提出，专业教学工作本质上是一门充满智慧的专业技艺（craft），研究素养不仅要求教师读懂科研论文，更是一种守护专业独立性与育人责任的德性，在有效性（what works）与适切性（what is appropriate）之间发挥把关与调和作用（[[Argument_Hagevold_Forsstrom_Keles_2026_ERR|Hagevold et al., 2026, p. 4]]；[[Argument_Mausethagen_2025_ERR|Mausethagen et al., 2025, p. 8]]）。

> [!concept-lens] 概念透镜
> - **核心含义** 研究素养既是专业认知能力，更是一种育人德性：它不仅要求能读懂并评估科研论文，更要求能明智判断某项研究是否适合此时此地的具体学情与学生。
> - **理论用途** 帮助研究者理解为什么阅读研究并不等同于能够有效整合研究，以及教师在面对外部科研时为何既不盲从也不全盘排斥。
> - **适用边界** 反对将研究素养降格为单纯的做题或统计技能，也反对将其等同于对科研结论的照单全收；它强调科研证据与实践经验应当平权[[Dialogue in Education|对话]]。

> [!citation-card]- 关键表述
> 研究素养是一种守护专业[[Areas of Knowledge|知识领域]]完整性的德性。它还发挥中介功能，连接有效性的领域与适切性的领域。（Eriksen, 2022，转引自 Hagevold et al., 2026, p. 4）
>
...
> [!boundary]- 概念边界
> - 不等同于 [[Professional Judgment|专业判断]]：专业判断是指教师在具体教学中临场决断的综合能力；研究素养则是指教师如何恰如其分地把外部科研证据纳入这一判断过程中的能力与德性。
> - 不等同于 盲目崇拜科学结论：研究素养恰恰要求教师有底气、有能力对论文结论进行审视，在论文所述成效与对具体学生是否合适之间做出理性的专业权衡。
...
> ```mermaid
> flowchart LR
>     A["研究素养（实践德性与行为构念）"] --> B["守护专业独立性 / 价值认同"]
>     A --> C["专业讲理能力 / 技能与知觉控制"]
>     A --> D["因地制宜灵活性 / 实践应用转化"]
>     B --> E["研究态度与意识"]
>     C --> F["检索、讨论与统计解读技能"]
