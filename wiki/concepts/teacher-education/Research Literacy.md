...
> [!def] 核心定义
> 研究素养（Research Literacy）指专业人员以既吸收研究证据又保持[[Professional Judgment|专业判断]]完整性的方式理解、评估与整合研究的能力与德性。Eriksen（2022）主张把专业工作理解为一种技艺（craft），研究素养是守护专业[[Areas of Knowledge|知识领域]]完整性的德性，并在什么有效的领域与什么恰当的领域之间发挥中介功能（[[Argument_Hagevold_Forsstrom_Keles_2026_ERR|Hagevold et al., 2026, p.4]]；[[Argument_Mausethagen_2025_ERR|Mausethagen et al., 2025, p.8]]）。
...
> [!citation-card]- 关键表述
> "研究素养是一种守护专业知识领域完整性的德性。它还发挥中介功能，连接'什么有效'的领域与'什么恰当'的领域。"（Eriksen, 2022，转引自 Hagevold et al., 2026, p.4）
>
...
> [!contrast-table] 概念辨析
> | 维度 | 研究素养 | [[Teacher Professional Agency\|教师专业能动性]] | 传统研究技能 |
> |------|--------|----------------|------------|
> | **分析对象** | 与研究证据打交道的能力与德性 | 教师行使专业决策权的自主空间 | 检索、统计计算与论文撰写技术 |
> | **核心机制** | 技艺模型下的判断敏感度与知识整合 | 结构条件与信任提供的行动空间 | 机械训练与操作规范积累 |
> | **适用范围** | 专业实践与研究的交界处 | 课程、教学法与评价决策全域 | 具体的研究操作任务 |
...
### 命题一　研究素养让专业实践摆脱"艺术／科学"二分，把研究使用转化为再情境化过程

> [!concept-lens] 专业性技艺模型
...
> | 命题类型 | 核心指向 | 适用情境 | 代表学者 |
> |---|---|---|---|
> | **技艺模型与再情境化** | 研究素养是守护专业完整性的德性，研究使用是判断性再情境化 | 教师与领导者面对研究时的选择、改编与协商 | Eriksen (2022); Mausethagen & Hermansen (2023) |
> | **培养的系统责任** | 技能发展是跨层机制，初始教育与持续专业发展共同塑造研究素养 | 教师教育、学校改进与系统政策 | [[Argument_Hagevold_Forsstrom_Keles_2026_ERR\|Hagevold et al. (2026)]] |
> | **多源知识整合德性** | 破除个体赤字归因，将研究素养确立为多源知识协商与价值裁决能力 | 复杂教学决策、循证课程开发、微观师生互动 | [[Argument_Mausethagen_2025_ERR\|Mausethagen et al. (2025)]] |
