...
> | **证据角色** | 课堂现场个案学童表现 ＋ 外部循证策略 | 听课者的主观印象与经验性评语 | 教师个人教学反思日记与[[Homework\|作业]]表现 | 外部[[Document\|文献]]宣讲，缺乏课堂二次检验 |
> | **评价功能** | 发现教学与学习之间的因果差距以改进教案 | 对执教教师业务水平的科层考核与打分 | 个人实践改善与经验积累 | 教师专业[[Further Education\|继续教育]]学时合规核查 |
> | **运作机制** | 协同设计—试验—微调迭代闭环（JPD） | 单次展示—课后点评—活动终结 | 个人计划—行动—反思单兵闭环 | 集中讲授—各自回校自行摸索尝试 |
...
> [!concept-lens] 制度支撑脱嵌与机会成本代价
> 课例研究并非轻量级工具，缺乏课时减免与高位引领的生硬推行会造成零效应与时间贫困。

> [!claim] [[Argument_Edovald_Nevill_2021_ECNUROE|Edovald & Nevill (2021)]]; Murphy, R. et al.
> **移植阻抗与时间替代代价** 当一种深度依附于东亚集体主义文化与制度化教研保障的教育[[Paradigm|范式]]被生硬植入高度问责且课时繁重的西方学校时，课例研究往往沦为“耗费大量教师精力、制造了高度协作满意假象，却未能穿透微观学科认知”的表层形式主义活动，甚至因占用教师日常备课和个别辅导时间对学生产出构成无形挤占。（p. 56）
...
>
> > [!axis] 内部[[Peer-Supported Learning|同伴互助]] vs 外部权威引领（Kōshi）
...
> [!case] 案例：英国 Dudley 课例研究模式[[Going Native|本土化]]探索
> 在英国中小学本土化推广中，达德利（Pete Dudley, 2013）开发了强调跟踪“个案学童”（Case Pupils）的课例研究操作指南。三名教师组成课例小组，在集体备课后选择具有不同学习特质的 3 名学生作为聚焦点。在公开授课环节，观课教师不记录全班通识纪律，而是专职记录这 3 名学童在面对特定任务时的困惑表情、言语互动与解题步骤；课后反思会基于这些微观证据重构教案并由另一位教师在平行班执教。该模式为西方教师提供了结构化的微观学情观察工具，成为英格兰最广泛应用的课例[[Paradigm|研究范式]]。
...
> | [[Teacher Knowledge Base]] | 知识基础 | 课例研究旨在深化教师关于特定学生认知障碍的微观学科教学知识（PCK）。 |
