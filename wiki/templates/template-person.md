...
> - **代表贡献**：1–3 个最重要的贡献，优先 wikilink 到 Concept / Theory / Method / Fact。
> - **阅读边界**：本页关注此人的哪一面，例如教育哲学、政策社会学、研究方法论或公共争议。
...
> | 维度 | 条目 | 贡献说明 |
> |------|------|----------|
> | 概念 | [[Concept]] | 此人如何提出、改造或传播该概念。 |
> | 理论 | [[Theory]] | 此人如何提供解释框架或理论传统。 |
> | 方法 | [[Method]] | 此人如何改变研究设计、测量、分析或证据综合方式。 |
> | 制度／政策 | [[Fact]] | 此人如何影响政策、组织、标准、课程或公共话语。 |

%% 只写有真实贡献的维度，无贡献的行删除。每行必须说明贡献关系，不只是列出关联条目。 %%
...
> [!tension] 争议焦点
> - **争议对象**：理论、方法、政策角色、商业关系、政治立场或解释边界。
> - **批评立场**：谁从什么立场提出批评。
> - **证据依据**：文本、数据、政策后果、方法问题还是伦理风险。
