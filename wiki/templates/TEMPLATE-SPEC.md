...
- `## 贡献地图` 使用 `[!contribution-map]`，以表格形式（维度 / 条目 / 贡献说明）把概念、理论、方法和制度／政策影响链接到具体 Concept / Theory / Method / Fact；没有贡献的维度删除对应行。
...
- `## 核心思想` 使用 `[!claim]` 写可争辩的核心论断，用 `[!citation-card]-` 收录关键表述；不另列概念工具（已在贡献地图呈现）。
