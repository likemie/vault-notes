...
> [!implication] 论证后果
> - **理论后果**：本文如何改变概念、理论或解释框架。
> - **方法后果**：本文对材料、证据或研究设计有什么启发。
> - **实践后果**：本文对政策、学校实践或未来研究有什么意义。
...
> [!implication]- 发现的意义
> - **概念层面**：这些发现如何改变对核心概念的理解。
> - **经验层面**：这些发现说明材料、案例或样本中的什么模式。
> - **研究层面**：这些发现为后续研究留下什么问题。
...
> [!tension] 主要张力
> 说明本文论证中仍然存在的理论张力、证据张力或规范张力。

> [!critique-method]- 方法边界
> - 原文或后续阅读中可以明确指出的方法限制。

> [!conclusion] 批评性裁定
> 用一两句话说明本文最值得保留的贡献，以及最需要谨慎使用的边界。
