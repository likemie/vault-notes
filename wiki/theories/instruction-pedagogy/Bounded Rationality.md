...
> [!info] 核心主张
> 有限理性（Bounded Rationality）是 Herbert A. Simon（1969/1996）在 *The Sciences of the Artificial* 中提出的理论，其基本主张是：专业任务如教学不是可以在输入-输出模型中概念化的简单任务，而是**复杂任务**。复杂专业任务的共同特征是：**任务的复杂性大于专业人员的实践能力**（Qvortrup, 2019, p.6）。
>
...
> [!abstract] 理论内部结构
> - **复杂性的不可化约性**：专业任务的复杂性不是可以通过更好的知识或更优的技术消除的临时问题，而是结构性条件
> - **理性赤字的永久性**：专业人员始终在理性赤字的条件下工作——他们不可能拥有做出"完全理性"决策所需的所有信息
> - **反馈作为修正机制**：应对有限理性的基本工具不是更多的预先规划，而是使用反馈作为持续的修正机制（Qvortrup, 2019, p.6）
>
...
> - 与教育学的关系：Qvortrup (2019) 将有限的理性与 Luhmann & Schorr 的"技术赤字"概念并置，共同构成专业判断的理论基础

## 争议与批评

> [!warning] 争议与批评
> - 有限理性理论虽然挑战了完全理性假设，但仍在理性选择框架内运作——更激进的理论（如 Luhmann 的系统理论、实践认识论）可能从根本上质疑"理性"作为理解专业实践的核心概念

## 应用领域

> [!success] 应用领域
> - [[Professional Judgment]] — Qvortrup (2019) 将有限理性作为专业判断的核心理论基础
> - [[Visible Learning]] — Qvortrup 运用有限理性解释为何 Hattie 的效应量提供的是概率信息而非因果食谱
