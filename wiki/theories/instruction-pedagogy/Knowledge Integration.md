...
> - **边界** 聚焦于复杂因果机制与质性科学概念的深层建构，区别于单纯追求运算熟练度的事实识记教学；区别于放任自流的[[Discovery Learning|纯发现学习]]，强调外源认识论支架的介入。
...
为精细刻画学生科学解释从碎片化走向整体融通的发展轨迹，Linn 团队建立了标准化的 5 级知识整合量规，该量规在学习科学界被广泛采纳并与自然语言处理（NLP）自动评分技术紧密整合：
