...
该理论是在 Rotter 的 [[Locus of Control]] 理论基础上的进一步发展。Weiner 将 Rotter 的单一控制点维度扩展为三个独立且相互作用的因素（Li, 2012, p.61）。
...
以能力和努力这两个最常见的归因为例：二者同为内部来源，但在稳定性和可控性上不同。努力通常被认为是可控的，但在不同任务间不稳定；能力则通常被视为稳定但相对不可控的因素（Li, 2012, p.61）。
...
> [!success]
> Weiner 的理论激发了大量研究，记录了与三个归因维度相关的具体情感（Li, 2012, p.61）：
