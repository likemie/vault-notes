...
> [[Jean Piaget|皮亚杰]]理论的核心命题围绕认知结构的建构机制与阶段性特征展开，并与脑-认知平行发育模型相整合：
> 
> - **命题一：[[Constructivist Paradigm|建构主义]]的知识建构机制 (Constructivism)**  
...
>   认知发展阶段的质变过渡，在物理层面上受到大脑[[Prefrontal Cortex|前额叶皮层]] (PFC) 解剖生理发育（包括[[Synaptogenesis|突触发生]]、[[Synaptic Pruning|突触修剪]]和[[Myelination|髓鞘化]]）的约束，并通过[[Executive Function|执行功能]] (EF) 的三核心成分（抑制、转换、更新）的逐步成熟与整合来具体表征 [[Argument_Bolton_2017_ArchPsych|(Bolton & Hattie, 2017, p. 8, p. 13)]]。
...
> 经典[[Jean Piaget|皮亚杰]]认知发展阶段可以通过**[[Prefrontal Cortex|前额叶皮层]] (PFC)** 的神经解剖发育特征和 **[[Executive Function|执行功能]] (EF)** 的行为测试表现进行精确对齐和解释。这四个发展阶段在物理和认知层面的对齐机制如下：
> 
> ```mermaid
> flowchart TD
...
> [!example] 理论的应用与对齐研究
> - [[Argument_Bolton_2017_ArchPsych]] — 对齐了[[Jean Piaget|皮亚杰]]认知发展阶段与[[Prefrontal Cortex|前额叶皮层]] (PFC) 生理发育及[[Executive Function|执行功能]] (EF) 发展轨迹的[[Literature Review|文献综述]]，论证了认知过渡的脑神经与执行功能基础。
