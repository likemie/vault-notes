---
title: Technological Trajectories
aliases:
  - "技术轨迹"
...
> [!info]
> [[Argument_Pavitt_1984_RP|Pavitt (1984)]]识别了塑造技术轨迹的三个基本因素：

> [!line-a] 技术来源（Sources of Technology）
> 不同产业依赖不同的知识基础。科学基础型（电子、化学）依赖基础科学和大学研究，通过内部研发产生创新。专业化供应商（机械工程、仪器）依赖设计能力和与客户的持续互动。规模密集型（金属制造、汽车）依赖生产工程和大规模设施运营经验。供应商主导型（纺织、农业）依赖外部设备供应商。

> [!line-a] 用户需求（Requirements of Users）
> 不同产业的用户对创新提出不同类型的要求。专业化供应商的用户需要定制化的、能解决特定生产问题的设备。规模密集型企业需要能显著降低单位成本或提高产能的流程创新。科学基础型企业的用户对产品性能有持续提升的要求，对成本的敏感度相对较低。

> [!line-a] 专有可能性（Possibilities for Appropriation）
> 不同产业保护创新收益的能力根本不同。科学基础型企业可以通过专利、先发优势和产品差异化保护创新收益。专业化供应商通过保密、设计复杂性和客户关系保护专业知识。供应商主导型企业难以从创新中获得独占收益，其竞争优势来自价格和交付效率而非技术独占。
...
[[Pavitt Taxonomy|Pavitt 分类法]]的三类产业分别对应三种典型的技术轨迹：
- **供应商主导型** 轨迹由外部设备供应商的技术进步驱动，创新以流程改进为主，累积性较弱
...
[[Argument_Bogliacino_Pianta_2016_EP|Bogliacino & Pianta (2016)]]后来通过主成分分析将这三类轨迹[[Operationalization|操作化]]为两个统计维度：成本竞争力（cost [[Competitiveness]]）和技术竞争力（technological competitiveness），为技术轨迹概念提供了定量验证。
