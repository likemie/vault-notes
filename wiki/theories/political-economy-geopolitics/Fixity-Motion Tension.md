...
> - [[Hub and Flow Imaginaries]] 是该张力的**意识形态表达**：枢纽代表固着的需求（锚定资本的地点），流动代表资本的全球移动性。这些想象将固着-流动张力[[Transfer Translation Transformation|转化]]为"自然的"世界图景
...
> [!warning] 争议与批评
> - Harvey 的理论框架高度抽象，在具体经验研究中的操作化面临挑战——如何将"固着-流动张力"[[Transfer Translation Transformation|转化]]为可经验检验的假设，仍然是一个开放的方法论问题
