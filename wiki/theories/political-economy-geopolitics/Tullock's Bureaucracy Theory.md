...
> [!abstract] 信息失真（Information Loss）
> 无论向上汇报或向下传达，信息逐级必然因解读错误、时间[[Jing (Refined Mastery)|精]]力限制被省略或扭曲。这是 Tullock 模型中**不可消解的结构特征**，不是管理技术可解决的。
>
> > 例：一位教育部长无法直接了解全国每一间教室的教学质量——信息从教师→科主任→校长→学区督导→教育部官员→部长，每一层级都必须对信息进行概括、筛选和翻译。当部长最终读到"全港通识教育科教学成效报告"时，她看到的是经过 5 层过滤的汇总数据，而非任何一间教室的实际教学。同理，当部长的决策（"强化国民教育元素"）向下传达时，每一层级都会根据自己的理解重新解读——最终教师收到的指令可能已与部长的原意有系统性偏差。Cowen (2019, pp. 6–7) 强调，这种信息损失是层级制本身的**结构性特征**，无法通过更好的管理技术消除。


> [!abstract] 主权者的应对策略
> Tullock (2005) 提出了四类策略，各有取舍：
>
> | 策略 | 优势 | 劣势 |
> |------|------|------|
...
> [!abstract] 专家委托的额外困境
> 当主权者不清楚最优政策方向时，须委托专家制定政策。专家带来三个新问题（Cowen, 2019）：
>
> 1. **专家分岐** — 主权者无法判断谁对
>
> > 例：Cowen (2019, pp. 7–8) 指出，当教育部长面对一组专家说"小班教学有效"而另一组专家说"小班教学无效"时，部长本身不具备判断哪方方法论更可靠的专业能力——这正是 Tullock 描述的"知识问题"在专家委托中的体现。主权者最终可能依据非认知标准（专家的声望、政治立场、建议的可操作性）来选择信任哪一方——这恰好解释了为什么 [[Evidence-Based Education|EBE]] 的 [[Randomised Controlled Trials|RCT]] 层级对主权者有吸引力：它承诺通过"方法论的客观标准"来替代主权者对专家资质的判断。
>
> 2. **解释困难** — 专家建议难以翻译为可执行的指令
>
> > 例：一位教育研究者可能建议"通过形成性评估提升学生元认知能力"，但这需要翻译为教师可执行的具体课堂行为（何时评估？如何[[Feedback|反馈]]？）。每一层级的翻译都可能引入信息失真——最终教师可能实施了"频繁测验"（将形成性评估误解为更多考试），而非研究者原意中的"以反馈促学习的评估循环"。（编者类比，基于 Cowen, 2019, pp. 6–7 对信息损失的分析）
>
> 3. **动机偏差** — 专家可能有不同于主权者的价值承诺
>
> > 例：Cowen (2019, p. 8) 指出，教育研究者可能更重视方法论严谨性（发表压力、学科规范）而非政策实用性——一位研究者可能花 3 年完成一项完美的 RCT，但教育部长需要的是 6 个月内的决策依据。此外，研究者可能有意识形态承诺（如对进步教育的承诺），使他们倾向于推荐符合其价值立场的干预，而非在特定情境下最有效的干预。
...
> - **2019** — Cowen 将 Tullock 模型扩展至 [[Evidence-Based Education|EBE]]，从公共选择角度解释实验研究范式为何占据主导
...
> [!info] 研究范式
> - **认识论立场**：方法个体主[[Rightness|义]]（methodological individualism）+ [[Bounded Rationality|有限理性]]（bounded rationality）
...
> - **Cowen (2019) 的回应**：Cowen 承认 Tullock 模型是简化，但认为这一简化具有分析价值——即使在分散决策系统中，每个决策层级内部仍面临 Tullock 描述的"知识问题"：部长无法了解所有学校、校长无法了解所有课堂。主权者隐喻在分析上是可分层应用的（编者概括，基于 Cowen, 2019, pp. 5–7）
>
> **目前状态**：主权者隐喻的简化程度在公共选择传统内部也被持续讨论。但 Cowen 论证，即使放宽这一假设，Tullock 的核心洞见（知识问题而非自利问题是官僚制的根本挑战）仍然成立。


> [!warning] 对非认知因素的排除：激励冲突与知识问题并存
> **争议背景**：Tullock 有意搁置自利动机（区别于 Niskanen 的预算最大化模型）以突出纯粹认知挑战——"即使所有官僚真诚追求共同善，知识问题依然存在"。但批评者指出，真实官僚系统中认知约束与激励冲突并存且交互——一个信息失真问题的根源可能同时来自"不知道"和"不想知道"。
>
> **各方立场**：
> - **批评立场**：Dunleavy (1991) 的官僚 career-driven 模型提供了反例——官僚的信息过滤行为不仅出于认知限制，更出于职业晋升考量（选择性地向上级呈现有利数据）。单纯的知识问题模型无法解释这种策略性信息操纵。
> - **Cowen (2019) 的认可**：Cowen 并未声称 Tullock 模型是完整的——他将其定位为对 Niskanen 自利模型的补充而非替代。知识问题和激励问题在经验上交织，但分析上区分有助于理解 [[Evidence-Based Education|EBE]] 的吸引力：即使决策者真诚追求教育改善，他们仍会选择 [[Randomised Controlled Trials|RCT]]/系统综述作为透明的过滤机制。（编者概括，基于 Cowen, 2019, pp. 5–8）
>
> **目前状态**：此张力在公共选择文献中尚未解决。Cowen 的贡献在于论证了纯粹知识问题视角对理解 EBE 制度韧性的独特解释力。


> [!warning] 系统性解释的局限：为什么是现在？
> **争议背景**：Cowen (2019) 承认 Tullock 模型只能对"为什么 EBE 在此时（21 世纪初）而非其他时期占据主导"提供尝试性假说——英国中央化教育改革、行为经济学的兴起等。该模型擅长解释 EBE 的**制度功能**（它为决策者解决了什么问题），但不擅长解释 EBE 的**历史时机**（为什么此刻出现）。
>
> **各方立场**：
> - **Cowen (2019) 的自我限定**：Cowen 明确表示仅提供"尝试性假说"而非确定解释。他指向两个可能的外部因素——英国 1988 年以来的中央化教育改革（创造了需要"远程控制"学校的主权者）和行为经济学的兴起（提供了 RCT 方法论的技术合法性）。
> - **可能的扩展方向**：将 Tullock 模型与[[Policy Borrowing|政策借用]]框架（Steiner-Khamsi, 2012）或历史制度主[[Rightness|义]]结合——前者解释时机（为什么是现在），后者解释功能（解决了什么问题）。
>
> **目前状态**：此局限尚未被后续研究系统填补。Cowen 的框架更多被用作分析 EBE 制度功能的工具，而非预测政策变迁时机的理论。

## 应用领域

> [!success] 应用领域
> - [[Evidence-Based Education]] — Cowen 用 Tullock 框架解释 EBE 的官僚功能
> - 教育问责制设计
> - 公共部门改革的政治经济学分析
