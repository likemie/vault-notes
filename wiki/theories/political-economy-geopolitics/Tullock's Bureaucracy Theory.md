...
> 例：Cowen (2019, pp. 7–8) 指出，当教育部长面对一组专家说"小班教学有效"而另一组专家说"小班教学无效"时，部长本身不具备判断哪方方法论更可靠的专业能力——这正是 Tullock 描述的"知识问题"在专家委托中的体现。主权者最终可能依据非认知标准（专家的声望、政治立场、建议的可操作性）来选择信任哪一方——这恰好解释了为什么 EBE 的 RCT 层级对主权者有吸引力：它承诺通过"方法论的客观标准"来替代主权者对专家资质的判断。

2. **解释困难** — 专家建议难以翻译为可执行的指令

> 例：一位教育研究者可能建议"通过形成性评估提升学生元认知能力"，但这需要翻译为教师可执行的具体课堂行为（何时评估？如何反馈？）。每一层级的翻译都可能引入信息失真——最终教师可能实施了"频繁测验"（将形成性评估误解为更多考试），而非研究者原意中的"以反馈促学习的评估循环"。（编者类比，基于 Cowen, 2019, pp. 6–7 对信息损失的分析）
...
- **2019** — Cowen 将 Tullock 模型扩展至 EBE，从公共选择角度解释实验研究范式为何占据主导
...
- **认识论立场**：方法个体主义（methodological individualism）+ 有限理性（bounded rationality）
- **所属传统**：公共选择理论（Public Choice）、奥地利经济学知识问题传统（Hayek, 1945）

## 争议与批评

### 主权者隐喻的局限：真实政治系统中的分散决策
...
- **Cowen (2019) 的认可**：Cowen 并未声称 Tullock 模型是完整的——他将其定位为对 Niskanen 自利模型的补充而非替代。知识问题和激励问题在经验上交织，但分析上区分有助于理解 EBE 的吸引力：即使决策者真诚追求教育改善，他们仍会选择 RCT/系统综述作为透明的过滤机制。（编者概括，基于 Cowen, 2019, pp. 5–8）
...
- **可能的扩展方向**：将 Tullock 模型与政策借用框架（Steiner-Khamsi, 2012）或历史制度主义结合——前者解释时机（为什么是现在），后者解释功能（解决了什么问题）。
