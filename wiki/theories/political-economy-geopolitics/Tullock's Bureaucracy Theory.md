...
> 无论向上汇报或向下传达，信息逐级必然因解读错误、时间精力限制被省略或扭曲。这是 Tullock 模型中**不可消解的结构特征**，不是管理技术可解决的。
>
...
>
> > 例：一位教育研究者可能建议"通过[[Formative Assessment|形成性评估]]提升学生元认知能力"，但这需要翻译为教师可执行的具体课堂行为（何时评估？如何[[Feedback|反馈]]？）。每一层级的翻译都可能引入信息失真——最终教师可能实施了"频繁测验"（将形成性评估误解为更多考试），而非研究者原意中的"以反馈促学习的评估循环"。（编者类比，基于 Cowen, 2019, pp. 6–7 对信息损失的分析）
>
...
> - **可能的扩展方向**：将 Tullock 模型与[[Policy Borrowing|政策借用]]框架（Steiner-Khamsi, 2012）或历史制度主义结合——前者解释时机（为什么是现在），后者解释功能（解决了什么问题）。
>
