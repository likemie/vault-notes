...
治理术分析的核心关注是主体化（subjectification）——权力如何将个体"制造"为特定类型的主体。治理不是简单地对既有主体的行为加以限制，而是通过提供特定的身份范畴、理想标准和自我实践模板，使人们主动将自己塑造成符合治理需要的形态（Thompson et al., 2022, p.226）。

在 Ch13 的分析中这一命题体现在两个层面：
- "[[Promising Student|有前景的学生]]"（[[Promising Student]]）不是被"发现"的天赋主体，而是通过 OSA 等自我技术被"呼唤"出来的主体形态（Thompson et al., 2022, p.221）
- 学生的学业成功被重构为个人自我管理的责任——治理术将结构性问题（教育资源不平等、学校分流效应）转化为个体需自行弥补的"差距"（Thompson et al., 2022, pp.226–227）
...
> [!info]
> - **本体论与认识论立场**：治理术属于后结构主[[Rightness|义]]认识论传统——拒绝权力/自由的二元对立，将治理视为一种"在自由中的治理"；拒绝将主体视为权力的被动承受者，而是关注权力如何积极地"生产"主体
> - **常用分析方法**：话语分析、政策文本分析、非参与式[[Observational and Correlational Research|观察]]

## 争议与批评

> [!warning]
> - **过度强调自我技术**：批评者指出治理术分析可能过于聚焦个体自我实践，忽视了强制性权力和物质不平等在治理中的持续作用（Thompson et al., 2022, p.227）
> - **历史特殊性**：治理术概念源于西欧自由主[[Rightness|义]]传统，应用于非自由主义语境时需要警惕理论移植的局限性
