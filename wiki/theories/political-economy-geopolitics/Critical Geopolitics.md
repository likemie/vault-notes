...
> - **谨慎使用** 需要补充物质权力分析（大国竞争中的军事和经济维度）；需要额外证据支持话语后果的经验验证——[[Discourse Analysis|话语分析]]不应替代对制度运作和资源分配的实际考察。
> - **不适合解释** 军事冲突的直接因果机制；技术封锁和出口管制的具体操作逻辑；纯粹的经济利益计算——这些更适合[[Classical Geopolitics|古典地缘政治]]或政治经济学框架。
...
> [!critique] 批评索引
> - **话语中心主义与物质权力分析的张力** 分析焦点集中在话语和象征层面，对物质权力结构（军事力量、领土控制、技术封锁）的直接分析能力较弱。在大国竞争回归的背景下，仅靠[[Discourse Analysis|话语分析]]难以充分解释高等教育面临的安全化和脱钩等现实。[[Argument_Yu_Xie_2025_JHE|(余婧然和谢爱磊, 2025, pp. 12–13)]]
