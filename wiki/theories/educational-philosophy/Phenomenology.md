...
> - [[Argument_Cohen_Manion_Morrison_2011_Routledge_Ch21|Cohen et al., 2011, Ch. 21]] — 详细介绍了 Hycner（1985）将现象学原理应用于访谈数据分析的 15 步操作程序，包括[[Epoché|悬置]]、意义单位划定、聚类、主题化和综合摘要，是现象学作为[[Qualitative Research|质性研究]]方法的具体操作指南；第29章在系统性数据分析框架内再次介绍该程序。
