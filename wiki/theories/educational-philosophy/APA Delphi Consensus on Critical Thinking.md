---
title: APA Delphi Consensus on Critical Thinking
aliases:
  - 德尔菲专家共识
  - 德尔菲批判性思维共识
  - 德尔菲批判性思维共识框架
  - Delphi Report on Critical Thinking
...
> - **前提二** 实证干预显示，教学干预能够同时显著促进技能（$g+ = 0.30$）与倾向（$g+ = 0.23$），且当融入[[Mentorship|导师制]]时，倾向的获得达到最高峰值（$g+ = 0.38$）（Abrami et al., 2015）。
...
> [!ma-table]- Abrami et al. (2015) 基于德尔菲双元框架的[[Meta-analysis|元分析]]实证成果
