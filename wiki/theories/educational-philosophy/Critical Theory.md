...
> - **作为分析工具**：追问"谁的知识""服务于谁的利益""谁从现状中受益"——将课程文本、政策[[Document|文件]]、学校制度视为意识形态文本进行解读。
...
> - **谨慎使用**：需要补充经验证据来检验"批判→解放"的[[Causality|因果]]链；仅有理论批判而无经验检验时容易停留在思辨层面。
> - **不适合解释**：不直接提供技术性的教学设计或[[Classroom Management|课堂管理]]策略；其规范性主张需要经验验证。
> - **常见误用**：将批判理论等同于简单的"揭露问题"，忽视了它同时要求提出变革议程和验证变革效果的实践维度。
...
> - **[[Ideology Critique|意识形态批判]]与解放之间的[[Causality|因果]]链不清晰**（Morrison, 1995a）：一个人或社会是否仅通过意识形态批判就能获得解放，是经验问题而非逻辑必然。
