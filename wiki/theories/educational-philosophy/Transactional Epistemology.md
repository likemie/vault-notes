...
> | 维度 | 表象认识论 | 交易认识论 |
> |------|----------|----------|
> | 知识是什么 | 外部世界的[[Jing (Refined Mastery)|精]]确反映 | 行动与后果的关系 |
> | 认知者角色 | 旁观者 | 参与者 |
> | 实验的角色 | 对现实的扭曲 | 认识现实的必要手段 |
> | 知识的时间性 | 延伸到未来（确定性） | 限定于过去（可能性） |
> | 对"什么有效"的含[[Rightness|义]] | 过去有效的未来也有效 | 过去有效的**可能**未来有效 |


> [!abstract] 关键推论
> 1. **知识的结构性不完整**：因为我们通过介入来认识世界，而介入会改变世界——完整的、静态的"世界本身"永远不可知
>
> > 例：教师无法通过"不介入"来了解一个班级的学习状态——一旦开始教学（介入），学生的反应就已经是在教师影响下的反应了。教师永远不会知道这个班级"本来"是什么样子，只能知道"在我的教学下"学生如何反应。（编者类比，基于 Biesta, 2010, pp. 494–495 对实验介入的认识论分析）
> 2. **确定性不可能**：交易认识论能提供"有依据的断言"（warranted assertions）而非"确定性"（certainty）
>
> > 例：一位教师去年用"同伴互评法"有效提高了学生的写作能力，但她不能因此断言该方法"确定有效"——去年有效只是提供了"有依据的断言"（warranted assertion），表明该方法在过去的情境下产生过这种关系。今年面对不同的学生群体，这一知识提供的是假设（hypothesis），而非确定性。（编者类比，基于 Biesta, 2010, pp. 494–495 关于 warranted assertions 与 certainty 的区分）
...
> - **1983** — Bernstein 在 *Beyond Objectivism and Relativism* 中重新阐释 Dewey 的认识论，挑战客观主[[Rightness|义]]/相对主义的二元对立
...
> [!info] 研究范式
> - **认识论立场**：实用主[[Rightness|义]] —— 超越现实主义/建构主义的二元对立，既不主张知识是对客观现实的反映，也不主张知识是纯粹的主观建构
> - **常用方法**：[[Philosophical Analysis in Education|哲学分析]]、概念分析

## 争议与批评

> [!warning] 相对主[[Rightness|义]]指控
...
>
> **目前状态**：此哲学争议在教育研究领域持续；Ercikan & Roth (2006) 以及 Maxwell (2004) 在[[Mixed Method and Multi-method Research|混合方法]]文献中提供了折中方案——承认知识的交易性但不放弃跨情境比较。


> [!warning] 对科学实践的描述是否准确
> 批评者指出，即使交易认识论在哲学上成立，科学家和教师在实践决策中实质上使用"表象认识论思维"——他们会说"研究显示 X 有效"，而不是"研究显示 X 过去在这种情况下产生过这种关系"。
>
> **目前状态**：此张力指出了[[Philosophical Analysis in Education|哲学分析]]和实践决策之间的不[[Matching|匹配]]——哲学家（如 Biesta）追求概念[[Jing (Refined Mastery)|精]]确性，实践者（如教师）需要可操作的启发式——两者可能永远无法完全对齐。


> [!warning] 实操意义不明
> 交易认识论对教育研究的具体方法论指引不够清晰：是否仍应进行实验？如果是，应如何不同地设计和解读实验？Biesta 在本文中的回答停留在哲学层面（"继续做研究但改变你的解读"），未提供方法论层面的操作指南。
>
> **目前状态**：Cartwright & Hardie (2012) 在 *Evidence-Based Policy: A Practical Guide to Doing It Better* 中提供了交易认识论视角下如何进行政策评估的操作性建议，部分回应了这一批评。
...
> - Biesta & Burbules (2003) — 全面阐述交易认识论对教育研究的意[[Rightness|义]]
