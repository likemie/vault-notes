...
> | 言语行为（Speech Act） | 概念 | 论证的基本[[Unit of Analysis\|分析单位]]。语用辩证法将论证中的每一步都视为特定的言语行为，并考察它们在分歧解决过程中的功能。 |
...
> - **前提一** 修辞学传统关注"在特定情境中发现可用的说服手段"（[[Aristotle|亚里士多德]]），这使论证者倾向于选择对自己最有利的论据和表达方式。
