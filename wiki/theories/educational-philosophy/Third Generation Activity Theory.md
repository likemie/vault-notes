...
> |---|---|---|
> | **主体（Subject）** | 理论要素 | 参与活动系统的个人或群体，如背负问责压力与改革期待的教师、使用智能工具的学生。 |
> | **客体（Object）** | 理论要素 | 活动系统所指向的意图、目标与动机，如提升考试成绩、推行探究教学或培养[[Higher-Order Thinking Skills\|高阶思维]]。 |
> | **中介工具（Mediating Tools）** | 理论要素 | 主体用于达成客体的符号与物质人工制品，如讲授法、测试卷、[[Dialogue in Education\|对话]]研讨或 [[Generative Artificial Intelligence\|ChatGPT]]。 |
> | **共同体（Community）** | 理论要素 | 主体所嵌入的社会关系网络，如家长、教育主管部门、教师同行、人机协作学习共同体。 |
> | **规则（Rules）** | 理论要素 | 规范活动系统运行的显性或隐性制度，如绩效考核、升学考试规定、学术诚信与提示词追踪规制。 |
> | **劳动分工（Division of Labor）** | 理论要素 | 共同体内成员之间的任务分配、权力结构与人机认知分工机制（如人类负责反思裁决，AI 负责发散初筛）。[[Argument_Wang_2025_CE\|(Wang & McLaughlin, 2025, p. 590)]]; [[Argument_Li_2026_CEAI\|(Li et al., 2026, p. 11)]] |
> | **矛盾（Contradictions）** | 解释机制 | 活动系统内部或系统之间出现的结构性张力（初级至四级矛盾），是触发变革与创新的根本动力。[[Argument_Wang_2025_CE\|(Wang & McLaughlin, 2025, p. 591)]] |
> | **边界跨越（Boundary Crossing）** | [[Praxis\|实践]]过程 | 行动者进入[[Heterogeneity\|异质性]]活动系统、引入外部中介工具并协商新含义的实践过程。 |
> | **共享客体（Shared Object）** | 核心概念 | 多个活动系统相遇时协商建构的共同意图，如将 LCE 解码为攻克高阶考题，或将 AI 整合定义为自适应专业特长培养。[[Argument_Wang_2025_CE\|(Wang & McLaughlin, 2025, pp. 598–600)]]; [[Argument_Li_2026_CEAI\|(Li et al., 2026, p. 12)]] |
> | **[[Boundary Object\|边界对象]]（Boundary Object）** | 理论概念 | 兼具结构鲁棒性与情境可塑性的人工制品（如 ChatGPT、跨学科探究量规），在中介不同共同体与学科对话中发挥中继连接功能。[[Argument_Li_2026_CEAI\|(Li et al., 2026, pp. 2, 12)]] |
> | **扩展性改造（Expansive Transformation）** | 核心成果 | 当共享客体确立后，活动系统要素发生的全面协同重组与文化升级，形成质变后的新实践形态。[[Argument_Wang_2025_CE\|(Wang & McLaughlin, 2025, pp. 600–602)]] |
...
> - **前提二** 学校通过将 LCE 的探究对话机制与中国儒家启发式教学传统及高考高阶解题能力建立[[Selective Affinity|选择性亲和]]（Selective Affinity），提炼出“以探究赋能应试”的学校特定共享目标。
...
> - **前提二** 单纯的“技术接纳”或“机械禁令”属于失效的工具中心论，必须将教学客体升级为“自适应专业特长（Adaptive Expertise）与高阶心智协同”。
> - **推导** 教学活动系统必须实施全面扩展性改造：
>   ① **中介工具** ChatGPT 重塑为分布式知识中继节点与[[Boundary Object|边界对象]]；
...
> - **[[Epistemology|认识论]]摩擦维持推论（源自命题二与命题五）** 在高度智能化的工具中介活动中，系统必须在规则与任务设计中主动引入“[[Epistemic Friction|认识论摩擦]]”（Epistemic Friction），人为制造良性认知张力，防止分工过度外包导致的主体反思能力萎缩。[[Argument_Li_2026_CEAI|(Li et al., 2026, p. 10)]]
> - **结构性硬边界制约推论（源自命题三与命题四）** 共享客体的建构受制于宏观制度的权力不对等；在强问责系统中，扩展性改造往往优先吸纳技术性中介手段，而将权力共享（如学生共决考核标准）排斥在系统边界之外。[[Argument_Wang_2025_CE|(Wang & McLaughlin, 2025, pp. 601–603)]]
...
> [!exegesis]- 教育研究例子
> 
> **案例一：跨国教学改革与高利害考试的系统[[Transfer Translation Transformation|转译]]（[[Argument_Wang_2025_CE|Wang & McLaughlin, 2025]]）**
...
> - **不能直接推出的东西** 本理论不能直接证明纯粹微观神经心理层面的因果反应，不能[[Hypothesis|假设]]共享客体的建构必然自动带来完美和谐（可能存在权力遮蔽），更不能将“矛盾”简化为机械的[[Independent Variable|自变量]]与[[Dependent Variable|因变量]]关系。

> [!theory-use] 理论使用方式
> - **作为[[Analytic Framework|分析框架]]** 用于解构复杂组织变革与跨文化[[Policy Borrowing|政策借用]]（如学校如何应对双重问责与改革压力）。
> - **作为干预与诊断工具** 定位技术引入或课程改革中的系统失调点（如仅更新中介工具而考核规则与劳动分工滞后导致的改革卡顿）。
> - **作为人机协同生态重塑的顶层设计蓝图** 为人工智能教育应用提供超越“技术接纳/禁用”二元对立的规制设计工具（工具、规则、分工、共同体协同推进）。
