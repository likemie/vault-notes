...
>
> 这一立场的认识论后果是：知识被视为静态范畴，通常与学习过程对立；与文化、教师、学校和政教理论的距离被推到最远。

## 理论内部结构

> [!abstract] 唯我论前提
> - 学习者是自足的认知系统，一切知识由个体内部建构
> - 外部世界（社会、科学、政治、经济）不在理论视野内
> - 例：[[John Hattie|Hattie]] 和 Yates (2013) 的书封面是 16 个独立大脑，每个大脑内有一个学习仪表盘，箭头指向 d≈0.4——完全处于学习者头脑内部（Rømer, 2018, p.8）


> [!abstract] 对教学的消解
> - 经典激进[[Constructivist Paradigm|建构主义]]的教师角色是被动的：教师只是学习环境的设计者，在学习过程中缺席
...
> - Rømer (2019) 将此批评概括为：VL"属于激进[[Constructivist Paradigm|建构主义范式]]，因此建构主义的问题与 Hattie 的教学概念直接相关，这导致教学本质的双重崩溃"（cited in Sarbiewska, 2019, p.121–122）
...
> - 2009 [[John Hattie|Hattie]] 的 VL 以 Glasersfeld 为出发点，添加教师中心教学
...
> - Rømer (2018) 指出 [[John Hattie|Hattie]] 的 VL 因此可以与任何利益体系结合——在丹麦，激进[[Constructivist Paradigm|建构主义]]的大脑被[[Luhmann's Systems Theory|系统理论]]、"竞争国家理论"、后结构主义甚至[[Posthumanism|后人类主义]]同时捕获（Rømer, 2018, p.8）

## 争议与批评

> [!warning] 规范性缺失
> 激进[[Constructivist Paradigm|建构主义]]消解了外部世界和规范性标准，导致无法区分好的建构与坏的建构、知识建构与谬误建构。教育判断（什么值得学、什么值得教）因此被排除在理论之外（Rømer, 2018, p.6-7）。


> [!warning] 与现实主义的根本对立
> Popper 的哲学代表科学实在论：World 3 的文化与科学对象是"客观地伟大的"（objectively great）。激进建构主义代表其对立面——主观建构论。[[John Hattie|Hattie]] 试图桥接两者但失败：他将 Popper 的 World 3 化简为主观认知（World 2），相当于用建构主义吞噬了实在论（Rømer, 2018, p.10-11）。


> [!warning] 外部世界的缺席
> Hattie 的书完全没有提及教学内容和学科——没有贝多芬的交响乐，没有科学对象。Rømer 将此定性为"自我湮没过程中的西方文化过渡"（Rømer, 2018, p.9）。

## 应用领域

> [!success] 应用领域
> - [[Visible Learning]] — [[John Hattie|Hattie]] 以激进[[Constructivist Paradigm|建构主义]]为学习理论基础，试图在其上添加教师中心的教学
> - [[Evidence-Based Education]] — Rømer 论证 EBE 的[[Appraisal Theory|评价理论]]逻辑与激进建构主义在消解教育对象上殊途同归
> - [[Argument_Sarbiewska_2019_JSR]] — Sarbiewska (2019) 引述 Rømer (2019) 批评：VL 属于激进[[Constructivist Paradigm|建构主义范式]]，导致"教学本质的双重崩溃"
