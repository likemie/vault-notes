...
> [!info] 核心主张
> Karl Popper 在 Tanner Lecture 中提出的[[Ontology|本体论]]框架，将实在区分为三个世界（Popper, 2011，转引自 [[Argument_Rømer_2018_EPT|Rømer, 2018, p.10-11]]）：
>
...
> 客观存在的物理实在，包括物质对象和物理过程。Hattie 将其对应于"[[Surface and Deep Learning|表层学习]]"（surface learning）。


> [!abstract] World 2: 主观世界
> 个体的主观经验、意识状态、认知过程。Hattie 将其对应于"深层学习"（deep learning）。学习本质上是 World 2 的属性。


> [!abstract] World 3: 文化与科学对象
> "客观地伟大的"抽象对象——伟大的书籍、理论、交响乐。这是 Popper 哲学的核心：存在独立于认知主体的客观知识领域。Hattie 将其对应于"建构性理解"（constructed understanding），并宣称以此作为 [[Visible Learning|VL]] 的教育理想。

## 发展脉络

> [!note-] 发展脉络
> - 1960s-1970s Popper 发展三个世界理论
> - 2011 Tanner Lecture 正式发表 "Three Worlds"（收录于 McMurrin & Sterling 编）
> - Bereiter (2002) 将三个世界理论引入教育研究，但做出关键化简：将 World 3 的文化对象化简为"真理与非真理"，排除人文学科和神学
> - Hattie (2009) 通过 Bereiter 进一步化简 Popper：World 3 的客观性完全塌缩为主观学习（World 2）

## 争议与批评

> [!warning] Hattie 对三个世界理论的误读
> [[Argument_Rømer_2018_EPT|Rømer (2018, p.10-11)]] 系统论证 Hattie 从根本上扭曲了 Popper 的理论：
>
...
>
> 3. **实在论 vs [[Constructivist Paradigm|建构主义]]的根本矛盾**：Popper 是哲学实在论者，Hattie 是主观建构主义者。Hattie 用建构主义吞噬了实在论：Popper 的"批评、大胆猜想、实验和证伪"词汇残留在 [[Visible Learning|VL]] 中，但被重构为制造 d>0.4 的学习方法，完全丧失了与文化和科学对象的接触。
>
...
> [!success] 应用领域
> - [[Visible Learning]] — Hattie 以（被严重误读的）Popper 三个世界理论作为 VL 的[[Epistemology|认识论]]基础；在回应 Eacott 的 [[Cult of the Guru]] 批评时，[[Argument_Hattie_2017_SLM|Hattie (2017, p.428)]]再度援引 Popper 证伪主义，声称 VL 包含"大胆猜想"因此"容易被证伪"——[[Argument_Rømer_2018_EPT|Rømer (2018)]]和 Johnson & Janzen（2023）指出 Popper 的 fallibilism 旨在区分科学与伪科学，而非为未经证伪的猜想提供免于批评的盾牌
