...
> [!example]
> 在规训社会中，考试是权力的节点——学生在考试前被规训、考试后被释放（即使只是暂时的）。在控制社会中，[[Learning Analytics|学习分析]]系统在学习全程中持续追踪学生的每一项行为，从入学前的 OSA 到毕业后的校友追踪，干预信号持续流动。学生可能被标记为"高风险"并自动触发辅导员介入——但她从未被"开除"。这就是 Deleuze 所说的关键差异："在控制社会中，解雇不再存在"（Deleuze, 1992, p.5）。
...
> [!example]
> - [[Argument_Thompson_2022_Promising_Student]] — 以控制社会理论作为分析 OSA 和竞争性大学治理的核心框架
