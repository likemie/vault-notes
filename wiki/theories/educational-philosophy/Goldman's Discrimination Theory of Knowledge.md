...
>
> 2. **知识是临时的（provisional）**：随着新证据[[Emergence|涌现]]，先前不相关的替代状态可能变得相关。在教师质量变异性的证据变得显著之前，我们"知道"[[Tracking|能力分组]]降低成就。但当教师间差异量级的证据出现后，我们无法区分"能力分组效应"与"教师分配效应"——因此我们不再知道能力分组降低成就。
...
> [!warning] 相关替代方案的界定问题
> 区分理论面临的核心挑战是：什么使一个替代方案成为"相关的"？如果没有独立的"相关性"标准，此理论可能空洞或循环。Goldman 本人承认这需要进一步限定，但认为在特定语境中可以合理判断。
...
> [!warning] 过于严格的标准？
> 如果知识要求能够排除所有相关替代方案，考虑到教育情境的极端复杂性（任何"干预效应"都可能被无数未测量的混淆因素替代解释），此标准可能意味着教育研究几乎永远无法产生"知识"——这可能是此理论在教育领域的归谬结果。
