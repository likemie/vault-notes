...
> "Causal forces belong to the 'deep' reality, and may be triggered or blocked by other forces or by aspects of the environment in which they attempt to materialise." (Wrigley & McCusker, 2019, p. 117, summarising Bhaskar, 1978; Sayer, 2000, pp. 10–19)

## 理论内部结构

### 三层本体论（Bhaskar, 1978）

批判实在论区分三个本体论层次（Wrigley & McCusker, 2019, p. 117）：
...
> 例：在 EEF Toolkit 的体育参与案例中，"经验"层面是报告的平均效应量 0.17（+2 个月）。但追踪到"实际"层面发现：高效应量的 Playing for Success 项目包含一对一辅导、专用 ICT 套件、个性化课程和足球明星见面会——远非普通"体育参与"。而"实在"层面（什么因果机制在起作用）在统计聚合过程中完全消失了（Wrigley & McCusker, 2019, pp. 120–123）。

### 开放系统与封闭系统（Bhaskar, 1978, 1979）

- **封闭系统**：实验室实验通过人为控制稳定除两个变量之外的所有条件，创造封闭系统。RCT 试图在教育中模拟这种封闭（稳定其他变量以隔离单一"干预"的效果）。
...
> 例：教师试图复制一项成功的阅读理解干预。在一个课堂中它有效（因果力被触发），在另一个课堂中无效（因果力被阻断——可能是由于学生先前知识不足、课堂管理问题或学校文化不支持独立阅读）。仅知道平均效应量无法帮助教师判断她的课堂属于哪种情况（编者类比）。

### 社会结构的涌现性（Bhaskar, 1979）
...
- **2000** — Andrew Sayer 出版 *Realism and Social Science*，为社会科学研究者提供批判实在论的方法论指南，系统讨论还原论问题（Wrigley & McCusker, 2019, p. 112）
- **2006** — Ray Pawson 出版 *Evidence-based Policy: A Realist Perspective*，将批判实在论应用于证据本位政策的分析，提出实在论综合（realist synthesis）作为元分析的替代方案（Wrigley & McCusker, 2019, pp. 114–115, 122）
- **2010** — Sayer 在 *Questioning Nineteenth-Century Assumptions about Knowledge, II: Reductionism* 中进一步讨论社会科学中的还原论问题（Wrigley & McCusker, 2019, p. 112）
- **2018–2019** — Wrigley (2018) 和 Wrigley & McCusker (2019) 将批判实在论用作分析 EBE 方法论缺陷的核心哲学框架
...
- **方法论操作性不足**：批判实在论提供了丰富的哲学框架，但将其转化为具体研究实践操作的指导相对薄弱。Wrigley 推崇的"实在论综合"（Pawson, 2006）比"计算平均效应量"复杂得多，尚未被证明可简化为一线教师可用的工具（编者类比）。
- **与实证研究的张力**：批判实在论对"经验层面"规则的怀疑可能被误解为对量化方法的全面拒绝——尽管 Bhaskar 和 Wrigley 均明确否认这一点。
- **在 EBE 辩论中的接受度**：批判实在论为 EBE 的方法论批判提供了最系统的哲学基础，但其在政策制定者和 EBE 倡导者中的影响力有限——部分原因是其术语体系（"深层实在"、"涌现"、"实际化"）对非哲学背景的读者构成理解障碍（编者类比）。

## 相关研究

- [[Argument_Wrigley_2019_ERE]] — 将批判实在论用作解构 EBT 简单科学观和分析 EEF Toolkit 体育参与案例的核心哲学框架
- [[Argument_Wrigley_2018_BERJ]] — 以批判实在论对 EBE 方法论进行三层技术解构（RCT→元分析→元-元分析）
