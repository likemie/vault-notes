...
> [!info] 核心主张
> 批判实在论（Critical realism）是由 [[Roy Bhaskar]] (1978, 1979) 发展的科学哲学，主张实在（real）、实际（actual）和经验（empirical/phenomenal）之间的[[Ontology|本体论]]区分。因果力属于"深层实在"（deep real），可能在开放系统中被其他力量或环境因素触发或阻断，以致未能实际化（actualise）或被感知。
>
...
>
> > 例：在 [[Education Endowment Foundation|EEF]] Toolkit 的体育参与案例中，"经验"层面是报告的平均[[Effect Size|效应量]] 0.17（+2 个月）。但追踪到"实际"层面发现：高效应量的 [[Playing for Success]] 项目包含一对一辅导、专用 ICT 套件、个性化课程和足球明星见面会——远非普通"体育参与"。而"实在"层面（什么因果机制在起作用）在统计聚合过程中完全消失了([[Argument_Wrigley_2019_ERE|Wrigley & McCusker, 2019, pp. 120–123]])。
...
>
> > "Closed system explanations are rarely adequate in the natural world, and certainly not in social situations. Multiple forces are at work which may contradict as well as reinforce each other, and it is rare that a single causal factor or force may explain much of what occurs." ([[Argument_Wrigley_2019_ERE|Wrigley & McCusker, 2019, p. 113]])
>
> > 例：教师试图复制一项成功的阅读理解干预。在一个课堂中它有效（因果力被触发），在另一个课堂中无效（因果力被阻断——可能是由于学生先前知识不足、[[Classroom Management|课堂管理]]问题或学校文化不支持独立阅读）。仅知道平均效应量无法帮助教师判断她的课堂属于哪种情况。


> [!abstract] 社会结构的[[Emergence|涌现]]性（Bhaskar, 1979）
> 社会结构拥有不是个体行动简单聚合的涌现权力。Bhaskar 的经典表述："军队不只是士兵的复数"（p. 34）——它依赖于结构和目的。虽然个体活动是维持和再生产社会结构所必需的，但社会和文化中固有的结构先于我们作为个体而存在："社会结构……总是已经被制造出来的"（p. 42）([[Argument_Wrigley_2019_ERE|Wrigley & McCusker, 2019, p. 113]])。


> [!abstract] 对经验主义的批判（Bhaskar, 1978）
> 批判实在论的核心批判对象是经验主义——即将经验观察到的规则性视为充分的因果解释。Bhaskar 论证：测量规则性对科学来说是不充分的；关注表面特征之外的深层因果机制才是科学探究的本质。
>
> > "Measuring regularities is insufficient for science; attentive observation is an essential part of the process of looking beyond surface features." ([[Argument_Wrigley_2019_ERE|Wrigley & McCusker, 2019, p. 117]])

## 发展脉络

> [!note-] 发展脉络
> - **1978** — [[Roy Bhaskar]] 出版 *A Realist Theory of Science*，提出批判实在论的科学哲学基础，区分三层[[Ontology|本体论]]和开放/封闭系统
> - **1979** — Bhaskar 在 *The Possibility of Naturalism* 中将批判实在论扩展至人文科学和社会科学，论证社会结构的[[Emergence|涌现]]性和因果解释在社会领域的特殊性
...
> - **2010** — Sayer 在 *Questioning Nineteenth-Century Assumptions about Knowledge, II: Reductionism* 中进一步讨论社会科学中的还原论问题([[Argument_Wrigley_2019_ERE|Wrigley & McCusker, 2019, p. 112]])
> - **2018–2019** — [[Argument_Wrigley_2018_BERJ|Wrigley (2018)]] 和 Wrigley & McCusker (2019) 将批判实在论用作分析 [[Evidence-Based Education|EBE]] 方法论缺陷的核心哲学框架
...
> - **在 [[Evidence-Based Education|EBE]] 辩论中的接受度**：批判实在论为 EBE 的方法论批判提供了最系统的哲学基础，但其在政策制定者和 EBE 倡导者中的影响力有限——部分原因是其术语体系（"深层实在"、"[[Emergence|涌现]]"、"实际化"）对非哲学背景的读者构成理解障碍。
