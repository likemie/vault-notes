...
Niklas Luhmann 的社会系统理论将社会理解为一个由自创生（autopoietic）沟通系统构成的整体，与个体的心理系统（意识）严格区分。其核心立场是：社会沟通系统永远无法观察个体心理系统，两者不共享编码且彼此不透明（Larsen, 2019, p.4）。
...
- **盲点（Blinder Fleck）** — 每一次观察都基于一个观察者无法看见的盲点。观察者在观察时无法看见自身。看到某物的条件恰恰是建立了看见与看不见之间的区分。所有自我观察都受制于盲点——它之所以可能，恰恰因为它无法看见自身的看见（Larsen, 2019, p.10）
  > 例：当 VL 研究者通过效应量数据观察"什么在教学中有效"时，他们建立了一个区分（可量化的效果 vs 不可量化的过程），但他们无法在观察框架内部看到这个区分本身的局限性和任意性。
- **结构耦合（Structural Coupling）** — 两个封闭、自我指涉系统之间的非因果链接。如在教育中，教学（社会系统）与学习（心理系统）之间不是因果关系而是结构耦合——教学不能直接'生产'学习，只能通过结构耦合间接地'扰动'学习者的心理系统
- **对不可知的无知** — 个体完全不可能知道自己不知道什么（Luhmann, 1997, p.39）。这一认识论上的根本限制意味着任何宣称全面捕捉了"什么有效"的知识体系（如 VL）都必然包含系统性的未知盲区（Larsen, 2019, p.10）
...
- 在教育研究中的应用存在两种截然相反的用法：
  - **批判性应用（Larsen, 2019）** — 以盲点和结构耦合论证 VL 的可见性宣称在认识论上不成立
  - **辩护性应用（Qvortrup, 2019）** — 以结构耦合论证 VL 并非宣称教学直接因果产生学习，而是需要专业判断作为"缺失环节"（编者类比）
