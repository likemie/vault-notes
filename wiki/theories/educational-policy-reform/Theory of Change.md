...
> | 核心活性成分与刚柔边界（Active Ingredients & Tight vs Loose Boundaries） | 概念 | 明确方案起效不可妥协的核心构件（刚性边界）与允许学校本土化调试的空间（弹性边界），依托干预描述与复制模板（Template for Intervention Description and Replication，TIDieR）实现标准化界定。[[Argument_Edovald_Nevill_2021_ROE\|(Hoffmann et al., 2014; Edovald & Nevill, 2021, p. 54)]] |
...
> | [[Implementation and Process Evaluation\|实施与过程评估（IPE）因果核验]] | 方法 | 在干预推进全程对照变革理论检验各个传导环节的依从性与保真度，作为区分理论失败与实施失败的方法学支柱。[[Argument_Edovald_Nevill_2021_ROE\|(Craig et al., 2008; Edovald & Nevill, 2021, p. 53)]] |
...
>
> **案例二｜儿童哲学（P4C）大规模级联推广中的实施稀释与因果链断裂（Gorard et al., 2015; Kitmitto et al., 2018; Edovald & Nevill, 2021, p. 57）**
...
> - **方法含义** 要求结合[[Mixed Methods Research|混合方法研究]]（Mixed Methods Research）、[[Formative Assessment|形成性评估]]与严谨[[Causality|因果推断]]（如理论驱动型多臂 [[Randomised Controlled Trials|RCT]]、双重差分模型）。
