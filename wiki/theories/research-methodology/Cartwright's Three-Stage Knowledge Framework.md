...
> - **替代方案的可操作性**Bonell et al. (2012) 提出的"实在论 RCT"（realist RCT）试图通过析因试验和多臂研究来识别因果机制，但面临成本激增和[[Sample Size Determination|样本量]]需求的挑战

## 相关研究

> [!example] 相关研究
> - [[Argument_Cowen_2015_CHESS]] — 以三阶段框架为核心理论框架，通过教师访谈验证外推问题的[[Praxis|实践]]表现
