...
> - **解释对象** 科学研究（尤其是实验与[[Quasi-Experimental Designs|准实验设计]]）中[[Causality|因果推断]]结论的真实性、[[Reliability|可靠性]]、[[External Validity|可推广性]]与[[Construct|构念]]测量有效性。
> - **理论问题** 回应实证研究中“如何确证干预与结果之间存在真实因果关系”、“如何系统排除竞争性替代解释”以及“因果知识能否及如何在不同人群与情境间推广”。
> - **理论类型** 方法论元理论（Methodological Meta-Theory）与因果效度[[Analytic Framework|分析框架]]。
> - **知识位置** [[Postpositivism|后实证主义]]（Postpositivism）科学哲学与实验心理学传统；代表人物为 Donald T. Campbell, Julian C. Stanley, Thomas D. Cook, William R. Shadish。

> [!claim] 核心主张
> **排除替代解释是因果推断的核心，[[Internal Validity|内部效度]]是因果成立的必要前提，而跨方法与跨评价者收敛是[[Construct Validity|构念效度]]的经验基准**。任何声称产生因果证据的设计，均须通过系统识别并排除对因果关系的竞争性威胁来建立内部效度；进而，当评估某一制度化特质（如“基于证据”）时，不同独立测量方法之间必须展示出高度的[[Convergent and Discriminant Validity|收敛效度]]与判别效度([[Argument_Hitchcock_2015_JBE|Hitchcock et al., 2015, pp. 461–462]]; [[Argument_Wadhwa_2024_RER|Wadhwa et al., 2024, pp. 4, 26]])。

> [!citation-card]- 关键表述
> 内部效度，即干预与[[Dependent Variable|结果变量]]之间因果关系的有效程度，是实验设计的[[Necessary and Sufficient Conditions|必要条件]]（sin qua non）。如果无法证明给定干预对结果负责，那么考察证据能否推广到不同情境就毫无意义。[[Argument_Hitchcock_2015_JBE|(Hitchcock et al., 2015, p. 461)]]
>
> *Internal validity, or the degree to which a causal relationship exists between a treatment and outcome [[Variable]] is valid, is the sin qua non of [[Experimental Research|experimental design]]. (Shadish et al., 2002)*
...
> [!proposition-chain] 核心命题一｜[[Internal Validity|内部效度]]是[[Causality|因果推断]]成立的[[Necessary and Sufficient Conditions|必要条件]]与证据门控的首要基准
...
>   > [!evidence-grid]- 证据
>   > - **证据一（[[Single-Case Design|SCD]] 与组间设计共通性）** 无论是[[Randomised Controlled Trials|随机对照试验]]（RCT）通过[[Random Assignment|随机分配]]消除选择偏倚，还是[[Single-Subject Design|单一被试设计]]（SCD）通过 ABAB 撤回与多基线阶段对比消除成熟和历史效应，均统一遵循排除替代解释的 Campbellian 逻辑。[[Argument_Hitchcock_2015_JBE|Hitchcock et al. (2015, p. 462)]]
...
> - **适合解释** 旨在确立[[Causality|因果关系]]的[[Experimental Research|实验研究]]、[[Quasi-Experimental Designs|准实验设计]]、单一被试研究以及针对证据评价体系的[[Construct Validity|构念效度]]元评估。
> - **谨慎使用** 在高度依赖质性探索、[[Phenomenology|现象学]]阐释、生成性批判或旨在理解行动者主观意义的研究中，不宜机械套用排除威胁的因果四分模型。
> - **不适合解释** 纯粹的规范性伦理价值选择、意识形态争论或后现代解构主义文本分析。
> - **常见误用** 误将“[[Internal Validity|内部效度]]达标”等同于“在任何学校均会成功”；或误认为非实验数据完全没有因果参考价值。
...
> [!debates] 理论争议
>
> > [!axis] [[Internal Validity|内部效度]]优先（Internal Validity Primacy） vs 现实[[Ecological Validity|生态效度]]（Ecological Realism）
