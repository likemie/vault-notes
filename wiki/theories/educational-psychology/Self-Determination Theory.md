...
> | 构件 | 类型 | 在理论中的功能 |
> |:-----|:-----|:--------------|
> | **基本心理需求（Basic Psychological Needs）** | 概念 | 理论的核心内核；设定了自主性（自我决定感）、胜任感（[[Self-Efficacy\|自我效能]]与掌握感）与归属感（人际连接与心理安全）作为人类动机与健康发展的必需养分。 |
> | **自决连续体（Self-Determination Continuum）** | 分类 | 构筑行为动机的谱系；沿自决程度从左至右依次划分为：无动机（Amotivation） $\to$ 外在调节 $\to$ 内摄调节 $\to$ 认同调节 $\to$ 整合调节 $\to$ 内在动机（Intrinsic Motivation）。 |
> | **认知评价子理论（CET）** | 机制 | 阐述外部奖赏、反馈与评价事件如何通过影响个体的胜任感和感知因果轨迹（Perceived Locus of [[Causality]], PLOC）来促进或破坏内在动机。 |
> | **有机整合子理论（OIT）** | 机制 | 解释学习者如何将原本乏味但有价值的外在学业规范与任务要求逐步内化为自我认同的一部分。 |
> | **基本心理需求量表（BPNS）** | 方法 | 心理测量工具；在教育中用于定量评估课堂、教师行为或数字化学习环境对三项心理需求的满足程度。 |
...
> [!proposition-chain] 核心命题二｜外在动机能够通过社会化认同与内化过程转化为高度自决的自主调节
> - **前提一** 绝大多数学校教育任务并非完全由纯粹的“乐趣”驱动，必须包含外在的价值规范与纪律要求。
> - **前提二** 个体具有将外部价值标准吸纳为自我构成部分的内在同化机制（Organismic Integration）。
>   > [!evidence-grid]- 证据
>   > - **内化梯度模型** Ryan & Deci (2000) 实验表明，在解释任务重要性、承认学习困难并给予选择权时，外在动机成功跃迁为认同调节与整合调节。
> - **推导** ① 外部规约在富有共情与支持的环境中被传达 $\to$ ② 学习者理解任务对个人长远发展的工具性价值（认同调节） $\to$ ③ 行为规约与个人核心价值观彻底融合（整合调节） $\to$ ④ 形成等同于内在动机的强劲学习动能。
...
> ```mermaid
> flowchart LR
>   subgraph Environment["教育与技术环境特征"]
>     A1["自主支持<br>(提供选择、尊重节奏)"]
>     A2["结构与脚手架<br>(适度挑战、即时反馈)"]
>     A3["关系与共情支持<br>(无威胁、低焦虑交互)"]
>   end
>   subgraph Needs["三大基本心理需求"]
>     B1["自主性需求<br>(Autonomy)"]
>     B2["胜任感需求<br>(Competence)"]
>     B3["归属感需求<br>(Relatedness)"]
>   end
>   subgraph Outcomes["学习动力与产出"]
>     C1["内在动机与认同调节<br>(Autonomous Motivation)"]
>     C2["认知深度与学业成就<br>(Academic Achievement)"]
>     C3["高情感与学业繁荣<br>(Affective Outcomes)"]
>   end
>   A1 --> B1
>   A2 --> B2
>   A3 --> B3
...
> > - **SDT 学者（Chirkov, Ryan et al.）** 澄清“自主（Autonomy）”不等于“独立（Independence）”；只要个体发自内心认同集体规范，集体主义行为同样是高度自决的。
>
> > [!axis] 外部奖励与奖学金是“破坏动机”还是“提供信息”
> > 争论行为主义强化手段在教育系统中的合法性。
> >
> > - **严格自决派** 警告外在控制性奖励会侵蚀长期的自发学习兴趣。
