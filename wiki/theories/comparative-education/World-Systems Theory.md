...
> - 其刚性空间性假设无法容纳变革——Marginson 指出世界体系理论犯了**方法论全球主义**（methodological globalism）的错误，即认为国家尺度完全由全球尺度决定。这是**方法论民族主义**的镜像错误：一个只看见国家，另一个只看见全球系统（Marginson, 2025, p. 13）
...
> - **与 Massey 多重性 的对比** — Massey 认为总是有松散的末端，任何权力系统都不是永久固定的；Wallerstein 则认为中心-边缘结构在资本主义框架内不可改变。二者对空间开放性的预设根本不同（Marginson, 2025, pp. 6–7, 12–13）
