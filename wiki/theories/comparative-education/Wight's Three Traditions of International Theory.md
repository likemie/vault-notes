...
- 对应 Machiavelli 传统。主权领土国家是国际政治的主要行动者，国际政治是自利国家之间的权力斗争。
- 国际社会缺乏中央权威，处于无政府状态，竞争和寻求优势是关系的基础。不安全与冲突是常态，霸权或均势是稳定的来源。
- 核心概念是权力（power）：国家对外获取服从和资源、对内施加意志的能力。跨国公司和多边组织被视为最强大国家外交政策的工具。
- 无政府状态允许联盟和权力集团的形成，也允许扩张主义帝国政治和对"国际社会"之外民族的剥削。

### 理性主义（Rationalism）

- 对应 Grotius 传统。无政府状态可以通过多边主义得到缓解。将国家领导人聚集在一起，可以讨论分歧并建立和平繁荣的国际社会。
- 国际社会是真实存在的，但"制度上存在缺陷"（Wight, 1992, p.39）。国际政治是冲突与合作的混合体。
- 核心概念是权威（authority）：法律赋予权力以正当性的外在来源，使权力转化为权威。权威是"因符合道德原则而获得正当性的权力"（Wight, 1992, p.107）。
- 国际法是关键制度，应适用于国际社会所有成员。强大成员对弱小成员负有"托管人"的法律责任。
...
> - **2023 年**：Klerides 将三大传统系统运用于比较教育领域，论证每个传统为比较教育带来了不同的"注意力议程"（agendas of attention），分别产生现实主义、理性主义和革命主义的比较教育形态（Klerides, 2023）。
...
> [!example]
> - [[Argument_Klerides_2023_CE]] — Klerides 运用三大传统框架重新解读比较教育的历史和现状，论证比较教育与国关的深层纠缠
