...
- **机制**：一个组织因另一个组织对其拥有依赖关系而能够施加其规范。这与 [[Max Weber1|Weber]] 的强制（coercion）概念最为接近——行动者可以在缺乏接受甚至遭遇抵抗的情况下强加其规范
...
> [!note]
> - **[[Max Weber1|Weber]]（1978）**：区分权力（Macht）与权威（Herrschaft），识别科学、法律和规则为现代权力的主要合法性来源，与魅力型权威形成对比。Weber 指出："权力成为权威（Herrschaft）增加了'一个具有特定内容的命令将被特定人群服从的概率'"（Weber, 1978, p.52, cited in Hartmann, 2022, p.183）
