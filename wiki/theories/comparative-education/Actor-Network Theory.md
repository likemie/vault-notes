...
> - **PISA 政策影响分析**。Li et al.（2025）将 ANT 整合进 PISA 对全球教育改革影响的三层机制模型中——在内部行动者网络层级，国际组织（如 OECD）虽可被视为全球政治场域的重要政策行动者，但其对一国政策制定的影响是特定社会环境中嵌入政策网络的各类主体（政策制定者、政党、协会、媒体）动态博弈的结果。
