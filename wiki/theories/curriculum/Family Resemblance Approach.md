...
title: "Family Resemblance Approach"
aliases:
  - "FRA"
  - "家族相似性进路"
  - "家族相似性科学本质观"
...
> - **提出者与原始文本** 居罗尔·伊尔齐克（Gürol Irzik）与罗伯特·诺拉（Robert Nola）于 2011 年在 *Science & Education* 期刊发表《A Family Resemblance Approach to the [[Nature of Science]] for Science Education》，系统提出 FRA 理论框架；西贝尔·埃尔杜兰（Sibel Erduran）与祖贝达·达格尔（Zoubeida Dagher）于 2014 年出版专著《Reconceptualizing the Nature of Science for Science Education》，将其全面扩展为科学课程与教学论模型。
> - **原初问题** 20 世纪末科学教育界形成的以诺曼·莱德曼（Norman Lederman）为代表的“共识观”（Consensus NOS），因将科学本质简化为 7 条普遍信条（如暂定性、主观性、经验性等）而广受批评，被指责抹杀了具体学科的独特性，脱离了真实科研实践。
> - **理论资源与材料** 引入维特根斯坦《哲学研究》（Philosophical Investigations）中的“家族相似性”（Family Resemblance）概念，并广泛吸纳科学史、科学哲学、科学社会学（HPS）对物理学、化学、地学和生物学实际运作规程的实证案例。
> - **形成路径** 从维特根斯坦“各项活动通过网状重叠的相似性交织在一起”的隐喻出发，构建由四大认知范畴（活动、价值、方法论、产品）与社会系统构成的矩阵式结构，替代线性的清单式定义。
...
> | 构件 | 类型 | 在理论中的功能 |
> |:-----|:-----|:--------------|
> | [[Nature of Science\|科学本质]] | 核心概念 | 理论解释的总括性对象，被重构为动态开放的家族相似性网络而非固定教条。 |
> | **科学活动** | 认知构件 | 涵盖观察、实验、模拟、测量与假说提出等多样化的学科探究实践。 |
> | **[[Epistemic Value\|认识论价值]]** | 规范构件 | 包含融贯性、经验充分性、简单性、预测力以及说服优于强制等共同体价值准则。 |
> | **方法与方法论** | 规程构件 | 涵盖受控实验、[[Retrodiction\|回溯推测]]、双盲试验、模型构建与统计推断等异质方法。 |
> | **知识产品** | 认知构件 | 包括事实、定性与定量规律（如物理万有引力定律与化学元素周期律）、假说、模型与理论。 |
> | **社会-建制系统** | 制度构件 | 包括专业活动、科学道德风尚（Ethos）、同行评议认证、社会价值与资助体系。 |
...
> |:---------|:---------------|:-----------------|:-----------------|
> | **科学活动与实践** | 学生在课堂中参与了哪些具体探究活动？是否局限于单一动手操作？ | 观察、实验操作、数据图表绘制、假说提出与辩驳记录。 | 出现多种探究形式支持高实践水平；仅有机械照方抓药则判定为低水平。 |
> | **[[Epistemic Value\|认识论价值]]与态度** | 教学是否引导学生理解评估知识主张的标准？ | 准确性、解释力、可检验性、[[Reflexivity\|反思性]]批判与开放心态。 | 师生主动讨论“为何该解释优于备选方案”即表明确立了价值意识。 |
> | **方法与方法论规程** | 探究方法是否反映了具体学科的独特性？ | 受控实验（物理）、[[Retrodiction\|回溯推测]]（地学）、定性模型构建（化学）。 | 能够区分不同学科方法差异表明破除了单一方法神话。 |
> | **知识产品形态** | 学生构建了何种形态的科学知识？ | 经验事实、概念模型、定律公式、分类系统与因果解释。 | 区分模型与绝对真理的区别，理解理论模型的暂定性与修正性。 |
> | **社会与建制系统** | 教学是否展现了科学共同体的[[Peer Debriefing\|同行审议]]与伦理规范？ | 同行评议[[Role-playing\|角色扮演]]、小组海报展示、利益冲突探讨与社会责任分析。 | 能将课堂论证与科学共同体制度规范对接。 |
