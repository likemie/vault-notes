...
> [!tip]
> 文化工具箱理论（Culture as Toolkit）由美国社会学家[[Ann Swidler]]（1986）在《美国社会学评论》（*ASR*）上提出，主张文化不仅是定[[Rightness|义]]价值观和行动目的的意义系统，更是为行动者提供建构行动策略所需工具的"工具箱"（tool-kit）或"技能库"（repertoire）。人在具体社会情境下无需深思[[Shu (Familiarization)|熟]]虑即可知道如何恰当地行事，因为他们已通过社会化过程内化了一组惯常使用的文化图式（schemas）。
...
> [!abstract]
> - **文化的双重功能**：文化同时以两种方式影响行动——通过定[[Rightness|义]]价值观来塑造行动目的（"想要什么"），以及通过提供文化工具来建构行动策略（"如何去做"）。后者是该理论区别于传统文化价值论的关键创新（[[Yajun Zheng|郑雅君]]，2023，引 Swidler, 1986）
> - **文化工具的阶层差异**：文化工具的可及性和掌握[[Shu (Familiarization)|熟]]练程度依[[Habitus|习性]]结构的不同而有着系统性的差异。对于在客观社会结构和历史中处于特定位置的人们而言，内在化于身体的结构为某些文化工具的获得提供了固有范围（郑雅君，2023）
...
> - **2023 教育研究应用**：[[Yajun Zheng|郑雅君]]在《金榜题名之后》中将该理论系统应用于中国[[Jing (Refined Mastery)|精]]英大学学生出路分化分析，从 Swidler 的两种生活状态出发建构了 [[Goal-Controlled Mode]] 和 [[Intuition-Dependent Mode]] 的区分（郑雅君，2023）
...
> - **意识层面的限定**：援引 Giddens 和 [[Pierre Bourdieu|Bourdieu]]，动机或[[Habitus|习性]]完全可能是无意识的。工具箱范式所假设的"文化运用者"形象——灵活[[Shu (Familiarization)|熟]]练、审时度势——只在有意识的、深思熟虑的认知层面成立，无法解释无意识层面的文化驱动（郑雅君，2023，引 Vaisey, 2009）
...
> - [[Intuition-Dependent Mode]] — 直觉依赖模式说明低阶层学生可及的文化工具集中缺少对[[Jing (Refined Mastery)|精]]英大学场域具有高度适用性的"工具"。其亚类型[[Lost Mode|迷失无从者]]和[[Value Conformist Mode|价值归顺者]]的区分，体现了"工具匮乏"与"价值馈赠"可能同时发生的复杂关系（郑雅君，2023）
