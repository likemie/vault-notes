...
> [!tip]
> 文化工具箱理论（Culture as Toolkit）由美国社会学家[[Ann Swidler]]（1986）在《美国社会学评论》（*ASR*）上提出，主张文化不仅是定义价值观和行动目的的意义系统，更是为行动者提供建构行动策略所需工具的"工具箱"（tool-kit）或"技能库"（repertoire）。人在具体社会情境下无需深思熟虑即可知道如何恰当地行事，因为他们已通过社会化过程内化了一组惯常使用的文化图式（schemas）。

> [!quote]
> "文化对行动的影响不仅是通过定义价值观去定义行动目的，也是通过提供建构行动策略所需要的文化工具（比如规范、价值、故事、[[Symbolic Boundary|象征边界]]、分类体系等）"（[[Yajun Zheng|郑雅君]]，2023，引 Swidler, 1986）
...
> [!success]
> - [[Goal-Controlled Mode]] — 该概念以工具箱理论为核心[[Analytic Framework|分析框架]]：目标掌控模式被理解为一组由优势家庭提供的文化工具，使学生能够在大学[[Champ|场域]]中策略性地组织行动路线。其亚类型[[Self-Driven Mode|自主驱动者]]和[[Opportunist Mode|机会主义者]]的区分，进一步体现了工具箱范式中"价值目的"和"策略手段"两个维度的独立运作（[[Yajun Zheng|郑雅君]]，2023）
