---
title: Lefebvre's Spatial Triad
aliases:
  - "Lefebvre 空间三元辩证法"
  - "spatial triad"
  - "production of space"
...
> 被日常使用者通过实际经验、想象和意义建构而"活出来"的空间。Cai 等（2025）的核心贡献在于聚焦这一最未被充分研究的维度——关键节点教师如何在日常实践中桥接跨部门网络、如何想象 GBA 的未来、如何在结构性空洞中创造合作机会。

---
## 在 GBA 研究中的应用

> [!info]
> Cai 等（2025）将 Lefebvre 空间三元辩证法与 Burt（2000）的结构洞理论结合，分析了 [[Guangdong-Hong Kong-Macau Greater Bay Area|GBA]] 高等教育空间的生产过程。关键节点教师——那些具有跨越学术、产业和政府网络经验的教师——通过填补三个空间维度之间的结构性空洞（structural holes），使 GBA 空间获得了"真实的"存在。这些早期战略行动者通过跨城市和行政边界的产学政交叉网络，创造了 GBA 的新需求均衡。

---
## 理论基础

> [!tip]
> - **Lefebvre（1991）** — 《空间的产生》，提出空间是社会关系的产物，批判将空间视为中性容器的传统观念
> - **Burt（2000）** — 结构洞理论：社会网络中的断连位置为个体提供了信息和控制的优势。Cai 等将结构洞从社会网络扩展到空间维度
