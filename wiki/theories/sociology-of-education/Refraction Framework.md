...
>
> > 例：在[[Seasonal Comparison|季节性比较]]研究中，SES 认知技能差距在学校期间增长更慢（甚至缩小），而在暑假期间加速扩大。学校虽未在绝对意义上消除差距，但相对于没有学校的情况（暑假作为反事实），学校发挥了补偿作用——就像减肥项目虽未使参与者减重，但对照组增重 5 磅，因此项目仍有正面效果（Downey & Condron, 2016, p.6）。
...
> [!info] 研究范式
> - **认识论立场**：后实证主义——承认学校效应的因果推断需要严格方法（[[Seasonal Comparison|季节性比较]]作为自然实验），同时重视将学校效应置于更广泛的社会分层系统中进行情境化理解
