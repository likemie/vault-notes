...
> - *Euthyphro*（《优绪弗洛》）— 早期对话，[[Socrates|苏格拉底]][[Probes|追问]]"什么是虔敬"的经典示范。Li 在第 2 章中重点拆解了苏格拉底与优绪弗洛的七轮对话过程（Li, 2012, pp.31-32）
...
> - [[Socrates|苏格拉底]]在柏拉图对话录中的"无情"[[Probes|追问]]方式——如在优绪弗洛对话中"不关心优绪弗洛的感受"——是否具有跨文化普适性？这一问题是 Li 中西学习传统比较的隐含关切之一（Li, 2012, pp.51-53）
