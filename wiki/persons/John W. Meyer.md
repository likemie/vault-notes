...
> [!info]
> John W. Meyer，美国社会学家，斯坦福大学社会学系教授（荣休）。世界社会理论（world society theory，亦称世界政体理论或斯坦福学派）的创始人，新制度主义组织社会学的重要代表人物。其学术工作从根本上重塑了对全球化、组织行为和教育扩张的理解——论证民族国家的制度形式、组织的结构特征以及个体的身份认同，在很大程度上是全球文化模型扩散的产物，而非纯粹的地方功能性结果。Meyer 提出或共同提出了 world society（世界社会）、organizational actorhood（组织能动者身份）和 otherhood（为他者行动）等核心概念，其理论框架是 Zapp (2022) 分析大学在全球治理中角色的主要理论资源（Zapp, 2022, pp.145, 148–149）。
...
- 核心内容：提出 otherhood 概念——论证现代社会中的"能动者"（actors）本身就是一种文化建构，otherhood（为他人行使代理权）是这种建构的核心机制（Zapp, 2022, p.149）。
...
### 2019 — "Reflections on Rationalization, Actors, and Others"

- APA：Meyer, J. W. (2019). Reflections on rationalization, actors, and others. In H. Hwang, J. Colyvas, & G. S. Drori (Eds.), *Agents, Actors, Actorhood: Institutional Perspectives on the Nature of Agency, Action, and Authority* (pp. 275–285). Emerald Publishing Limited.
- 核心内容：反思理性化、能动者与 otherhood 的关系，进一步完善 otherhood 的理论内涵（Zapp, 2022, p.149）。
- 思想位置：晚期对 otherhood 概念的反思和深化。
- 相关概念／理论：[[Otherhood]]
...
> - **世界社会作为文化建构**：世界层面存在一个由共享文化模型、规范和认知框架构成的"世界社会"，它不依赖中央权威，而是通过文化模型的扩散与模仿来运作
> - **组织能动者身份**：在全球文化模型压力下，各类组织日益获得标准化但同时又寻求独特性的能动者身份——自主性、目标导向、问责性和社会嵌入性构成现代"完全组织"的四个核心维度
...
> [!success]
> - 在比较教育和高等教育研究领域：Meyer 的世界社会理论是 Zapp (2022)、Parreira do Amaral (2022) 等学者分析大学全球转型和知识地缘政治的核心理论资源
> - 在组织社会学领域：Bromley & Meyer (2015) 的组织能动者身份理论已成为分析大学、国际组织和其他非国家行动者组织变迁的重要框架
> - 在国际关系学领域：世界社会理论与建构主义 IR（Wendt, 1999; Barnett & Finnemore, 2004）形成对话和互补，推动了全球治理研究从"硬治理"向"软治理"的范式转移（Zapp, 2022, p.145）
> - 斯坦福学派的研究网络——包括 Francisco Ramirez、David P. Baker、Patricia Bromley、David John Frank 等——持续扩展和深化了世界社会理论在跨国比较研究中的应用

---
## 争议与批评

> [!warning]
> - **对权力和冲突的低估**：Zapp (2022) 指出，世界社会理论倾向于强调全球文化模型的扩散与同构，可能低估国家权力、地缘政治冲突和市场逻辑对组织行为的持续塑造作用（pp.155–157）
