...
> EspectAtor 方法不以学术论著来"论证"替代认识论的必要性，而是以剧场表演直接**制造**官方知识体系无法消化的替代知识——这一实践逻辑被 [[Dell Delambre]] 在 [[Creative Tension of Sense]] 和 [[Ganz-Methode]] 中分析为"承载新旧张力"和"发现[[Life Power|生命力量]]"的典型案例([[Argument_Delambre_2022_Springer|Delambre, 2022, p.109–110, 112–113]])。
...
> 这种演员-观众的角色融合在认识论层面具有深刻意义：它拒绝了一种外在的"专家"（如学术研究者、专业编剧）来代表贫民窟居民的经验——知识的生产权被归还给经验者自身。这就是 Delambre 将其定性为"[[Epistemology of Resistance|抵抗认识论]]"的根本原因：EspectAtor 不请求[[Official Knowledge|官方知识]]体制的认可，而是直接在剧场中制造出另一种关于什么算是"有效知识"的标准([[Argument_Delambre_2022_Springer|Delambre, 2022, p.110]])。

> EspectAtor 方法的操作逻辑同时包含两个维度：（1）**承载张力**——让贫民窟的口述剧场与城市官方知识模式并置共存，不以官方标准评判前者；（2）**发现[[Life Power|生命力量]]**——通过表演暴力创伤，居民实践性地定义"什么使我们的存在有意义"([[Argument_Delambre_2022_Springer|Delambre, 2022, p.109–110, 112–116]])。这一双层逻辑后被 Delambre 在 [[Ganz-Methode]] 框架中理论化（详见 [[Ganz-Methode#核心要素]]）。

## 影响

> [!success]
> - EspectAtor 方法被 Delambre (2022) 定位为 [[Ganz-Methode]] 在文化实践领域的核心案例，将抽象的去殖民认识论转化为具体的剧场操作方法([[Argument_Delambre_2022_Springer|Delambre, 2022, p.109–110]])
