...
> [!info]
> Dell Delambre 是巴西学者和实践者，任职于 WTS Sustainable Business & Coaching（位于里约热内卢）。其工作跨越商业教练、可持续发展、社区发展和认识论研究，提出 [[Creative Tension of Sense]] 理论和 [[Ganz-Methode]] 方法论。他的研究根植于巴西里约热内卢的基层实践——包括贫民窟（favela）社区剧场、社会博物馆学（social museology）和 生态博物馆学——试图在西方现代性认识论霸权之外构建替代性知识范式（Delambre, 2022, p.105, 107, 109–110）。
>
...
> - 2013–2020 年在里约热内卢开展多案例实践研究，涵盖个体发展、地方发展（通过 生态博物馆 和剧场）、商业发展、学校发展、制度发展和可持续发展（Delambre, 2022, p.107）
...
> - 核心内容：对 Rio+20 峰会最终文件中可持续性和可持续发展概念的批判性分析，与 Ignacy Sachs 的生态发展（ecodevelopment）提案对话。
> - 思想位置：代表早期思想形成阶段——从可持续性概念批判出发，逐步发展出"整体可持续性"（Whole Sustainability）概念。
> - 相关概念／理论：[[Creative Tension of Sense]]
>
> ### 2022 — *Creative Tension of Sense and the Whole Approach to Knowledge and Practice*
>
...
> - 核心内容：系统阐述 Creative Tension of Sense 理论及其 Ganz-Methode 方法论，从认识论角度回应新知识地缘政治的讨论，并展示该理论在里约热内卢实践中的应用。
> - 思想位置：代表理论成熟和系统化表达阶段。
...
>
> 他的独特贡献在于将高度抽象的去殖民认识论讨论（Mignolo、Dussel、Santos）与极度具体的巴西基层实践（贫民窟剧场、社区博物馆、生态博物馆）相连接，是少数试图在"批判"和"建构"之间架桥的当代认识论学者。
>
> > "张力是正常的，因为'旧'和'新'必须始终在一起。因此，张力就是'今日之新'（today's new）。"（Delambre, 2022, p.121）
...
> - 在社会博物馆学（social museology）和 生态博物馆学 领域，其"生命力量"和"整体可持续性"概念为社区主导的知识保护实践提供了认识论框架

## 格言／关键表述

> [!quote]
> "大学如何参与解决方案，如果它们是问题的核心部分？一种可能性是接纳新在旧内部诞生的张力。"（Delambre, 2022, p.119）
>
> "出发点是张力中的沉默，而不是答案。"（Delambre, 2022, p.113）
