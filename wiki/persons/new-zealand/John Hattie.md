...
> [!person-profile] 人物档案
> - **身份位置** 新西兰教育统计学家，墨尔本大学教育研究所（Melbourne Graduate School of Education）荣休教授，曾任澳大利亚教学与[[School Leadership\|学校领导力]]研究院（[[Australian Institute for Teaching and School Leadership]]，AITSL）主席，兼任澳大利亚[[Evidence for Learning]]（E4L）学校专家咨询委员会（Schools Expert Reference Council）主席。
...
> - **2016–2023** 英国教育部 Coldwell et al. 报告将其列为官方认可证据来源；出任澳大利亚[[Educational Brokerage Agency\|证据中介机构]][[Evidence for Learning]]（E4L）学校专家咨询委员会（Schools Expert Reference Council）主席，为澳大利亚版《[[EEF Teaching and Learning Toolkit\|教学与学习工具包]]》及指导指南的本土化研发提供核心专家指导；澳大利亚广播公司（Australian Broadcasting Corporation，ABC）纪录片《革命学校》将其描绘为公共教育拯救者；在学术界遭遇伪科学与[[Neo-Taylorism\|新泰勒主义]]系统批判的同时，转向三阶段学习模型并反思“结果的暴政”；北欧政策咨询网络实证揭示其研究在法定行政法令起草中遭遇断崖式引文清洗。[[Argument_Steiner-Khamsi_2024_CE\|(Steiner-Khamsi et al., 2024, pp. 547–548)]]
...
>   - **阶段转向** 结合认知科学阐释学习机制，将学术[[Research Translation\|研究转化]]为连锁经营式的培训、评估工具（asTTle）与学校认证系统，强调将效应量结合学段解释，把[[Heterogeneity\|异质性]]转化为[[Research Question\|研究问题]]。
> - **2016 至今 — 排名反思、三阶段学习模型与跨国治理批判阶段** 此阶段主要回应学界关于伪科学、[[Neo-Taylorism\|新泰勒主义]]监控的指控以及在北欧等国政策咨询中的治理落差。
>   - **代表著作** Hattie & Donoghue (2016) *Learning strategies: a synthesis and conceptual model*；Hattie (2020) *Lessons from Lockdown*；Hattie (2023) *Visible Learning: The Sequel*。[[Argument_Blass_2020_JESP\|(Blass, 2020, pp. 95–96)]]
>   - **关键概念／方法** 三输入（技能/意愿/激情）三阶段（表层/深层/迁移）模型、“结果的暴政”（Tyranny of Outcomes）、[[Structural Coupling\|结构耦合]]、法定行政法令引文过滤。[[Argument_Steiner-Khamsi_2024_CE\|(Steiner-Khamsi et al., 2024, pp. 547–548)]]
>   - **阶段转向** 放弃单一线性排行榜，承认教学干预的阶段变异与[[Problem-Based Learning\|基于问题的学习]]（Problem-Based Learning，PBL）在迁移阶段的价值，反思证据本位对教育复杂性的遮蔽；跨国实证进一步解构了其作为个体学术权威在主权国家硬性规制中的制度穿透局限。
...
> [!claim] 核心主张
> 教育教学的核心机制在于“使教对学生可见、使学对教师可见”。教师不应充当消极旁观的课堂“促进者”，而必须成为主动干预、高频反馈并以可见证据评估自身教学成效的“激活者”。通过以标准差为单位的[[Effect Size\|效应量]]关节点（$d=0.40$）建立证据排序坐标，能够穿透主观轶事与教学时尚，为学校改进提供实证标尺；然而，证据并非行动处方，而是明智[[Problem Solving\|问题解决]]的[[Hypothesis\|假设]]起点。

> [!citation-card] 可见的教与学之本质
> 当教师成为自身教学的学习者、学生成为自身教师时，对学生学习产生最大效应。[[Argument_McKnight_2020_Discourse\|(McKnight & Whitburn, 2020, p. 40)]]
>
...
> [!citation-card] 教师作为激活者而非单纯促进者
> [[Constructivist Paradigm\|建构主义]]是一种知识形式，但不是一种教学形式……教学要求教师成为主动的激活者，指导学习、提供反馈并监控理解过程。[[Argument_Terhart_2011_JCS\|(Terhart, 2011, p. 433)]]
>
> *“Constructivism is a theory of knowing, not a theory of teaching... Teaching requires teachers to be activators who direct learning, provide [[Feedback]], and monitor understanding.”*

> [!citation-card] 证据与理论的主导关系
> 证据不意味着不应该有理论。证据是被解释的；证据通过镜头解释，那个镜头就是理论。理论是主导的。[[Argument_Knudsen_2017_NordSTEP\|(Knudsen, 2017, pp. 258–259)]]
>
> *“Evidence does not mean there should not be theory. Evidence is interpreted; evidence is interpreted through a lens, and that lens is theory. Theory is dominant.”*
...
> - [[Argument_Fredens_2015_Paideia\|Fredens, 2015]] — 从脑科学与学习科学视角评析 Hattie 教学原则在丹麦的[[Going Native\|本土化]]转译。
> - [[Argument_Qvortrup_2015_Paideia\|Qvortrup, 2015]] — 运用动态知识学习模型回应丹麦批评，重建学习结果多维概念。
> - [[Argument_Laursen_2015_Paideia\|Laursen, 2015]] — 评估《可见的学习》核心综合在丹麦公立学校改革中的总体适用性。
> - [[Argument_Qvortrup_2019_NordSTEP\|Qvortrup, 2019]] — 从[[Niklas Luhmann\|卢曼]]系统论与[[Structural Coupling\|结构耦合]]视角为 Hattie 辩护，批判意识形态解释社群。
> - [[Argument_Golovchin_2019_ESC\|Golovchin, 2019]] — 基于变差系数与数据极端不均匀性建议俄罗斯教育政策慎用 VL。
> - [[Argument_Bainbridge_2022_ROE\|Bainbridge et al., 2022]] — 审视英国教育政策将 Hattie 列为官方认可证据来源的治理效应。
> - [[Argument_Steiner-Khamsi_2024_CE\|Steiner-Khamsi et al., 2024]] — 揭示北欧五国政策咨询网络在法定规制阶段对 Hattie 等学术明星的海量引文过滤。
...
>
> *“It is obvious that Hattie in fact has not found the Holy Grail... It is a debate of bottom-up school improvers against technocratic, administratively driven, centralist neo-liberal strategies.”*
...
> [!debates] 学术争议
>
> > [!axis] Snook-Hattie 论战：[[Meta-analysis\|元分析]]质量、截断值与因果外推
> > 围绕 2009–2010 年《新西兰教育研究杂志》（New Zealand Journal of Educational Studies，NZJES）三大回合交锋，争论[[Meta-meta-analysis\|元综合]]是否构成“垃圾进垃圾出”与误导性因果外推。
> >
> > - **Ivan Snook 等人批判** 指出元分析未评估纳入研究质量，武断设定 $d=0.40$ 截断值，平均化掩盖了[[Homework\|家庭作业]]（小学 0.15 vs 中学 0.64）和[[Class Size\|班级规模]]的复杂性，选择性排除解释 70–80% 差异的非学校社会背景，沦为技术官僚的“银弹式”行政工具。[[Argument_Snook_2009_NZJES\|(Snook et al., 2009)]]; [[Argument_Snook_2010_NZJES\|(Snook et al., 2010)]]
> > - **Hattie 本人辩护** 辩护称该书并非关于研究批评的专著，凡已知质量问题均已标注；$d=0.40$ 基于 800+ 元分析经验平均值作为叙事工具而非绝对戒律；坚持将[[Research Scope\|研究范围]]界定在“教育者可控制的学校因素”。[[Argument_Hattie_2010_NZJES\|(Hattie, 2010, pp. 88–92)]]
>
> > [!axis] 社会的良知与批评者：专业技术辩护 vs 结构性社会公正
> > 围绕新西兰大学立法赋予学者的法定角色，争论学者介入公共政策的伦理边界。
> >
> > - **[[Gerald Grace]] 批判** 批评 Hattie 混淆了学科内部技术批判的“学术批评者”与必须将阶级、贫困等非学校因素置于核心地位的“[[Critic and Conscience of Society\|社会的批评者与良知]]”，选择性排除社会背景与良知角色存在根本矛盾。[[Argument_Grace_2010_NZJES\|(Grace, 2010, pp. 90–91)]]
> > - **Hattie 职能自辩** 坚持援引法定条款为公共参与辩护，主张学者应遵守仅在专业领域发言、展示谨慎提升专业的自我约束原则。[[Argument_Hattie_2010_NZJES\|(Hattie, 2010, pp. 86–87)]]
>
> > [!axis] 统计方法学审查：通用连续体与伪综合指控
> > 围绕六个分析步骤与计算逻辑，统计学界与比较教育学界展开严格的方法论质询。
> >
> > - **Wecker 等人** 构建三层[[Analytic Framework\|分析框架]]揭示六步骤均存方法缺陷（Fisher's z 省略、[[Standard Error\|标准误]]与标准差混淆、无[[Confidence Interval\|置信区间]]检验、[[Fixed-Effect and Random-Effects Models\|固定效应模型]]不适），判定愿景有远见但科学上不可行。[[Argument_Wecker_2016_ZfE\|(Wecker et al., 2016)]]
> > - **Bergeron 与 Rivard** 从统计学家视角定性为伪科学：常用[[Effect Size\|效应量]]（Common Language Effect Size，CLE）计算错误出现负概率、不同效应量公式产生矛盾排名、聚合任意性。[[Argument_Bergeron_2017_MJE\|(Bergeron & Rivard, 2017)]]
...
> [!critique]- 批评索引
> - [[Argument_Terhart_2011_JCS\|Terhart, 2011]] — [[Didaktik\|教学理论]]内容空洞、Popper 误用与可见性福柯式支配批评。
> - [[Argument_Allerup_2015_Paideia\|Allerup, 2015]] — 效应量排名[[Sample Size Determination\|样本量]]依赖、置信区间缺失与社会经济背景控制批评。
> - [[Argument_Wecker_2016_ZfE\|Wecker et al., 2016]] — 三层分析框架揭示六步骤统计方法论缺陷与模型不适。
> - [[Argument_Bergeron_2017_MJE\|Bergeron & Rivard, 2017]] — CLE 负概率计算错误、基线任意性与伪科学定性。
> - [[Argument_Eacott_2017_SLM\|Eacott, 2017]] — 澳大利亚[[School Leadership\|学校领导力]]屈从于大师崇拜与新泰勒主义批判。
> - [[Argument_Zhao_2017_JEC\|Zhao, 2017]] — 直接教学（DI）效应量证据背后的创造力抑制与非生产性成功副作用。
> - [[Argument_Rømer_2018_EPT\|Rømer, 2018]] — 五线哲学批判：评价理论篡位教育、激进[[Constructivist Paradigm\|建构主义]]消解教学与[[Dependent Variable\|因变量]]不清。
> - [[Argument_Larsen_2019_EducSci\|Larsen, 2019]] — [[Phenomenology\|现象学]]与自由哲学视角的“盲视”（Blindness）框架批判与 Bildung 替代。
> - [[Argument_Golovchin_2019_ESC\|Golovchin, 2019]] — 变差系数过高与数据集极端不均匀性批评。
> - [[Argument_OConnor_2020_AJLL\|O'Connor, 2020]] — 全语言分类错误、不对称修正与先验偏见驱动审查。
> - [[Argument_McKnight_2020_Discourse\|McKnight & Whitburn, 2020]] — 女性主义与能力批判视角下的文化政治七点批判。
> - [[Argument_Nielsen_2021_IRTP\|Nielsen & Klitmøller, 2021b]] — 哈贝马斯合法化危机视角：技术理性内核满足政治合法化需求。
...
> - **对排名的放弃与立场转向** Hattie & Donoghue（2016）承认策略内部变异过大而放弃单一排名，开发三阶段学习模型；公开表示若能重来会极力避免“结果的暴政”；2020 年演讲进一步肯定失败与[[Inquiry-Based Learning\|探究式学习]]的价值，呈现出晚期理论反思与早期直接教学排名的割裂。[[Argument_Blass_2020_JESP\|(Blass, 2020, pp. 95–96)]]
...
> | [[Evidence for Learning]] | 事实 | 出任其学校专家咨询委员会主席，指导澳大利亚循证工具包与实践指南的[[Going Native\|本土化]]。 |
...
> | [[Formative Assessment]] | 概念 | 将高影响反馈与可见学习[[Transfer Translation Transformation\|转译]]为形成性评估与 asTTle 测评工具。 |
> | [[Evidence-Based Education]] | 概念 | 作为全球循证教育运动的象征性人物，推动量化证据深度嵌入政策标准。 |
> | [[Critiques of Visible Learning]] | 概念 | 激发了当代教育学界针对元分析伪科学、[[Neo-Taylorism\|新泰勒主义]]与技术理性的系统批判。 |
> | [[Policy Brokerage]] | 概念 | 其学术成果与培训网络被跨国组织与国家专家委员会作为政策中介的重要合法化工具。 |
> | [[Governing by Numbers]] | 概念 | 其指标排序为国家与学区实施基于数字的学校绩效问责与远处规制提供了操作[[Scaffolding\|脚手架]]。 |
