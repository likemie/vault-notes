...
> - **1999 至 2000** 年通过奥克兰大学受教育部合同领导开发教学与学习评估工具（Assessment Tools for Teaching and Learning，asTTle），基于光盘的教师管理型国家课程测试系统，用于[[Formative Assessment|形成性评估]]，任项目主任
...
> [!abstract] Hattie, J., [[John Biggs|Biggs, J.]] & Purdie, N. (1996). Effects of learning skills interventions on student learning. *Review of Educational Research*, 66(2), 99–136.
...
> [!info] 教学观
> - **可见的教与学** ”当教师成为自身教学的学习者、学生成为自身教师时，对学生学习产生最大效应”（Hattie, 2009, p.271，引自 [[Argument_McKnight_2020_Discourse|McKnight & Whitburn, 2020, p.40]]）
> - **教师作为激活者与促进者** Hattie 基于分析结果将教师角色分为两类。激活者平均[[Effect Size|效应量]] $d = 0.60$，策略包括交互教学（$d = 0.74$）、反馈（$d = 0.72$）、[[Metacognition|元认知]]策略（$d = 0.67$）、[[Direct Instruction|直接教学]]（$d = 0.59$）、精熟学习（$d = 0.57$）。促进者平均 $d = 0.17$，策略包括模拟与游戏（$d = 0.32$）、探究式教学（$d = 0.31$）、小班教学（$d = 0.21$）、问题式学习（$d = 0.15$）、[[Whole Language|全语言]]（$d = 0.06$）（Hattie, 2009, p.243；Terhart, 2011, p.433）
> - **忠实执行** 强调对方案的一丝不苟的遵循。Hattie 从咖啡连锁店授权经营模式中获取灵感，核心关注质量控制。在培训中，五人中仅一人通过认证，因为”几乎每个教师都想站起来讲自己的故事、轶事和课堂。我们不允许这样”([[Argument_Knudsen_2017_NordSTEP|Knudsen, 2017, p.254]])
> - **从个人教师到学校改进工程** 教师要把自己对学生学习造成了什么影响作为持续判断对象，但这件事不能靠教师单打独斗，而要通过教师协作、课堂观察、数据使用与能力建设，变成整个学校的工作方式([[Argument_Nordahl_2015_Paideia|Nordahl, 2015, pp.61–67]])
...
> [!info] 证据观
> - **[[Effect Size|效应量]]关节点 $d = 0.40$** 以 $d = 0.40$ 作为比较教育影响的经验参考点，而非脱离情境的硬性戒律。Hattie 后来强调低于 0.40 的效果仍需结合学段、结果类型和同类研究解释（Hattie, 2015, pp.11, 17）。详见 [[Effect Size#Hattie 的关节点与影响气压计]]
...
>
> **新西兰与澳大利亚**[[Argument_Sarbiewska_2019_JSR|Sarbiewska (2019)]] 从波兰教育者视角系统记录了 《[[Visible Learning|可见的学习]]》在新西兰和澳大利亚的政策采纳轨迹——2003 年 新西兰教育部长 Trevor Mallard 将优质教学作为优先议程；[[PISA|国际学生评估项目]]（Programme for International Student Assessment，PISA）2001 数据揭示校内差异是主要问题后，政策焦点从外部因素转向师生互动；澳大利亚维多利亚州 高影响教学策略（High Impact Teaching Strategies，[[Victorian HITS and Literacy Toolkit|HITS]]）和新西兰教育审查办公室 将 《可见的学习》原则制度化。
>
> **斯堪的纳维亚的学校改进[[Transfer Translation Transformation|转译]]** [[Argument_Nordahl_2015_Paideia|Nordahl (2015)]] 提供了一条与商业化品牌扩张不同的接受路径。这里的 Hattie 既不是单纯的[[Effect Size|效应量]]排行榜作者，也不是外部问责工具的代名词，而是被转译为“学校为何必须围绕学习结果重组改进工作”的论据来源。其关键影响不在推广某个单一方法，而在推动学校把 [[Professional Judgment|专业判断]]、教师协作、[[Knowledge Mobilisation|知识动员]]与学习结果评估重新绑在一起([[Argument_Nordahl_2015_Paideia|Nordahl, 2015, pp. 61–69]])。
>
> **北欧政策咨询体系中的引文过滤与制度权威落差** [[Argument_Steiner-Khamsi_2024_CE|Steiner-Khamsi et al. (2024, pp. 547–548)]] 对北欧五国政策咨询网络（[[Policy Brokerage|政策中介]]系统）的实证追踪揭示出个体学术明星与制度化跨国组织之间的巨大权威落差：以挪威教育部推行能力导向课程改革为例，5 个政府专家委员会在咨询报告中累计引用 464 篇[[Document|文献]]，广泛动员 Hattie 等全球知名学者的[[Meta-analysis|元分析]]成果以营造循证客观性；但当教育部最终起草颁布法定行政法令（Ministerial Decrees）时，文献被急剧过滤至仅存 22 篇（损耗率超 95%），且其中 20 篇全部来自专门审查[[OECD|经济合作与发展组织]]（Organisation for Economic Co-operation and Development，OECD）能力界定与选择（Definition and Selection of Competencies，DeSeCo）项目的委员会。实证表明，尽管北欧专家咨询层热衷借用 Hattie 等学术大师的实证声誉进行议程倡导，但在具有硬性法律效力的行政规制出台阶段，主权国家官僚系统实施了极端的政治筛选，个体学术权威在最终法定文本中几乎被彻底剔除，其制度穿透力远逊于经合组织等建构硬性标准的跨国治理复合体。
>
...
>
> **丹麦** 2014 年学校改革明确引用《可见的学习》后，Hattie 被丹麦批评者从"教育英雄"转变为"教育敌人"。[[Argument_Fredens_2015_Paideia|Fredens (2015)]] 书评以正面立场评述 Hattie & Yates (2014) 丹麦语译本；[[Argument_Qvortrup_2015_Paideia|Qvortrup (2015)]] 以支持者立场回应批评，同时承认学习结果概念需通过 [[Dynamic Knowledge and Learning Model]] 加以重建；[[Argument_Laursen_2015_Paideia|Laursen (2015)]] 认为 《可见的学习》核心综合在丹麦"总体上"适用；随后丹麦语批评文集 *[[Hattie på dansk]]* (2017) 汇集多篇批评；[[Argument_Qvortrup_2019_NordSTEP|Qvortrup (2019)]] 进一步辩护，将批评定性为意识形态驱动的解释社群现象。丹麦争议的详细分析参见 [[Visible Learning#丹麦争议（2014–2019）]]。
>
> **俄罗斯** 2017 年 《可见的学习》俄文版出版后在俄罗斯学界获得热烈反响：Borisenko（2018）称其为"翻译教育[[Document|文献]]出版领域的主要事件"；Vachkov & Vachkova（2018）呼吁使用[[Meta-analysis|元分析]]"检验教学创新的生产力"；Sokolova（2017）将《可见的学习》与俄罗斯联邦国家教育标准联系起来([[Argument_Golovchin_2019_ESC|Golovchin, 2019, p. 237]])。然而 [[Argument_Golovchin_2019_ESC|Golovchin (2019)]] 基于方法论和文化分析建议俄罗斯教育政策不应采用《可见的学习》。
...
> [!warning] Snook-Hattie 论战 (2009–2010)
> *[[Visible Learning]]* (2009) 出版后引发的第一场系统学术论战，以《新西兰教育研究杂志》（New Zealand Journal of Educational Studies，NZJES）为阵地，历时三个回合。
>
> **第一回合：[[Argument_Snook_2009_NZJES|Snook et al. (2009)]] — Invisible Learnings?**
>
> Snook, O'Neill, Clark, O'Neill, & Openshaw (2009) 发表 *Invisible Learnings? A Commentary on John Hattie's book: Visible Learning*，从七个维度系统质疑《可见的学习》的方法论和政策外推：
...
>
> Hattie 以 *On Being a 'Critic and Conscience of Society'* 回应，援引新西兰《教育法》赋予学者的法定角色为公共参与伦理基础，以 Alexander (2010) 的四种腐蚀性话语（二分法、嘲弄、神话、意义虚无）分析批评模式：
...
> - 可推广性："翻译现有研究可能比根本不依赖任何研究更有价值"
> - 非学校因素：承认"可能比书中讨论的许多问题更重要"，但[[Research Scope|研究范围]]限定在"教育者能控制的因素"
>
> **第三回合：[[Argument_Snook_2010_NZJES|Snook et al. (2010)]] — Critic and Conscience of Society: A Reply**
>
> Snook, Clark, Harker, O'Neill, & O'Neill (2010) 发表再回应，逐点论证 Hattie 的辩护未能充分解决实质性方法论关切：
...
> - 重申核心立场：元分析"常模糊而非照亮良好政策决策所需的信息"，效应量清单鼓励"银弹式回应"
>
> 同期 **Smythe (2010)** 在另一渠道发表了"Visible Shipwreck"系列批评文章([[Argument_Terhart_2011_JCS|Terhart, 2011, p.435]])。
>
> 在这场论战之外，Hattie 在新西兰还面临更广泛的争议：被批评在教学与学习评估工具（asTTle）的推广中存在经济利益，模糊了科学家、政治顾问和商业利益者之间的界限；被指控提倡绩效薪酬、忽视社会背景和不平等([[Argument_Terhart_2011_JCS|Terhart, 2011, p.434–435]])。
>
...
> 在 [[Argument_Hattie_2010_NZJES|Hattie (2010)]] 和 [[Argument_Snook_2010_NZJES|Snook et al. (2010)]] 的论战之后，[[Gerald Grace]]——"[[Critic and Conscience of Society]]"概念的原作者和新西兰大学立法中该条款的推动者——在同一卷 NZJES（Vol. 45, No. 2）发表评论，质疑 Hattie 是否真正理解了该概念的含义([[Argument_Grace_2010_NZJES|Grace, 2010, p. 90]])。
>
...
> [!warning] 方法论批评
> - **[[Argument_Terhart_2011_JCS|Terhart (2011)]]** — 《可见的学习》最早的学术书评之一：识别[[Meta-meta-analysis|元-元分析]]的信息损失与稳定性/变异性双重困境；批评[[Didaktik|教学理论]]内容空洞（Popper 误用、[[Bildung]] 缺失）；从 Foucault 视角定性可见性为"精致的支配形式"。结论："很明显 Hattie 事实上没有找到圣杯"（详见 [[Visible Learning#Terhart (2011)]]）
> - **[[Argument_Allerup_2015_Paideia|Allerup (2015)]]** — 从统计学角度批评 Hattie 用效应量给教学干预排序：d=0.40 与显著性的关系依赖[[Sample Size Determination|样本量]]，排名未系统报告[[Confidence Interval|置信区间]]、[[Standard Error|标准误]]或相邻 d 值的显著性检验，且国际数学与科学[[Trend Study|趋势研究]]（Trends in International Mathematics and Science Study，TIMSS）2011 例子显示边际效应量在[[Societies of Control|控制社会]]经济背景后可明显下降（详见 [[Effect Size#基本公式与构成逻辑]]、[[Meta-meta-analysis#技术方法论缺陷]]）
> - **[[Argument_Wecker_2016_ZfE|Wecker et al. (2016)]]** — 迄今最系统的技术评估：构建三层[[Analytic Framework|分析框架]]，发现六个分析步骤均存在方法论不足（数据基础缺失、Fisher's z 省略、标准误（Standard Error，SE）与标准差（Standard Deviation，SD）混淆、重复数据未中和、简单平均替代加权、无置信区间（Confidence Interval，CI）与显著性检验）；外部批判揭示[[Fixed-Effect and Random-Effects Models|固定效应模型]]不适、138 因素不可比、d=0.40 实质意义存疑。综合判断：愿景"有远见"但方法"以科学合理的方式不可行"（详见 [[Visible Learning#Wecker et al. (2016)]]）
> - **[[Argument_Bergeron_2017_MJE|Bergeron & Rivard (2017)]]** — 统计学家视角定性为伪科学：常用效应量（Common Language Effect Size，CLE）计算错误（负概率）、基线比较任意性、三种效应量公式产生矛盾排名、r→d 转换危险、聚合任意性。结论："任何人都不应该复制这种方法论"（详见 [[Visible Learning#Bergeron & Rivard (2017)]]）
> - **[[Argument_Golovchin_2019_ESC|Golovchin (2019)]]** — 变差系数检验：Vσ=56.87%，数据集"极端不均匀"；[[Systematic Review|系统综述]] 10+ 位批评者论点；建议俄罗斯教育政策不采用《[[Visible Learning|可见的学习]]》（Visible Learning，VL）（详见 [[Visible Learning#Golovchin (2019)]]）
> - **[[Argument_OConnor_2020_AJLL|O'Connor (2020)]]** — [[Whole Language|全语言]]案例审查：分类错误（[[Language Experience Approach|语言经验法]]≠全语言）、不对称审查（接受 d=-0.65/修正 d=+0.65）、选择性修正（VL 唯一被修正的元分析），不加权平均、[[Primary and Secondary Documents|次级文献]]系统性忽略。论证先验偏见驱动数据选择（详见 [[Visible Learning#O'Connor (2020)]]）
...
> [!warning] 文化与政治批评
> - **[[Argument_ONeill_2012_NZJES|O'Neill (2012)]]** — 以 新西兰财政部 2011 年简报为案例，揭示了 Hattie 的《可见的学习》证据在政策论述中被脱离语境援引的具体机制。Treasury 援引"教学质量"证据论证可增加生师比，但 Hattie 本人明确反对、且该证据全部来自大学生评教研究对学校教育无相关性（详见 [[Treasury Briefing on Student-Teacher Ratios]]）
> - **[[Argument_ONeill_2016_Report|O'Neill et al. (2016)]]** — 以"政策创业"框架系统追踪 Hattie 从 asTTle 到 Visible Classroom 的商业化轨迹，记录 2010–2014 年从 [[Cognition Education|Cognition Education]] 获得第三方付款（USD 10K → USD 223K），定性为公共福利、非营利和营利创业的"无缝融合"（详见 [[Visible Learning Branding and Global Influences]]）
> - **[[Argument_Eacott_2017_SLM|Eacott (2017)]]** — 以 Callahan (1962) 为历史框架论证澳大利亚[[School Leadership|学校领导力]]已屈服于"Hattie [[Cult of the Guru|大师崇拜]]"，定性 VL 为 [[Neo-Taylorism|新泰勒主义]]：将教学拆解为最小可测量单元，"与 100 多年前 Taylor 的工作相差不远"（详见 [[Visible Learning#大师崇拜]]）
> - **[[Argument_Eacott_2019_IJLE|Eacott (2019)]]** — 以自身经历记录 Hattie 回应过程中的学术[[Dialogue in Education|对话]]质量问题：Hattie 回应两天内被接收 vs 原论文"数月和多轮评审"；Eacott 被拒绝发表再回应（详见 [[Visible Learning#Eacott (2019)]]）
> - **[[Argument_McKnight_2020_Discourse|McKnight & Whitburn (2020)]]** — 从女性主义、[[Post-structuralism|后结构主义]]和能力批判视角提出七点文化政治批评：新自由主义监控、色情片逻辑类比、拒绝对话、忽视关怀伦理、接近法西斯主义、过度简化、能力主义假设（详见 [[Visible Learning#文化政治七点批评]]）
...
> - **[[Argument_Steiner-Khamsi_2024_CE|Steiner-Khamsi et al. (2024, pp. 547–548)]]** — 从[[Policy Brokerage|政策中介]]与跨国[[Governing by Numbers|数字治理]]视角批判学术明星在国家法定规制中的制度局限：基于北欧五国政策咨询网络追踪（特别是挪威教育部能力导向课程改革法令），揭示政府专家委员会在咨询报告中海量引用 Hattie 等明星学者的循证综合以充当外部合法化杠杆；但进入法定行政法令（Ministerial Decrees）起草阶段，464 篇专家文献遭断崖式筛选仅存 22 篇，个体学术权威被全数剔除，而[[OECD|经合组织]]（OECD）DeSeCo 项目框架独占 20 篇。这证实个体“大师”的循证叙事仅是政策周期前端的策略性外在化工具，面对经合组织等建构系统性量化指标的跨国制度复合体，个体学术权威在主权国家硬性规制层面缺乏持久的制度生存力。

> [!warning] 教育哲学批评
> - **[[Argument_Rømer_2018_EPT|Rømer (2018)]]** — 五线哲学批判：评价理论取代教育、[[Dependent Variable|因变量]]概念不清、[[Radical Constructivism|激进建构主义]]消解教学、反馈集权化、误读 Popper 三个世界理论。与 Nielsen & Klitmøller（2021b）形成互补——前者追问理论前提是否正确，后者追问为什么错了还如此成功（详见 [[Visible Learning#Rømer (2018)]]）
> - **[[Argument_Larsen_2019_EducSci|Larsen (2019)]]** — 从[[Phenomenology|现象学]]、神经科学、自由哲学和概念史四个领域整合为统一的"盲视"（blindness）批判框架：学习对学习主体并非即时可见；大脑-身体-社会复杂性不可还原为简单测量；教师可见的学习（Visible Learning，VL）不等于学生有意识/无意识学习；学习不是[[Value Neutrality|价值中立]]的概念，应以 [[Bildung]] 替代。Larsen 追问的核心问题是"《可见的学习》在原则上能看到什么、不能看到什么？"（详见 [[Visible Learning#观看中的盲视与 Bildung 替代（Larsen, 2019）]]）
> - **[[Argument_Zhao_2017_JEC|Zhao (2017)]]** — 以副作用框架审视 Hattie 将[[Direct Instruction|直接教学]]（Direct Instruction，DI）评为 d=0.59 的效应量证据：虽然 DI 在成绩测试上有效，但同时存在抑制[[Creativity|创造力]]、限制自发探索、产生"非生产性成功"等副作用。
> - **[[Argument_Nielsen_2021_IRTP|Nielsen & Klitmøller (2021b)]]** — 以 Habermas 合法化危机理论解释 《可见的学习》全球流行：VL 的吸引力在于其[[Technical Rationality|技术理性]]内核满足了教育系统的合法化需求，而非其科学质量（详见 [[Visible Learning#合法化危机与技术理性（Nielsen & Klitmøller, 2021）]]）
> - **[[Argument_Nielsen_2021_NordPsych|Nielsen & Klitmøller (2021a)]]** — 论证 Hattie 是教育理论家而非纯统计学家：追溯行为主义理论谱系（Skinner→Glaser→Hattie, 1987），对 《可见的学习》反馈效应（d=0.73）的 5 项最重元分析逐项审查，发现 4/5 未研究 Hattie 所定义的反馈。

> [!warning] Hattie 的回应与立场演变
> #### 对批评的直接回应
>
> - [[Argument_Hattie_2010_NZJES|Hattie (2010)]] 以新西兰《教育法》赋予学者的"critic and conscience of society"法定角色为其公共参与的伦理基础，并制定三条自我约束原则：（1）仅在专业领域内发言；（2）基于自身的阅读和对研究的解读；（3）始终以展示尊重和谨慎来提升专业。
> - 承认"很少有人对其提出质疑"（Hattie, Masters, & Birch, 2016，引自 McKnight & Whitburn, 2020, p.33）
> - 针对 [[Argument_Eacott_2017_SLM|Eacott (2017)]]，[[Argument_Hattie_2017_SLM|Hattie (2017)]]发表回应"Educators are not uncritical believers of a cult figure"，援引 Popper and Said 为学术批评传统，逐条反驳 Eacott 的三项主张（详见 [[Cult of the Guru#争议与批评]]）。
...
> #### 立场演变与距离感
>
> - **Hattie & Donoghue (2016) 放弃排名** 在试图完成另一个排名元分析时，因发现策略内部变异太大而放弃排名，转而开发三输入（技能/意愿/激情）三阶段（表层/深层/迁移）学习模型。该模型承认对[[Problem-Based Learning|基于问题的学习]]（Problem-Based Learning，PBL）的批评可解释为一年级医学生仍处于[[Surface and Deep Learning|表层学习]]阶段([[Argument_Blass_2020_JESP|Blass, 2020, pp.95–96]])
