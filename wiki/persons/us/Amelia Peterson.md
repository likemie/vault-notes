...
> 2. **改进网络**为机制实验的发现提供实施和[[Feedback|反馈]]基础设施
...
> 2. **从伙伴关系方法中提取学习**：What Works 系统行动者承担协调机构的新角色，系统性地捕捉和[[Jing (Refined Mastery)|精]]炼跨网络和现有试验库中的"猜想"——即从业者和研究者在改编项目使其在情境中有效时关于什么导致学生改进的隐含假设
