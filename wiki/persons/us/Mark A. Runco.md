...
aliases:
  ...
  - 马克·朗科
  - Mark Runco
summary: "美国创造力心理学家，Creativity Research Journal 创刊主编，在发散思维测量、创造潜能理论与创造力评估领域做出了系统性学术贡献"
type: person
nationality: "us"
person_region: "us"
...
> - **核心角色** 创造力心理学与教育评估领域的关键奠基人之一，在[[Divergent Thinking|发散思维]]测量效度、观念行为量表（RIBS）开发及创造潜能理论构建中承担核心节点角色。
...
> [!claim] [[Creativity|创造潜能]]的普遍性与可干预性
> 创造力本质上是一种可被识别与培养的普遍潜能（Creative Potential），而非少数天才独有的特质；教育与环境的首要任务是识别潜能并提供适切的认知与情境支持，使其转化为显性创造表现（Creative Performance）。[[Argument_Runco_2026_CRJ|(Runco et al., 2026, pp. 2–4)]]
...
> [!claim] 过程构件与效标问题
> [[Divergent Thinking|发散思维]]（Divergent Thinking）是评估创造潜能的核心认知构件，但仅代表构想生成阶段；解决创造力测量长期面临的效标问题（The Criterion Problem）需要整合问题发现、观念生成与多维外认知调节[[Variable|变量]]。[[Argument_Runco_2026_CRJ|(Runco et al., 2026, pp. 6–8)]]
...
> [!timeline] 生平与职涯
> - **1988** 创办学术期刊《[[Creativity|创造力]]研究期刊》（*Creativity Research Journal*）并长期担任主编，推动创造力研究的实证化与跨学科发展。
> - **1990s** 提出认知与创造力整合模型（Runco & Chand, 1995），开发朗科观念行为量表（Runco Ideational Behavior Scale, RIBS）。
> - **2000s–2010s** 深入探讨[[Divergent Thinking|发散思维]]测试的[[Criterion-related Validity|效标关联效度]]与效标问题，主编多部权威创造力手册。
> - **2026** 领衔完成首个覆盖 52 项一阶[[Meta-analysis|元分析]]、124 万参与者的创造力[[Meta-meta-analysis|二阶元分析]]研究。[[Argument_Runco_2026_CRJ|(Runco et al., 2026)]]
...
> [!person-network] 关系网络
> - **合作者** Mark A. Runco 长期与 S. Acar、M. Karwowski、R. J. Sternberg 等[[Creativity|创造力]]学者开展合作研究与手册编纂。
> - **机构** 历任加州州立大学富勒顿分校、乔治亚大学、阿尔托大学教授，《Creativity Research Journal》编辑部。
...
> [!debates] 学术争议
>
> > [!axis] 效标问题与[[Divergent Thinking|发散思维]]的[[Predictive Validity|预测效度]]
> > 探讨发散思维测验是否能够有效预测现实生活中的重大[[Creativity|创造性]]成就。
> >
> > - **Runco (2024)** 强调发散思维测量的是创造潜能而非最终成就，潜能需要动机、环境支持与专业领域技能的共同配合才能转化为实际成果。
> > - **[[Argument_Runco_2026_CRJ|Runco et al. (2026)]]** [[Meta-analysis|元分析]]数据显示发散思维与创造力结果存在稳健的正相关（$r = 0.14$），而综合创造过程的关联更强（$r = 0.27$）。
