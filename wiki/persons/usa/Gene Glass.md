...
> - **核心角色**：元分析（Meta-analysis）方法的奠基人，在社会科学与医学定量研究综合网络中承担核心方法论建构者的节点角色。
...
> | 类型 | 条目 | 贡献 |
> |:-----|:-----|:-----|
> | 概念 | [[Effect Size\|效应量]] | 将效应量以标准差单位表示，确立为跨不同量具进行效果比较的通用尺度。 |
> | 方法 | [[Meta-analysis\|元分析]] | 1976 年首次定义并应用该方法，整合零散研究发现，其思想间接影响了元-元分析和循证工具包的开发。 |
...
> - **方法路径**：使元分析成为医学、心理学和教育学的标准综合方法，效应量（如 Glass's $\Delta$）至今是定量研究的标准报告指标。
