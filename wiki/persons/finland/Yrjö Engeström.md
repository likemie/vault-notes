...
Engeström（2001）的第三代活动理论聚焦于跨越不同活动系统边界的过程。其核心[[Hypothesis|假设]]包括([[Argument_Wang_2025_CE|Wang & McLaughlin, 2025, pp.590-591]])：
...
> [!quote]
> "活动理论将人类实践概念化为集体活动，'活动'——定义为'一个有对象导向和文化形塑的结构'——成为分析单元"（Engeström, 1999, p.21，引自 [[Argument_Wang_2025_CE|Wang & McLaughlin, 2025, p.590]]）
...
- 在教育改革研究中，[[Third Generation Activity Theory|第三代活动理论]]被用于分析不同教育目标系统之间的张力与可能的协同。[[Argument_Wang_2025_CE|Wang & McLaughlin (2025)]]以该理论为框架，分析了中国学校中[[Test-Based Accountability|考试问责]]系统与 [[Learner-Centred Education|LCE]] 改革系统之间的互动和共享目标的建立（pp.590-601）。
