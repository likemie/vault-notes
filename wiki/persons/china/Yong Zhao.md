...
> [!tip]
> Yong Zhao 的核心思想围绕两个相互关联的批判框架展开。
...
- 核心内容：从医学引入副作用概念，论证效果与副作用的不可分离性。
- 思想发展：以[[Direct Instruction|直接教学]]、东亚教育体系、[[No Child Left Behind Act 2001|NCLB]] 三个案例展开论证。
- 相关概念／理论：[[Side Effects]]、[[Direct Instruction]]、[[Randomised Controlled Trials]]。

### 2020 — PISA 系统性批评

- 核心内容：从教育观、实施和解释三个维度揭示 [[PISA]] 的根本缺陷。
- 思想发展：从副作用框架扩展到对国际评估系统的全面批评，指出 PISA 批评未能阻止其影响力扩大的困境。
- 相关概念／理论：[[PISA Made-up Claim]]、[[PISA Monolithic View of Education]]、[[PISA Distorted View of Education]]、[[PISA Score Negative Correlation]]、[[PISA Glorifying Authoritarian Education]]。
