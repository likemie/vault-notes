...
aliases: ["曼努埃尔·卡斯特尔斯", "曼纽尔·卡斯特", "Castells, M."]
...
> [!info]
> Manuel Castells（曼努埃尔·卡斯特尔斯，1942–）是西班牙社会学家，以其对信息时代、[[Network Society|网络社会]]和全球化的大规模理论研究而闻名。他的代表作《信息时代：经济、社会与文化》三部曲（*The Information Age: Economy, Society, and Culture*）是信息社会研究的奠基性著作之一，对多个学科产生了深远影响。
...
> [!success]
> - 其[[Informationalism|信息主义]]和[[Soviet Statism|国家主义]][[Analytic Framework|分析框架]]被用于解释苏联和后共产主义国家的技术落后与体制转型困境。
> - [[Network Society|网络社会]]和信息主义的理论概念被广泛引入城市研究、传播学、政治经济学和教育研究等多个领域。
