...
aliases:
  - Latour, B.
  - 布鲁诺·拉图尔
summary: "法国著名哲学家、人类学家与科学社会学家，科学技术学（STS）与行动者网络理论（ANT）的核心奠基人；提出广义对称性、铭文装置、计算中心、不变移动物与重新组装社会理论，为现代教育政策拓扑学、数据基础设施与远处治理研究提供了基础本体论与方法论工具。"
type: person
nationality: france
...
>   - **阶段转向** 从揭露事实的建构性质转向培育对脆弱生态与异质关联的关切与修补伦理。
...
>
> *By acting at a distance on unfamiliar events, places and people, centers of calculation gather inscriptions, combine them and make them legible, enabling a few to dominate the many.* (Latour, 1987)

> [!citation-card] 拉图尔论重新组装社会与追踪行动者痕迹
> 社会不是由社会性的东西构成的，社会是由异质的行动者通过联结所产生的效果。社会学的任务不是用一个叫作‘社会’的神秘力量去解释一切，而是去追踪那些正在重新组装社会的痕迹。（Latour, 2005, pp. 1–11）
>
> *There is no society, no social realm, and no social ties, but there exists translations between mediating sites.* (Latour, 2005)
...
> > - **批判政治经济学者** 批评将电线、量规与人类等同会陷入极度扁平的物化拜物教，模糊了跨国资本与统治精英的道德与阶级剥削责任。
...
> [!warning] 适用边界
> 拉图尔的 ANT 适用于描摹多尺度、异质缠绕与物质技术介入深厚的动态网络；当分析纯粹心理认知加工或高度极权的刚性行政垂直命令时，其解释力有所减弱。
...
> | 条目 | 类型 | 贡献 |
> |:-----|:-----|:-----|
> | [[Actor-Network Theory]] | 理论 | 核心创始人，提出广义对称性与转译社会学。 |
> | [[Assemblage]] | 概念 | 将装配理论引入唯物主义社会学，论述异质实体的社会-物质构型。 |
> | [[Center of Calculation]] | 概念 | 提出计算中心理论，阐释现代科学与治理如何从远处采取行动。 |
> | [[Governing at a Distance]] | 理论 | 为远处治理提供不变移动物与计算中心等关键物质技术机制支撑。 |
> | [[Data Infrastructure]] | 概念 | 为数据基础设施的社会-技术装配属性提供核心[[Ontology\|本体论]]工具。 |
