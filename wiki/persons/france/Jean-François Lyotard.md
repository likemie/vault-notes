...
> [!tip]
> - **[[Narrative Knowledge|叙事知识]]与科学知识的区分**：Lyotard 在《后现代状况》中区分了两种知识类型——叙事知识（narrative knowledge）存在于传统社会的习俗、神话和日常语言中，通过讲故事的方式传递社会规范并自我合法化；科学知识（scientific knowledge）则依赖经验验证、可重复性和[[Falsification|证伪]]逻辑，通过指称外部实在来主张合法性。Lyotard 的核心论点是：科学知识实际上也依赖叙事（如科学进步解放人类的启蒙大叙事）来获得合法性，而后现代的核心特征正是**对这种元叙事的怀疑**（Lyotard, 1979/1984, p.xxiv）
...
> - **发展作为准形而上学**：Lyotard 在其生涯晚期批评发展话语已成为当代主导意识形态——一种**不需要终极目的的准形而上学**，不依附于类似理性和人类自由解放的理念（Lyotard, 1988/1991, p.7），因而是非人的（inhuman）。技术系统以其自主逻辑扩张，不再服务于人的解放而是驱使人适应其效率需求

> [!quote]
> "Simplifying to the extreme, I define postmodern as incredulity toward metanarratives."（Lyotard, 1979/1984, p.xxiv）
> 
> 极其简化地看，我将后现代定义为对元叙事的怀疑。
...
> 
> 权力的合法化就是这样形成的。权力不仅是良好的表演性，也是有效的验证和良好的裁决。它基于效率使科学和法律合法化……因此，权力的增长及其自我合法化，现在正走上数据存储和可获取性以及信息可操作性的路线。

## 影响

... Applied fuzzy match at line 48-100.

> [!success]
> - Lyotard 的[[Narrative Knowledge|叙事知识]]／科学知识区分成为[[Geopolitics of Knowledge|知识地缘政治]]（GPK）研究的关键分析工具。[[Argument_Partaken_2022_Springer|Partaken (2022)]] 运用此区分论证叙事知识在全球 GPK 中处于急剧衰退——不是因为后现代对元叙事的怀疑，而是因为具有商业价值的科学知识得到了国家和产业的有力赞助和推动
