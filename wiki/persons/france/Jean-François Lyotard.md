...
Lyotard 出生于凡尔赛，早年在索邦[[The Great Learning|大学]]学习哲学，后加入社会主义或野蛮（Socialisme ou Barbarie）团体从事激进政治活动。1954 年取得国家博士学位，先后在索邦大学、南泰尔大学、巴黎第八大学任教。1970 年代末转向后现代理论，在魁北克政府委托下撰写了《后现代状况》。晚年任教于美国多所大学，1998 年因白血病在巴黎去世。
...
> [!tip]
> - **[[Narrative Knowledge|叙事知识]]与科学知识的区分**：Lyotard 在《后现代状况》中区分了两种知识类型——叙事知识（narrative knowledge）存在于传统社会的习俗、神话和日常语言中，通过讲故事的方式传递社会规范并自我合法化；科学知识（scientific knowledge）则依赖经验验证、可重复性和证伪逻辑，通过指称外部实在来主张合法性。Lyotard 的核心论点是：科学知识实际上也依赖叙事（如"科学进步解放人类"的启蒙大叙事）来获得合法性，而后现代的核心特征正是"对这种元叙事的怀疑"（Lyotard, 1979/1984, p.xxiv）
> - **表演性与知识合法化**：Lyotard 论证，在后工业社会中知识的合法化标准已从"是否真实"转向"是否有效"——即表演性（performativity）。"权力不仅是好的表演性，而且是有效的验证和好的裁决。它基于效率合法化科学和法律……权力的增长及其自我合法化现在正在走数据存储和可获取性以及信息可操作性的路线"（Lyotard, 1979/1984, p.47）。这一分析预言了当代[[The Great Learning|大学]]排名、研究评估框架和绩效管理的核心逻辑
...
> - 其表演性概念深刻影响了教育社会学和高等教育研究，被广泛用于分析[[The Great Learning|大学]]排名、研究评估、学术资本主义等现象
