...
> [!tip]
> - **[[Narrative Knowledge|叙事知识]]与科学知识的区分**：Lyotard 在《后现代状况》中区分了两种知识类型——叙事知识（narrative knowledge）存在于传统社会的习俗、神话和日常语言中，通过讲故事的方式传递社会规范并自我合法化；科学知识（scientific knowledge）则依赖经验验证、可重复性和证伪逻辑，通过指称外部实在来主张合法性。Lyotard 的核心论点是：科学知识实际上也依赖叙事（如科学进步解放人类的启蒙大叙事）来获得合法性，而后现代的核心特征正是**对这种元叙事的怀疑**（Lyotard, 1979/1984, p.xxiv）
