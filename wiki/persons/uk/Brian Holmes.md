...
> - **1960s — [[Problem Approach|问题法]][[Paradigm|范式]]确立与跨大西洋大论战期** 直面战后教育规划与现代化转型，全面建构[[Problem Solving|问题解决]]法分析程序，向历史学派与归纳学派发起范式论战。
>   - **代表著作** *Problems in Education: A Comparative Approach* (1965)。[[Argument_Kazamias_2009_ForgottenThemes|(Kazamias, 2009, pp. 53–54)]]
>   - **关键概念／方法** [[Problem Solving]]、[[Policy Science in Comparative Education]]、文化滞后与[[Critical Dualism|批判二元论]]。
...
>
> *A science of comparative education must be a generalising science whose hallmark is prediction rather than retrospective explanation. The reformer is primarily interested in the consequences of theoretical actions rather than the causes of his discontent.*

> [!citation-card] [[Critical Dualism|批判二元论]]与文化滞后作为教育危机的解释根源
> 基于波普尔批判二元论，霍姆斯严格区分客观自然法则与可由人类调整的规范法则。社会变迁呈现出结构性的时代不同步（Asynchrony）：技术与经济制度的快速现代化，往往与深层社会制度、文化心态及宗教价值体系的缓慢变迁发生剧烈冲突，这种文化滞后（Cultural Lag）构成了跨国教育危机的普遍症结。[[Argument_Cowen_2023_CE|(Cowen, 2023, p. 328; Holmes, 1965)]]
>
...
> [!citation-card] 规范法则与权变社会学法则的[[Ontology|本体论]]二元分立
> 霍姆斯指出，规范法则是人为设立的道德公约，构成学校运行所处的深层文化情境；而社会学法则则是假说性陈述，用以描述机构功能的实际运行。与物理学定律不同，社会学法则不具有超越时空的绝对普适性，而是具有严格的情境权变性（contingent），其有效性完全受制于适用的初始条件。（Holmes, 1981, pp. 78–80; [[Argument_Mattheou_2009_ScientificParadigm|Mattheou, 2009, pp. 62–63]]）
>
...
> [!citation-card] 霍姆斯对美国经验实证归纳主义的三重[[Epistemology|认识论]]清算
> 霍姆斯尖锐批判美国实证量化学派的归纳进路：其一，仅凭直觉假说收集数据，只能在研究者预设的参照系内自我证实；其二，轻率假定概念可无歧义地[[Operationalization|操作化]]为跨国指标，漠视了不同文化语境为同一概念赋予的异质内涵；其三，过度执迷于可量化指标，导致[[Michael Sadler|萨德勒]]所指的活的精神、[[National Character|国民性格]]以及决策者的政策意志等核心历史维度被彻底扫除出视野。[[Argument_Mattheou_2009_ScientificParadigm|(Mattheou, 2009, p. 66)]]
>
...
> [!citation-card] 卡扎米亚斯论霍姆斯对历史学派的实证挑战
> 卡扎米亚斯在总结历史-哲学母题遭遇的科学化围剿时指出，霍姆斯代表了战后新一代学者最强有力的批判声音：他敏锐抓住了历史学派重解释轻预测的阿喀琉斯之踵，促使后来的历史比较学者反思自身的方法论工具并走向广义科学重构。[[Argument_Kazamias_2009_ForgottenThemes|(Kazamias, 2009, pp. 53–54)]]
>
...
> 迪米特里斯·马修（Dimitris Mattheou）指出，霍姆斯在[[Critical Dualism|批判二元论]]框架下运用跨国规范模式（[[Plato|柏拉图]]、马克思、[[John Dewey|杜威]]）以及国家层面的心理状态模式（[[Michael Sadler|萨德勒]]所谓的活的精神与[[National Character|国民性格]]），既对美国实证派肤浅的[[Variable|变量]][[Operationalization|操作化]]和去情境化提出了尖锐反思，也在很大程度上满足了卡扎米亚斯关于“综合历史与社会科学”的学术追求。[[Argument_Mattheou_2009_ScientificParadigm|(Mattheou, 2009, pp. 66–67)]]
>
> *Reflecting perhaps the influence of the English (and European) humanistic tradition in comparative education, the problem-solving approach reserved a place for history... Thus, in a way, the Holmesian [[Scientific Method|scientific approach]] came, in my judgement, closer to satisfying Kazamias appeal for a synthesis of history and social science.*
...
> [!debates] 学术争议
>
> > [!axis] 演绎[[Problem Approach|问题法]] vs 归纳区域研究法
> > 争论焦点在于比较研究应当从经验事实归纳出发，还是必须由理论假说与问题驱动展开演绎检验。
> >
