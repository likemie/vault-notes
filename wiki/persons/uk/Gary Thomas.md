...
aliases:
- 加里·托马斯
summary: 英国教育学者和方法论批评者，“民间科学观”批判提出者，为教育研究反思RCT黄金标准和因果解释模式提供替代视角。
type: person
nationality: uk
tags:
- Gary Thomas
...
Thomas (2012, p. 28) 提出了"民间科学观"（folk-view of science）这一关键概念——即 EBT 倡导者通过诉诸一种过分简化的、刻板的日常科学形象来获得修辞效果，但未能深入探讨科学的真正特征（Wrigley & McCusker, 2019, p. 111）。

### 证据的阶段论

Thomas (2004, pp. 1–6, 10) 区分了科学探究中证据使用的不同阶段：拼凑/直觉阶段（bricolage/hunch）、灵感阶段（inspirational）、发现阶段（discovery）和确认/证实阶段（corroborative/confirmatory）。他的核心观点是 EBT 只关注证据的最后阶段——确认阶段——而忽视了科学发现过程中同样重要的前几个阶段（Wrigley & McCusker, 2019, p. 111）。
...
Thomas 论证实验通常用于验证而非推进知识：许多重大科学发现和发明并非来自系统程序——青霉素、尼龙、超导性、飞机等（Wrigley & McCusker, 2019, p. 111）。
...
Thomas (2012) 论证教育研究方法必须关注"教育本身的性质和目的"——研究方法的适宜性不能脱离对教育目的（telos）的思考（Wrigley & McCusker, 2019, p. 123）。
