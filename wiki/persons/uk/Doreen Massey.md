...
Massey 反对将空间视为静态容器。社会空间不是预先存在的、等待被填充的空容器（如空体育场），而是处于持续运动之中，由人类行动者不断构建。每个人的生命是在时间中移动的轨迹，这些轨迹在空间中交汇——"如果时间作为变化展开，那么空间作为互动展开"（Massey, 2005, p. 61）。现实从未固定或完成，而是持续[[Emergence|涌现]]的([[Argument_Marginson_2025_ECNUROE|Marginson, 2025, p. 3]])。这一立场是 空间制造 框架的直接理论基础。
...
Massey 最重要的洞见，详见 [[Multiplicity|多重性]] 条目。核心要点：空间是"共存异质性"的领域；全球化加剧而非消解多重性；在开放本体论中，没有权力系统是永久固定的——"总是有松散的末端"（Massey, 2003, p. 5）。[[Argument_Marginson_2025_ECNUROE|Marginson (2025)]]认为这一洞见在高等教育中被反复证实([[Argument_Marginson_2025_ECNUROE|Marginson, 2025, pp. 5–7]])。
...
Massey 强调空间关系中的权力不对称：问题不在于抽象的空间形式，而在于空间及其开放与封闭如何通过社会关系被建构——即"空间-时间的不断变化的[[Power-Geometries|权力几何学]]"（Massey, 2005, pp. 93, 166, 171）。在高等教育中，伦敦、英国和美国是"新自由主义资本主义全球"被生产出来的地点；顶尖英美大学也是全球空间的不平等制造者([[Argument_Marginson_2025_ECNUROE|Marginson, 2025, p. 12]])。这一概念在 [[Geopolitics of Knowledge|知识地缘政治]] 分析中具有核心方法论意义。

### 对尺度的方法论贡献

Massey 反复论证全球空间不是预先给定的、"在外面的"、外在于能动性或地方性的。全球尺度和其他尺度一样，是被建构的、具体的、生活化的。这意味着：尺度不可相互化约（如国家科学有其规范中心，全球科学没有规范中心，由期刊和传播网络构成）；任何[[Scale in Higher Education|尺度分析]]都必须容纳多重轨迹和多重行动者([[Argument_Marginson_2025_ECNUROE|Marginson, 2025, pp. 8–9]])。
