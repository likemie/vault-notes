...
> - **1996** 出版晚期集大成代表作《教学法、符号控制与认同》（*Pedagogy, Symbolic Control and Identity*），深入建构教育装置、[[Recontextualization|再脉络化]]与知识结构图式。
...
>   - **限制代码（Restricted Code）** 依赖高度共享的经验背景与隐性[[Hypothesis|假设]]，语言结构简洁、语境紧密嵌构，多见于传统工人阶级群体，强调集体团结与位置取向。
...
>   - **分类（Classification）** 指不同[[Areas of Knowledge|知识领域]]、学科内容或范畴之间边界的清晰与隔绝程度，关涉权力如何划界。强分类（+C）学科壁垒森严、专业纯粹；弱分类（-C）学科界限模糊、强调交叉整合。
...
>   - **原初[[Champ|场域]]与再脉络化场域** 学术共同体原初生产的专门知识无法直接进驻课堂，必须经过官方再脉络化场域（国家教育部、课程编写组）与教学再脉络化场域（教研员、教科书编者、教师）的选择性挪用与重构。
...
>
> > [!axis] 与[[New Sociology of Education|新教育社会学]]（NSE）的关系界定
...
> > - **[[Argument_Ball_2008_SR|Ball (2008)]]** 澄清指出，伯恩斯坦始终拒绝等同于 NSE；他尖锐批评 NSE 沉溺于抽象[[Phenomenology|现象学]]空谈且缺乏经验实证支撑，坚持依靠严密的社会学分类矩阵与经验数据构建理论大厦。[[Argument_Ball_2008_SR|Ball, 2008, p. 661]]

> [!critique]- 批评索引
> - [[Argument_Ball_2008_SR|Ball, 2008]] — 指出伯恩斯坦过于精密且高度抽象的形式化概念体系，虽然具有惊人的理论生产力，但也筑起了极高的学术理解门槛，在一定程度上加剧了教育社会学内部语言壁垒的割裂。

> [!warning] 未解问题与边界
> 伯恩斯坦的结构代码模型在解释宏观权力与制度分类方面力量强大，但在解释行动者微观日常能动性突破与意外创造时偶显[[Determinism|决定论]]色彩；此外，在移动互联、人工智能与社交媒体席卷的当代，代码控制如何超越传统课堂物理围栏在虚拟空间中重组，仍是留待后继学者持续拓展的学术前沿。
...
> | [[Recontextualization]] | 概念 | 阐明学术原初知识经由官方与教学[[Champ\|场域]]层层重构而转化为课堂内容的再脉络化规则机制。 |
> | [[Regulative and Instructional Discourse]] | 概念 | 提出教学性话语深嵌于规约性话语之中，论证任何课程均不具备[[Value Neutrality\|价值中立]]性。 |
> | [[Totally Pedagogised Society]] | 概念 | 前瞻性预见教学与评估关系向全社会弥散、个体终身被纳入符号控制的现代社会趋势。 |
> | [[Social Realism]] | 概念 | 为后继学者超越[[Radical Constructivism\|激进建构主义]]与后现代相对主义、恢复学科核心知识合法地位提供坚实概念基石。 |
> | [[Critical Theory]] | 理论 | 为批判理论与课程社会学批判意识形态再生产提供了深度的符号与制度结构[[Analytic Framework\|分析框架]]。 |
> | [[Discourse Analysis]] | 方法 | 奠定批判性话语分析在课程政策与教科书研究中的分类、框架与[[Coding in Qualitative Research\|编码]]分析操作规程。 |
> | [[NZ Curriculum Refresh 2021-2026]] | 政策 | 其理论被作为诊断该国新课程改革中科学概念知识[[Attrition\|流失]]与规约性话语泛滥的核心分析框架。 |
