...
aliases:
  - 汤姆·舒勒
  - Schuller, T.
summary: "英国社会科学院（Academy of Social Sciences）院士，长期研究社会资本、终身学习与教育中介，与Tracey Burns合著《教育中介机构的历史与演进》（2022），倡导从单体机构迈向跨机构元协作以建构累积性知识库。"
type: person
nationality: uk
person_region: "uk"
...
> [!claim] 核心主张
> Schuller 的学术关注点在于[[Lifelong Learning|终身学习]]与[[Epistemic Governance|知识治理]]在制度层面的系统性连接。他与 Burns 共同确立的核心诊断是：教育[[Knowledge Mediation|知识中介]]的存续危机根本上是政治与预算治理结构失灵的结果，而非学术质量问题；单一机构在缺乏跨国元协作的情况下，既无法建立具备广泛社会公认度的知识基础，也无法抵御政党轮替与商业利益的侵蚀。唯有通过"中介的中介"机制与二阶[[Systematic Review|系统综述]]，才能完成从"学术证据孤岛"向"全球公认知识大厦"的跃升。

> [!citation-card] Burns & Schuller 论中介机构夭折的政治根源
> 在上述案例中，资金削减更多地与政府更迭直接相关，而非取决于实际影响或[[Performance Indicators|绩效指标]]。[[Argument_Burns_Schuller_2022_BrokerageAgencies|(Burns & Schuller, 2022, p. 64)]]
>
> *"Among the examples above, funding cuts were more related to changes in government rather than impact or performance measures."*
...
> [!influence-path] 影响路径
> - **理论路径** 将[[Lifelong Learning|终身学习]]的广谱视野与中介机构的机构生态学分析相结合，使教育[[Epistemic Governance|知识治理]]的讨论超越单一学段与单一国别局限，推动跨生命周期、跨制度语境的比较研究框架。
...
> | 条目 | 类型 | 贡献 |
> |:-----|:-----|:-----|
> | [[Educational Brokerage Agency]] | 概念 | 与 Burns 共同建立中介机构的类型学框架与15年纵向追踪分析，揭示政治预算周期对机构存续的决定性作用。 |
> | [[Cumulative Knowledge Base]] | 概念 | 提出通过跨机构元协作与二阶综述建构准普遍公认的累积性知识库，超越单体机构孤岛。 |
> | [[Lifelong Learning]] | 概念 | 将终身学习的跨生命周期视野带入教育[[Epistemic Governance\|知识治理]]讨论，拓宽了中介研究的议题边界。 |
> | [[Canadian Council on Learning]] | 机构事实 | 以 CCL 的关停为核心证据，论证联邦制国家缺乏跨辖区法定协议时中介机构的高度脆弱性。 |
