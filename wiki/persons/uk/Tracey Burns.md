...
aliases:
  - 特蕾西·伯恩斯
  - Burns, T.
summary: "加拿大裔英国籍经合组织资深分析师与教育知识治理学者，长期在OECD教育研究与创新中心（CERI）主导教育中介机构研究，与Tom Schuller合著《教育中介机构的历史与演进》，倡导推进跨机构元协作以建构跨国累积性知识库。"
type: person
nationality: uk
person_region: "uk"
...
> - **2016** 与 Florian Köster 合编 OECD 报告《在复杂世界中治理教育》（*Governing Education in a Complex World*），将复杂系统理论框架系统引入教育政策与[[Epistemic Governance|知识治理]]研究。（Burns, Köster & Fuster, 2016）
...
> [!claim] 核心主张
> Burns 的核心论旨在于：教育[[Knowledge Mediation|知识中介]]不能止步于向学校与教师提供[[Abstract|研究摘要]]与工具包，必须在政策、实践与公众媒介三个层面同时发力；中介机构的高夭折率本质上是政治与预算治理失灵的体现，而非学术绩效不足；唯有建立跨机构、跨国别的元中介协作网络（"中介的中介"），并保持对循证医学技术化异化的警惕，才能建构真正具有社会公信力的累积性教育知识基石。

> [!citation-card] Burns & Schuller 论建构累积性知识基石的系统要求
> 正如研究综合本身已经从关注单篇论文迈向二阶[[Systematic Review|系统综述]]一样，中介的结构与流程同样需要在机构与系统之间协同运作，以支持累积性的努力。（p. 66）
>
> *"Just as research synthesis itself has moved beyond a focus on individual research papers to systematic reviews of reviews, so too do the structures and processes of brokerage need to work together across institutions and systems to support a cumulative effort."* [[Argument_Burns_Schuller_2022_BrokerageAgencies|(Burns & Schuller, 2022, p. 66)]]
...
> [!influence-path] 影响路径
> - **理论路径** 将[[Complexity Theory|复杂性理论]]系统引入教育[[Epistemic Governance|知识治理]]，推动学界从"研究生产-传播-采纳"的线性供给模型转向重视社会关系、系统反馈与情境适应的复杂系统视角。
...
> [!person-network] 关系网络
> - **长期合著者** [[Tom Schuller]] — Burns 与 Schuller 自 2007 年以来多次合著与合编，共同建构了[[Educational Brokerage Agency|教育中介机构]]研究的核心[[Analytic Framework|分析框架]]。
> - **项目主任** Nóra Révai — 在 [[Centre for Educational Research and Innovation|OECD CERI]]"强化教育[[Research Impact|研究影响力]]"项目中担任专家顾问委员会成员，Révai 任项目主任。
> - **依托机构** [[OECD]] / [[Centre for Educational Research and Innovation]] — 主要研究与政策输出平台。
...
> | 条目 | 类型 | 贡献 |
> |:-----|:-----|:-----|
> | [[Educational Brokerage Agency]] | 概念 | 提出后真相时代中介机构的三重变迁诊断，确立部委嵌入、政府自治与慈善基金三种治理模式的类型学谱系。 |
> | [[Cumulative Knowledge Base]] | 概念 | 与 Schuller 共同提出"中介的中介"与二阶综述路径，以建构准普遍公认的累积性教育知识库。 |
> | [[Complexity Theory]] | 理论 | 将复杂[[Luhmann's Systems Theory\|系统理论]]引入教育[[Epistemic Governance\|知识治理]]研究，倡导从线性供给转向关注社会关系与情境适应的系统观。 |
> | [[Canadian Council on Learning]] | 机构事实 | 以 CCL 的夭折为核心案例，论证缺乏跨辖区法定制度协议对中介机构存续的致命性。 |
> | [[Centre for Educational Research and Innovation]] | 机构事实 | 主要工作平台，依托 CERI 发布系列 [[OECD]] 教育知识治理政策研究。 |
