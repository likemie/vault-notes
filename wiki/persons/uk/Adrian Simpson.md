...
>
> **测量设计——聚焦度与精确度**（Simpson, 2017, pp.11–14）：聚焦度——假设肥料仅对阳光下豆子有效，测量阳光下的豆子 → 更大效应量。精确度——选 5 颗 vs 10 颗豆子测量 → 后者效应量可达前者的 140%。教育中非标准化测试平均比标准化测试高约 40%（[[Education Endowment Foundation|EEF]] Toolkit 14 项元分析）；对 α=0.75 的测试，20 题使效应量翻倍以上（Figure 3）。
>
