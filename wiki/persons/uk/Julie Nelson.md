...
>
> - **把 EIP 概念做清楚**：与 [[Carol Campbell]] 共同主张 EIP 应被理解成专业判断、系统数据、课堂数据和研究证据的整合，而不是“多看一点研究”的宽泛口号（Nelson & Campbell, 2017, p.129）。
...
> [!success] 主要贡献
> - **EIP 概念框架** — 与 [[Carol Campbell]] 一起把 [[Evidence-Informed Practice]] 系统整合为定义、应用、测量三维问题域。
...
> - 在当前 vault 的分工里，她与 [[Carol Campbell]] 形成互补：Campbell 更偏系统改革与领导力条件，Nelson 更偏概念整合与测量工具。

## 主要著作

> [!abstract] 主要著作
> - Nelson, J., & Campbell, C. (2017). *Evidence-informed practice in education_ meanings and applications*. Educational Research, 59(2), 127–135. — 系统整理 EIP 的含义与应用。
...
> [!note]
> - 任英国 NFER 研究者，工作集中于研究使用、教师研究参与和证据知情实践。
