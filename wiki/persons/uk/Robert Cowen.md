...
**[[Transitology]]（转型学）**：教育被视为社会转型中"摧毁过去、重新定[[Rightness|义]]未来"的象征性和重构性力量。转型涉及国家机器、社会经济分层体系和政治愿景的同时性崩溃与重建（Cowen, 2000, p.338；Amos, 2022, p.53）。
...
- Cowen, R. (2000). Comparing futures or comparing pasts. *Comparative Education*, 36(3), 333–342. — 给出 transitology 的正式定[[Rightness|义]]
