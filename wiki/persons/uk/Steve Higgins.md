...
> - **2016 — *Meta-synthesis and comparative metaanalysis of education research findings: some risks and benefits*** 追溯从皮尔逊 1904 年到现代元综合的演进，系统论证跨[[Meta-analysis|元分析]]比较虽然面临“苹果与橙子”不可比的技术风险，但在控制[[Heterogeneity|异质性]]前提下仍是回答教育干预相对成效的最佳可用手段。[[Argument_Higgins_2016_RE|(Higgins, 2016, pp. 31–53)]]
> - **2016 — *A re-analysis of 17 [[Education Endowment Foundation]] evaluations*** 对 17 项教育[[Randomised Controlled Trials|随机对照试验]]微观数据应用 4 种主流统计模型进行并行复算，证实 12 项试验存在严重的模型依赖性漂移，为国际循证试验规范提供了关键实证预警。[[Argument_Edovald_Nevill_2021_ROE|(Edovald & Nevill, 2021, p. 52)]]
...
> [!claim] 核心主张
> Higgins 坚持[[Evidence-Based Education|循证教育]]必须兼顾科学严密性与实践可操作性。他主张面对海量[[Heterogeneity|异质性]]研究，[[Meta-meta-analysis|二阶元分析]]与跨干预综合是打破信息孤岛、辅助循证决策的最佳工具；通过“进展月数”将抽象统计[[Effect Size|效应量]][[Transfer Translation Transformation|转译]]为教师与校长的通用日常语言，能够有效降低决策门槛。同时，他高度警惕统计推断中的“模型依赖性”，主张通过透明公开微观数据、执行独立二次审计和前置确立统计分析计划（SAP），以方法学制度化来防范分析偏倚。

> [!citation-card] 跨[[Meta-analysis|元分析]]比较在教育决策中的最佳可用性（[[Argument_Higgins_2016_RE|Higgins, 2016]]）
...
> 当采用 [[Analysis of Covariance|ANCOVA]]、GEE、两级 HLM 与贝叶斯分层模型分别对相同的 17 项试验微观数据进行复算时，超过三分之二的干预其效应量估计或[[Statistical Significance|统计显著性]]发生了质变。这证明即便原始数据完全真实透明，最终推断仍高度依赖研究者设定的统计模型。唯有在试验开展前强制制定统计分析计划并规范主要分析模型，才能保障循证科学的公信力。[[Argument_Edovald_Nevill_2021_ROE|(Edovald & Nevill, 2021, p. 52)]]
>
...
> > - **Steve Higgins（2016）** 承认跨[[Meta-analysis|元分析]]比较存在局限，但辩护称在真实决策环境中，结合挂锁证据星级与成本估计的二阶综合，是防止政策制定者受商业噱头蒙蔽的最优务实方案。[[Argument_Higgins_2016_RE|(Higgins, 2016, pp. 31–53)]]
