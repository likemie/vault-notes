...
> - **核心角色**：实在论评估（Realist Evaluation）与实在论综合（Realist Synthesis）的创立者，在社会与教育干预项目评估学派中承担核心方法论引领者的节点角色。
> - **代表贡献**：创立 [[Realist Evaluation\|实在论评估]] 与实在论综合的方法论体系，系统剖析 RCT 与元分析的去情境化偏误。
...
> | 类型 | 条目 | 贡献 |
> |:-----|:-----|:-----|
> | 方法 | [[Realist Evaluation\|实在论评估]] | 突破传统实验评估，构建以 CMO 为核心的因果分析框架，并提出 “实在论综合” 替代去情境的元分析效应量均值计算。 |
...
> [!claim] 核心主张
> 社会与教育干预项目绝非被动的物理 “注射” 过程，而是一个通过受试者能动推理（Reasoning）来激活资源的过程。政策评估的目标必须是寻找 “背景-机制-结果”（CMO）的配置规则，而非计算脱离情境的平均效应量。循证教育中盲目套用去情境的 RCT 和元分析排行榜，进行 “洗涤与净化” 的过程，将抹杀人类意志和结构变异性，导致灾难性的去专业化政策决策。
...
> [!person-network] 关系网络
> - **师承／合作者**：罗伊·巴斯卡 (Roy Bhaskar) — 为其奠定批判实在论哲学起点；尼克·蒂利 (Nick Tilley) — 共同创立实在论评估；[[Terry Wrigley]] — 将其评估思想与 “实在论综合” 引入教育政策批判。
...
> - **证据依据**：实在论综合需要深度审阅每次干预的具体情境、利益相关者的反思理论和结构障碍，这无法像 EEF 工具包那样提供一眼即得的仪表盘或平均数排行榜，在需要瞬间决策的行政体制中缺乏推广优势。
> - **回应或余留问题**：波森强调追求简单结论的 “钝器” 会导致更严重的决策错误（如错误裁剪 TA），政策制定者必须接受社会干预因果关系的复杂性。
