...
> [!claim] 核心主张
> 社会与教育干预项目绝非被动的物理 “注射” 过程，而是一个通过受试者能动推理（Reasoning）来激活资源的过程。政策评估的目标必须是寻找 “背景-机制-结果”（CMO）的配置规则，而非计算脱离情境的平均[[Effect Size|效应量]]。[[Evidence-Based Education|循证教育]]中盲目套用去情境的 [[Randomised Controlled Trials|RCT]] 和[[Meta-analysis|元分析]]排行榜，进行 “洗涤与净化” 的过程，将抹杀人类意志和结构变异性，导致灾难性的去专业化政策决策。
...
> 波森强烈批评元分析在每一聚合阶段都在进行系统性简化：缩减[[Hypothesis|假设]]、舍弃研究、过滤干预细节、抹除背景信息、提取均值、进行估算。在此净化过程中，学界所做的工作就像是将干预机制 “清洗干净” 一样，恰恰是解释干预如何起作用的关键特征被系统性清洗掉，使复杂的社会项目沦为一纸空洞的数字排行榜。 ([[Argument_Wrigley_2019_ERE|Wrigley & McCusker, 2019, p. 122]])；另见 ([[Argument_Wrigley_2018_BERJ|Wrigley, 2018, p. 13]])
