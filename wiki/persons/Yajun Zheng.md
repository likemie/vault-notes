...
related_theories: ["[[Pierre Bourdieu]]", "[[Culture as Toolkit]]", "[[Rational Action Theory in Education]]", "[[Dual-Process Model of Culture in Action]]"]
related_concepts: ["[[Goal-Controlled Mode]]", "[[Intuition-Dependent Mode]]", "[[Cultural Barrier in Higher Education]]", "[[Habitus]]", "[[Cultural Capital]]", "[[Champ]]", "[[Academic and Social Integration]]", "[[Student Engagement]]", "[[The Shock of the Elite]]", "[[Self-Authorship]]", "[[Self-Driven Mode]]", "[[Opportunist Mode]]", "[[Lost Mode]]", "[[Value Conformist Mode]]", "[[Graduation Pathway Typology (Zheng)]]", "[[Work Meaning Schemas (Zheng)]]", "[[Cultural Disembedding]]", "[[Cultural Disorientation]]"]
related_persons: ["[[Marcia Baxter Magolda]]", "[[Didier Eribon]]"]
...
郑雅君，中国高等教育研究者，研究方向为高等教育社会学、教育公平与大学生发展。其主要学术贡献在于对中国精英大学中大学生毕业出路分化的阶层机制进行了系统的质性研究，原创性地提出了"目标掌控模式"与"直觉依赖模式"两种大学生活组织图式的类型学框架（郑雅君，2023）。
...
方法论上，郑雅君遵循韦伯诠释社会学传统，以[[Constructivist Grounded Theory|建构主义扎根理论]]方法处理 62 名跟踪式深度访谈数据（累计 150+ 万字），在理论演绎与现象归纳的循环迭代中最终产出了目标掌控模式／直觉依赖模式的类型学发现（郑雅君，2023）。其研究进一步提出"文化障碍"概念，指称那些因不具备精英大学中被默认掌握的文化知识和文化技能而造成的无形阻碍。
