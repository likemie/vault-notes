...
aliases:
- 迪特里希·本纳
summary: "德国教育学家，一般教育学代表人物和 Bildung/Erziehung 区分提出者，为教育研究连接教学论与规范性判断提供基础。"
type: person
nationality: germany
tags:
- dietrich-benner
...
> [!info] 简介
> 德国教育学家（Pedagogue），以对 [[Bildung]]（品格陶成）与 Erziehung（教育）的区分以及修正版教学三角模型著称。其工作根植于德国[[Jing (Refined Mastery)|精]]神科学教育学传统。
...
> - "教育"（educating）被局限于道德领域或[[Li (Propriety)|礼]]仪培养，与教学分离
>
> **修正模型：**
> - "教师"和"学习者"的位置不变，但他们相对于"课程"的活动安排发生了根本变化
> - 课程不再是交换对象，而是执行"学习/教学"活动的目标
> - 来自"教师"一侧的"教学/教育"活动指向一个圆形交汇区域，在该区域中与"学生"的活动相遇
> - 教育被理解为两种独立活动的协同——教师的教学与学生的学习在课程目标的指引下交汇
> - 这个交汇区域构成了真正的"教育"空间
>
> > 例：在传统模型中，教师按统一教案向全班讲授，考试衡量学生记住了多少。在修正模型中，教师设计学习任务让每个学生以自身起点积极建构理解，同时教师的角色是引导、[[Feedback|反馈]]和创造学习条件——两种活动在课程目标的交汇点产生真正的教育。
