...
aliases:
  ...
  - 施莱歇尔
  - A. Schleicher
summary: "德国教育统计学家、经合组织（OECD）教育与技能司司长及秘书长教育政策特别顾问，被公认为国际学生评估项目（PISA）的总设计师；主导将经合组织重塑为全球教育数据中枢与政策中介平台，开创了基于大规模跨国评估的软性硬事实治理范式。"
type: person
nationality: germany
...
tags:
  ...
  - person/educational-measurement
  - theme/oecd
  - theme/pisa
...
>
> *[T]he organisation [OECD] provides a unique forum and knowledge hub for data and analysis, exchange of experiences, best-practice sharing, and advice on public policies and international standard-setting.*
...
> [!influence-path] 影响路径
> - **方法路径** 将复杂矩阵抽样、[[Item Response Theory|项目反应理论]]（IRT）与多重填补技术标准化运用于跨国大规模教育测评，确立了全球学生素养量化测量的技术[[Paradigm|范式]]。
...
> [!person-network] 关系网络
> - **机构／运动／项目** [[OECD]] — 长期担任教育与技能司司长，领导经合组织全球教育战略。
> - **机构／运动／项目** [[PISA]] — 担任总设计师与项目负责人，主导测试设计与全球报告发布。
> - **批评者／论敌** 83 位国际顶尖学者 — 2014 年 5 月在英国《卫报》联名致信施莱歇尔，抗议 PISA 窄化课程、加剧应试狂热与推行全球公学商业化。
> - **批评者／论敌** [[Paul Morris]] — 深入批判其在媒体公关中使用的口号化修辞与商业化咨询倾向。
> - **批评者／论敌** [[Yong Zhao|赵勇]] — 批评其过度推崇[[High-Stakes Testing|高利害测验]]与威权文化中的学生自我归咎心理。
...
> [!debates] 学术争议
>
> > [!axis] 全球通用素养标尺 vs 在地多元教育文化生态
> > 批判学者与测评技术官僚围绕是否存在单一的全球优质教育标准展开激烈争辩。
> >
> > - **施莱歇尔与[[OECD|经合组织]]** 坚持全球化劳动力市场对[[Critical Thinking|批判性思维]]与高阶[[Problem Solving|问题解决]]提出了普遍要求，跨国标尺是促进教育公平与打破国内利益集团阻碍的利器。
> > - **比较学者与批判教育家** 指责 [[PISA]] 抹杀各主权国家独特的历史文化传统与人文主义价值追求，将复杂的教育生态简化为单一维度的奥林匹克竞赛。(Open Letter, 2014)
>
> > [!axis] [[Policy Brokerage|政策中介]]的中立性 vs 跨国教育产业与新自由主义推销
...
> - [[Argument_Grey_2018_CE|Grey & Morris (2018)]] — 揭露其在伦敦发布会运用极度迎合媒体传播的简报技术，将高度不确定的统计相关性包装为确定性的因果改革处方。
...
> | 条目 | 类型 | 贡献 |
> |:-----|:-----|:-----|
> | [[PISA]] | 政策事实 / 工具 | 亲手设计并主导其实施二十余年，奠定全球大规模学生测评标准。 |
> | [[OECD]] | 国际组织 | 推动该组织完成从经济智库向全球教育知识枢纽与[[Policy Brokerage\|政策中介]]的转型。 |
> | [[Policy Brokerage]] | 概念 | 将政策中介在教育领域的运作制度化为集数据、报告与咨询于一体的知识平台。 |
> | [[Soft Power by Hard Facts]] | 概念 | 践行以可比硬事实指标对主权国家实施非强制性软治理的核心代表人物。 |
> | [[2014 Open Letter on PISA]] | 历史事件 | 面对 83 位国际顶尖学者集体抗议并代表经合组织进行公开辩护的当事人。 |
