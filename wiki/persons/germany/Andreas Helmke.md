...
> [!info] 核心思想
> - Helmke 提出了一份包含十项[[Effective Teaching|有效教学]]质量的清单。与 [[John Hattie|Hattie]]、Meyer 一样，Helmke 强调教师领导、照顾个别学生、清晰目标和学习导向的课堂气氛（Laursen, 2015, p.35）。
> - 与 Hattie 的简要概括相比，Helmke 的综合更细致。例如，Helmke 明确纳入巩固和动机等因素；Hattie 在其他著作中也强调过这两点（Laursen, 2015, p.35）。
> - Helmke 讨论过文化语境与学生前提条件。他指出，学生前提不同，教学措施的效果也会不同：学科和语言基础较弱的学生，在低控制、低要求、低[[Feedback|反馈]]的开放教学中表现较差；基础较强的学生则可以较好地适应这类教学（Laursen, 2015, p.36）。
...
> - [[Feedback]] — Helmke 与 [[John Hattie|Hattie]]、Meyer 都认为给学生关于其表现的反馈能促进学习；这一共识使 SFI 关于反馈的零效应需要谨慎解释，因为 SFI 问项可能没有捕捉反馈的核心机制（Laursen, 2015, p.39）。
