...
2. **领导力研究的方法论反思**：ISSPP 类型的成功学校领导力研究虽有贡献，但过度关注个人能力、忽视权力结构，有陷入"英雄叙事"的风险（p.380-381）
...
> "To lead education beyond the agenda of what works, we need different approaches to research, including reflective approaches and critical studies addressing the power structures."（Møller, 2017, p.382）

## 主要贡献

- **ISSPP 项目参与** — 自 2002 年起参与 ISSPP，提供北欧国家的案例研究视角，同时对该项目的方法论局限保持反思性批评（Møller, 2017, p.379-381）
- **OECD ISL 项目参与** — 被 OECD 邀请为 ISL 项目 Vol. 2 收集"最佳实践"案例数据，基于亲历经验提出对 OECD 知识生产政治的批判（Møller, 2017, p.377）
- **新公共管理与教育的批判性分析** — 与 Gunter, Hall, Serpieri, Skedsmo 等合作，分析 NPM 在欧洲教育改革中的作用（Møller, 2017, p.381-382, citing Hall et al., 2015; Gunter et al., 2016; Skedsmo & Møller, 2016）
...
- Møller, J. (2009). Approaches to school leadership in Scandinavia. *Journal of Educational Administration and History*, *41*(2), 165–177. — 分析北欧学校领导力路径
- Møller, J. & Skedsmo, G. (2013). Modernizing education: NPM reform in the Norwegian education system. *Journal of Educational Administration & History*, *45*(4), 336–353. — 挪威教育系统的新公共管理改革分析
...
- 受 Carolyn Shields 的变革型领导力框架和 Helen Gunter 的批判性教育政策视角影响
