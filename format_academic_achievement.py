...
> [!boundary]- 概念边界
> - 不等于 **智商或潜在认知能力** — 学业成就是努力、策略、动机与信念的综合结果输出，受情境因素剧烈影响，而非纯粹固定的底层能力。
> - 不等于 **主观自报成绩** — 研究表明，学生自陈的成绩与客观的官方成绩或标准化测试存在巨大偏差，使用自报数据会严重稀释变量间的真实理论关联。[[Argument_Greene_2018_JEP|(Greene et al., 2018)]]
...
> [!concept-lens] 认知深度的匹配假设
> 高阶的心理构念（如认识论认知）并不必然促进所有类型的学习成绩，其预测效力随成绩所要求的认知深度而发生阶梯式变化。

> [!claim] Greene, J.
> **高阶成就类型的强挂钩** 成就指标的要求越高阶，其与学生深层认知信念的相关性就越强。实证数据表明，认识论认知对概念性知识（$r = .190$）和论证能力（$r = .154$）的预测力，明显强于底层的陈述性知识（$r = .127$），而对死记硬背的程序性知识则完全无效（$r = .077$，不显著）。这证明了高级认知信念只有在遇到需要深层加工的学业成就测试时，才能发挥作用。[[Argument_Greene_2018_JEP|(Greene et al., 2018)]]
...
> | **测量对齐法则** | 学业成就的测量必须是客观的（排斥自报），且在颗粒度上必须与预测变量的特异性严格对齐。 | 教育测量工具设计、量化回归分析 | Greene |
...
> |---|---|---|---|---|---|---|
> | [[Argument_Greene_2010_JEP\|Greene et al. (2010)]] | 740名美国学生 | 问卷调查与多项逻辑回归 | 历史与数学学科表现 | 较差的数学成绩显著正向预测学生落入“初级认识论阶段”的几率（OR = 1.770） | $p < .01$ | 表明在结构不良问题和学术表现上，坚持纯粹现实主义信念会导致更差的学业成就 |
