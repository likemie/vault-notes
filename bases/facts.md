...
views:
  ...
  - type: table
    ...
    filters:
      and:
        - 'fact_region == "australia" || fact_region == "newzealand" || fact_region == "new-zealand" || fact_region == "New Zealand"'
    order:
      - file.name
      - summary
      - fact_kind
  ...
  - type: table
    ...
    filters:
      and:
        - 'fact_region == "hongkong" || fact_region == "eu" || fact_region == "EU" || fact_region == "europe"'
    order:
      - file.name
      - summary
      - fact_kind
